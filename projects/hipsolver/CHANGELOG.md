...
* Added ability to control rocSOLVER logging using the environment variables `HIPSOLVER_ENABLE_ROCSOLVER_LOGGING` `HIPSOLVER_REFACTOR_ENABLE_ROCSOLVER_LOGGING`, and `HIPSOLVER_SPARSE_ENABLE_ROCSOLVER_LOGGING`.
