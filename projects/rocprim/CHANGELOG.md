...
* Added support for large number of segments to `rocprim::device_segmented_reduce`.
* Added support for large sizes to `rocprim::device_run_length_encode` and `rocprim::device_run_length_encode_non_trivial_runs`.
