...
TESTS_DEFINE(BinaryFunctionalPlaceholdersTest, VectorTestsParams);
TESTS_DEFINE(FunctionalPlaceholdersLogicalNotTest, IntegralVectorTestsParams);
...
#define BINARY_FUNCTIONAL_PLACEHOLDERS_TEST(name, reference_operator, functor)                        \
  TYPED_TEST(BinaryFunctionalPlaceholdersTest, TestFunctionalPlaceholders##name)                      \
  {                                                                                                   \
...
TYPED_TEST(FunctionalPlaceholdersLogicalNotTest, TestFunctionalPlaceholdersLogicalNot)
{
  SCOPED_TRACE(testing::Message() << "with device_id= " << test::set_device_from_ctest());
