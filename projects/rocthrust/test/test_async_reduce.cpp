...
TEST(AsyncReduceTests, test_async_reduce_bug1886)
{
  ...
  IteratorType zip_begin;
  IteratorType zip_end;
  try
  {
    zip_begin = thrust::make_zip_iterator(thrust::make_tuple(d_data1.begin(), d_data2.begin()));
    zip_end   = thrust::make_zip_iterator(thrust::make_tuple(d_data2.end(), d_data2.end()));
  }
