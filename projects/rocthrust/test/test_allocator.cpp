...
TEST(AllocatorTests, TestAllocatorTraitsRebind)
{
  ...
  ASSERT_EQ((::std::is_same<typename thrust::detail::allocator_traits<
...
TEST(AllocatorTests, TestAllocatorTraitsRebindCpp11)
{
  ...
  ASSERT_EQ(
    (::std::is_same<typename thrust::detail::allocator_traits<my_minimal_allocator<int>>::template rebind_alloc<float>,
  ...
  ASSERT_EQ(
    (::std::is_same<typename thrust::detail::allocator_traits<my_minimal_allocator<int>>::template rebind_traits<float>,
                    typename thrust::detail::allocator_traits<my_minimal_allocator<float>>>::value),
    true);
}
