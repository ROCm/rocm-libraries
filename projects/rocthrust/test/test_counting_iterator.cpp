...
// ensure that we properly support thrust::counting_iterator from std
TEST(CountingIteratorTests, TestIteratorTraits)
{
  ...
  static_assert(::std::is_same<It::difference_type, ptrdiff_t>::value, "");
  static_assert(::std::is_same<It::value_type, int>::value, "");
  static_assert(::std::is_same<It::pointer, void>::value, "");
  static_assert(::std::is_same<It::reference, signed int>::value, "");
  static_assert(::std::is_same<It::iterator_category, category>::value, "");
