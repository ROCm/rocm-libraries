...
using BitNegateTestsParams = ::testing::Types<
  Params<thrust::host_vector<signed char>>,
  Params<thrust::host_vector<short>>,
...
TESTS_DEFINE(BinaryTests, BinaryTestsParams);
TESTS_DEFINE(BitNegateTests, BitNegateTestsParams);
...
#define BINARY_FUNCTIONAL_PLACEHOLDERS_TEST(name, op, reference_functor)                                        \
  TYPED_TEST(BinaryTests, TestFunctionalPlaceholders##name)                                                     \
  {                                                                                                             \
...
TYPED_TEST(BitNegateTests, TestFunctionalPlaceholdersBitNegate)
{
  using Vector      = typename TestFixture::input_type;
  using T           = typename Vector::value_type;
