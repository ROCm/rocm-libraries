...
TYPED_TEST(ZipIteratorNumericTests, TestZipIteratorTraversal)
{
  ...
  // ASSERT_EQ(true, (::std::is_convertible<zip_iterator_traversal_type1,
  ...
  // ASSERT_EQ(true, (::std::is_convertible<zip_iterator_traversal_type2,
...
TYPED_TEST(ZipIteratorNumericTests, TestZipIteratorSystem)
{
  ...
  // ASSERT_EQ(true, (::std::is_same<zip_iterator_system_type1, experimental::space::host>::value) );
  ...
  // ASSERT_EQ(true, (::std::is_convertible<zip_iterator_system_type2, experimental::space::device>::value)
  // );
  ...
  // ASSERT_EQ(true, (::std::is_convertible<zip_iterator_system_type3,
  ...
  // ASSERT_EQ(true, (::std::is_convertible<zip_iterator_system_type4, thrust::host_system_tag>::value) );
  ...
  // ASSERT_EQ(true, (::std::is_convertible<zip_iterator_system_type5, thrust::host_system_tag>::value) );
  ...
  // ASSERT_EQ(true, (::std::is_convertible<zip_iterator_system_type6, thrust::device_system_tag>::value) );
  ...
  // ASSERT_EQ(true, (::std::is_convertible<zip_iterator_system_type7, thrust::device_system_tag>::value) );
}
