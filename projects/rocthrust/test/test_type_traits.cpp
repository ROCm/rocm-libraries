...
TEST(TypeTraitsTests, TestTriviallyRelocatable)
{
  ...
  static_assert(thrust::is_trivially_relocatable<::std::complex<float>>::value, "");
  static_assert(thrust::is_trivially_relocatable<thrust::pair<int, thrust::complex<float>>>::value, "");
  static_assert(thrust::is_trivially_relocatable<::std::pair<int, ::std::complex<float>>>::value, "");
  static_assert(thrust::is_trivially_relocatable<thrust::tuple<int, thrust::complex<float>, char>>::value, "");
  static_assert(thrust::is_trivially_relocatable<::std::tuple<int, ::std::complex<float>, char>>::value, "");
#endif // defined(THRUST_GCC_VERSION) && THRUST_GCC_VERSION >= 70000
  // static_assert(thrust::is_trivially_relocatable<
  //                 ::cuda::std::tuple<thrust::pair<int, thrust::tuple<int, ::std::tuple<>>>,
  //                                    thrust::tuple<::std::pair<int, thrust::tuple<>>, int>>>::value,
  //               "");

  static_assert(!thrust::is_trivially_relocatable<thrust::pair<int, std::string>>::value, "");
  static_assert(!thrust::is_trivially_relocatable<::std::pair<int, std::string>>::value, "");
  static_assert(!thrust::is_trivially_relocatable<thrust::tuple<int, float, std::string>>::value, "");
  static_assert(!thrust::is_trivially_relocatable<::std::tuple<int, float, std::string>>::value, "");
  ...
  static_assert(thrust::is_trivially_relocatable<::std::pair<NonTriviallyCopyable, int>>::value, "");
  // static_assert(thrust::is_trivially_relocatable<thrust::tuple<NonTriviallyCopyable>>::value, "");
  static_assert(thrust::is_trivially_relocatable<::std::tuple<NonTriviallyCopyable>>::value, "");
}
