...
def parse_args():
    ...
    parser.add_argument('--no-offload-compress', required=False, default=True, action='store_true', help='Do not apply offload compression (deafult: True)')                        
...
def config_cmd():
  ...
  # build type
    ...
    if args.no_offload_compress:
        cmake_options.append( f"-DBUILD_OFFLOAD_COMPRESS=ON" )
