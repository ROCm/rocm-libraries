...
using is_trivially_relocatable_to =
  integral_constant<bool, ::internal::is_same<From, To>::value && is_trivially_relocatable<To>::value>;
...
template <typename T>
struct is_trivially_relocatable_impl
    : integral_constant<bool, ::internal::is_trivially_copyable<T>::value || proclaim_trivially_relocatable<T>::value>
{};
...
#endif
    : ::internal::conjunction<is_trivially_relocatable<T>, is_trivially_relocatable<U>>
{};
...
#else
struct proclaim_trivially_relocatable<::std::tuple<Ts...>>
#endif
    : ::internal::conjunction<is_trivially_relocatable<Ts>...>
{};
THRUST_NAMESPACE_END
