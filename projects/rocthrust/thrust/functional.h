...
//! deprecated [since 3.1]
template <class T = void>
using maximum THRUST_DEPRECATED_BECAUSE("Use _THRUST_LIBCXX::maximum instead") = ::internal::maximum<T>;
//! deprecated [since 3.1]
template <class T = void>
using minimum THRUST_DEPRECATED_BECAUSE("Use _THRUST_LIBCXX::minimum instead") = ::internal::minimum<T>;
...
{
  return ::internal::not_fn(_THRUST_STD::forward<Fn>(f));
}
