...
public:
   ...
   *         first adapted base engine.
   */
  THRUST_HOST_DEVICE xor_combine_engine(const base1_type& urng1, const base2_type& urng2);
...
private:
  ...
  THRUST_HOST_DEVICE bool equal(const xor_combine_engine& rhs) const;
...
THRUST_HOST_DEVICE bool operator==(const xor_combine_engine<Engine1_, s1_, Engine2_, s2_>& lhs,
