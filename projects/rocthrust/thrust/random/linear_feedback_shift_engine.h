...
public:
   ...
   */
  THRUST_HOST_DEVICE explicit linear_feedback_shift_engine(result_type value = default_seed);
...
private:
  ...
  THRUST_HOST_DEVICE bool equal(const linear_feedback_shift_engine& rhs) const;
...
THRUST_HOST_DEVICE bool operator==(const linear_feedback_shift_engine<UIntType_, w_, k_, q_, s_>& lhs,
