...
public:
   ...
   */
  THRUST_HOST_DEVICE discard_block_engine();
   ...
   *         adapted base engine.
   */
  THRUST_HOST_DEVICE explicit discard_block_engine(const base_type& urng);
...
private:
  ...
  THRUST_HOST_DEVICE bool equal(const discard_block_engine& rhs) const;
