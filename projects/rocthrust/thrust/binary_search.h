...
THRUST_HOST_DEVICE ForwardIterator lower_bound(
 ...
 *  input[4] = 8;
 *
 *  thrust::lower_bound(input.begin(), input.end(), 0, _THRUST_STD::less<int>()); // returns input.begin()
 *  thrust::lower_bound(input.begin(), input.end(), 1, _THRUST_STD::less<int>()); // returns input.begin() + 1
 *  thrust::lower_bound(input.begin(), input.end(), 2, _THRUST_STD::less<int>()); // returns input.begin() + 1
 *  thrust::lower_bound(input.begin(), input.end(), 3, _THRUST_STD::less<int>()); // returns input.begin() + 2
 *  thrust::lower_bound(input.begin(), input.end(), 8, _THRUST_STD::less<int>()); // returns input.begin() + 4
 *  thrust::lower_bound(input.begin(), input.end(), 9, _THRUST_STD::less<int>()); // returns input.end()
 *  \endcode
 *
 *  \see https://en.cppreference.com/w/cpp/algorithm/lower_bound
 *  \see \p upper_bound
 ...
 */
template <typename DerivedPolicy, typename ForwardIterator, typename LessThanComparable>
THRUST_HOST_DEVICE ForwardIterator upper_bound(
  const thrust::detail::execution_policy_base<DerivedPolicy>& exec,
  ForwardIterator first,
  ForwardIterator last,
  const LessThanComparable& value);
 ...
 *  input[4] = 8;
 *
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 0, _THRUST_STD::less<int>()); // returns input.begin() +
 * 1 thrust::upper_bound(thrust::device, input.begin(), input.end(), 1, _THRUST_STD::less<int>()); // returns input.begin() +
 * 1 thrust::upper_bound(thrust::device, input.begin(), input.end(), 2, _THRUST_STD::less<int>()); // returns input.begin() +
 * 2 thrust::upper_bound(thrust::device, input.begin(), input.end(), 3, _THRUST_STD::less<int>()); // returns input.begin() +
 * 2 thrust::upper_bound(thrust::device, input.begin(), input.end(), 8, _THRUST_STD::less<int>()); // returns input.end()
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 9, _THRUST_STD::less<int>()); // returns input.end()
 *  \endcode
 *
 *  \see https://en.cppreference.com/w/cpp/algorithm/upper_bound
 *  \see \p lower_bound
 ...
 *  input[4] = 8;
 *
 *  thrust::upper_bound(input.begin(), input.end(), 0, _THRUST_STD::less<int>()); // returns input.begin() + 1
 *  thrust::upper_bound(input.begin(), input.end(), 1, _THRUST_STD::less<int>()); // returns input.begin() + 1
 *  thrust::upper_bound(input.begin(), input.end(), 2, _THRUST_STD::less<int>()); // returns input.begin() + 2
 *  thrust::upper_bound(input.begin(), input.end(), 3, _THRUST_STD::less<int>()); // returns input.begin() + 2
 *  thrust::upper_bound(input.begin(), input.end(), 8, _THRUST_STD::less<int>()); // returns input.end()
 *  thrust::upper_bound(input.begin(), input.end(), 9, _THRUST_STD::less<int>()); // returns input.end()
 *  \endcode
 *
 *  \see https://en.cppreference.com/w/cpp/algorithm/upper_bound
 *  \see \p lower_bound
 ...
 */
template <typename DerivedPolicy, typename ForwardIterator, typename LessThanComparable>
THRUST_HOST_DEVICE bool binary_search(
  const thrust::detail::execution_policy_base<DerivedPolicy>& exec,
  ForwardIterator first,
  ForwardIterator last,
  const LessThanComparable& value);
 ...
 *  input[4] = 8;
 *
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 0, _THRUST_STD::less<int>()); // returns true
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 1, _THRUST_STD::less<int>()); // returns false
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 2, _THRUST_STD::less<int>()); // returns true
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 3, _THRUST_STD::less<int>()); // returns false
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 8, _THRUST_STD::less<int>()); // returns true
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 9, _THRUST_STD::less<int>()); // returns false
 *  \endcode
 *
 *  \see https://en.cppreference.com/w/cpp/algorithm/binary_search
 *  \see \p lower_bound
 ...
 *  input[4] = 8;
 *
 *  thrust::binary_search(input.begin(), input.end(), 0, _THRUST_STD::less<int>()); // returns true
 *  thrust::binary_search(input.begin(), input.end(), 1, _THRUST_STD::less<int>()); // returns false
 *  thrust::binary_search(input.begin(), input.end(), 2, _THRUST_STD::less<int>()); // returns true
 *  thrust::binary_search(input.begin(), input.end(), 3, _THRUST_STD::less<int>()); // returns false
 *  thrust::binary_search(input.begin(), input.end(), 8, _THRUST_STD::less<int>()); // returns true
 *  thrust::binary_search(input.begin(), input.end(), 9, _THRUST_STD::less<int>()); // returns false
 *  \endcode
 *
 *  \see https://en.cppreference.com/w/cpp/algorithm/binary_search
 *  \see \p lower_bound
 ...
 */
template <typename DerivedPolicy, typename ForwardIterator, typename LessThanComparable>
THRUST_HOST_DEVICE thrust::pair<ForwardIterator, ForwardIterator> equal_range(
  const thrust::detail::execution_policy_base<DerivedPolicy>& exec,
  ForwardIterator first,
  ForwardIterator last,
  const LessThanComparable& value);
 ...
 *  input[4] = 8;
 *
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 0, _THRUST_STD::less<int>()); // returns [input.begin(),
 * input.begin() + 1) thrust::equal_range(thrust::device, input.begin(), input.end(), 1, _THRUST_STD::less<int>()); //
 * returns [input.begin() + 1, input.begin() + 1) thrust::equal_range(thrust::device, input.begin(), input.end(), 2,
 * _THRUST_STD::less<int>()); // returns [input.begin() + 1, input.begin() + 2) thrust::equal_range(thrust::device,
 * input.begin(), input.end(), 3, _THRUST_STD::less<int>()); // returns [input.begin() + 2, input.begin() + 2)
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 8, _THRUST_STD::less<int>()); // returns [input.begin() +
 * 4, input.end()) thrust::equal_range(thrust::device, input.begin(), input.end(), 9, _THRUST_STD::less<int>()); // returns
 ...
 *  input[4] = 8;
 *
 *  thrust::equal_range(input.begin(), input.end(), 0, _THRUST_STD::less<int>()); // returns [input.begin(), input.begin() +
 * 1) thrust::equal_range(input.begin(), input.end(), 1, _THRUST_STD::less<int>()); // returns [input.begin() + 1,
 * input.begin() + 1) thrust::equal_range(input.begin(), input.end(), 2, _THRUST_STD::less<int>()); // returns [input.begin()
 * + 1, input.begin() + 2) thrust::equal_range(input.begin(), input.end(), 3, _THRUST_STD::less<int>()); // returns
 * [input.begin() + 2, input.begin() + 2) thrust::equal_range(input.begin(), input.end(), 8, _THRUST_STD::less<int>()); //
 * returns [input.begin() + 4, input.end()) thrust::equal_range(input.begin(), input.end(), 9, _THRUST_STD::less<int>()); //
...
THRUST_HOST_DEVICE OutputIterator lower_bound(
  const thrust::detail::execution_policy_base<DerivedPolicy>& exec,
  ForwardIterator first,
  ForwardIterator last,
 ...
 */
template <typename DerivedPolicy, typename ForwardIterator, typename InputIterator, typename OutputIterator>
THRUST_HOST_DEVICE OutputIterator upper_bound(
  const thrust::detail::execution_policy_base<DerivedPolicy>& exec,
  ForwardIterator first,
  ForwardIterator last,
  InputIterator values_first,
 ...
 */
template <typename DerivedPolicy, typename ForwardIterator, typename InputIterator, typename OutputIterator>
THRUST_HOST_DEVICE OutputIterator binary_search(
  const thrust::detail::execution_policy_base<DerivedPolicy>& exec,
  ForwardIterator first,
  ForwardIterator last,
  InputIterator values_first,
