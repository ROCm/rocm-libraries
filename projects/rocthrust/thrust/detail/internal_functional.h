...
struct generate_functor
    : thrust::detail::eval_if<::internal::is_convertible<System, thrust::host_system_tag>::value,
...
struct is_non_const_reference
    : ::internal::_And<thrust::detail::not_<::internal::is_const<T>>,
                       ::internal::disjunction<::internal::is_reference<T>, thrust::detail::is_proxy_reference<T>>>
{};
...
struct enable_if_non_const_reference_or_tuple_of_iterator_references
    : ::internal::enable_if<is_non_const_reference<T>::value || is_tuple_of_iterator_references<T>::value>
{};
