...
vector_base<T, Alloc>::vector_base(InputIterator first, InputIterator last)
    ...
    , m_size(0)
{
  static_assert(!::internal::is_integral_v<InputIterator>); // TODO(bgruber): remove, just for testing
...
void vector_base<T, Alloc>::resize(size_type new_size, default_init_t)
{
  if (new_size < size())
  {
    erase(_THRUST_STD::next(begin(), new_size), end());
  }
  else
  {
    append</* SkipInit = */ _THRUST_STD::is_trivially_constructible_v<T>>(new_size - size());
  }
}
...
template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::size_type vector_base<T, Alloc>::size() const
{
  return m_size;
} // end vector_base::size()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::size_type vector_base<T, Alloc>::max_size() const
{
...
void vector_base<T, Alloc>::reserve(size_type n)
{
  if (n > capacity())
  {
    ...
    new_capacity = _THRUST_STD::min<size_type>(new_capacity, max_size());
...
template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::size_type vector_base<T, Alloc>::capacity() const
{
...
template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::reference vector_base<T, Alloc>::operator[](const size_type n)
{
  return m_storage[n];
} // end vector_base::operator[]

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_reference
...
template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::iterator vector_base<T, Alloc>::begin()
{
  return m_storage.begin();
} // end vector_base::begin()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_iterator vector_base<T, Alloc>::begin() const
{
  return m_storage.begin();
} // end vector_base::begin()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_iterator vector_base<T, Alloc>::cbegin() const
{
  return begin();
} // end vector_base::cbegin()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::reverse_iterator vector_base<T, Alloc>::rbegin()
{
  return reverse_iterator(end());
} // end vector_base::rbegin()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_reverse_iterator vector_base<T, Alloc>::rbegin() const
{
  return const_reverse_iterator(end());
} // end vector_base::rbegin()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_reverse_iterator vector_base<T, Alloc>::crbegin() const
{
  return rbegin();
...
template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_iterator vector_base<T, Alloc>::cend() const
{
  return end();
} // end vector_base::cend()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::reverse_iterator vector_base<T, Alloc>::rend()
{
  return reverse_iterator(begin());
} // end vector_base::rend()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_reverse_iterator vector_base<T, Alloc>::rend() const
{
  return const_reverse_iterator(begin());
} // end vector_base::rend()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_reverse_iterator vector_base<T, Alloc>::crend() const
{
  return rend();
} // end vector_base::crend()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_reference vector_base<T, Alloc>::front() const
{
  return *begin();
} // end vector_base::front()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::reference vector_base<T, Alloc>::front()
{
  return *begin();
} // end vector_base::front()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_reference vector_base<T, Alloc>::back() const
{
...
template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::reference vector_base<T, Alloc>::back()
{
...
template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::pointer vector_base<T, Alloc>::data()
{
  return pointer(&front());
} // end vector_base::data()

template <typename T, typename Alloc>
THRUST_HOST_DEVICE typename vector_base<T, Alloc>::const_pointer vector_base<T, Alloc>::data() const
{
...
template <typename T, typename Alloc>
THRUST_HOST_DEVICE bool vector_base<T, Alloc>::empty() const
{
  return size() == 0;
...
void vector_base<T, Alloc>::assign(InputIterator first, InputIterator last)
{
  ...
  if constexpr (::internal::is_integral_v<InputIterator>)
  {
  ...
  if (first != last)
  {
    ...
    else
    {
      ...
      size_type new_capacity =
        old_size + _THRUST_STD::max THRUST_PREVENT_MACRO_SUBSTITUTION(old_size, num_new_elements);

      // allocate exponentially larger new storage
      new_capacity = _THRUST_STD::max<size_type>(new_capacity, 2 * capacity());
...
void vector_base<T, Alloc>::append(size_type n)
{
  if (n != 0)
  {
    ...
    else
    {
      ...
      // compute the new capacity after the allocation
      size_type new_capacity = old_size + _THRUST_STD::max THRUST_PREVENT_MACRO_SUBSTITUTION(old_size, n);
  ...
  size_type requested_size, ForwardIterator first, ForwardIterator last, storage_type& new_storage)
{
  ...
  // allocate exponentially larger new storage
  size_type allocated_size = _THRUST_STD::max<size_type>(requested_size, 2 * capacity());

  // do not exceed maximum storage
  allocated_size = _THRUST_STD::min<size_type>(allocated_size, max_size());
