...
template <typename T, typename Alloc>
template <typename InputIterator,
          ::internal::enable_if_t<::thrust::detail::is_cpp17_input_iterator<InputIterator>::value, int>>
...
bool vector_equal(InputIterator1 first1, InputIterator1 last1, InputIterator2 first2)
{
  ...
  return vector_equal(first1, last1, first2, ::internal::is_same<system1, system2>());
}
