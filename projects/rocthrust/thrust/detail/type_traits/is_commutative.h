...
{};
template <typename T>
struct is_commutative<typename ::internal::minimum<T>> : public ::internal::is_arithmetic<T>
{};
template <typename T>
struct is_commutative<typename ::internal::maximum<T>> : public ::internal::is_arithmetic<T>
{};
template <typename T>
