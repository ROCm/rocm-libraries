...
#ifndef LIBCXX_WRAPPER_FUNCTIONAL_MINIMUM_H
#define LIBCXX_WRAPPER_FUNCTIONAL_MINIMUM_H
...
#  include _THRUST_LIBCXX_INCLUDE(__functional/minimum.h)
#else
...
THRUST_CTAD_SUPPORTED_FOR_TYPE(minimum);
...
#endif // LIBCXX_WRAPPER_FUNCTIONAL_MINIMUM_H
