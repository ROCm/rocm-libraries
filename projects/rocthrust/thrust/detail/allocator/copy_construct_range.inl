...
struct copy_construct_with_allocator
{
  ...
  THRUST_HOST_DEVICE copy_construct_with_allocator(Allocator& a)
      : a(a)
  {}

  template <typename Tuple>
  inline THRUST_HOST_DEVICE void operator()(Tuple t)
  {
...
struct needs_copy_construct_via_allocator<std::allocator<U>, T>
    : integral_constant<bool, !_THRUST_STD::is_trivially_copy_constructible<T>::value>
{};
...
THRUST_HOST_DEVICE enable_if_convertible_t<FromSystem, ToSystem, Pointer> uninitialized_copy_with_allocator(
  Allocator& a,
...
THRUST_HOST_DEVICE enable_if_convertible_t<FromSystem, ToSystem, Pointer> uninitialized_copy_with_allocator_n(
  Allocator& a,
  const thrust::execution_policy<FromSystem>&,
  const thrust::execution_policy<ToSystem>& to_system,
  InputIterator first,
...
template <typename Allocator, typename FromSystem, typename ToSystem, typename InputIterator, typename Pointer>
THRUST_HOST_DEVICE typename disable_if_convertible<FromSystem, ToSystem, Pointer>::type uninitialized_copy_with_allocator(
  Allocator&,
...
template <typename Allocator, typename FromSystem, typename ToSystem, typename InputIterator, typename Size, typename Pointer>
THRUST_HOST_DEVICE typename disable_if_convertible<FromSystem, ToSystem, Pointer>::type
...
THRUST_HOST_DEVICE Pointer copy_construct_range(
...
THRUST_HOST_DEVICE Pointer copy_construct_range_n(
