...
public:
  ...
  using is_always_equal =
    typename eval_if<allocator_traits_detail::has_is_always_equal<allocator_type>::value,
                     ...
                     ::internal::is_empty<allocator_type>>::type;
  ...
  THRUST_HOST_DEVICE static pointer allocate(allocator_type& a, size_type n)
  {
    return superclass::allocate(a, n);
  }

  THRUST_EXEC_CHECK_DISABLE
  THRUST_HOST_DEVICE static pointer allocate(allocator_type& a, size_type n, const_void_pointer hint)
  {
    return superclass::allocate(a, n, hint);
  }

  THRUST_EXEC_CHECK_DISABLE
  THRUST_HOST_DEVICE static void deallocate(allocator_type& a, pointer p, size_type n) noexcept
  {
  ...
  THRUST_HOST_DEVICE static void construct(allocator_type& a, U* p, Args&&... args)
  {
  ...
  THRUST_EXEC_CHECK_DISABLE
  template <typename U>
  THRUST_HOST_DEVICE static void destroy(allocator_type& a, U* p) noexcept
  {
    superclass::destroy(a, p);
  }

  THRUST_EXEC_CHECK_DISABLE
  THRUST_HOST_DEVICE static size_type max_size(const allocator_type& a)
  {
...
template <typename Alloc>
THRUST_HOST_DEVICE ::internal::enable_if_t<has_member_allocate_with_hint<Alloc>::value,
...
THRUST_EXEC_CHECK_DISABLE
template <typename Alloc, typename T>
inline THRUST_HOST_DEVICE ::internal::enable_if_t<has_member_construct1<Alloc, T>::value> construct(Alloc& a, T* p)
{
  a.construct(p);
}
...
THRUST_EXEC_CHECK_DISABLE
template <typename Alloc, typename T>
inline THRUST_HOST_DEVICE ::internal::enable_if_t<!has_member_construct1<Alloc, T>::value> construct(Alloc&, T* p)
{
...
THRUST_EXEC_CHECK_DISABLE
template <typename Alloc, typename T, typename Arg1>
inline THRUST_HOST_DEVICE ::internal::enable_if_t<has_member_construct2<Alloc, T, Arg1>::value>
...
THRUST_EXEC_CHECK_DISABLE
template <typename Alloc, typename T, typename... Args>
inline THRUST_HOST_DEVICE ::internal::enable_if_t<has_member_constructN<Alloc, T, Args...>::value>
...
THRUST_EXEC_CHECK_DISABLE
template <typename Alloc, typename T>
inline THRUST_HOST_DEVICE ::internal::enable_if_t<has_member_destroy<Alloc, T>::value> destroy(Alloc& a, T* p)
{
  a.destroy(p);
}
...
THRUST_EXEC_CHECK_DISABLE
template <typename Alloc, typename T>
inline THRUST_HOST_DEVICE ::internal::enable_if_t<!has_member_destroy<Alloc, T>::value> destroy(Alloc&, T* p)
{
  p->~T();
}
...
template <typename Alloc>
THRUST_HOST_DEVICE ::internal::enable_if_t<has_member_max_size<Alloc>::value, typename allocator_traits<Alloc>::size_type>
...
template <typename Alloc>
THRUST_HOST_DEVICE ::internal::enable_if_t<!has_member_max_size<Alloc>::value,
...
template <typename Alloc>
THRUST_HOST_DEVICE ::internal::enable_if_t<has_member_system<Alloc>::value, typename allocator_system<Alloc>::type&>
system(Alloc& a)
{
...
template <typename Alloc>
THRUST_HOST_DEVICE typename allocator_traits<Alloc>::pointer
allocator_traits<Alloc>::allocate(Alloc& a, typename allocator_traits<Alloc>::size_type n)
{
  struct workaround_warnings
  {
    THRUST_EXEC_CHECK_DISABLE
    static THRUST_HOST_DEVICE typename allocator_traits<Alloc>::pointer
...
template <typename Alloc>
THRUST_HOST_DEVICE typename allocator_traits<Alloc>::pointer allocator_traits<Alloc>::allocate(
...
template <typename Alloc>
template <typename T>
THRUST_HOST_DEVICE void allocator_traits<Alloc>::construct(allocator_type& a, T* p)
{
...
THRUST_HOST_DEVICE void allocator_traits<Alloc>::construct(allocator_type& a, T* p, const Arg1& arg1)
{
...
THRUST_HOST_DEVICE void allocator_traits<Alloc>::construct(allocator_type& a, T* p, Args&&... args)
{
...
template <typename Alloc>
template <typename T>
THRUST_HOST_DEVICE void allocator_traits<Alloc>::destroy(allocator_type& a, T* p) noexcept
{
  return allocator_traits_detail::destroy(a, p);
}

template <typename Alloc>
THRUST_HOST_DEVICE typename allocator_traits<Alloc>::size_type allocator_traits<Alloc>::max_size(const allocator_type& a)
{
  return allocator_traits_detail::max_size(a);
}

template <typename Alloc>
THRUST_HOST_DEVICE typename allocator_system<Alloc>::get_result_type allocator_system<Alloc>::get(Alloc& a)
{
