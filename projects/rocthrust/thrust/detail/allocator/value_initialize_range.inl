...
struct needs_default_construct_via_allocator
    : ::internal::disjunction<has_member_construct1<Allocator, T>, // if the Allocator does something interesting
                                                                   // or if T's default constructor does something
                                                                   // interesting
                              thrust::detail::not_<::internal::is_trivially_default_constructible<T>>>
{};
