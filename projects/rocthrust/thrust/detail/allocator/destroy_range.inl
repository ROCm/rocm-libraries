...
struct enable_if_destroy_range_case1
    : ::internal::enable_if<has_effectful_member_destroy<Allocator, typename pointer_element<Pointer>::type>::value>
{};
...
struct enable_if_destroy_range_case2
    : ::internal::enable_if<!has_effectful_member_destroy<Allocator, typename pointer_element<Pointer>::type>::value
                            && !::internal::is_trivially_destructible<typename pointer_element<Pointer>::type>::value>
{};
...
struct destroy_via_allocator
{
  ...
  THRUST_HOST_DEVICE destroy_via_allocator(Allocator& a) noexcept
      : a(a)
  {}

  template <typename T>
  inline THRUST_HOST_DEVICE void operator()(T& x) noexcept
  {
...
THRUST_HOST_DEVICE typename enable_if_destroy_range_case1<Allocator, Pointer>::type
...
template <typename Allocator, typename Pointer, typename Size>
THRUST_HOST_DEVICE typename enable_if_destroy_range_case2<Allocator, Pointer>::type
destroy_range(Allocator& a, Pointer p, Size n) noexcept
{
...
template <typename Allocator, typename Pointer, typename Size>
THRUST_HOST_DEVICE typename enable_if_destroy_range_case3<Allocator, Pointer>::type
...
template <typename Allocator, typename Pointer, typename Size>
THRUST_HOST_DEVICE void destroy_range(Allocator& a, Pointer p, Size n) noexcept
{
