...
struct construct2_via_allocator
{
  ...
  THRUST_HOST_DEVICE construct2_via_allocator(Allocator& a, const Arg1& arg)
      : a(a)
      , arg(arg)
  {}
...
THRUST_HOST_DEVICE void fill_construct_range(Alloc& a, Pointer p, Size n, const T& value)
{
