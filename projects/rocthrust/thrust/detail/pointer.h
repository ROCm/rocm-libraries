...
struct pointer_base
{
  ...
  using derived_type =
    typename thrust::detail::eval_if<_THRUST_STD::is_same<Derived, use_default>::value,
                                     ::internal::type_identity<pointer<Element, Tag, Reference, Derived>>,
                                     ::internal::type_identity<Derived>>::type;
  ...
  using reference_type = typename thrust::detail::eval_if<
    ...
    thrust::detail::eval_if<_THRUST_STD::is_same<Reference, use_default>::value,
                            ::internal::type_identity<reference<Element, derived_type>>,
                            ::internal::type_identity<Reference>>>::type;
