...
THRUST_HOST_DEVICE pointer<Element, Tag, Reference, Derived>::pointer()
    : super_t(static_cast<Element*>(nullptr))
{} // end pointer::pointer

template <typename Element, typename Tag, typename Reference, typename Derived>
THRUST_HOST_DEVICE pointer<Element, Tag, Reference, Derived>::pointer(std::nullptr_t)
    : super_t(static_cast<Element*>(nullptr))
{} // end pointer::pointer

template <typename Element, typename Tag, typename Reference, typename Derived>
template <typename OtherElement>
THRUST_HOST_DEVICE pointer<Element, Tag, Reference, Derived>::pointer(OtherElement* other)
    : super_t(other)
{} // end pointer::pointer
...
THRUST_HOST_DEVICE pointer<Element, Tag, Reference, Derived>::pointer(
  ...
  typename thrust::detail::enable_if_pointer_is_convertible<OtherPointer,
                                                            pointer<Element, Tag, Reference, Derived>>::type*)
...
THRUST_HOST_DEVICE pointer<Element, Tag, Reference, Derived>::pointer(
  ...
  typename thrust::detail::
    enable_if_void_pointer_is_system_convertible<OtherPointer, pointer<Element, Tag, Reference, Derived>>::type*)
    : super_t(static_cast<Element*>(thrust::detail::pointer_traits<OtherPointer>::get(other)))
{} // end pointer::pointer

template <typename Element, typename Tag, typename Reference, typename Derived>
THRUST_HOST_DEVICE typename pointer<Element, Tag, Reference, Derived>::derived_type&
pointer<Element, Tag, Reference, Derived>::operator=(decltype(nullptr))
{
...
template <typename Element, typename Tag, typename Reference, typename Derived>
template <typename OtherPointer>
THRUST_HOST_DEVICE typename thrust::detail::enable_if_pointer_is_convertible<
  OtherPointer,
  pointer<Element, Tag, Reference, Derived>,
  typename pointer<Element, Tag, Reference, Derived>::derived_type&>::type
...
template <typename Element, typename Tag, typename Reference, typename Derived>
THRUST_HOST_DEVICE typename pointer<Element, Tag, Reference, Derived>::super_t::reference
pointer<Element, Tag, Reference, Derived>::dereference() const
{
  ...
  using IsCppRef = typename _THRUST_STD::is_reference<RefT>::type;
...
template <typename Element, typename Tag, typename Reference, typename Derived>
THRUST_HOST_DEVICE Element* pointer<Element, Tag, Reference, Derived>::get() const
{
  return super_t::base();
} // end pointer::get

template <typename Element, typename Tag, typename Reference, typename Derived>
THRUST_HOST_DEVICE Element* pointer<Element, Tag, Reference, Derived>::operator->() const
{
  return super_t::base();
} // end pointer::operator->

template <typename Element, typename Tag, typename Reference, typename Derived>
THRUST_HOST_DEVICE pointer<Element, Tag, Reference, Derived>::operator bool() const
{
  return bool(get());
...
// `std::unique_ptr`.
template <typename Element, typename Tag, typename Reference, typename Derived>
THRUST_HOST_DEVICE bool operator==(std::nullptr_t, pointer<Element, Tag, Reference, Derived> p)
{
  return nullptr == p.get();
}

template <typename Element, typename Tag, typename Reference, typename Derived>
THRUST_HOST_DEVICE bool operator==(pointer<Element, Tag, Reference, Derived> p, std::nullptr_t)
{
  return nullptr == p.get();
}
