 ...
 *
 *  _THRUST_LIBCXX::maximum<int> binary_op;
 *
 ...
 *  \code
 *  int data[10] = {-5, 0, 2, -3, 2, 4, 0, -1, 2, 8};
 *  thrust::inclusive_scan(thrust::host, data, data + 10, data, 1, _THRUST_LIBCXX::maximum<>{}); // in-place scan
 ...
 *  int data[10] = {-5, 0, 2, -3, 2, 4, 0, -1, 2, 8};
 *  _THRUST_LIBCXX::maximum<int> binary_op;
 *  thrust::inclusive_scan(data, data + 10, data, 1, _THRUST_LIBCXX::maximum<>{}); // in-place scan
 *  // data is now {1, 1, 2, 2, 2, 4, 4, 4, 4, 8}
 *  \endcode
 *
 *  \see https://en.cppreference.com/w/cpp/algorithm/partial_sum
