...
struct enable_if_bool_sort
    : ::internal::enable_if<::internal::is_same<bool, typename thrust::iterator_value<Iterator>::type>::value>
{};

template <typename Iterator>
struct disable_if_bool_sort
    : thrust::detail::disable_if<::internal::is_same<bool, typename thrust::iterator_value<Iterator>::type>::value>
{};
