...
inline constexpr bool
  select_system_exists_impl<_THRUST_STD::void_t<decltype(select_system(_THRUST_STD::declval<Tags&>()...))>, Tags...> =
    true;

template <typename... Tags>
inline constexpr bool select_system_exists = select_system_exists_impl<void, Tags...>;

template <typename System, _THRUST_STD::enable_if_t<!select_system_exists<System>, int> = 0>
THRUST_HOST_DEVICE auto select_system(thrust::execution_policy<System>& system) -> System&
{
...
select_system(thrust::execution_policy<System1>& system1,
              thrust::execution_policy<System2>& system2) -> thrust::detail::minimum_system_t<System1, System2>&
{
  using min_sys = thrust::detail::minimum_system_t<System1, System2>;
  if constexpr (_THRUST_STD::is_same_v<System1, System2> || _THRUST_STD::is_same_v<System1, min_sys>)
  {
...
template <typename System1,
          typename System2,
          typename... Systems,
          _THRUST_STD::enable_if_t<!select_system_exists<System1, System2, Systems...>, int> = 0>
THRUST_HOST_DEVICE auto select_system(
