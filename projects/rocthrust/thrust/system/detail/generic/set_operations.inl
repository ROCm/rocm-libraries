  ...
  OutputIterator result)
{
  ...
  return thrust::set_difference(exec, first1, last1, first2, last2, result, _THRUST_STD::less<value_type>());
} // end set_difference()
...
{
  using value_type = thrust::detail::it_value_t<InputIterator1>;
  return thrust::set_intersection(exec, first1, last1, first2, last2, result, _THRUST_STD::less<value_type>());
...
{
  using value_type = thrust::detail::it_value_t<InputIterator1>;
  return thrust::set_symmetric_difference(exec, first1, last1, first2, last2, result, _THRUST_STD::less<value_type>());
...
{
  using value_type = thrust::detail::it_value_t<InputIterator1>;
  return thrust::set_union(exec, first1, last1, first2, last2, result, _THRUST_STD::less<value_type>());
} // end set_union()
