...
THRUST_HOST_DEVICE ForwardIterator uninitialized_copy(
  ...
  thrust::detail::false_type) // ::internal::is_trivially_copy_constructible
{
...
THRUST_HOST_DEVICE ForwardIterator uninitialized_copy(
  ...
  InputIterator last,
  ForwardIterator result,
  thrust::detail::true_type) // ::internal::is_trivially_copy_constructible
{
  ...
  thrust::execution_policy<ExecutionPolicy>& exec, InputIterator first, InputIterator last, ForwardIterator result)
{
  ...
  using ResultTypeHasTrivialCopyConstructor = typename ::internal::is_trivially_copy_constructible<ResultType>::type;
