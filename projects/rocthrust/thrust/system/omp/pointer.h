 ...
 *
 *  The raw pointer encapsulated by a \p omp::pointer may be obtained by either its
 ...
 */
template <typename T>
using universal_pointer = thrust::pointer<T, thrust::system::omp::tag, _THRUST_STD::add_lvalue_reference_t<T>>;
