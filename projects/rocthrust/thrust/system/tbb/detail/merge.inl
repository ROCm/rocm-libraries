...
struct range
{
  ...
  {
    return static_cast<size_t>(_THRUST_STD::distance(first1, last1) + _THRUST_STD::distance(first2, last2))
         > grain_size;
  }
};
...
struct range
{
  ...
  bool is_divisible() const
  {
    return static_cast<size_t>(
             _THRUST_STD::distance(keys_first1, keys_last1) + _THRUST_STD::distance(keys_first2, keys_last2))
         > grain_size;
  }
};
  ...
  StrictWeakOrdering comp)
{
  ...
  _THRUST_STD::advance(
    keys_result, _THRUST_STD::distance(keys_first1, keys_last1) + _THRUST_STD::distance(keys_first2, keys_last2));
  _THRUST_STD::advance(
    values_result, _THRUST_STD::distance(keys_first1, keys_last1) + _THRUST_STD::distance(keys_first2, keys_last2));
