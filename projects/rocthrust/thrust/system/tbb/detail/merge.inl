...
struct range
{
      ...
      , grain_size(r.grain_size)
  {
    ...
    size_t n1 = _THRUST_STD::distance(first1, last1);
    size_t n2 = _THRUST_STD::distance(first2, last2);
    ...
    first1 = mid1;
    first2 = mid2;
    result += _THRUST_STD::distance(r.first1, mid1) + _THRUST_STD::distance(r.first2, mid2);
  }
  ...
  {
    return static_cast<size_t>(_THRUST_STD::distance(first1, last1) + _THRUST_STD::distance(first2, last2)) > grain_size;
  }
};
...
struct range
{
  ...
  range(InputIterator1 keys_first1,
        ...
        StrictWeakOrdering comp,
        size_t grain_size = 1024)
      : keys_first1(keys_first1)
      , keys_last1(keys_last1)
      , keys_first2(keys_first2)
      , keys_last2(keys_last2)
  ...
  range(range& r, ::tbb::split)
      : keys_first1(r.keys_first1)
      , keys_last1(r.keys_last1)
      , keys_first2(r.keys_first2)
      , keys_last2(r.keys_last2)
      , values_first1(r.values_first1)
      , values_first2(r.values_first2)
      , keys_result(r.keys_result)
      , values_result(r.values_result)
      , comp(r.comp)
      , grain_size(r.grain_size)
  {
    // we can assume n1 and n2 are not both 0
    size_t n1 = _THRUST_STD::distance(keys_first1, keys_last1);
    size_t n2 = _THRUST_STD::distance(keys_first2, keys_last2);
    ...
    keys_first1 = mid1;
    keys_first2 = mid2;
    values_first1 += _THRUST_STD::distance(r.keys_first1, mid1);
    values_first2 += _THRUST_STD::distance(r.keys_first2, mid2);
    keys_result += _THRUST_STD::distance(r.keys_first1, mid1) + _THRUST_STD::distance(r.keys_first2, mid2);
    values_result += _THRUST_STD::distance(r.keys_first1, mid1) + _THRUST_STD::distance(r.keys_first2, mid2);
  }
  ...
  bool is_divisible() const
  {
    return static_cast<size_t>(_THRUST_STD::distance(keys_first1, keys_last1) + _THRUST_STD::distance(keys_first2, keys_last2))
         > grain_size;
  }
};
...
template <typename DerivedPolicy,
          ...
          typename StrictWeakOrdering>
OutputIterator
merge(execution_policy<DerivedPolicy>&,
      ...
      StrictWeakOrdering comp)
{
  ...
  _THRUST_STD::advance(result, _THRUST_STD::distance(first1, last1) + _THRUST_STD::distance(first2, last2));
  ...
  StrictWeakOrdering comp)
{
  ...
  _THRUST_STD::advance(keys_result, _THRUST_STD::distance(keys_first1, keys_last1) + _THRUST_STD::distance(keys_first2, keys_last2));
  _THRUST_STD::advance(values_result, _THRUST_STD::distance(keys_first1, keys_last1) + _THRUST_STD::distance(keys_first2, keys_last2));
