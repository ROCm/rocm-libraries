 ...
 *
 *  thrust::all_of(thrust::host, A, A + 2, _THRUST_STD::identity{}); // returns true
 *  thrust::all_of(thrust::host, A, A + 3, _THRUST_STD::identity{}); // returns false
 *
 *  // empty range
 *  thrust::all_of(thrust::host, A, A, _THRUST_STD::identity{}); // returns true
 *
 *  \endcode
 *
 *  \see any_of
 ...
 *  bool A[3] = {true, true, false};
 *
 *  thrust::all_of(A, A + 2, _THRUST_STD::identity{}); // returns true
 *  thrust::all_of(A, A + 3, _THRUST_STD::identity{}); // returns false
 *
 *  // empty range
 *  thrust::all_of(A, A, _THRUST_STD::identity{}); // returns true
 *
 *  \endcode
 *
 *  \see any_of
 ...
 *  bool A[3] = {true, true, false};
 *
 *  thrust::any_of(thrust::host, A, A + 2, _THRUST_STD::identity{}); // returns true
 *  thrust::any_of(thrust::host, A, A + 3, _THRUST_STD::identity{}); // returns true
 *
 *  thrust::any_of(thrust::host, A + 2, A + 3, _THRUST_STD::identity{}); // returns false
 *
 *  // empty range
 *  thrust::any_of(thrust::host, A, A, _THRUST_STD::identity{}); // returns false
 *  \endcode
 *
 *  \see all_of
 *  \see none_of
 ...
 *  bool A[3] = {true, true, false};
 *
 *  thrust::any_of(A, A + 2, _THRUST_STD::identity{}); // returns true
 *  thrust::any_of(A, A + 3, _THRUST_STD::identity{}); // returns true
 *
 *  thrust::any_of(A + 2, A + 3, _THRUST_STD::identity{}); // returns false
 *
 *  // empty range
 *  thrust::any_of(A, A, _THRUST_STD::identity{}); // returns false
 *  \endcode
 *
 *  \see all_of
 *  \see none_of
 ...
 *  bool A[3] = {true, true, false};
 *
 *  thrust::none_of(thrust::host, A, A + 2, _THRUST_STD::identity{}); // returns false
 *  thrust::none_of(thrust::host, A, A + 3, _THRUST_STD::identity{}); // returns false
 *
 *  thrust::none_of(thrust::host, A + 2, A + 3, _THRUST_STD::identity{}); // returns true
 *
 *  // empty range
 *  thrust::none_of(thrust::host, A, A, _THRUST_STD::identity{}); // returns true
 *  \endcode
 *
 *  \see all_of
 *  \see any_of
 ...
 *  bool A[3] = {true, true, false};
 *
 *  thrust::none_of(A, A + 2, _THRUST_STD::identity{}); // returns false
 *  thrust::none_of(A, A + 3, _THRUST_STD::identity{}); // returns false
 *
 *  thrust::none_of(A + 2, A + 3, _THRUST_STD::identity{}); // returns true
 *
 *  // empty range
 *  thrust::none_of(A, A, _THRUST_STD::identity{}); // returns true
 *  \endcode
 *
 *  \see all_of
 *  \see any_of
