...
struct is_retaggable
    : integral_constant<bool,
                        (::internal::is_convertible<FromTag, ToTag>::value
                         || ::internal::is_convertible<ToTag, FromTag>::value)>
{};

template <typename FromTag, typename ToTag, typename Result>
struct enable_if_retaggable : ::internal::enable_if<is_retaggable<FromTag, ToTag>::value, Result>
{}; // end enable_if_retaggable

} // namespace detail

template <typename Tag, typename Iterator>
THRUST_HOST_DEVICE thrust::detail::tagged_iterator<Iterator, Tag> reinterpret_tag(Iterator iter)
{
...
THRUST_HOST_DEVICE thrust::pointer<T, Tag> reinterpret_tag(T* ptr)
{
...
THRUST_HOST_DEVICE thrust::pointer<T, Tag> reinterpret_tag(thrust::pointer<T, OtherTag, Reference, Derived> ptr)
{
...
THRUST_HOST_DEVICE thrust::detail::tagged_iterator<BaseIterator, Tag>
...
// specialization for raw pointer
template <typename Tag, typename T>
THRUST_HOST_DEVICE typename thrust::detail::
...
THRUST_HOST_DEVICE typename thrust::detail::enable_if_retaggable<OtherTag, Tag, thrust::pointer<T, Tag>>::type
