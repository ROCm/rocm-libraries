...
struct iterator_category_to_system
    ...
    : eval_if<
        ::internal::disjunction<::internal::is_convertible<Category, thrust::input_host_iterator_tag>,
                                ::internal::is_convertible<Category, thrust::output_host_iterator_tag>>::value,

        detail::identity_<thrust::host_system_tag>,

        // convertible to device iterator?
        eval_if<::internal::disjunction<::internal::is_convertible<Category, thrust::input_device_iterator_tag>,
                                        ::internal::is_convertible<Category, thrust::output_device_iterator_tag>>::value,
