...
template <typename Iterator>
struct iterator_system_impl<Iterator, ::internal::void_t<typename iterator_traits<Iterator>::iterator_category>>
...
template <typename T>
struct is_iterator_traversal : ::internal::is_convertible<T, incrementable_traversal_tag>
{}; // end is_iterator_traversal

template <typename T>
struct is_iterator_system
    : ::internal::disjunction<::internal::is_convertible<T, any_system_tag>,
                              ::internal::disjunction<::internal::is_convertible<T, host_system_tag>,
                                                      ::internal::is_convertible<T, device_system_tag>>>
