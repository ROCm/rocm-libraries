...
struct make_zip_iterator_base<_THRUST_STD::tuple<Its...>>
{
  ...
  using traversal_category = minimum_type_t<iterator_traversal_t<Its>...>;
...
template <class... Iterators>
THRUST_HOST_DEVICE zip_iterator(Iterators...) -> zip_iterator<thrust::tuple<Iterators...>>;
...
#else
  return zip_iterator<thrust::tuple<Iterators...>>{its...};
#endif
}
