...
struct make_counting_iterator_base
{
  using system = typename eval_if<_THRUST_STD::is_same<System, use_default>::value,
                                  _THRUST_STD::type_identity<any_system_tag>,
                                  _THRUST_STD::type_identity<System>>::type;
...
public:
  ...
  THRUST_HOST_DEVICE explicit counting_iterator(Incrementable x)
      : super_t(x)
  {}

  THRUST_HOST_DEVICE explicit counting_iterator(Incrementable x, StrideHolder stride)
      : super_t(x)
      , StrideHolder(stride)
  {}
...
private:
  ...
  THRUST_HOST_DEVICE auto stride() const
  {
  ...
  {
    if constexpr (_THRUST_STD::is_same_v<StrideHolder, detail::unit_stride>)
    {
  ...
  THRUST_HOST_DEVICE difference_type distance_to(
...
template <typename Incrementable>
inline THRUST_HOST_DEVICE counting_iterator<Incrementable> make_counting_iterator(Incrementable x)
{
...
THRUST_HOST_DEVICE auto make_counting_iterator(Incrementable x, Stride stride)
{
...
THRUST_HOST_DEVICE auto make_counting_iterator(Incrementable x)
{
