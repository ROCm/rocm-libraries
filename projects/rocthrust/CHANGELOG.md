...
* Deprecated `thrust::constant_iterator`, `thrust::strided_iterator` and `thrust::tabulate_output_iterator`. Use `hip::constant_iterator`, `hip::strided_iterator` and `hip::tabulate_output_iterator` instead.
