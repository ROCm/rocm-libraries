...
* Added `enum_devices.cpp` to the test directory and used in CMake to automatically generate the resource spec file for CTest.
...
* Removed the `GenerateResourceSpec.cmake` script - it is replaced by the `enum_devices.cpp` code above.
