...
class test_derived_class : test_class<int, double>
{
   ...
   *  and test Doxybook rendering.
   */
  THRUST_HOST_DEVICE constexpr double test_derived_member_function(int, int);
};
