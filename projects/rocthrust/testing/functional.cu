...
THRUST_DISABLE_BROKEN_GCC_VECTORIZER void TestMaximumFunctional()
{
  ...
  thrust::transform(input1.begin(), input1.end(), input2.begin(), output.begin(), ::internal::maximum<T>());
...
THRUST_DISABLE_BROKEN_GCC_VECTORIZER void TestMinimumFunctional()
{
  ...
  thrust::transform(input1.begin(), input1.end(), input2.begin(), output.begin(), ::internal::minimum<T>());
...
THRUST_DISABLE_BROKEN_GCC_VECTORIZER void TestNot1()
{
  ...
  thrust::transform(input.begin(), input.end(), output.begin(), ::internal::not_fn(::internal::identity{}));
...
THRUST_DISABLE_BROKEN_GCC_VECTORIZER void TestNot2()
{
  ...
  thrust::transform(
    input1.begin(), input1.end(), input2.begin(), output.begin(), ::internal::not_fn(_THRUST_STD::equal_to<T>()));
