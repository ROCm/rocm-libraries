...
void TestSetIntersectionDescendingSimple()
{
  ...
  Iterator end = thrust::set_intersection(a.begin(), a.end(), b.begin(), b.end(), result.begin(), _THRUST_STD::greater<T>());
...
void TestSetIntersectionDescending(const size_t n)
{
  ...
  h_end =
    thrust::set_intersection(h_a.begin(), h_a.end(), h_b.begin(), h_b.end(), h_result.begin(), _THRUST_STD::greater<T>());
  h_result.resize(h_end - h_result.begin());

  d_end =
    thrust::set_intersection(d_a.begin(), d_a.end(), d_b.begin(), d_b.end(), d_result.begin(), _THRUST_STD::greater<T>());
