...
void TestMergeSortKeySimple(void)
{
    ...
    thrust::system::cuda_bulk::detail::detail::stable_merge_sort(cuda_tag, unsorted_keys.begin(), unsorted_keys.end(), _THRUST_STD::less<T>());
...
void TestMergeSortKeyValueSimple(void)
{
    ...
    thrust::cuda_bulk::tag cuda_tag;
    thrust::system::cuda_bulk::detail::detail::stable_merge_sort_by_key(cuda_tag, unsorted_keys.begin(), unsorted_keys.end(), unsorted_values.begin(), _THRUST_STD::less<T>());
...
void TestMergeSortAscendingKeyValue([[maybe_unused]] const size_t n)
{
    ...
    thrust::cuda_bulk::tag cuda_tag;
    thrust::system::cuda_bulk::detail::detail::stable_merge_sort_by_key(cuda_tag, d_keys.begin(), d_keys.end(), d_values.begin(), _THRUST_STD::less<T>());
...
void TestMergeSortKeyValue([[maybe_unused]] size_t n)
{
  ...
  thrust::cuda_bulk::tag cuda_tag;
  thrust::system::cuda_bulk::detail::detail::stable_merge_sort(cuda_tag, d_data.begin(), d_data.end(), _THRUST_STD::less<T>());
