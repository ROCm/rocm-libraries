...
struct TestZipIteratorTraversal
{
  void operator()(void)
  {
    ...
    // ASSERT_EQUAL(true, (::std::is_convertible<zip_iterator_traversal_type1,
    ...
    // ASSERT_EQUAL(true, (::std::is_convertible<zip_iterator_traversal_type2,
...
struct TestZipIteratorSystem
{
  void operator()(void)
  {
    ...
    // ASSERT_EQUAL(true, (::std::is_same<zip_iterator_system_type1, experimental::space::host>::value) );
    ...
    // ASSERT_EQUAL(true, (::std::is_convertible<zip_iterator_system_type2, experimental::space::device>::value)
    // );
    ...
    // ASSERT_EQUAL(true, (::std::is_convertible<zip_iterator_system_type3,
    ...
    // ASSERT_EQUAL(true, (::std::is_convertible<zip_iterator_system_type4, thrust::host_system_tag>::value) );
    ...
    // ASSERT_EQUAL(true, (::std::is_convertible<zip_iterator_system_type5, thrust::host_system_tag>::value) );
    ...
    // ASSERT_EQUAL(true, (::std::is_convertible<zip_iterator_system_type6, thrust::device_system_tag>::value) );
    ...
    // ASSERT_EQUAL(true, (::std::is_convertible<zip_iterator_system_type7, thrust::device_system_tag>::value) );
  } // end operator()()
};
...
struct SumTwoTuple
{
  ...
  THRUST_HOST_DEVICE typename ::std::remove_reference<typename thrust::tuple_element<0, Tuple>::type>::type
