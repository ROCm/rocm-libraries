.. meta::
  :description: rocThrust installation
  :keywords: install, rocThrust, AMD, ROCm, installation, prerequisites, dependencies, requirements
...
rocThrust is included with the ROCm Core SDK on Linux and Windows. For the most
...
nightly builds for the ROCm Core SDK and its components, including rocThrust.
