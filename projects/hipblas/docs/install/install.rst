.. meta::
   :description: Installation instructions for hipBLAS
   :keywords: lib, hipblas, blas, algorithm, install, sdk, rocm
...
hipBLAS is included with the ROCm Core SDK on Linux and Windows. For the most
...
Alternatively, if you want to install hipBLAS as part of the ROCm
...
This includes hipBLAS, other BLAS libraries, and runtime components.
...
2. Install the ROCm BLAS package that matches your desired ROCm version,
   ...
   .. code-block:: shell-session
      ...
      amdrocm-blas<rocm_version>-<dev/devel>-<llvm_target>
...
nightly builds for the ROCm Core SDK and its components, including hipBLAS. See
