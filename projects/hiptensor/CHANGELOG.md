...
### Known issues 
* Unary operations in contraction are not currently supported with HIPTENSOR_ALGO_ACTOR_CRITIC plan for problems with a both F16 datatypes and compute types, or both BF16 datatypes and compute types.

### Upcoming changes
* Trinary contraction support.
