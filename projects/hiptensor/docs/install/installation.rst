...
.. selected:: i=pkgman
   ...
   .. selected:: fam=all
      ...
      2. Use the following command to install hipTensor for all GPU architectures:
   ...
   .. selected:: gfx=gfx950
      ...
      2. Use the following command to install hipTensor for your ``gfx950`` GPU:
   ...
   .. selected:: gfx=gfx942
      ...
      2. Use the following command to install hipTensor for your ``gfx942`` GPU:
   ...
   .. selected:: gfx=gfx90a
      ...
      2. Use the following command to install hipTensor for your ``gfx90a`` GPU:
   ...
   .. selected:: gfx=gfx908
      ...
      2. Use the following command to install hipTensor for your ``gfx908`` GPU:
   ...
   .. selected:: gfx=gfx1200
      ...
      2. Use the following command to install hipTensor for your ``gfx1200`` GPU:
   ...
   .. selected:: gfx=gfx1201
      ...
      2. Use the following command to install hipTensor for your ``gfx1201`` GPU:
   ...
   .. selected:: gfx=gfx1100
      ...
      2. Use the following command to install hipTensor for your ``gfx1100`` GPU:
   ...
   .. selected:: gfx=gfx1101
      ...
      2. Use the following command to install hipTensor for your ``gfx1101`` GPU:
   ...
   .. selected:: gfx=gfx1102
      ...
      2. Use the following command to install hipTensor for your ``gfx1102`` GPU:
   ...
   .. selected:: gfx=gfx1103
      ...
      2. Use the following command to install hipTensor for your ``gfx1103`` GPU:
   ...
   .. selected:: gfx=gfx1030
      ...
      2. Use the following command to install hipTensor for your ``gfx1030`` GPU:
   ...
   .. selected:: gfx=gfx1151
      ...
      2. Use the following command to install hipTensor for your ``gfx1151`` GPU:
   ...
   .. selected:: gfx=gfx1150
      ...
      2. Use the following command to install hipTensor for your ``gfx1150`` GPU:
   ...
   .. selected:: gfx=gfx1152
      ...
      2. Use the following command to install hipTensor for your ``gfx1152`` GPU:
   ...
   .. selected:: gfx=gfx1153
      ...
      2. Use the following command to install hipTensor for your ``gfx1153`` GPU:
