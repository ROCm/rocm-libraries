...
Additionally, hipTensor is supported on AMD RDNA GPUs:
 - gfx11-generic: gfx1100, gfx1101, gfx02, gfx1150, gfx1151, gfx1152 and gfx1153.
...
.. list-table::
    ...
    *   -   ``GPU_TARGETS``
        ...
        -   ``gfx908``; ``gfx90a``; ``gfx942``; ``gfx950``; ``gfx1100``; ``gfx1101``; ``gfx1102``; ``gfx1150``; ``gfx1151``; ``gfx1152``; ``gfx1153``; ``gfx11-generic``; ``gfx1200``; ``gfx1201``; ``gfx12-generic``
