...
**Performance testing** measures on every pull request and judges nothing.
...
**Suite size.** TensileLite's unit and characterization suites together are about six thousand tests,
running in four separate CI lanes; see
