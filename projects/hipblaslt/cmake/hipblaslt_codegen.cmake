...
function(create_device_library)
    ...
    set(_one
        ...
        KEEP_BUILD_TMP ASM_DEBUG DEBUG_WGM REQUIRE_GFX1250V0_OVERLAY)
    set(_multi ARCHES)
    ...
    if(NOT DEFINED _cdl_DEBUG_WGM)
        set(_cdl_DEBUG_WGM "${TENSILELITE_DEBUG_WGM}")
    endif()
    ...
    if(_cdl_DEBUG_WGM)
        list(APPEND _opts_list "--debug-wgm")
    endif()
    if(_cdl_YAML_FORMAT)
