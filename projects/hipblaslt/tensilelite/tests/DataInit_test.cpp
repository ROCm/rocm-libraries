...
using TensileLite::Client::isMXFP4Problem;
...
// =============================================================================
//   Section 2 - TensileLite::Client::isMXFP4Problem
//
//   Contract:
//       isMXFP4Problem(P)
