...
# (empirically v0 -> 0, v1 -> 1). detect_gpu_revision_target() (in
# Tensile/GpuRevisionTarget.py) lets tox generate/test v0 kernels on a v0 machine
# while defaulting to the shipping v1 everywhere else.
