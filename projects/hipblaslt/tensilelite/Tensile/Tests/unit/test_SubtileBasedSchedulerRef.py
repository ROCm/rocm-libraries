  ...
  Partition 0:
    ...
    subIterK=2:
      ...
      preMFMA path 0:
        [ 6] wait_lr    wait_lr
      path 0:
        [ 7] wait_gr    wait_gr(A=4,B=4,SA=1)
        [ 8] sync       sync
        [ 1] lr         LR A  (MT n, subIterK [3]) [0-3]
        [ 2] lr         LR B  (MT n, subIterK [3]) [0-3]
      path 1:
    ...
    subIterK=3:
      ...
      preMFMA path 0:
        [ 5] wait_lr    wait_lr
      path 0:
        [ 6] wait_gr    wait_gr(A=4,B=4,SA=1,SB=1)
        [ 7] sync       sync
        [ 8] lr_inc     lr_inc(A)
        [ 9] lr_inc     lr_inc(B)
        [10] lr_inc     lr_inc(SA)
