...
# down afterwards.  The thirteen gfx1151 w4a16 entries did not: they were generated
...
EXPECTED_CENSUS = {
    ...
    # 60, plus the thirteen gfx1151 w4a16 kernels: their solutions set StaggerU 0,
