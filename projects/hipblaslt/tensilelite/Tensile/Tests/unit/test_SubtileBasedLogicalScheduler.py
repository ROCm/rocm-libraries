...
def make_cfg_256x256_fp4(depthU=256, k_gran=1, partSizeM=0, partSizeN=0,
                         ...
                         miWaveGroup=None,
                         grSA_k_gran=1, grSA_mn_gran=1,
                         grSB_k_gran=1, grSB_mn_gran=1):
    """Build FP4 config with scale tensors. k_gran applies to LR A/B.
    grSA/SB_{k,mn}_gran are multipliers on the tile-info-derived GR values
    used by the multi-DU asymmetric-MIWT tests."""
