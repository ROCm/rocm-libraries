...
## D29 — `Contractions.py`: first arm of the deferred predicate/state matrix (isStreamK)
...
While adding `StreamKWorkgroupNumberCheck` for ROCM-31290, this branch
initially got exactly that rejected treatment: a synthetic
