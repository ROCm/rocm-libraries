...
.text
.protected Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB64_UserArgs_MT64x160x64_MI16x16x1_gfx1151
.globl Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB64_UserArgs_MT64x160x64_MI16x16x1_gfx1151
.p2align 8
.type Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB64_UserArgs_MT64x160x64_MI16x16x1_gfx1151,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB64_UserArgs_MT64x160x64_MI16x16x1_gfx1151
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB64_UserArgs_MT64x160x64_MI16x16x1_gfx1151
    .symbol: 'Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB64_UserArgs_MT64x160x64_MI16x16x1_gfx1151.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
s_mov_b32 s59, 0                                   // STATIC_DIV: divisor=160
s_mul_i32 s58, 819, s25                            // tmp1 = dividend * magic hi
s_lshl_b64 s[58:59], s[58:59], 16                  // left shift 16 bits
s_mul_i32 s61, s25, 13108                          // tmp0 = dividend * magic lo
s_add_u32 s58, s61, s58                            // add lo
s_addc_u32 s59, s59, 0                             // add hi
s_lshr_b64 s[58:59], s[58:59], 33                  // tmp0 = quotient
s_mul_i32 s59, s58, 160                            // tmp1 = quotient * divisor
s_cmp_lg_u32 s59, s25                              // if (quotient * divisor != dividend), result+=1
s_addc_u32 s61, s58, 0                             // if (quotient * divisor != dividend), result+=1
...
v_lshrrev_b32 v22, 6, v20                          // scaleA: kGroup = k/64
...
/* apply mask, calc new C and issue writes */
v_mov_b32 v116, 0xffff0000                         // mask for pack two bfloat16 element to 32bit
v_mov_b32 v117, 0x7fff0000                         // fp32 Nan
v_mov_b32 v118, 0x7fff                             // rounding bias for bfloat16
v_cmp_u_f32 s8, v[vgprValuC+121], v[vgprValuC+121] // check Nan
v_bfe_u32 v115, v[vgprValuC+121], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+121], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+121], v115, v117, s8
v_lshrrev_b32 v121, 16, v[vgprValuC+121]           // convert C to bf16
buffer_store_b16 v121, v119, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s8, v[vgprValuC+122], v[vgprValuC+122] // check Nan
v_bfe_u32 v115, v[vgprValuC+122], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+122], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+122], v115, v117, s8
v_lshrrev_b32 v122, 16, v[vgprValuC+122]           // convert C to bf16
buffer_store_b16 v122, v119, s[sgprSrdD:sgprSrdD+3], 0 offen offset:64 // store D
v_cmp_u_f32 s8, v[vgprValuC+123], v[vgprValuC+123] // check Nan
v_bfe_u32 v115, v[vgprValuC+123], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+123], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+123], v115, v117, s8
v_lshrrev_b32 v123, 16, v[vgprValuC+123]           // convert C to bf16
...
v_cmp_u_f32 s8, v[vgprValuC+124], v[vgprValuC+124] // check Nan
v_bfe_u32 v115, v[vgprValuC+124], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+124], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+124], v115, v117, s8
...
v_cmp_u_f32 s8, v[vgprValuC+125], v[vgprValuC+125] // check Nan
v_bfe_u32 v115, v[vgprValuC+125], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+125], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+125], v115, v117, s8
v_lshrrev_b32 v125, 16, v[vgprValuC+125]           // convert C to bf16
s_mul_i32 s8, s[sgprStrideD1J], 4                  // scale StrideD *= numRows(2) * bpe
s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s8         // incToNextRow(2): gra SRD += inc(lower)
s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow(2): gra SRD += inc(upper)
buffer_store_b16 v125, v119, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s8, v[vgprValuC+126], v[vgprValuC+126] // check Nan
v_bfe_u32 v115, v[vgprValuC+126], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+126], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+126], v115, v117, s8
...
v_cmp_u_f32 s8, v[vgprValuC+127], v[vgprValuC+127] // check Nan
v_bfe_u32 v115, v[vgprValuC+127], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+127], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+127], v115, v117, s8
...
v_cmp_u_f32 s8, v[vgprValuC+128], v[vgprValuC+128] // check Nan
v_bfe_u32 v115, v[vgprValuC+128], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+128], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+128], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+129], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+129], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+129], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+130], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+130], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+130], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+131], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+131], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+131], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+132], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+132], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+132], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+133], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+133], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+133], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+134], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+134], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+134], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+135], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+135], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+135], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+136], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+136], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+136], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+137], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+137], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+137], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+138], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+138], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+138], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+139], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+139], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+139], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+140], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+140], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+140], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+141], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+141], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+141], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+142], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+142], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+142], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+143], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+143], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+143], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+144], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+144], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+144], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+145], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+145], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+145], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+146], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+146], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+146], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+147], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+147], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+147], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+148], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+148], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+148], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+149], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+149], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+149], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+150], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+150], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+150], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+151], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+151], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+151], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+152], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+152], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+152], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+153], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+153], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+153], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+154], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+154], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+154], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+155], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+155], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+155], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+156], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+156], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+156], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+157], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+157], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+157], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+158], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+158], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+158], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+159], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+159], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+159], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+160], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+160], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+160], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+161], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+161], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+161], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+162], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+162], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+162], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+163], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+163], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+163], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+164], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+164], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+164], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+165], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+165], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+165], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+166], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+166], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+166], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+167], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+167], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+167], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+168], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+168], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+168], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+169], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+169], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+169], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+170], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+170], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+170], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+171], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+171], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+171], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+172], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+172], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+172], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+173], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+173], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+173], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+174], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+174], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+174], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+175], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+175], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+175], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+176], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+176], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+176], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+177], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+177], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+177], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+178], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+178], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+178], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+179], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+179], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+179], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+180], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+180], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+180], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+181], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+181], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+181], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+182], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+182], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+182], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+183], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+183], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+183], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+184], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+184], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+184], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+185], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+185], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+185], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+186], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+186], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+186], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+187], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+187], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+187], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+188], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+188], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+188], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+189], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+189], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+189], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+190], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+190], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+190], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+191], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+191], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+191], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+192], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+192], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+192], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+193], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+193], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+193], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+194], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+194], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+194], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+195], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+195], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+195], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+196], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+196], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+196], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+197], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+197], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+197], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+198], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+198], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+198], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+199], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+199], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+199], v115, v117, s8
...
v_bfe_u32 v115, v[vgprValuC+200], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+200], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+200], v115, v117, s8
...
v_mov_b32 v117, 0x7fff0000                         // fp32 Nan
v_mov_b32 v118, 0x7fff                             // rounding bias for bfloat16
v_cmp_u_f32 s28, v[vgprValuC+119], v[vgprValuC+119] // check Nan
v_bfe_u32 v115, v[vgprValuC+119], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+119], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+119], v115, v117, s28
...
v_cmp_u_f32 s28, v[vgprValuC+120], v[vgprValuC+120] // check Nan
v_bfe_u32 v115, v[vgprValuC+120], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+120], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+120], v115, v117, s28
v_lshrrev_b32 v120, 16, v[vgprValuC+120]           // convert C to bf16
buffer_store_b16 v120, v186, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+121], v[vgprValuC+121] // check Nan
v_bfe_u32 v115, v[vgprValuC+121], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+121], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+121], v115, v117, s28
v_lshrrev_b32 v121, 16, v[vgprValuC+121]           // convert C to bf16
buffer_store_b16 v121, v187, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+122], v[vgprValuC+122] // check Nan
v_bfe_u32 v115, v[vgprValuC+122], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+122], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+122], v115, v117, s28
v_lshrrev_b32 v122, 16, v[vgprValuC+122]           // convert C to bf16
buffer_store_b16 v122, v188, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+123], v[vgprValuC+123] // check Nan
v_bfe_u32 v115, v[vgprValuC+123], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+123], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+123], v115, v117, s28
v_lshrrev_b32 v123, 16, v[vgprValuC+123]           // convert C to bf16
buffer_store_b16 v123, v189, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+124], v[vgprValuC+124] // check Nan
v_bfe_u32 v115, v[vgprValuC+124], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+124], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+124], v115, v117, s28
v_lshrrev_b32 v124, 16, v[vgprValuC+124]           // convert C to bf16
buffer_store_b16 v124, v190, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+125], v[vgprValuC+125] // check Nan
v_bfe_u32 v115, v[vgprValuC+125], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+125], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+125], v115, v117, s28
v_lshrrev_b32 v125, 16, v[vgprValuC+125]           // convert C to bf16
buffer_store_b16 v125, v191, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+126], v[vgprValuC+126] // check Nan
v_bfe_u32 v115, v[vgprValuC+126], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+126], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+126], v115, v117, s28
v_lshrrev_b32 v126, 16, v[vgprValuC+126]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+127], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+127], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+127], v115, v117, s28
v_lshrrev_b32 v127, 16, v[vgprValuC+127]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+128], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+128], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+128], v115, v117, s28
v_lshrrev_b32 v128, 16, v[vgprValuC+128]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+129], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+129], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+129], v115, v117, s28
v_lshrrev_b32 v129, 16, v[vgprValuC+129]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+130], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+130], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+130], v115, v117, s28
v_lshrrev_b32 v130, 16, v[vgprValuC+130]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+131], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+131], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+131], v115, v117, s28
v_lshrrev_b32 v131, 16, v[vgprValuC+131]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+132], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+132], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+132], v115, v117, s28
v_lshrrev_b32 v132, 16, v[vgprValuC+132]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+133], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+133], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+133], v115, v117, s28
v_lshrrev_b32 v133, 16, v[vgprValuC+133]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+134], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+134], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+134], v115, v117, s28
v_lshrrev_b32 v134, 16, v[vgprValuC+134]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+135], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+135], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+135], v115, v117, s28
v_lshrrev_b32 v135, 16, v[vgprValuC+135]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+136], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+136], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+136], v115, v117, s28
v_lshrrev_b32 v136, 16, v[vgprValuC+136]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+137], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+137], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+137], v115, v117, s28
v_lshrrev_b32 v137, 16, v[vgprValuC+137]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+138], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+138], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+138], v115, v117, s28
v_lshrrev_b32 v138, 16, v[vgprValuC+138]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+139], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+139], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+139], v115, v117, s28
v_lshrrev_b32 v139, 16, v[vgprValuC+139]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+140], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+140], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+140], v115, v117, s28
v_lshrrev_b32 v140, 16, v[vgprValuC+140]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+141], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+141], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+141], v115, v117, s28
v_lshrrev_b32 v141, 16, v[vgprValuC+141]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+142], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+142], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+142], v115, v117, s28
v_lshrrev_b32 v142, 16, v[vgprValuC+142]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+143], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+143], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+143], v115, v117, s28
v_lshrrev_b32 v143, 16, v[vgprValuC+143]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+144], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+144], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+144], v115, v117, s28
v_lshrrev_b32 v144, 16, v[vgprValuC+144]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+145], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+145], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+145], v115, v117, s28
v_lshrrev_b32 v145, 16, v[vgprValuC+145]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+146], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+146], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+146], v115, v117, s28
v_lshrrev_b32 v146, 16, v[vgprValuC+146]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+147], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+147], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+147], v115, v117, s28
v_lshrrev_b32 v147, 16, v[vgprValuC+147]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+148], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+148], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+148], v115, v117, s28
v_lshrrev_b32 v148, 16, v[vgprValuC+148]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+149], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+149], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+149], v115, v117, s28
v_lshrrev_b32 v149, 16, v[vgprValuC+149]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+150], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+150], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+150], v115, v117, s28
v_lshrrev_b32 v150, 16, v[vgprValuC+150]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+151], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+151], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+151], v115, v117, s28
v_lshrrev_b32 v151, 16, v[vgprValuC+151]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+152], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+152], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+152], v115, v117, s28
v_lshrrev_b32 v152, 16, v[vgprValuC+152]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+153], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+153], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+153], v115, v117, s28
v_lshrrev_b32 v153, 16, v[vgprValuC+153]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+154], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+154], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+154], v115, v117, s28
v_lshrrev_b32 v154, 16, v[vgprValuC+154]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+155], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+155], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+155], v115, v117, s28
v_lshrrev_b32 v155, 16, v[vgprValuC+155]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+156], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+156], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+156], v115, v117, s28
v_lshrrev_b32 v156, 16, v[vgprValuC+156]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+157], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+157], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+157], v115, v117, s28
v_lshrrev_b32 v157, 16, v[vgprValuC+157]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+158], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+158], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+158], v115, v117, s28
v_lshrrev_b32 v158, 16, v[vgprValuC+158]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+159], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+159], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+159], v115, v117, s28
v_lshrrev_b32 v159, 16, v[vgprValuC+159]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+160], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+160], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+160], v115, v117, s28
v_lshrrev_b32 v160, 16, v[vgprValuC+160]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+161], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+161], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+161], v115, v117, s28
v_lshrrev_b32 v161, 16, v[vgprValuC+161]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+162], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+162], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+162], v115, v117, s28
v_lshrrev_b32 v162, 16, v[vgprValuC+162]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+163], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+163], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+163], v115, v117, s28
v_lshrrev_b32 v163, 16, v[vgprValuC+163]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+164], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+164], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+164], v115, v117, s28
v_lshrrev_b32 v164, 16, v[vgprValuC+164]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+165], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+165], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+165], v115, v117, s28
v_lshrrev_b32 v165, 16, v[vgprValuC+165]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+166], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+166], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+166], v115, v117, s28
v_lshrrev_b32 v166, 16, v[vgprValuC+166]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+167], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+167], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+167], v115, v117, s28
v_lshrrev_b32 v167, 16, v[vgprValuC+167]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+168], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+168], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+168], v115, v117, s28
v_lshrrev_b32 v168, 16, v[vgprValuC+168]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+169], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+169], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+169], v115, v117, s28
v_lshrrev_b32 v169, 16, v[vgprValuC+169]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+170], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+170], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+170], v115, v117, s28
v_lshrrev_b32 v170, 16, v[vgprValuC+170]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+171], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+171], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+171], v115, v117, s28
v_lshrrev_b32 v171, 16, v[vgprValuC+171]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+172], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+172], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+172], v115, v117, s28
v_lshrrev_b32 v172, 16, v[vgprValuC+172]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+173], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+173], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+173], v115, v117, s28
v_lshrrev_b32 v173, 16, v[vgprValuC+173]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+174], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+174], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+174], v115, v117, s28
v_lshrrev_b32 v174, 16, v[vgprValuC+174]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+175], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+175], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+175], v115, v117, s28
v_lshrrev_b32 v175, 16, v[vgprValuC+175]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+176], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+176], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+176], v115, v117, s28
v_lshrrev_b32 v176, 16, v[vgprValuC+176]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+177], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+177], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+177], v115, v117, s28
v_lshrrev_b32 v177, 16, v[vgprValuC+177]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+178], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+178], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+178], v115, v117, s28
v_lshrrev_b32 v178, 16, v[vgprValuC+178]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+179], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+179], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+179], v115, v117, s28
v_lshrrev_b32 v179, 16, v[vgprValuC+179]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+180], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+180], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+180], v115, v117, s28
v_lshrrev_b32 v180, 16, v[vgprValuC+180]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+181], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+181], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+181], v115, v117, s28
v_lshrrev_b32 v181, 16, v[vgprValuC+181]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+182], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+182], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+182], v115, v117, s28
v_lshrrev_b32 v182, 16, v[vgprValuC+182]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+183], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+183], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+183], v115, v117, s28
v_lshrrev_b32 v183, 16, v[vgprValuC+183]           // convert C to bf16
...
v_bfe_u32 v115, v[vgprValuC+184], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+184], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+184], v115, v117, s28
v_lshrrev_b32 v184, 16, v[vgprValuC+184]           // convert C to bf16
...
v_lshlrev_b32 v112, 16, v187                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+121], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+121], v[vgprValuC+121] // check Nan
v_bfe_u32 v115, v[vgprValuC+121], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+121], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+121], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v188                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+122], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+122], v[vgprValuC+122] // check Nan
v_bfe_u32 v115, v[vgprValuC+122], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+122], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+122], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v189                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+123], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+123], v[vgprValuC+123] // check Nan
v_bfe_u32 v115, v[vgprValuC+123], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+123], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+123], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v190                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+124], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+124], v[vgprValuC+124] // check Nan
v_bfe_u32 v115, v[vgprValuC+124], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+124], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+124], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v191                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+125], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+125], v[vgprValuC+125] // check Nan
v_bfe_u32 v115, v[vgprValuC+125], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+125], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+125], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v192                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+126], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+126], v[vgprValuC+126] // check Nan
v_bfe_u32 v115, v[vgprValuC+126], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+126], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+126], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v193                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+127], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+127], v[vgprValuC+127] // check Nan
v_bfe_u32 v115, v[vgprValuC+127], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+127], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+127], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v194                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+128], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+128], v[vgprValuC+128] // check Nan
v_bfe_u32 v115, v[vgprValuC+128], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+128], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+128], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v195                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+129], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+129], v[vgprValuC+129] // check Nan
v_bfe_u32 v115, v[vgprValuC+129], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+129], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+129], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v196                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+130], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+130], v[vgprValuC+130] // check Nan
v_bfe_u32 v115, v[vgprValuC+130], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+130], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+130], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v197                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+131], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+131], v[vgprValuC+131] // check Nan
v_bfe_u32 v115, v[vgprValuC+131], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+131], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+131], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v198                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+132], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+132], v[vgprValuC+132] // check Nan
v_bfe_u32 v115, v[vgprValuC+132], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+132], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+132], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v199                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+133], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+133], v[vgprValuC+133] // check Nan
v_bfe_u32 v115, v[vgprValuC+133], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+133], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+133], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v200                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+134], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+134], v[vgprValuC+134] // check Nan
v_bfe_u32 v115, v[vgprValuC+134], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+134], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+134], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v201                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+135], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+135], v[vgprValuC+135] // check Nan
v_bfe_u32 v115, v[vgprValuC+135], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+135], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+135], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v202                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+136], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+136], v[vgprValuC+136] // check Nan
v_bfe_u32 v115, v[vgprValuC+136], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+136], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+136], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v203                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+137], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+137], v[vgprValuC+137] // check Nan
v_bfe_u32 v115, v[vgprValuC+137], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+137], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+137], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v204                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+138], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+138], v[vgprValuC+138] // check Nan
v_bfe_u32 v115, v[vgprValuC+138], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+138], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+138], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v205                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+139], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+139], v[vgprValuC+139] // check Nan
v_bfe_u32 v115, v[vgprValuC+139], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+139], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+139], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v206                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+140], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+140], v[vgprValuC+140] // check Nan
v_bfe_u32 v115, v[vgprValuC+140], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+140], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+140], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v207                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+141], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+141], v[vgprValuC+141] // check Nan
v_bfe_u32 v115, v[vgprValuC+141], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+141], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+141], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v208                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+142], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+142], v[vgprValuC+142] // check Nan
v_bfe_u32 v115, v[vgprValuC+142], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+142], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+142], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v209                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+143], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+143], v[vgprValuC+143] // check Nan
v_bfe_u32 v115, v[vgprValuC+143], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+143], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+143], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v210                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+144], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+144], v[vgprValuC+144] // check Nan
v_bfe_u32 v115, v[vgprValuC+144], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+144], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+144], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v211                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+145], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+145], v[vgprValuC+145] // check Nan
v_bfe_u32 v115, v[vgprValuC+145], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+145], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+145], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v212                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+146], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+146], v[vgprValuC+146] // check Nan
v_bfe_u32 v115, v[vgprValuC+146], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+146], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+146], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v213                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+147], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+147], v[vgprValuC+147] // check Nan
v_bfe_u32 v115, v[vgprValuC+147], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+147], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+147], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v214                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+148], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+148], v[vgprValuC+148] // check Nan
v_bfe_u32 v115, v[vgprValuC+148], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+148], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+148], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v215                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+149], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+149], v[vgprValuC+149] // check Nan
v_bfe_u32 v115, v[vgprValuC+149], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+149], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+149], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v216                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+150], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+150], v[vgprValuC+150] // check Nan
v_bfe_u32 v115, v[vgprValuC+150], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+150], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+150], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v217                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+151], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+151], v[vgprValuC+151] // check Nan
v_bfe_u32 v115, v[vgprValuC+151], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+151], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+151], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v218                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+152], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+152], v[vgprValuC+152] // check Nan
v_bfe_u32 v115, v[vgprValuC+152], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+152], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+152], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v219                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+153], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+153], v[vgprValuC+153] // check Nan
v_bfe_u32 v115, v[vgprValuC+153], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+153], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+153], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v220                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+154], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+154], v[vgprValuC+154] // check Nan
v_bfe_u32 v115, v[vgprValuC+154], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+154], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+154], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v221                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+155], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+155], v[vgprValuC+155] // check Nan
v_bfe_u32 v115, v[vgprValuC+155], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+155], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+155], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v223                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+156], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+156], v[vgprValuC+156] // check Nan
v_bfe_u32 v115, v[vgprValuC+156], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+156], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+156], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v224                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+157], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+157], v[vgprValuC+157] // check Nan
v_bfe_u32 v115, v[vgprValuC+157], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+157], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+157], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v225                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+158], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+158], v[vgprValuC+158] // check Nan
v_bfe_u32 v115, v[vgprValuC+158], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+158], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+158], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v226                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+159], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+159], v[vgprValuC+159] // check Nan
v_bfe_u32 v115, v[vgprValuC+159], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+159], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+159], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v227                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+160], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+160], v[vgprValuC+160] // check Nan
v_bfe_u32 v115, v[vgprValuC+160], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+160], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+160], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v228                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+161], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+161], v[vgprValuC+161] // check Nan
v_bfe_u32 v115, v[vgprValuC+161], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+161], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+161], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v229                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+162], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+162], v[vgprValuC+162] // check Nan
v_bfe_u32 v115, v[vgprValuC+162], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+162], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+162], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v230                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+163], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+163], v[vgprValuC+163] // check Nan
v_bfe_u32 v115, v[vgprValuC+163], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+163], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+163], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v231                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+164], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+164], v[vgprValuC+164] // check Nan
v_bfe_u32 v115, v[vgprValuC+164], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+164], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+164], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v232                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+165], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+165], v[vgprValuC+165] // check Nan
v_bfe_u32 v115, v[vgprValuC+165], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+165], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+165], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v233                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+166], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+166], v[vgprValuC+166] // check Nan
v_bfe_u32 v115, v[vgprValuC+166], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+166], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+166], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v234                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+167], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+167], v[vgprValuC+167] // check Nan
v_bfe_u32 v115, v[vgprValuC+167], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+167], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+167], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v235                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+168], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+168], v[vgprValuC+168] // check Nan
v_bfe_u32 v115, v[vgprValuC+168], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+168], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+168], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v236                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+169], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+169], v[vgprValuC+169] // check Nan
v_bfe_u32 v115, v[vgprValuC+169], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+169], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+169], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v237                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+170], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+170], v[vgprValuC+170] // check Nan
v_bfe_u32 v115, v[vgprValuC+170], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+170], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+170], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v238                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+171], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+171], v[vgprValuC+171] // check Nan
v_bfe_u32 v115, v[vgprValuC+171], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+171], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+171], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v239                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+172], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+172], v[vgprValuC+172] // check Nan
v_bfe_u32 v115, v[vgprValuC+172], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+172], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+172], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v240                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+173], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+173], v[vgprValuC+173] // check Nan
v_bfe_u32 v115, v[vgprValuC+173], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+173], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+173], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v241                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+174], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+174], v[vgprValuC+174] // check Nan
v_bfe_u32 v115, v[vgprValuC+174], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+174], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+174], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v242                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+175], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+175], v[vgprValuC+175] // check Nan
v_bfe_u32 v115, v[vgprValuC+175], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+175], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+175], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v243                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+176], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+176], v[vgprValuC+176] // check Nan
v_bfe_u32 v115, v[vgprValuC+176], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+176], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+176], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v244                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+177], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+177], v[vgprValuC+177] // check Nan
v_bfe_u32 v115, v[vgprValuC+177], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+177], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+177], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v245                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+178], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+178], v[vgprValuC+178] // check Nan
v_bfe_u32 v115, v[vgprValuC+178], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+178], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+178], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v246                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+179], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+179], v[vgprValuC+179] // check Nan
v_bfe_u32 v115, v[vgprValuC+179], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+179], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+179], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v247                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+180], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+180], v[vgprValuC+180] // check Nan
v_bfe_u32 v115, v[vgprValuC+180], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+180], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+180], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v248                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+181], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+181], v[vgprValuC+181] // check Nan
v_bfe_u32 v115, v[vgprValuC+181], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+181], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+181], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v249                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+182], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+182], v[vgprValuC+182] // check Nan
v_bfe_u32 v115, v[vgprValuC+182], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+182], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+182], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v250                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+183], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+183], v[vgprValuC+183] // check Nan
v_bfe_u32 v115, v[vgprValuC+183], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+183], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+183], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v251                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+184], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+184], v[vgprValuC+184] // check Nan
v_bfe_u32 v115, v[vgprValuC+184], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+184], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+184], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v252                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+185], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+185], v[vgprValuC+185] // check Nan
v_bfe_u32 v115, v[vgprValuC+185], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+185], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+185], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v253                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+186], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+186], v[vgprValuC+186] // check Nan
v_bfe_u32 v115, v[vgprValuC+186], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+186], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+186], v115, v117, s8
...
v_lshlrev_b32 v112, 16, v135                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+121], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+121], v[vgprValuC+121] // check Nan
v_bfe_u32 v115, v[vgprValuC+121], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+121], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v136                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+122], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+122], v[vgprValuC+122] // check Nan
v_bfe_u32 v115, v[vgprValuC+122], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+122], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v137                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+123], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+123], v[vgprValuC+123] // check Nan
v_bfe_u32 v115, v[vgprValuC+123], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+123], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v138                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+124], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+124], v[vgprValuC+124] // check Nan
v_bfe_u32 v115, v[vgprValuC+124], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+124], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v139                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+125], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+125], v[vgprValuC+125] // check Nan
v_bfe_u32 v115, v[vgprValuC+125], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+125], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v140                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+126], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+126], v[vgprValuC+126] // check Nan
v_bfe_u32 v115, v[vgprValuC+126], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+126], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v141                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+127], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+127], v[vgprValuC+127] // check Nan
v_bfe_u32 v115, v[vgprValuC+127], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+127], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v142                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+128], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+128], v[vgprValuC+128] // check Nan
v_bfe_u32 v115, v[vgprValuC+128], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+128], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v143                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+129], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+129], v[vgprValuC+129] // check Nan
v_bfe_u32 v115, v[vgprValuC+129], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+129], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v144                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+130], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+130], v[vgprValuC+130] // check Nan
v_bfe_u32 v115, v[vgprValuC+130], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+130], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v145                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+131], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+131], v[vgprValuC+131] // check Nan
v_bfe_u32 v115, v[vgprValuC+131], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+131], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v146                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+132], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+132], v[vgprValuC+132] // check Nan
v_bfe_u32 v115, v[vgprValuC+132], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+132], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v147                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+133], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+133], v[vgprValuC+133] // check Nan
v_bfe_u32 v115, v[vgprValuC+133], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+133], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v148                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+134], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+134], v[vgprValuC+134] // check Nan
v_bfe_u32 v115, v[vgprValuC+134], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+134], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_mov_b32 v117, 0x7fff0000                         // fp32 Nan
v_mov_b32 v118, 0x7fff                             // rounding bias for bfloat16
v_lshlrev_b32 v112, 16, v163                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+119], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+119], v[vgprValuC+119] // check Nan
v_bfe_u32 v115, v[vgprValuC+119], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+119], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+119], v115, v117, s28
...
v_lshlrev_b32 v112, 16, v165                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+120], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+120], v[vgprValuC+120] // check Nan
v_bfe_u32 v115, v[vgprValuC+120], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+120], v115, v118      // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+120], v115, v117, s28
...
v_lshlrev_b32 v112, 16, v167                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+121], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+121], v[vgprValuC+121] // check Nan
v_bfe_u32 v115, v[vgprValuC+121], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+121], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v169                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+122], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+122], v[vgprValuC+122] // check Nan
v_bfe_u32 v115, v[vgprValuC+122], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+122], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v171                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+123], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+123], v[vgprValuC+123] // check Nan
v_bfe_u32 v115, v[vgprValuC+123], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+123], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v173                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+124], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+124], v[vgprValuC+124] // check Nan
v_bfe_u32 v115, v[vgprValuC+124], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+124], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v175                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+125], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+125], v[vgprValuC+125] // check Nan
v_bfe_u32 v115, v[vgprValuC+125], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+125], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v177                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+126], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+126], v[vgprValuC+126] // check Nan
v_bfe_u32 v115, v[vgprValuC+126], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+126], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v179                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+127], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+127], v[vgprValuC+127] // check Nan
v_bfe_u32 v115, v[vgprValuC+127], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+127], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v181                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+128], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+128], v[vgprValuC+128] // check Nan
v_bfe_u32 v115, v[vgprValuC+128], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+128], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v183                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+129], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+129], v[vgprValuC+129] // check Nan
v_bfe_u32 v115, v[vgprValuC+129], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+129], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v185                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+130], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+130], v[vgprValuC+130] // check Nan
v_bfe_u32 v115, v[vgprValuC+130], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+130], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_mov_b32 v117, 0x7fff0000                         // fp32 Nan
v_mov_b32 v118, 0x7fff                             // rounding bias for bfloat16
v_lshlrev_b32 v112, 16, v155                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+119], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+119], v[vgprValuC+119] // check Nan
v_bfe_u32 v115, v[vgprValuC+119], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+119], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v157                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+120], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+120], v[vgprValuC+120] // check Nan
v_bfe_u32 v115, v[vgprValuC+120], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+120], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v159                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+121], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+121], v[vgprValuC+121] // check Nan
v_bfe_u32 v115, v[vgprValuC+121], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+121], v115, v118      // Non-Nan case: add lsb and the increment for rounding
...
v_lshlrev_b32 v112, 16, v161                       // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+122], v112, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+122], v[vgprValuC+122] // check Nan
v_bfe_u32 v115, v[vgprValuC+122], 16, 1            // Non-Nan case: store lsb of bf16
v_add3_u32 v115, v[vgprValuC+122], v115, v118      // Non-Nan case: add lsb and the increment for rounding
