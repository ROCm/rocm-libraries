	...
	.section	.text.bm128_bn192_bk032_wm8_wn1_mc1,"axG",@progbits,bm128_bn192_bk032_wm8_wn1_mc1,comdat
	.protected	bm128_bn192_bk032_wm8_wn1_mc1 ; -- Begin function bm128_bn192_bk032_wm8_wn1_mc1
	.globl	bm128_bn192_bk032_wm8_wn1_mc1
	.p2align	8
	.type	bm128_bn192_bk032_wm8_wn1_mc1,@function
bm128_bn192_bk032_wm8_wn1_mc1: ; @bm128_bn192_bk032_wm8_wn1_mc1
; %bb.0:
...
.LBB0_24:
	...
	v_cndmask_b32_e64 v107, 0, 1, s43
	s_barrier_wait -1
	...
	v_dual_mov_b32 v90, v9 :: v_dual_mov_b32 v41, v9
...
; %bb.25:
	v_dual_lshlrev_b32 v3, 5, v0 :: v_dual_lshlrev_b32 v1, 9, v105
	v_and_b32_e32 v2, 16, v0
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s1, 0x5500
	...
	v_dual_lshrrev_b32 v4, 4, v1 :: v_dual_lshrrev_b32 v6, 4, v6
	s_lshr_b32 s4, s4, 2
	v_add_nc_u32_e32 v102, v2, v5
	...
	v_dual_mov_b32 v101, 0 :: v_dual_add_nc_u32 v98, v4, v1
	v_or_b32_e32 v1, 0x400, v3
	v_and_b32_e32 v4, 56, v6
	v_or_b32_e32 v6, 0x800, v3
	v_or_b32_e32 v8, 0xc00, v3
	v_or_b32_e32 v10, 0x1000, v3
	v_lshrrev_b32_e32 v1, 4, v1
	v_or_b32_e32 v11, 0x1200, v3
	v_lshrrev_b32_e32 v6, 4, v6
	v_or_b32_e32 v12, 0x1400, v3
	s_add_co_i32 s4, s1, 0x7700
	v_and_b32_e32 v9, 0x58, v1
	v_or_b32_e32 v1, 0xe00, v3
	...
	v_dual_lshrrev_b32 v12, 4, v12 :: v_dual_lshrrev_b32 v3, 4, v3
	s_sub_co_i32 s7, 16, s10
	s_add_co_i32 s45, s1, 0x5500
	s_lshr_b32 s1, s7, 2
	...
	v_dual_add_nc_u32 v108, v2, v4 :: v_dual_add_nc_u32 v110, v2, v9
	s_lshr_b32 s7, s7, 27
	v_dual_add_nc_u32 v112, v2, v5 :: v_dual_add_nc_u32 v114, v2, v6
	s_add_co_i32 s12, s12, s7
	v_dual_add_nc_u32 v116, v2, v7 :: v_dual_add_nc_u32 v118, v2, v8
	v_dual_add_nc_u32 v120, v2, v13 :: v_dual_add_nc_u32 v122, v2, v10
	v_dual_add_nc_u32 v124, v2, v11 :: v_dual_add_nc_u32 v126, v2, v12
	v_dual_mov_b32 v5, v101 :: v_dual_add_nc_u32 v128, v2, v3
	v_dual_mov_b32 v2, v101 :: v_dual_lshrrev_b32 v104, 8, v99
	v_lshrrev_b32_e32 v106, 8, v1
	s_lshl_b32 s10, s1, 2
	s_ashr_i32 s47, s12, 5
	s_mul_i32 s6, s17, 0xc0
	s_cmp_lt_i32 s3, 0xc0
	v_dual_add_nc_u32 v1, 2, v104 :: v_dual_add_nc_u32 v14, 2, v106
	...
	v_dual_mov_b32 v3, v101 :: v_dual_bitop2_b32 v109, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v4, v101 :: v_dual_bitop2_b32 v111, 30, v14 bitop3:0x40
	...
	v_dual_mov_b32 v99, v104 :: v_dual_add_nc_u32 v103, -1, v106
...
.LBB0_29:                               ;   in Loop: Header=BB0_30 Depth=2
	...
	v_cmp_eq_u32_e32 vcc_lo, s6, v109
...
.LBB0_30:                               ;   Parent Loop BB0_27 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s19, v99
	v_cmpx_le_u32_e64 s18, v104
	s_cbranch_execz .LBB0_32
; %bb.31:                               ;   in Loop: Header=BB0_30 Depth=2
	v_mov_b32_e32 v100, v130
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[132:133], v[100:101], 2, s[14:15]
...
.LBB0_35:                               ;   in Loop: Header=BB0_36 Depth=2
	...
	v_add_nc_u32_e32 v131, 0x200, v131
	v_cmp_eq_u32_e32 vcc_lo, s13, v111
	v_add_nc_u32_e32 v130, 0x200, v130
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
.LBB0_36:                               ;   Parent Loop BB0_27 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s13, v103
	v_cmpx_le_u32_e64 s13, v106
	s_cbranch_execz .LBB0_38
; %bb.37:                               ;   in Loop: Header=BB0_36 Depth=2
	v_mov_b32_e32 v100, v130
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[132:133], v[100:101], 2, s[6:7]
	flat_store_b32 v[132:133], v101
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_lshl_add_u32 v100, v98, 1, s2
	v_lshl_add_u32 v113, v102, 1, s1
	v_lshl_add_u32 v115, v114, 1, s1
	v_lshl_add_u32 v117, v116, 1, s1
	v_lshl_add_u32 v119, v124, 1, s1
	ds_load_b128 v[130:133], v100
	ds_load_b128 v[134:137], v100 offset:16
	v_lshl_add_u32 v100, v108, 1, s1
	ds_load_b128 v[138:141], v113
	ds_load_b128 v[142:145], v113 offset:16
	v_lshl_add_u32 v113, v110, 1, s1
	ds_load_b128 v[170:173], v115 offset:4096
	ds_load_b128 v[146:149], v100 offset:1024
	ds_load_b128 v[150:153], v100 offset:1040
	v_lshl_add_u32 v100, v112, 1, s1
	ds_load_b128 v[154:157], v113 offset:2048
	ds_load_b128 v[158:161], v113 offset:2064
	ds_load_b128 v[174:177], v115 offset:4112
	ds_load_b128 v[178:181], v117 offset:5120
	ds_load_b128 v[162:165], v100 offset:3072
	ds_load_b128 v[166:169], v100 offset:3088
	v_lshl_add_u32 v100, v126, 1, s1
	v_lshl_add_u32 v113, v118, 1, s1
	v_lshl_add_u32 v115, v122, 1, s1
	...
	v_wmma_f32_16x16x32_bf16 v[50:57], v[130:137], v[170:177], v[50:57] matrix_a_reuse
	ds_load_b128 v[138:141], v100 offset:10240
	ds_load_b128 v[142:145], v100 offset:10256
	v_lshl_add_u32 v100, v128, 1, s1
	ds_load_b128 v[182:185], v117 offset:5136
	ds_load_b128 v[154:157], v113 offset:6144
	ds_load_b128 v[158:161], v113 offset:6160
	ds_load_b128 v[170:173], v115 offset:8192
	ds_load_b128 v[146:149], v100 offset:11264
	ds_load_b128 v[150:153], v100 offset:11280
	v_lshl_add_u32 v100, v120, 1, s1
	ds_load_b128 v[174:177], v115 offset:8208
	ds_load_b128 v[186:189], v119 offset:9216
	ds_load_b128 v[190:193], v119 offset:9232
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[130:137], v[186:193], v[34:41] matrix_a_reuse
	ds_load_b128 v[162:165], v100 offset:7168
	ds_load_b128 v[166:169], v100 offset:7184
	...
	v_wmma_f32_16x16x32_bf16 v[58:65], v[130:137], v[146:153], v[58:65] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[130:137], v[178:185], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[130:137], v[154:161], v[18:25] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[130:137], v[162:169], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[130:137], v[170:177], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(6) SyncID(0)
...
; %bb.48:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v113, s13 :: v_dual_mov_b32 v130, s14
...
.LBB0_50:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v113, s5 :: v_dual_mov_b32 v130, s6
...
; %bb.52:
	...
	v_add_nc_u32_e32 v29, v10, v83
	v_and_b32_e32 v10, 0xaf0, v4
	v_dual_add_nc_u32 v50, v67, v83 :: v_dual_add_nc_u32 v26, v26, v83
	v_and_b32_e32 v1, 0xbf0, v1
	v_dual_add_nc_u32 v75, v82, v83 :: v_dual_add_nc_u32 v27, v27, v83
	v_cvt_pk_bf16_f32 v15, v12, v13
	v_add_nc_u32_e32 v28, v19, v83
	v_cvt_pk_bf16_f32 v6, v2, v3
	v_cvt_pk_bf16_f32 v5, v40, v41
	v_cvt_pk_bf16_f32 v4, v38, v39
	v_cvt_pk_bf16_f32 v3, v36, v37
	v_cvt_pk_bf16_f32 v2, v34, v35
	ds_store_b128 v66, v[54:57] offset:16384
	ds_store_b128 v50, v[30:33] offset:20480
	v_add_nc_u32_e32 v30, v10, v83
	...
	ds_store_b128 v26, v[22:25] offset:24576
	ds_store_b128 v27, v[14:17] offset:28672
	ds_store_b128 v28, v[6:9] offset:32768
	ds_store_b128 v29, v[2:5] offset:36864
	ds_store_b128 v30, v[10:13] offset:40960
	ds_store_b128 v1, v[18:21] offset:45056
.LBB0_53:
...
.LBB0_64:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn192_bk032_wm8_wn1_mc1, .Lfunc_end0-bm128_bn192_bk032_wm8_wn1_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn192_bk032_wm8_wn1_mc1
	...
	.section	.text.bm128_bn192_bk032_wm8_wn1_mc1,"axG",@progbits,bm128_bn192_bk032_wm8_wn1_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn192_bk032_wm8_wn1_mc1.num_vgpr, 194
	.set .Lbm128_bn192_bk032_wm8_wn1_mc1.num_agpr, 0
	.set .Lbm128_bn192_bk032_wm8_wn1_mc1.numbered_sgpr, 56
	.set .Lbm128_bn192_bk032_wm8_wn1_mc1.num_named_barrier, 0
	.set .Lbm128_bn192_bk032_wm8_wn1_mc1.private_seg_size, 0
	.set .Lbm128_bn192_bk032_wm8_wn1_mc1.uses_vcc, 1
	.set .Lbm128_bn192_bk032_wm8_wn1_mc1.uses_flat_scratch, 0
	.set .Lbm128_bn192_bk032_wm8_wn1_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn192_bk032_wm8_wn1_mc1.has_recursion, 0
	.set .Lbm128_bn192_bk032_wm8_wn1_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_9454dfd49b854d59,@object ; @__hip_cuid_9454dfd49b854d59
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_9454dfd49b854d59
__hip_cuid_9454dfd49b854d59:
	.byte	0                               ; 0x0
	.size	__hip_cuid_9454dfd49b854d59, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_9454dfd49b854d59
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn192_bk032_wm8_wn1_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn192_bk032_wm8_wn1_mc1.kd
