	...
	.section	.text.bm128_bn256_bk032_wm8_wn1_mc0,"axG",@progbits,bm128_bn256_bk032_wm8_wn1_mc0,comdat
	.protected	bm128_bn256_bk032_wm8_wn1_mc0 ; -- Begin function bm128_bn256_bk032_wm8_wn1_mc0
	.globl	bm128_bn256_bk032_wm8_wn1_mc0
	.p2align	8
	.type	bm128_bn256_bk032_wm8_wn1_mc0,@function
bm128_bn256_bk032_wm8_wn1_mc0: ; @bm128_bn256_bk032_wm8_wn1_mc0
; %bb.0:
...
.LBB0_18:
	...
	v_cndmask_b32_e64 v137, 0, 1, s40
	...
	v_dual_mov_b32 v122, v9 :: v_dual_mov_b32 v57, v9
...
; %bb.19:
	v_dual_lshlrev_b32 v3, 5, v0 :: v_dual_lshlrev_b32 v1, 9, v135
	...
	v_dual_add_nc_u32 v134, v2, v5 :: v_dual_lshrrev_b32 v4, 4, v4
	v_or_b32_e32 v5, 0x600, v3
	v_and_b32_e32 v8, 56, v1
	v_or_b32_e32 v1, 0xc00, v3
	v_or_b32_e32 v6, 0x800, v3
	v_or_b32_e32 v9, 0xe00, v3
	v_or_b32_e32 v11, 0x1200, v3
	v_or_b32_e32 v12, 0x1400, v3
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_lshrrev_b32 v10, 4, v10
	v_or_b32_e32 v14, 0x1800, v3
	v_or_b32_e32 v15, 0x1a00, v3
	v_or_b32_e32 v16, 0x1c00, v3
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v13, 0xd8, v1
	v_or_b32_e32 v1, 0x1600, v3
	...
	v_dual_lshrrev_b32 v12, 4, v12 :: v_dual_lshrrev_b32 v1, 4, v1
	v_dual_lshrrev_b32 v14, 4, v14 :: v_dual_lshrrev_b32 v15, 4, v15
	v_dual_lshrrev_b32 v16, 4, v16 :: v_dual_lshrrev_b32 v3, 4, v3
	...
	v_and_b32_e32 v17, 0x178, v1
	v_and_b32_e32 v14, 0x198, v14
	v_and_b32_e32 v15, 0x1b8, v15
	v_and_b32_e32 v16, 0x1d8, v16
	v_and_b32_e32 v3, 0x1f8, v3
	v_dual_add_nc_u32 v1, 2, v136 :: v_dual_add_nc_u32 v142, v2, v5
	s_mov_b32 s43, s5
	s_ashr_i32 s5, s4, 31
	s_ashr_i32 s7, s6, 31
	s_wait_kmcnt 0x0
	...
	v_dual_add_nc_u32 v138, v2, v8 :: v_dual_add_nc_u32 v144, v2, v6
	v_dual_add_nc_u32 v140, v2, v4 :: v_dual_add_nc_u32 v146, v2, v7
	v_dual_add_nc_u32 v148, v2, v13 :: v_dual_add_nc_u32 v152, v2, v10
	v_dual_add_nc_u32 v150, v2, v9 :: v_dual_add_nc_u32 v154, v2, v11
	v_dual_add_nc_u32 v156, v2, v12 :: v_dual_add_nc_u32 v158, v2, v17
	v_dual_add_nc_u32 v160, v2, v14 :: v_dual_add_nc_u32 v162, v2, v15
	v_dual_add_nc_u32 v164, v2, v16 :: v_dual_add_nc_u32 v166, v2, v3
	v_lshl_or_b32 v168, v0, 2, 0x4000
	v_dual_mov_b32 v169, v133 :: v_dual_mov_b32 v2, v133
	...
	v_dual_mov_b32 v49, v133 :: v_dual_mov_b32 v74, v133
	...
	v_dual_mov_b32 v129, v133 :: v_dual_mov_b32 v50, v133
	...
	v_dual_mov_b32 v73, v133 :: v_dual_mov_b32 v131, v136
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v132, v170 :: v_dual_add_nc_u32 v143, -2, v143
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v143, s14 :: v_dual_mov_b32 v170, s12
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v143, v134, 1, s0
	v_lshl_add_u32 v145, v138, 1, s0
	v_lshl_add_u32 v147, v144, 1, s0
	v_lshl_add_u32 v149, v146, 1, s0
	ds_load_b128 v[170:173], v132
	ds_load_b128 v[174:177], v132 offset:16
	ds_load_b128 v[178:181], v143
	ds_load_b128 v[182:185], v143 offset:16
	v_lshl_add_u32 v132, v140, 1, s0
	v_lshl_add_u32 v143, v142, 1, s0
	v_lshl_add_u32 v151, v148, 1, s0
	ds_load_b128 v[186:189], v145 offset:1024
	ds_load_b128 v[190:193], v145 offset:1040
	ds_load_b128 v[194:197], v132 offset:2048
	ds_load_b128 v[198:201], v132 offset:2064
	ds_load_b128 v[202:205], v143 offset:3072
	ds_load_b128 v[206:209], v143 offset:3088
	ds_load_b128 v[210:213], v147 offset:4096
	ds_load_b128 v[214:217], v147 offset:4112
	ds_load_b128 v[218:221], v149 offset:5120
	ds_load_b128 v[222:225], v149 offset:5136
	ds_load_b128 v[226:229], v151 offset:6144
	ds_load_b128 v[230:233], v151 offset:6160
	v_lshl_add_u32 v153, v150, 1, s0
	v_lshl_add_u32 v132, v166, 1, s0
	v_lshl_add_u32 v143, v152, 1, s0
	v_lshl_add_u32 v145, v156, 1, s0
	ds_load_b128 v[234:237], v153 offset:7168
	s_wait_dscnt 0xd
	...
	ds_load_b128 v[178:181], v132 offset:15360
	ds_load_b128 v[182:185], v132 offset:15376
	v_lshl_add_u32 v132, v154, 1, s0
	ds_load_b128 v[186:189], v143 offset:8192
	ds_load_b128 v[190:193], v143 offset:8208
	v_lshl_add_u32 v143, v158, 1, s0
	ds_load_b128 v[202:205], v145 offset:10240
	ds_load_b128 v[194:197], v132 offset:9216
	ds_load_b128 v[198:201], v132 offset:9232
	ds_load_b128 v[206:209], v145 offset:10256
	v_lshl_add_u32 v132, v160, 1, s0
	ds_load_b128 v[210:213], v143 offset:11264
	v_lshl_add_u32 v145, v162, 1, s0
	ds_load_b128 v[214:217], v143 offset:11280
	v_lshl_add_u32 v143, v164, 1, s0
	ds_load_b128 v[238:241], v153 offset:7184
	ds_load_b128 v[218:221], v132 offset:12288
	ds_load_b128 v[222:225], v132 offset:12304
	ds_load_b128 v[226:229], v145 offset:13312
	ds_load_b128 v[230:233], v145 offset:13328
	ds_load_b128 v[242:245], v143 offset:14336
	ds_load_b128 v[246:249], v143 offset:14352
	s_wait_dscnt 0xf
	v_wmma_f32_16x16x32_bf16 v[66:73], v[170:177], v[178:185], v[66:73] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(8) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(17) SyncID(0)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[42:49], v[170:177], v[234:241], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[170:177], v[186:193], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[170:177], v[194:201], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[170:177], v[202:209], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[170:177], v[210:217], v[10:17] matrix_a_reuse
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[2:9], v[170:177], v[218:225], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[50:57], v[170:177], v[226:233], v[50:57] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(8) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[170:177], v[242:249], v[58:65] matrix_a_reuse
...
; %bb.43:
	...
	v_dual_lshrrev_b32 v20, 3, v28 :: v_dual_lshrrev_b32 v106, 3, v106
	v_and_b32_e32 v76, 0x8f0, v76
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_and_b32_e32 v10, 0xdf0, v10
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_lshrrev_b32_e32 v4, 3, v11
	v_and_b32_e32 v82, 0x6f0, v91
	v_cvt_pk_bf16_f32 v46, v42, v43
	v_and_b32_e32 v43, 0x9f0, v74
	v_and_b32_e32 v26, 0xaf0, v35
	v_lshrrev_b32_e32 v1, 3, v1
	v_and_b32_e32 v114, 0x3f0, v116
	v_and_b32_e32 v83, 0x7f0, v83
	v_and_b32_e32 v27, 0xbf0, v27
	v_and_b32_e32 v108, 0x4f0, v108
	v_and_b32_e32 v19, 0xcf0, v20
	v_cvt_pk_bf16_f32 v102, v98, v99
	v_and_b32_e32 v99, 0x5f0, v106
	v_add_nc_u32_e32 v42, v76, v115
	v_cvt_pk_bf16_f32 v39, v36, v37
	v_add_nc_u32_e32 v29, v10, v115
	v_and_b32_e32 v10, 0xef0, v4
	v_dual_add_nc_u32 v82, v82, v115 :: v_dual_add_nc_u32 v34, v43, v115
	v_add_nc_u32_e32 v26, v26, v115
	v_and_b32_e32 v1, 0xff0, v1
	v_dual_add_nc_u32 v107, v114, v115 :: v_dual_add_nc_u32 v75, v83, v115
	v_add_nc_u32_e32 v27, v27, v115
	v_cvt_pk_bf16_f32 v15, v12, v13
	v_add_nc_u32_e32 v98, v108, v115
	v_cvt_pk_bf16_f32 v95, v92, v93
	v_add_nc_u32_e32 v28, v19, v115
	v_cvt_pk_bf16_f32 v6, v2, v3
	v_add_nc_u32_e32 v90, v99, v115
	...
	ds_store_b128 v75, v[46:49] offset:28672
	...
	ds_store_b128 v26, v[22:25] offset:40960
	ds_store_b128 v27, v[14:17] offset:45056
	ds_store_b128 v28, v[6:9] offset:49152
	ds_store_b128 v29, v[2:5] offset:53248
	ds_store_b128 v30, v[10:13] offset:57344
	ds_store_b128 v1, v[18:21] offset:61440
.LBB0_44:
	v_cmp_ne_u32_e32 vcc_lo, 1, v137
	;;#ASMSTART
	s_wait_dscnt 0
	;;#ASMEND
	s_barrier_signal -1
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn256_bk032_wm8_wn1_mc0, .Lfunc_end0-bm128_bn256_bk032_wm8_wn1_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn256_bk032_wm8_wn1_mc0
	...
	.section	.text.bm128_bn256_bk032_wm8_wn1_mc0,"axG",@progbits,bm128_bn256_bk032_wm8_wn1_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn256_bk032_wm8_wn1_mc0.num_vgpr, 250
	.set .Lbm128_bn256_bk032_wm8_wn1_mc0.num_agpr, 0
	.set .Lbm128_bn256_bk032_wm8_wn1_mc0.numbered_sgpr, 56
	.set .Lbm128_bn256_bk032_wm8_wn1_mc0.num_named_barrier, 0
	.set .Lbm128_bn256_bk032_wm8_wn1_mc0.private_seg_size, 0
	.set .Lbm128_bn256_bk032_wm8_wn1_mc0.uses_vcc, 1
	.set .Lbm128_bn256_bk032_wm8_wn1_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn256_bk032_wm8_wn1_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn256_bk032_wm8_wn1_mc0.has_recursion, 0
	.set .Lbm128_bn256_bk032_wm8_wn1_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_c4779acf5556c67d,@object ; @__hip_cuid_c4779acf5556c67d
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_c4779acf5556c67d
__hip_cuid_c4779acf5556c67d:
	.byte	0                               ; 0x0
	.size	__hip_cuid_c4779acf5556c67d, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_c4779acf5556c67d
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn256_bk032_wm8_wn1_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn256_bk032_wm8_wn1_mc0.kd
