	...
	.section	.text.bm064_bn256_bk128_wm1_wn8_mc0,"axG",@progbits,bm064_bn256_bk128_wm1_wn8_mc0,comdat
	.protected	bm064_bn256_bk128_wm1_wn8_mc0 ; -- Begin function bm064_bn256_bk128_wm1_wn8_mc0
	.globl	bm064_bn256_bk128_wm1_wn8_mc0
	.p2align	8
	.type	bm064_bn256_bk128_wm1_wn8_mc0,@function
bm064_bn256_bk128_wm1_wn8_mc0: ; @bm064_bn256_bk128_wm1_wn8_mc0
; %bb.0:
...
; %bb.15:
	...
	s_add_co_i32 s2, s30, 0x11000
	s_mov_b32 s3, s1
	v_lshlrev_b32_e32 v1, 7, v0
	s_and_b64 s[6:7], s[2:3], 15
	s_mov_b32 s42, s1
	s_sub_co_i32 s0, 16, s6
	v_or_b32_e32 v78, 0xf00, v0
	s_lshr_b32 s0, s0, 2
	s_cmp_lg_u64 s[6:7], 0
	v_and_b32_e32 v2, 0x780, v1
	s_cselect_b32 s0, s0, 0
	s_mov_b32 s7, 0
	s_lshl2_add_u32 s40, s0, s2
	v_or_b32_e32 v72, 0x4000, v66
	s_add_co_i32 s0, s40, 0x4400
	v_and_or_b32 v3, v0, 16, v2
	s_and_b32 s6, s0, 15
	...
	v_dual_add_nc_u32 v68, v2, v3 :: v_dual_add_nc_u32 v70, v4, v1
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v73, v67 :: v_dual_mov_b32 v75, v67
	v_or_b32_e32 v79, 0x4300, v0
	v_or_b32_e32 v74, 0x11000, v66
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_lshl_add_u64 v[84:85], v[66:67], 2, s[2:3]
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[76:77], s[2:3], v[72:73]
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v77, s10 :: v_dual_mov_b32 v76, s8
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	ds_load_b128 v[128:131], v66 offset:13120
	ds_load_b128 v[132:135], v66 offset:13136
	ds_load_b128 v[136:139], v76 offset:64
	ds_load_b128 v[140:143], v76 offset:80
	ds_load_b128 v[144:147], v76 offset:4416
	ds_load_b128 v[148:151], v76 offset:4432
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[50:57], v[80:87], v[96:103], v[50:57] matrix_b_reuse
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[26:33], v[88:95], v[96:103], v[26:33] matrix_b_reuse
	ds_load_b128 v[104:107], v66 offset:8704
	ds_load_b128 v[108:111], v66 offset:8720
	ds_load_b128 v[112:115], v66 offset:13056
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[10:17], v[104:111], v[96:103], v[10:17] matrix_b_reuse
	ds_load_b128 v[116:119], v66 offset:13072
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[112:119], v[96:103], v[34:41] matrix_a_reuse
	ds_load_b128 v[96:99], v76
	ds_load_b128 v[100:103], v76 offset:16
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[80:87], v[96:103], v[58:65]
	v_wmma_f32_16x16x32_bf16 v[42:49], v[88:95], v[96:103], v[42:49] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[112:119], v[96:103], v[2:9] matrix_b_reuse
	ds_load_b128 v[112:115], v66 offset:8768
	ds_load_b128 v[116:119], v66 offset:8784
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[104:111], v[96:103], v[18:25] matrix_b_reuse
	ds_load_b128 v[104:107], v66 offset:64
	ds_load_b128 v[108:111], v66 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[80:83], v66 offset:128
	ds_load_b128 v[84:87], v66 offset:144
	ds_load_b128 v[88:91], v66 offset:4480
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[58:65], v[104:111], v[136:143], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[120:127], v[136:143], v[42:49] matrix_b_reuse
	ds_load_b128 v[92:95], v66 offset:4496
	ds_load_b128 v[96:99], v66 offset:8832
	ds_load_b128 v[100:103], v66 offset:8848
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[112:119], v[136:143], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[128:135], v[136:143], v[2:9] matrix_b_reuse
	ds_load_b128 v[136:139], v66 offset:13184
	ds_load_b128 v[140:143], v66 offset:13200
	ds_load_b128 v[152:155], v76 offset:128
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[128:135], v[144:151], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[112:119], v[144:151], v[10:17] matrix_b_reuse
	ds_load_b128 v[156:159], v76 offset:144
	ds_load_b128 v[112:115], v76 offset:4480
	ds_load_b128 v[116:119], v76 offset:4496
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[120:127], v[144:151], v[26:33] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[104:111], v[144:151], v[50:57] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[104:107], v66 offset:192
	ds_load_b128 v[108:111], v66 offset:208
	ds_load_b128 v[120:123], v66 offset:4544
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[58:65], v[80:87], v[152:159], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[88:95], v[152:159], v[42:49] matrix_b_reuse
	ds_load_b128 v[124:127], v66 offset:4560
	ds_load_b128 v[128:131], v66 offset:8896
	ds_load_b128 v[132:135], v66 offset:8912
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[96:103], v[152:159], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[136:143], v[152:159], v[2:9] matrix_b_reuse
	ds_load_b128 v[144:147], v66 offset:13248
	ds_load_b128 v[148:151], v66 offset:13264
	ds_load_b128 v[152:155], v76 offset:192
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[34:41], v[136:143], v[112:119], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[96:103], v[112:119], v[10:17] matrix_b_reuse
	ds_load_b128 v[156:159], v76 offset:208
	ds_load_b128 v[96:99], v76 offset:4544
	ds_load_b128 v[100:103], v76 offset:4560
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[88:95], v[112:119], v[26:33] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[80:87], v[112:119], v[50:57] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[58:65], v[104:111], v[152:159], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[120:127], v[152:159], v[42:49] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[128:135], v[152:159], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[144:151], v[152:159], v[2:9] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[144:151], v[96:103], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[128:135], v[96:103], v[10:17] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[120:127], v[96:103], v[26:33] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[104:111], v[96:103], v[50:57] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.38:
	v_dual_lshlrev_b32 v1, 6, v0 :: v_dual_lshrrev_b32 v66, 1, v0
	v_nop
	v_nop
	v_nop
	...
	ds_store_b128 v26, v[54:57] offset:2048
	ds_store_b128 v1, v[62:65]
	ds_store_b128 v1, v[46:49] offset:32
	ds_store_b128 v18, v[30:33] offset:32
	ds_store_b128 v18, v[14:17] offset:64
	ds_store_b128 v1, v[22:25] offset:64
	ds_store_b128 v1, v[6:9] offset:96
	ds_store_b128 v18, v[2:5] offset:96
.LBB0_39:
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn256_bk128_wm1_wn8_mc0, .Lfunc_end0-bm064_bn256_bk128_wm1_wn8_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn256_bk128_wm1_wn8_mc0
	...
	.section	.text.bm064_bn256_bk128_wm1_wn8_mc0,"axG",@progbits,bm064_bn256_bk128_wm1_wn8_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn256_bk128_wm1_wn8_mc0.num_vgpr, 160
	.set .Lbm064_bn256_bk128_wm1_wn8_mc0.num_agpr, 0
	.set .Lbm064_bn256_bk128_wm1_wn8_mc0.numbered_sgpr, 56
	.set .Lbm064_bn256_bk128_wm1_wn8_mc0.num_named_barrier, 0
	.set .Lbm064_bn256_bk128_wm1_wn8_mc0.private_seg_size, 0
	.set .Lbm064_bn256_bk128_wm1_wn8_mc0.uses_vcc, 1
	.set .Lbm064_bn256_bk128_wm1_wn8_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn256_bk128_wm1_wn8_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn256_bk128_wm1_wn8_mc0.has_recursion, 0
	.set .Lbm064_bn256_bk128_wm1_wn8_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_906aa783e9e68c1c,@object ; @__hip_cuid_906aa783e9e68c1c
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_906aa783e9e68c1c
__hip_cuid_906aa783e9e68c1c:
	.byte	0                               ; 0x0
	.size	__hip_cuid_906aa783e9e68c1c, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_906aa783e9e68c1c
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn256_bk128_wm1_wn8_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn256_bk128_wm1_wn8_mc0.kd
