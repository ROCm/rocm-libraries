	...
	.section	.text.bm128_bn064_bk128_wm4_wn2_mc1,"axG",@progbits,bm128_bn064_bk128_wm4_wn2_mc1,comdat
	.protected	bm128_bn064_bk128_wm4_wn2_mc1 ; -- Begin function bm128_bn064_bk128_wm4_wn2_mc1
	.globl	bm128_bn064_bk128_wm4_wn2_mc1
	.p2align	8
	.type	bm128_bn064_bk128_wm4_wn2_mc1,@function
bm128_bn064_bk128_wm4_wn2_mc1: ; @bm128_bn064_bk128_wm4_wn2_mc1
; %bb.0:
...
; %bb.17:
	...
	v_or_b32_e32 v50, 0x2100, v0
	s_lshl2_add_u32 s6, s4, s16
	v_or_b32_e32 v44, 0x8800, v36
	s_add_co_i32 s4, s6, 0x15400
	v_and_or_b32 v5, 0x1000, v43, v3
	s_and_b32 s10, s4, 15
	...
	v_dual_lshrrev_b32 v6, 4, v4 :: v_dual_bitop2_b32 v2, v2, v1 bitop3:0x54
	v_mov_b32_e32 v37, 0
	s_lshr_b32 s7, s7, 25
	s_lshl_b32 s10, s6, 2
	...
	v_add_nc_u32_e32 v34, v6, v4
	v_and_b32_e32 v2, 0x378, v2
	s_wait_kmcnt 0x0
	s_bfe_i64 s[18:19], s[20:21], 0x200000
	v_dual_add_nc_u32 v3, v3, v1 :: v_dual_mov_b32 v45, v37
	s_ashr_i32 s51, s50, 31
	s_mul_u64 s[6:7], s[18:19], s[6:7]
	s_bfe_i64 s[18:19], s[24:25], 0x200000
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_add_nc_u32 v38, v7, v5 :: v_dual_add_nc_u32 v40, v2, v3
	s_mul_u64 s[18:19], s[18:19], s[50:51]
	v_cmp_eq_u32_e64 s0, 0, v35
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v47, v37 :: v_dual_add_nc_u32 v42, v6, v3
	v_or_b32_e32 v51, 0xf00, v0
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v36, v48 :: v_dual_add_nc_u32 v52, -2, v52
	v_dual_mov_b32 v54, v49 :: v_dual_mov_b32 v55, v37
...
; %bb.23:                               ;   in Loop: Header=BB0_19 Depth=1
	v_add_nc_u64_e32 v[48:49], s[6:7], v[44:45]
...
.LBB0_24:                               ;   Parent Loop BB0_19 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[48:49], 0x400, v[48:49]
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_lshl_add_u32 v48, v38, 1, s6
	ds_load_b128 v[52:55], v36
	ds_load_b128 v[56:59], v36 offset:16
	ds_load_b128 v[76:79], v48 offset:4352
	ds_load_b128 v[80:83], v48 offset:4368
	ds_load_b128 v[92:95], v48 offset:64
	ds_load_b128 v[96:99], v48 offset:80
	ds_load_b128 v[100:103], v48 offset:4416
	ds_load_b128 v[104:107], v48 offset:4432
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[18:25], v[52:59], v[76:83], v[18:25] matrix_a_reuse
	ds_load_b128 v[60:63], v36 offset:4352
	ds_load_b128 v[64:67], v36 offset:4368
	ds_load_b128 v[68:71], v48
	ds_load_b128 v[72:75], v48 offset:16
	v_lshl_add_u32 v36, v40, 1, s5
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	ds_load_b128 v[84:87], v36 offset:4416
	ds_load_b128 v[88:91], v36 offset:4432
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[52:59], v[68:75], v[26:33]
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[60:67], v[68:75], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[60:67], v[76:83], v[10:17]
	ds_load_b128 v[60:63], v36 offset:64
	ds_load_b128 v[64:67], v36 offset:80
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v36, v42, 1, s5
	ds_load_b128 v[52:55], v36 offset:128
	ds_load_b128 v[56:59], v36 offset:144
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[60:67], v[92:99], v[26:33]
	ds_load_b128 v[68:71], v36 offset:4480
	ds_load_b128 v[72:75], v36 offset:4496
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[60:67], v[100:107], v[18:25] matrix_a_reuse
	ds_load_b128 v[60:63], v48 offset:128
	ds_load_b128 v[64:67], v48 offset:144
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[84:91], v[100:107], v[10:17]
	ds_load_b128 v[76:79], v48 offset:4480
	ds_load_b128 v[80:83], v48 offset:4496
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[84:91], v[92:99], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[84:87], v36 offset:192
	ds_load_b128 v[88:91], v36 offset:208
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[26:33], v[52:59], v[60:67], v[26:33]
	ds_load_b128 v[92:95], v36 offset:4544
	ds_load_b128 v[96:99], v36 offset:4560
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[18:25], v[52:59], v[76:83], v[18:25] matrix_a_reuse
	ds_load_b128 v[52:55], v48 offset:192
	ds_load_b128 v[56:59], v48 offset:208
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[68:75], v[76:83], v[10:17]
	ds_load_b128 v[76:79], v48 offset:4544
	ds_load_b128 v[80:83], v48 offset:4560
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[68:75], v[60:67], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[84:91], v[52:59], v[26:33]
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[84:91], v[76:83], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[92:99], v[76:83], v[10:17]
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[92:99], v[52:59], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.38:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_dual_mov_b32 v49, s13 :: v_dual_mov_b32 v48, s14
...
.LBB0_40:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v49, s5 :: v_dual_mov_b32 v48, s6
	s_bitset1_b32 s7, 31
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn064_bk128_wm4_wn2_mc1, .Lfunc_end0-bm128_bn064_bk128_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn064_bk128_wm4_wn2_mc1
	...
	.section	.text.bm128_bn064_bk128_wm4_wn2_mc1,"axG",@progbits,bm128_bn064_bk128_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn064_bk128_wm4_wn2_mc1.num_vgpr, 108
	.set .Lbm128_bn064_bk128_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm128_bn064_bk128_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm128_bn064_bk128_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm128_bn064_bk128_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm128_bn064_bk128_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm128_bn064_bk128_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn064_bk128_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn064_bk128_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm128_bn064_bk128_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_27ce90ed89acdf4f,@object ; @__hip_cuid_27ce90ed89acdf4f
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_27ce90ed89acdf4f
__hip_cuid_27ce90ed89acdf4f:
	.byte	0                               ; 0x0
	.size	__hip_cuid_27ce90ed89acdf4f, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_27ce90ed89acdf4f
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn064_bk128_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn064_bk128_wm4_wn2_mc1.kd
