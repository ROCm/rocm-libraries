	...
	.section	.text.bm064_bn320_bk064_wm4_wn2_mc0,"axG",@progbits,bm064_bn320_bk064_wm4_wn2_mc0,comdat
	.protected	bm064_bn320_bk064_wm4_wn2_mc0 ; -- Begin function bm064_bn320_bk064_wm4_wn2_mc0
	.globl	bm064_bn320_bk064_wm4_wn2_mc0
	.p2align	8
	.type	bm064_bn320_bk064_wm4_wn2_mc0,@function
bm064_bn320_bk064_wm4_wn2_mc0: ; @bm064_bn320_bk064_wm4_wn2_mc0
; %bb.0:
...
.LBB0_10:                               ; =>This Inner Loop Header: Depth=1
	...
	v_cmp_lt_u32_e32 vcc_lo, 0x297f, v2
...
.LBB0_18:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 3, v93 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	s_and_b32 s34, s29, s25
	v_mov_b32_e32 v9, 0
	v_cndmask_b32_e64 v87, 0, 1, s34
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v89, 48, v1
...
; %bb.19:
	...
	v_dual_lshlrev_b32 v2, 6, v91 :: v_dual_lshlrev_b32 v3, 6, v89
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s0, 0xcc00
	...
	v_and_b32_e32 v7, 0x2b8, v7
	v_and_b32_e32 v6, 0xf8, v6
	v_or_b32_e32 v12, 0x1400, v5
	v_dual_mov_b32 v83, v88 :: v_dual_add_nc_u32 v16, 0x2000, v5
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_lshrrev_b32 v11, 4, v11 :: v_dual_add_nc_u32 v82, v6, v1
	v_lshrrev_b32_e32 v1, 4, v8
	v_add_nc_u32_e32 v8, 0x800, v5
	v_add_nc_u32_e32 v86, v7, v5
	v_add_nc_u32_e32 v17, 0x2400, v5
	v_lshrrev_b32_e32 v12, 4, v12
	v_and_b32_e32 v10, 0x2f8, v1
	v_lshrrev_b32_e32 v8, 4, v8
	v_dual_mov_b32 v131, v85 :: v_dual_add_nc_u32 v18, 0x820, v5
	v_add_nc_u32_e32 v13, 0x1800, v5
	v_and_b32_e32 v14, 0x3b8, v11
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_and_b32_e32 v8, 0x3b8, v8
	v_add_nc_u32_e32 v90, v10, v5
	v_and_b32_e32 v12, 0x3f8, v12
	v_dual_mov_b32 v10, v85 :: v_dual_add_nc_u32 v19, 0xc20, v5
	v_dual_add_nc_u32 v92, v8, v5 :: v_dual_mov_b32 v8, v85
	v_dual_lshrrev_b32 v17, 4, v17 :: v_dual_lshrrev_b32 v18, 4, v18
	v_and_b32_e32 v20, 0x3f8, v1
	v_add_nc_u32_e32 v1, 0x1820, v5
	s_cmp_lg_u64 s[6:7], 0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_and_b32_e32 v17, 0x6f8, v17
	v_add_nc_u32_e32 v2, v4, v2
	s_cselect_b32 s4, s4, 0
	v_dual_lshrrev_b32 v16, 4, v16 :: v_dual_add_nc_u32 v96, v14, v5
	v_dual_add_nc_u32 v98, v12, v5 :: v_dual_add_nc_u32 v106, v17, v5
	v_add3_u32 v108, v4, v3, v6
	v_add3_u32 v120, v2, v12, 0x1400
	v_dual_mov_b32 v4, v85 :: v_dual_lshrrev_b32 v13, 4, v13
	v_dual_mov_b32 v12, v85 :: v_dual_lshrrev_b32 v19, 4, v19
	v_lshrrev_b32_e32 v1, 4, v1
	s_lshl2_add_u32 s6, s4, s0
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v13, 0x7b8, v13
	s_add_co_i32 s4, s6, 0xee00
	v_and_b32_e32 v16, 0x6b8, v16
	v_and_b32_e32 v18, 0x7f8, v18
	v_dual_mov_b32 v14, v85 :: v_dual_add_nc_u32 v21, 0x1c20, v5
	v_dual_mov_b32 v3, v85 :: v_dual_add_nc_u32 v22, 0x2020, v5
	v_add_nc_u32_e32 v23, 0x2420, v5
	v_and_b32_e32 v24, 0x7f8, v1
	v_sub_nc_u32_e32 v1, 0x2a7f, v0
	s_and_b32 s10, s4, 15
	s_mul_i32 s0, s1, 0x140
	s_sub_co_i32 s1, 16, s10
	s_add_co_i32 s43, s6, 0xcc00
	s_lshr_b32 s1, s1, 2
	v_dual_lshrrev_b32 v21, 4, v21 :: v_dual_lshrrev_b32 v22, 4, v22
	v_dual_add_nc_u32 v100, v13, v5 :: v_dual_add_nc_u32 v104, v16, v5
	v_add3_u32 v114, v2, v18, 0x800
	v_dual_mov_b32 v16, v85 :: v_dual_mov_b32 v18, v85
	v_dual_lshrrev_b32 v23, 4, v23 :: v_dual_lshrrev_b32 v1, 8, v1
	s_cmp_lg_u64 s[10:11], 0
	v_add_nc_u32_e32 v9, 0xc00, v5
	s_cselect_b32 s1, s1, 0
	s_ashr_i32 s6, s17, 31
	v_dual_mov_b32 v6, v85 :: v_dual_add_nc_u32 v15, 0x1c00, v5
	s_lshr_b32 s6, s6, 26
	...
	v_dual_add_nc_u32 v25, 1, v1 :: v_dual_add_nc_u32 v1, 2, v88
	s_add_co_i32 s17, s17, s6
	s_lshl_b32 s10, s1, 2
	s_ashr_i32 s45, s17, 6
	s_cmp_lt_i32 s3, 0x140
	v_dual_lshrrev_b32 v15, 4, v15 :: v_dual_bitop2_b32 v95, 46, v25 bitop3:0x40
	v_dual_add_nc_u32 v110, v7, v2 :: v_dual_bitop2_b32 v97, 30, v1 bitop3:0x40
	v_add3_u32 v112, v2, v20, 0x400
	v_add3_u32 v116, v2, v19, 0xc00
	v_add3_u32 v118, v2, v11, 0x1000
	v_add3_u32 v122, v2, v24, 0x1800
	v_add3_u32 v124, v2, v21, 0x1c00
	v_add3_u32 v126, v2, v22, 0x2000
	v_add3_u32 v128, v2, v23, 0x2400
	v_dual_mov_b32 v2, v85 :: v_dual_lshrrev_b32 v9, 4, v9
	...
	v_cmp_ne_u32_e64 s0, v25, v95
	v_dual_add_nc_u32 v94, v9, v5 :: v_dual_add_nc_u32 v102, v15, v5
	v_dual_mov_b32 v20, v85 :: v_dual_add_nc_u32 v99, 0xffffff00, v26
	v_dual_mov_b32 v5, v85 :: v_dual_lshlrev_b32 v130, 2, v26
	v_dual_mov_b32 v7, v85 :: v_dual_mov_b32 v9, v85
	v_dual_mov_b32 v11, v85 :: v_dual_mov_b32 v13, v85
	v_dual_mov_b32 v15, v85 :: v_dual_mov_b32 v17, v85
	v_dual_mov_b32 v19, v85 :: v_dual_mov_b32 v21, v85
	v_dual_mov_b32 v22, v85 :: v_dual_mov_b32 v23, v85
	v_dual_mov_b32 v24, v85 :: v_dual_mov_b32 v25, v85
...
.LBB0_24:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s15, v83
	v_cmpx_le_u32_e64 s14, v88
	s_cbranch_execz .LBB0_26
; %bb.25:                               ;   in Loop: Header=BB0_24 Depth=2
	v_mov_b32_e32 v84, v132
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[134:135], v[84:85], 2, s[12:13]
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v84, v132 :: v_dual_add_nc_u32 v101, -2, v101
	v_dual_mov_b32 v134, v133 :: v_dual_mov_b32 v135, v85
	v_add_nc_u32_e32 v133, 0x200, v133
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[136:137], v[84:85], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v101
	v_add_nc_u32_e32 v132, 0x200, v132
	v_lshl_add_u64 v[134:135], v[134:135], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[136:137], v85
	flat_store_b32 v[134:135], v85
...
; %bb.31:                               ;   in Loop: Header=BB0_21 Depth=1
	v_add_nc_u64_e32 v[132:133], s[6:7], v[130:131]
...
.LBB0_32:                               ;   Parent Loop BB0_21 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[132:133], 0x400, v[132:133]
	v_cmp_lt_u32_e32 vcc_lo, 0x297f, v84
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v101, s14 :: v_dual_mov_b32 v132, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_dual_mov_b32 v101, s5 :: v_dual_mov_b32 v132, s6
	s_and_b32 s1, s7, 0x1ffffff
	s_and_b32 s7, s29, s12
	s_bitset1_b32 s1, 31
	v_cndmask_b32_e64 v84, 0, 1, s7
	v_mov_b32_e32 v103, s1
	v_readfirstlane_b32 s13, v101
	v_readfirstlane_b32 s14, v132
	s_lshr_b64 s[6:7], s[30:31], 16
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v103, v96, 1, s1
	v_lshl_add_u32 v105, v102, 1, s1
	v_lshl_add_u32 v107, v104, 1, s1
	ds_load_b128 v[132:135], v84
	ds_load_b128 v[136:139], v84 offset:16
	v_lshl_add_u32 v84, v90, 1, s1
	ds_load_b128 v[140:143], v101
	ds_load_b128 v[144:147], v101 offset:16
	v_lshl_add_u32 v101, v94, 1, s1
	ds_load_b128 v[172:175], v103 offset:8192
	ds_load_b128 v[148:151], v84 offset:2048
	ds_load_b128 v[152:155], v84 offset:2064
	v_lshl_add_u32 v84, v92, 1, s1
	ds_load_b128 v[164:167], v101 offset:6144
	ds_load_b128 v[168:171], v101 offset:6160
	v_lshl_add_u32 v101, v100, 1, s1
	ds_load_b128 v[184:187], v107 offset:16400
	ds_load_b128 v[156:159], v84 offset:4096
	ds_load_b128 v[160:163], v84 offset:4112
	v_lshl_add_u32 v84, v106, 1, s1
	v_lshl_add_u32 v109, v110, 1, s1
	v_lshl_add_u32 v111, v112, 1, s1
	v_lshl_add_u32 v113, v114, 1, s1
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[74:81], v[132:139], v[140:147], v[74:81]
	v_lshl_add_u32 v115, v116, 1, s1
	v_lshl_add_u32 v117, v118, 1, s1
	v_lshl_add_u32 v119, v122, 1, s1
	v_lshl_add_u32 v121, v124, 1, s1
	v_lshl_add_u32 v123, v126, 1, s1
	ds_load_b128 v[188:191], v111 offset:64
	ds_load_b128 v[192:195], v111 offset:80
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[66:73], v[132:139], v[148:155], v[66:73] matrix_a_reuse
	ds_load_b128 v[196:199], v113 offset:64
	ds_load_b128 v[200:203], v113 offset:80
	ds_load_b128 v[204:207], v117 offset:64
	ds_load_b128 v[208:211], v117 offset:80
	ds_load_b128 v[220:223], v119 offset:64
	ds_load_b128 v[224:227], v119 offset:80
	ds_load_b128 v[228:231], v123 offset:64
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[58:65], v[132:139], v[156:163], v[58:65] matrix_a_reuse
	ds_load_b128 v[232:235], v123 offset:80
	; sched_group_barrier mask(0x00000100) size(11) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[132:139], v[164:171], v[50:57] matrix_a_reuse
	ds_load_b128 v[140:143], v84 offset:18432
	ds_load_b128 v[144:147], v84 offset:18448
	v_lshl_add_u32 v84, v98, 1, s1
	ds_load_b128 v[176:179], v103 offset:8208
	v_lshl_add_u32 v103, v108, 1, s2
	ds_load_b128 v[156:159], v101 offset:12288
	ds_load_b128 v[160:163], v101 offset:12304
	ds_load_b128 v[164:167], v105 offset:14336
	ds_load_b128 v[168:171], v105 offset:14352
	ds_load_b128 v[148:151], v103 offset:64
	ds_load_b128 v[180:183], v107 offset:16384
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[42:49], v[132:139], v[140:147], v[42:49] matrix_a_reuse
	ds_load_b128 v[140:143], v84 offset:10240
	ds_load_b128 v[144:147], v84 offset:10256
	v_lshl_add_u32 v84, v120, 1, s1
	ds_load_b128 v[152:155], v103 offset:80
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(11) SyncID(0)
	ds_load_b128 v[212:215], v84 offset:64
	ds_load_b128 v[216:219], v84 offset:80
	v_lshl_add_u32 v84, v128, 1, s1
	s_wait_dscnt 0xb
	v_wmma_f32_16x16x32_bf16 v[34:41], v[132:139], v[172:179], v[34:41] matrix_a_reuse
	ds_load_b128 v[172:175], v109 offset:64
	ds_load_b128 v[176:179], v109 offset:80
	ds_load_b128 v[236:239], v84 offset:64
	ds_load_b128 v[240:243], v84 offset:80
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[26:33], v[132:139], v[140:147], v[26:33] matrix_a_reuse
	ds_load_b128 v[140:143], v115 offset:64
	ds_load_b128 v[144:147], v115 offset:80
	v_wmma_f32_16x16x32_bf16 v[18:25], v[132:139], v[156:163], v[18:25] matrix_a_reuse
	ds_load_b128 v[156:159], v121 offset:64
	ds_load_b128 v[160:163], v121 offset:80
	v_wmma_f32_16x16x32_bf16 v[10:17], v[132:139], v[164:171], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[132:139], v[180:187], v[2:9] matrix_a_reuse
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[74:81], v[148:155], v[172:179], v[74:81]
	; sched_group_barrier mask(0x00000100) size(11) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[66:73], v[148:155], v[188:195], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[148:155], v[196:203], v[58:65] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[50:57], v[148:155], v[140:147], v[50:57] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[148:155], v[204:211], v[34:41] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(11) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[148:155], v[212:219], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[148:155], v[220:227], v[18:25] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[148:155], v[156:163], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[148:155], v[228:235], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[148:155], v[236:243], v[42:49] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn320_bk064_wm4_wn2_mc0, .Lfunc_end0-bm064_bn320_bk064_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn320_bk064_wm4_wn2_mc0
	...
	.section	.text.bm064_bn320_bk064_wm4_wn2_mc0,"axG",@progbits,bm064_bn320_bk064_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn320_bk064_wm4_wn2_mc0.num_vgpr, 244
	.set .Lbm064_bn320_bk064_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm064_bn320_bk064_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm064_bn320_bk064_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm064_bn320_bk064_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm064_bn320_bk064_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm064_bn320_bk064_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn320_bk064_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn320_bk064_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm064_bn320_bk064_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_b5e84097e2cca066,@object ; @__hip_cuid_b5e84097e2cca066
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_b5e84097e2cca066
__hip_cuid_b5e84097e2cca066:
	.byte	0                               ; 0x0
	.size	__hip_cuid_b5e84097e2cca066, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_b5e84097e2cca066
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn320_bk064_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn320_bk064_wm4_wn2_mc0.kd
