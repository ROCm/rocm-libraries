	...
	.section	.text.bm128_bn064_bk096_wm8_wn1_mc0,"axG",@progbits,bm128_bn064_bk096_wm8_wn1_mc0,comdat
	.protected	bm128_bn064_bk096_wm8_wn1_mc0 ; -- Begin function bm128_bn064_bk096_wm8_wn1_mc0
	.globl	bm128_bn064_bk096_wm8_wn1_mc0
	.p2align	8
	.type	bm128_bn064_bk096_wm8_wn1_mc0,@function
bm128_bn064_bk096_wm8_wn1_mc0: ; @bm128_bn064_bk096_wm8_wn1_mc0
; %bb.0:
...
; %bb.8:                                ;   in Loop: Header=BB0_7 Depth=1
	ds_store_b32 v3, v5 offset:26112
; %bb.9:                                ;   in Loop: Header=BB0_7 Depth=1
	s_or_b32 exec_lo, exec_lo, s11
	s_and_saveexec_b32 s2, vcc_lo
	s_cbranch_execz .LBB0_6
; %bb.10:                               ;   in Loop: Header=BB0_7 Depth=1
	ds_store_b32 v3, v5 offset:27136
	s_branch .LBB0_6
.LBB0_11:
...
; %bb.19:
	...
	s_mov_b32 s7, s5
	v_mul_u32_u24_e32 v1, 0x600, v39
	v_and_b32_e32 v3, 16, v0
	s_and_b64 s[6:7], s[6:7], 15
	v_and_b32_e32 v2, 15, v0
	s_sub_co_i32 s4, 16, s6
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v37, 0 :: v_dual_bitop2_b32 v1, v1, v3 bitop3:0x54
	s_lshr_b32 s4, s4, 2
	...
	s_cmp_lt_i32 s3, 64
	v_dual_add_nc_u32 v34, v4, v1 :: v_dual_bitop2_b32 v3, v5, v3 bitop3:0x54
	...
	v_mad_u32_u24 v4, v2, s2, 0x600
	s_movk_i32 s2, 0xc00
	v_and_b32_e32 v1, 0x78, v1
	v_mad_u32_u24 v6, 0x60, v2, s2
	v_mad_u32_u24 v2, 0x60, v2, s6
	v_dual_add_nc_u32 v5, 32, v3 :: v_dual_lshrrev_b32 v4, 4, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_add_nc_u32_e32 v38, v3, v1
	v_add_nc_u32_e32 v1, 0x620, v3
	v_dual_lshrrev_b32 v2, 4, v2 :: v_dual_add_nc_u32 v8, 64, v3
	s_delay_alu instid0(VALU_DEP_4)
	v_mad_u32_u24 v7, 0x600, v39, v5
	v_dual_mov_b32 v69, v37 :: v_dual_add_nc_u32 v10, 0x1220, v3
	v_lshrrev_b32_e32 v5, 4, v5
	v_lshrrev_b32_e32 v1, 4, v1
	v_mad_u32_u24 v11, 0x600, v39, v8
	...
	v_add_nc_u32_e32 v9, 0xc20, v3
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_add_nc_u32 v42, v3, v4 :: v_dual_lshrrev_b32 v11, 4, v11
	v_and_b32_e32 v14, 0x7f8, v1
	v_mad_u32_u24 v4, 0x600, v39, v3
	v_and_b32_e32 v5, 0xf8, v5
	v_lshrrev_b32_e32 v8, 4, v8
	v_add_nc_u32_e32 v13, 0xc40, v3
	v_sub_nc_u32_e32 v15, 0x197f, v0
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_add_nc_u32 v48, v7, v4 :: v_dual_add_nc_u32 v50, v5, v3
	v_dual_add_nc_u32 v58, v14, v4 :: v_dual_mov_b32 v4, v37
	v_lshrrev_b32_e32 v9, 4, v9
	v_and_b32_e32 v8, 0xf8, v8
	v_add_nc_u32_e32 v46, v3, v2
	v_add_nc_u32_e32 v2, 0x600, v3
	v_and_b32_e32 v10, 0x1f8, v10
	s_lshl_b32 s0, s0, 6
	v_dual_add_nc_u32 v60, v8, v3 :: v_dual_mov_b32 v8, v37
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_nc_u32 v52, v12, v2 :: v_dual_mov_b32 v12, v37
	v_dual_lshrrev_b32 v13, 4, v13 :: v_dual_lshrrev_b32 v15, 8, v15
	s_ashr_i32 s1, s0, 31
	s_wait_kmcnt 0x0
	s_bfe_i64 s[6:7], s[20:21], 0x200000
	s_mov_b32 s42, s5
	...
	s_mul_u64 s[4:5], s[6:7], s[4:5]
	v_and_b32_e32 v43, 26, v15
	s_add_nc_u64 s[20:21], s[14:15], s[0:1]
	s_lshl_b64 s[0:1], s[4:5], 1
	v_add_nc_u32_e32 v1, 0x1240, v3
	s_add_nc_u64 s[38:39], s[18:19], s[0:1]
	v_cmp_ne_u32_e64 s0, v15, v43
	v_dual_mov_b32 v14, v37 :: v_dual_add_nc_u32 v15, 0x1200, v3
	v_and_b32_e32 v6, 0x1f8, v6
	v_and_b32_e32 v9, 0x1f8, v9
	v_and_b32_e32 v11, 0xf8, v11
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v56, v10, v15 :: v_dual_mov_b32 v10, v37
	v_lshrrev_b32_e32 v1, 4, v1
	v_and_b32_e32 v13, 0x1f8, v13
	v_add_nc_u32_e32 v44, v3, v6
	v_dual_mov_b32 v5, v37 :: v_dual_add_nc_u32 v6, 0xc00, v3
	v_and_b32_e32 v16, 0x1f8, v1
	v_sub_nc_u32_e32 v1, 0xcbf, v0
	v_mov_b32_e32 v3, v37
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_add_nc_u32_e32 v54, v9, v6
	v_dual_mov_b32 v7, v37 :: v_dual_add_nc_u32 v62, v11, v2
	v_lshrrev_b32_e32 v40, 8, v1
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v64, v13, v6 :: v_dual_add_nc_u32 v66, v16, v15
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v2, v37 :: v_dual_add_nc_u32 v17, 2, v40
	v_add_nc_u32_e32 v35, -1, v40
	v_lshl_or_b32 v18, v43, 8, v0
	v_dual_mov_b32 v6, v37 :: v_dual_mov_b32 v9, v37
	v_dual_mov_b32 v11, v37 :: v_dual_bitop2_b32 v45, 30, v17 bitop3:0x40
	v_mov_b32_e32 v13, v37
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v26, v37 :: v_dual_add_nc_u32 v47, 0xffffff00, v18
	v_dual_mov_b32 v15, v37 :: v_dual_lshlrev_b32 v68, 2, v18
	v_dual_mov_b32 v17, v37 :: v_dual_mov_b32 v16, v37
	...
	v_dual_mov_b32 v33, v37 :: v_dual_mov_b32 v18, v37
	v_dual_mov_b32 v19, v37 :: v_dual_mov_b32 v20, v37
...
; %bb.22:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	s_cmp_lg_u32 s5, 0
	s_mov_b32 s1, 0
	s_cselect_b32 s7, s42, s35
	s_cselect_b32 s6, s43, 0
.LBB0_23:                               ;   Parent Loop BB0_21 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v36, v70 :: v_dual_add_nc_u32 v49, -2, v49
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v49, s2 :: v_dual_mov_b32 v70, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v49, s5 :: v_dual_mov_b32 v70, s6
	s_bitset1_b32 s7, 31
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	ds_load_b128 v[82:85], v49 offset:16
	v_lshl_add_u32 v36, v42, 1, s2
	v_lshl_add_u32 v49, v46, 1, s2
	v_lshl_add_u32 v57, v56, 1, s2
	ds_load_b128 v[94:97], v51 offset:64
	ds_load_b128 v[98:101], v51 offset:80
	ds_load_b128 v[86:89], v36 offset:3072
	ds_load_b128 v[110:113], v53 offset:64
	ds_load_b128 v[114:117], v53 offset:80
	ds_load_b128 v[118:121], v55 offset:64
	ds_load_b128 v[122:125], v55 offset:80
	ds_load_b128 v[126:129], v57 offset:64
	ds_load_b128 v[130:133], v57 offset:80
	...
	ds_load_b128 v[78:81], v49 offset:9216
	ds_load_b128 v[82:85], v49 offset:9232
	v_lshl_add_u32 v49, v48, 1, s1
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[70:77], v[78:85], v[18:25] matrix_a_reuse
	ds_load_b128 v[78:81], v49 offset:64
	ds_load_b128 v[82:85], v49 offset:80
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[70:77], v[86:93], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v36, v58, 1, s1
	v_lshl_add_u32 v49, v60, 1, s2
	v_lshl_add_u32 v51, v62, 1, s2
	ds_load_b128 v[70:73], v36 offset:128
	ds_load_b128 v[74:77], v36 offset:144
	ds_load_b128 v[86:89], v49 offset:128
	ds_load_b128 v[90:93], v49 offset:144
	v_lshl_add_u32 v36, v64, 1, s2
	v_lshl_add_u32 v49, v66, 1, s2
	ds_load_b128 v[102:105], v51 offset:128
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[26:33], v[78:85], v[94:101], v[26:33]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[78:85], v[110:117], v[10:17] matrix_a_reuse
	ds_load_b128 v[106:109], v51 offset:144
	ds_load_b128 v[94:97], v36 offset:128
	ds_load_b128 v[98:101], v36 offset:144
	ds_load_b128 v[110:113], v49 offset:128
	ds_load_b128 v[114:117], v49 offset:144
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	...
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[10:17], v[70:77], v[102:109], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[70:77], v[94:101], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[70:77], v[110:117], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.43:
	v_dual_lshrrev_b32 v1, 1, v0 :: v_dual_lshlrev_b32 v34, 7, v0
	v_cvt_pk_bf16_f32 v33, v32, v33
	v_cvt_pk_bf16_f32 v32, v30, v31
	v_cvt_pk_bf16_f32 v30, v26, v27
	v_cvt_pk_bf16_f32 v17, v16, v17
	v_bitop3_b32 v1, v34, 0x788, v1 bitop3:0xc8
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v13, 3, v26 :: v_dual_lshrrev_b32 v14, 3, v27
	v_and_b32_e32 v26, 0xf0, v35
	v_lshrrev_b32_e32 v1, 3, v1
	v_lshl_or_b32 v12, v39, 5, v12
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn064_bk096_wm8_wn1_mc0, .Lfunc_end0-bm128_bn064_bk096_wm8_wn1_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn064_bk096_wm8_wn1_mc0
	...
	.section	.text.bm128_bn064_bk096_wm8_wn1_mc0,"axG",@progbits,bm128_bn064_bk096_wm8_wn1_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn064_bk096_wm8_wn1_mc0.num_vgpr, 134
	.set .Lbm128_bn064_bk096_wm8_wn1_mc0.num_agpr, 0
	.set .Lbm128_bn064_bk096_wm8_wn1_mc0.numbered_sgpr, 56
	.set .Lbm128_bn064_bk096_wm8_wn1_mc0.num_named_barrier, 0
	.set .Lbm128_bn064_bk096_wm8_wn1_mc0.private_seg_size, 0
	.set .Lbm128_bn064_bk096_wm8_wn1_mc0.uses_vcc, 1
	.set .Lbm128_bn064_bk096_wm8_wn1_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn064_bk096_wm8_wn1_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn064_bk096_wm8_wn1_mc0.has_recursion, 0
	.set .Lbm128_bn064_bk096_wm8_wn1_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_c70958f7f061af8d,@object ; @__hip_cuid_c70958f7f061af8d
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_c70958f7f061af8d
__hip_cuid_c70958f7f061af8d:
	.byte	0                               ; 0x0
	.size	__hip_cuid_c70958f7f061af8d, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_c70958f7f061af8d
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn064_bk096_wm8_wn1_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn064_bk096_wm8_wn1_mc0.kd
