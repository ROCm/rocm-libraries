	...
	.section	.text.bm256_bn064_bk032_wm8_wn1_mc0,"axG",@progbits,bm256_bn064_bk032_wm8_wn1_mc0,comdat
	.protected	bm256_bn064_bk032_wm8_wn1_mc0 ; -- Begin function bm256_bn064_bk032_wm8_wn1_mc0
	.globl	bm256_bn064_bk032_wm8_wn1_mc0
	.p2align	8
	.type	bm256_bn064_bk032_wm8_wn1_mc0,@function
bm256_bn064_bk032_wm8_wn1_mc0: ; @bm256_bn064_bk032_wm8_wn1_mc0
; %bb.0:
...
.LBB0_18:
	...
	v_dual_mov_b32 v18, v9 :: v_dual_mov_b32 v57, v9
...
; %bb.19:
	v_dual_lshlrev_b32 v3, 5, v0 :: v_dual_mov_b32 v69, 0
	v_dual_lshlrev_b32 v1, 10, v73 :: v_dual_bitop2_b32 v2, 16, v0 bitop3:0x40
	...
	v_or_b32_e32 v3, 0x600, v3
	s_add_co_i32 s4, s6, 0x9900
	s_add_co_i32 s42, s6, 0x5500
	v_dual_add_nc_u32 v66, v1, v4 :: v_dual_lshrrev_b32 v1, 4, v5
	v_dual_lshlrev_b32 v5, 1, v0 :: v_dual_lshrrev_b32 v6, 4, v6
	s_and_b32 s10, s4, 15
	s_mov_b32 s43, s5
	...
	v_dual_lshrrev_b32 v3, 4, v3 :: v_dual_add_nc_u32 v70, v2, v5
	v_and_b32_e32 v5, 56, v6
	v_dual_mov_b32 v83, v69 :: v_dual_sub_nc_u32 v6, 0x43f, v0
	...
	s_cmp_lt_i32 s3, 64
	v_and_b32_e32 v7, 0x58, v1
	s_cselect_b32 s45, -1, 0
	s_lshl_b32 s4, s0, 6
	s_lshl_b32 s6, s2, 8
	v_and_b32_e32 v3, 0x78, v3
	v_dual_add_nc_u32 v6, 2, v72 :: v_dual_add_nc_u32 v76, v2, v5
	s_ashr_i32 s5, s4, 31
	s_ashr_i32 s7, s6, 31
	s_wait_kmcnt 0x0
	...
	v_dual_add_nc_u32 v74, v8, v4 :: v_dual_bitop2_b32 v75, 14, v6 bitop3:0x40
	v_add_nc_u32_e32 v78, v2, v7
	v_dual_mov_b32 v3, v69 :: v_dual_add_nc_u32 v80, v2, v3
	...
	v_dual_mov_b32 v25, v69 :: v_dual_mov_b32 v50, v69
	...
	v_dual_mov_b32 v49, v69 :: v_dual_mov_b32 v67, v72
...
.LBB0_23:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_dual_mov_b32 v68, v84 :: v_dual_add_nc_u32 v77, -2, v77
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v77, s14 :: v_dual_mov_b32 v84, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v77, s5 :: v_dual_mov_b32 v84, s6
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v77, v74, 1, s0
	v_lshl_add_u32 v79, v76, 1, s2
	ds_load_b128 v[84:87], v68
	ds_load_b128 v[88:91], v68 offset:16
	ds_load_b128 v[92:95], v77 offset:1024
	ds_load_b128 v[100:103], v79 offset:1024
	ds_load_b128 v[104:107], v79 offset:1040
	ds_load_b128 v[96:99], v77 offset:1040
	v_lshl_add_u32 v68, v78, 1, s2
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[50:57], v[84:91], v[100:107], v[50:57] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[92:99], v[100:107], v[26:33] matrix_a_reuse
	ds_load_b128 v[100:103], v68 offset:2048
	ds_load_b128 v[104:107], v68 offset:2064
	v_lshl_add_u32 v68, v80, 1, s2
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[92:99], v[100:107], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[84:91], v[100:107], v[18:25] matrix_a_reuse
	ds_load_b128 v[100:103], v68 offset:3072
	ds_load_b128 v[104:107], v68 offset:3088
	v_lshl_add_u32 v68, v70, 1, s2
	ds_load_b128 v[112:115], v68 offset:16
	ds_load_b128 v[108:111], v68
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[92:99], v[108:115], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[84:91], v[108:115], v[58:65]
	...
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[92:99], v[100:107], v[42:49]
...
; %bb.43:
	...
	v_dual_lshrrev_b32 v18, 3, v1 :: v_dual_lshlrev_b32 v21, 1, v1
	v_or_b32_e32 v1, 0x3000, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v19, 3, v50 :: v_dual_lshrrev_b32 v20, 3, v51
	v_and_b32_e32 v18, 0x1f0, v18
	v_cvt_pk_bf16_f32 v9, v8, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshrrev_b32_e32 v1, 3, v1
	v_and_b32_e32 v19, 0x3f0, v19
	v_and_b32_e32 v20, 0x5f0, v20
	...
	ds_store_b128 v19, v[54:57] offset:8192
	ds_store_b128 v19, v[2:5] offset:8224
	ds_store_b128 v20, v[22:25] offset:16384
	ds_store_b128 v20, v[6:9] offset:16416
	ds_store_b128 v1, v[14:17] offset:24576
	ds_store_b128 v1, v[10:13] offset:24608
.LBB0_44:
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn064_bk032_wm8_wn1_mc0, .Lfunc_end0-bm256_bn064_bk032_wm8_wn1_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn064_bk032_wm8_wn1_mc0
	...
	.section	.text.bm256_bn064_bk032_wm8_wn1_mc0,"axG",@progbits,bm256_bn064_bk032_wm8_wn1_mc0,comdat
                                        ; -- End function
	.set .Lbm256_bn064_bk032_wm8_wn1_mc0.num_vgpr, 116
	.set .Lbm256_bn064_bk032_wm8_wn1_mc0.num_agpr, 0
	.set .Lbm256_bn064_bk032_wm8_wn1_mc0.numbered_sgpr, 56
	.set .Lbm256_bn064_bk032_wm8_wn1_mc0.num_named_barrier, 0
	.set .Lbm256_bn064_bk032_wm8_wn1_mc0.private_seg_size, 0
	.set .Lbm256_bn064_bk032_wm8_wn1_mc0.uses_vcc, 1
	.set .Lbm256_bn064_bk032_wm8_wn1_mc0.uses_flat_scratch, 1
	.set .Lbm256_bn064_bk032_wm8_wn1_mc0.has_dyn_sized_stack, 0
	.set .Lbm256_bn064_bk032_wm8_wn1_mc0.has_recursion, 0
	.set .Lbm256_bn064_bk032_wm8_wn1_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_fb9cff6f9d4c8b39,@object ; @__hip_cuid_fb9cff6f9d4c8b39
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_fb9cff6f9d4c8b39
__hip_cuid_fb9cff6f9d4c8b39:
	.byte	0                               ; 0x0
	.size	__hip_cuid_fb9cff6f9d4c8b39, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_fb9cff6f9d4c8b39
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn064_bk032_wm8_wn1_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn064_bk032_wm8_wn1_mc0.kd
