	...
	.section	.text.bm064_bn256_bk064_wm4_wn2_mc0,"axG",@progbits,bm064_bn256_bk064_wm4_wn2_mc0,comdat
	.protected	bm064_bn256_bk064_wm4_wn2_mc0 ; -- Begin function bm064_bn256_bk064_wm4_wn2_mc0
	.globl	bm064_bn256_bk064_wm4_wn2_mc0
	.p2align	8
	.type	bm064_bn256_bk064_wm4_wn2_mc0,@function
bm064_bn256_bk064_wm4_wn2_mc0: ; @bm064_bn256_bk064_wm4_wn2_mc0
; %bb.0:
...
; %bb.19:
	...
	s_or_b32 s6, s34, 0xaa00
	s_mov_b32 s7, s5
	v_dual_lshlrev_b32 v2, 6, v77 :: v_dual_lshlrev_b32 v3, 6, v75
	...
	s_add_co_i32 s42, s6, 0xaa00
	s_and_b32 s10, s4, 15
	v_or_b32_e32 v8, 0x400, v5
	v_and_b32_e32 v6, 0xf8, v6
	s_sub_co_i32 s7, 16, s10
	v_or_b32_e32 v9, 0x800, v5
	s_lshr_b32 s6, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_and_b32_e32 v7, 0x238, v7
	v_dual_mov_b32 v69, 0 :: v_dual_add_nc_u32 v66, v6, v1
	v_or_b32_e32 v1, 0xc00, v5
	v_or_b32_e32 v12, 0x1000, v5
	v_or_b32_e32 v13, 0x1400, v5
	v_or_b32_e32 v14, 0x1800, v5
	v_or_b32_e32 v15, 0x1c00, v5
	s_cselect_b32 s6, s6, 0
	s_ashr_i32 s7, s17, 31
	v_dual_lshrrev_b32 v8, 4, v8 :: v_dual_lshrrev_b32 v9, 4, v9
	s_lshr_b32 s7, s7, 26
	v_dual_add_nc_u32 v70, v7, v5 :: v_dual_lshrrev_b32 v12, 4, v12
	s_add_co_i32 s17, s17, s7
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_lshrrev_b32 v14, 4, v14
	v_dual_lshrrev_b32 v13, 4, v13 :: v_dual_lshrrev_b32 v15, 4, v15
	s_lshl_b32 s10, s6, 2
	...
	s_lshl_b32 s4, s0, 8
	s_lshl_b32 s6, s2, 6
	v_and_b32_e32 v10, 0x278, v8
	v_and_b32_e32 v11, 0x2b8, v9
	v_and_b32_e32 v16, 0x2f8, v1
	v_and_b32_e32 v17, 0x338, v12
	v_and_b32_e32 v18, 0x378, v13
	v_and_b32_e32 v19, 0x3b8, v14
	...
	v_dual_add_nc_u32 v1, 2, v72 :: v_dual_add_nc_u32 v2, v4, v2
	v_add_nc_u32_e32 v82, v18, v5
	s_ashr_i32 s5, s4, 31
	s_ashr_i32 s7, s6, 31
	s_wait_kmcnt 0x0
	...
	v_dual_mov_b32 v67, v72 :: v_dual_bitop2_b32 v79, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v74, v10, v5 :: v_dual_add_nc_u32 v76, v11, v5
	v_dual_add_nc_u32 v78, v16, v5 :: v_dual_add_nc_u32 v80, v17, v5
	v_dual_mov_b32 v107, v69 :: v_dual_add_nc_u32 v84, v19, v5
	v_add_nc_u32_e32 v86, v15, v5
	v_add3_u32 v88, v4, v3, v6
	v_dual_mov_b32 v3, v69 :: v_dual_add_nc_u32 v90, v7, v2
	v_add3_u32 v92, v2, v8, 0x400
	v_add3_u32 v94, v2, v9, 0x800
	v_add3_u32 v96, v2, v20, 0xc00
	v_add3_u32 v98, v2, v12, 0x1000
	v_add3_u32 v100, v2, v13, 0x1400
	v_add3_u32 v102, v2, v14, 0x1800
	v_add3_u32 v104, v2, v15, 0x1c00
	v_or_b32_e32 v81, 0x2100, v0
	v_lshl_or_b32 v106, v0, 2, 0x8800
...
.LBB0_24:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s15, v67
	v_cmpx_le_u32_e64 s14, v72
	s_cbranch_execz .LBB0_26
; %bb.25:                               ;   in Loop: Header=BB0_24 Depth=2
	v_mov_b32_e32 v68, v108
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[110:111], v[68:69], 2, s[12:13]
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v83, s14 :: v_dual_mov_b32 v108, s12
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v83, v70, 1, s0
	v_lshl_add_u32 v85, v82, 1, s0
	v_lshl_add_u32 v87, v88, 1, s2
	v_lshl_add_u32 v89, v90, 1, s0
	ds_load_b128 v[108:111], v68
	ds_load_b128 v[112:115], v68 offset:16
	v_lshl_add_u32 v68, v74, 1, s0
	ds_load_b128 v[116:119], v83
	ds_load_b128 v[120:123], v83 offset:16
	v_lshl_add_u32 v83, v78, 1, s0
	v_lshl_add_u32 v91, v94, 1, s0
	ds_load_b128 v[124:127], v68 offset:2048
	ds_load_b128 v[128:131], v68 offset:2064
	v_lshl_add_u32 v68, v76, 1, s0
	ds_load_b128 v[140:143], v83 offset:6144
	v_lshl_add_u32 v93, v96, 1, s0
	v_lshl_add_u32 v95, v98, 1, s0
	v_lshl_add_u32 v97, v100, 1, s0
	ds_load_b128 v[132:135], v68 offset:4096
	ds_load_b128 v[136:139], v68 offset:4112
	v_lshl_add_u32 v68, v84, 1, s0
	v_lshl_add_u32 v99, v102, 1, s0
	ds_load_b128 v[148:151], v89 offset:64
	ds_load_b128 v[152:155], v89 offset:80
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[58:65], v[108:115], v[116:123], v[58:65]
	ds_load_b128 v[164:167], v91 offset:64
	ds_load_b128 v[168:171], v91 offset:80
	ds_load_b128 v[172:175], v95 offset:64
	ds_load_b128 v[176:179], v95 offset:80
	ds_load_b128 v[180:183], v97 offset:64
	ds_load_b128 v[184:187], v97 offset:80
	...
	ds_load_b128 v[132:135], v85 offset:10240
	ds_load_b128 v[136:139], v85 offset:10256
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[108:115], v[132:139], v[10:17] matrix_a_reuse
	ds_load_b128 v[116:119], v68 offset:12288
	ds_load_b128 v[120:123], v68 offset:12304
	v_lshl_add_u32 v68, v86, 1, s0
	ds_load_b128 v[144:147], v83 offset:6160
	v_lshl_add_u32 v83, v92, 1, s0
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	ds_load_b128 v[156:159], v83 offset:64
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[108:115], v[116:123], v[2:9] matrix_a_reuse
	ds_load_b128 v[116:119], v68 offset:14336
	ds_load_b128 v[120:123], v68 offset:14352
	v_lshl_add_u32 v68, v80, 1, s0
	ds_load_b128 v[160:163], v83 offset:80
	ds_load_b128 v[124:127], v68 offset:8192
	ds_load_b128 v[128:131], v68 offset:8208
	v_lshl_add_u32 v68, v104, 1, s0
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[34:41], v[108:115], v[116:123], v[34:41] matrix_a_reuse
	ds_load_b128 v[116:119], v87 offset:64
	ds_load_b128 v[120:123], v87 offset:80
	ds_load_b128 v[188:191], v68 offset:64
	ds_load_b128 v[192:195], v68 offset:80
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[108:115], v[140:147], v[26:33] matrix_a_reuse
	ds_load_b128 v[140:143], v93 offset:64
	ds_load_b128 v[144:147], v93 offset:80
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[18:25], v[108:115], v[124:131], v[18:25] matrix_a_reuse
	ds_load_b128 v[124:127], v99 offset:64
	ds_load_b128 v[128:131], v99 offset:80
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[58:65], v[116:123], v[148:155], v[58:65]
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[116:123], v[156:163], v[50:57] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[116:123], v[164:171], v[42:49] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[116:123], v[140:147], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[116:123], v[172:179], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[116:123], v[180:187], v[10:17] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[116:123], v[124:131], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[116:123], v[188:195], v[34:41] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.43:
	...
	v_add_nc_u32_e32 v28, 0x1800, v1
	...
	v_dual_lshrrev_b32 v45, 3, v45 :: v_dual_lshrrev_b32 v51, 3, v51
	...
	v_dual_add_nc_u32 v42, v45, v50 :: v_dual_add_nc_u32 v27, v44, v50
	v_add_nc_u32_e32 v18, v26, v50
	...
	ds_store_b128 v42, v[30:33] offset:6144
	ds_store_b128 v27, v[22:25] offset:8192
	ds_store_b128 v18, v[14:17] offset:10240
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn256_bk064_wm4_wn2_mc0, .Lfunc_end0-bm064_bn256_bk064_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn256_bk064_wm4_wn2_mc0
	...
	.section	.text.bm064_bn256_bk064_wm4_wn2_mc0,"axG",@progbits,bm064_bn256_bk064_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn256_bk064_wm4_wn2_mc0.num_vgpr, 196
	.set .Lbm064_bn256_bk064_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm064_bn256_bk064_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm064_bn256_bk064_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm064_bn256_bk064_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm064_bn256_bk064_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm064_bn256_bk064_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn256_bk064_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn256_bk064_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm064_bn256_bk064_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_9ae92cdac61de991,@object ; @__hip_cuid_9ae92cdac61de991
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_9ae92cdac61de991
__hip_cuid_9ae92cdac61de991:
	.byte	0                               ; 0x0
	.size	__hip_cuid_9ae92cdac61de991, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_9ae92cdac61de991
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn256_bk064_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn256_bk064_wm4_wn2_mc0.kd
