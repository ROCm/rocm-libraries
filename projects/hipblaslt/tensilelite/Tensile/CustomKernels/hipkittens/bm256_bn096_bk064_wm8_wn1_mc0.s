	...
	.section	.text.bm256_bn096_bk064_wm8_wn1_mc0,"axG",@progbits,bm256_bn096_bk064_wm8_wn1_mc0,comdat
	.protected	bm256_bn096_bk064_wm8_wn1_mc0 ; -- Begin function bm256_bn096_bk064_wm8_wn1_mc0
	.globl	bm256_bn096_bk064_wm8_wn1_mc0
	.p2align	8
	.type	bm256_bn096_bk064_wm8_wn1_mc0,@function
bm256_bn096_bk064_wm8_wn1_mc0: ; @bm256_bn096_bk064_wm8_wn1_mc0
; %bb.0:
...
; %bb.8:                                ;   in Loop: Header=BB0_7 Depth=1
	ds_store_b32 v3, v5 offset:34816
; %bb.9:                                ;   in Loop: Header=BB0_7 Depth=1
	s_or_b32 exec_lo, exec_lo, s10
	s_and_saveexec_b32 s2, vcc_lo
	s_cbranch_execz .LBB0_6
; %bb.10:                               ;   in Loop: Header=BB0_7 Depth=1
	ds_store_b32 v3, v5 offset:35840
	s_branch .LBB0_6
.LBB0_11:
...
.LBB0_18:
	...
	v_cndmask_b32_e64 v103, 0, 1, s39
	s_delay_alu instid0(VALU_DEP_2)
	...
	v_dual_mov_b32 v90, v9 :: v_dual_mov_b32 v65, v9
...
; %bb.19:
	...
	v_or_b32_e32 v109, 0x2100, v0
	v_and_or_b32 v2, v0, 16, v1
	s_lshr_b32 s4, s4, 2
	v_or_b32_e32 v7, 0x400, v1
	s_cmp_lg_u64 s[6:7], 0
	v_or_b32_e32 v8, 0x1000, v1
	v_lshl_or_b32 v3, v105, 11, v2
	s_cselect_b32 s4, s4, 0
	s_mul_i32 s6, s34, 0x60
	s_lshl2_add_u32 s0, s4, s0
	v_or_b32_e32 v120, 0x8800, v98
	v_lshrrev_b32_e32 v4, 4, v3
	v_or_b32_e32 v5, 0x400, v3
	s_add_co_i32 s4, s0, 0x14300
	s_add_co_i32 s42, s0, 0xbb00
	s_and_b32 s10, s4, 15
	v_and_b32_e32 v4, 0x3b8, v4
	v_dual_lshrrev_b32 v5, 4, v5 :: v_dual_bitop2_b32 v6, 56, v98 bitop3:0x40
	v_mov_b32_e32 v99, 0
	s_sub_co_i32 s7, 16, s10
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add_nc_u32_e32 v100, v4, v3
	v_and_b32_e32 v4, 0x3f8, v5
	v_dual_add_nc_u32 v102, v2, v6 :: v_dual_lshrrev_b32 v6, 4, v7
	...
	s_lshr_b32 s0, s7, 2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v5, 4, v5 :: v_dual_lshrrev_b32 v7, 4, v7
	v_lshrrev_b32_e32 v1, 4, v1
	s_cmp_lg_u64 s[10:11], 0
	v_and_b32_e32 v6, 0x78, v6
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v5, 0xb8, v5
	v_sub_nc_u32_e32 v9, 0xcbf, v0
	v_and_b32_e32 v7, 0xf8, v7
	v_and_b32_e32 v8, 0x138, v8
	v_and_b32_e32 v10, 0x178, v1
	s_cselect_b32 s0, s0, 0
	s_ashr_i32 s7, s17, 31
	v_dual_add_nc_u32 v106, v3, v4 :: v_dual_add_nc_u32 v108, v6, v2
	s_lshr_b32 s7, s7, 26
	v_dual_add_nc_u32 v110, v5, v2 :: v_dual_add_nc_u32 v112, v7, v2
	s_add_co_i32 s17, s17, s7
	v_dual_add_nc_u32 v114, v8, v2 :: v_dual_add_nc_u32 v116, v10, v2
	v_dual_mov_b32 v2, v99 :: v_dual_lshrrev_b32 v104, 8, v9
	s_lshl_b32 s10, s0, 2
	...
	v_dual_add_nc_u32 v101, -1, v104 :: v_dual_bitop2_b32 v107, 30, v9 bitop3:0x40
	v_dual_mov_b32 v121, v99 :: v_dual_add_nc_u32 v118, 0x400, v106
	...
	v_dual_mov_b32 v49, v99 :: v_dual_mov_b32 v50, v99
	...
	v_dual_mov_b32 v57, v99 :: v_dual_mov_b32 v66, v99
	...
	v_dual_mov_b32 v97, v99 :: v_dual_mov_b32 v58, v99
...
.LBB0_23:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_dual_mov_b32 v98, v122 :: v_dual_add_nc_u32 v111, -2, v111
	v_dual_mov_b32 v124, v123 :: v_dual_mov_b32 v125, v99
	v_add_nc_u32_e32 v123, 0x200, v123
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[126:127], v[98:99], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v111
	v_add_nc_u32_e32 v122, 0x200, v122
	v_lshl_add_u64 v[124:125], v[124:125], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[126:127], v99
	flat_store_b32 v[124:125], v99
...
; %bb.25:                               ;   in Loop: Header=BB0_21 Depth=1
	v_add_nc_u64_e32 v[122:123], s[6:7], v[120:121]
...
.LBB0_26:                               ;   Parent Loop BB0_21 Depth=1
	...
	flat_store_b32 v[122:123], v99
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[122:123], 0x400, v[122:123]
...
.LBB0_28:                               ;   in Loop: Header=BB0_29 Depth=2
	...
	v_add_nc_u32_e32 v123, 0x200, v123
	v_cmp_eq_u32_e32 vcc_lo, s12, v107
	v_add_nc_u32_e32 v122, 0x200, v122
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s12, v101
	v_cmpx_le_u32_e64 s12, v104
	s_cbranch_execz .LBB0_31
; %bb.30:                               ;   in Loop: Header=BB0_29 Depth=2
	v_mov_b32_e32 v98, v122
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[124:125], v[98:99], 2, s[6:7]
	flat_store_b32 v[124:125], v99
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v111, s14 :: v_dual_mov_b32 v122, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_dual_mov_b32 v111, s5 :: v_dual_mov_b32 v122, s6
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v98, v100, 1, s0
	v_lshl_add_u32 v111, v106, 1, s0
	v_lshl_add_u32 v186, v112, 1, s2
	v_lshl_add_u32 v115, v110, 1, s2
	v_lshl_add_u32 v113, v116, 1, s2
	ds_load_b128 v[122:125], v98
	ds_load_b128 v[126:129], v98 offset:16
	ds_load_b128 v[130:133], v111 offset:2048
	ds_load_b128 v[134:137], v111 offset:2064
	ds_load_b128 v[162:165], v186 offset:6144
	ds_load_b128 v[166:169], v186 offset:6160
	v_lshl_add_u32 v111, v114, 1, s2
	v_lshl_add_u32 v117, v108, 1, s2
	v_lshl_add_u32 v119, v102, 1, s2
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[66:73], v[122:129], v[162:169], v[66:73] matrix_a_reuse
	ds_load_b128 v[146:149], v115 offset:4096
	ds_load_b128 v[150:153], v115 offset:4112
	ds_load_b128 v[170:173], v119 offset:64
	ds_load_b128 v[174:177], v119 offset:80
	ds_load_b128 v[178:181], v117 offset:2112
	ds_load_b128 v[182:185], v117 offset:2128
	ds_load_b128 v[190:193], v111 offset:8272
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[74:81], v[122:129], v[146:153], v[74:81] matrix_a_reuse
	ds_load_b128 v[138:141], v113 offset:10240
	ds_load_b128 v[142:145], v113 offset:10256
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[122:129], v[138:145], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[130:137], v[138:145], v[58:65]
	ds_load_b128 v[138:141], v111 offset:8192
	ds_load_b128 v[142:145], v111 offset:8208
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[130:137], v[138:145], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[130:137], v[146:153], v[18:25] matrix_a_reuse
	ds_load_b128 v[154:157], v117 offset:2048
	ds_load_b128 v[158:161], v117 offset:2064
	ds_load_b128 v[146:149], v98 offset:64
	ds_load_b128 v[150:153], v98 offset:80
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[122:129], v[138:145], v[50:57] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[130:137], v[154:161], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[122:129], v[154:161], v[82:89] matrix_a_reuse
	ds_load_b128 v[154:157], v119
	ds_load_b128 v[158:161], v119 offset:16
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[130:137], v[154:161], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[90:97], v[122:129], v[154:161], v[90:97]
	ds_load_b128 v[122:125], v115 offset:4160
	ds_load_b128 v[126:129], v115 offset:4176
	v_nop
	v_nop
	v_nop
	v_nop
	v_lshl_add_u32 v158, v118, 1, s0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[130:137], v[162:169], v[10:17] matrix_a_reuse
	ds_load_b128 v[162:165], v186 offset:6208
	ds_load_b128 v[166:169], v186 offset:6224
	ds_load_b128 v[186:189], v111 offset:8256
	ds_load_b128 v[154:157], v158 offset:64
	ds_load_b128 v[158:161], v158 offset:80
	ds_load_b128 v[130:133], v113 offset:10304
	ds_load_b128 v[134:137], v113 offset:10320
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_wmma_f32_16x16x32_bf16 v[90:97], v[146:153], v[170:177], v[90:97]
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[82:89], v[146:153], v[178:185], v[82:89] matrix_a_reuse
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[74:81], v[146:153], v[122:129], v[74:81] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[66:73], v[146:153], v[162:169], v[66:73] matrix_a_reuse
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[50:57], v[146:153], v[186:193], v[50:57] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[146:153], v[130:137], v[42:49] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[154:161], v[130:137], v[58:65]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[154:161], v[186:193], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[154:161], v[162:169], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[154:161], v[122:129], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[154:161], v[178:185], v[26:33] matrix_a_reuse
...
; %bb.43:
	...
	v_dual_lshrrev_b32 v83, 3, v83 :: v_dual_lshrrev_b32 v84, 3, v84
	v_and_b32_e32 v78, 0x3f0, v78
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v82, 3, v82 :: v_dual_lshrrev_b32 v1, 3, v1
	...
	ds_store_b128 v76, v[38:41] offset:32
	ds_store_b128 v85, v[86:89] offset:8192
	ds_store_b128 v85, v[30:33] offset:8224
	ds_store_b128 v82, v[78:81] offset:16384
	ds_store_b128 v82, v[22:25] offset:16416
	v_cvt_pk_bf16_f32 v5, v64, v65
	v_cvt_pk_bf16_f32 v4, v62, v63
	v_cvt_pk_bf16_f32 v3, v60, v61
	v_cvt_pk_bf16_f32 v2, v58, v59
	ds_store_b128 v66, v[70:73] offset:24576
	ds_store_b128 v66, v[14:17] offset:24608
	ds_store_b128 v67, v[54:57] offset:32768
	ds_store_b128 v67, v[6:9] offset:32800
	ds_store_b128 v1, v[46:49] offset:40960
	ds_store_b128 v1, v[2:5] offset:40992
.LBB0_44:
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn096_bk064_wm8_wn1_mc0, .Lfunc_end0-bm256_bn096_bk064_wm8_wn1_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn096_bk064_wm8_wn1_mc0
	...
	.section	.text.bm256_bn096_bk064_wm8_wn1_mc0,"axG",@progbits,bm256_bn096_bk064_wm8_wn1_mc0,comdat
                                        ; -- End function
	.set .Lbm256_bn096_bk064_wm8_wn1_mc0.num_vgpr, 194
	.set .Lbm256_bn096_bk064_wm8_wn1_mc0.num_agpr, 0
	.set .Lbm256_bn096_bk064_wm8_wn1_mc0.numbered_sgpr, 56
	.set .Lbm256_bn096_bk064_wm8_wn1_mc0.num_named_barrier, 0
	.set .Lbm256_bn096_bk064_wm8_wn1_mc0.private_seg_size, 0
	.set .Lbm256_bn096_bk064_wm8_wn1_mc0.uses_vcc, 1
	.set .Lbm256_bn096_bk064_wm8_wn1_mc0.uses_flat_scratch, 1
	.set .Lbm256_bn096_bk064_wm8_wn1_mc0.has_dyn_sized_stack, 0
	.set .Lbm256_bn096_bk064_wm8_wn1_mc0.has_recursion, 0
	.set .Lbm256_bn096_bk064_wm8_wn1_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_17c3ef773913e5a7,@object ; @__hip_cuid_17c3ef773913e5a7
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_17c3ef773913e5a7
__hip_cuid_17c3ef773913e5a7:
	.byte	0                               ; 0x0
	.size	__hip_cuid_17c3ef773913e5a7, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_17c3ef773913e5a7
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn096_bk064_wm8_wn1_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn096_bk064_wm8_wn1_mc0.kd
