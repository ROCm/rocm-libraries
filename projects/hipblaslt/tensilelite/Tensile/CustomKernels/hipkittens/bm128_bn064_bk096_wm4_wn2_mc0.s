	...
	.section	.text.bm128_bn064_bk096_wm4_wn2_mc0,"axG",@progbits,bm128_bn064_bk096_wm4_wn2_mc0,comdat
	.protected	bm128_bn064_bk096_wm4_wn2_mc0 ; -- Begin function bm128_bn064_bk096_wm4_wn2_mc0
	.globl	bm128_bn064_bk096_wm4_wn2_mc0
	.p2align	8
	.type	bm128_bn064_bk096_wm4_wn2_mc0,@function
bm128_bn064_bk096_wm4_wn2_mc0: ; @bm128_bn064_bk096_wm4_wn2_mc0
; %bb.0:
...
; %bb.19:
	...
	v_dual_mov_b32 v37, 0 :: v_dual_bitop2_b32 v5, v2, v3 bitop3:0x54
	s_cselect_b32 s4, s4, 0
	s_mov_b32 s11, 0
	...
	v_dual_add_nc_u32 v6, v6, v8 :: v_dual_mov_b32 v20, v37
	v_dual_mov_b32 v21, v37 :: v_dual_mov_b32 v22, v37
	v_dual_mov_b32 v23, v37 :: v_dual_add_nc_u32 v38, v12, v11
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_bitop2_b32 v7, v2, v9 bitop3:0x54
	v_or_b32_e32 v9, v9, v1
	v_dual_mov_b32 v24, v37 :: v_dual_bitop2_b32 v3, 64, v3 bitop3:0x54
	v_mov_b32_e32 v25, v37
	v_mad_u32_u24 v13, 0x60, v4, v7
	v_add_nc_u32_e32 v7, v7, v8
	v_and_b32_e32 v12, 0x1f8, v6
	v_or_b32_e32 v1, v1, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v42, v5, v10 :: v_dual_lshrrev_b32 v6, 4, v13
	v_mad_u32_u24 v13, 0x60, v4, v9
	v_dual_lshrrev_b32 v7, 4, v7 :: v_dual_add_nc_u32 v9, v9, v8
	v_or_b32_e32 v2, v2, v3
	v_and_b32_e32 v14, 0x7f8, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshrrev_b32_e32 v6, 4, v13
	v_and_b32_e32 v36, 0x7f8, v7
	v_lshrrev_b32_e32 v7, 4, v9
	v_mad_u32_u24 v3, 0x60, v4, v2
	v_mad_u32_u24 v4, 0x60, v4, v1
	v_and_b32_e32 v13, 0x1f8, v6
	v_dual_mov_b32 v9, v37 :: v_dual_add_nc_u32 v6, v2, v8
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v3, 4, v3 :: v_dual_add_nc_u32 v1, v1, v8
	v_and_b32_e32 v2, 0x1f8, v7
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_lshrrev_b32 v8, 4, v4
	v_sub_nc_u32_e32 v7, 0x197f, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_mov_b32 v5, v37
	v_and_b32_e32 v4, 0x7f8, v6
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v16, 0x1f8, v8
	v_add_nc_u32_e32 v8, 0x600, v10
	v_and_b32_e32 v15, 0x7f8, v3
	v_and_b32_e32 v6, 0x1f8, v1
	v_sub_nc_u32_e32 v1, 0xcbf, v0
	v_add_nc_u32_e32 v44, v12, v11
	v_add_nc_u64_e32 v[46:47], v[36:37], v[8:9]
	v_add_nc_u32_e32 v36, 0x600, v11
	v_add_nc_u64_e32 v[56:57], v[4:5], v[8:9]
	v_dual_mov_b32 v4, v37 :: v_dual_lshrrev_b32 v3, 8, v7
	v_dual_lshrrev_b32 v40, 8, v1 :: v_dual_add_nc_u32 v54, v15, v10
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v48, v14, v10 :: v_dual_add_nc_u32 v50, v13, v11
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v3, 1, v3 :: v_dual_add_nc_u32 v7, 2, v40
	v_dual_mov_b32 v8, v37 :: v_dual_add_nc_u32 v35, -1, v40
	v_dual_mov_b32 v26, v37 :: v_dual_mov_b32 v27, v37
	v_and_b32_e32 v45, 26, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v7, v37 :: v_dual_bitop2_b32 v49, 30, v7 bitop3:0x40
	v_dual_mov_b32 v28, v37 :: v_dual_mov_b32 v29, v37
	v_cmp_ne_u32_e64 s0, v3, v45
	v_mov_b32_e32 v3, v37
	v_lshl_or_b32 v17, v45, 8, v0
	v_add_nc_u64_e32 v[60:61], v[6:7], v[36:37]
	v_dual_add_nc_u32 v58, v16, v11 :: v_dual_mov_b32 v6, v37
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add_nc_u64_e32 v[52:53], v[2:3], v[36:37]
	v_add_nc_u32_e32 v47, 0xffffff00, v17
	v_dual_lshlrev_b32 v62, 2, v17 :: v_dual_mov_b32 v2, v37
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn064_bk096_wm4_wn2_mc0, .Lfunc_end0-bm128_bn064_bk096_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn064_bk096_wm4_wn2_mc0
	...
	.section	.text.bm128_bn064_bk096_wm4_wn2_mc0,"axG",@progbits,bm128_bn064_bk096_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn064_bk096_wm4_wn2_mc0.num_vgpr, 120
	.set .Lbm128_bn064_bk096_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm128_bn064_bk096_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm128_bn064_bk096_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm128_bn064_bk096_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm128_bn064_bk096_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm128_bn064_bk096_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn064_bk096_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn064_bk096_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm128_bn064_bk096_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_adbf8ff33f4adb01,@object ; @__hip_cuid_adbf8ff33f4adb01
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_adbf8ff33f4adb01
__hip_cuid_adbf8ff33f4adb01:
	.byte	0                               ; 0x0
	.size	__hip_cuid_adbf8ff33f4adb01, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_adbf8ff33f4adb01
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn064_bk096_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn064_bk096_wm4_wn2_mc0.kd
