	...
	.section	.text.bm064_bn064_bk064_wm2_wn4_mc0,"axG",@progbits,bm064_bn064_bk064_wm2_wn4_mc0,comdat
	.protected	bm064_bn064_bk064_wm2_wn4_mc0 ; -- Begin function bm064_bn064_bk064_wm2_wn4_mc0
	.globl	bm064_bn064_bk064_wm2_wn4_mc0
	.p2align	8
	.type	bm064_bn064_bk064_wm2_wn4_mc0,@function
bm064_bn064_bk064_wm2_wn4_mc0: ; @bm064_bn064_bk064_wm2_wn4_mc0
; %bb.0:
...
; %bb.23:
	...
	s_mov_b32 s11, s25
	v_dual_lshlrev_b32 v5, 6, v0 :: v_dual_bitop2_b32 v4, 16, v0 bitop3:0x40
	s_and_b64 s[28:29], s[10:11], 15
	v_dual_lshlrev_b32 v2, 6, v29 :: v_dual_lshlrev_b32 v1, 6, v27
	s_sub_co_i32 s8, 16, s28
	s_delay_alu instid0(VALU_DEP_2)
	v_and_or_b32 v4, 0x3c0, v5, v4
	s_lshr_b32 s8, s8, 2
	...
	s_cmp_lt_i32 s23, 64
	v_add_nc_u32_e32 v18, v7, v5
	s_cselect_b32 s39, -1, 0
	s_lshl_b32 s28, s0, 6
	s_lshl_b32 s44, s22, 6
	v_dual_mov_b32 v21, 0 :: v_dual_add_nc_u32 v22, v9, v6
	v_and_b32_e32 v8, 0xf8, v8
	v_dual_add_nc_u32 v6, v4, v1 :: v_dual_add_nc_u32 v3, 2, v24
	...
	v_dual_add_nc_u32 v26, v8, v5 :: v_dual_bitop2_b32 v31, 30, v3 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_add_nc_u32_e32 v28, v7, v6
	v_add3_u32 v30, v6, v8, 0x400
	v_add3_u32 v32, v4, v2, v9
...
; %bb.29:                               ;   in Loop: Header=BB0_28 Depth=2
	...
	v_lshl_add_u64 v[36:37], v[20:21], 2, s[28:29]
...
; %bb.43:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v33, s5 :: v_dual_mov_b32 v34, s6
...
.LBB0_46:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_lshl_add_u32 v33, v26, 1, s0
	v_nop
	v_lshl_add_u32 v54, v22, 1, s2
	v_lshl_add_u32 v58, v32, 1, s2
	ds_load_b128 v[34:37], v20
	ds_load_b128 v[38:41], v20 offset:16
	ds_load_b128 v[42:45], v33 offset:2048
	ds_load_b128 v[50:53], v54
	ds_load_b128 v[54:57], v54 offset:16
	v_lshl_add_u32 v20, v28, 1, s0
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[34:41], v[50:57], v[2:9]
	ds_load_b128 v[46:49], v33 offset:2064
	v_lshl_add_u32 v33, v30, 1, s0
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	ds_load_b128 v[34:37], v33 offset:64
	ds_load_b128 v[38:41], v33 offset:80
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[10:17], v[42:49], v[50:57], v[10:17] matrix_b_reuse
	ds_load_b128 v[42:45], v20 offset:64
	ds_load_b128 v[46:49], v20 offset:80
	ds_load_b128 v[50:53], v58 offset:64
	ds_load_b128 v[54:57], v58 offset:80
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[42:49], v[50:57], v[2:9]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[34:41], v[50:57], v[10:17] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_61:
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn064_bk064_wm2_wn4_mc0, .Lfunc_end0-bm064_bn064_bk064_wm2_wn4_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn064_bk064_wm2_wn4_mc0
	...
	.section	.text.bm064_bn064_bk064_wm2_wn4_mc0,"axG",@progbits,bm064_bn064_bk064_wm2_wn4_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn064_bk064_wm2_wn4_mc0.num_vgpr, 59
	.set .Lbm064_bn064_bk064_wm2_wn4_mc0.num_agpr, 0
	.set .Lbm064_bn064_bk064_wm2_wn4_mc0.numbered_sgpr, 52
	.set .Lbm064_bn064_bk064_wm2_wn4_mc0.num_named_barrier, 0
	.set .Lbm064_bn064_bk064_wm2_wn4_mc0.private_seg_size, 0
	.set .Lbm064_bn064_bk064_wm2_wn4_mc0.uses_vcc, 1
	.set .Lbm064_bn064_bk064_wm2_wn4_mc0.uses_flat_scratch, 0
	.set .Lbm064_bn064_bk064_wm2_wn4_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn064_bk064_wm2_wn4_mc0.has_recursion, 0
	.set .Lbm064_bn064_bk064_wm2_wn4_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_706054adcca04ebf,@object ; @__hip_cuid_706054adcca04ebf
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_706054adcca04ebf
__hip_cuid_706054adcca04ebf:
	.byte	0                               ; 0x0
	.size	__hip_cuid_706054adcca04ebf, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_706054adcca04ebf
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn064_bk064_wm2_wn4_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     54
    .sgpr_spill_count: 0
    .symbol:         bm064_bn064_bk064_wm2_wn4_mc0.kd
