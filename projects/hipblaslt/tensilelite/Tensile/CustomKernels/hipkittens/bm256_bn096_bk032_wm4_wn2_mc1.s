	...
	.section	.text.bm256_bn096_bk032_wm4_wn2_mc1,"axG",@progbits,bm256_bn096_bk032_wm4_wn2_mc1,comdat
	.protected	bm256_bn096_bk032_wm4_wn2_mc1 ; -- Begin function bm256_bn096_bk032_wm4_wn2_mc1
	.globl	bm256_bn096_bk032_wm4_wn2_mc1
	.p2align	8
	.type	bm256_bn096_bk032_wm4_wn2_mc1,@function
bm256_bn096_bk032_wm4_wn2_mc1: ; @bm256_bn096_bk032_wm4_wn2_mc1
; %bb.0:
...
.LBB0_20:
	...
	v_and_b32_e32 v107, 0xc0, v0
	v_cndmask_b32_e64 v103, 0, 1, s43
	...
	v_cndmask_b32_e64 v109, 0, 48, vcc_lo
...
; %bb.21:
	...
	v_dual_lshlrev_b32 v1, 5, v109 :: v_dual_lshlrev_b32 v2, 5, v107
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s1, 0x5d80
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v4, 0x1e0, v4
	s_mov_b32 s7, s5
	v_lshl_or_b32 v116, v0, 2, 0x4000
	s_and_b64 s[6:7], s[6:7], 15
	v_or_b32_e32 v113, 0xf00, v0
	v_or3_b32 v2, v2, v3, v4
	v_or3_b32 v3, v1, v3, v4
	s_sub_co_i32 s4, 16, s6
	s_mov_b32 s44, s39
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v101, 0 :: v_dual_lshrrev_b32 v5, 4, v2
	...
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_lshrrev_b32 v1, 4, v1
	s_cmp_lg_u64 s[6:7], 0
	v_dual_mov_b32 v117, v101 :: v_dual_add_nc_u32 v8, 0x400, v3
	v_add_nc_u32_e32 v98, v5, v2
	v_or_b32_e32 v5, 0x600, v2
	s_cselect_b32 s4, s4, 0
	v_and_b32_e32 v4, 0x1f8, v6
	s_lshl2_add_u32 s1, s4, s1
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_lshrrev_b32 v6, 4, v3 :: v_dual_lshrrev_b32 v5, 4, v5
	v_and_b32_e32 v9, 0x1f8, v1
	s_add_co_i32 s4, s1, 0xa180
	v_add_nc_u32_e32 v106, v4, v2
	s_and_b32 s10, s4, 15
	v_and_b32_e32 v5, 0x1f8, v5
	v_and_b32_e32 v6, 0x78, v6
	v_dual_lshrrev_b32 v1, 4, v8 :: v_dual_add_nc_u32 v108, v9, v2
	s_sub_co_i32 s7, 16, s10
	s_delay_alu instid0(VALU_DEP_3)
	v_add_nc_u32_e32 v110, v5, v2
	v_dual_mov_b32 v2, v101 :: v_dual_lshrrev_b32 v7, 4, v7
	s_add_co_i32 s45, s1, 0x5d80
	s_lshr_b32 s1, s7, 2
	...
	s_lshl_b32 s10, s1, 2
	s_lshr_b32 s7, s7, 27
	v_add_nc_u32_e32 v112, v7, v3
	s_add_co_i32 s12, s12, s7
	v_dual_mov_b32 v5, v101 :: v_dual_add_nc_u32 v114, v8, v3
	v_dual_mov_b32 v3, v101 :: v_dual_lshrrev_b32 v104, 8, v6
	s_ashr_i32 s47, s12, 5
	s_cmp_lt_i32 s3, 0x60
	s_mul_i32 s6, s17, 0x60
	s_cselect_b32 s48, -1, 0
	s_lshl_b32 s18, s18, 8
	v_dual_add_nc_u32 v6, 2, v104 :: v_dual_mov_b32 v4, v101
	s_ashr_i32 s7, s6, 31
	...
	v_dual_mov_b32 v6, v101 :: v_dual_bitop2_b32 v111, 14, v6 bitop3:0x40
	...
	v_dual_mov_b32 v49, v101 :: v_dual_mov_b32 v66, v101
	...
	v_dual_mov_b32 v65, v101 :: v_dual_mov_b32 v34, v101
	...
	v_dual_mov_b32 v41, v101 :: v_dual_mov_b32 v50, v101
...
.LBB0_25:                               ;   Parent Loop BB0_23 Depth=1
	...
	v_dual_mov_b32 v100, v118 :: v_dual_add_nc_u32 v115, -2, v115
	v_dual_mov_b32 v120, v119 :: v_dual_mov_b32 v121, v101
	v_add_nc_u32_e32 v119, 0x200, v119
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[122:123], v[100:101], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v115
	v_add_nc_u32_e32 v118, 0x200, v118
	v_lshl_add_u64 v[120:121], v[120:121], 2, s[6:7]
	s_clause 0x1
...
; %bb.27:                               ;   in Loop: Header=BB0_23 Depth=1
	v_add_nc_u64_e32 v[118:119], s[6:7], v[116:117]
...
.LBB0_28:                               ;   Parent Loop BB0_23 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[118:119], 0x400, v[118:119]
...
.LBB0_30:                               ;   in Loop: Header=BB0_31 Depth=2
	...
	v_add_nc_u32_e32 v119, 0x200, v119
	v_cmp_eq_u32_e32 vcc_lo, s6, v111
	v_add_nc_u32_e32 v118, 0x200, v118
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
; %bb.32:                               ;   in Loop: Header=BB0_31 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[120:121], v[100:101], 2, s[14:15]
	flat_store_b32 v[120:121], v101
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_lshl_add_u32 v115, v106, 1, s1
	v_lshl_add_u32 v138, v108, 1, s1
	v_lshl_add_u32 v146, v110, 1, s1
	ds_load_b128 v[118:121], v100
	ds_load_b128 v[122:125], v100 offset:16
	v_lshl_add_u32 v100, v114, 1, s2
	ds_load_b128 v[126:129], v115 offset:1024
	ds_load_b128 v[130:133], v115 offset:1040
	...
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[142:149], v[158:165], v[34:41] matrix_a_reuse
	...
	v_wmma_f32_16x16x32_bf16 v[58:65], v[142:149], v[166:173], v[58:65] matrix_b_reuse
	...
	v_wmma_f32_16x16x32_bf16 v[42:49], v[126:133], v[158:165], v[42:49] matrix_b_reuse
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v115, s13 :: v_dual_mov_b32 v118, s14
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v115, s5 :: v_dual_mov_b32 v118, s6
...
; %bb.47:
	...
	v_dual_lshlrev_b32 v82, 1, v1 :: v_dual_lshrrev_b32 v76, 3, v76
	v_dual_lshrrev_b32 v74, 3, v74 :: v_dual_lshrrev_b32 v83, 3, v75
	...
	v_add_nc_u32_e32 v29, v43, v82
	v_cvt_pk_bf16_f32 v25, v24, v25
	v_cvt_pk_bf16_f32 v24, v22, v23
	v_cvt_pk_bf16_f32 v23, v20, v21
	v_cvt_pk_bf16_f32 v22, v18, v19
	v_add_nc_u32_e32 v30, 0x1020, v1
	v_add_nc_u32_e32 v77, 0x2010, v1
	ds_store_b128 v66, v[46:49] offset:8192
	ds_store_b128 v29, v[22:25] offset:64
	v_add_nc_u32_e32 v24, 0x2020, v1
	v_dual_add_nc_u32 v28, 48, v1 :: v_dual_lshrrev_b32 v18, 3, v30
	v_cvt_pk_bf16_f32 v30, v26, v27
	v_add_nc_u32_e32 v26, 0x1030, v1
	v_add_nc_u32_e32 v1, 0x2030, v1
	v_dual_lshrrev_b32 v68, 3, v77 :: v_dual_lshrrev_b32 v24, 3, v24
	v_lshrrev_b32_e32 v43, 3, v28
	v_cvt_pk_bf16_f32 v17, v16, v17
	v_cvt_pk_bf16_f32 v16, v14, v15
	v_cvt_pk_bf16_f32 v15, v12, v13
	v_dual_lshrrev_b32 v12, 3, v26 :: v_dual_lshrrev_b32 v1, 3, v1
	v_and_b32_e32 v68, 0xff0, v68
	v_and_b32_e32 v22, 0xff0, v18
	v_lshlrev_b32_e32 v23, 1, v69
	v_and_b32_e32 v24, 0xff0, v24
	v_and_b32_e32 v19, 0xff0, v43
	v_cvt_pk_bf16_f32 v14, v10, v11
	v_and_b32_e32 v10, 0xff0, v12
	v_lshlrev_b32_e32 v11, 1, v28
	v_and_b32_e32 v1, 0xff0, v1
	v_add_nc_u32_e32 v42, v68, v67
	v_dual_add_nc_u32 v22, v22, v23 :: v_dual_add_nc_u32 v23, v24, v23
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_cvt_pk_bf16_f32 v6, v2, v3
	v_add_nc_u32_e32 v25, v19, v82
	...
	ds_store_b128 v42, v[30:33] offset:16384
	ds_store_b128 v22, v[14:17] offset:8192
	ds_store_b128 v23, v[6:9] offset:16384
	ds_store_b128 v25, v[18:21] offset:96
	ds_store_b128 v24, v[2:5] offset:8192
	ds_store_b128 v1, v[10:13] offset:16384
.LBB0_48:
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn096_bk032_wm4_wn2_mc1, .Lfunc_end0-bm256_bn096_bk032_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn096_bk032_wm4_wn2_mc1
	...
	.section	.text.bm256_bn096_bk032_wm4_wn2_mc1,"axG",@progbits,bm256_bn096_bk032_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm256_bn096_bk032_wm4_wn2_mc1.num_vgpr, 174
	.set .Lbm256_bn096_bk032_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm256_bn096_bk032_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm256_bn096_bk032_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm256_bn096_bk032_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm256_bn096_bk032_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm256_bn096_bk032_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm256_bn096_bk032_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm256_bn096_bk032_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm256_bn096_bk032_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_1f16276ff5dd3677,@object ; @__hip_cuid_1f16276ff5dd3677
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_1f16276ff5dd3677
__hip_cuid_1f16276ff5dd3677:
	.byte	0                               ; 0x0
	.size	__hip_cuid_1f16276ff5dd3677, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_1f16276ff5dd3677
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn096_bk032_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn096_bk032_wm4_wn2_mc1.kd
