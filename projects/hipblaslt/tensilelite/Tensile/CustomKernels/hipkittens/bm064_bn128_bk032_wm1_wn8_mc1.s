	...
	.section	.text.bm064_bn128_bk032_wm1_wn8_mc1,"axG",@progbits,bm064_bn128_bk032_wm1_wn8_mc1,comdat
	.protected	bm064_bn128_bk032_wm1_wn8_mc1 ; -- Begin function bm064_bn128_bk032_wm1_wn8_mc1
	.globl	bm064_bn128_bk032_wm1_wn8_mc1
	.p2align	8
	.type	bm064_bn128_bk032_wm1_wn8_mc1,@function
bm064_bn128_bk032_wm1_wn8_mc1: ; @bm064_bn128_bk032_wm1_wn8_mc1
; %bb.0:
...
.LBB0_24:
	...
	v_dual_mov_b32 v9, 0 :: v_dual_lshlrev_b32 v45, 4, v41
...
; %bb.25:
	...
	v_lshl_or_b32 v4, v45, 5, v2
	v_and_b32_e32 v3, 24, v3
	v_or_b32_e32 v1, 0x600, v1
	s_add_co_i32 s4, s6, 0x4400
	s_add_co_i32 s45, s6, 0x3300
	s_and_b32 s10, s4, 15
	v_dual_lshrrev_b32 v7, 4, v4 :: v_dual_add_nc_u32 v34, v3, v2
	v_dual_lshrrev_b32 v3, 4, v5 :: v_dual_lshrrev_b32 v5, 4, v6
	...
	v_dual_mov_b32 v37, 0 :: v_dual_bitop2_b32 v3, 56, v3 bitop3:0x40
	v_and_b32_e32 v5, 0x58, v5
	v_and_b32_e32 v7, 0x78, v1
	v_sub_nc_u32_e32 v1, 0x87f, v0
	s_cselect_b32 s6, s6, 0
	s_ashr_i32 s7, s12, 31
	v_dual_add_nc_u32 v38, v6, v4 :: v_dual_lshrrev_b32 v40, 8, v35
	s_lshr_b32 s7, s7, 27
	v_dual_add_nc_u32 v44, v3, v2 :: v_dual_add_nc_u32 v46, v5, v2
	s_add_co_i32 s12, s12, s7
	v_dual_add_nc_u32 v48, v7, v2 :: v_dual_mov_b32 v2, v37
	v_dual_lshrrev_b32 v42, 8, v1 :: v_dual_add_nc_u32 v1, 2, v40
	s_lshl_b32 s10, s6, 2
	s_ashr_i32 s47, s12, 5
	s_cmp_lt_i32 s3, 0x80
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_add_nc_u32 v4, 2, v42 :: v_dual_bitop2_b32 v47, 14, v1 bitop3:0x40
	...
	v_dual_mov_b32 v35, v40 :: v_dual_bitop2_b32 v49, 30, v4 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v39, v42 :: v_dual_mov_b32 v3, v37
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_lshl_add_u32 v62, v44, 1, s1
	v_lshl_add_u32 v70, v46, 1, s1
	v_lshl_add_u32 v71, v38, 1, s2
	ds_load_b128 v[50:53], v36
	ds_load_b128 v[54:57], v36 offset:16
	ds_load_b128 v[58:61], v62 offset:1024
	ds_load_b128 v[62:65], v62 offset:1040
	ds_load_b128 v[66:69], v70 offset:2048
	ds_load_b128 v[74:77], v71
	ds_load_b128 v[78:81], v71 offset:16
	ds_load_b128 v[70:73], v70 offset:2064
	v_lshl_add_u32 v36, v48, 1, s1
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[66:73], v[74:81], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[50:57], v[74:81], v[2:9]
	ds_load_b128 v[50:53], v36 offset:3072
	ds_load_b128 v[54:57], v36 offset:3088
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[50:57], v[74:81], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[58:65], v[74:81], v[10:17] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
...
; %bb.52:
	...
	ds_store_b128 v1, v[10:13] offset:64
...
.LBB0_64:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn128_bk032_wm1_wn8_mc1, .Lfunc_end0-bm064_bn128_bk032_wm1_wn8_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn128_bk032_wm1_wn8_mc1
	...
	.section	.text.bm064_bn128_bk032_wm1_wn8_mc1,"axG",@progbits,bm064_bn128_bk032_wm1_wn8_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn128_bk032_wm1_wn8_mc1.num_vgpr, 82
	.set .Lbm064_bn128_bk032_wm1_wn8_mc1.num_agpr, 0
	.set .Lbm064_bn128_bk032_wm1_wn8_mc1.numbered_sgpr, 56
	.set .Lbm064_bn128_bk032_wm1_wn8_mc1.num_named_barrier, 0
	.set .Lbm064_bn128_bk032_wm1_wn8_mc1.private_seg_size, 0
	.set .Lbm064_bn128_bk032_wm1_wn8_mc1.uses_vcc, 1
	.set .Lbm064_bn128_bk032_wm1_wn8_mc1.uses_flat_scratch, 0
	.set .Lbm064_bn128_bk032_wm1_wn8_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn128_bk032_wm1_wn8_mc1.has_recursion, 0
	.set .Lbm064_bn128_bk032_wm1_wn8_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_d50a164656e7e914,@object ; @__hip_cuid_d50a164656e7e914
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_d50a164656e7e914
__hip_cuid_d50a164656e7e914:
	.byte	0                               ; 0x0
	.size	__hip_cuid_d50a164656e7e914, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_d50a164656e7e914
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn128_bk032_wm1_wn8_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn128_bk032_wm1_wn8_mc1.kd
