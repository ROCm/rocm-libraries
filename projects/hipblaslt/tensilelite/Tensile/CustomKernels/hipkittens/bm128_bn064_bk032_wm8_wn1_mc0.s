	...
	.section	.text.bm128_bn064_bk032_wm8_wn1_mc0,"axG",@progbits,bm128_bn064_bk032_wm8_wn1_mc0,comdat
	.protected	bm128_bn064_bk032_wm8_wn1_mc0 ; -- Begin function bm128_bn064_bk032_wm8_wn1_mc0
	.globl	bm128_bn064_bk032_wm8_wn1_mc0
	.p2align	8
	.type	bm128_bn064_bk032_wm8_wn1_mc0,@function
bm128_bn064_bk032_wm8_wn1_mc0: ; @bm128_bn064_bk032_wm8_wn1_mc0
; %bb.0:
...
.LBB0_22:
	...
	v_dual_mov_b32 v28, v33 :: v_dual_mov_b32 v27, v33
	v_dual_mov_b32 v26, v33 :: v_dual_mov_b32 v9, v33
	v_dual_mov_b32 v8, v33 :: v_dual_mov_b32 v7, v33
	v_dual_mov_b32 v6, v33 :: v_dual_mov_b32 v5, v33
	v_dual_mov_b32 v4, v33 :: v_dual_mov_b32 v3, v33
	v_dual_mov_b32 v2, v33 :: v_dual_mov_b32 v17, v33
	v_dual_mov_b32 v16, v33 :: v_dual_mov_b32 v15, v33
	v_dual_mov_b32 v14, v33 :: v_dual_mov_b32 v13, v33
	v_dual_mov_b32 v12, v33 :: v_dual_mov_b32 v11, v33
	v_dual_mov_b32 v10, v33 :: v_dual_mov_b32 v25, v33
	v_dual_mov_b32 v24, v33 :: v_dual_mov_b32 v23, v33
	v_dual_mov_b32 v22, v33 :: v_dual_mov_b32 v21, v33
	v_dual_mov_b32 v20, v33 :: v_dual_mov_b32 v19, v33
	v_mov_b32_e32 v18, v33
	s_barrier_wait -1
	s_cbranch_vccnz .LBB0_47
; %bb.23:
	v_dual_lshlrev_b32 v1, 9, v41 :: v_dual_lshlrev_b32 v2, 5, v0
	...
	s_mov_b32 s16, 64
	v_dual_add_nc_u32 v34, v4, v1 :: v_dual_lshlrev_b32 v1, 1, v0
	...
	v_dual_lshrrev_b32 v3, 4, v4 :: v_dual_lshrrev_b32 v4, 4, v5
	v_dual_mov_b32 v37, 0 :: v_dual_lshrrev_b32 v5, 4, v6
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_add_nc_u32 v38, v2, v1 :: v_dual_bitop2_b32 v3, 56, v3 bitop3:0x40
	v_dual_mov_b32 v26, v37 :: v_dual_sub_nc_u32 v1, 0x43f, v0
	s_lshr_b32 s7, s7, 27
	s_lshl_b32 s10, s6, 2
	s_add_co_i32 s17, s17, s7
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_lshrrev_b32 v40, 8, v35 :: v_dual_lshrrev_b32 v42, 8, v1
	...
	v_dual_add_nc_u32 v1, 2, v40 :: v_dual_add_nc_u32 v6, 2, v42
	s_ashr_i32 s7, s6, 31
	s_mul_u64 s[4:5], s[20:21], s[4:5]
	s_bfe_i64 s[12:13], s[12:13], 0x200000
	s_lshl_b64 s[4:5], s[4:5], 1
	s_mul_u64 s[6:7], s[12:13], s[6:7]
	v_dual_mov_b32 v35, v40 :: v_dual_bitop2_b32 v45, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v39, v42 :: v_dual_bitop2_b32 v47, 14, v6 bitop3:0x40
	v_dual_add_nc_u32 v44, v2, v3 :: v_dual_add_nc_u32 v46, v2, v4
	v_dual_mov_b32 v27, v37 :: v_dual_add_nc_u32 v48, v2, v5
...
; %bb.43:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v49, s14 :: v_dual_mov_b32 v50, s12
...
.LBB0_45:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v49, s5 :: v_dual_mov_b32 v50, s6
...
.LBB0_46:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	ds_load_b128 v[62:65], v49 offset:16
	v_lshl_add_u32 v36, v44, 1, s2
	ds_load_b128 v[66:69], v36 offset:1024
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[26:33], v[50:57], v[58:65], v[26:33]
	ds_load_b128 v[70:73], v36 offset:1040
	v_lshl_add_u32 v36, v46, 1, s2
	ds_load_b128 v[58:61], v36 offset:2048
	ds_load_b128 v[62:65], v36 offset:2064
	v_lshl_add_u32 v36, v48, 1, s2
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[50:57], v[66:73], v[2:9] matrix_a_reuse
	ds_load_b128 v[66:69], v36 offset:3072
	ds_load_b128 v[70:73], v36 offset:3088
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[50:57], v[66:73], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[50:57], v[58:65], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
...
; %bb.48:
	...
	v_lshl_or_b32 v27, v41, 5, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_and_b32_e32 v4, 0x1f0, v5
	v_and_b32_e32 v5, 0x2f0, v6
	v_cvt_pk_bf16_f32 v6, v2, v3
	v_and_b32_e32 v1, 0x3f0, v1
	v_dual_add_nc_u32 v26, v26, v27 :: v_dual_add_nc_u32 v28, v4, v27
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u32_e32 v29, v5, v27
	...
	ds_store_b128 v29, v[2:5] offset:8192
...
.LBB0_60:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn064_bk032_wm8_wn1_mc0, .Lfunc_end0-bm128_bn064_bk032_wm8_wn1_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn064_bk032_wm8_wn1_mc0
	...
	.section	.text.bm128_bn064_bk032_wm8_wn1_mc0,"axG",@progbits,bm128_bn064_bk032_wm8_wn1_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn064_bk032_wm8_wn1_mc0.num_vgpr, 74
	.set .Lbm128_bn064_bk032_wm8_wn1_mc0.num_agpr, 0
	.set .Lbm128_bn064_bk032_wm8_wn1_mc0.numbered_sgpr, 56
	.set .Lbm128_bn064_bk032_wm8_wn1_mc0.num_named_barrier, 0
	.set .Lbm128_bn064_bk032_wm8_wn1_mc0.private_seg_size, 0
	.set .Lbm128_bn064_bk032_wm8_wn1_mc0.uses_vcc, 1
	.set .Lbm128_bn064_bk032_wm8_wn1_mc0.uses_flat_scratch, 0
	.set .Lbm128_bn064_bk032_wm8_wn1_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn064_bk032_wm8_wn1_mc0.has_recursion, 0
	.set .Lbm128_bn064_bk032_wm8_wn1_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_481fc707bf94841e,@object ; @__hip_cuid_481fc707bf94841e
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_481fc707bf94841e
__hip_cuid_481fc707bf94841e:
	.byte	0                               ; 0x0
	.size	__hip_cuid_481fc707bf94841e, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_481fc707bf94841e
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn064_bk032_wm8_wn1_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn064_bk032_wm8_wn1_mc0.kd
