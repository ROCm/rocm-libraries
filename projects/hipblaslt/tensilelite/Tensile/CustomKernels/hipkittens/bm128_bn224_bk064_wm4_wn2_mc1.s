	...
	.section	.text.bm128_bn224_bk064_wm4_wn2_mc1,"axG",@progbits,bm128_bn224_bk064_wm4_wn2_mc1,comdat
	.protected	bm128_bn224_bk064_wm4_wn2_mc1 ; -- Begin function bm128_bn224_bk064_wm4_wn2_mc1
	.globl	bm128_bn224_bk064_wm4_wn2_mc1
	.p2align	8
	.type	bm128_bn224_bk064_wm4_wn2_mc1,@function
bm128_bn224_bk064_wm4_wn2_mc1: ; @bm128_bn224_bk064_wm4_wn2_mc1
; %bb.0:
...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	...
	v_cmp_lt_u32_e32 vcc_lo, 0x1cbf, v1
	s_or_b32 s7, vcc_lo, s7
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s7
...
.LBB0_16:
	...
	v_cndmask_b32_e64 v115, 0, 1, s38
...
; %bb.17:
	...
	v_dual_lshlrev_b32 v2, 6, v121 :: v_dual_lshlrev_b32 v3, 6, v119
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s1, 0xbb00
	s_delay_alu instid0(VALU_DEP_2)
	v_and_or_b32 v4, 0x3c0, v4, v1
	s_mov_b32 s7, s5
	v_lshl_or_b32 v152, v0, 2, 0x4000
	s_and_b64 s[6:7], s[6:7], 15
	v_or_b32_e32 v129, 0xf00, v0
	v_or_b32_e32 v6, v2, v4
	v_or_b32_e32 v5, v3, v4
	s_sub_co_i32 s4, 16, s6
	s_mov_b32 s44, s39
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mov_b32 v117, 0 :: v_dual_lshrrev_b32 v7, 4, v6
	v_lshrrev_b32_e32 v1, 4, v5
	s_lshr_b32 s4, s4, 2
	s_cmp_lg_u64 s[6:7], 0
	s_mul_i32 s6, s17, 0xe0
	...
	v_add_nc_u32_e32 v114, v1, v5
	v_or_b32_e32 v1, 0x400, v5
	v_add_nc_u32_e32 v8, 0x400, v6
	v_add_nc_u32_e32 v9, 0x800, v6
	v_dual_mov_b32 v155, v117 :: v_dual_add_nc_u32 v10, 0xc00, v6
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_lshrrev_b32 v8, 4, v8
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v9, 4, v9 :: v_dual_add_nc_u32 v118, v7, v6
	v_add_nc_u32_e32 v12, 0x1400, v6
	v_and_b32_e32 v11, 0x1f8, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v7, 0x3f8, v8
	v_and_b32_e32 v8, 0x3f8, v9
	v_dual_lshrrev_b32 v1, 4, v10 :: v_dual_bitop2_b32 v10, 32, v4 bitop3:0x54
	v_add_nc_u32_e32 v9, 0x1000, v6
	v_add_nc_u32_e32 v13, 0x1800, v6
	v_add_nc_u32_e32 v122, v7, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_and_b32_e32 v14, 0x3f8, v1
	v_dual_add_nc_u32 v120, v11, v5 :: v_dual_add_nc_u32 v124, v8, v6
	v_dual_lshrrev_b32 v1, 4, v9 :: v_dual_bitop2_b32 v9, v10, v3 bitop3:0x54
	v_dual_add_nc_u32 v3, v4, v3 :: v_dual_bitop2_b32 v10, v10, v2 bitop3:0x54
	v_mov_b32_e32 v5, v117
	v_and_b32_e32 v15, 0x3f8, v1
	s_delay_alu instid0(VALU_DEP_4)
	v_or_b32_e32 v1, 0x400, v9
	v_lshrrev_b32_e32 v9, 4, v9
	v_add_nc_u32_e32 v16, 0x400, v10
	v_lshrrev_b32_e32 v17, 4, v10
	v_dual_mov_b32 v7, v117 :: v_dual_add_nc_u32 v18, 0x800, v10
	v_lshrrev_b32_e32 v1, 4, v1
	v_and_b32_e32 v9, 0x1b8, v9
	v_dual_lshrrev_b32 v13, 4, v13 :: v_dual_lshrrev_b32 v16, 4, v16
	v_dual_mov_b32 v11, v117 :: v_dual_add_nc_u32 v20, 0x1000, v10
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_and_b32_e32 v19, 0x1f8, v1
	v_lshrrev_b32_e32 v1, 4, v18
	v_add_nc_u32_e32 v18, 0xc00, v10
	v_dual_add_nc_u32 v2, v4, v2 :: v_dual_add_nc_u32 v134, v9, v3
	v_add3_u32 v136, v3, v19, 0x400
	v_dual_mov_b32 v3, v117 :: v_dual_lshrrev_b32 v12, 4, v12
	s_lshl2_add_u32 s1, s4, s1
	v_and_b32_e32 v13, 0x3f8, v13
	v_dual_mov_b32 v8, v117 :: v_dual_add_nc_u32 v21, 0x1400, v10
	v_and_b32_e32 v22, 0x3f8, v1
	v_add_nc_u32_e32 v1, 0x1800, v10
	v_dual_mov_b32 v9, v117 :: v_dual_lshrrev_b32 v10, 4, v18
	v_lshrrev_b32_e32 v18, 4, v20
	v_sub_nc_u32_e32 v20, 0x1dbf, v0
	s_add_co_i32 s4, s1, 0xff00
	v_add_nc_u32_e32 v132, v13, v6
	s_and_b32 s10, s4, 15
	v_and_b32_e32 v10, 0x3f8, v10
	v_dual_mov_b32 v13, v117 :: v_dual_lshrrev_b32 v21, 4, v21
	v_lshrrev_b32_e32 v20, 8, v20
	s_sub_co_i32 s7, 16, s10
	s_add_co_i32 s45, s1, 0xbb00
	s_lshr_b32 s1, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_add_nc_u32_e32 v20, 1, v20
	v_add3_u32 v144, v2, v10, 0xc00
	v_dual_mov_b32 v10, v117 :: v_dual_lshrrev_b32 v1, 4, v1
	s_cselect_b32 s1, s1, 0
	s_ashr_i32 s7, s12, 31
	v_dual_add_nc_u32 v126, v14, v6 :: v_dual_bitop2_b32 v125, 30, v20 bitop3:0x40
	s_lshr_b32 s7, s7, 26
	s_lshl_b32 s10, s1, 2
	...
	v_cmp_ne_u32_e64 s1, v20, v125
	v_dual_add_nc_u32 v128, v15, v6 :: v_dual_add_nc_u32 v130, v12, v6
	v_add_nc_u32_e32 v138, v17, v2
	v_add3_u32 v140, v2, v16, 0x400
	v_add3_u32 v142, v2, v22, 0x800
	v_add3_u32 v146, v2, v18, 0x1000
	v_add3_u32 v148, v2, v21, 0x1400
	v_add3_u32 v150, v2, v23, 0x1800
	v_dual_mov_b32 v12, v117 :: v_dual_add_nc_u32 v127, 0xffffff00, v24
	v_dual_lshlrev_b32 v154, 2, v24 :: v_dual_mov_b32 v2, v117
	v_dual_mov_b32 v4, v117 :: v_dual_mov_b32 v6, v117
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v116, v156 :: v_dual_add_nc_u32 v131, -2, v131
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_lshl_add_u32 v131, v118, 1, s5
	v_lshl_add_u32 v133, v138, 1, s5
	v_lshl_add_u32 v135, v140, 1, s5
	v_lshl_add_u32 v137, v142, 1, s5
	ds_load_b128 v[156:159], v116
	ds_load_b128 v[160:163], v116 offset:16
	v_lshl_add_u32 v116, v122, 1, s5
	ds_load_b128 v[164:167], v131
	ds_load_b128 v[168:171], v131 offset:16
	v_lshl_add_u32 v131, v124, 1, s5
	v_lshl_add_u32 v139, v144, 1, s5
	ds_load_b128 v[172:175], v116 offset:2048
	ds_load_b128 v[176:179], v116 offset:2064
	v_lshl_add_u32 v116, v120, 1, s6
	ds_load_b128 v[188:191], v131 offset:4096
	v_lshl_add_u32 v141, v146, 1, s5
	v_lshl_add_u32 v143, v148, 1, s5
	v_lshl_add_u32 v145, v150, 1, s5
	ds_load_b128 v[180:183], v116 offset:2048
	ds_load_b128 v[184:187], v116 offset:2064
	v_lshl_add_u32 v116, v132, 1, s5
	ds_load_b128 v[204:207], v135 offset:64
	ds_load_b128 v[208:211], v135 offset:80
	ds_load_b128 v[212:215], v137 offset:64
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[106:113], v[156:163], v[164:171], v[106:113]
	ds_load_b128 v[216:219], v137 offset:80
	ds_load_b128 v[220:223], v141 offset:64
	ds_load_b128 v[224:227], v141 offset:80
	ds_load_b128 v[228:231], v143 offset:64
	ds_load_b128 v[232:235], v143 offset:80
	ds_load_b128 v[236:239], v145 offset:64
	ds_load_b128 v[240:243], v145 offset:80
	s_wait_dscnt 0xd
	v_wmma_f32_16x16x32_bf16 v[98:105], v[156:163], v[172:179], v[98:105] matrix_a_reuse
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[34:41], v[180:187], v[172:179], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[180:187], v[164:171], v[58:65] matrix_a_reuse
	ds_load_b128 v[164:167], v116 offset:12288
	ds_load_b128 v[168:171], v116 offset:12304
	v_lshl_add_u32 v116, v128, 1, s5
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[156:163], v[164:171], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[180:187], v[164:171], v[50:57]
	ds_load_b128 v[164:167], v116 offset:8192
	ds_load_b128 v[168:171], v116 offset:8208
	v_lshl_add_u32 v116, v126, 1, s5
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[74:81], v[156:163], v[164:171], v[74:81] matrix_a_reuse
	ds_load_b128 v[172:175], v116 offset:6144
	ds_load_b128 v[176:179], v116 offset:6160
	v_lshl_add_u32 v116, v130, 1, s5
	ds_load_b128 v[196:199], v116 offset:10240
	ds_load_b128 v[200:203], v116 offset:10256
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[66:73], v[156:163], v[196:203], v[66:73] matrix_a_reuse
	ds_load_b128 v[192:195], v131 offset:4112
	v_lshl_add_u32 v116, v134, 1, s6
	v_lshl_add_u32 v131, v136, 1, s6
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[180:187], v[164:171], v[10:17] matrix_a_reuse
	ds_load_b128 v[164:167], v133 offset:64
	ds_load_b128 v[168:171], v133 offset:80
	v_wmma_f32_16x16x32_bf16 v[18:25], v[180:187], v[172:179], v[18:25] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[180:187], v[188:195], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[90:97], v[156:163], v[188:195], v[90:97] matrix_a_reuse
	ds_load_b128 v[188:191], v131 offset:64
	ds_load_b128 v[192:195], v131 offset:80
	v_wmma_f32_16x16x32_bf16 v[82:89], v[156:163], v[172:179], v[82:89] matrix_a_reuse
	ds_load_b128 v[172:175], v116 offset:64
	ds_load_b128 v[176:179], v116 offset:80
	ds_load_b128 v[156:159], v139 offset:64
	ds_load_b128 v[160:163], v139 offset:80
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[180:187], v[196:203], v[2:9] matrix_a_reuse
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[106:113], v[172:179], v[164:171], v[106:113]
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[98:105], v[172:179], v[204:211], v[98:105] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[90:97], v[172:179], v[212:219], v[90:97] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[82:89], v[172:179], v[156:163], v[82:89] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[74:81], v[172:179], v[220:227], v[74:81] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[172:179], v[228:235], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[172:179], v[236:243], v[42:49] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[188:195], v[236:243], v[50:57]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[188:195], v[228:235], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[188:195], v[220:227], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[188:195], v[156:163], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[188:195], v[212:219], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[188:195], v[204:211], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[188:195], v[164:171], v[58:65] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_40:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v131, s5 :: v_dual_mov_b32 v156, s6
	s_bitset1_b32 s7, 31
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn224_bk064_wm4_wn2_mc1, .Lfunc_end0-bm128_bn224_bk064_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn224_bk064_wm4_wn2_mc1
	...
	.section	.text.bm128_bn224_bk064_wm4_wn2_mc1,"axG",@progbits,bm128_bn224_bk064_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn224_bk064_wm4_wn2_mc1.num_vgpr, 244
	.set .Lbm128_bn224_bk064_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm128_bn224_bk064_wm4_wn2_mc1.numbered_sgpr, 60
	.set .Lbm128_bn224_bk064_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm128_bn224_bk064_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm128_bn224_bk064_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm128_bn224_bk064_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn224_bk064_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn224_bk064_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm128_bn224_bk064_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_402df20f075f4a82,@object ; @__hip_cuid_402df20f075f4a82
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_402df20f075f4a82
__hip_cuid_402df20f075f4a82:
	.byte	0                               ; 0x0
	.size	__hip_cuid_402df20f075f4a82, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_402df20f075f4a82
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn224_bk064_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     62
    .sgpr_spill_count: 0
    .symbol:         bm128_bn224_bk064_wm4_wn2_mc1.kd
