	...
	.section	.text.bm128_bn064_bk128_wm8_wn1_mc1,"axG",@progbits,bm128_bn064_bk128_wm8_wn1_mc1,comdat
	.protected	bm128_bn064_bk128_wm8_wn1_mc1 ; -- Begin function bm128_bn064_bk128_wm8_wn1_mc1
	.globl	bm128_bn064_bk128_wm8_wn1_mc1
	.p2align	8
	.type	bm128_bn064_bk128_wm8_wn1_mc1,@function
bm128_bn064_bk128_wm8_wn1_mc1: ; @bm128_bn064_bk128_wm8_wn1_mc1
; %bb.0:
...
.LBB0_16:
	...
	v_dual_mov_b32 v9, 0 :: v_dual_lshlrev_b32 v46, 7, v0
	s_and_b32 s42, s3, s29
	s_and_not1_b32 vcc_lo, exec_lo, s13
	v_cndmask_b32_e64 v39, 0, 1, s42
...
; %bb.17:
	...
	v_dual_add_nc_u32 v36, v4, v3 :: v_dual_add_nc_u32 v38, v2, v1
	v_mov_b32_e32 v41, v35
	v_cmp_eq_u32_e64 s0, 0, v37
	v_or_b32_e32 v1, 0x100, v0
	v_or_b32_e32 v42, 0x4000, v34
	v_dual_mov_b32 v43, v35 :: v_dual_mov_b32 v2, v35
	v_dual_mov_b32 v3, v35 :: v_dual_mov_b32 v4, v35
	v_dual_mov_b32 v5, v35 :: v_dual_mov_b32 v6, v35
	v_dual_mov_b32 v7, v35 :: v_dual_mov_b32 v8, v35
	v_dual_mov_b32 v9, v35 :: v_dual_mov_b32 v10, v35
	v_dual_mov_b32 v11, v35 :: v_dual_mov_b32 v12, v35
	v_dual_mov_b32 v13, v35 :: v_dual_mov_b32 v14, v35
	v_dual_mov_b32 v15, v35 :: v_dual_mov_b32 v16, v35
	v_dual_mov_b32 v17, v35 :: v_dual_mov_b32 v26, v35
	v_dual_mov_b32 v27, v35 :: v_dual_mov_b32 v28, v35
	v_dual_mov_b32 v29, v35 :: v_dual_mov_b32 v30, v35
	v_dual_mov_b32 v31, v35 :: v_dual_mov_b32 v32, v35
	v_dual_mov_b32 v33, v35 :: v_dual_mov_b32 v18, v35
	v_dual_mov_b32 v19, v35 :: v_dual_mov_b32 v20, v35
	v_dual_mov_b32 v21, v35 :: v_dual_mov_b32 v22, v35
	v_dual_mov_b32 v23, v35 :: v_dual_mov_b32 v24, v35
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v34, v44 :: v_dual_add_nc_u32 v49, -2, v49
	v_dual_mov_b32 v50, v45 :: v_dual_mov_b32 v51, v35
	v_add_nc_u32_e32 v45, 0x200, v45
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[52:53], v[34:35], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v49
	v_add_nc_u32_e32 v44, 0x200, v44
	v_lshl_add_u64 v[50:51], v[50:51], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[52:53], v35
	flat_store_b32 v[50:51], v35
...
.LBB0_24:                               ;   Parent Loop BB0_19 Depth=1
	...
	flat_store_b32 v[44:45], v35
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[44:45], 0x400, v[44:45]
...
; %bb.28:                               ;   in Loop: Header=BB0_19 Depth=1
	v_add_nc_u64_e32 v[44:45], s[6:7], v[42:43]
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_cselect_b32 s6, s38, s41
	v_lshl_add_u32 v34, v36, 1, s5
	v_lshl_add_u32 v44, v38, 1, s6
	ds_load_b128 v[50:53], v34
	ds_load_b128 v[54:57], v34 offset:16
	ds_load_b128 v[58:61], v44
	ds_load_b128 v[62:65], v44 offset:16
	ds_load_b128 v[82:85], v44 offset:8704
	ds_load_b128 v[86:89], v44 offset:8720
	ds_load_b128 v[66:69], v44 offset:4352
	ds_load_b128 v[74:77], v44 offset:64
	ds_load_b128 v[78:81], v44 offset:80
	ds_load_b128 v[90:93], v44 offset:4416
	ds_load_b128 v[94:97], v44 offset:4432
	ds_load_b128 v[98:101], v44 offset:8768
	ds_load_b128 v[102:105], v44 offset:8784
	ds_load_b128 v[106:109], v44 offset:13120
	ds_load_b128 v[110:113], v44 offset:13136
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0xb
	v_wmma_f32_16x16x32_bf16 v[26:33], v[50:57], v[58:65], v[26:33]
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[2:9], v[50:57], v[82:89], v[2:9] matrix_a_reuse
	ds_load_b128 v[58:61], v44 offset:13056
	ds_load_b128 v[62:65], v44 offset:13072
	ds_load_b128 v[70:73], v44 offset:4368
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[18:25], v[50:57], v[58:65], v[18:25] matrix_a_reuse
	ds_load_b128 v[58:61], v34 offset:64
	ds_load_b128 v[62:65], v34 offset:80
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[10:17], v[50:57], v[66:73], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[50:53], v34 offset:128
	ds_load_b128 v[54:57], v34 offset:144
	ds_load_b128 v[66:69], v44 offset:128
	ds_load_b128 v[70:73], v44 offset:144
	ds_load_b128 v[82:85], v44 offset:4480
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[26:33], v[58:65], v[74:81], v[26:33]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[58:65], v[90:97], v[10:17] matrix_a_reuse
	ds_load_b128 v[86:89], v44 offset:4496
	ds_load_b128 v[74:77], v44 offset:8832
	ds_load_b128 v[78:81], v44 offset:8848
	ds_load_b128 v[90:93], v44 offset:13184
	ds_load_b128 v[94:97], v44 offset:13200
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[58:65], v[98:105], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[58:65], v[106:113], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[58:61], v34 offset:192
	ds_load_b128 v[62:65], v34 offset:208
	ds_load_b128 v[98:101], v44 offset:192
	ds_load_b128 v[102:105], v44 offset:208
	ds_load_b128 v[106:109], v44 offset:4544
	s_wait_dscnt 0xb
	v_wmma_f32_16x16x32_bf16 v[26:33], v[50:57], v[66:73], v[26:33]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[10:17], v[50:57], v[82:89], v[10:17] matrix_a_reuse
	ds_load_b128 v[110:113], v44 offset:4560
	ds_load_b128 v[66:69], v44 offset:8896
	ds_load_b128 v[70:73], v44 offset:8912
	ds_load_b128 v[82:85], v44 offset:13248
	ds_load_b128 v[86:89], v44 offset:13264
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[2:9], v[50:57], v[74:81], v[2:9] matrix_a_reuse
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[18:25], v[50:57], v[90:97], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[26:33], v[58:65], v[98:105], v[26:33]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[10:17], v[58:65], v[106:113], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[58:65], v[66:73], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[58:65], v[82:89], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_40:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v45, s5 :: v_dual_mov_b32 v44, s6
	s_bitset1_b32 s7, 31
...
; %bb.42:
	...
	v_bitop3_b32 v1, v46, 0x788, v1 bitop3:0xc8
	...
	v_and_b32_e32 v26, 0xf0, v34
	v_lshrrev_b32_e32 v1, 3, v1
	v_lshl_or_b32 v12, v37, 5, v12
	v_and_b32_e32 v13, 0x1f0, v13
	v_and_b32_e32 v27, 0x2f0, v14
	v_cvt_pk_bf16_f32 v14, v10, v11
	v_and_b32_e32 v1, 0x3f0, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v10, v26, v12 :: v_dual_add_nc_u32 v11, v13, v12
	v_add_nc_u32_e32 v13, v27, v12
	...
	ds_store_b128 v10, v[30:33]
	ds_store_b128 v11, v[14:17] offset:4096
	ds_store_b128 v13, v[6:9] offset:8192
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn064_bk128_wm8_wn1_mc1, .Lfunc_end0-bm128_bn064_bk128_wm8_wn1_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn064_bk128_wm8_wn1_mc1
	...
	.section	.text.bm128_bn064_bk128_wm8_wn1_mc1,"axG",@progbits,bm128_bn064_bk128_wm8_wn1_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn064_bk128_wm8_wn1_mc1.num_vgpr, 114
	.set .Lbm128_bn064_bk128_wm8_wn1_mc1.num_agpr, 0
	.set .Lbm128_bn064_bk128_wm8_wn1_mc1.numbered_sgpr, 56
	.set .Lbm128_bn064_bk128_wm8_wn1_mc1.num_named_barrier, 0
	.set .Lbm128_bn064_bk128_wm8_wn1_mc1.private_seg_size, 0
	.set .Lbm128_bn064_bk128_wm8_wn1_mc1.uses_vcc, 1
	.set .Lbm128_bn064_bk128_wm8_wn1_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn064_bk128_wm8_wn1_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn064_bk128_wm8_wn1_mc1.has_recursion, 0
	.set .Lbm128_bn064_bk128_wm8_wn1_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_4226998175518a9c,@object ; @__hip_cuid_4226998175518a9c
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_4226998175518a9c
__hip_cuid_4226998175518a9c:
	.byte	0                               ; 0x0
	.size	__hip_cuid_4226998175518a9c, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_4226998175518a9c
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn064_bk128_wm8_wn1_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn064_bk128_wm8_wn1_mc1.kd
