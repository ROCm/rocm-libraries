	...
	.section	.text.bm064_bn320_bk128_wm2_wn4_mc1,"axG",@progbits,bm064_bn320_bk128_wm2_wn4_mc1,comdat
	.protected	bm064_bn320_bk128_wm2_wn4_mc1 ; -- Begin function bm064_bn320_bk128_wm2_wn4_mc1
	.globl	bm064_bn320_bk128_wm2_wn4_mc1
	.p2align	8
	.type	bm064_bn320_bk128_wm2_wn4_mc1,@function
bm064_bn320_bk128_wm2_wn4_mc1: ; @bm064_bn320_bk128_wm2_wn4_mc1
; %bb.0:
...
.LBB0_16:
	...
	v_dual_lshlrev_b32 v1, 3, v89 :: v_dual_bitop2_b32 v91, 3, v89 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s42, s3, s29
	s_and_not1_b32 vcc_lo, exec_lo, s13
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v87, 32, v1
...
; %bb.17:
	...
	s_mov_b32 s7, s5
	v_dual_lshlrev_b32 v2, 7, v87 :: v_dual_lshlrev_b32 v3, 7, v0
	s_and_b64 s[38:39], s[6:7], 15
	v_mul_u32_u24_e32 v1, 0x2800, v91
	s_sub_co_i32 s4, 16, s38
	s_mov_b32 s11, 0
	s_lshr_b32 s4, s4, 2
	v_and_b32_e32 v3, 0x780, v3
	s_cmp_lg_u64 s[38:39], 0
	v_or_b32_e32 v98, 0xf00, v0
	s_cselect_b32 s4, s4, 0
	v_or_b32_e32 v92, 0x4000, v84
	...
	s_lshl_b32 s10, s7, 2
	s_lshr_b32 s8, s8, 25
	v_dual_mov_b32 v85, 0 :: v_dual_lshrrev_b32 v6, 4, v5
	...
	s_or_b32 s4, s18, 0x7510000
	v_and_b32_e32 v6, 0x178, v6
	v_dual_add_nc_u32 v86, v7, v1 :: v_dual_add_nc_u32 v2, v4, v2
	...
	v_add_nc_u32_e32 v82, v6, v5
	v_cmp_eq_u32_e64 s0, 0, v89
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v88, v3, v2 :: v_dual_add_nc_u32 v90, v6, v2
	v_dual_mov_b32 v93, v85 :: v_dual_mov_b32 v95, v85
	v_or_b32_e32 v99, 0x5300, v0
	v_or_b32_e32 v94, 0x15000, v84
	v_dual_mov_b32 v2, v85 :: v_dual_mov_b32 v3, v85
	v_dual_mov_b32 v4, v85 :: v_dual_mov_b32 v5, v85
	v_dual_mov_b32 v6, v85 :: v_dual_mov_b32 v7, v85
	v_dual_mov_b32 v8, v85 :: v_dual_mov_b32 v9, v85
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v84, v96 :: v_dual_add_nc_u32 v100, -2, v100
	v_dual_mov_b32 v102, v97 :: v_dual_mov_b32 v103, v85
...
; %bb.23:                               ;   in Loop: Header=BB0_19 Depth=1
	v_add_nc_u64_e32 v[96:97], s[6:7], v[92:93]
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_lshl_add_u32 v96, v86, 1, s6
	ds_load_b128 v[100:103], v84
	ds_load_b128 v[104:107], v84 offset:16
	ds_load_b128 v[108:111], v96
	ds_load_b128 v[112:115], v96 offset:16
	ds_load_b128 v[116:119], v84 offset:4352
	ds_load_b128 v[120:123], v84 offset:4368
	ds_load_b128 v[124:127], v96 offset:4352
	v_lshl_add_u32 v84, v88, 1, s5
	ds_load_b128 v[148:151], v96 offset:64
	ds_load_b128 v[152:155], v96 offset:80
	ds_load_b128 v[156:159], v96 offset:8768
	ds_load_b128 v[160:163], v96 offset:8784
	ds_load_b128 v[164:167], v96 offset:13120
	ds_load_b128 v[168:171], v96 offset:13136
	ds_load_b128 v[172:175], v96 offset:17472
	ds_load_b128 v[176:179], v96 offset:17488
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0xb
	v_wmma_f32_16x16x32_bf16 v[74:81], v[100:107], v[108:115], v[74:81]
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[26:33], v[116:123], v[108:115], v[26:33] matrix_a_reuse
	ds_load_b128 v[140:143], v96 offset:17408
	ds_load_b128 v[144:147], v96 offset:17424
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[100:107], v[140:147], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[116:123], v[140:147], v[42:49]
	ds_load_b128 v[108:111], v96 offset:13056
	ds_load_b128 v[112:115], v96 offset:13072
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[50:57], v[100:107], v[108:115], v[50:57] matrix_a_reuse
	ds_load_b128 v[132:135], v96 offset:8704
	ds_load_b128 v[136:139], v96 offset:8720
	ds_load_b128 v[128:131], v96 offset:4368
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[116:123], v[108:115], v[2:9] matrix_a_reuse
	ds_load_b128 v[108:111], v96 offset:4416
	ds_load_b128 v[112:115], v96 offset:4432
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[10:17], v[116:123], v[132:139], v[10:17] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[18:25], v[116:123], v[124:131], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[100:107], v[124:131], v[66:73] matrix_a_reuse
	ds_load_b128 v[124:127], v84 offset:64
	ds_load_b128 v[128:131], v84 offset:80
	v_wmma_f32_16x16x32_bf16 v[58:65], v[100:107], v[132:139], v[58:65] matrix_a_reuse
	ds_load_b128 v[132:135], v84 offset:4416
	ds_load_b128 v[136:139], v84 offset:4432
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v84, v90, 1, s5
	ds_load_b128 v[100:103], v96 offset:128
	ds_load_b128 v[104:107], v96 offset:144
	ds_load_b128 v[180:183], v96 offset:4480
	ds_load_b128 v[116:119], v84 offset:128
	ds_load_b128 v[120:123], v84 offset:144
	ds_load_b128 v[140:143], v84 offset:4480
	ds_load_b128 v[144:147], v84 offset:4496
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[74:81], v[124:131], v[148:155], v[74:81]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[66:73], v[124:131], v[108:115], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[124:131], v[156:163], v[58:65] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[124:131], v[164:171], v[50:57] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[124:131], v[172:179], v[34:41] matrix_a_reuse
	ds_load_b128 v[184:187], v96 offset:4496
	ds_load_b128 v[124:127], v96 offset:8832
	ds_load_b128 v[128:131], v96 offset:8848
	ds_load_b128 v[188:191], v96 offset:13184
	ds_load_b128 v[192:195], v96 offset:13200
	ds_load_b128 v[196:199], v96 offset:17536
	ds_load_b128 v[200:203], v96 offset:17552
	s_wait_dscnt 0xe
	v_wmma_f32_16x16x32_bf16 v[42:49], v[132:139], v[172:179], v[42:49]
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[132:139], v[164:171], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[132:139], v[156:163], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[132:139], v[108:115], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[132:139], v[148:155], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[108:111], v84 offset:192
	ds_load_b128 v[112:115], v84 offset:208
	ds_load_b128 v[132:135], v84 offset:4544
	ds_load_b128 v[136:139], v84 offset:4560
	ds_load_b128 v[148:151], v96 offset:192
	ds_load_b128 v[152:155], v96 offset:208
	ds_load_b128 v[156:159], v96 offset:4544
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[74:81], v[116:123], v[100:107], v[74:81]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0xd
	v_wmma_f32_16x16x32_bf16 v[66:73], v[116:123], v[180:187], v[66:73] matrix_a_reuse
	s_wait_dscnt 0xb
	v_wmma_f32_16x16x32_bf16 v[58:65], v[116:123], v[124:131], v[58:65] matrix_a_reuse
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[50:57], v[116:123], v[188:195], v[50:57] matrix_a_reuse
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[34:41], v[116:123], v[196:203], v[34:41] matrix_a_reuse
	ds_load_b128 v[160:163], v96 offset:4560
	ds_load_b128 v[116:119], v96 offset:8896
	ds_load_b128 v[120:123], v96 offset:8912
	ds_load_b128 v[164:167], v96 offset:13248
	ds_load_b128 v[168:171], v96 offset:13264
	ds_load_b128 v[172:175], v96 offset:17600
	ds_load_b128 v[176:179], v96 offset:17616
	v_wmma_f32_16x16x32_bf16 v[42:49], v[140:147], v[196:203], v[42:49]
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[140:147], v[188:195], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[140:147], v[124:131], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[140:147], v[180:187], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[140:147], v[100:107], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[74:81], v[108:115], v[148:155], v[74:81]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[66:73], v[108:115], v[156:163], v[66:73] matrix_a_reuse
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[58:65], v[108:115], v[116:123], v[58:65] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[50:57], v[108:115], v[164:171], v[50:57] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[108:115], v[172:179], v[34:41] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[132:139], v[172:179], v[42:49]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[132:139], v[164:171], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[132:139], v[116:123], v[10:17] matrix_a_reuse
...
; %bb.38:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_dual_mov_b32 v97, s13 :: v_dual_mov_b32 v96, s14
...
.LBB0_40:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v97, s5 :: v_dual_mov_b32 v96, s6
	s_bitset1_b32 s7, 31
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn320_bk128_wm2_wn4_mc1, .Lfunc_end0-bm064_bn320_bk128_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn320_bk128_wm2_wn4_mc1
	...
	.section	.text.bm064_bn320_bk128_wm2_wn4_mc1,"axG",@progbits,bm064_bn320_bk128_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn320_bk128_wm2_wn4_mc1.num_vgpr, 204
	.set .Lbm064_bn320_bk128_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm064_bn320_bk128_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm064_bn320_bk128_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm064_bn320_bk128_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm064_bn320_bk128_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm064_bn320_bk128_wm2_wn4_mc1.uses_flat_scratch, 1
	.set .Lbm064_bn320_bk128_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn320_bk128_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm064_bn320_bk128_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_580991e4f3b6fd5c,@object ; @__hip_cuid_580991e4f3b6fd5c
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_580991e4f3b6fd5c
__hip_cuid_580991e4f3b6fd5c:
	.byte	0                               ; 0x0
	.size	__hip_cuid_580991e4f3b6fd5c, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_580991e4f3b6fd5c
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn320_bk128_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn320_bk128_wm2_wn4_mc1.kd
