	...
	.section	.text.bm128_bn256_bk032_wm1_wn8_mc1,"axG",@progbits,bm128_bn256_bk032_wm1_wn8_mc1,comdat
	.protected	bm128_bn256_bk032_wm1_wn8_mc1 ; -- Begin function bm128_bn256_bk032_wm1_wn8_mc1
	.globl	bm128_bn256_bk032_wm1_wn8_mc1
	.p2align	8
	.type	bm128_bn256_bk032_wm1_wn8_mc1,@function
bm128_bn256_bk032_wm1_wn8_mc1: ; @bm128_bn256_bk032_wm1_wn8_mc1
; %bb.0:
...
.LBB0_20:
	...
	v_dual_mov_b32 v66, v9 :: v_dual_mov_b32 v105, v9
...
; %bb.21:
	...
	v_dual_lshrrev_b32 v5, 4, v5 :: v_dual_add_nc_u32 v130, v3, v4
	v_or_b32_e32 v3, 0x800, v2
	v_or_b32_e32 v1, 0xa00, v2
	...
	s_lshr_b32 s7, s7, 27
	v_dual_lshrrev_b32 v7, 4, v7 :: v_dual_mov_b32 v133, 0
	s_add_co_i32 s12, s12, s7
	v_dual_lshrrev_b32 v3, 4, v3 :: v_dual_bitop2_b32 v5, 56, v5 bitop3:0x40
	v_lshrrev_b32_e32 v1, 4, v1
	v_dual_lshrrev_b32 v9, 4, v9 :: v_dual_lshrrev_b32 v2, 4, v2
	v_and_b32_e32 v10, 0x1d8, v10
	...
	v_add_nc_u32_e32 v134, v10, v8
	v_and_b32_e32 v10, 0x1f8, v11
	v_dual_add_nc_u32 v1, 2, v136 :: v_dual_mov_b32 v155, v133
	s_ashr_i32 s7, s6, 31
	...
	v_and_b32_e32 v139, 30, v1
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v138, v5, v4 :: v_dual_add_nc_u32 v140, v6, v4
	v_dual_add_nc_u32 v142, v7, v4 :: v_dual_add_nc_u32 v146, v12, v4
	v_dual_add_nc_u32 v144, v3, v4 :: v_dual_add_nc_u32 v148, v9, v4
	v_dual_add_nc_u32 v150, v2, v4 :: v_dual_mov_b32 v2, v133
	v_dual_mov_b32 v3, v133 :: v_dual_add_nc_u32 v152, v10, v8
...
.LBB0_25:                               ;   in Loop: Header=BB0_26 Depth=2
	...
	v_cmp_eq_u32_e32 vcc_lo, s6, v139
...
; %bb.27:                               ;   in Loop: Header=BB0_26 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[158:159], v[132:133], 2, s[14:15]
...
.LBB0_31:                               ;   Parent Loop BB0_23 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v132, v156 :: v_dual_add_nc_u32 v143, -2, v143
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_lshl_add_u32 v143, v138, 1, s1
	v_lshl_add_u32 v145, v140, 1, s1
	v_lshl_add_u32 v147, v152, 1, s2
	ds_load_b128 v[156:159], v132
	ds_load_b128 v[160:163], v132 offset:16
	v_lshl_add_u32 v132, v146, 1, s1
	ds_load_b128 v[164:167], v143 offset:1024
	ds_load_b128 v[168:171], v143 offset:1040
	ds_load_b128 v[172:175], v145 offset:2048
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	ds_load_b128 v[188:191], v132 offset:5120
	ds_load_b128 v[192:195], v132 offset:5136
	v_lshl_add_u32 v132, v148, 1, s1
	ds_load_b128 v[196:199], v132 offset:6144
	ds_load_b128 v[200:203], v132 offset:6160
	v_lshl_add_u32 v132, v134, 1, s2
	ds_load_b128 v[204:207], v132
	ds_load_b128 v[208:211], v132 offset:16
	v_lshl_add_u32 v132, v144, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[196:203], v[204:211], v[2:9] matrix_b_reuse
	ds_load_b128 v[180:183], v147 offset:1024
	ds_load_b128 v[184:187], v147 offset:1040
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[188:195], v[180:187], v[10:17] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[188:195], v[204:211], v[18:25] matrix_b_reuse
	ds_load_b128 v[188:191], v132 offset:4096
	ds_load_b128 v[192:195], v132 offset:4112
	v_lshl_add_u32 v132, v142, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[188:195], v[180:187], v[26:33] matrix_b_reuse
	ds_load_b128 v[212:215], v132 offset:3072
	ds_load_b128 v[216:219], v132 offset:3088
	v_lshl_add_u32 v132, v150, 1, s1
	ds_load_b128 v[224:227], v132 offset:7184
	ds_load_b128 v[220:223], v132 offset:7168
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[90:97], v[220:227], v[180:187], v[90:97] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[220:227], v[204:211], v[82:89] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[98:105], v[164:171], v[180:187], v[98:105] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[114:121], v[156:163], v[180:187], v[114:121] matrix_b_reuse
	ds_load_b128 v[176:179], v145 offset:2064
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[172:179], v[180:187], v[58:65] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[74:81], v[196:203], v[180:187], v[74:81] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[122:129], v[156:163], v[204:211], v[122:129]
	v_wmma_f32_16x16x32_bf16 v[106:113], v[164:171], v[204:211], v[106:113] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[188:195], v[204:211], v[34:41] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[172:179], v[204:211], v[66:73] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[212:219], v[204:211], v[50:57] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[212:219], v[180:187], v[42:49] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_dual_mov_b32 v143, s13 :: v_dual_mov_b32 v156, s14
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_dual_mov_b32 v143, s5 :: v_dual_mov_b32 v156, s6
...
; %bb.47:
	...
	ds_store_b128 v98, v[62:65] offset:64
	ds_store_b128 v1, v[70:73] offset:64
	ds_store_b128 v1, v[54:57] offset:96
	ds_store_b128 v98, v[46:49] offset:96
	ds_store_b128 v98, v[30:33] offset:128
	ds_store_b128 v1, v[38:41] offset:128
	ds_store_b128 v1, v[22:25] offset:160
	ds_store_b128 v98, v[14:17] offset:160
	ds_store_b128 v98, v[2:5] offset:192
	ds_store_b128 v1, v[6:9] offset:192
	ds_store_b128 v1, v[10:13] offset:224
	ds_store_b128 v98, v[18:21] offset:224
.LBB0_48:
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn256_bk032_wm1_wn8_mc1, .Lfunc_end0-bm128_bn256_bk032_wm1_wn8_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn256_bk032_wm1_wn8_mc1
	...
	.section	.text.bm128_bn256_bk032_wm1_wn8_mc1,"axG",@progbits,bm128_bn256_bk032_wm1_wn8_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn256_bk032_wm1_wn8_mc1.num_vgpr, 228
	.set .Lbm128_bn256_bk032_wm1_wn8_mc1.num_agpr, 0
	.set .Lbm128_bn256_bk032_wm1_wn8_mc1.numbered_sgpr, 56
	.set .Lbm128_bn256_bk032_wm1_wn8_mc1.num_named_barrier, 0
	.set .Lbm128_bn256_bk032_wm1_wn8_mc1.private_seg_size, 0
	.set .Lbm128_bn256_bk032_wm1_wn8_mc1.uses_vcc, 1
	.set .Lbm128_bn256_bk032_wm1_wn8_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn256_bk032_wm1_wn8_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn256_bk032_wm1_wn8_mc1.has_recursion, 0
	.set .Lbm128_bn256_bk032_wm1_wn8_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_99caf14ecb28128d,@object ; @__hip_cuid_99caf14ecb28128d
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_99caf14ecb28128d
__hip_cuid_99caf14ecb28128d:
	.byte	0                               ; 0x0
	.size	__hip_cuid_99caf14ecb28128d, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_99caf14ecb28128d
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn256_bk032_wm1_wn8_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn256_bk032_wm1_wn8_mc1.kd
