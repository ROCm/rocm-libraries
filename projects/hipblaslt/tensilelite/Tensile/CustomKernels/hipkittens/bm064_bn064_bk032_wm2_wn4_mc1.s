	...
	.section	.text.bm064_bn064_bk032_wm2_wn4_mc1,"axG",@progbits,bm064_bn064_bk032_wm2_wn4_mc1,comdat
	.protected	bm064_bn064_bk032_wm2_wn4_mc1 ; -- Begin function bm064_bn064_bk032_wm2_wn4_mc1
	.globl	bm064_bn064_bk032_wm2_wn4_mc1
	.p2align	8
	.type	bm064_bn064_bk032_wm2_wn4_mc1,@function
bm064_bn064_bk032_wm2_wn4_mc1: ; @bm064_bn064_bk032_wm2_wn4_mc1
; %bb.0:
...
; %bb.12:                               ;   in Loop: Header=BB0_11 Depth=1
	ds_store_b32 v4, v5 offset:4352
; %bb.13:                               ;   in Loop: Header=BB0_11 Depth=1
	s_or_b32 exec_lo, exec_lo, s5
	s_and_saveexec_b32 s2, vcc_lo
	s_cbranch_execz .LBB0_10
; %bb.14:                               ;   in Loop: Header=BB0_11 Depth=1
	ds_store_b32 v4, v5 offset:5376
	s_branch .LBB0_10
.LBB0_15:
	s_or_b32 exec_lo, exec_lo, s11
	s_barrier_signal -1
...
.LBB0_24:
	...
	v_dual_lshlrev_b32 v1, 3, v23 :: v_dual_lshlrev_b32 v2, 4, v23
	v_mov_b32_e32 v9, 0
	s_and_b32 s41, s29, s25
	s_and_not1_b32 vcc_lo, exec_lo, s13
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_and_b32_e32 v27, 32, v1
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v30, 48, v2 bitop3:0x40
...
; %bb.25:
	...
	s_add_co_i32 s4, s6, 0x3300
	s_add_co_i32 s43, s6, 0x2200
	s_and_b32 s10, s4, 15
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_lshrrev_b32 v3, 4, v2 :: v_dual_lshrrev_b32 v5, 4, v1
	s_sub_co_i32 s7, 16, s10
	v_or_b32_e32 v4, 0x200, v2
	s_lshr_b32 s6, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_and_b32_e32 v3, 0x58, v3
	...
	v_dual_mov_b32 v21, 0 :: v_dual_lshrrev_b32 v22, 8, v19
	s_lshl_b32 s10, s6, 2
	s_ashr_i32 s45, s12, 5
	s_cmp_lt_i32 s3, 64
	...
	v_dual_add_nc_u32 v24, v5, v1 :: v_dual_add_nc_u32 v1, 2, v22
	s_ashr_i32 s7, s6, 31
	...
	v_dual_mov_b32 v19, v22 :: v_dual_bitop2_b32 v31, 14, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v26, v3, v2 :: v_dual_mov_b32 v2, v21
	v_dual_mov_b32 v3, v21 :: v_dual_mov_b32 v4, v21
...
.LBB0_30:                               ;   Parent Loop BB0_27 Depth=1
	...
	s_mov_b32 s7, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_or_b64 s[16:17], s[6:7], 0x100000000
	s_mov_b32 s7, exec_lo
	v_cmp_le_u32_e32 vcc_lo, s17, v19
	v_cmpx_le_u32_e64 s16, v22
	s_cbranch_execz .LBB0_32
; %bb.31:                               ;   in Loop: Header=BB0_30 Depth=2
	v_mov_b32_e32 v20, v28
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[32:33], v[20:21], 2, s[14:15]
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_lshl_add_u32 v28, v26, 1, s1
	v_lshl_add_u32 v29, v24, 1, s2
	...
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[32:39], v[48:55], v[2:9]
	ds_load_b128 v[44:47], v28 offset:1040
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[40:47], v[48:55], v[10:17] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
...
.LBB0_50:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_dual_mov_b32 v29, s5 :: v_dual_mov_b32 v28, s6
	s_and_b32 s1, s7, 0x1ffffff
	s_and_b32 s7, s29, s13
	s_bitset1_b32 s1, 31
...
; %bb.52:
	...
	v_and_or_b32 v18, v0, 15, v30
	v_nop
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_and_or_b32 v1, v1, 8, v27
...
.LBB0_64:
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn064_bk032_wm2_wn4_mc1, .Lfunc_end0-bm064_bn064_bk032_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn064_bk032_wm2_wn4_mc1
	...
	.section	.text.bm064_bn064_bk032_wm2_wn4_mc1,"axG",@progbits,bm064_bn064_bk032_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn064_bk032_wm2_wn4_mc1.num_vgpr, 56
	.set .Lbm064_bn064_bk032_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm064_bn064_bk032_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm064_bn064_bk032_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm064_bn064_bk032_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm064_bn064_bk032_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm064_bn064_bk032_wm2_wn4_mc1.uses_flat_scratch, 0
	.set .Lbm064_bn064_bk032_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn064_bk032_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm064_bn064_bk032_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_26c106df1240bb49,@object ; @__hip_cuid_26c106df1240bb49
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_26c106df1240bb49
__hip_cuid_26c106df1240bb49:
	.byte	0                               ; 0x0
	.size	__hip_cuid_26c106df1240bb49, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_26c106df1240bb49
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn064_bk032_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn064_bk032_wm2_wn4_mc1.kd
