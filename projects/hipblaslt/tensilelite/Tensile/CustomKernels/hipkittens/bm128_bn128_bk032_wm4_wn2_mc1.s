	...
	.section	.text.bm128_bn128_bk032_wm4_wn2_mc1,"axG",@progbits,bm128_bn128_bk032_wm4_wn2_mc1,comdat
	.protected	bm128_bn128_bk032_wm4_wn2_mc1 ; -- Begin function bm128_bn128_bk032_wm4_wn2_mc1
	.globl	bm128_bn128_bk032_wm4_wn2_mc1
	.p2align	8
	.type	bm128_bn128_bk032_wm4_wn2_mc1,@function
bm128_bn128_bk032_wm4_wn2_mc1: ; @bm128_bn128_bk032_wm4_wn2_mc1
; %bb.0:
	...
	s_add_co_i32 s3, s25, 0x7f
	s_sub_co_i32 s4, s24, s28
	s_ashr_i32 s5, s2, 31
	s_ashr_i32 s8, s3, 31
	s_min_i32 s27, s4, 0x80
	s_lshr_b32 s4, s5, 25
	s_lshr_b32 s5, s8, 25
...
.LBB0_24:
	...
	v_dual_lshlrev_b32 v1, 4, v73 :: v_dual_lshlrev_b32 v2, 6, v73
	v_mov_b32_e32 v17, 0
	s_and_b32 s41, s29, s25
	s_and_not1_b32 vcc_lo, exec_lo, s13
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_and_b32_e32 v75, 0x60, v1
	v_dual_mov_b32 v16, v17 :: v_dual_bitop2_b32 v77, 64, v2 bitop3:0x40
...
; %bb.25:
	...
	v_dual_mov_b32 v69, 0 :: v_dual_lshrrev_b32 v5, 4, v2
	s_lshl2_add_u32 s6, s4, s36
	v_or_b32_e32 v1, 0x200, v2
	s_add_co_i32 s4, s6, 0x6600
	s_add_co_i32 s43, s6, 0x4400
	s_and_b32 s10, s4, 15
	...
	v_dual_add_nc_u32 v70, v4, v3 :: v_dual_add_nc_u32 v1, 2, v72
	...
	v_dual_add_nc_u32 v74, v8, v2 :: v_dual_add_nc_u32 v78, v5, v3
	v_dual_add_nc_u32 v76, v4, v3 :: v_dual_add_nc_u32 v80, v6, v3
...
.LBB0_30:                               ;   Parent Loop BB0_27 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s17, v67
	v_cmpx_le_u32_e64 s16, v72
	s_cbranch_execz .LBB0_32
; %bb.31:                               ;   in Loop: Header=BB0_30 Depth=2
	v_mov_b32_e32 v68, v82
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[84:85], v[68:69], 2, s[14:15]
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_lshl_add_u32 v81, v74, 1, s1
	v_lshl_add_u32 v94, v78, 1, s2
	ds_load_b128 v[82:85], v68
	ds_load_b128 v[86:89], v68 offset:16
	v_lshl_add_u32 v68, v80, 1, s2
	ds_load_b128 v[90:93], v81 offset:1024
	ds_load_b128 v[98:101], v94 offset:2048
	ds_load_b128 v[102:105], v94 offset:2064
	ds_load_b128 v[94:97], v81 offset:1040
	ds_load_b128 v[106:109], v68 offset:3072
	ds_load_b128 v[110:113], v68 offset:3088
	v_lshl_add_u32 v68, v70, 1, s2
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[90:97], v[106:113], v[34:41]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[82:89], v[106:113], v[2:9] matrix_a_reuse
	ds_load_b128 v[106:109], v68
	ds_load_b128 v[110:113], v68 offset:16
	v_lshl_add_u32 v68, v76, 1, s2
	ds_load_b128 v[118:121], v68 offset:1040
	ds_load_b128 v[114:117], v68 offset:1024
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[90:97], v[114:121], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[82:89], v[114:121], v[50:57] matrix_a_reuse
	...
	v_wmma_f32_16x16x32_bf16 v[42:49], v[82:89], v[98:105], v[42:49] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[90:97], v[106:113], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[82:89], v[106:113], v[58:65]
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
...
; %bb.48:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v81, s13 :: v_dual_mov_b32 v82, s14
...
.LBB0_50:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v81, s5 :: v_dual_mov_b32 v82, s6
...
; %bb.52:
	...
	v_dual_add_nc_u32 v45, 16, v1 :: v_dual_lshrrev_b32 v42, 3, v42
	...
	v_add_nc_u32_e32 v11, 0x1010, v1
	...
	v_dual_lshrrev_b32 v10, 3, v44 :: v_dual_lshlrev_b32 v44, 1, v45
	...
	ds_store_b128 v42, v[6:9] offset:12288
	ds_store_b128 v43, v[14:17] offset:32
	ds_store_b128 v45, v[2:5] offset:4096
...
.LBB0_64:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn128_bk032_wm4_wn2_mc1, .Lfunc_end0-bm128_bn128_bk032_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn128_bk032_wm4_wn2_mc1
	...
	.section	.text.bm128_bn128_bk032_wm4_wn2_mc1,"axG",@progbits,bm128_bn128_bk032_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn128_bk032_wm4_wn2_mc1.num_vgpr, 122
	.set .Lbm128_bn128_bk032_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm128_bn128_bk032_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm128_bn128_bk032_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm128_bn128_bk032_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm128_bn128_bk032_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm128_bn128_bk032_wm4_wn2_mc1.uses_flat_scratch, 0
	.set .Lbm128_bn128_bk032_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn128_bk032_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm128_bn128_bk032_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_dfde103d9b7edd89,@object ; @__hip_cuid_dfde103d9b7edd89
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_dfde103d9b7edd89
__hip_cuid_dfde103d9b7edd89:
	.byte	0                               ; 0x0
	.size	__hip_cuid_dfde103d9b7edd89, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_dfde103d9b7edd89
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn128_bk032_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn128_bk032_wm4_wn2_mc1.kd
