	...
	.section	.text.bm064_bn128_bk032_wm4_wn2_mc0,"axG",@progbits,bm064_bn128_bk032_wm4_wn2_mc0,comdat
	.protected	bm064_bn128_bk032_wm4_wn2_mc0 ; -- Begin function bm064_bn128_bk032_wm4_wn2_mc0
	.globl	bm064_bn128_bk032_wm4_wn2_mc0
	.p2align	8
	.type	bm064_bn128_bk032_wm4_wn2_mc0,@function
bm064_bn128_bk032_wm4_wn2_mc0: ; @bm064_bn128_bk032_wm4_wn2_mc0
; %bb.0:
...
.LBB0_22:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 3, v41 :: v_dual_lshlrev_b32 v2, 6, v41
	s_and_b32 s40, s29, s25
	v_mov_b32_e32 v25, 0
	v_cndmask_b32_e64 v43, 0, 1, s40
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v45, 48, v1
	v_and_b32_e32 v47, 64, v2
	s_and_not1_b32 vcc_lo, exec_lo, s16
	v_dual_mov_b32 v24, v25 :: v_dual_mov_b32 v23, v25
	v_dual_mov_b32 v22, v25 :: v_dual_mov_b32 v21, v25
	v_dual_mov_b32 v20, v25 :: v_dual_mov_b32 v19, v25
	v_dual_mov_b32 v18, v25 :: v_dual_mov_b32 v33, v25
	v_dual_mov_b32 v32, v25 :: v_dual_mov_b32 v31, v25
	v_dual_mov_b32 v30, v25 :: v_dual_mov_b32 v29, v25
	v_dual_mov_b32 v28, v25 :: v_dual_mov_b32 v27, v25
	v_dual_mov_b32 v26, v25 :: v_dual_mov_b32 v9, v25
	v_dual_mov_b32 v8, v25 :: v_dual_mov_b32 v7, v25
	v_dual_mov_b32 v6, v25 :: v_dual_mov_b32 v5, v25
	v_dual_mov_b32 v4, v25 :: v_dual_mov_b32 v3, v25
	v_dual_mov_b32 v2, v25 :: v_dual_mov_b32 v17, v25
	v_dual_mov_b32 v16, v25 :: v_dual_mov_b32 v15, v25
	v_dual_mov_b32 v14, v25 :: v_dual_mov_b32 v13, v25
	v_dual_mov_b32 v12, v25 :: v_dual_mov_b32 v11, v25
...
; %bb.23:
	...
	v_dual_lshlrev_b32 v1, 5, v47 :: v_dual_lshlrev_b32 v2, 5, v45
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s35, 0x3300
	...
	s_add_co_i32 s4, s6, 0x4400
	s_add_co_i32 s42, s6, 0x3300
	s_and_b32 s10, s4, 15
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_add_nc_u32 v34, v1, v2 :: v_dual_lshrrev_b32 v2, 4, v5
	v_and_b32_e32 v1, 0x98, v4
	v_or_b32_e32 v5, 0x600, v3
	s_sub_co_i32 s7, 16, s10
	v_dual_mov_b32 v37, 0 :: v_dual_lshrrev_b32 v4, 4, v6
	s_lshr_b32 s6, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_dual_add_nc_u32 v38, v1, v3 :: v_dual_lshrrev_b32 v1, 4, v5
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_dual_mov_b32 v18, v37 :: v_dual_sub_nc_u32 v5, 0x87f, v0
	s_cselect_b32 s6, s6, 0
	s_ashr_i32 s7, s17, 31
	v_dual_lshrrev_b32 v40, 8, v35 :: v_dual_lshrrev_b32 v42, 8, v5
	s_lshr_b32 s7, s7, 27
	s_lshl_b32 s10, s6, 2
	...
	v_dual_add_nc_u32 v1, 2, v40 :: v_dual_add_nc_u32 v5, 2, v42
	s_ashr_i32 s7, s6, 31
	s_ashr_i32 s5, s4, 31
	s_wait_kmcnt 0x0
	...
	v_dual_mov_b32 v35, v40 :: v_dual_bitop2_b32 v49, 14, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v39, v42 :: v_dual_bitop2_b32 v52, 30, v5 bitop3:0x40
	v_dual_add_nc_u32 v44, v2, v3 :: v_dual_add_nc_u32 v46, v4, v3
	v_dual_mov_b32 v19, v37 :: v_dual_add_nc_u32 v48, v6, v3
...
.LBB0_27:                               ;   in Loop: Header=BB0_28 Depth=2
	...
	v_cmp_eq_u32_e32 vcc_lo, s6, v49
...
; %bb.29:                               ;   in Loop: Header=BB0_28 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[54:55], v[36:37], 2, s[12:13]
...
.LBB0_33:                               ;   in Loop: Header=BB0_34 Depth=2
	...
	s_add_co_i32 s6, s6, 2
	v_add_nc_u32_e32 v51, 0x200, v51
	v_cmp_eq_u32_e32 vcc_lo, s6, v52
	v_add_nc_u32_e32 v50, 0x200, v50
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
; %bb.43:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v51, s14 :: v_dual_mov_b32 v50, s12
...
.LBB0_46:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_lshl_add_u32 v36, v34, 1, s0
	v_lshl_add_u32 v50, v38, 1, s2
	...
	ds_load_b128 v[70:73], v36 offset:1024
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[18:25], v[54:61], v[62:69], v[18:25]
	ds_load_b128 v[74:77], v36 offset:1040
	v_lshl_add_u32 v36, v46, 1, s2
	ds_load_b128 v[62:65], v36 offset:2048
	ds_load_b128 v[66:69], v36 offset:2064
	v_lshl_add_u32 v36, v48, 1, s2
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[54:61], v[70:77], v[26:33] matrix_a_reuse
	ds_load_b128 v[70:73], v36 offset:3072
	ds_load_b128 v[74:77], v36 offset:3088
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[54:61], v[70:77], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[54:61], v[62:69], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
...
; %bb.48:
	...
	v_and_or_b32 v34, v0, 15, v47
	v_nop
	v_nop
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_cvt_pk_bf16_f32 v25, v24, v25
	v_and_or_b32 v1, v1, 8, v45
	...
	ds_store_b128 v26, v[22:25]
	ds_store_b128 v28, v[18:21] offset:2048
...
.LBB0_60:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn128_bk032_wm4_wn2_mc0, .Lfunc_end0-bm064_bn128_bk032_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn128_bk032_wm4_wn2_mc0
	...
	.section	.text.bm064_bn128_bk032_wm4_wn2_mc0,"axG",@progbits,bm064_bn128_bk032_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn128_bk032_wm4_wn2_mc0.num_vgpr, 78
	.set .Lbm064_bn128_bk032_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm064_bn128_bk032_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm064_bn128_bk032_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm064_bn128_bk032_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm064_bn128_bk032_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm064_bn128_bk032_wm4_wn2_mc0.uses_flat_scratch, 0
	.set .Lbm064_bn128_bk032_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn128_bk032_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm064_bn128_bk032_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_10ef44fbc4398d04,@object ; @__hip_cuid_10ef44fbc4398d04
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_10ef44fbc4398d04
__hip_cuid_10ef44fbc4398d04:
	.byte	0                               ; 0x0
	.size	__hip_cuid_10ef44fbc4398d04, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_10ef44fbc4398d04
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn128_bk032_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn128_bk032_wm4_wn2_mc0.kd
