	...
	.section	.text.bm128_bn128_bk064_wm2_wn4_mc0,"axG",@progbits,bm128_bn128_bk064_wm2_wn4_mc0,comdat
	.protected	bm128_bn128_bk064_wm2_wn4_mc0 ; -- Begin function bm128_bn128_bk064_wm2_wn4_mc0
	.globl	bm128_bn128_bk064_wm2_wn4_mc0
	.p2align	8
	.type	bm128_bn128_bk064_wm2_wn4_mc0,@function
bm128_bn128_bk064_wm2_wn4_mc0: ; @bm128_bn128_bk064_wm2_wn4_mc0
; %bb.0:
	...
	s_wait_kmcnt 0x0
	s_add_co_i32 s4, s16, 0x7f
	s_add_co_i32 s6, s17, 0x7f
	s_ashr_i32 s5, s4, 31
	s_lshl_b32 s20, s35, 7
	s_lshr_b32 s5, s5, 25
...
.LBB0_14:
	...
	s_and_b32 s35, s21, s17
	s_and_not1_b32 vcc_lo, exec_lo, s29
	v_cndmask_b32_e64 v67, 0, 1, s35
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v71, 64, v1 bitop3:0x40
...
; %bb.15:
	v_dual_lshlrev_b32 v1, 6, v0 :: v_dual_lshlrev_b32 v2, 6, v71
	...
	v_or_b32_e32 v8, 0xc00, v4
	s_lshl2_add_u32 s2, s0, s37
	v_or_b32_e32 v6, 0x400, v4
	v_and_b32_e32 v5, 0x138, v5
	s_add_co_i32 s0, s2, 0xcc00
	s_add_co_i32 s38, s2, 0x8800
	s_and_b32 s6, s0, 15
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_add_nc_u32 v66, v5, v4
	...
	v_dual_lshrrev_b32 v14, 4, v14 :: v_dual_add_nc_u32 v72, v6, v4
	s_lshl_b32 s6, s2, 2
	...
	v_dual_add_nc_u32 v74, v7, v4 :: v_dual_add_nc_u32 v78, v9, v5
	v_dual_add_nc_u32 v80, v10, v2 :: v_dual_add_nc_u32 v88, v15, v5
	v_add3_u32 v82, v2, v11, 0x400
	v_add3_u32 v84, v2, v13, 0x800
	v_add3_u32 v86, v2, v12, 0xc00
	v_add3_u32 v90, v5, v14, 0x400
	v_or_b32_e32 v75, 0xf00, v0
	v_lshl_or_b32 v92, v0, 2, 0x4000
	v_dual_mov_b32 v93, v69 :: v_dual_mov_b32 v2, v69
...
; %bb.18:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_cmp_lg_u32 s31, 0
	s_mov_b32 s6, 0
	s_cselect_b32 s3, s37, s27
	s_cselect_b32 s2, s38, 0
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v68, v94 :: v_dual_add_nc_u32 v77, -2, v77
	v_dual_mov_b32 v96, v95 :: v_dual_mov_b32 v97, v69
	v_add_nc_u32_e32 v95, 0x200, v95
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[98:99], v[68:69], 2, s[2:3]
	v_cmp_eq_u32_e32 vcc_lo, 0, v77
	v_add_nc_u32_e32 v94, 0x200, v94
	v_lshl_add_u64 v[96:97], v[96:97], 2, s[2:3]
	s_clause 0x1
	flat_store_b32 v[98:99], v69
	flat_store_b32 v[96:97], v69
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[94:95], s[2:3], v[92:93]
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_dual_mov_b32 v77, s1 :: v_dual_mov_b32 v94, s2
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_lshl_add_u32 v77, v72, 1, s1
	v_lshl_add_u32 v79, v70, 1, s2
	v_lshl_add_u32 v81, v86, 1, s1
	v_lshl_add_u32 v83, v88, 1, s2
	ds_load_b128 v[94:97], v68
	ds_load_b128 v[98:101], v68 offset:16
	ds_load_b128 v[102:105], v77 offset:2048
	ds_load_b128 v[110:113], v79
	ds_load_b128 v[114:117], v79 offset:16
	v_lshl_add_u32 v68, v78, 1, s2
	v_lshl_add_u32 v79, v84, 1, s1
	v_lshl_add_u32 v85, v90, 1, s2
	ds_load_b128 v[134:137], v81 offset:64
	ds_load_b128 v[138:141], v81 offset:80
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[58:65], v[94:101], v[110:117], v[58:65]
	ds_load_b128 v[118:121], v68 offset:2048
	ds_load_b128 v[122:125], v68 offset:2064
	v_lshl_add_u32 v68, v74, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[50:57], v[94:101], v[118:125], v[50:57] matrix_b_reuse
	ds_load_b128 v[94:97], v68 offset:4096
	ds_load_b128 v[98:101], v68 offset:4112
	v_lshl_add_u32 v68, v76, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[94:101], v[110:117], v[18:25] matrix_b_reuse
	ds_load_b128 v[106:109], v77 offset:2064
	v_lshl_add_u32 v77, v82, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[102:109], v[110:117], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[102:109], v[118:125], v[26:33] matrix_b_reuse
	ds_load_b128 v[106:109], v68 offset:6160
	ds_load_b128 v[102:105], v68 offset:6144
	v_lshl_add_u32 v68, v80, 1, s1
	ds_load_b128 v[126:129], v68 offset:64
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[34:41], v[102:109], v[118:125], v[34:41] matrix_a_reuse
	ds_load_b128 v[130:133], v68 offset:80
	...
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[94:101], v[118:125], v[10:17] matrix_b_reuse
	ds_load_b128 v[118:121], v79 offset:64
	ds_load_b128 v[122:125], v79 offset:80
	ds_load_b128 v[94:97], v83 offset:64
	ds_load_b128 v[98:101], v83 offset:80
	v_wmma_f32_16x16x32_bf16 v[2:9], v[102:109], v[110:117], v[2:9] matrix_b_reuse
	ds_load_b128 v[102:105], v77 offset:64
	ds_load_b128 v[106:109], v77 offset:80
	ds_load_b128 v[110:113], v85 offset:64
	ds_load_b128 v[114:117], v85 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[58:65], v[126:133], v[94:101], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[42:49], v[102:109], v[94:101], v[42:49] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[118:125], v[94:101], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[134:141], v[94:101], v[2:9] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[134:141], v[110:117], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[118:125], v[110:117], v[10:17] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[102:109], v[110:117], v[26:33] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[126:133], v[110:117], v[50:57] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn128_bk064_wm2_wn4_mc0, .Lfunc_end0-bm128_bn128_bk064_wm2_wn4_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn128_bk064_wm2_wn4_mc0
	...
	.section	.text.bm128_bn128_bk064_wm2_wn4_mc0,"axG",@progbits,bm128_bn128_bk064_wm2_wn4_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn128_bk064_wm2_wn4_mc0.num_vgpr, 142
	.set .Lbm128_bn128_bk064_wm2_wn4_mc0.num_agpr, 0
	.set .Lbm128_bn128_bk064_wm2_wn4_mc0.numbered_sgpr, 52
	.set .Lbm128_bn128_bk064_wm2_wn4_mc0.num_named_barrier, 0
	.set .Lbm128_bn128_bk064_wm2_wn4_mc0.private_seg_size, 0
	.set .Lbm128_bn128_bk064_wm2_wn4_mc0.uses_vcc, 1
	.set .Lbm128_bn128_bk064_wm2_wn4_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn128_bk064_wm2_wn4_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn128_bk064_wm2_wn4_mc0.has_recursion, 0
	.set .Lbm128_bn128_bk064_wm2_wn4_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_bd20871d07625ce1,@object ; @__hip_cuid_bd20871d07625ce1
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_bd20871d07625ce1
__hip_cuid_bd20871d07625ce1:
	.byte	0                               ; 0x0
	.size	__hip_cuid_bd20871d07625ce1, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_bd20871d07625ce1
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn128_bk064_wm2_wn4_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     54
    .sgpr_spill_count: 0
    .symbol:         bm128_bn128_bk064_wm2_wn4_mc0.kd
