	...
	.section	.text.bm064_bn160_bk032_wm4_wn2_mc1,"axG",@progbits,bm064_bn160_bk032_wm4_wn2_mc1,comdat
	.protected	bm064_bn160_bk032_wm4_wn2_mc1 ; -- Begin function bm064_bn160_bk032_wm4_wn2_mc1
	.globl	bm064_bn160_bk032_wm4_wn2_mc1
	.p2align	8
	.type	bm064_bn160_bk032_wm4_wn2_mc1,@function
bm064_bn160_bk032_wm4_wn2_mc1: ; @bm064_bn160_bk032_wm4_wn2_mc1
; %bb.0:
...
.LBB0_24:
	...
	v_dual_lshlrev_b32 v1, 3, v51 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	v_mov_b32_e32 v17, 0
	s_and_b32 s43, s35, s29
	s_mov_b32 s11, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v53, 48, v1
	v_cmp_ne_u32_e32 vcc_lo, 0, v2
	v_cndmask_b32_e64 v49, 0, 1, s43
	v_dual_mov_b32 v16, v17 :: v_dual_mov_b32 v15, v17
	v_dual_mov_b32 v14, v17 :: v_dual_mov_b32 v13, v17
	v_cndmask_b32_e64 v55, 0, 0x50, vcc_lo
	v_dual_mov_b32 v12, v17 :: v_dual_mov_b32 v11, v17
	v_dual_mov_b32 v10, v17 :: v_dual_mov_b32 v41, v17
	...
	v_dual_mov_b32 v34, v17 :: v_dual_mov_b32 v9, v17
...
; %bb.25:
	...
	v_dual_lshlrev_b32 v1, 5, v55 :: v_dual_lshlrev_b32 v2, 5, v53
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s1, 0x3b80
	s_delay_alu instid0(VALU_DEP_2)
	...
	v_dual_mov_b32 v45, 0 :: v_dual_lshrrev_b32 v5, 4, v2
	s_cmp_lg_u64 s[6:7], 0
	v_or_b32_e32 v4, 0x400, v3
	s_cselect_b32 s4, s4, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v13, v45 :: v_dual_add_nc_u32 v6, 0x800, v3
	v_and_b32_e32 v5, 0x78, v5
	s_lshl2_add_u32 s1, s4, s1
	s_mul_i32 s6, s17, 0xa0
	v_lshrrev_b32_e32 v1, 4, v3
	s_add_co_i32 s4, s1, 0x4c80
	v_add_nc_u32_e32 v42, v5, v2
	s_and_b32 s10, s4, 15
	s_add_co_i32 s45, s1, 0x3b80
	v_and_b32_e32 v1, 0xb8, v1
	s_sub_co_i32 s7, 16, s10
	v_dual_mov_b32 v11, v45 :: v_dual_add_nc_u32 v2, 0x200, v3
	s_lshr_b32 s1, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_dual_mov_b32 v10, v45 :: v_dual_add_nc_u32 v5, 0x600, v3
	v_add_nc_u32_e32 v46, v1, v3
	v_dual_mov_b32 v12, v45 :: v_dual_sub_nc_u32 v1, 0xa9f, v0
	s_cselect_b32 s1, s1, 0
	s_ashr_i32 s7, s12, 31
	v_dual_lshrrev_b32 v2, 4, v2 :: v_dual_lshrrev_b32 v4, 4, v4
	s_lshr_b32 s7, s7, 27
	v_dual_lshrrev_b32 v5, 4, v5 :: v_dual_lshrrev_b32 v6, 4, v6
	s_add_co_i32 s12, s12, s7
	v_dual_lshrrev_b32 v50, 8, v1 :: v_dual_lshrrev_b32 v48, 8, v43
	s_lshl_b32 s10, s1, 2
	...
	v_dual_add_nc_u32 v7, 2, v50 :: v_dual_add_nc_u32 v1, 2, v48
	...
	v_and_b32_e32 v59, 14, v7
	v_dual_add_nc_u32 v52, v2, v3 :: v_dual_bitop2_b32 v57, 14, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v54, v4, v3 :: v_dual_add_nc_u32 v56, v5, v3
	v_dual_add_nc_u32 v58, v6, v3 :: v_dual_mov_b32 v14, v45
	v_dual_mov_b32 v15, v45 :: v_dual_mov_b32 v16, v45
	v_dual_mov_b32 v17, v45 :: v_dual_mov_b32 v34, v45
	...
	v_dual_mov_b32 v41, v45 :: v_dual_mov_b32 v2, v45
	v_dual_mov_b32 v3, v45 :: v_dual_mov_b32 v4, v45
	v_dual_mov_b32 v5, v45 :: v_dual_mov_b32 v6, v45
	v_dual_mov_b32 v7, v45 :: v_dual_mov_b32 v8, v45
	v_dual_mov_b32 v9, v45 :: v_dual_mov_b32 v18, v45
	...
	v_dual_mov_b32 v25, v45 :: v_dual_mov_b32 v26, v45
	...
	v_dual_mov_b32 v33, v45 :: v_dual_mov_b32 v43, v48
...
.LBB0_29:                               ;   in Loop: Header=BB0_30 Depth=2
	...
	v_cmp_eq_u32_e32 vcc_lo, s6, v57
...
.LBB0_30:                               ;   Parent Loop BB0_27 Depth=1
	...
	v_cmpx_le_u32_e64 s18, v48
	s_cbranch_execz .LBB0_32
; %bb.31:                               ;   in Loop: Header=BB0_30 Depth=2
	v_mov_b32_e32 v44, v60
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[62:63], v[44:45], 2, s[14:15]
	flat_store_b32 v[62:63], v45
...
.LBB0_34:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	s_cmp_lg_u32 s5, 0
	s_mov_b32 s6, 0
	s_cselect_b32 s15, s41, s44
	s_cselect_b32 s14, s40, s38
	s_mov_b32 s10, 0
	s_branch .LBB0_36
.LBB0_35:                               ;   in Loop: Header=BB0_36 Depth=2
	...
	s_add_co_i32 s6, s6, 2
	v_add_nc_u32_e32 v61, 0x200, v61
	v_cmp_eq_u32_e32 vcc_lo, s6, v59
	v_add_nc_u32_e32 v60, 0x200, v60
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
.LBB0_36:                               ;   Parent Loop BB0_27 Depth=1
	...
	s_or_b64 s[18:19], s[6:7], 0x100000000
	s_mov_b32 s7, exec_lo
	v_cmp_le_u32_e32 vcc_lo, s19, v47
	v_cmpx_le_u32_e64 s18, v50
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_lshl_add_u32 v44, v42, 1, s1
	v_lshl_add_u32 v72, v46, 1, s2
	v_lshl_add_u32 v96, v56, 1, s2
	v_lshl_add_u32 v104, v58, 1, s2
	ds_load_b128 v[60:63], v44
	ds_load_b128 v[64:67], v44 offset:16
	v_lshl_add_u32 v44, v52, 1, s2
	ds_load_b128 v[68:71], v72
	ds_load_b128 v[72:75], v72 offset:16
	ds_load_b128 v[92:95], v96 offset:3072
	ds_load_b128 v[96:99], v96 offset:3088
	ds_load_b128 v[76:79], v44 offset:1024
	ds_load_b128 v[80:83], v44 offset:1040
	v_lshl_add_u32 v44, v54, 1, s2
	ds_load_b128 v[100:103], v104 offset:4096
	ds_load_b128 v[104:107], v104 offset:4112
	ds_load_b128 v[84:87], v44 offset:2048
	ds_load_b128 v[88:91], v44 offset:2064
	; sched_group_barrier mask(0x00000100) size(12) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[34:41], v[60:67], v[68:75], v[34:41]
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[10:17], v[60:67], v[76:83], v[10:17] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[60:67], v[84:91], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[60:67], v[92:99], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[60:67], v[100:107], v[26:33] matrix_a_reuse
...
; %bb.48:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v61, s13 :: v_dual_mov_b32 v60, s14
...
; %bb.52:
	...
	v_and_or_b32 v42, v0, 15, v55
	v_cvt_pk_bf16_f32 v17, v16, v17
	v_cvt_pk_bf16_f32 v16, v14, v15
	v_cvt_pk_bf16_f32 v15, v12, v13
	v_and_or_b32 v1, v1, 8, v53
	...
	v_dual_lshrrev_b32 v10, 3, v11 :: v_dual_lshrrev_b32 v11, 3, v12
	v_lshlrev_b32_e32 v12, 1, v1
	v_add_nc_u32_e32 v1, 0x1000, v1
	v_lshrrev_b32_e32 v7, 3, v7
	v_and_b32_e32 v10, 0x7f0, v10
	v_and_b32_e32 v11, 0x7f0, v11
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v34, v6, v12 :: v_dual_lshrrev_b32 v1, 3, v1
	v_and_b32_e32 v13, 0x7f0, v7
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v35, v10, v12 :: v_dual_add_nc_u32 v36, v11, v12
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_and_b32_e32 v1, 0x7f0, v1
	v_cvt_pk_bf16_f32 v6, v2, v3
	v_add_nc_u32_e32 v37, v13, v12
	...
	ds_store_b128 v35, v[14:17] offset:2048
	ds_store_b128 v36, v[6:9] offset:4096
	ds_store_b128 v37, v[2:5] offset:6144
...
.LBB0_64:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn160_bk032_wm4_wn2_mc1, .Lfunc_end0-bm064_bn160_bk032_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn160_bk032_wm4_wn2_mc1
	...
	.section	.text.bm064_bn160_bk032_wm4_wn2_mc1,"axG",@progbits,bm064_bn160_bk032_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn160_bk032_wm4_wn2_mc1.num_vgpr, 108
	.set .Lbm064_bn160_bk032_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm064_bn160_bk032_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm064_bn160_bk032_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm064_bn160_bk032_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm064_bn160_bk032_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm064_bn160_bk032_wm4_wn2_mc1.uses_flat_scratch, 0
	.set .Lbm064_bn160_bk032_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn160_bk032_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm064_bn160_bk032_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_5116441300be5a26,@object ; @__hip_cuid_5116441300be5a26
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_5116441300be5a26
__hip_cuid_5116441300be5a26:
	.byte	0                               ; 0x0
	.size	__hip_cuid_5116441300be5a26, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_5116441300be5a26
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn160_bk032_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn160_bk032_wm4_wn2_mc1.kd
