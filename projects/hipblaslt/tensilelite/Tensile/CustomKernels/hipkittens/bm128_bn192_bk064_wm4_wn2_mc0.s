	...
	.section	.text.bm128_bn192_bk064_wm4_wn2_mc0,"axG",@progbits,bm128_bn192_bk064_wm4_wn2_mc0,comdat
	.protected	bm128_bn192_bk064_wm4_wn2_mc0 ; -- Begin function bm128_bn192_bk064_wm4_wn2_mc0
	.globl	bm128_bn192_bk064_wm4_wn2_mc0
	.p2align	8
	.type	bm128_bn192_bk064_wm4_wn2_mc0,@function
bm128_bn192_bk064_wm4_wn2_mc0: ; @bm128_bn192_bk064_wm4_wn2_mc0
; %bb.0:
...
; %bb.15:
	...
	v_dual_lshlrev_b32 v2, 6, v105 :: v_dual_lshlrev_b32 v3, 6, v103
	...
	v_or_b32_e32 v111, 0xf00, v0
	v_or_b32_e32 v6, v2, v4
	v_or_b32_e32 v5, v3, v4
	s_sub_co_i32 s6, 16, s4
	v_lshl_or_b32 v132, v0, 2, 0x4000
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v101, 0 :: v_dual_lshrrev_b32 v8, 4, v6
	v_lshrrev_b32_e32 v1, 4, v5
	v_or_b32_e32 v7, 0x400, v5
	s_lshr_b32 s6, s6, 2
	s_cmp_lg_u64 s[4:5], 0
	v_dual_mov_b32 v135, v101 :: v_dual_sub_nc_u32 v20, 0x197f, v0
	...
	v_and_b32_e32 v7, 0x1b8, v8
	v_or_b32_e32 v8, 0x400, v6
	v_add_nc_u32_e32 v9, 0x800, v6
	v_add_nc_u32_e32 v11, 0x1000, v6
	s_add_co_i32 s6, s0, 0xee00
	v_add_nc_u32_e32 v102, v7, v6
	v_and_b32_e32 v10, 0x1f8, v1
	v_dual_lshrrev_b32 v1, 4, v8 :: v_dual_lshrrev_b32 v8, 4, v9
	...
	v_and_b32_e32 v7, 0x3b8, v8
	v_add_nc_u32_e32 v13, 0x1400, v6
	v_dual_lshrrev_b32 v20, 8, v20 :: v_dual_bitop2_b32 v8, v9, v3 bitop3:0x54
	v_add_nc_u32_e32 v104, v10, v5
	...
	v_or_b32_e32 v15, 0x400, v1
	v_lshrrev_b32_e32 v16, 4, v1
	v_dual_mov_b32 v10, v101 :: v_dual_add_nc_u32 v17, 0x800, v1
	v_dual_mov_b32 v133, v101 :: v_dual_add_nc_u32 v18, 0xc00, v1
	v_add_nc_u32_e32 v19, 0x1000, v1
	v_add_nc_u32_e32 v1, 0x1400, v1
	v_dual_add_nc_u32 v20, 1, v20 :: v_dual_add_nc_u32 v106, v12, v6
	...
	v_dual_add_nc_u32 v108, v7, v6 :: v_dual_bitop2_b32 v109, 26, v20 bitop3:0x40
	v_dual_add_nc_u32 v3, v4, v3 :: v_dual_add_nc_u32 v110, v14, v6
	v_dual_mov_b32 v12, v101 :: v_dual_mov_b32 v14, v101
	...
	v_cmp_ne_u32_e64 s0, v20, v109
	v_dual_add_nc_u32 v112, v11, v6 :: v_dual_add_nc_u32 v114, v13, v6
	v_dual_add_nc_u32 v116, v8, v3 :: v_dual_lshlrev_b32 v134, 2, v22
	v_add3_u32 v118, v3, v9, 0x400
	v_add_nc_u32_e32 v113, 0xffffff00, v22
	v_dual_mov_b32 v3, v101 :: v_dual_add_nc_u32 v120, v16, v2
	v_mov_b32_e32 v5, v101
	v_add3_u32 v122, v2, v15, 0x400
	v_add3_u32 v124, v2, v17, 0x800
	v_add3_u32 v126, v2, v18, 0xc00
	v_add3_u32 v128, v2, v19, 0x1000
	v_add3_u32 v130, v2, v21, 0x1400
	v_dual_mov_b32 v2, v101 :: v_dual_mov_b32 v4, v101
	v_dual_mov_b32 v6, v101 :: v_dual_mov_b32 v7, v101
	v_dual_mov_b32 v9, v101 :: v_dual_mov_b32 v8, v101
	v_dual_mov_b32 v11, v101 :: v_dual_mov_b32 v13, v101
	v_dual_mov_b32 v15, v101 :: v_dual_mov_b32 v17, v101
	v_dual_mov_b32 v16, v101 :: v_dual_mov_b32 v18, v101
	v_dual_mov_b32 v19, v101 :: v_dual_mov_b32 v20, v101
	v_dual_mov_b32 v21, v101 :: v_dual_mov_b32 v22, v101
	v_dual_mov_b32 v23, v101 :: v_dual_mov_b32 v26, v101
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v100, v136 :: v_dual_add_nc_u32 v115, -2, v115
	v_dual_mov_b32 v138, v137 :: v_dual_mov_b32 v139, v101
	v_add_nc_u32_e32 v137, 0x200, v137
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[140:141], v[100:101], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v115
	v_add_nc_u32_e32 v136, 0x200, v136
	v_lshl_add_u64 v[138:139], v[138:139], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[140:141], v101
	flat_store_b32 v[138:139], v101
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[136:137], s[6:7], v[132:133]
...
.LBB0_22:                               ;   Parent Loop BB0_17 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[136:137], 0x400, v[136:137]
...
; %bb.26:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[136:137], s[6:7], v[134:135]
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v115, s14 :: v_dual_mov_b32 v136, s12
...
.LBB0_35:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v115, s5 :: v_dual_mov_b32 v136, s6
	s_bitset1_b32 s7, 31
	v_readfirstlane_b32 s52, v100
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_lshl_add_u32 v115, v104, 1, s6
	v_lshl_add_u32 v117, v114, 1, s5
	v_lshl_add_u32 v119, v122, 1, s5
	v_lshl_add_u32 v121, v124, 1, s5
	ds_load_b128 v[136:139], v100
	ds_load_b128 v[140:143], v100 offset:16
	ds_load_b128 v[144:147], v115 offset:2048
	ds_load_b128 v[148:151], v115 offset:2064
	ds_load_b128 v[152:155], v117 offset:10240
	ds_load_b128 v[156:159], v117 offset:10256
	v_lshl_add_u32 v100, v112, 1, s5
	v_lshl_add_u32 v115, v118, 1, s6
	v_lshl_add_u32 v117, v120, 1, s5
	v_lshl_add_u32 v123, v126, 1, s5
	v_lshl_add_u32 v125, v128, 1, s5
	v_lshl_add_u32 v127, v130, 1, s5
	ds_load_b128 v[184:187], v121 offset:64
	ds_load_b128 v[188:191], v121 offset:80
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[34:41], v[136:143], v[152:159], v[34:41] matrix_a_reuse
	ds_load_b128 v[192:195], v127 offset:64
	ds_load_b128 v[196:199], v127 offset:80
	v_wmma_f32_16x16x32_bf16 v[50:57], v[144:151], v[152:159], v[50:57]
	ds_load_b128 v[152:155], v100 offset:8192
	ds_load_b128 v[156:159], v100 offset:8208
	v_lshl_add_u32 v100, v108, 1, s5
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[144:151], v[152:159], v[2:9] matrix_a_reuse
	ds_load_b128 v[160:163], v100 offset:4096
	ds_load_b128 v[164:167], v100 offset:4112
	v_lshl_add_u32 v100, v106, 1, s5
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[74:81], v[136:143], v[160:167], v[74:81] matrix_a_reuse
	ds_load_b128 v[168:171], v100 offset:2048
	ds_load_b128 v[172:175], v100 offset:2064
	v_lshl_add_u32 v100, v102, 1, s5
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[144:151], v[168:175], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[136:143], v[168:175], v[82:89] matrix_a_reuse
	ds_load_b128 v[168:171], v100
	ds_load_b128 v[172:175], v100 offset:16
	v_lshl_add_u32 v100, v110, 1, s5
	ds_load_b128 v[176:179], v100 offset:6144
	ds_load_b128 v[180:183], v100 offset:6160
	v_lshl_add_u32 v100, v116, 1, s6
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[66:73], v[136:143], v[176:183], v[66:73] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[144:151], v[176:183], v[10:17] matrix_a_reuse
	ds_load_b128 v[176:179], v119 offset:64
	ds_load_b128 v[180:183], v119 offset:80
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[136:143], v[152:159], v[58:65] matrix_a_reuse
	ds_load_b128 v[152:155], v125 offset:64
	ds_load_b128 v[156:159], v125 offset:80
	v_wmma_f32_16x16x32_bf16 v[18:25], v[144:151], v[160:167], v[18:25] matrix_a_reuse
	ds_load_b128 v[160:163], v100 offset:64
	ds_load_b128 v[164:167], v100 offset:80
	v_wmma_f32_16x16x32_bf16 v[90:97], v[136:143], v[168:175], v[90:97]
	ds_load_b128 v[136:139], v117 offset:64
	ds_load_b128 v[140:143], v117 offset:80
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[144:151], v[168:175], v[42:49] matrix_a_reuse
	ds_load_b128 v[168:171], v115 offset:64
	ds_load_b128 v[172:175], v115 offset:80
	ds_load_b128 v[144:147], v123 offset:64
	ds_load_b128 v[148:151], v123 offset:80
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[90:97], v[160:167], v[136:143], v[90:97]
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[82:89], v[160:167], v[176:183], v[82:89] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[74:81], v[160:167], v[184:191], v[74:81] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[66:73], v[160:167], v[144:151], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[160:167], v[152:159], v[58:65] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[160:167], v[192:199], v[34:41] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[168:175], v[192:199], v[50:57]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[168:175], v[152:159], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[168:175], v[144:151], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[168:175], v[184:191], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[168:175], v[176:183], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[168:175], v[136:143], v[42:49] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn192_bk064_wm4_wn2_mc0, .Lfunc_end0-bm128_bn192_bk064_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn192_bk064_wm4_wn2_mc0
	...
	.section	.text.bm128_bn192_bk064_wm4_wn2_mc0,"axG",@progbits,bm128_bn192_bk064_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn192_bk064_wm4_wn2_mc0.num_vgpr, 200
	.set .Lbm128_bn192_bk064_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm128_bn192_bk064_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm128_bn192_bk064_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm128_bn192_bk064_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm128_bn192_bk064_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm128_bn192_bk064_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn192_bk064_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn192_bk064_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm128_bn192_bk064_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_e51202f910846f72,@object ; @__hip_cuid_e51202f910846f72
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_e51202f910846f72
__hip_cuid_e51202f910846f72:
	.byte	0                               ; 0x0
	.size	__hip_cuid_e51202f910846f72, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_e51202f910846f72
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn192_bk064_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn192_bk064_wm4_wn2_mc0.kd
