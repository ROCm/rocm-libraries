	...
	.section	.text.bm256_bn064_bk096_wm8_wn1_mc0,"axG",@progbits,bm256_bn064_bk096_wm8_wn1_mc0,comdat
	.protected	bm256_bn064_bk096_wm8_wn1_mc0 ; -- Begin function bm256_bn064_bk096_wm8_wn1_mc0
	.globl	bm256_bn064_bk096_wm8_wn1_mc0
	.p2align	8
	.type	bm256_bn064_bk096_wm8_wn1_mc0,@function
bm256_bn064_bk096_wm8_wn1_mc0: ; @bm256_bn064_bk096_wm8_wn1_mc0
; %bb.0:
...
; %bb.19:
	...
	s_mov_b32 s7, s5
	v_mul_u32_u24_e32 v1, 0xc00, v73
	...
	s_add_co_i32 s43, s7, 0xff00
	s_and_b32 s10, s4, 15
	v_mad_u32_u24 v2, 0x60, v3, v5
	...
	v_dual_add_nc_u32 v66, v6, v2 :: v_dual_add_nc_u32 v5, v5, v7
	v_dual_mov_b32 v69, 0 :: v_dual_lshrrev_b32 v6, 4, v8
	v_or_b32_e32 v8, v8, v4
	s_ashr_i32 s5, s4, 31
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshrrev_b32_e32 v5, 4, v5
	v_and_b32_e32 v6, 0x78, v6
	v_dual_lshrrev_b32 v11, 4, v7 :: v_dual_bitop2_b32 v9, 32, v4 bitop3:0x54
	v_mad_u32_u24 v22, 0xc00, v73, v8
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_and_b32_e32 v68, 0xff8, v5
	v_mad_u32_u24 v5, v3, s0, 0xc00
	s_movk_i32 s0, 0x1200
	v_dual_add_nc_u32 v70, v8, v6 :: v_dual_bitop2_b32 v10, v9, v1 bitop3:0x54
	v_mad_u32_u24 v6, 0x60, v3, s0
	v_lshrrev_b32_e32 v5, 4, v5
	v_mad_u32_u24 v14, 0x60, v3, v9
	v_and_b32_e32 v11, 0xf8, v11
	v_mad_u32_u24 v12, 0x60, v3, v10
	v_dual_add_nc_u32 v10, v10, v7 :: v_dual_lshrrev_b32 v6, 4, v6
	v_and_b32_e32 v13, 0x1f8, v5
	s_ashr_i32 s7, s6, 31
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v5, 4, v12 :: v_dual_lshrrev_b32 v10, 4, v10
	v_and_b32_e32 v12, 0x1f8, v6
	v_or_b32_e32 v6, 64, v4
	s_wait_kmcnt 0x0
	s_bfe_i64 s[20:21], s[20:21], 0x200000
	v_and_b32_e32 v15, 0xff8, v5
	v_add_nc_u32_e32 v5, v7, v9
	v_and_b32_e32 v4, 0xff8, v10
	v_or_b32_e32 v1, v1, v6
	v_lshrrev_b32_e32 v10, 4, v14
	v_add_nc_u32_e32 v9, 0xc00, v14
	v_lshrrev_b32_e32 v5, 4, v5
	v_add_nc_u32_e32 v14, 0x1200, v14
	v_mad_u32_u24 v16, 0x60, v3, v1
	v_mad_u32_u24 v3, 0x60, v3, v6
	...
	v_and_b32_e32 v16, 0xff8, v5
	v_add_nc_u32_e32 v5, v7, v6
	v_add_nc_u32_e32 v6, 0xc00, v3
	v_add_nc_u32_e32 v7, 0x1200, v3
	v_lshrrev_b32_e32 v3, 4, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v76, v8, v11 :: v_dual_lshrrev_b32 v5, 4, v5
	v_lshrrev_b32_e32 v18, 4, v6
	v_and_b32_e32 v6, 0xff8, v1
	v_sub_nc_u32_e32 v1, 0xcbf, v0
	v_and_b32_e32 v19, 0xf8, v3
	v_and_b32_e32 v20, 0x1f8, v5
	v_dual_mov_b32 v3, v69 :: v_dual_lshrrev_b32 v9, 4, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v14, 4, v14 :: v_dual_lshrrev_b32 v72, 8, v1
	v_or_b32_e32 v1, 0x100, v0
	v_add_nc_u64_e32 v[74:75], v[68:69], v[2:3]
	v_add_nc_u32_e32 v68, 0x600, v22
	v_and_b32_e32 v9, 0x1f8, v9
	v_dual_add_nc_u32 v5, 2, v72 :: v_dual_add_nc_u32 v67, -1, v72
	v_and_b32_e32 v14, 0x3f8, v14
	v_dual_mov_b32 v107, v69 :: v_dual_add_nc_u32 v2, 0xc00, v8
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v80, v8, v12 :: v_dual_bitop2_b32 v77, 30, v5 bitop3:0x40
	v_mov_b32_e32 v5, v69
	v_add_nc_u32_e32 v3, 0x1200, v8
	v_dual_add_nc_u32 v78, v8, v13 :: v_dual_add_nc_u32 v82, v15, v22
	v_dual_add_nc_u32 v86, v10, v8 :: v_dual_add_nc_u32 v90, v9, v2
	v_add_nc_u64_e32 v[84:85], v[4:5], v[68:69]
	v_dual_mov_b32 v4, v69 :: v_dual_lshrrev_b32 v7, 4, v7
	v_and_b32_e32 v18, 0x1f8, v18
	v_add3_u32 v88, v8, v17, 32
	v_dual_add_nc_u32 v94, v16, v22 :: v_dual_add_nc_u32 v98, v19, v8
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v21, 0x3f8, v7
	v_mov_b32_e32 v7, v69
	v_add3_u32 v100, v8, v20, 64
	v_add_nc_u32_e32 v102, v18, v2
	v_or_b32_e32 v75, 0x3100, v0
	v_lshl_or_b32 v106, v0, 2, 0xc800
	v_add_nc_u64_e32 v[96:97], v[6:7], v[68:69]
	v_dual_mov_b32 v2, v69 :: v_dual_mov_b32 v6, v69
	v_dual_mov_b32 v8, v69 :: v_dual_add_nc_u32 v92, v14, v3
	v_add_nc_u32_e32 v104, v21, v3
...
.LBB0_23:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_dual_mov_b32 v68, v108 :: v_dual_add_nc_u32 v79, -2, v79
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v79, s2 :: v_dual_mov_b32 v108, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v79, s5 :: v_dual_mov_b32 v108, s6
	s_bitset1_b32 s7, 31
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_readfirstlane_b32 s12, v68
	v_mov_b32_e32 v81, s7
	v_readfirstlane_b32 s13, v79
	v_readfirstlane_b32 s14, v108
	s_lshr_b64 s[6:7], s[30:31], 16
	s_lshl_b32 s5, s30, 16
	v_readfirstlane_b32 s15, v81
	s_mov_b32 s7, s47
	s_mov_b32 s10, s11
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v79, v74, 1, s2
	v_lshl_add_u32 v81, v76, 1, s0
	v_lshl_add_u32 v83, v88, 1, s0
	v_lshl_add_u32 v85, v90, 1, s0
	...
	v_lshl_add_u32 v79, v84, 1, s2
	v_lshl_add_u32 v87, v92, 1, s0
	ds_load_b128 v[132:135], v68
	ds_load_b128 v[136:139], v68 offset:16
	v_lshl_add_u32 v68, v78, 1, s0
	ds_load_b128 v[148:151], v79 offset:64
	ds_load_b128 v[152:155], v79 offset:80
	ds_load_b128 v[156:159], v83 offset:3072
	ds_load_b128 v[160:163], v83 offset:3088
	ds_load_b128 v[164:167], v85 offset:64
	ds_load_b128 v[168:171], v85 offset:80
	ds_load_b128 v[172:175], v87 offset:64
	ds_load_b128 v[176:179], v87 offset:80
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[18:25], v[116:123], v[132:139], v[18:25] matrix_a_reuse
	...
	v_lshl_add_u32 v68, v80, 1, s0
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[108:115], v[132:139], v[42:49] matrix_a_reuse
	ds_load_b128 v[124:127], v81 offset:3072
	ds_load_b128 v[128:131], v81 offset:3088
	v_lshl_add_u32 v81, v86, 1, s0
	s_wait_dscnt 0x0
	...
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[108:115], v[124:131], v[26:33] matrix_a_reuse
	...
	ds_load_b128 v[116:119], v81 offset:64
	ds_load_b128 v[120:123], v81 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v68, v94, 1, s2
	v_lshl_add_u32 v79, v96, 1, s2
	ds_load_b128 v[108:111], v68 offset:128
	ds_load_b128 v[112:115], v68 offset:144
	v_lshl_add_u32 v68, v98, 1, s0
	ds_load_b128 v[124:127], v79 offset:128
	s_wait_dscnt 0x3
	...
	v_lshl_add_u32 v68, v100, 1, s0
	ds_load_b128 v[128:131], v79 offset:144
	v_lshl_add_u32 v79, v102, 1, s0
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[140:147], v[164:171], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[140:147], v[172:179], v[26:33] matrix_a_reuse
	...
	v_wmma_f32_16x16x32_bf16 v[18:25], v[148:155], v[116:123], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[58:65], v[108:115], v[132:139], v[58:65]
	...
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[108:115], v[164:171], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn064_bk096_wm8_wn1_mc0, .Lfunc_end0-bm256_bn064_bk096_wm8_wn1_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn064_bk096_wm8_wn1_mc0
	...
	.section	.text.bm256_bn064_bk096_wm8_wn1_mc0,"axG",@progbits,bm256_bn064_bk096_wm8_wn1_mc0,comdat
                                        ; -- End function
	.set .Lbm256_bn064_bk096_wm8_wn1_mc0.num_vgpr, 188
	.set .Lbm256_bn064_bk096_wm8_wn1_mc0.num_agpr, 0
	.set .Lbm256_bn064_bk096_wm8_wn1_mc0.numbered_sgpr, 56
	.set .Lbm256_bn064_bk096_wm8_wn1_mc0.num_named_barrier, 0
	.set .Lbm256_bn064_bk096_wm8_wn1_mc0.private_seg_size, 0
	.set .Lbm256_bn064_bk096_wm8_wn1_mc0.uses_vcc, 1
	.set .Lbm256_bn064_bk096_wm8_wn1_mc0.uses_flat_scratch, 1
	.set .Lbm256_bn064_bk096_wm8_wn1_mc0.has_dyn_sized_stack, 0
	.set .Lbm256_bn064_bk096_wm8_wn1_mc0.has_recursion, 0
	.set .Lbm256_bn064_bk096_wm8_wn1_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_d3cc694636b6eb61,@object ; @__hip_cuid_d3cc694636b6eb61
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_d3cc694636b6eb61
__hip_cuid_d3cc694636b6eb61:
	.byte	0                               ; 0x0
	.size	__hip_cuid_d3cc694636b6eb61, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_d3cc694636b6eb61
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn064_bk096_wm8_wn1_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn064_bk096_wm8_wn1_mc0.kd
