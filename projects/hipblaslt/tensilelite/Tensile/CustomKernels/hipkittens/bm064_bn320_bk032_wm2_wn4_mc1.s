	...
	.section	.text.bm064_bn320_bk032_wm2_wn4_mc1,"axG",@progbits,bm064_bn320_bk032_wm2_wn4_mc1,comdat
	.protected	bm064_bn320_bk032_wm2_wn4_mc1 ; -- Begin function bm064_bn320_bk032_wm2_wn4_mc1
	.globl	bm064_bn320_bk032_wm2_wn4_mc1
	.p2align	8
	.type	bm064_bn320_bk032_wm2_wn4_mc1,@function
bm064_bn320_bk032_wm2_wn4_mc1: ; @bm064_bn320_bk032_wm2_wn4_mc1
; %bb.0:
...
.LBB0_20:
	...
	v_dual_lshlrev_b32 v1, 3, v91 :: v_dual_mov_b32 v9, 0
	s_and_b32 s43, s35, s29
	v_and_b32_e32 v93, 3, v91
	v_cndmask_b32_e64 v87, 0, 1, s43
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v89, 32, v1 bitop3:0x40
...
; %bb.21:
	v_dual_lshlrev_b32 v4, 5, v0 :: v_dual_lshlrev_b32 v2, 5, v89
	v_and_b32_e32 v3, 16, v0
	v_mul_u32_u24_e32 v1, 0xa00, v93
	...
	v_dual_mov_b32 v101, v85 :: v_dual_add_nc_u32 v6, 0x400, v3
	v_add_nc_u32_e32 v7, 0x600, v3
	v_add_nc_u32_e32 v8, 0x800, v3
	v_dual_add_nc_u32 v86, v5, v3 :: v_dual_add_nc_u32 v90, v4, v2
	v_dual_mov_b32 v2, v85 :: v_dual_lshrrev_b32 v1, 4, v1
	v_dual_mov_b32 v4, v85 :: v_dual_lshrrev_b32 v5, 4, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v6, 4, v7 :: v_dual_lshrrev_b32 v7, 4, v8
	v_sub_nc_u32_e32 v8, 0x153f, v0
	...
	v_add_nc_u32_e32 v94, v5, v3
	v_dual_mov_b32 v5, v85 :: v_dual_lshrrev_b32 v1, 8, v8
	s_lshr_b32 s1, s7, 2
	...
	v_dual_add_nc_u32 v96, v6, v3 :: v_dual_bitop2_b32 v95, 22, v8 bitop3:0x40
	...
	v_dual_add_nc_u32 v1, 2, v88 :: v_dual_add_nc_u32 v92, v9, v3
	v_lshl_or_b32 v10, v95, 8, v0
	...
	v_dual_add_nc_u32 v98, v7, v3 :: v_dual_bitop2_b32 v97, 14, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_cmp_ne_u32_e64 s1, v8, v95
	v_dual_mov_b32 v6, v85 :: v_dual_add_nc_u32 v99, 0xffffff00, v10
	v_dual_mov_b32 v7, v85 :: v_dual_lshlrev_b32 v100, 2, v10
	v_dual_mov_b32 v3, v85 :: v_dual_mov_b32 v8, v85
...
; %bb.27:                               ;   in Loop: Header=BB0_26 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[104:105], v[84:85], 2, s[14:15]
...
.LBB0_31:                               ;   Parent Loop BB0_23 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v84, v102 :: v_dual_add_nc_u32 v104, -2, v104
	v_dual_mov_b32 v106, v103 :: v_dual_mov_b32 v107, v85
	v_add_nc_u32_e32 v103, 0x200, v103
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[108:109], v[84:85], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v104
	v_add_nc_u32_e32 v102, 0x200, v102
	v_lshl_add_u64 v[106:107], v[106:107], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[108:109], v85
...
; %bb.33:                               ;   in Loop: Header=BB0_23 Depth=1
	v_add_nc_u64_e32 v[102:103], s[6:7], v[100:101]
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_lshl_add_u32 v114, v86, 1, s5
	ds_load_b128 v[102:105], v84
	ds_load_b128 v[106:109], v84 offset:16
	v_lshl_add_u32 v84, v90, 1, s2
	ds_load_b128 v[110:113], v114
	ds_load_b128 v[114:117], v114 offset:16
	ds_load_b128 v[118:121], v84 offset:1024
	ds_load_b128 v[122:125], v84 offset:1040
	...
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[10:17], v[118:125], v[110:117], v[10:17] matrix_a_reuse
	ds_load_b128 v[130:133], v84 offset:1040
	v_lshl_add_u32 v84, v94, 1, s5
	ds_load_b128 v[110:113], v84 offset:2048
	ds_load_b128 v[114:117], v84 offset:2064
	v_lshl_add_u32 v84, v98, 1, s5
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[118:125], v[110:117], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[118:125], v[126:133], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[102:109], v[126:133], v[66:73] matrix_a_reuse
	ds_load_b128 v[126:129], v84 offset:4096
	ds_load_b128 v[130:133], v84 offset:4112
	v_lshl_add_u32 v84, v96, 1, s5
	ds_load_b128 v[134:137], v84 offset:3072
	ds_load_b128 v[138:141], v84 offset:3088
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[102:109], v[134:141], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[118:125], v[134:141], v[34:41] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[102:109], v[110:117], v[58:65] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[102:109], v[126:133], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[118:125], v[126:133], v[50:57]
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_nop
	v_dual_mov_b32 v103, s5 :: v_dual_mov_b32 v102, s6
	s_bitset1_b32 s7, 31
	v_readfirstlane_b32 s52, v84
...
; %bb.47:
	...
	v_dual_add_nc_u32 v59, v59, v61 :: v_dual_lshrrev_b32 v66, 3, v66
	...
	v_and_b32_e32 v18, 0x1ff0, v43
	v_add_nc_u32_e32 v42, v59, v61
	v_cvt_pk_bf16_f32 v23, v20, v21
	ds_store_b128 v1, v[62:65] offset:4096
	ds_store_b128 v58, v[46:49] offset:6144
	ds_store_b128 v42, v[22:25] offset:8192
	v_add_nc_u32_e32 v22, v18, v61
	v_add_nc_u32_e32 v18, 0x810, v74
	v_cvt_pk_bf16_f32 v17, v16, v17
	v_cvt_pk_bf16_f32 v16, v14, v15
	v_cvt_pk_bf16_f32 v14, v10, v11
	v_add_nc_u32_e32 v11, 0xc10, v74
	v_add_nc_u32_e32 v44, 0x410, v74
	v_lshrrev_b32_e32 v10, 3, v18
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_lshrrev_b32_e32 v4, 3, v11
	v_add_nc_u32_e32 v11, 0x1010, v74
	...
	v_add_nc_u32_e32 v23, v10, v19
	v_and_b32_e32 v10, 0xffffff0, v4
	v_and_b32_e32 v18, 0xffffff0, v11
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn320_bk032_wm2_wn4_mc1, .Lfunc_end0-bm064_bn320_bk032_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn320_bk032_wm2_wn4_mc1
	...
	.section	.text.bm064_bn320_bk032_wm2_wn4_mc1,"axG",@progbits,bm064_bn320_bk032_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn320_bk032_wm2_wn4_mc1.num_vgpr, 142
	.set .Lbm064_bn320_bk032_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm064_bn320_bk032_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm064_bn320_bk032_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm064_bn320_bk032_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm064_bn320_bk032_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm064_bn320_bk032_wm2_wn4_mc1.uses_flat_scratch, 1
	.set .Lbm064_bn320_bk032_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn320_bk032_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm064_bn320_bk032_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_85041e391e4583a1,@object ; @__hip_cuid_85041e391e4583a1
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_85041e391e4583a1
__hip_cuid_85041e391e4583a1:
	.byte	0                               ; 0x0
	.size	__hip_cuid_85041e391e4583a1, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_85041e391e4583a1
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn320_bk032_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn320_bk032_wm2_wn4_mc1.kd
