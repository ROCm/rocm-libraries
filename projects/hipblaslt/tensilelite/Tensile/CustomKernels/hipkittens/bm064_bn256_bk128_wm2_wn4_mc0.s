	...
	.section	.text.bm064_bn256_bk128_wm2_wn4_mc0,"axG",@progbits,bm064_bn256_bk128_wm2_wn4_mc0,comdat
	.protected	bm064_bn256_bk128_wm2_wn4_mc0 ; -- Begin function bm064_bn256_bk128_wm2_wn4_mc0
	.globl	bm064_bn256_bk128_wm2_wn4_mc0
	.p2align	8
	.type	bm064_bn256_bk128_wm2_wn4_mc0,@function
bm064_bn256_bk128_wm2_wn4_mc0: ; @bm064_bn256_bk128_wm2_wn4_mc0
; %bb.0:
...
.LBB0_14:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 3, v71 :: v_dual_lshlrev_b32 v2, 6, v71
	s_and_b32 s39, s25, s21
	v_mov_b32_e32 v9, 0
	v_cndmask_b32_e64 v67, 0, 1, s39
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v73, 32, v1
	v_and_b32_e32 v75, 0xc0, v2
...
; %bb.15:
	...
	s_mov_b32 s3, s1
	v_dual_lshlrev_b32 v1, 7, v0 :: v_dual_lshlrev_b32 v2, 7, v75
	...
	s_add_co_i32 s0, s41, 0x4400
	v_or_b32_e32 v77, 0xf00, v0
	s_and_b32 s6, s0, 15
	...
	v_or_b32_e32 v84, 0x4300, v0
	v_or_b32_e32 v80, 0x11000, v68
	v_dual_mov_b32 v81, v69 :: v_dual_mov_b32 v2, v69
	...
	v_dual_mov_b32 v17, v69 :: v_dual_mov_b32 v26, v69
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v68, v82 :: v_dual_add_nc_u32 v85, -2, v85
	v_dual_mov_b32 v86, v83 :: v_dual_mov_b32 v87, v69
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[82:83], s[2:3], v[78:79]
...
; %bb.26:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[82:83], s[2:3], v[80:81]
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v83, s10 :: v_dual_mov_b32 v82, s8
...
.LBB0_35:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_and_b32 s3, s3, 0x1ffffff
	v_dual_mov_b32 v83, s1 :: v_dual_mov_b32 v82, s2
	s_bitset1_b32 s3, 31
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_lshl_add_u32 v82, v70, 1, s2
	ds_load_b128 v[86:89], v68
	ds_load_b128 v[90:93], v68 offset:16
	ds_load_b128 v[94:97], v68 offset:4352
	ds_load_b128 v[98:101], v68 offset:4368
	ds_load_b128 v[110:113], v82
	ds_load_b128 v[114:117], v82 offset:16
	v_lshl_add_u32 v68, v72, 1, s1
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[94:101], v[110:117], v[26:33] matrix_a_reuse
	ds_load_b128 v[118:121], v68 offset:64
	ds_load_b128 v[122:125], v68 offset:80
	ds_load_b128 v[126:129], v68 offset:4416
	ds_load_b128 v[130:133], v68 offset:4432
	v_wmma_f32_16x16x32_bf16 v[58:65], v[86:93], v[110:117], v[58:65]
	ds_load_b128 v[110:113], v82 offset:8704
	ds_load_b128 v[114:117], v82 offset:8720
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[86:93], v[110:117], v[42:49] matrix_a_reuse
	ds_load_b128 v[102:105], v82 offset:4352
	ds_load_b128 v[106:109], v82 offset:4368
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[94:101], v[102:109], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[86:93], v[102:109], v[50:57] matrix_a_reuse
	ds_load_b128 v[102:105], v82 offset:13056
	ds_load_b128 v[106:109], v82 offset:13072
	v_lshl_add_u32 v82, v74, 1, s2
	ds_load_b128 v[134:137], v82 offset:4416
	ds_load_b128 v[138:141], v82 offset:4432
	ds_load_b128 v[142:145], v82 offset:8768
	ds_load_b128 v[146:149], v82 offset:8784
	ds_load_b128 v[150:153], v82 offset:13120
	ds_load_b128 v[154:157], v82 offset:13136
	s_wait_dscnt 0x6
	...
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[94:101], v[110:117], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[94:101], v[102:109], v[34:41]
	ds_load_b128 v[94:97], v82 offset:64
	ds_load_b128 v[98:101], v82 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v68, v76, 1, s1
	ds_load_b128 v[86:89], v68 offset:128
	ds_load_b128 v[90:93], v68 offset:144
	ds_load_b128 v[102:105], v68 offset:4480
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[58:65], v[118:125], v[94:101], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[118:125], v[134:141], v[50:57] matrix_a_reuse
	ds_load_b128 v[106:109], v68 offset:4496
	ds_load_b128 v[110:113], v82 offset:128
	ds_load_b128 v[114:117], v82 offset:144
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[118:125], v[142:149], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[118:125], v[150:157], v[18:25] matrix_a_reuse
	ds_load_b128 v[118:121], v82 offset:4480
	ds_load_b128 v[122:125], v82 offset:4496
	ds_load_b128 v[158:161], v82 offset:8832
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[126:133], v[150:157], v[34:41]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[126:133], v[142:149], v[2:9] matrix_a_reuse
	ds_load_b128 v[162:165], v82 offset:8848
	ds_load_b128 v[142:145], v82 offset:13184
	ds_load_b128 v[146:149], v82 offset:13200
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[126:133], v[134:141], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[126:133], v[94:101], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[94:97], v68 offset:192
	ds_load_b128 v[98:101], v68 offset:208
	ds_load_b128 v[126:129], v68 offset:4544
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[58:65], v[86:93], v[110:117], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[50:57], v[86:93], v[118:125], v[50:57] matrix_a_reuse
	ds_load_b128 v[130:133], v68 offset:4560
	ds_load_b128 v[134:137], v82 offset:192
	ds_load_b128 v[138:141], v82 offset:208
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x8
	...
	ds_load_b128 v[86:89], v82 offset:4544
	ds_load_b128 v[90:93], v82 offset:4560
	ds_load_b128 v[150:153], v82 offset:8896
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[102:109], v[142:149], v[34:41]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[102:109], v[158:165], v[2:9] matrix_a_reuse
	ds_load_b128 v[154:157], v82 offset:8912
	ds_load_b128 v[142:145], v82 offset:13248
	ds_load_b128 v[146:149], v82 offset:13264
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[102:109], v[118:125], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[102:109], v[110:117], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[58:65], v[94:101], v[134:141], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[50:57], v[94:101], v[86:93], v[50:57] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[42:49], v[94:101], v[150:157], v[42:49] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[94:101], v[142:149], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[126:133], v[142:149], v[34:41]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[126:133], v[150:157], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[126:133], v[86:93], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[126:133], v[134:141], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn256_bk128_wm2_wn4_mc0, .Lfunc_end0-bm064_bn256_bk128_wm2_wn4_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn256_bk128_wm2_wn4_mc0
	...
	.section	.text.bm064_bn256_bk128_wm2_wn4_mc0,"axG",@progbits,bm064_bn256_bk128_wm2_wn4_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn256_bk128_wm2_wn4_mc0.num_vgpr, 166
	.set .Lbm064_bn256_bk128_wm2_wn4_mc0.num_agpr, 0
	.set .Lbm064_bn256_bk128_wm2_wn4_mc0.numbered_sgpr, 56
	.set .Lbm064_bn256_bk128_wm2_wn4_mc0.num_named_barrier, 0
	.set .Lbm064_bn256_bk128_wm2_wn4_mc0.private_seg_size, 0
	.set .Lbm064_bn256_bk128_wm2_wn4_mc0.uses_vcc, 1
	.set .Lbm064_bn256_bk128_wm2_wn4_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn256_bk128_wm2_wn4_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn256_bk128_wm2_wn4_mc0.has_recursion, 0
	.set .Lbm064_bn256_bk128_wm2_wn4_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_54b859d13f1cc1cd,@object ; @__hip_cuid_54b859d13f1cc1cd
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_54b859d13f1cc1cd
__hip_cuid_54b859d13f1cc1cd:
	.byte	0                               ; 0x0
	.size	__hip_cuid_54b859d13f1cc1cd, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_54b859d13f1cc1cd
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn256_bk128_wm2_wn4_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn256_bk128_wm2_wn4_mc0.kd
