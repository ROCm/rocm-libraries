	...
	.section	.text.bm128_bn064_bk064_wm8_wn1_mc1,"axG",@progbits,bm128_bn064_bk064_wm8_wn1_mc1,comdat
	.protected	bm128_bn064_bk064_wm8_wn1_mc1 ; -- Begin function bm128_bn064_bk064_wm8_wn1_mc1
	.globl	bm128_bn064_bk064_wm8_wn1_mc1
	.p2align	8
	.type	bm128_bn064_bk064_wm8_wn1_mc1,@function
bm128_bn064_bk064_wm8_wn1_mc1: ; @bm128_bn064_bk064_wm8_wn1_mc1
; %bb.0:
...
; %bb.21:
	...
	v_dual_mov_b32 v35, 0 :: v_dual_bitop2_b32 v7, 56, v34 bitop3:0x40
	...
	v_or_b32_e32 v48, 0x4000, v34
	v_dual_add_nc_u32 v36, v4, v3 :: v_dual_lshrrev_b32 v3, 4, v6
	v_lshrrev_b32_e32 v1, 4, v1
	s_cselect_b32 s6, s6, 0
	s_ashr_i32 s7, s12, 31
	v_and_b32_e32 v4, 0x78, v5
	v_sub_nc_u32_e32 v5, 0x87f, v0
	v_and_b32_e32 v3, 0xb8, v3
	v_and_b32_e32 v6, 0xf8, v1
	s_lshr_b32 s7, s7, 26
	s_lshl_b32 s10, s6, 2
	s_add_co_i32 s12, s12, s7
	v_add_nc_u32_e32 v38, v2, v7
	s_ashr_i32 s47, s12, 6
	v_dual_add_nc_u32 v42, v4, v2 :: v_dual_add_nc_u32 v44, v3, v2
	v_dual_mov_b32 v3, v35 :: v_dual_add_nc_u32 v46, v6, v2
	v_dual_mov_b32 v2, v35 :: v_dual_lshrrev_b32 v40, 8, v5
	s_cmp_lt_i32 s3, 64
	...
	v_dual_add_nc_u32 v5, 2, v40 :: v_dual_mov_b32 v37, v40
	...
	v_dual_mov_b32 v49, v35 :: v_dual_bitop2_b32 v43, 30, v5 bitop3:0x40
...
.LBB0_25:                               ;   Parent Loop BB0_23 Depth=1
	...
	v_dual_mov_b32 v34, v50 :: v_dual_add_nc_u32 v47, -2, v47
	v_dual_mov_b32 v52, v51 :: v_dual_mov_b32 v53, v35
	v_add_nc_u32_e32 v51, 0x200, v51
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[54:55], v[34:35], 2, s[6:7]
...
.LBB0_31:                               ;   Parent Loop BB0_23 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s19, v37
	v_cmpx_le_u32_e64 s18, v40
	s_cbranch_execz .LBB0_33
; %bb.32:                               ;   in Loop: Header=BB0_31 Depth=2
	v_mov_b32_e32 v34, v50
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[52:53], v[34:35], 2, s[14:15]
	flat_store_b32 v[52:53], v35
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_lshl_add_u32 v47, v38, 1, s2
	v_lshl_add_u32 v86, v42, 1, s2
	v_lshl_add_u32 v90, v44, 1, s2
	v_lshl_add_u32 v91, v46, 1, s2
	ds_load_b128 v[50:53], v34
	ds_load_b128 v[54:57], v34 offset:16
	ds_load_b128 v[58:61], v47
	ds_load_b128 v[62:65], v47 offset:16
	ds_load_b128 v[66:69], v86 offset:2048
	ds_load_b128 v[74:77], v47 offset:64
	ds_load_b128 v[78:81], v47 offset:80
	ds_load_b128 v[82:85], v86 offset:2112
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[26:33], v[50:57], v[58:65], v[26:33]
	ds_load_b128 v[70:73], v86 offset:2064
	ds_load_b128 v[86:89], v86 offset:2128
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[10:17], v[50:57], v[66:73], v[10:17] matrix_a_reuse
	ds_load_b128 v[58:61], v90 offset:4096
	ds_load_b128 v[62:65], v90 offset:4112
	ds_load_b128 v[66:69], v91 offset:6208
	ds_load_b128 v[70:73], v91 offset:6224
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[50:57], v[58:65], v[2:9] matrix_a_reuse
	ds_load_b128 v[58:61], v91 offset:6144
	ds_load_b128 v[62:65], v91 offset:6160
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x0
	...
	ds_load_b128 v[50:53], v90 offset:4160
	ds_load_b128 v[54:57], v90 offset:4176
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[58:65], v[74:81], v[26:33]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[58:65], v[82:89], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[58:65], v[50:57], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[58:65], v[66:73], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_nop
	v_dual_mov_b32 v47, s13 :: v_dual_mov_b32 v50, s14
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v47, s5 :: v_dual_mov_b32 v50, s6
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn064_bk064_wm8_wn1_mc1, .Lfunc_end0-bm128_bn064_bk064_wm8_wn1_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn064_bk064_wm8_wn1_mc1
	...
	.section	.text.bm128_bn064_bk064_wm8_wn1_mc1,"axG",@progbits,bm128_bn064_bk064_wm8_wn1_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn064_bk064_wm8_wn1_mc1.num_vgpr, 92
	.set .Lbm128_bn064_bk064_wm8_wn1_mc1.num_agpr, 0
	.set .Lbm128_bn064_bk064_wm8_wn1_mc1.numbered_sgpr, 56
	.set .Lbm128_bn064_bk064_wm8_wn1_mc1.num_named_barrier, 0
	.set .Lbm128_bn064_bk064_wm8_wn1_mc1.private_seg_size, 0
	.set .Lbm128_bn064_bk064_wm8_wn1_mc1.uses_vcc, 1
	.set .Lbm128_bn064_bk064_wm8_wn1_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn064_bk064_wm8_wn1_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn064_bk064_wm8_wn1_mc1.has_recursion, 0
	.set .Lbm128_bn064_bk064_wm8_wn1_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_ad2011c469883653,@object ; @__hip_cuid_ad2011c469883653
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_ad2011c469883653
__hip_cuid_ad2011c469883653:
	.byte	0                               ; 0x0
	.size	__hip_cuid_ad2011c469883653, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_ad2011c469883653
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn064_bk064_wm8_wn1_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn064_bk064_wm8_wn1_mc1.kd
