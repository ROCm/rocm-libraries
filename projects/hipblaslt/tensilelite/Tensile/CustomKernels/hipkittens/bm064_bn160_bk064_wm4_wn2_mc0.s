	...
	.section	.text.bm064_bn160_bk064_wm4_wn2_mc0,"axG",@progbits,bm064_bn160_bk064_wm4_wn2_mc0,comdat
	.protected	bm064_bn160_bk064_wm4_wn2_mc0 ; -- Begin function bm064_bn160_bk064_wm4_wn2_mc0
	.globl	bm064_bn160_bk064_wm4_wn2_mc0
	.p2align	8
	.type	bm064_bn160_bk064_wm4_wn2_mc0,@function
bm064_bn160_bk064_wm4_wn2_mc0: ; @bm064_bn160_bk064_wm4_wn2_mc0
; %bb.0:
...
; %bb.19:
	...
	v_dual_lshlrev_b32 v2, 6, v53 :: v_dual_lshlrev_b32 v3, 6, v51
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s0, 0x7700
	...
	v_dual_mov_b32 v45, 0 :: v_dual_add_nc_u32 v2, v4, v2
	...
	v_add_nc_u32_e32 v42, v5, v1
	v_or_b32_e32 v9, 0x800, v6
	v_dual_lshrrev_b32 v1, 4, v8 :: v_dual_add_nc_u32 v46, v7, v6
	v_add_nc_u32_e32 v11, 0x420, v6
	v_add_nc_u32_e32 v12, 0xc20, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshrrev_b32_e32 v8, 4, v9
	v_and_b32_e32 v10, 0x1f8, v1
	v_add_nc_u32_e32 v1, 0x1000, v6
	v_add_nc_u32_e32 v13, 0x1020, v6
	v_add3_u32 v58, v4, v3, v5
	v_and_b32_e32 v8, 0x1f8, v8
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v4, v45 :: v_dual_lshrrev_b32 v1, 4, v1
	v_lshrrev_b32_e32 v11, 4, v11
	s_lshl2_add_u32 s6, s4, s0
	v_dual_add_nc_u32 v50, v10, v6 :: v_dual_add_nc_u32 v52, v8, v6
	s_add_co_i32 s4, s6, 0x9900
	v_and_b32_e32 v14, 0x378, v1
	v_dual_mov_b32 v10, v45 :: v_dual_sub_nc_u32 v1, 0x153f, v0
	v_add3_u32 v64, v2, v8, 0x800
	v_dual_mov_b32 v8, v45 :: v_dual_lshrrev_b32 v12, 4, v12
	v_lshrrev_b32_e32 v13, 4, v13
	s_and_b32 s10, s4, 15
	s_mul_i32 s0, s1, 0xa0
	s_sub_co_i32 s1, 16, s10
	s_add_co_i32 s43, s6, 0x7700
	s_lshr_b32 s1, s1, 2
	...
	s_lshr_b32 s6, s6, 26
	v_dual_mov_b32 v3, v45 :: v_dual_add_nc_u32 v60, v7, v2
	v_add3_u32 v62, v2, v11, 0x400
	v_add3_u32 v66, v2, v12, 0xc00
	v_add3_u32 v68, v2, v13, 0x1000
	v_dual_mov_b32 v2, v45 :: v_dual_lshrrev_b32 v9, 4, v9
	s_add_co_i32 s17, s17, s6
	s_lshl_b32 s10, s1, 2
	s_ashr_i32 s45, s17, 6
	s_cmp_lt_i32 s3, 0xa0
	v_dual_add_nc_u32 v1, 2, v48 :: v_dual_bitop2_b32 v55, 22, v15 bitop3:0x40
	...
	v_lshl_or_b32 v16, v55, 8, v0
	s_lshl_b64 s[0:1], s[0:1], 1
	s_mul_u64 s[4:5], s[6:7], s[4:5]
	s_add_nc_u64 s[20:21], s[14:15], s[0:1]
	s_lshl_b64 s[0:1], s[4:5], 1
	v_dual_add_nc_u32 v54, v9, v6 :: v_dual_bitop2_b32 v57, 30, v1 bitop3:0x40
	s_add_nc_u64 s[38:39], s[18:19], s[0:1]
	v_mov_b32_e32 v43, v48
	v_or_b32_e32 v1, 0x100, v0
	v_cmp_ne_u32_e64 s0, v15, v55
	v_dual_mov_b32 v71, v45 :: v_dual_add_nc_u32 v56, v14, v6
	v_dual_mov_b32 v12, v45 :: v_dual_add_nc_u32 v59, 0xffffff00, v16
	v_dual_mov_b32 v5, v45 :: v_dual_lshlrev_b32 v70, 2, v16
	v_dual_mov_b32 v7, v45 :: v_dual_mov_b32 v6, v45
	v_dual_mov_b32 v9, v45 :: v_dual_mov_b32 v11, v45
...
.LBB0_24:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_cmpx_le_u32_e64 s14, v48
	s_cbranch_execz .LBB0_26
; %bb.25:                               ;   in Loop: Header=BB0_24 Depth=2
	v_mov_b32_e32 v44, v72
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[74:75], v[44:45], 2, s[12:13]
	flat_store_b32 v[74:75], v45
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v44, v72 :: v_dual_add_nc_u32 v61, -2, v61
	v_dual_mov_b32 v74, v73 :: v_dual_mov_b32 v75, v45
	v_add_nc_u32_e32 v73, 0x200, v73
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[76:77], v[44:45], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v61
	v_add_nc_u32_e32 v72, 0x200, v72
	v_lshl_add_u64 v[74:75], v[74:75], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[76:77], v45
	flat_store_b32 v[74:75], v45
...
; %bb.31:                               ;   in Loop: Header=BB0_21 Depth=1
	v_add_nc_u64_e32 v[72:73], s[6:7], v[70:71]
...
.LBB0_32:                               ;   Parent Loop BB0_21 Depth=1
	...
	flat_store_b32 v[72:73], v45
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[72:73], 0x400, v[72:73]
	v_cmp_lt_u32_e32 vcc_lo, 0x143f, v44
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v61, s14 :: v_dual_mov_b32 v72, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v61, s5 :: v_dual_mov_b32 v72, s6
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v61, v46, 1, s2
	v_lshl_add_u32 v63, v56, 1, s2
	ds_load_b128 v[72:75], v44
	ds_load_b128 v[76:79], v44 offset:16
	v_lshl_add_u32 v44, v50, 1, s2
	ds_load_b128 v[80:83], v61
	ds_load_b128 v[84:87], v61 offset:16
	v_lshl_add_u32 v61, v54, 1, s2
	ds_load_b128 v[112:115], v63 offset:8192
	ds_load_b128 v[88:91], v44 offset:2048
	ds_load_b128 v[92:95], v44 offset:2064
	v_lshl_add_u32 v44, v52, 1, s2
	ds_load_b128 v[104:107], v61 offset:6144
	ds_load_b128 v[108:111], v61 offset:6160
	ds_load_b128 v[116:119], v63 offset:8208
	v_lshl_add_u32 v61, v60, 1, s2
	ds_load_b128 v[96:99], v44 offset:4096
	ds_load_b128 v[100:103], v44 offset:4112
	v_lshl_add_u32 v44, v58, 1, s1
	v_lshl_add_u32 v63, v62, 1, s2
	; sched_group_barrier mask(0x00000100) size(12) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[34:41], v[72:79], v[80:87], v[34:41]
	ds_load_b128 v[80:83], v44 offset:64
	ds_load_b128 v[84:87], v44 offset:80
	v_lshl_add_u32 v44, v64, 1, s2
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[26:33], v[72:79], v[88:95], v[26:33] matrix_a_reuse
	ds_load_b128 v[88:91], v61 offset:64
	ds_load_b128 v[92:95], v61 offset:80
	v_lshl_add_u32 v61, v66, 1, s2
	ds_load_b128 v[120:123], v61 offset:64
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[10:17], v[72:79], v[96:103], v[10:17] matrix_a_reuse
	ds_load_b128 v[96:99], v63 offset:64
	ds_load_b128 v[100:103], v63 offset:80
	v_lshl_add_u32 v63, v68, 1, s2
	ds_load_b128 v[124:127], v61 offset:80
	v_wmma_f32_16x16x32_bf16 v[2:9], v[72:79], v[104:111], v[2:9] matrix_a_reuse
	ds_load_b128 v[104:107], v44 offset:64
	ds_load_b128 v[108:111], v44 offset:80
	v_wmma_f32_16x16x32_bf16 v[18:25], v[72:79], v[112:119], v[18:25] matrix_a_reuse
	ds_load_b128 v[72:75], v63 offset:64
	ds_load_b128 v[76:79], v63 offset:80
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[34:41], v[80:87], v[88:95], v[34:41]
	; sched_group_barrier mask(0x00000100) size(12) SyncID(0)
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[26:33], v[80:87], v[96:103], v[26:33] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[10:17], v[80:87], v[104:111], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[80:87], v[120:127], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[80:87], v[72:79], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn160_bk064_wm4_wn2_mc0, .Lfunc_end0-bm064_bn160_bk064_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn160_bk064_wm4_wn2_mc0
	...
	.section	.text.bm064_bn160_bk064_wm4_wn2_mc0,"axG",@progbits,bm064_bn160_bk064_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn160_bk064_wm4_wn2_mc0.num_vgpr, 128
	.set .Lbm064_bn160_bk064_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm064_bn160_bk064_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm064_bn160_bk064_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm064_bn160_bk064_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm064_bn160_bk064_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm064_bn160_bk064_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn160_bk064_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn160_bk064_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm064_bn160_bk064_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_d752e673caf8087d,@object ; @__hip_cuid_d752e673caf8087d
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_d752e673caf8087d
__hip_cuid_d752e673caf8087d:
	.byte	0                               ; 0x0
	.size	__hip_cuid_d752e673caf8087d, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_d752e673caf8087d
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn160_bk064_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn160_bk064_wm4_wn2_mc0.kd
