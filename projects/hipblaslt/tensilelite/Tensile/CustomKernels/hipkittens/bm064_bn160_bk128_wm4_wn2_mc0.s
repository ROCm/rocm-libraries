	...
	.section	.text.bm064_bn160_bk128_wm4_wn2_mc0,"axG",@progbits,bm064_bn160_bk128_wm4_wn2_mc0,comdat
	.protected	bm064_bn160_bk128_wm4_wn2_mc0 ; -- Begin function bm064_bn160_bk128_wm4_wn2_mc0
	.globl	bm064_bn160_bk128_wm4_wn2_mc0
	.p2align	8
	.type	bm064_bn160_bk128_wm4_wn2_mc0,@function
bm064_bn160_bk128_wm4_wn2_mc0: ; @bm064_bn160_bk128_wm4_wn2_mc0
; %bb.0:
...
.LBB0_14:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 3, v47 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	s_and_b32 s40, s3, s25
	v_mov_b32_e32 v9, 0
	v_cndmask_b32_e64 v43, 0, 1, s40
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v49, 48, v1
	v_cmp_ne_u32_e32 vcc_lo, 0, v2
	s_mov_b32 s11, 0
	v_dual_mov_b32 v8, v9 :: v_dual_mov_b32 v7, v9
	v_dual_mov_b32 v6, v9 :: v_dual_mov_b32 v5, v9
	v_cndmask_b32_e64 v51, 0, 0x50, vcc_lo
...
; %bb.15:
	v_dual_lshlrev_b32 v3, 7, v0 :: v_dual_lshlrev_b32 v2, 7, v51
	v_lshlrev_b32_e32 v1, 7, v49
	...
	v_dual_mov_b32 v45, 0 :: v_dual_bitop2_b32 v3, v3, v1 bitop3:0x54
	s_lshr_b32 s4, s4, 2
	...
	s_mul_i32 s6, s34, 0xa0
	s_add_co_i32 s4, s0, 0x13200
	s_delay_alu instid0(VALU_DEP_1)
	v_and_b32_e32 v8, 0x2f8, v8
	v_and_b32_e32 v7, 0x1f8, v7
	s_and_b32 s10, s4, 15
	s_add_co_i32 s42, s0, 0xee00
	s_sub_co_i32 s7, 16, s10
	v_add3_u32 v50, v4, v2, v8
	v_dual_add_nc_u32 v42, v7, v5 :: v_dual_mov_b32 v2, v45
	v_dual_add_nc_u32 v46, v8, v6 :: v_dual_lshrrev_b32 v5, 8, v9
	s_lshr_b32 s0, s7, 2
	...
	v_dual_mov_b32 v55, v45 :: v_dual_add_nc_u32 v6, v4, v1
	s_lshr_b32 s7, s7, 25
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v53, 46, v5
	...
	v_cmp_ne_u32_e64 s0, v5, v53
	v_dual_add_nc_u32 v52, v7, v6 :: v_dual_lshlrev_b32 v56, 2, v9
	v_lshl_or_b32 v54, v0, 2, 0x4000
	v_dual_mov_b32 v4, v45 :: v_dual_add_nc_u32 v61, 0xffffff00, v9
	v_dual_mov_b32 v57, v45 :: v_dual_mov_b32 v3, v45
	v_dual_mov_b32 v5, v45 :: v_dual_mov_b32 v6, v45
	v_dual_mov_b32 v7, v45 :: v_dual_mov_b32 v8, v45
	v_dual_mov_b32 v9, v45 :: v_dual_mov_b32 v10, v45
	v_dual_mov_b32 v11, v45 :: v_dual_mov_b32 v12, v45
	v_dual_mov_b32 v13, v45 :: v_dual_mov_b32 v14, v45
	v_dual_mov_b32 v15, v45 :: v_dual_mov_b32 v16, v45
	v_dual_mov_b32 v17, v45 :: v_dual_mov_b32 v26, v45
	...
	v_dual_mov_b32 v19, v45 :: v_dual_mov_b32 v20, v45
	v_dual_mov_b32 v21, v45 :: v_dual_mov_b32 v22, v45
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v44, v58 :: v_dual_add_nc_u32 v62, -2, v62
	v_dual_mov_b32 v64, v59 :: v_dual_mov_b32 v65, v45
	v_add_nc_u32_e32 v59, 0x200, v59
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[66:67], v[44:45], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v62
	v_add_nc_u32_e32 v58, 0x200, v58
	v_lshl_add_u64 v[64:65], v[64:65], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[66:67], v45
	flat_store_b32 v[64:65], v45
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[58:59], s[6:7], v[54:55]
...
.LBB0_22:                               ;   Parent Loop BB0_17 Depth=1
	...
	flat_store_b32 v[58:59], v45
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[58:59], 0x400, v[58:59]
	v_cmp_lt_u32_e32 vcc_lo, 0xfff, v44
...
.LBB0_27:                               ;   Parent Loop BB0_17 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[58:59], 0x400, v[58:59]
	v_cmp_lt_u32_e32 vcc_lo, 0x297f, v44
	s_or_b32 s6, vcc_lo, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s6
...
.LBB0_35:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v59, s5 :: v_dual_mov_b32 v58, s6
	s_bitset1_b32 s7, 31
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_cselect_b32 s5, s42, 0
	s_cselect_b32 s6, s34, s39
	v_lshl_add_u32 v44, v42, 1, s5
	v_lshl_add_u32 v58, v46, 1, s6
	ds_load_b128 v[62:65], v44
	ds_load_b128 v[66:69], v44 offset:16
	ds_load_b128 v[70:73], v58
	ds_load_b128 v[74:77], v58 offset:16
	ds_load_b128 v[78:81], v58 offset:4352
	ds_load_b128 v[82:85], v58 offset:4368
	ds_load_b128 v[86:89], v58 offset:8704
	ds_load_b128 v[90:93], v58 offset:8720
	ds_load_b128 v[94:97], v58 offset:13056
	ds_load_b128 v[98:101], v58 offset:13072
	ds_load_b128 v[102:105], v58 offset:17408
	ds_load_b128 v[106:109], v58 offset:17424
	v_lshl_add_u32 v44, v48, 1, s5
	v_lshl_add_u32 v58, v50, 1, s6
	; sched_group_barrier mask(0x00000100) size(12) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[34:41], v[62:69], v[70:77], v[34:41]
	ds_load_b128 v[70:73], v44 offset:64
	ds_load_b128 v[74:77], v44 offset:80
	ds_load_b128 v[110:113], v58 offset:8768
	ds_load_b128 v[114:117], v58 offset:8784
	ds_load_b128 v[118:121], v58 offset:13120
	ds_load_b128 v[122:125], v58 offset:13136
	ds_load_b128 v[126:129], v58 offset:17472
	s_wait_dscnt 0xd
	v_wmma_f32_16x16x32_bf16 v[26:33], v[62:69], v[78:85], v[26:33] matrix_a_reuse
	ds_load_b128 v[78:81], v58 offset:64
	ds_load_b128 v[82:85], v58 offset:80
	ds_load_b128 v[130:133], v58 offset:17488
	s_wait_dscnt 0xe
	v_wmma_f32_16x16x32_bf16 v[10:17], v[62:69], v[86:93], v[10:17] matrix_a_reuse
	ds_load_b128 v[86:89], v58 offset:4416
	ds_load_b128 v[90:93], v58 offset:4432
	s_wait_dscnt 0xe
	v_wmma_f32_16x16x32_bf16 v[2:9], v[62:69], v[94:101], v[2:9] matrix_a_reuse
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[18:25], v[62:69], v[102:109], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v44, v52, 1, s5
	ds_load_b128 v[62:65], v58 offset:128
	ds_load_b128 v[66:69], v58 offset:144
	ds_load_b128 v[94:97], v58 offset:4480
	ds_load_b128 v[98:101], v58 offset:4496
	ds_load_b128 v[102:105], v44 offset:128
	ds_load_b128 v[106:109], v44 offset:144
	ds_load_b128 v[134:137], v58 offset:8832
	ds_load_b128 v[138:141], v58 offset:8848
	ds_load_b128 v[142:145], v58 offset:13184
	ds_load_b128 v[146:149], v58 offset:13200
	ds_load_b128 v[150:153], v58 offset:17536
	ds_load_b128 v[154:157], v58 offset:17552
	s_wait_dscnt 0xf
	v_wmma_f32_16x16x32_bf16 v[34:41], v[70:77], v[78:85], v[34:41]
	; sched_group_barrier mask(0x00000100) size(12) SyncID(0)
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[26:33], v[70:77], v[86:93], v[26:33] matrix_a_reuse
	...
	v_wmma_f32_16x16x32_bf16 v[18:25], v[70:77], v[126:133], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[70:73], v44 offset:192
	ds_load_b128 v[74:77], v44 offset:208
	ds_load_b128 v[78:81], v58 offset:192
	ds_load_b128 v[82:85], v58 offset:208
	ds_load_b128 v[86:89], v58 offset:4544
	ds_load_b128 v[90:93], v58 offset:4560
	ds_load_b128 v[110:113], v58 offset:8896
	ds_load_b128 v[114:117], v58 offset:8912
	ds_load_b128 v[118:121], v58 offset:13248
	ds_load_b128 v[122:125], v58 offset:13264
	ds_load_b128 v[126:129], v58 offset:17600
	ds_load_b128 v[130:133], v58 offset:17616
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[34:41], v[102:109], v[62:69], v[34:41]
	; sched_group_barrier mask(0x00000100) size(12) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[102:109], v[94:101], v[26:33] matrix_a_reuse
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[10:17], v[102:109], v[134:141], v[10:17] matrix_a_reuse
	s_wait_dscnt 0xe
	v_wmma_f32_16x16x32_bf16 v[2:9], v[102:109], v[142:149], v[2:9] matrix_a_reuse
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[18:25], v[102:109], v[150:157], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[34:41], v[70:77], v[78:85], v[34:41]
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn160_bk128_wm4_wn2_mc0, .Lfunc_end0-bm064_bn160_bk128_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn160_bk128_wm4_wn2_mc0
	...
	.section	.text.bm064_bn160_bk128_wm4_wn2_mc0,"axG",@progbits,bm064_bn160_bk128_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn160_bk128_wm4_wn2_mc0.num_vgpr, 158
	.set .Lbm064_bn160_bk128_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm064_bn160_bk128_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm064_bn160_bk128_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm064_bn160_bk128_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm064_bn160_bk128_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm064_bn160_bk128_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn160_bk128_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn160_bk128_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm064_bn160_bk128_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_22397e4219550b42,@object ; @__hip_cuid_22397e4219550b42
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_22397e4219550b42
__hip_cuid_22397e4219550b42:
	.byte	0                               ; 0x0
	.size	__hip_cuid_22397e4219550b42, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_22397e4219550b42
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn160_bk128_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn160_bk128_wm4_wn2_mc0.kd
