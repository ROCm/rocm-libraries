	...
	.section	.text.bm256_bn128_bk096_wm4_wn2_mc1,"axG",@progbits,bm256_bn128_bk096_wm4_wn2_mc1,comdat
	.protected	bm256_bn128_bk096_wm4_wn2_mc1 ; -- Begin function bm256_bn128_bk096_wm4_wn2_mc1
	.globl	bm256_bn128_bk096_wm4_wn2_mc1
	.p2align	8
	.type	bm256_bn128_bk096_wm4_wn2_mc1,@function
bm256_bn128_bk096_wm4_wn2_mc1: ; @bm256_bn128_bk096_wm4_wn2_mc1
; %bb.0:
...
.LBB0_16:
	...
	v_dual_lshlrev_b32 v1, 6, v139 :: v_dual_mov_b32 v9, 0
	s_and_b32 s38, s3, s29
	v_and_b32_e32 v135, 0xc0, v0
	v_cndmask_b32_e64 v131, 0, 1, s38
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v137, 64, v1 bitop3:0x40
...
; %bb.17:
	...
	v_or_b32_e32 v143, 0x3100, v0
	s_add_co_i32 s4, s7, 0x13200
	s_add_co_i32 s45, s7, 0x6600
	s_and_b32 s10, s4, 15
	v_lshl_or_b32 v180, v0, 2, 0xc800
	...
	v_dual_lshrrev_b32 v6, 4, v4 :: v_dual_add_nc_u32 v8, v9, v11
	v_add_nc_u32_e32 v12, v9, v15
	v_mad_u32_u24 v34, 0x60, v7, v9
	s_movk_i32 s16, 0x80
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_add_nc_u32_e32 v130, v6, v4
	v_dual_lshrrev_b32 v4, 4, v8 :: v_dual_lshrrev_b32 v6, 4, v10
	v_dual_lshrrev_b32 v8, 4, v12 :: v_dual_bitop2_b32 v2, v17, v2 bitop3:0x54
	v_mov_b32_e32 v133, 0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v19, 0xff8, v4
	v_and_b32_e32 v21, 0xff8, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_lshrrev_b32_e32 v4, 4, v2
	v_and_b32_e32 v23, 0xff8, v8
	v_dual_add_nc_u32 v6, v17, v11 :: v_dual_bitop2_b32 v8, 32, v5 bitop3:0x54
	v_dual_add_nc_u32 v10, v17, v13 :: v_dual_add_nc_u32 v12, v17, v15
	v_and_b32_e32 v4, 0x1f8, v4
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_bitop2_b32 v14, v8, v3 bitop3:0x54
	v_lshrrev_b32_e32 v10, 4, v10
	v_mad_u32_u24 v36, 0x60, v7, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v134, v4, v2 :: v_dual_lshrrev_b32 v2, 4, v12
	v_and_b32_e32 v26, 0x3f8, v6
	v_mad_u32_u24 v4, 0x60, v7, v14
	v_add_nc_u32_e32 v6, v14, v11
	v_and_b32_e32 v28, 0x3f8, v10
	v_and_b32_e32 v29, 0x3f8, v2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v2, v14, v13 :: v_dual_lshrrev_b32 v4, 4, v4
	v_dual_add_nc_u32 v10, v14, v15 :: v_dual_lshrrev_b32 v6, 4, v6
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v2, 4, v2 :: v_dual_bitop2_b32 v8, v1, v8 bitop3:0x54
	v_and_b32_e32 v30, 0xff8, v4
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshrrev_b32_e32 v4, 4, v10
	v_and_b32_e32 v132, 0xff8, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_mad_u32_u24 v6, 0x60, v7, v8
	v_dual_add_nc_u32 v10, v8, v11 :: v_dual_bitop2_b32 v5, 64, v5 bitop3:0x54
	v_add_nc_u32_e32 v12, v8, v13
	v_add_nc_u32_e32 v24, 0x600, v34
	v_lshrrev_b32_e32 v6, 4, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v10, 4, v10 :: v_dual_add_nc_u32 v8, v8, v15
	v_dual_lshrrev_b32 v12, 4, v12 :: v_dual_bitop2_b32 v3, v3, v5 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_and_b32_e32 v31, 0x3f8, v6
	v_and_b32_e32 v6, 0x3f8, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v10, 4, v8 :: v_dual_add_nc_u32 v16, v3, v11
	v_and_b32_e32 v8, 0x3f8, v12
	v_add_nc_u32_e32 v12, v3, v13
	v_mad_u32_u24 v14, 0x60, v7, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v3, v3, v15 :: v_dual_lshrrev_b32 v16, 4, v16
	v_dual_mov_b32 v25, v133 :: v_dual_lshrrev_b32 v18, 4, v12
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v3, 4, v3 :: v_dual_bitop2_b32 v1, v1, v5 bitop3:0x54
	v_lshrrev_b32_e32 v14, 4, v14
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_and_b32_e32 v12, 0xff8, v16
	v_and_b32_e32 v2, 0xff8, v2
	v_mad_u32_u24 v5, 0x60, v7, v1
	v_dual_add_nc_u32 v11, v1, v11 :: v_dual_add_nc_u32 v13, v1, v13
	v_and_b32_e32 v16, 0xff8, v3
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v1, v1, v15 :: v_dual_lshrrev_b32 v3, 4, v5
	v_dual_lshrrev_b32 v5, 4, v11 :: v_dual_lshrrev_b32 v11, 4, v13
	v_sub_nc_u32_e32 v13, 0x197f, v0
	v_and_b32_e32 v4, 0xff8, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v33, 0x3f8, v3
	v_and_b32_e32 v32, 0xff8, v14
	v_and_b32_e32 v14, 0xff8, v18
	v_lshrrev_b32_e32 v3, 8, v13
	v_lshrrev_b32_e32 v1, 4, v1
	v_and_b32_e32 v18, 0x3f8, v5
	v_dual_add_nc_u32 v136, v19, v34 :: v_dual_add_nc_u32 v142, v26, v36
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v5, v133 :: v_dual_add_nc_u32 v3, 1, v3
	v_dual_mov_b32 v7, v133 :: v_dual_add_nc_u32 v26, 0x1200, v34
	v_mov_b32_e32 v27, v133
	v_and_b32_e32 v10, 0x3f8, v10
	v_and_b32_e32 v141, 26, v3
	v_and_b32_e32 v20, 0x3f8, v11
	v_and_b32_e32 v22, 0x3f8, v1
	v_dual_add_nc_u32 v138, v21, v34 :: v_dual_add_nc_u32 v140, v23, v34
	s_delay_alu instid0(VALU_DEP_4)
	v_cmp_ne_u32_e64 s1, v3, v141
	v_mov_b32_e32 v3, v133
	v_add_nc_u64_e32 v[144:145], v[132:133], v[24:25]
	v_add_nc_u32_e32 v132, 0xc00, v34
	...
	v_dual_mov_b32 v11, v133 :: v_dual_add_nc_u32 v4, 0xc00, v36
	v_dual_mov_b32 v29, v133 :: v_dual_add_nc_u32 v28, 0x1200, v36
	v_dual_mov_b32 v13, v133 :: v_dual_mov_b32 v15, v133
	v_dual_mov_b32 v17, v133 :: v_dual_add_nc_u32 v164, v32, v34
	v_dual_mov_b32 v19, v133 :: v_dual_mov_b32 v21, v133
	v_dual_mov_b32 v23, v133 :: v_dual_mov_b32 v181, v133
	v_lshl_or_b32 v35, v141, 8, v0
	...
	v_dual_add_nc_u32 v150, v30, v34 :: v_dual_add_nc_u32 v156, v31, v36
	v_dual_add_nc_u32 v172, v33, v36 :: v_dual_lshlrev_b32 v182, 2, v35
	v_dual_mov_b32 v4, v133 :: v_dual_add_nc_u32 v145, 0xffffff00, v35
	v_dual_mov_b32 v183, v133 :: v_dual_mov_b32 v6, v133
	v_dual_mov_b32 v2, v133 :: v_dual_mov_b32 v8, v133
...
; %bb.42:
	...
	v_and_b32_e32 v107, 0x1ff0, v107
	...
	v_and_b32_e32 v108, 0xbf0, v116
	v_and_b32_e32 v84, 0xbf0, v84
	...
	v_dual_add_nc_u32 v106, v106, v114 :: v_dual_add_nc_u32 v107, v107, v114
	...
	v_add_nc_u32_e32 v100, v108, v114
	v_add_nc_u32_e32 v69, v84, v114
	...
	v_add_nc_u32_e32 v52, 0x3020, v1
	...
	v_add_nc_u32_e32 v34, 0x1030, v1
	ds_store_b128 v106, v[110:113] offset:16384
	ds_store_b128 v100, v[94:97] offset:32
	ds_store_b128 v107, v[102:105] offset:24576
	ds_store_b128 v69, v[62:65] offset:64
	ds_store_b128 v90, v[86:89] offset:8192
	ds_store_b128 v82, v[70:73] offset:16384
	ds_store_b128 v59, v[26:29] offset:24576
	ds_store_b128 v50, v[46:49] offset:8192
	ds_store_b128 v42, v[38:41] offset:16384
	v_add_nc_u32_e32 v28, 0x2030, v1
	v_add_nc_u32_e32 v1, 0x3030, v1
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn128_bk096_wm4_wn2_mc1, .Lfunc_end0-bm256_bn128_bk096_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn128_bk096_wm4_wn2_mc1
	...
	.section	.text.bm256_bn128_bk096_wm4_wn2_mc1,"axG",@progbits,bm256_bn128_bk096_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm256_bn128_bk096_wm4_wn2_mc1.num_vgpr, 288
	.set .Lbm256_bn128_bk096_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm256_bn128_bk096_wm4_wn2_mc1.numbered_sgpr, 60
	.set .Lbm256_bn128_bk096_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm256_bn128_bk096_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm256_bn128_bk096_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm256_bn128_bk096_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm256_bn128_bk096_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm256_bn128_bk096_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm256_bn128_bk096_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_ad4eeb3dfe4a7d28,@object ; @__hip_cuid_ad4eeb3dfe4a7d28
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_ad4eeb3dfe4a7d28
__hip_cuid_ad4eeb3dfe4a7d28:
	.byte	0                               ; 0x0
	.size	__hip_cuid_ad4eeb3dfe4a7d28, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_ad4eeb3dfe4a7d28
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn128_bk096_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     62
    .sgpr_spill_count: 0
    .symbol:         bm256_bn128_bk096_wm4_wn2_mc1.kd
