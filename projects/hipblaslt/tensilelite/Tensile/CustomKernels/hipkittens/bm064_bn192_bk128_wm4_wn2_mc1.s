	...
	.section	.text.bm064_bn192_bk128_wm4_wn2_mc1,"axG",@progbits,bm064_bn192_bk128_wm4_wn2_mc1,comdat
	.protected	bm064_bn192_bk128_wm4_wn2_mc1 ; -- Begin function bm064_bn192_bk128_wm4_wn2_mc1
	.globl	bm064_bn192_bk128_wm4_wn2_mc1
	.p2align	8
	.type	bm064_bn192_bk128_wm4_wn2_mc1,@function
bm064_bn192_bk128_wm4_wn2_mc1: ; @bm064_bn192_bk128_wm4_wn2_mc1
; %bb.0:
...
; %bb.3:
	...
	v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v3, v52
	s_mov_b32 s7, 0
	v_mov_b32_e32 v4, v1
...
.LBB0_16:
	...
	v_dual_lshlrev_b32 v1, 3, v55 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s42, s3, s29
	s_mov_b32 s11, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v57, 48, v1
	v_cmp_ne_u32_e32 vcc_lo, 0, v2
	v_cndmask_b32_e64 v51, 0, 1, s42
	v_dual_mov_b32 v8, v9 :: v_dual_mov_b32 v7, v9
	v_dual_mov_b32 v6, v9 :: v_dual_mov_b32 v5, v9
	v_cndmask_b32_e64 v59, 0, 0x60, vcc_lo
...
; %bb.17:
	...
	s_lshl2_add_u32 s7, s4, s41
	v_dual_mov_b32 v53, 0 :: v_dual_bitop2_b32 v3, v3, v1 bitop3:0x54
	s_add_co_i32 s4, s7, 0x11000
	s_delay_alu instid0(VALU_DEP_2)
	...
	s_or_b32 s4, s18, 0x7510000
	v_dual_add_nc_u32 v50, v7, v5 :: v_dual_add_nc_u32 v54, v8, v6
	v_lshrrev_b32_e32 v3, 4, v3
	s_wait_kmcnt 0x0
	s_bfe_i64 s[18:19], s[20:21], 0x200000
	v_dual_add_nc_u32 v5, v4, v1 :: v_dual_mov_b32 v63, v53
	...
	v_dual_mov_b32 v65, v53 :: v_dual_add_nc_u32 v56, v3, v5
	v_add3_u32 v58, v4, v2, v8
	v_dual_add_nc_u32 v60, v7, v5 :: v_dual_mov_b32 v2, v53
	v_or_b32_e32 v61, 0xf00, v0
	v_or_b32_e32 v62, 0x4000, v52
	v_or_b32_e32 v68, 0x3100, v0
	v_or_b32_e32 v64, 0xc800, v52
	v_dual_mov_b32 v3, v53 :: v_dual_mov_b32 v4, v53
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v52, v66 :: v_dual_add_nc_u32 v69, -2, v69
	v_dual_mov_b32 v70, v67 :: v_dual_mov_b32 v71, v53
	v_add_nc_u32_e32 v67, 0x200, v67
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[72:73], v[52:53], 2, s[6:7]
...
.LBB0_24:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_cmp_lt_u32_e32 vcc_lo, 0xfff, v52
...
.LBB0_29:                               ;   Parent Loop BB0_19 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[66:67], 0x400, v[66:67]
	v_cmp_lt_u32_e32 vcc_lo, 0x31ff, v52
	s_or_b32 s6, vcc_lo, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s6
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_lshl_add_u32 v67, v58, 1, s6
	ds_load_b128 v[70:73], v52
	ds_load_b128 v[74:77], v52 offset:16
	ds_load_b128 v[78:81], v66
	ds_load_b128 v[82:85], v66 offset:16
	ds_load_b128 v[86:89], v66 offset:4352
	ds_load_b128 v[90:93], v66 offset:4368
	ds_load_b128 v[118:121], v66 offset:17408
	ds_load_b128 v[122:125], v66 offset:17424
	ds_load_b128 v[94:97], v66 offset:8704
	v_lshl_add_u32 v52, v56, 1, s5
	ds_load_b128 v[102:105], v67 offset:64
	ds_load_b128 v[106:109], v67 offset:80
	ds_load_b128 v[110:113], v67 offset:4416
	ds_load_b128 v[114:117], v67 offset:4432
	ds_load_b128 v[126:129], v67 offset:13120
	ds_load_b128 v[130:133], v67 offset:13136
	ds_load_b128 v[134:137], v67 offset:17472
	ds_load_b128 v[138:141], v67 offset:17488
	ds_load_b128 v[142:145], v67 offset:21824
	ds_load_b128 v[146:149], v67 offset:21840
	s_wait_dscnt 0xf
	v_wmma_f32_16x16x32_bf16 v[42:49], v[70:77], v[78:85], v[42:49]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0xd
	v_wmma_f32_16x16x32_bf16 v[34:41], v[70:77], v[86:93], v[34:41] matrix_a_reuse
	s_wait_dscnt 0xb
	v_wmma_f32_16x16x32_bf16 v[2:9], v[70:77], v[118:125], v[2:9] matrix_a_reuse
	ds_load_b128 v[78:81], v66 offset:21760
	ds_load_b128 v[82:85], v66 offset:21776
	ds_load_b128 v[98:101], v66 offset:8720
	ds_load_b128 v[86:89], v52 offset:64
	ds_load_b128 v[90:93], v52 offset:80
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[26:33], v[70:77], v[78:85], v[26:33] matrix_a_reuse
	ds_load_b128 v[78:81], v66 offset:13056
	ds_load_b128 v[82:85], v66 offset:13072
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[18:25], v[70:77], v[94:101], v[18:25] matrix_a_reuse
	ds_load_b128 v[94:97], v67 offset:8768
	ds_load_b128 v[98:101], v67 offset:8784
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[10:17], v[70:77], v[78:85], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v52, v60, 1, s5
	ds_load_b128 v[70:73], v67 offset:128
	ds_load_b128 v[74:77], v67 offset:144
	ds_load_b128 v[78:81], v67 offset:4480
	ds_load_b128 v[82:85], v67 offset:4496
	ds_load_b128 v[118:121], v52 offset:128
	ds_load_b128 v[122:125], v52 offset:144
	ds_load_b128 v[150:153], v67 offset:8832
	v_wmma_f32_16x16x32_bf16 v[42:49], v[86:93], v[102:109], v[42:49]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[86:93], v[110:117], v[34:41] matrix_a_reuse
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[18:25], v[86:93], v[94:101], v[18:25] matrix_a_reuse
	ds_load_b128 v[154:157], v67 offset:8848
	ds_load_b128 v[94:97], v67 offset:13184
	ds_load_b128 v[98:101], v67 offset:13200
	ds_load_b128 v[102:105], v67 offset:17536
	ds_load_b128 v[106:109], v67 offset:17552
	ds_load_b128 v[110:113], v67 offset:21888
	ds_load_b128 v[114:117], v67 offset:21904
	v_wmma_f32_16x16x32_bf16 v[10:17], v[86:93], v[126:133], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[86:93], v[134:141], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[86:93], v[142:149], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[86:89], v52 offset:192
	ds_load_b128 v[90:93], v52 offset:208
	ds_load_b128 v[126:129], v67 offset:192
	ds_load_b128 v[130:133], v67 offset:208
	ds_load_b128 v[134:137], v67 offset:4544
	ds_load_b128 v[138:141], v67 offset:4560
	ds_load_b128 v[142:145], v67 offset:8896
	s_wait_dscnt 0xf
	v_wmma_f32_16x16x32_bf16 v[42:49], v[118:125], v[70:77], v[42:49]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[118:125], v[78:85], v[34:41] matrix_a_reuse
	s_wait_dscnt 0xd
	v_wmma_f32_16x16x32_bf16 v[18:25], v[118:125], v[150:157], v[18:25] matrix_a_reuse
	ds_load_b128 v[146:149], v67 offset:8912
	ds_load_b128 v[70:73], v67 offset:13248
	ds_load_b128 v[74:77], v67 offset:13264
	ds_load_b128 v[78:81], v67 offset:17600
	ds_load_b128 v[82:85], v67 offset:17616
	ds_load_b128 v[150:153], v67 offset:21952
	ds_load_b128 v[154:157], v67 offset:21968
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[10:17], v[118:125], v[94:101], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[2:9], v[118:125], v[102:109], v[2:9] matrix_a_reuse
	s_wait_dscnt 0xe
	v_wmma_f32_16x16x32_bf16 v[26:33], v[118:125], v[110:117], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[42:49], v[86:93], v[126:133], v[42:49]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[34:41], v[86:93], v[134:141], v[34:41] matrix_a_reuse
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[18:25], v[86:93], v[142:149], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[10:17], v[86:93], v[70:77], v[10:17] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[86:93], v[78:85], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[86:93], v[150:157], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.42:
	...
	v_and_b32_e32 v20, 0x7f0, v20
	v_add_nc_u32_e32 v37, v22, v35
	v_cvt_pk_bf16_f32 v22, v18, v19
	v_and_b32_e32 v19, 0x7f0, v36
	v_add_nc_u32_e32 v34, v34, v35
	v_and_b32_e32 v1, 0x7f0, v1
	v_dual_add_nc_u32 v21, v21, v35 :: v_dual_add_nc_u32 v18, v20, v35
	v_cvt_pk_bf16_f32 v17, v16, v17
	v_cvt_pk_bf16_f32 v16, v14, v15
	v_cvt_pk_bf16_f32 v15, v12, v13
	v_cvt_pk_bf16_f32 v14, v10, v11
	v_add_nc_u32_e32 v10, v19, v35
	...
	ds_store_b128 v21, v[38:41] offset:2048
	ds_store_b128 v37, v[22:25] offset:4096
	ds_store_b128 v18, v[14:17] offset:6144
	ds_store_b128 v10, v[6:9] offset:8192
	ds_store_b128 v1, v[2:5] offset:10240
.LBB0_43:
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn192_bk128_wm4_wn2_mc1, .Lfunc_end0-bm064_bn192_bk128_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn192_bk128_wm4_wn2_mc1
	...
	.section	.text.bm064_bn192_bk128_wm4_wn2_mc1,"axG",@progbits,bm064_bn192_bk128_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn192_bk128_wm4_wn2_mc1.num_vgpr, 158
	.set .Lbm064_bn192_bk128_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm064_bn192_bk128_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm064_bn192_bk128_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm064_bn192_bk128_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm064_bn192_bk128_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm064_bn192_bk128_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm064_bn192_bk128_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn192_bk128_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm064_bn192_bk128_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_557349aa382fc271,@object ; @__hip_cuid_557349aa382fc271
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_557349aa382fc271
__hip_cuid_557349aa382fc271:
	.byte	0                               ; 0x0
	.size	__hip_cuid_557349aa382fc271, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_557349aa382fc271
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn192_bk128_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn192_bk128_wm4_wn2_mc1.kd
