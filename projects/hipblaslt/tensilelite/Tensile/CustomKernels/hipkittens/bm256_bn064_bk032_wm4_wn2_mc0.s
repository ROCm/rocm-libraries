	...
	.section	.text.bm256_bn064_bk032_wm4_wn2_mc0,"axG",@progbits,bm256_bn064_bk032_wm4_wn2_mc0,comdat
	.protected	bm256_bn064_bk032_wm4_wn2_mc0 ; -- Begin function bm256_bn064_bk032_wm4_wn2_mc0
	.globl	bm256_bn064_bk032_wm4_wn2_mc0
	.p2align	8
	.type	bm256_bn064_bk032_wm4_wn2_mc0,@function
bm256_bn064_bk032_wm4_wn2_mc0: ; @bm256_bn064_bk032_wm4_wn2_mc0
; %bb.0:
...
; %bb.19:
	v_dual_lshlrev_b32 v1, 5, v0 :: v_dual_lshlrev_b32 v2, 5, v75
	v_dual_mov_b32 v69, 0 :: v_dual_bitop2_b32 v3, 16, v0 bitop3:0x40
	...
	v_dual_add_nc_u32 v74, v3, v2 :: v_dual_add_nc_u32 v76, v8, v2
	s_lshr_b32 s7, s7, 27
	v_add_nc_u32_e32 v78, v5, v2
	s_add_co_i32 s17, s17, s7
	v_dual_mov_b32 v2, v69 :: v_dual_add_nc_u32 v70, v6, v4
	...
	s_lshl_b32 s4, s0, 6
	s_lshl_b32 s6, s2, 8
	v_and_b32_e32 v6, 0x78, v7
	v_dual_add_nc_u32 v7, 2, v72 :: v_dual_mov_b32 v83, v69
	s_ashr_i32 s5, s4, 31
	s_ashr_i32 s7, s6, 31
	s_wait_kmcnt 0x0
	...
	v_dual_add_nc_u32 v80, v6, v4 :: v_dual_bitop2_b32 v77, 14, v7 bitop3:0x40
	v_lshl_or_b32 v82, v0, 2, 0x4000
	...
	v_dual_mov_b32 v33, v69 :: v_dual_mov_b32 v50, v69
	...
	v_dual_mov_b32 v25, v69 :: v_dual_mov_b32 v34, v69
	...
	v_dual_mov_b32 v41, v69 :: v_dual_mov_b32 v42, v69
...
.LBB0_23:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_dual_mov_b32 v68, v84 :: v_dual_add_nc_u32 v81, -2, v81
	v_dual_mov_b32 v86, v85 :: v_dual_mov_b32 v87, v69
	v_add_nc_u32_e32 v85, 0x200, v85
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[88:89], v[68:69], 2, s[6:7]
...
; %bb.30:                               ;   in Loop: Header=BB0_29 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[86:87], v[68:69], 2, s[12:13]
	flat_store_b32 v[86:87], v69
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_dual_mov_b32 v81, s14 :: v_dual_mov_b32 v84, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v81, s5 :: v_dual_mov_b32 v84, s6
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_lshl_add_u32 v96, v70, 1, s2
	ds_load_b128 v[84:87], v68
	ds_load_b128 v[88:91], v68 offset:16
	ds_load_b128 v[92:95], v81 offset:1024
	ds_load_b128 v[100:103], v96
	ds_load_b128 v[104:107], v96 offset:16
	v_lshl_add_u32 v68, v80, 1, s2
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[84:91], v[100:107], v[58:65]
	ds_load_b128 v[108:111], v68 offset:1024
	ds_load_b128 v[112:115], v68 offset:1040
	v_lshl_add_u32 v68, v76, 1, s0
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[50:57], v[84:91], v[108:115], v[50:57] matrix_b_reuse
	ds_load_b128 v[84:87], v68 offset:2048
	ds_load_b128 v[88:91], v68 offset:2064
	v_lshl_add_u32 v68, v78, 1, s0
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[84:91], v[100:107], v[2:9] matrix_b_reuse
	ds_load_b128 v[96:99], v81 offset:1040
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[92:99], v[100:107], v[26:33] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[92:99], v[108:115], v[10:17] matrix_b_reuse
	ds_load_b128 v[96:99], v68 offset:3088
	ds_load_b128 v[92:95], v68 offset:3072
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[92:99], v[108:115], v[42:49] matrix_a_reuse
	...
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[84:91], v[108:115], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[92:99], v[100:107], v[34:41] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
...
; %bb.43:
	...
	v_or3_b32 v1, v1, v75, v66
	v_cvt_pk_bf16_f32 v64, v62, v63
	v_cvt_pk_bf16_f32 v63, v60, v61
	v_cvt_pk_bf16_f32 v62, v58, v59
	v_cvt_pk_bf16_f32 v55, v52, v53
	v_or_b32_e32 v30, 0x1000, v1
	v_dual_lshrrev_b32 v28, 3, v1 :: v_dual_lshlrev_b32 v50, 1, v1
	v_dual_add_nc_u32 v53, 32, v1 :: v_dual_add_nc_u32 v29, 16, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshrrev_b32_e32 v51, 3, v30
	v_and_b32_e32 v28, 0x5f0, v28
	v_lshlrev_b32_e32 v58, 1, v30
	...
	v_cvt_pk_bf16_f32 v20, v46, v47
	v_cvt_pk_bf16_f32 v19, v44, v45
	v_cvt_pk_bf16_f32 v18, v42, v43
	ds_store_b128 v29, v[30:33] offset:32
	ds_store_b128 v26, v[14:17] offset:32
	ds_store_b128 v27, v[6:9] offset:64
	ds_store_b128 v28, v[2:5] offset:64
	ds_store_b128 v22, v[10:13] offset:96
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn064_bk032_wm4_wn2_mc0, .Lfunc_end0-bm256_bn064_bk032_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn064_bk032_wm4_wn2_mc0
	...
	.section	.text.bm256_bn064_bk032_wm4_wn2_mc0,"axG",@progbits,bm256_bn064_bk032_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm256_bn064_bk032_wm4_wn2_mc0.num_vgpr, 116
	.set .Lbm256_bn064_bk032_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm256_bn064_bk032_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm256_bn064_bk032_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm256_bn064_bk032_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm256_bn064_bk032_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm256_bn064_bk032_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm256_bn064_bk032_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm256_bn064_bk032_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm256_bn064_bk032_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_71ea97702b5f4ad9,@object ; @__hip_cuid_71ea97702b5f4ad9
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_71ea97702b5f4ad9
__hip_cuid_71ea97702b5f4ad9:
	.byte	0                               ; 0x0
	.size	__hip_cuid_71ea97702b5f4ad9, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_71ea97702b5f4ad9
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn064_bk032_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn064_bk032_wm4_wn2_mc0.kd
