	...
	.section	.text.bm128_bn128_bk064_wm4_wn2_mc0,"axG",@progbits,bm128_bn128_bk064_wm4_wn2_mc0,comdat
	.protected	bm128_bn128_bk064_wm4_wn2_mc0 ; -- Begin function bm128_bn128_bk064_wm4_wn2_mc0
	.globl	bm128_bn128_bk064_wm4_wn2_mc0
	.p2align	8
	.type	bm128_bn128_bk064_wm4_wn2_mc0,@function
bm128_bn128_bk064_wm4_wn2_mc0: ; @bm128_bn128_bk064_wm4_wn2_mc0
; %bb.0:
...
; %bb.15:
	...
	v_dual_lshlrev_b32 v2, 6, v75 :: v_dual_lshlrev_b32 v3, 6, v73
	...
	v_and_b32_e32 v9, 0x138, v9
	v_and_b32_e32 v12, 0x1f8, v12
	v_and_b32_e32 v14, 0x1f8, v14
	v_and_b32_e32 v15, 0x1f8, v15
	v_dual_add_nc_u32 v72, v6, v5 :: v_dual_add_nc_u32 v3, v4, v3
	v_dual_add_nc_u32 v2, v4, v2 :: v_dual_add_nc_u32 v78, v10, v7
	s_ashr_i32 s3, s2, 31
	s_ashr_i32 s1, s0, 31
	s_wait_kmcnt 0x0
	...
	v_dual_add_nc_u32 v74, v8, v7 :: v_dual_add_nc_u32 v76, v13, v7
	v_dual_add_nc_u32 v80, v11, v3 :: v_dual_add_nc_u32 v84, v9, v2
	v_add3_u32 v82, v3, v16, 0x400
	v_add3_u32 v86, v2, v12, 0x400
	v_add3_u32 v88, v2, v14, 0x800
	v_add3_u32 v90, v2, v15, 0xc00
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v68, v94 :: v_dual_add_nc_u32 v79, -2, v79
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_dual_mov_b32 v79, s1 :: v_dual_mov_b32 v94, s2
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	ds_load_b128 v[102:105], v79 offset:2048
	...
	ds_load_b128 v[122:125], v68 offset:4112
	ds_load_b128 v[106:109], v79 offset:2064
	v_lshl_add_u32 v68, v74, 1, s2
	v_lshl_add_u32 v79, v82, 1, s1
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[102:109], v[118:125], v[2:9] matrix_a_reuse
	ds_load_b128 v[110:113], v81 offset:6144
	ds_load_b128 v[114:117], v81 offset:6160
	v_lshl_add_u32 v81, v84, 1, s2
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[102:109], v[110:117], v[34:41]
	...
	ds_load_b128 v[126:129], v68 offset:2048
	ds_load_b128 v[130:133], v68 offset:2064
	v_lshl_add_u32 v68, v70, 1, s2
	ds_load_b128 v[110:113], v87 offset:64
	ds_load_b128 v[114:117], v87 offset:80
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[10:17], v[102:109], v[126:133], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[94:101], v[126:133], v[50:57] matrix_a_reuse
	ds_load_b128 v[126:129], v68
	ds_load_b128 v[130:133], v68 offset:16
	v_lshl_add_u32 v68, v80, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[94:101], v[126:133], v[58:65]
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[94:101], v[118:125], v[42:49] matrix_a_reuse
	ds_load_b128 v[94:97], v68 offset:64
	ds_load_b128 v[98:101], v68 offset:80
	ds_load_b128 v[118:121], v79 offset:64
	ds_load_b128 v[122:125], v79 offset:80
	v_wmma_f32_16x16x32_bf16 v[26:33], v[102:109], v[126:133], v[26:33] matrix_a_reuse
	ds_load_b128 v[126:129], v81 offset:64
	ds_load_b128 v[130:133], v81 offset:80
	ds_load_b128 v[102:105], v85 offset:64
	ds_load_b128 v[106:109], v85 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	...
	v_wmma_f32_16x16x32_bf16 v[58:65], v[94:101], v[126:133], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[94:101], v[134:141], v[50:57] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[94:101], v[102:109], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[94:101], v[110:117], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[118:125], v[110:117], v[34:41]
	...
	v_wmma_f32_16x16x32_bf16 v[26:33], v[118:125], v[126:133], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn128_bk064_wm4_wn2_mc0, .Lfunc_end0-bm128_bn128_bk064_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn128_bk064_wm4_wn2_mc0
	...
	.section	.text.bm128_bn128_bk064_wm4_wn2_mc0,"axG",@progbits,bm128_bn128_bk064_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn128_bk064_wm4_wn2_mc0.num_vgpr, 142
	.set .Lbm128_bn128_bk064_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm128_bn128_bk064_wm4_wn2_mc0.numbered_sgpr, 52
	.set .Lbm128_bn128_bk064_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm128_bn128_bk064_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm128_bn128_bk064_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm128_bn128_bk064_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn128_bk064_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn128_bk064_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm128_bn128_bk064_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_35c20c6c2edb9301,@object ; @__hip_cuid_35c20c6c2edb9301
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_35c20c6c2edb9301
__hip_cuid_35c20c6c2edb9301:
	.byte	0                               ; 0x0
	.size	__hip_cuid_35c20c6c2edb9301, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_35c20c6c2edb9301
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn128_bk064_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     54
    .sgpr_spill_count: 0
    .symbol:         bm128_bn128_bk064_wm4_wn2_mc0.kd
