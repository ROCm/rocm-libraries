	...
	.section	.text.bm064_bn320_bk064_wm2_wn4_mc1,"axG",@progbits,bm064_bn320_bk064_wm2_wn4_mc1,comdat
	.protected	bm064_bn320_bk064_wm2_wn4_mc1 ; -- Begin function bm064_bn320_bk064_wm2_wn4_mc1
	.globl	bm064_bn320_bk064_wm2_wn4_mc1
	.p2align	8
	.type	bm064_bn320_bk064_wm2_wn4_mc1,@function
bm064_bn320_bk064_wm2_wn4_mc1: ; @bm064_bn320_bk064_wm2_wn4_mc1
; %bb.0:
...
.LBB0_12:
	...
	s_or_b32 s38, s0, 0x2200
	s_add_co_i32 s18, s7, -1
	s_min_i32 s1, s33, s8
	s_and_b32 s19, s16, 3
	s_lshl_b32 s17, 15, s2
...
.LBB0_20:
	...
	v_dual_lshlrev_b32 v1, 3, v91 :: v_dual_bitop2_b32 v93, 3, v91 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s43, s35, s29
	s_and_not1_b32 vcc_lo, exec_lo, s13
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v89, 32, v1
	v_cndmask_b32_e64 v87, 0, 1, s43
...
; %bb.21:
	v_mul_u32_u24_e32 v1, 0x1400, v93
	v_dual_lshlrev_b32 v2, 6, v89 :: v_dual_bitop2_b32 v3, 16, v0 bitop3:0x40
	v_dual_lshlrev_b32 v4, 6, v0 :: v_dual_lshrrev_b32 v88, 8, v83
	...
	v_dual_mov_b32 v85, 0 :: v_dual_bitop2_b32 v4, v2, v3 bitop3:0x54
	s_lshr_b32 s4, s4, 2
	s_cmp_lg_u64 s[6:7], 0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v8, 4, v6 :: v_dual_lshrrev_b32 v5, 4, v4
	v_or_b32_e32 v7, 0x400, v4
	v_dual_mov_b32 v115, v85 :: v_dual_add_nc_u32 v10, 0x800, v6
	v_add_nc_u32_e32 v11, 0xc00, v6
	v_and_b32_e32 v5, 0xb8, v5
	v_dual_mov_b32 v83, v88 :: v_dual_add_nc_u32 v12, 0x1000, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v10, 4, v10 :: v_dual_lshrrev_b32 v11, 4, v11
	v_dual_add_nc_u32 v82, v5, v4 :: v_dual_lshrrev_b32 v5, 4, v7
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v86, v7, v6 :: v_dual_lshrrev_b32 v7, 4, v8
	v_or_b32_e32 v8, v9, v2
	v_dual_add_nc_u32 v2, v3, v2 :: v_dual_bitop2_b32 v1, v9, v1 bitop3:0x54
	v_mov_b32_e32 v3, v85
	v_and_b32_e32 v9, 0x7f8, v11
	s_delay_alu instid0(VALU_DEP_4)
	v_or_b32_e32 v13, 0x400, v8
	v_lshrrev_b32_e32 v12, 4, v12
	v_lshrrev_b32_e32 v8, 4, v8
	v_add_nc_u32_e32 v15, 0x800, v1
	v_lshrrev_b32_e32 v14, 4, v1
	v_lshrrev_b32_e32 v13, 4, v13
	v_and_b32_e32 v11, 0x7f8, v12
	...
	v_sub_nc_u32_e32 v17, 0x2a7f, v0
	v_dual_add_nc_u32 v100, v8, v2 :: v_dual_mov_b32 v8, v85
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_add_nc_u32 v90, v5, v4
	s_add_co_i32 s4, s6, 0xee00
	v_dual_add_nc_u32 v94, v10, v6 :: v_dual_add_nc_u32 v98, v11, v6
	s_and_b32 s10, s4, 15
	v_and_b32_e32 v18, 0x7f8, v1
	v_dual_mov_b32 v10, v85 :: v_dual_lshrrev_b32 v1, 8, v17
	s_mul_i32 s0, s1, 0x140
	s_sub_co_i32 s1, 16, s10
	s_add_co_i32 s45, s6, 0xcc00
	s_lshr_b32 s1, s1, 2
	...
	v_dual_add_nc_u32 v1, 2, v88 :: v_dual_add_nc_u32 v92, v7, v6
	v_lshl_or_b32 v19, v95, 8, v0
	s_ashr_i32 s1, s0, 31
	s_ashr_i32 s7, s6, 31
	s_wait_kmcnt 0x0
	...
	v_dual_add_nc_u32 v96, v9, v6 :: v_dual_bitop2_b32 v97, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_cmp_ne_u32_e64 s1, v17, v95
	v_dual_mov_b32 v9, v85 :: v_dual_add_nc_u32 v104, v14, v6
	v_add3_u32 v106, v6, v13, 0x400
	v_add3_u32 v108, v6, v15, 0x800
	v_add3_u32 v110, v6, v16, 0xc00
	v_add3_u32 v112, v6, v18, 0x1000
	v_add_nc_u32_e32 v99, 0xffffff00, v19
	v_lshlrev_b32_e32 v114, 2, v19
	v_add3_u32 v102, v2, v12, 0x400
	v_dual_mov_b32 v2, v85 :: v_dual_mov_b32 v6, v85
	v_dual_mov_b32 v7, v85 :: v_dual_mov_b32 v11, v85
	v_dual_mov_b32 v13, v85 :: v_dual_mov_b32 v12, v85
...
.LBB0_26:                               ;   Parent Loop BB0_23 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s19, v83
	v_cmpx_le_u32_e64 s18, v88
	s_cbranch_execz .LBB0_28
; %bb.27:                               ;   in Loop: Header=BB0_26 Depth=2
	v_mov_b32_e32 v84, v116
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[118:119], v[84:85], 2, s[14:15]
...
.LBB0_31:                               ;   Parent Loop BB0_23 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v84, v116 :: v_dual_add_nc_u32 v101, -2, v101
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_lshl_add_u32 v101, v86, 1, s2
	v_lshl_add_u32 v103, v104, 1, s2
	v_lshl_add_u32 v105, v106, 1, s2
	v_lshl_add_u32 v107, v108, 1, s2
	ds_load_b128 v[116:119], v84
	ds_load_b128 v[120:123], v84 offset:16
	v_lshl_add_u32 v84, v90, 1, s5
	ds_load_b128 v[124:127], v101
	ds_load_b128 v[128:131], v101 offset:16
	v_lshl_add_u32 v101, v98, 1, s2
	v_lshl_add_u32 v109, v110, 1, s2
	ds_load_b128 v[132:135], v84 offset:2048
	ds_load_b128 v[136:139], v84 offset:2064
	v_lshl_add_u32 v84, v92, 1, s2
	v_lshl_add_u32 v111, v112, 1, s2
	ds_load_b128 v[164:167], v103 offset:64
	ds_load_b128 v[168:171], v103 offset:80
	ds_load_b128 v[172:175], v107 offset:64
	ds_load_b128 v[140:143], v84 offset:2048
	ds_load_b128 v[176:179], v107 offset:80
	ds_load_b128 v[180:183], v109 offset:64
	ds_load_b128 v[184:187], v109 offset:80
	...
	ds_load_b128 v[124:127], v101 offset:8192
	ds_load_b128 v[128:131], v101 offset:8208
	v_lshl_add_u32 v101, v96, 1, s2
	ds_load_b128 v[140:143], v111 offset:64
	ds_load_b128 v[144:147], v111 offset:80
	s_wait_dscnt 0x2
	...
	ds_load_b128 v[124:127], v101 offset:6144
	ds_load_b128 v[128:131], v101 offset:6160
	v_lshl_add_u32 v101, v94, 1, s2
	ds_load_b128 v[148:151], v101 offset:4096
	ds_load_b128 v[152:155], v101 offset:4112
	v_lshl_add_u32 v101, v102, 1, s5
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[116:123], v[148:155], v[58:65] matrix_a_reuse
	ds_load_b128 v[156:159], v101 offset:64
	ds_load_b128 v[160:163], v101 offset:80
	...
	ds_load_b128 v[132:135], v105 offset:64
	ds_load_b128 v[136:139], v105 offset:80
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_dual_mov_b32 v101, s13 :: v_dual_mov_b32 v116, s14
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v101, s5 :: v_dual_mov_b32 v116, s6
	s_bitset1_b32 s7, 31
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn320_bk064_wm2_wn4_mc1, .Lfunc_end0-bm064_bn320_bk064_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn320_bk064_wm2_wn4_mc1
	...
	.section	.text.bm064_bn320_bk064_wm2_wn4_mc1,"axG",@progbits,bm064_bn320_bk064_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn320_bk064_wm2_wn4_mc1.num_vgpr, 188
	.set .Lbm064_bn320_bk064_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm064_bn320_bk064_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm064_bn320_bk064_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm064_bn320_bk064_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm064_bn320_bk064_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm064_bn320_bk064_wm2_wn4_mc1.uses_flat_scratch, 1
	.set .Lbm064_bn320_bk064_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn320_bk064_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm064_bn320_bk064_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_4f12baaf4072f60a,@object ; @__hip_cuid_4f12baaf4072f60a
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_4f12baaf4072f60a
__hip_cuid_4f12baaf4072f60a:
	.byte	0                               ; 0x0
	.size	__hip_cuid_4f12baaf4072f60a, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_4f12baaf4072f60a
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn320_bk064_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn320_bk064_wm2_wn4_mc1.kd
