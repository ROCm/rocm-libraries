	...
	.section	.text.bm128_bn320_bk032_wm4_wn2_mc1,"axG",@progbits,bm128_bn320_bk032_wm4_wn2_mc1,comdat
	.protected	bm128_bn320_bk032_wm4_wn2_mc1 ; -- Begin function bm128_bn320_bk032_wm4_wn2_mc1
	.globl	bm128_bn320_bk032_wm4_wn2_mc1
	.p2align	8
	.type	bm128_bn320_bk032_wm4_wn2_mc1,@function
bm128_bn320_bk032_wm4_wn2_mc1: ; @bm128_bn320_bk032_wm4_wn2_mc1
; %bb.0:
...
; %bb.1:
	...
	s_or_b32 s2, s4, s2
.LBB0_2:
	v_sub_nc_u32_e32 v163, 0x87f, v0
	s_and_not1_b32 vcc_lo, exec_lo, s2
	s_cbranch_vccnz .LBB0_12
; %bb.3:
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_dual_lshrrev_b32 v2, 8, v163 :: v_dual_lshlrev_b32 v3, 2, v0
	s_mov_b32 s4, 0
	s_mov_b32 s10, 0
...
.LBB0_20:
	...
	v_dual_lshlrev_b32 v1, 4, v171 :: v_dual_mov_b32 v9, 0
	v_and_b32_e32 v162, 32, v0
	s_and_b32 s43, s35, s29
	s_mov_b32 s11, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v169, 0x60, v1
	v_mov_b32_e32 v8, v9
	...
	v_cndmask_b32_e64 v173, 0, 0xa0, vcc_lo
...
; %bb.21:
	v_dual_lshlrev_b32 v2, 5, v169 :: v_dual_lshlrev_b32 v4, 5, v0
	v_dual_lshlrev_b32 v1, 5, v173 :: v_dual_bitop2_b32 v3, 16, v0 bitop3:0x40
	...
	s_lshr_b32 s4, s4, 2
	v_add_nc_u32_e32 v12, 0x1200, v3
	v_and_b32_e32 v1, 0xd8, v5
	v_dual_lshrrev_b32 v4, 4, v6 :: v_dual_lshrrev_b32 v5, 4, v3
	...
	v_and_b32_e32 v5, 0x158, v5
	v_add_nc_u32_e32 v9, 0xc00, v3
	v_dual_mov_b32 v191, v165 :: v_dual_add_nc_u32 v10, 0xe00, v3
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_add_nc_u32 v166, v5, v3
	v_dual_add_nc_u32 v170, v4, v2 :: v_dual_mov_b32 v2, v165
	...
	v_dual_lshrrev_b32 v1, 4, v10 :: v_dual_add_nc_u32 v176, v6, v3
	v_dual_mov_b32 v6, v165 :: v_dual_lshrrev_b32 v10, 4, v11
	v_lshrrev_b32_e32 v11, 4, v12
	v_sub_nc_u32_e32 v12, 0x153f, v0
	s_add_co_i32 s4, s1, 0x9900
	v_and_b32_e32 v14, 0x3f8, v1
	s_and_b32 s10, s4, 15
	v_add_nc_u32_e32 v174, v5, v3
	v_dual_mov_b32 v5, v165 :: v_dual_lshrrev_b32 v1, 8, v12
	v_lshrrev_b32_e32 v168, 8, v163
	s_sub_co_i32 s7, 16, s10
	s_add_co_i32 s45, s1, 0x7700
	s_lshr_b32 s1, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_dual_add_nc_u32 v12, 1, v1 :: v_dual_add_nc_u32 v1, 2, v168
	s_cselect_b32 s1, s1, 0
	s_ashr_i32 s7, s12, 31
	s_lshl_b32 s10, s1, 2
	s_lshr_b32 s7, s7, 27
	v_dual_add_nc_u32 v172, v8, v3 :: v_dual_bitop2_b32 v175, 22, v12 bitop3:0x40
	...
	v_dual_add_nc_u32 v178, v7, v3 :: v_dual_bitop2_b32 v177, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_cmp_ne_u32_e64 s1, v12, v175
	v_add_nc_u32_e32 v180, v13, v3
	v_dual_add_nc_u32 v182, v9, v3 :: v_dual_add_nc_u32 v184, v14, v3
	v_dual_add_nc_u32 v186, v10, v3 :: v_dual_add_nc_u32 v188, v11, v3
	v_dual_mov_b32 v8, v165 :: v_dual_add_nc_u32 v179, 0xffffff00, v15
	v_dual_mov_b32 v7, v165 :: v_dual_lshlrev_b32 v190, 2, v15
	v_dual_mov_b32 v3, v165 :: v_dual_mov_b32 v9, v165
...
.LBB0_25:                               ;   in Loop: Header=BB0_26 Depth=2
	...
	v_cmp_eq_u32_e32 vcc_lo, s6, v177
...
; %bb.27:                               ;   in Loop: Header=BB0_26 Depth=2
	...
	v_lshl_add_u64 v[194:195], v[164:165], 2, s[14:15]
...
.LBB0_31:                               ;   Parent Loop BB0_23 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v164, v192 :: v_dual_add_nc_u32 v181, -2, v181
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	ds_load_b128 v[200:203], v164 offset:3072
	ds_load_b128 v[204:207], v164 offset:3088
	v_lshl_add_u32 v164, v174, 1, s2
	ds_load_b128 v[216:219], v164 offset:2048
	ds_load_b128 v[220:223], v164 offset:2064
	v_lshl_add_u32 v164, v172, 1, s2
	ds_load_b128 v[224:227], v164 offset:1024
	ds_load_b128 v[228:231], v164 offset:1040
	v_lshl_add_u32 v164, v180, 1, s2
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[26:33], v[208:215], v[200:207], v[26:33] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[34:41], v[208:215], v[216:223], v[34:41] matrix_a_reuse
	s_wait_dscnt 0x0
	...
	v_wmma_f32_16x16x32_bf16 v[138:145], v[192:199], v[216:223], v[138:145] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[130:137], v[192:199], v[200:207], v[130:137] matrix_a_reuse
	ds_load_b128 v[200:203], v164 offset:5120
	ds_load_b128 v[204:207], v164 offset:5136
	v_lshl_add_u32 v164, v178, 1, s2
	ds_load_b128 v[216:219], v164 offset:4096
	ds_load_b128 v[220:223], v164 offset:4112
	v_lshl_add_u32 v164, v182, 1, s2
	ds_load_b128 v[224:227], v164 offset:6144
	ds_load_b128 v[228:231], v164 offset:6160
	v_lshl_add_u32 v164, v184, 1, s2
	s_wait_dscnt 0x4
	...
	v_lshl_add_u32 v164, v186, 1, s2
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[18:25], v[208:215], v[216:223], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[122:129], v[192:199], v[216:223], v[122:129] matrix_a_reuse
	ds_load_b128 v[216:219], v164 offset:8192
	ds_load_b128 v[220:223], v164 offset:8208
	v_lshl_add_u32 v164, v188, 1, s2
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[66:73], v[208:215], v[216:223], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[208:215], v[224:231], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[106:113], v[192:199], v[224:231], v[106:113] matrix_a_reuse
	ds_load_b128 v[224:227], v164 offset:9216
	ds_load_b128 v[228:231], v164 offset:9232
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[50:57], v[192:199], v[224:231], v[50:57] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[208:215], v[224:231], v[82:89]
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(6) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(6) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[208:215], v[200:207], v[58:65] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[98:105], v[192:199], v[200:207], v[98:105] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[74:81], v[192:199], v[216:223], v[74:81] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(6) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v181, s13 :: v_dual_mov_b32 v192, s14
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v181, s5 :: v_dual_mov_b32 v192, s6
	s_bitset1_b32 s7, 31
	v_readfirstlane_b32 s52, v164
...
; %bb.47:
	...
	v_add_nc_u32_e32 v44, 0x1810, v1
	...
	v_add_nc_u32_e32 v44, 0x2010, v1
	...
	v_dual_add_nc_u32 v146, 16, v1 :: v_dual_lshrrev_b32 v140, 3, v148
	...
	v_and_b32_e32 v74, 0x1ff0, v99
	v_and_b32_e32 v75, 0x1ff0, v75
	v_lshlrev_b32_e32 v76, 1, v146
	v_and_b32_e32 v42, 0x1ff0, v51
	v_cvt_pk_bf16_f32 v38, v34, v35
	v_cvt_pk_bf16_f32 v33, v32, v33
	v_and_b32_e32 v35, 0x1ff0, v44
	v_cvt_pk_bf16_f32 v32, v30, v31
	v_cvt_pk_bf16_f32 v30, v26, v27
	v_dual_lshrrev_b32 v27, 3, v36 :: v_dual_add_nc_u32 v115, v90, v141
	v_cvt_pk_bf16_f32 v90, v106, v107
	v_and_b32_e32 v107, 0x1ff0, v110
	v_and_b32_e32 v43, 0x1ff0, v43
	v_dual_add_nc_u32 v130, v136, v141 :: v_dual_add_nc_u32 v122, v131, v141
	v_dual_add_nc_u32 v106, v112, v141 :: v_dual_add_nc_u32 v74, v74, v141
	v_dual_add_nc_u32 v50, v75, v76 :: v_dual_add_nc_u32 v42, v42, v76
	v_add_nc_u32_e32 v26, v35, v76
	v_cvt_pk_bf16_f32 v25, v24, v25
	v_cvt_pk_bf16_f32 v24, v22, v23
	v_cvt_pk_bf16_f32 v23, v20, v21
	v_cvt_pk_bf16_f32 v22, v18, v19
	v_and_b32_e32 v18, 0x1ff0, v27
	v_add_nc_u32_e32 v98, v107, v141
	v_add_nc_u32_e32 v34, v43, v76
	...
	ds_store_b128 v98, v[78:81] offset:32768
	...
	v_add_nc_u32_e32 v22, v18, v76
	v_add_nc_u32_e32 v18, 0x3810, v1
	v_add_nc_u32_e32 v20, 0x3010, v1
	v_cvt_pk_bf16_f32 v17, v16, v17
	v_cvt_pk_bf16_f32 v16, v14, v15
	v_cvt_pk_bf16_f32 v14, v10, v11
	v_lshrrev_b32_e32 v10, 3, v18
	v_add_nc_u32_e32 v11, 0x4010, v1
	v_add_nc_u32_e32 v1, 0x4810, v1
	v_dual_lshrrev_b32 v149, 3, v146 :: v_dual_lshrrev_b32 v19, 3, v20
	...
	ds_store_b128 v22, v[14:17] offset:20480
	ds_store_b128 v23, v[6:9] offset:24576
	ds_store_b128 v24, v[2:5] offset:28672
	ds_store_b128 v25, v[10:13] offset:32768
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn320_bk032_wm4_wn2_mc1, .Lfunc_end0-bm128_bn320_bk032_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn320_bk032_wm4_wn2_mc1
	...
	.section	.text.bm128_bn320_bk032_wm4_wn2_mc1,"axG",@progbits,bm128_bn320_bk032_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn320_bk032_wm4_wn2_mc1.num_vgpr, 232
	.set .Lbm128_bn320_bk032_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm128_bn320_bk032_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm128_bn320_bk032_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm128_bn320_bk032_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm128_bn320_bk032_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm128_bn320_bk032_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn320_bk032_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn320_bk032_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm128_bn320_bk032_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_8dc85a279484cc4e,@object ; @__hip_cuid_8dc85a279484cc4e
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_8dc85a279484cc4e
__hip_cuid_8dc85a279484cc4e:
	.byte	0                               ; 0x0
	.size	__hip_cuid_8dc85a279484cc4e, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_8dc85a279484cc4e
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn320_bk032_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn320_bk032_wm4_wn2_mc1.kd
