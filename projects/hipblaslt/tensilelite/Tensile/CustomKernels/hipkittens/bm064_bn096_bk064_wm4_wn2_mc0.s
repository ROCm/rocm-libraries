	...
	.section	.text.bm064_bn096_bk064_wm4_wn2_mc0,"axG",@progbits,bm064_bn096_bk064_wm4_wn2_mc0,comdat
	.protected	bm064_bn096_bk064_wm4_wn2_mc0 ; -- Begin function bm064_bn096_bk064_wm4_wn2_mc0
	.globl	bm064_bn096_bk064_wm4_wn2_mc0
	.p2align	8
	.type	bm064_bn096_bk064_wm4_wn2_mc0,@function
bm064_bn096_bk064_wm4_wn2_mc0: ; @bm064_bn096_bk064_wm4_wn2_mc0
; %bb.0:
...
; %bb.23:
	...
	v_dual_lshlrev_b32 v2, 6, v39 :: v_dual_lshlrev_b32 v3, 6, v37
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s0, 0x5500
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	v_and_or_b32 v4, 0x3c0, v4, v1
	s_mov_b32 s7, s5
	s_mov_b32 s43, s5
	s_and_b64 s[6:7], s[6:7], 15
	v_dual_mov_b32 v29, 0 :: v_dual_bitop2_b32 v1, v3, v4 bitop3:0x54
	s_sub_co_i32 s4, 16, s6
	s_mov_b32 s41, s1
	s_lshr_b32 s4, s4, 2
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_dual_lshrrev_b32 v5, 4, v1 :: v_dual_bitop2_b32 v6, v2, v4 bitop3:0x54
	...
	v_add_nc_u32_e32 v9, 0x420, v6
	s_add_co_i32 s4, s0, 0x7700
	v_add_nc_u32_e32 v10, 0x820, v6
	v_dual_add_nc_u32 v26, v5, v1 :: v_dual_lshrrev_b32 v1, 4, v6
	s_and_b32 s10, s4, 15
	s_add_co_i32 s42, s0, 0x5500
	s_sub_co_i32 s7, 16, s10
	v_add3_u32 v40, v4, v3, v5
	v_and_b32_e32 v11, 0xf8, v1
	s_lshr_b32 s0, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_lshrrev_b32_e32 v32, 8, v27
	v_add_nc_u32_e32 v8, 0x800, v6
	v_dual_mov_b32 v3, v29 :: v_dual_add_nc_u32 v30, v11, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v4, v29 :: v_dual_mov_b32 v27, v32
	v_dual_lshrrev_b32 v1, 4, v7 :: v_dual_lshrrev_b32 v7, 4, v8
	...
	s_lshl_b32 s10, s0, 2
	s_lshr_b32 s7, s7, 26
	v_dual_add_nc_u32 v36, v10, v6 :: v_dual_add_nc_u32 v38, v7, v6
	s_add_co_i32 s17, s17, s7
	v_dual_mov_b32 v6, v29 :: v_dual_lshrrev_b32 v34, 8, v1
	v_add_nc_u32_e32 v1, 2, v32
	...
	v_dual_add_nc_u32 v12, 2, v34 :: v_dual_bitop2_b32 v41, 30, v1 bitop3:0x40
	s_ashr_i32 s7, s6, 31
	s_ashr_i32 s5, s4, 31
	s_wait_kmcnt 0x0
	...
	v_dual_add_nc_u32 v31, -1, v34 :: v_dual_bitop2_b32 v43, 30, v12 bitop3:0x40
	v_dual_mov_b32 v5, v29 :: v_dual_add_nc_u32 v42, v11, v2
	v_mov_b32_e32 v7, v29
	v_add3_u32 v44, v2, v8, 0x400
	v_add3_u32 v46, v2, v9, 0x800
	v_dual_mov_b32 v2, v29 :: v_dual_mov_b32 v8, v29
	v_dual_mov_b32 v9, v29 :: v_dual_mov_b32 v18, v29
	...
	v_dual_mov_b32 v25, v29 :: v_dual_mov_b32 v10, v29
...
.LBB0_27:                               ;   in Loop: Header=BB0_28 Depth=2
	...
	v_cmp_eq_u32_e32 vcc_lo, s6, v41
...
; %bb.29:                               ;   in Loop: Header=BB0_28 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[50:51], v[28:29], 2, s[12:13]
	flat_store_b32 v[50:51], v29
...
.LBB0_33:                               ;   in Loop: Header=BB0_34 Depth=2
	...
	v_add_nc_u32_e32 v49, 0x200, v49
	v_cmp_eq_u32_e32 vcc_lo, s12, v43
	v_add_nc_u32_e32 v48, 0x200, v48
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
.LBB0_34:                               ;   Parent Loop BB0_25 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s12, v31
	v_cmpx_le_u32_e64 s12, v34
...
; %bb.43:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_dual_mov_b32 v45, s14 :: v_dual_mov_b32 v48, s12
	...
	v_readfirstlane_b32 s54, v48
	s_lshr_b64 s[14:15], s[2:3], 16
	v_readfirstlane_b32 s52, v28
	v_readfirstlane_b32 s55, v47
...
.LBB0_46:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_lshl_add_u32 v45, v30, 1, s2
	v_lshl_add_u32 v47, v44, 1, s2
	v_lshl_add_u32 v80, v46, 1, s2
	ds_load_b128 v[48:51], v28
	ds_load_b128 v[52:55], v28 offset:16
	v_lshl_add_u32 v28, v36, 1, s2
	ds_load_b128 v[56:59], v45
	ds_load_b128 v[60:63], v45 offset:16
	v_lshl_add_u32 v45, v42, 1, s2
	ds_load_b128 v[64:67], v28 offset:2048
	ds_load_b128 v[68:71], v28 offset:2064
	v_lshl_add_u32 v28, v38, 1, s2
	ds_load_b128 v[72:75], v28 offset:4096
	ds_load_b128 v[76:79], v28 offset:4112
	v_lshl_add_u32 v28, v40, 1, s0
	; sched_group_barrier mask(0x00000100) size(8) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[18:25], v[48:55], v[56:63], v[18:25]
	ds_load_b128 v[56:59], v28 offset:64
	ds_load_b128 v[60:63], v28 offset:80
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[2:9], v[48:55], v[64:71], v[2:9] matrix_a_reuse
	ds_load_b128 v[64:67], v45 offset:64
	ds_load_b128 v[68:71], v45 offset:80
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[10:17], v[48:55], v[72:79], v[10:17] matrix_a_reuse
	ds_load_b128 v[48:51], v47 offset:64
	ds_load_b128 v[52:55], v47 offset:80
	ds_load_b128 v[72:75], v80 offset:64
	ds_load_b128 v[76:79], v80 offset:80
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[18:25], v[56:63], v[64:71], v[18:25]
	; sched_group_barrier mask(0x00000100) size(8) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[56:63], v[48:55], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x0
...
; %bb.48:
	...
	v_dual_lshlrev_b32 v1, 1, v1 :: v_dual_lshrrev_b32 v3, 3, v4
	s_delay_alu instid0(VALU_DEP_2)
	v_lshrrev_b32_e32 v16, 3, v18
	v_cvt_pk_bf16_f32 v4, v14, v15
	v_and_b32_e32 v14, 0x1f0, v2
	v_cvt_pk_bf16_f32 v2, v10, v11
	v_and_b32_e32 v15, 0x3f0, v3
	v_and_b32_e32 v16, 0x3f0, v16
	v_cvt_pk_bf16_f32 v3, v12, v13
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v10, v14, v1 :: v_dual_add_nc_u32 v11, v15, v1
...
.LBB0_60:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn096_bk064_wm4_wn2_mc0, .Lfunc_end0-bm064_bn096_bk064_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn096_bk064_wm4_wn2_mc0
	...
	.section	.text.bm064_bn096_bk064_wm4_wn2_mc0,"axG",@progbits,bm064_bn096_bk064_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn096_bk064_wm4_wn2_mc0.num_vgpr, 81
	.set .Lbm064_bn096_bk064_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm064_bn096_bk064_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm064_bn096_bk064_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm064_bn096_bk064_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm064_bn096_bk064_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm064_bn096_bk064_wm4_wn2_mc0.uses_flat_scratch, 0
	.set .Lbm064_bn096_bk064_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn096_bk064_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm064_bn096_bk064_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_e285ccce19e6a0f2,@object ; @__hip_cuid_e285ccce19e6a0f2
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_e285ccce19e6a0f2
__hip_cuid_e285ccce19e6a0f2:
	.byte	0                               ; 0x0
	.size	__hip_cuid_e285ccce19e6a0f2, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_e285ccce19e6a0f2
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn096_bk064_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn096_bk064_wm4_wn2_mc0.kd
