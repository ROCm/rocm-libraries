	...
	.section	.text.bm128_bn096_bk064_wm4_wn2_mc0,"axG",@progbits,bm128_bn096_bk064_wm4_wn2_mc0,comdat
	.protected	bm128_bn096_bk064_wm4_wn2_mc0 ; -- Begin function bm128_bn096_bk064_wm4_wn2_mc0
	.globl	bm128_bn096_bk064_wm4_wn2_mc0
	.p2align	8
	.type	bm128_bn096_bk064_wm4_wn2_mc0,@function
bm128_bn096_bk064_wm4_wn2_mc0: ; @bm128_bn096_bk064_wm4_wn2_mc0
; %bb.0:
...
.LBB0_18:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 4, v57 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s40, s29, s25
	s_movk_i32 s16, 0x60
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v59, 0x60, v1
	v_cmp_ne_u32_e32 vcc_lo, 0, v2
	v_cndmask_b32_e64 v55, 0, 1, s40
	v_dual_mov_b32 v8, v9 :: v_dual_mov_b32 v7, v9
	v_dual_mov_b32 v6, v9 :: v_dual_mov_b32 v5, v9
	v_cndmask_b32_e64 v61, 0, 48, vcc_lo
...
; %bb.19:
	...
	v_dual_lshlrev_b32 v2, 6, v61 :: v_dual_lshlrev_b32 v3, 6, v59
	s_mov_b64 s[6:7], src_shared_base
	s_or_b32 s4, s0, 0x7700
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	v_and_or_b32 v4, 0x3c0, v4, v1
	s_mov_b32 s5, s7
	s_mov_b32 s43, s7
	s_and_b64 s[4:5], s[4:5], 15
	v_dual_mov_b32 v53, 0 :: v_dual_bitop2_b32 v5, v3, v4 bitop3:0x54
	...
	v_lshl_or_b32 v74, v0, 2, 0x4000
	v_dual_mov_b32 v75, v53 :: v_dual_add_nc_u32 v8, 0x400, v6
	v_and_b32_e32 v1, 0x1b8, v1
	v_dual_lshrrev_b32 v7, 4, v7 :: v_dual_bitop2_b32 v9, 32, v4 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_lshrrev_b32_e32 v8, 4, v8
	s_cselect_b32 s4, s6, 0
	v_dual_add_nc_u32 v50, v1, v5 :: v_dual_lshrrev_b32 v1, 4, v6
	s_delay_alu instid0(VALU_DEP_3)
	v_or_b32_e32 v11, v9, v3
	s_lshl2_add_u32 s0, s4, s0
	v_add_nc_u32_e32 v10, 0x800, v6
	v_and_b32_e32 v7, 0x1f8, v7
	v_and_b32_e32 v1, 0xf8, v1
	v_add_nc_u32_e32 v3, v4, v3
	s_add_co_i32 s6, s0, 0xbb00
	s_add_co_i32 s42, s0, 0x7700
	s_and_b32 s10, s6, 15
	v_add_nc_u32_e32 v54, v1, v6
	v_or_b32_e32 v1, v9, v2
	v_or_b32_e32 v9, 0x400, v11
	v_dual_lshrrev_b32 v11, 4, v11 :: v_dual_add_nc_u32 v58, v7, v5
	s_sub_co_i32 s5, 16, s10
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mov_b32 v5, v53 :: v_dual_lshrrev_b32 v9, 4, v9
	v_and_b32_e32 v11, 0x1b8, v11
	v_add_nc_u32_e32 v12, 0x400, v1
	v_add_nc_u32_e32 v13, 0x800, v1
	v_add_nc_u32_e32 v2, v4, v2
	v_and_b32_e32 v9, 0x1f8, v9
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_add_nc_u32 v64, v11, v3
	s_lshr_b32 s0, s5, 2
	s_cmp_lg_u64 s[10:11], 0
	s_delay_alu instid0(VALU_DEP_2)
	v_add3_u32 v66, v3, v9, 0x400
	v_dual_mov_b32 v3, v53 :: v_dual_lshrrev_b32 v10, 4, v10
	v_and_b32_e32 v14, 0xf8, v1
	v_dual_mov_b32 v4, v53 :: v_dual_sub_nc_u32 v1, 0xcbf, v0
	...
	v_dual_add_nc_u32 v51, -1, v56 :: v_dual_bitop2_b32 v63, 30, v15 bitop3:0x40
	v_dual_add_nc_u32 v60, v8, v6 :: v_dual_add_nc_u32 v62, v10, v6
	v_dual_add_nc_u32 v68, v14, v2 :: v_dual_mov_b32 v6, v53
	v_add3_u32 v70, v2, v12, 0x400
	v_add3_u32 v72, v2, v13, 0x800
	v_dual_mov_b32 v2, v53 :: v_dual_mov_b32 v7, v53
	v_dual_mov_b32 v8, v53 :: v_dual_mov_b32 v9, v53
	v_dual_mov_b32 v10, v53 :: v_dual_mov_b32 v11, v53
	v_dual_mov_b32 v12, v53 :: v_dual_mov_b32 v13, v53
	v_dual_mov_b32 v14, v53 :: v_dual_mov_b32 v15, v53
	v_dual_mov_b32 v16, v53 :: v_dual_mov_b32 v17, v53
	v_dual_mov_b32 v18, v53 :: v_dual_mov_b32 v19, v53
...
.LBB0_23:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_dual_mov_b32 v52, v76 :: v_dual_add_nc_u32 v67, -2, v67
...
.LBB0_28:                               ;   in Loop: Header=BB0_29 Depth=2
	...
	v_add_nc_u32_e32 v77, 0x200, v77
	v_cmp_eq_u32_e32 vcc_lo, s12, v63
	v_add_nc_u32_e32 v76, 0x200, v76
...
; %bb.30:                               ;   in Loop: Header=BB0_29 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[78:79], v[52:53], 2, s[6:7]
	flat_store_b32 v[78:79], v53
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v67, s14 :: v_dual_mov_b32 v76, s12
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v52, v50, 1, s0
	v_lshl_add_u32 v67, v58, 1, s0
	v_lshl_add_u32 v69, v54, 1, s2
	v_lshl_add_u32 v71, v70, 1, s2
	v_lshl_add_u32 v73, v72, 1, s2
	ds_load_b128 v[76:79], v52
	ds_load_b128 v[80:83], v52 offset:16
	v_lshl_add_u32 v52, v60, 1, s2
	ds_load_b128 v[84:87], v67 offset:2048
	ds_load_b128 v[88:91], v67 offset:2064
	ds_load_b128 v[92:95], v69
	v_lshl_add_u32 v67, v66, 1, s0
	ds_load_b128 v[100:103], v52 offset:2048
	ds_load_b128 v[104:107], v52 offset:2064
	v_lshl_add_u32 v52, v62, 1, s2
	...
	ds_load_b128 v[108:111], v73 offset:64
	ds_load_b128 v[112:115], v73 offset:80
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[42:49], v[76:83], v[84:91], v[42:49]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[76:83], v[92:99], v[34:41] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[76:83], v[108:115], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[100:107], v[108:115], v[26:33]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[100:107], v[92:99], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[100:107], v[84:91], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn096_bk064_wm4_wn2_mc0, .Lfunc_end0-bm128_bn096_bk064_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn096_bk064_wm4_wn2_mc0
	...
	.section	.text.bm128_bn096_bk064_wm4_wn2_mc0,"axG",@progbits,bm128_bn096_bk064_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn096_bk064_wm4_wn2_mc0.num_vgpr, 116
	.set .Lbm128_bn096_bk064_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm128_bn096_bk064_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm128_bn096_bk064_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm128_bn096_bk064_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm128_bn096_bk064_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm128_bn096_bk064_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn096_bk064_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn096_bk064_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm128_bn096_bk064_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_264c6adb05cb2d4f,@object ; @__hip_cuid_264c6adb05cb2d4f
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_264c6adb05cb2d4f
__hip_cuid_264c6adb05cb2d4f:
	.byte	0                               ; 0x0
	.size	__hip_cuid_264c6adb05cb2d4f, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_264c6adb05cb2d4f
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn096_bk064_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn096_bk064_wm4_wn2_mc0.kd
