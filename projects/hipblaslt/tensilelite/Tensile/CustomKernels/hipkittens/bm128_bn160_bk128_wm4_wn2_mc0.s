	...
	.section	.text.bm128_bn160_bk128_wm4_wn2_mc0,"axG",@progbits,bm128_bn160_bk128_wm4_wn2_mc0,comdat
	.protected	bm128_bn160_bk128_wm4_wn2_mc0 ; -- Begin function bm128_bn160_bk128_wm4_wn2_mc0
	.globl	bm128_bn160_bk128_wm4_wn2_mc0
	.p2align	8
	.type	bm128_bn160_bk128_wm4_wn2_mc0,@function
bm128_bn160_bk128_wm4_wn2_mc0: ; @bm128_bn160_bk128_wm4_wn2_mc0
; %bb.0:
...
.LBB0_14:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 4, v91 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s39, s3, s25
	s_mov_b32 s11, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v87, 0x60, v1
	v_cmp_ne_u32_e32 vcc_lo, 0, v2
	v_cndmask_b32_e64 v83, 0, 1, s39
	v_dual_mov_b32 v8, v9 :: v_dual_mov_b32 v7, v9
	v_dual_mov_b32 v6, v9 :: v_dual_mov_b32 v5, v9
	v_cndmask_b32_e64 v89, 0, 0x50, vcc_lo
...
; %bb.15:
	v_dual_lshlrev_b32 v3, 7, v0 :: v_dual_lshlrev_b32 v2, 7, v89
	v_lshlrev_b32_e32 v1, 7, v87
	s_mov_b64 s[4:5], src_shared_base
	s_add_co_i32 s6, s40, 0xaa00
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v3, 0x780, v3
	s_mov_b32 s7, s5
	s_mov_b32 s43, s5
	s_and_b64 s[6:7], s[6:7], 15
	v_or_b32_e32 v100, 0x2100, v0
	v_and_or_b32 v4, v0, 16, v3
	s_sub_co_i32 s4, 16, s6
	v_dual_mov_b32 v85, 0 :: v_dual_bitop2_b32 v3, v3, v1 bitop3:0x54
	s_lshr_b32 s4, s4, 2
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_2)
	v_or_b32_e32 v6, v2, v4
	v_or_b32_e32 v5, v1, v4
	s_cmp_lg_u64 s[6:7], 0
	v_sub_nc_u32_e32 v9, 0x2a7f, v0
	s_cselect_b32 s4, s4, 0
	...
	s_lshl_b32 s4, s30, 7
	v_add_nc_u32_e32 v88, v3, v6
	v_lshl_or_b32 v9, v93, 8, v0
	s_ashr_i32 s7, s6, 31
	s_ashr_i32 s5, s4, 31
	s_wait_kmcnt 0x0
	...
	v_cmp_ne_u32_e64 s0, v5, v93
	v_dual_add_nc_u32 v92, v7, v6 :: v_dual_lshlrev_b32 v96, 2, v9
	v_lshl_or_b32 v94, v0, 2, 0x8800
	v_dual_mov_b32 v4, v85 :: v_dual_add_nc_u32 v101, 0xffffff00, v9
	v_dual_mov_b32 v97, v85 :: v_dual_mov_b32 v3, v85
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v84, v98 :: v_dual_add_nc_u32 v102, -2, v102
	v_dual_mov_b32 v104, v99 :: v_dual_mov_b32 v105, v85
	v_add_nc_u32_e32 v99, 0x200, v99
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[106:107], v[84:85], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v102
	v_add_nc_u32_e32 v98, 0x200, v98
	v_lshl_add_u64 v[104:105], v[104:105], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[106:107], v85
...
.LBB0_22:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_cmp_lt_u32_e32 vcc_lo, 0x20ff, v84
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v99, s14 :: v_dual_mov_b32 v98, s12
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	ds_load_b128 v[118:121], v84 offset:4352
	ds_load_b128 v[122:125], v84 offset:4368
	ds_load_b128 v[126:129], v98 offset:4352
	...
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[26:33], v[118:125], v[110:117], v[26:33] matrix_a_reuse
	...
	v_wmma_f32_16x16x32_bf16 v[42:49], v[118:125], v[142:149], v[42:49]
	ds_load_b128 v[110:113], v98 offset:13056
	ds_load_b128 v[114:117], v98 offset:13072
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[50:57], v[102:109], v[110:117], v[50:57] matrix_a_reuse
	ds_load_b128 v[134:137], v98 offset:8704
	ds_load_b128 v[138:141], v98 offset:8720
	ds_load_b128 v[130:133], v98 offset:4368
	v_lshl_add_u32 v98, v90, 1, s6
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	ds_load_b128 v[150:153], v98 offset:64
	v_wmma_f32_16x16x32_bf16 v[2:9], v[118:125], v[110:117], v[2:9] matrix_a_reuse
	ds_load_b128 v[154:157], v98 offset:80
	ds_load_b128 v[110:113], v98 offset:4416
	ds_load_b128 v[114:117], v98 offset:4432
	ds_load_b128 v[158:161], v98 offset:8768
	ds_load_b128 v[162:165], v98 offset:8784
	ds_load_b128 v[166:169], v98 offset:13120
	ds_load_b128 v[170:173], v98 offset:13136
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[10:17], v[118:125], v[134:141], v[10:17] matrix_a_reuse
	ds_load_b128 v[174:177], v98 offset:17472
	ds_load_b128 v[178:181], v98 offset:17488
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[18:25], v[118:125], v[126:133], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[102:109], v[126:133], v[66:73] matrix_a_reuse
	ds_load_b128 v[126:129], v84 offset:64
	ds_load_b128 v[130:133], v84 offset:80
	v_wmma_f32_16x16x32_bf16 v[58:65], v[102:109], v[134:141], v[58:65] matrix_a_reuse
	ds_load_b128 v[134:137], v84 offset:4416
	ds_load_b128 v[138:141], v84 offset:4432
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v84, v92, 1, s5
	ds_load_b128 v[102:105], v98 offset:128
	ds_load_b128 v[106:109], v98 offset:144
	ds_load_b128 v[182:185], v98 offset:4480
	ds_load_b128 v[118:121], v84 offset:128
	ds_load_b128 v[122:125], v84 offset:144
	ds_load_b128 v[142:145], v84 offset:4480
	ds_load_b128 v[146:149], v84 offset:4496
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[74:81], v[126:133], v[150:157], v[74:81]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[66:73], v[126:133], v[110:117], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[126:133], v[158:165], v[58:65] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[126:133], v[166:173], v[50:57] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[126:133], v[174:181], v[34:41] matrix_a_reuse
	ds_load_b128 v[186:189], v98 offset:4496
	ds_load_b128 v[126:129], v98 offset:8832
	ds_load_b128 v[130:133], v98 offset:8848
	ds_load_b128 v[190:193], v98 offset:13184
	ds_load_b128 v[194:197], v98 offset:13200
	ds_load_b128 v[198:201], v98 offset:17536
	ds_load_b128 v[202:205], v98 offset:17552
	s_wait_dscnt 0xe
	v_wmma_f32_16x16x32_bf16 v[42:49], v[134:141], v[174:181], v[42:49]
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	...
	v_wmma_f32_16x16x32_bf16 v[18:25], v[134:141], v[110:117], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[134:141], v[150:157], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[110:113], v84 offset:192
	ds_load_b128 v[114:117], v84 offset:208
	ds_load_b128 v[134:137], v84 offset:4544
	ds_load_b128 v[138:141], v84 offset:4560
	ds_load_b128 v[150:153], v98 offset:192
	ds_load_b128 v[154:157], v98 offset:208
	ds_load_b128 v[158:161], v98 offset:4544
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[74:81], v[118:125], v[102:109], v[74:81]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0xd
	v_wmma_f32_16x16x32_bf16 v[66:73], v[118:125], v[182:189], v[66:73] matrix_a_reuse
	s_wait_dscnt 0xb
	v_wmma_f32_16x16x32_bf16 v[58:65], v[118:125], v[126:133], v[58:65] matrix_a_reuse
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[50:57], v[118:125], v[190:197], v[50:57] matrix_a_reuse
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[34:41], v[118:125], v[198:205], v[34:41] matrix_a_reuse
	ds_load_b128 v[162:165], v98 offset:4560
	ds_load_b128 v[118:121], v98 offset:8896
	ds_load_b128 v[122:125], v98 offset:8912
	ds_load_b128 v[166:169], v98 offset:13248
	ds_load_b128 v[170:173], v98 offset:13264
	ds_load_b128 v[174:177], v98 offset:17600
	ds_load_b128 v[178:181], v98 offset:17616
	v_wmma_f32_16x16x32_bf16 v[42:49], v[142:149], v[198:205], v[42:49]
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[142:149], v[190:197], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[142:149], v[126:133], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[142:149], v[182:189], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[142:149], v[102:109], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[74:81], v[110:117], v[150:157], v[74:81]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[66:73], v[110:117], v[158:165], v[66:73] matrix_a_reuse
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[58:65], v[110:117], v[118:125], v[58:65] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[50:57], v[110:117], v[166:173], v[50:57] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[110:117], v[174:181], v[34:41] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[134:141], v[174:181], v[42:49]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[134:141], v[166:173], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[134:141], v[118:125], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[134:141], v[158:165], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[134:141], v[150:157], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
...
; %bb.38:
	...
	v_add_nc_u32_e32 v52, 0x810, v1
	v_add_nc_u32_e32 v67, 0x2000, v1
	v_cvt_pk_bf16_f32 v33, v32, v33
	v_cvt_pk_bf16_f32 v32, v30, v31
	v_cvt_pk_bf16_f32 v30, v26, v27
	v_add_nc_u32_e32 v27, 0x1010, v1
	v_cvt_pk_bf16_f32 v31, v28, v29
	v_add_nc_u32_e32 v29, 0x1810, v1
	v_add_nc_u32_e32 v1, 0x2010, v1
	v_lshrrev_b32_e32 v58, 3, v58
	ds_store_b128 v59, v[78:81]
	ds_store_b128 v60, v[70:73] offset:4096
	v_dual_add_nc_u32 v59, v61, v66 :: v_dual_lshrrev_b32 v61, 3, v68
	v_cvt_pk_bf16_f32 v41, v40, v41
	v_cvt_pk_bf16_f32 v40, v38, v39
	v_cvt_pk_bf16_f32 v38, v34, v35
	v_dual_lshrrev_b32 v35, 3, v52 :: v_dual_lshrrev_b32 v67, 3, v67
	...
	v_and_b32_e32 v51, 0x7f0, v61
	v_and_b32_e32 v26, 0xff0, v35
	v_lshlrev_b32_e32 v28, 1, v68
	v_and_b32_e32 v60, 0xff0, v67
	v_and_b32_e32 v27, 0xff0, v27
	v_cvt_pk_bf16_f32 v22, v18, v19
	v_and_b32_e32 v19, 0xff0, v20
	v_and_b32_e32 v1, 0xff0, v1
	v_dual_add_nc_u32 v58, v58, v66 :: v_dual_add_nc_u32 v34, v51, v66
	v_dual_add_nc_u32 v26, v26, v28 :: v_dual_add_nc_u32 v50, v60, v66
	...
	ds_store_b128 v58, v[62:65] offset:8192
	ds_store_b128 v59, v[54:57] offset:12288
	ds_store_b128 v50, v[38:41] offset:16384
	ds_store_b128 v34, v[30:33] offset:32
	ds_store_b128 v26, v[22:25] offset:4096
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn160_bk128_wm4_wn2_mc0, .Lfunc_end0-bm128_bn160_bk128_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn160_bk128_wm4_wn2_mc0
	...
	.section	.text.bm128_bn160_bk128_wm4_wn2_mc0,"axG",@progbits,bm128_bn160_bk128_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn160_bk128_wm4_wn2_mc0.num_vgpr, 206
	.set .Lbm128_bn160_bk128_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm128_bn160_bk128_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm128_bn160_bk128_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm128_bn160_bk128_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm128_bn160_bk128_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm128_bn160_bk128_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn160_bk128_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn160_bk128_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm128_bn160_bk128_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_7976c172d229bf16,@object ; @__hip_cuid_7976c172d229bf16
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_7976c172d229bf16
__hip_cuid_7976c172d229bf16:
	.byte	0                               ; 0x0
	.size	__hip_cuid_7976c172d229bf16, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_7976c172d229bf16
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn160_bk128_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn160_bk128_wm4_wn2_mc0.kd
