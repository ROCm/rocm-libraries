	...
	.section	.text.bm256_bn064_bk128_wm2_wn4_mc0,"axG",@progbits,bm256_bn064_bk128_wm2_wn4_mc0,comdat
	.protected	bm256_bn064_bk128_wm2_wn4_mc0 ; -- Begin function bm256_bn064_bk128_wm2_wn4_mc0
	.globl	bm256_bn064_bk128_wm2_wn4_mc0
	.p2align	8
	.type	bm256_bn064_bk128_wm2_wn4_mc0,@function
bm256_bn064_bk128_wm2_wn4_mc0: ; @bm256_bn064_bk128_wm2_wn4_mc0
; %bb.0:
...
; %bb.3:
	...
	v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v3, v68
	s_mov_b32 s7, 0
	v_mov_b32_e32 v4, v1
...
; %bb.15:
	...
	s_lshl2_add_u32 s2, s0, s30
	v_or_b32_e32 v1, v4, v3
	s_add_co_i32 s0, s2, 0x15400
	s_add_co_i32 s41, s2, 0x4400
	s_and_b32 s6, s0, 15
	...
	v_dual_mov_b32 v77, v69 :: v_dual_add_nc_u32 v70, v7, v5
	v_or_b32_e32 v1, 0x100, v0
	v_add3_u32 v72, v4, v3, v6
	v_add3_u32 v74, v4, v2, v7
	v_or_b32_e32 v82, 0x4300, v0
	v_or_b32_e32 v76, 0x11000, v68
	v_or_b32_e32 v83, 0xf00, v0
	v_or_b32_e32 v78, 0x4000, v68
	v_dual_mov_b32 v79, v69 :: v_dual_mov_b32 v2, v69
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v68, v80 :: v_dual_add_nc_u32 v84, -2, v84
	v_dual_mov_b32 v86, v81 :: v_dual_mov_b32 v87, v69
	v_add_nc_u32_e32 v81, 0x200, v81
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[88:89], v[68:69], 2, s[2:3]
	v_cmp_eq_u32_e32 vcc_lo, 0, v84
	v_add_nc_u32_e32 v80, 0x200, v80
	v_lshl_add_u64 v[86:87], v[86:87], 2, s[2:3]
	s_clause 0x1
	flat_store_b32 v[88:89], v69
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[80:81], s[2:3], v[76:77]
...
.LBB0_22:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_cmp_lt_u32_e32 vcc_lo, 0x42ff, v68
...
; %bb.26:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[80:81], s[2:3], v[78:79]
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v81, s10 :: v_dual_mov_b32 v80, s8
...
.LBB0_35:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_and_b32 s3, s3, 0x1ffffff
	v_dual_mov_b32 v81, s1 :: v_dual_mov_b32 v80, s2
	s_bitset1_b32 s3, 31
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_lshl_add_u32 v80, v70, 1, s2
	ds_load_b128 v[84:87], v68
	ds_load_b128 v[88:91], v68 offset:16
	ds_load_b128 v[92:95], v68 offset:4352
	ds_load_b128 v[96:99], v68 offset:4368
	ds_load_b128 v[100:103], v68 offset:8704
	ds_load_b128 v[104:107], v68 offset:8720
	ds_load_b128 v[108:111], v68 offset:13056
	ds_load_b128 v[112:115], v68 offset:13072
	ds_load_b128 v[116:119], v68 offset:17408
	ds_load_b128 v[128:131], v80
	ds_load_b128 v[132:135], v80 offset:16
	v_lshl_add_u32 v80, v74, 1, s2
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[84:91], v[128:135], v[58:65]
	ds_load_b128 v[176:179], v80 offset:64
	ds_load_b128 v[180:183], v80 offset:80
	v_wmma_f32_16x16x32_bf16 v[50:57], v[92:99], v[128:135], v[50:57] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[100:107], v[128:135], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[108:115], v[128:135], v[26:33] matrix_b_reuse
	ds_load_b128 v[120:123], v68 offset:30464
	ds_load_b128 v[124:127], v68 offset:30480
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[120:127], v[128:135], v[34:41] matrix_b_reuse
	ds_load_b128 v[120:123], v68 offset:26112
	ds_load_b128 v[124:127], v68 offset:26128
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[120:127], v[128:135], v[2:9] matrix_b_reuse
	ds_load_b128 v[120:123], v68 offset:21760
	ds_load_b128 v[124:127], v68 offset:21776
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[120:127], v[128:135], v[10:17] matrix_b_reuse
	ds_load_b128 v[120:123], v68 offset:17424
	v_lshl_add_u32 v68, v72, 1, s1
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	ds_load_b128 v[136:139], v68 offset:4416
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[18:25], v[116:123], v[128:135], v[18:25] matrix_b_reuse
	ds_load_b128 v[116:119], v68 offset:64
	ds_load_b128 v[120:123], v68 offset:80
	ds_load_b128 v[140:143], v68 offset:4432
	ds_load_b128 v[84:87], v68 offset:8768
	ds_load_b128 v[88:91], v68 offset:8784
	ds_load_b128 v[144:147], v68 offset:13120
	ds_load_b128 v[148:151], v68 offset:13136
	ds_load_b128 v[152:155], v68 offset:17472
	ds_load_b128 v[156:159], v68 offset:17488
	ds_load_b128 v[92:95], v68 offset:21824
	ds_load_b128 v[96:99], v68 offset:21840
	ds_load_b128 v[160:163], v68 offset:26176
	ds_load_b128 v[164:167], v68 offset:26192
	ds_load_b128 v[168:171], v68 offset:30528
	ds_load_b128 v[172:175], v68 offset:30544
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[100:103], v68 offset:128
	ds_load_b128 v[104:107], v68 offset:144
	ds_load_b128 v[108:111], v68 offset:4480
	ds_load_b128 v[112:115], v68 offset:4496
	ds_load_b128 v[124:127], v68 offset:8832
	ds_load_b128 v[128:131], v68 offset:8848
	ds_load_b128 v[184:187], v68 offset:13184
	ds_load_b128 v[188:191], v68 offset:13200
	ds_load_b128 v[132:135], v68 offset:17536
	s_wait_dscnt 0x16
	v_wmma_f32_16x16x32_bf16 v[58:65], v[116:123], v[176:183], v[58:65]
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0x15
	v_wmma_f32_16x16x32_bf16 v[50:57], v[136:143], v[176:183], v[50:57] matrix_b_reuse
	s_wait_dscnt 0x13
	v_wmma_f32_16x16x32_bf16 v[42:49], v[84:91], v[176:183], v[42:49] matrix_b_reuse
	s_wait_dscnt 0x11
	v_wmma_f32_16x16x32_bf16 v[26:33], v[144:151], v[176:183], v[26:33] matrix_b_reuse
	ds_load_b128 v[136:139], v68 offset:17552
	ds_load_b128 v[84:87], v68 offset:21888
	ds_load_b128 v[88:91], v68 offset:21904
	ds_load_b128 v[116:119], v68 offset:26240
	ds_load_b128 v[120:123], v68 offset:26256
	ds_load_b128 v[140:143], v68 offset:30592
	ds_load_b128 v[144:147], v68 offset:30608
	ds_load_b128 v[192:195], v80 offset:128
	ds_load_b128 v[196:199], v80 offset:144
	s_wait_dscnt 0x18
	v_wmma_f32_16x16x32_bf16 v[18:25], v[152:159], v[176:183], v[18:25] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0x16
	v_wmma_f32_16x16x32_bf16 v[10:17], v[92:99], v[176:183], v[10:17] matrix_b_reuse
	s_wait_dscnt 0x14
	v_wmma_f32_16x16x32_bf16 v[2:9], v[160:167], v[176:183], v[2:9] matrix_b_reuse
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[34:41], v[168:175], v[176:183], v[34:41] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[92:95], v68 offset:192
	ds_load_b128 v[96:99], v68 offset:208
	ds_load_b128 v[148:151], v68 offset:4544
	ds_load_b128 v[152:155], v68 offset:4560
	ds_load_b128 v[156:159], v68 offset:8896
	ds_load_b128 v[160:163], v68 offset:8912
	ds_load_b128 v[164:167], v68 offset:13248
	ds_load_b128 v[168:171], v68 offset:13264
	ds_load_b128 v[172:175], v68 offset:17600
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[58:65], v[100:107], v[192:199], v[58:65]
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[108:115], v[192:199], v[50:57] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[124:131], v[192:199], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[184:191], v[192:199], v[26:33] matrix_b_reuse
	ds_load_b128 v[176:179], v68 offset:17616
	ds_load_b128 v[100:103], v68 offset:21952
	ds_load_b128 v[104:107], v68 offset:21968
	ds_load_b128 v[108:111], v68 offset:26304
	ds_load_b128 v[112:115], v68 offset:26320
	ds_load_b128 v[124:127], v68 offset:30656
	ds_load_b128 v[128:131], v68 offset:30672
	ds_load_b128 v[180:183], v80 offset:192
	ds_load_b128 v[184:187], v80 offset:208
	v_wmma_f32_16x16x32_bf16 v[18:25], v[132:139], v[192:199], v[18:25] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[84:91], v[192:199], v[10:17] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[116:123], v[192:199], v[2:9] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[140:147], v[192:199], v[34:41] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[92:99], v[180:187], v[58:65]
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[148:155], v[180:187], v[50:57] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[156:163], v[180:187], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[164:171], v[180:187], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[172:179], v[180:187], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[100:107], v[180:187], v[10:17] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[108:115], v[180:187], v[2:9] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[124:131], v[180:187], v[34:41] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn064_bk128_wm2_wn4_mc0, .Lfunc_end0-bm256_bn064_bk128_wm2_wn4_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn064_bk128_wm2_wn4_mc0
	...
	.section	.text.bm256_bn064_bk128_wm2_wn4_mc0,"axG",@progbits,bm256_bn064_bk128_wm2_wn4_mc0,comdat
                                        ; -- End function
	.set .Lbm256_bn064_bk128_wm2_wn4_mc0.num_vgpr, 200
	.set .Lbm256_bn064_bk128_wm2_wn4_mc0.num_agpr, 0
	.set .Lbm256_bn064_bk128_wm2_wn4_mc0.numbered_sgpr, 56
	.set .Lbm256_bn064_bk128_wm2_wn4_mc0.num_named_barrier, 0
	.set .Lbm256_bn064_bk128_wm2_wn4_mc0.private_seg_size, 0
	.set .Lbm256_bn064_bk128_wm2_wn4_mc0.uses_vcc, 1
	.set .Lbm256_bn064_bk128_wm2_wn4_mc0.uses_flat_scratch, 1
	.set .Lbm256_bn064_bk128_wm2_wn4_mc0.has_dyn_sized_stack, 0
	.set .Lbm256_bn064_bk128_wm2_wn4_mc0.has_recursion, 0
	.set .Lbm256_bn064_bk128_wm2_wn4_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_1f014e0b777e4c6b,@object ; @__hip_cuid_1f014e0b777e4c6b
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_1f014e0b777e4c6b
__hip_cuid_1f014e0b777e4c6b:
	.byte	0                               ; 0x0
	.size	__hip_cuid_1f014e0b777e4c6b, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_1f014e0b777e4c6b
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn064_bk128_wm2_wn4_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn064_bk128_wm2_wn4_mc0.kd
