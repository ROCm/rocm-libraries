	...
	.section	.text.bm064_bn256_bk064_wm2_wn4_mc0,"axG",@progbits,bm064_bn256_bk064_wm2_wn4_mc0,comdat
	.protected	bm064_bn256_bk064_wm2_wn4_mc0 ; -- Begin function bm064_bn256_bk064_wm2_wn4_mc0
	.globl	bm064_bn256_bk064_wm2_wn4_mc0
	.p2align	8
	.type	bm064_bn256_bk064_wm2_wn4_mc0,@function
bm064_bn256_bk064_wm2_wn4_mc0: ; @bm064_bn256_bk064_wm2_wn4_mc0
; %bb.0:
...
; %bb.19:
	...
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_bitop2_b32 v7, v2, v4 bitop3:0x54
	v_lshrrev_b32_e32 v1, 4, v5
	s_add_co_i32 s4, s6, 0xcc00
	s_add_co_i32 s42, s6, 0xaa00
	v_or_b32_e32 v8, 0x400, v7
	v_or_b32_e32 v10, 0x800, v7
	v_and_b32_e32 v1, 0xb8, v1
	s_and_b32 s10, s4, 15
	v_or_b32_e32 v11, 0xc00, v7
	v_dual_lshrrev_b32 v8, 4, v8 :: v_dual_bitop2_b32 v12, v9, v3 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_nc_u32 v66, v1, v5 :: v_dual_lshrrev_b32 v1, 4, v7
	...
	s_lshl_b32 s10, s6, 2
	s_lshr_b32 s7, s7, 26
	v_dual_add_nc_u32 v70, v1, v7 :: v_dual_lshrrev_b32 v1, 4, v10
	v_dual_lshrrev_b32 v10, 4, v11 :: v_dual_lshrrev_b32 v11, 4, v12
	s_add_co_i32 s17, s17, s7
	s_add_nc_u64 s[34:35], s[4:5], s[10:11]
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v13, 0x3b8, v1
	...
	v_or_b32_e32 v14, 0x800, v9
	v_or_b32_e32 v15, 0xc00, v9
	...
	v_dual_add_nc_u32 v76, v8, v7 :: v_dual_add_nc_u32 v78, v13, v7
	v_dual_add_nc_u32 v82, v11, v3 :: v_dual_add_nc_u32 v86, v9, v2
	v_add3_u32 v84, v3, v16, 0x400
	v_add3_u32 v88, v2, v12, 0x400
	v_add3_u32 v90, v2, v14, 0x800
	v_add3_u32 v92, v2, v15, 0xc00
	v_or_b32_e32 v81, 0x2100, v0
	v_lshl_or_b32 v94, v0, 2, 0x8800
	v_dual_mov_b32 v95, v69 :: v_dual_mov_b32 v2, v69
...
; %bb.25:                               ;   in Loop: Header=BB0_24 Depth=2
	...
	v_lshl_add_u64 v[98:99], v[68:69], 2, s[12:13]
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v68, v96 :: v_dual_add_nc_u32 v83, -2, v83
	v_dual_mov_b32 v98, v97 :: v_dual_mov_b32 v99, v69
	v_add_nc_u32_e32 v97, 0x200, v97
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[100:101], v[68:69], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v83
	v_add_nc_u32_e32 v96, 0x200, v96
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[100:101], v69
	flat_store_b32 v[98:99], v69
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v83, s14 :: v_dual_mov_b32 v96, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_dual_mov_b32 v83, s5 :: v_dual_mov_b32 v96, s6
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v85, v76, 1, s2
	v_lshl_add_u32 v87, v88, 1, s2
	v_lshl_add_u32 v89, v90, 1, s2
	ds_load_b128 v[96:99], v68
	ds_load_b128 v[100:103], v68 offset:16
	v_lshl_add_u32 v68, v70, 1, s2
	ds_load_b128 v[104:107], v83 offset:2048
	ds_load_b128 v[108:111], v83 offset:2064
	v_lshl_add_u32 v83, v84, 1, s0
	v_lshl_add_u32 v91, v92, 1, s2
	ds_load_b128 v[120:123], v68
	ds_load_b128 v[124:127], v68 offset:16
	v_lshl_add_u32 v68, v78, 1, s2
	ds_load_b128 v[136:139], v83 offset:64
	ds_load_b128 v[140:143], v83 offset:80
	ds_load_b128 v[144:147], v87 offset:64
	ds_load_b128 v[148:151], v87 offset:80
	ds_load_b128 v[152:155], v89 offset:64
	ds_load_b128 v[156:159], v89 offset:80
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[26:33], v[104:111], v[120:127], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[96:103], v[120:127], v[58:65]
	ds_load_b128 v[120:123], v68 offset:4096
	ds_load_b128 v[124:127], v68 offset:4112
	v_lshl_add_u32 v68, v80, 1, s2
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[96:103], v[120:127], v[42:49] matrix_a_reuse
	ds_load_b128 v[112:115], v85 offset:2048
	ds_load_b128 v[116:119], v85 offset:2064
	v_lshl_add_u32 v85, v86, 1, s2
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[104:111], v[112:119], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[96:103], v[112:119], v[50:57] matrix_a_reuse
	ds_load_b128 v[116:119], v68 offset:6160
	ds_load_b128 v[112:115], v68 offset:6144
	v_lshl_add_u32 v68, v82, 1, s0
	ds_load_b128 v[128:131], v68 offset:64
	ds_load_b128 v[132:135], v68 offset:80
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[18:25], v[96:103], v[112:119], v[18:25] matrix_a_reuse
	...
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[104:111], v[120:127], v[2:9] matrix_a_reuse
	ds_load_b128 v[120:123], v91 offset:64
	ds_load_b128 v[124:127], v91 offset:80
	v_wmma_f32_16x16x32_bf16 v[34:41], v[104:111], v[112:119], v[34:41]
	ds_load_b128 v[104:107], v85 offset:64
	ds_load_b128 v[108:111], v85 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[128:135], v[104:111], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[128:135], v[144:151], v[50:57] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[128:135], v[152:159], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[128:135], v[120:127], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[136:143], v[120:127], v[34:41]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[136:143], v[152:159], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[136:143], v[144:151], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[136:143], v[104:111], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn256_bk064_wm2_wn4_mc0, .Lfunc_end0-bm064_bn256_bk064_wm2_wn4_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn256_bk064_wm2_wn4_mc0
	...
	.section	.text.bm064_bn256_bk064_wm2_wn4_mc0,"axG",@progbits,bm064_bn256_bk064_wm2_wn4_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn256_bk064_wm2_wn4_mc0.num_vgpr, 160
	.set .Lbm064_bn256_bk064_wm2_wn4_mc0.num_agpr, 0
	.set .Lbm064_bn256_bk064_wm2_wn4_mc0.numbered_sgpr, 56
	.set .Lbm064_bn256_bk064_wm2_wn4_mc0.num_named_barrier, 0
	.set .Lbm064_bn256_bk064_wm2_wn4_mc0.private_seg_size, 0
	.set .Lbm064_bn256_bk064_wm2_wn4_mc0.uses_vcc, 1
	.set .Lbm064_bn256_bk064_wm2_wn4_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn256_bk064_wm2_wn4_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn256_bk064_wm2_wn4_mc0.has_recursion, 0
	.set .Lbm064_bn256_bk064_wm2_wn4_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_1074606529a24493,@object ; @__hip_cuid_1074606529a24493
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_1074606529a24493
__hip_cuid_1074606529a24493:
	.byte	0                               ; 0x0
	.size	__hip_cuid_1074606529a24493, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_1074606529a24493
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn256_bk064_wm2_wn4_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn256_bk064_wm2_wn4_mc0.kd
