	...
	.section	.text.bm128_bn160_bk096_wm4_wn2_mc1,"axG",@progbits,bm128_bn160_bk096_wm4_wn2_mc1,comdat
	.protected	bm128_bn160_bk096_wm4_wn2_mc1 ; -- Begin function bm128_bn160_bk096_wm4_wn2_mc1
	.globl	bm128_bn160_bk096_wm4_wn2_mc1
	.p2align	8
	.type	bm128_bn160_bk096_wm4_wn2_mc1,@function
bm128_bn160_bk096_wm4_wn2_mc1: ; @bm128_bn160_bk096_wm4_wn2_mc1
; %bb.0:
...
.LBB0_16:
	...
	v_dual_lshlrev_b32 v1, 4, v89 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	v_mov_b32_e32 v9, 0
	...
	v_cndmask_b32_e64 v91, 0, 0x50, vcc_lo
...
; %bb.17:
	...
	v_dual_add_nc_u32 v86, v4, v28 :: v_dual_bitop2_b32 v12, 32, v5 bitop3:0x54
	v_dual_lshrrev_b32 v8, 4, v8 :: v_dual_lshrrev_b32 v10, 4, v2
	v_add_nc_u32_e32 v4, 0x1200, v28
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v6, v6, v13 :: v_dual_bitop2_b32 v14, v3, v12 bitop3:0x54
	v_and_b32_e32 v15, 0x3f8, v8
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v19, 0x3f8, v10
	v_lshrrev_b32_e32 v10, 4, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_bitop2_b32 v12, v1, v12 bitop3:0x54
	v_mad_u32_u24 v8, 0x60, v7, v14
	v_add_nc_u32_e32 v14, v14, v9
	v_and_b32_e32 v21, 0x3f8, v10
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mad_u32_u24 v10, 0x60, v7, v12
	v_dual_lshrrev_b32 v8, 4, v8 :: v_dual_bitop2_b32 v5, 64, v5 bitop3:0x54
	v_and_b32_e32 v23, 0x3f8, v6
	v_lshrrev_b32_e32 v6, 4, v14
	s_delay_alu instid0(VALU_DEP_4)
	v_lshrrev_b32_e32 v16, 4, v10
	v_add_nc_u32_e32 v14, 0xc00, v10
	v_and_b32_e32 v26, 0x7f8, v8
	v_add_nc_u32_e32 v8, v12, v9
	v_add_nc_u32_e32 v10, 0x1200, v10
	v_or_b32_e32 v3, v3, v5
	v_and_b32_e32 v84, 0x7f8, v6
	v_and_b32_e32 v27, 0x3f8, v16
	v_dual_lshrrev_b32 v6, 4, v8 :: v_dual_lshrrev_b32 v8, 4, v14
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_mad_u32_u24 v14, 0x60, v7, v3
	v_dual_add_nc_u32 v12, v12, v13 :: v_dual_add_nc_u32 v94, v21, v28
	v_add_nc_u32_e32 v96, v23, v28
	v_and_b32_e32 v6, 0x3f8, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v14, 4, v14 :: v_dual_bitop2_b32 v1, v1, v5 bitop3:0x54
	v_dual_lshrrev_b32 v5, 4, v12 :: v_dual_add_nc_u32 v3, v3, v9
	v_and_b32_e32 v8, 0x7f8, v8
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v29, 0x7f8, v14
	v_mad_u32_u24 v7, 0x60, v7, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_and_b32_e32 v12, 0x3f8, v5
	v_dual_add_nc_u32 v5, v1, v9 :: v_dual_lshrrev_b32 v3, 4, v3
	v_dual_add_nc_u32 v1, v1, v13 :: v_dual_lshrrev_b32 v9, 4, v7
	v_add_nc_u32_e32 v88, v11, v17
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshrrev_b32_e32 v5, 4, v5
	v_and_b32_e32 v14, 0x7f8, v3
	v_add_nc_u32_e32 v3, 0xc00, v7
	v_add_nc_u32_e32 v7, 0x1200, v7
	v_lshrrev_b32_e32 v1, 4, v1
	v_and_b32_e32 v16, 0x3f8, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v90, v15, v28 :: v_dual_lshrrev_b32 v3, 4, v3
	...
	v_sub_nc_u32_e32 v3, 0x1fdf, v0
	v_and_b32_e32 v20, 0x7f8, v5
	v_dual_lshrrev_b32 v5, 8, v7 :: v_dual_add_nc_u32 v92, v19, v28
	v_dual_add_nc_u32 v98, v26, v17 :: v_dual_add_nc_u32 v102, v27, v28
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_dual_lshrrev_b32 v1, 8, v3 :: v_dual_add_nc_u32 v3, 1, v5
	v_dual_mov_b32 v7, v85 :: v_dual_mov_b32 v9, v85
	v_dual_mov_b32 v11, v85 :: v_dual_add_nc_u32 v5, 1, v1
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v93, 26, v3
	v_add_nc_u64_e32 v[100:101], v[84:85], v[24:25]
	v_dual_mov_b32 v13, v85 :: v_dual_add_nc_u32 v84, 0x600, v28
	v_add_nc_u32_e32 v26, 0x1800, v28
	v_and_b32_e32 v95, 62, v5
	v_cmp_ne_u32_e64 s1, v3, v93
	v_dual_mov_b32 v3, v85 :: v_dual_lshrrev_b32 v10, 4, v10
	v_dual_mov_b32 v27, v85 :: v_dual_mov_b32 v15, v85
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_cmp_ne_u32_e64 s2, v5, v95
	v_mov_b32_e32 v5, v85
	v_and_b32_e32 v10, 0x7f8, v10
	v_dual_add_nc_u32 v112, v29, v17 :: v_dual_add_nc_u32 v116, v30, v28
	v_dual_mov_b32 v17, v85 :: v_dual_mov_b32 v19, v85
	v_dual_mov_b32 v21, v85 :: v_dual_mov_b32 v23, v85
	v_lshl_or_b32 v31, v93, 8, v0
	v_lshl_or_b32 v32, v95, 8, v0
	v_add_nc_u64_e32 v[104:105], v[6:7], v[84:85]
	v_add_nc_u64_e32 v[106:107], v[8:9], v[2:3]
	v_add_nc_u64_e32 v[108:109], v[10:11], v[4:5]
	v_add_nc_u64_e32 v[110:111], v[12:13], v[26:27]
	v_add_nc_u64_e32 v[114:115], v[14:15], v[24:25]
	v_add_nc_u64_e32 v[118:119], v[16:17], v[84:85]
	v_add_nc_u64_e32 v[120:121], v[18:19], v[2:3]
	v_add_nc_u64_e32 v[122:123], v[20:21], v[4:5]
	v_add_nc_u64_e32 v[124:125], v[22:23], v[26:27]
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v10, v85 :: v_dual_add_nc_u32 v97, 0xffffff00, v31
	v_dual_mov_b32 v127, v85 :: v_dual_lshlrev_b32 v126, 2, v31
	v_dual_mov_b32 v12, v85 :: v_dual_add_nc_u32 v99, 0xffffff00, v32
	v_dual_mov_b32 v129, v85 :: v_dual_lshlrev_b32 v128, 2, v32
	v_dual_mov_b32 v2, v85 :: v_dual_mov_b32 v4, v85
	v_dual_mov_b32 v6, v85 :: v_dual_mov_b32 v8, v85
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_lshl_add_u32 v105, v104, 1, s5
	v_lshl_add_u32 v107, v106, 1, s5
	...
	v_lshl_add_u32 v84, v112, 1, s6
	v_lshl_add_u32 v101, v114, 1, s6
	v_lshl_add_u32 v103, v116, 1, s5
	v_lshl_add_u32 v105, v118, 1, s5
	...
	v_lshl_add_u32 v84, v120, 1, s5
	v_lshl_add_u32 v101, v122, 1, s5
	v_lshl_add_u32 v103, v124, 1, s5
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn160_bk096_wm4_wn2_mc1, .Lfunc_end0-bm128_bn160_bk096_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn160_bk096_wm4_wn2_mc1
	...
	.section	.text.bm128_bn160_bk096_wm4_wn2_mc1,"axG",@progbits,bm128_bn160_bk096_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn160_bk096_wm4_wn2_mc1.num_vgpr, 234
	.set .Lbm128_bn160_bk096_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm128_bn160_bk096_wm4_wn2_mc1.numbered_sgpr, 60
	.set .Lbm128_bn160_bk096_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm128_bn160_bk096_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm128_bn160_bk096_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm128_bn160_bk096_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn160_bk096_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn160_bk096_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm128_bn160_bk096_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_72931317fbf03ce6,@object ; @__hip_cuid_72931317fbf03ce6
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_72931317fbf03ce6
__hip_cuid_72931317fbf03ce6:
	.byte	0                               ; 0x0
	.size	__hip_cuid_72931317fbf03ce6, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_72931317fbf03ce6
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn160_bk096_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     62
    .sgpr_spill_count: 0
    .symbol:         bm128_bn160_bk096_wm4_wn2_mc1.kd
