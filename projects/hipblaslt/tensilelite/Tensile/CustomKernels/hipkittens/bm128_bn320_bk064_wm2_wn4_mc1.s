	...
	.section	.text.bm128_bn320_bk064_wm2_wn4_mc1,"axG",@progbits,bm128_bn320_bk064_wm2_wn4_mc1,comdat
	.protected	bm128_bn320_bk064_wm2_wn4_mc1 ; -- Begin function bm128_bn320_bk064_wm2_wn4_mc1
	.globl	bm128_bn320_bk064_wm2_wn4_mc1
	.p2align	8
	.type	bm128_bn320_bk064_wm2_wn4_mc1,@function
bm128_bn320_bk064_wm2_wn4_mc1: ; @bm128_bn320_bk064_wm2_wn4_mc1
; %bb.0:
...
.LBB0_16:
	...
	v_dual_lshlrev_b32 v1, 4, v171 :: v_dual_bitop2_b32 v169, 3, v171 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s3, s42, s29
	s_and_not1_b32 vcc_lo, exec_lo, s13
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v167, 64, v1
...
; %bb.17:
	v_mul_u32_u24_e32 v1, 0x1400, v169
	v_dual_lshlrev_b32 v2, 6, v167 :: v_dual_bitop2_b32 v3, 16, v0 bitop3:0x40
	...
	v_lshl_or_b32 v200, v0, 2, 0x4000
	...
	v_add_nc_u32_e32 v13, 0x1000, v6
	s_lshl2_add_u32 s1, s4, s1
	v_dual_add_nc_u32 v162, v5, v4 :: v_dual_lshrrev_b32 v5, 4, v7
	...
	v_dual_add_nc_u32 v168, v5, v4 :: v_dual_bitop2_b32 v14, v12, v2 bitop3:0x54
	v_dual_add_nc_u32 v170, v7, v4 :: v_dual_add_nc_u32 v172, v8, v4
	v_dual_add_nc_u32 v2, v3, v2 :: v_dual_mov_b32 v4, v165
	...
	v_dual_lshrrev_b32 v15, 4, v15 :: v_dual_bitop2_b32 v1, v12, v1 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_lshrrev_b32 v12, 4, v16 :: v_dual_lshrrev_b32 v16, 4, v17
	v_add_nc_u32_e32 v9, 0x400, v6
	v_dual_mov_b32 v201, v165 :: v_dual_add_nc_u32 v10, 0x800, v6
	v_and_b32_e32 v14, 0x138, v14
	v_and_b32_e32 v15, 0x1f8, v15
	v_and_b32_e32 v12, 0x1f8, v12
	v_and_b32_e32 v16, 0x1f8, v16
	v_lshrrev_b32_e32 v10, 4, v10
	v_sub_nc_u32_e32 v21, 0x2a7f, v0
	v_add_nc_u32_e32 v182, v14, v2
	v_add3_u32 v184, v2, v15, 0x400
	v_add3_u32 v186, v2, v12, 0x800
	v_add3_u32 v188, v2, v16, 0xc00
	v_dual_mov_b32 v2, v165 :: v_dual_lshrrev_b32 v9, 4, v9
	s_add_co_i32 s4, s1, 0x13200
	v_and_b32_e32 v10, 0x7f8, v10
	s_and_b32 s10, s4, 15
	v_dual_mov_b32 v12, v165 :: v_dual_lshrrev_b32 v21, 8, v21
	s_sub_co_i32 s7, 16, s10
	s_add_co_i32 s45, s1, 0xee00
	s_lshr_b32 s1, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_and_b32_e32 v11, 0x7f8, v11
	v_dual_mov_b32 v203, v165 :: v_dual_add_nc_u32 v18, 0x400, v1
	v_lshrrev_b32_e32 v17, 4, v1
	v_dual_mov_b32 v8, v165 :: v_dual_add_nc_u32 v19, 0x800, v1
	v_dual_mov_b32 v3, v165 :: v_dual_add_nc_u32 v20, 0xc00, v1
	v_add_nc_u32_e32 v1, 0x1000, v1
	v_dual_add_nc_u32 v176, v10, v6 :: v_dual_add_nc_u32 v21, 1, v21
	v_add_nc_u32_e32 v178, v11, v6
	...
	v_dual_lshrrev_b32 v18, 4, v18 :: v_dual_lshrrev_b32 v19, 4, v19
	v_dual_lshrrev_b32 v20, 4, v20 :: v_dual_bitop2_b32 v173, 46, v21 bitop3:0x40
	s_delay_alu instid0(VALU_DEP_3)
	v_add_nc_u32_e32 v180, v13, v6
	v_dual_mov_b32 v10, v165 :: v_dual_lshrrev_b32 v1, 4, v1
	v_add_nc_u32_e32 v174, v9, v6
	s_lshl_b32 s10, s1, 2
	...
	v_and_b32_e32 v22, 0x7f8, v1
	s_wait_kmcnt 0x0
	s_bfe_i64 s[20:21], s[20:21], 0x200000
	v_lshl_or_b32 v23, v173, 8, v0
	...
	v_cmp_ne_u32_e64 s1, v21, v173
	v_add_nc_u32_e32 v190, v17, v6
	v_add3_u32 v192, v6, v18, 0x400
	v_add3_u32 v194, v6, v19, 0x800
	v_add3_u32 v196, v6, v20, 0xc00
	v_add3_u32 v198, v6, v22, 0x1000
	v_dual_mov_b32 v14, v165 :: v_dual_add_nc_u32 v177, 0xffffff00, v23
	v_dual_mov_b32 v5, v165 :: v_dual_lshlrev_b32 v202, 2, v23
	v_dual_mov_b32 v7, v165 :: v_dual_mov_b32 v6, v165
	v_dual_mov_b32 v9, v165 :: v_dual_mov_b32 v11, v165
	v_dual_mov_b32 v13, v165 :: v_dual_mov_b32 v15, v165
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_wmma_f32_16x16x32_bf16 v[90:97], v[212:219], v[252:259], v[90:97] matrix_a_reuse
	s_set_vgpr_msb 64                       ;  msbs: dst=1 src0=0 src1=0 src2=0
	...
	v_wmma_f32_16x16x32_bf16 v[82:89], v[212:219], v[244:251], v[82:89]
	; sched_group_barrier mask(0x00000008) size(10) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[220:227], v[244:251], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[74:81], v[228:235], v[244:251], v[74:81]
	ds_load_b128 v[244:247], v164 offset:64
	ds_load_b128 v[248:251], v164 offset:80
	v_lshl_add_u32 v164, v194, 1, s6
	v_wmma_f32_16x16x32_bf16 v[42:49], v[220:227], v[252:259], v[42:49] matrix_a_reuse
	...
	s_set_vgpr_msb 0x400                    ;  msbs: dst=0 src0=0 src1=0 src2=0
	v_wmma_f32_16x16x32_bf16 v[66:73], v[220:227], v[236:243], v[66:73]
	...
	v_wmma_f32_16x16x32_bf16 v[26:33], v[228:235], v[236:243], v[26:33] matrix_a_reuse
	...
	v_wmma_f32_16x16x32_bf16 v[82:89], v[220:227], v[36:43] /*v[292:299]*/, v[82:89]
	v_wmma_f32_16x16x32_bf16 v[90:97], v[220:227], v[28:35] /*v[284:291]*/, v[90:97] matrix_a_reuse
	...
	; sched_group_barrier mask(0x00000008) size(10) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[66:73], v[228:235], v[252:259], v[66:73]
	s_set_vgpr_msb 4                        ;  msbs: dst=0 src0=0 src1=1 src2=0
	...
	v_wmma_f32_16x16x32_bf16 v[42:49], v[228:235], v[28:35] /*v[284:291]*/, v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[228:235], v[36:43] /*v[292:299]*/, v[34:41] matrix_a_reuse
	...
	s_set_vgpr_msb 0x400                    ;  msbs: dst=0 src0=0 src1=0 src2=0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[244:251], v[252:259], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(10) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.38:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_dual_mov_b32 v179, s13 :: v_dual_mov_b32 v204, s14
...
; %bb.42:
	v_mul_u32_u24_e32 v1, 0x50, v169
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn320_bk064_wm2_wn4_mc1, .Lfunc_end0-bm128_bn320_bk064_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn320_bk064_wm2_wn4_mc1
	...
	.section	.text.bm128_bn320_bk064_wm2_wn4_mc1,"axG",@progbits,bm128_bn320_bk064_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn320_bk064_wm2_wn4_mc1.num_vgpr, 300
	.set .Lbm128_bn320_bk064_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm128_bn320_bk064_wm2_wn4_mc1.numbered_sgpr, 60
	.set .Lbm128_bn320_bk064_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm128_bn320_bk064_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm128_bn320_bk064_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm128_bn320_bk064_wm2_wn4_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn320_bk064_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn320_bk064_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm128_bn320_bk064_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_77db25986e64269e,@object ; @__hip_cuid_77db25986e64269e
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_77db25986e64269e
__hip_cuid_77db25986e64269e:
	.byte	0                               ; 0x0
	.size	__hip_cuid_77db25986e64269e, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_77db25986e64269e
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn320_bk064_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     62
    .sgpr_spill_count: 0
    .symbol:         bm128_bn320_bk064_wm2_wn4_mc1.kd
