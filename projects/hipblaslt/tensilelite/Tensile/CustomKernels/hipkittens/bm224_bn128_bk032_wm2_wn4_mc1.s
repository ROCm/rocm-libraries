	...
	.section	.text.bm224_bn128_bk032_wm2_wn4_mc1,"axG",@progbits,bm224_bn128_bk032_wm2_wn4_mc1,comdat
	.protected	bm224_bn128_bk032_wm2_wn4_mc1 ; -- Begin function bm224_bn128_bk032_wm2_wn4_mc1
	.globl	bm224_bn128_bk032_wm2_wn4_mc1
	.p2align	8
	.type	bm224_bn128_bk032_wm2_wn4_mc1,@function
bm224_bn128_bk032_wm2_wn4_mc1: ; @bm224_bn128_bk032_wm2_wn4_mc1
; %bb.0:
...
; %bb.1:
	...
	s_or_b32 s2, s4, s2
.LBB0_2:
	v_sub_nc_u32_e32 v115, 0xedf, v0
	s_and_not1_b32 vcc_lo, exec_lo, s2
	s_cbranch_vccnz .LBB0_16
; %bb.3:
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_dual_lshrrev_b32 v2, 8, v115 :: v_dual_lshlrev_b32 v3, 2, v0
	s_mov_b32 s4, 0
	s_mov_b32 s5, 0
...
.LBB0_24:
	s_or_b32 exec_lo, exec_lo, s4
	v_dual_mov_b32 v9, 0 :: v_dual_lshrrev_b32 v125, 7, v0
	s_and_b32 s43, s41, s29
	s_and_not1_b32 vcc_lo, exec_lo, s13
	v_cndmask_b32_e64 v121, 0, 1, s43
	s_delay_alu instid0(VALU_DEP_2)
	...
	v_dual_mov_b32 v106, v9 :: v_dual_mov_b32 v49, v9
...
; %bb.25:
	v_dual_lshlrev_b32 v1, 5, v0 :: v_dual_bitop2_b32 v3, 16, v0 bitop3:0x40
	v_mul_u32_u24_e32 v2, 0xe00, v125
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s16, 0x5d80
	s_delay_alu instid0(VALU_DEP_2)
	...
	v_dual_mov_b32 v117, 0 :: v_dual_add_nc_u32 v6, 0x400, v2
	v_add_nc_u32_e32 v5, 0x200, v2
	v_dual_lshrrev_b32 v3, 4, v2 :: v_dual_bitop2_b32 v1, v0, v1 bitop3:0x54
	...
	v_and_or_b32 v4, 0xc10, v1, v4
	v_and_b32_e32 v6, 0x1f8, v6
	v_add_nc_u32_e32 v1, 0x800, v2
	s_cselect_b32 s4, s4, 0
	v_add_nc_u32_e32 v8, 0xc00, v2
	v_or_b32_e32 v10, 0x200, v4
	v_dual_add_nc_u32 v126, v6, v2 :: v_dual_mov_b32 v6, v117
	v_dual_lshrrev_b32 v9, 4, v4 :: v_dual_lshrrev_b32 v1, 4, v1
	s_lshl2_add_u32 s6, s4, s16
	v_and_b32_e32 v5, 0x1f8, v5
	s_add_co_i32 s4, s6, 0x9900
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v9, 0xd8, v9
	v_lshrrev_b32_e32 v10, 4, v10
	s_and_b32 s10, s4, 15
	s_add_co_i32 s45, s6, 0x5d80
	s_sub_co_i32 s7, 16, s10
	v_add_nc_u32_e32 v118, v9, v4
	v_and_b32_e32 v9, 0xf8, v10
	s_lshr_b32 s6, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_and_b32_e32 v11, 0x1f8, v1
	s_cselect_b32 s6, s6, 0
	v_add_nc_u32_e32 v136, v9, v4
	v_dual_mov_b32 v4, v117 :: v_dual_add_nc_u32 v114, v3, v2
	v_lshrrev_b32_e32 v3, 4, v7
	s_ashr_i32 s7, s12, 31
	v_add_nc_u32_e32 v7, 0xa00, v2
	v_sub_nc_u32_e32 v1, 0x87f, v0
	v_lshrrev_b32_e32 v120, 8, v115
	v_and_b32_e32 v3, 0x1f8, v3
	s_lshr_b32 s7, s7, 27
	s_lshl_b32 s10, s6, 2
	s_add_co_i32 s12, s12, s7
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_mov_b32 v9, v117 :: v_dual_add_nc_u32 v128, v3, v2
	v_dual_mov_b32 v3, v117 :: v_dual_lshrrev_b32 v8, 4, v8
	s_ashr_i32 s47, s12, 5
	v_lshrrev_b32_e32 v122, 8, v1
	s_cmp_lt_i32 s3, 0x80
	v_add_nc_u32_e32 v1, 2, v120
	v_and_b32_e32 v8, 0x1f8, v8
	v_add_nc_u32_e32 v130, v11, v2
	s_cselect_b32 s48, -1, 0
	s_lshl_b32 s6, s0, 7
	s_wait_kmcnt 0x0
	s_bfe_i64 s[20:21], s[20:21], 0x200000
	v_dual_add_nc_u32 v134, v8, v2 :: v_dual_mov_b32 v8, v117
	v_lshrrev_b32_e32 v7, 4, v7
	s_ashr_i32 s7, s6, 31
	v_add_nc_u32_e32 v10, 2, v122
	s_ashr_i32 s19, s18, 31
	...
	v_dual_add_nc_u32 v124, v5, v2 :: v_dual_bitop2_b32 v127, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v5, v117 :: v_dual_bitop2_b32 v129, 30, v10 bitop3:0x40
	v_dual_mov_b32 v7, v117 :: v_dual_add_nc_u32 v132, v7, v2
	v_dual_mov_b32 v2, v117 :: v_dual_mov_b32 v10, v117
	v_dual_mov_b32 v11, v117 :: v_dual_mov_b32 v12, v117
	v_dual_mov_b32 v13, v117 :: v_dual_mov_b32 v14, v117
	v_dual_mov_b32 v15, v117 :: v_dual_mov_b32 v16, v117
	v_dual_mov_b32 v17, v117 :: v_dual_mov_b32 v18, v117
	v_dual_mov_b32 v19, v117 :: v_dual_mov_b32 v20, v117
	v_dual_mov_b32 v21, v117 :: v_dual_mov_b32 v22, v117
	v_dual_mov_b32 v23, v117 :: v_dual_mov_b32 v24, v117
	v_dual_mov_b32 v25, v117 :: v_dual_mov_b32 v26, v117
	v_dual_mov_b32 v27, v117 :: v_dual_mov_b32 v28, v117
	v_dual_mov_b32 v29, v117 :: v_dual_mov_b32 v30, v117
	v_dual_mov_b32 v31, v117 :: v_dual_mov_b32 v32, v117
	v_dual_mov_b32 v33, v117 :: v_dual_mov_b32 v34, v117
	v_dual_mov_b32 v35, v117 :: v_dual_mov_b32 v36, v117
	v_dual_mov_b32 v37, v117 :: v_dual_mov_b32 v38, v117
	v_dual_mov_b32 v39, v117 :: v_dual_mov_b32 v40, v117
	v_dual_mov_b32 v41, v117 :: v_dual_mov_b32 v66, v117
	...
	v_dual_mov_b32 v113, v117 :: v_dual_mov_b32 v42, v117
	...
	v_dual_mov_b32 v57, v117 :: v_dual_mov_b32 v58, v117
	...
	v_dual_mov_b32 v65, v117 :: v_dual_add_nc_u32 v115, -1, v120
...
.LBB0_29:                               ;   in Loop: Header=BB0_30 Depth=2
	...
	v_cmp_eq_u32_e32 vcc_lo, s13, v127
...
.LBB0_30:                               ;   Parent Loop BB0_27 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s13, v115
	v_cmpx_le_u32_e64 s13, v120
	s_cbranch_execz .LBB0_32
; %bb.31:                               ;   in Loop: Header=BB0_30 Depth=2
	v_mov_b32_e32 v116, v138
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[140:141], v[116:117], 2, s[6:7]
	flat_store_b32 v[140:141], v117
...
.LBB0_35:                               ;   in Loop: Header=BB0_36 Depth=2
	...
	v_add_nc_u32_e32 v139, 0x200, v139
	v_cmp_eq_u32_e32 vcc_lo, s6, v129
	v_add_nc_u32_e32 v138, 0x200, v138
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
.LBB0_36:                               ;   Parent Loop BB0_27 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s19, v119
	v_cmpx_le_u32_e64 s18, v122
	s_cbranch_execz .LBB0_38
; %bb.37:                               ;   in Loop: Header=BB0_36 Depth=2
	v_mov_b32_e32 v116, v138
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[140:141], v[116:117], 2, s[14:15]
	flat_store_b32 v[140:141], v117
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_lshl_add_u32 v116, v114, 1, s1
	v_lshl_add_u32 v131, v124, 1, s1
	v_lshl_add_u32 v133, v126, 1, s1
	v_lshl_add_u32 v135, v136, 1, s2
	ds_load_b128 v[138:141], v116
	ds_load_b128 v[142:145], v116 offset:16
	v_lshl_add_u32 v116, v128, 1, s1
	ds_load_b128 v[146:149], v131 offset:1024
	ds_load_b128 v[150:153], v131 offset:1040
	v_lshl_add_u32 v131, v130, 1, s1
	ds_load_b128 v[154:157], v133 offset:2048
	ds_load_b128 v[162:165], v116 offset:3072
	ds_load_b128 v[166:169], v116 offset:3088
	v_lshl_add_u32 v116, v134, 1, s1
	ds_load_b128 v[158:161], v133 offset:2064
	ds_load_b128 v[170:173], v131 offset:4096
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	ds_load_b128 v[186:189], v116 offset:6144
	ds_load_b128 v[190:193], v116 offset:6160
	v_lshl_add_u32 v116, v132, 1, s1
	ds_load_b128 v[194:197], v116 offset:5120
	ds_load_b128 v[198:201], v116 offset:5136
	v_lshl_add_u32 v116, v118, 1, s2
	ds_load_b128 v[202:205], v116
	ds_load_b128 v[206:209], v116 offset:16
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[90:97], v[146:153], v[202:209], v[90:97] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[74:81], v[154:161], v[202:209], v[74:81] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[162:169], v[202:209], v[34:41] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[194:201], v[202:209], v[2:9] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[186:193], v[202:209], v[50:57] matrix_b_reuse
	ds_load_b128 v[174:177], v131 offset:4112
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[170:177], v[202:209], v[18:25] matrix_b_reuse
	ds_load_b128 v[178:181], v135 offset:1024
	ds_load_b128 v[182:185], v135 offset:1040
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[162:169], v[178:185], v[26:33] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[154:161], v[178:185], v[66:73] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[146:153], v[178:185], v[82:89] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[98:105], v[138:145], v[178:185], v[98:105] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[186:193], v[178:185], v[58:65] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[194:201], v[178:185], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[106:113], v[138:145], v[202:209], v[106:113]
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[170:177], v[178:185], v[10:17] matrix_b_reuse
...
; %bb.48:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_dual_mov_b32 v131, s13 :: v_dual_mov_b32 v138, s14
...
.LBB0_50:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v131, s5 :: v_dual_mov_b32 v138, s6
...
; %bb.52:
	v_mul_u32_u24_e32 v1, 0x70, v125
	v_lshrrev_b32_e32 v114, 1, v0
	v_and_b32_e32 v115, 0x6f, v0
	...
	ds_store_b128 v66, v[38:41] offset:96
	ds_store_b128 v34, v[30:33] offset:96
	ds_store_b128 v26, v[22:25] offset:128
	v_add_nc_u32_e32 v22, v18, v98
	v_add_nc_u32_e32 v18, 0xe50, v1
	v_add_nc_u32_e32 v20, 0x50, v1
	...
	v_cvt_pk_bf16_f32 v21, v64, v65
	v_cvt_pk_bf16_f32 v20, v62, v63
	v_cvt_pk_bf16_f32 v19, v60, v61
	v_cvt_pk_bf16_f32 v18, v58, v59
	ds_store_b128 v22, v[14:17] offset:128
	ds_store_b128 v23, v[6:9] offset:160
	ds_store_b128 v24, v[2:5] offset:160
	ds_store_b128 v25, v[10:13] offset:192
	ds_store_b128 v1, v[18:21] offset:192
.LBB0_53:
...
.LBB0_64:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm224_bn128_bk032_wm2_wn4_mc1, .Lfunc_end0-bm224_bn128_bk032_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm224_bn128_bk032_wm2_wn4_mc1
		.amdhsa_group_segment_fixed_size 60928
	...
	.section	.text.bm224_bn128_bk032_wm2_wn4_mc1,"axG",@progbits,bm224_bn128_bk032_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm224_bn128_bk032_wm2_wn4_mc1.num_vgpr, 210
	.set .Lbm224_bn128_bk032_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm224_bn128_bk032_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm224_bn128_bk032_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm224_bn128_bk032_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm224_bn128_bk032_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm224_bn128_bk032_wm2_wn4_mc1.uses_flat_scratch, 0
	.set .Lbm224_bn128_bk032_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm224_bn128_bk032_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm224_bn128_bk032_wm2_wn4_mc1.has_indirect_call, 0
...
; FloatMode: 240
; IeeeMode: 1
; LDSByteSize: 60928 bytes/workgroup (compile time only)
; SGPRBlocks: 0
; VGPRBlocks: 13
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_2663e7cf790861bc,@object ; @__hip_cuid_2663e7cf790861bc
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_2663e7cf790861bc
__hip_cuid_2663e7cf790861bc:
	.byte	0                               ; 0x0
	.size	__hip_cuid_2663e7cf790861bc, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_2663e7cf790861bc
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .cluster_dims:
      ...
      - 1
    .gfx1250_revision: B0
    .group_segment_fixed_size: 60928
    ...
    .name:           bm224_bn128_bk032_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm224_bn128_bk032_wm2_wn4_mc1.kd
