	...
	.section	.text.bm128_bn064_bk032_wm4_wn2_mc0,"axG",@progbits,bm128_bn064_bk032_wm4_wn2_mc0,comdat
	.protected	bm128_bn064_bk032_wm4_wn2_mc0 ; -- Begin function bm128_bn064_bk032_wm4_wn2_mc0
	.globl	bm128_bn064_bk032_wm4_wn2_mc0
	.p2align	8
	.type	bm128_bn064_bk032_wm4_wn2_mc0,@function
bm128_bn064_bk032_wm4_wn2_mc0: ; @bm128_bn064_bk032_wm4_wn2_mc0
; %bb.0:
...
.LBB0_22:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 4, v41 :: v_dual_mov_b32 v25, 0
	s_and_b32 s40, s29, s25
	s_and_not1_b32 vcc_lo, exec_lo, s16
	v_cndmask_b32_e64 v43, 0, 1, s40
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v45, 0x60, v1
...
; %bb.23:
	...
	v_dual_lshlrev_b32 v1, 5, v0 :: v_dual_lshlrev_b32 v2, 5, v45
	...
	v_and_or_b32 v3, 0x410, v4, v1
	s_lshl2_add_u32 s6, s4, s35
	s_mov_b32 s43, s5
	s_add_co_i32 s4, s6, 0x5500
	...
	v_dual_mov_b32 v37, 0 :: v_dual_add_nc_u32 v34, v1, v2
	v_sub_nc_u32_e32 v1, 0x43f, v0
	s_lshr_b32 s7, s7, 27
	s_lshl_b32 s10, s6, 2
	s_add_co_i32 s17, s17, s7
	v_dual_lshrrev_b32 v4, 4, v4 :: v_dual_lshrrev_b32 v6, 4, v6
	s_ashr_i32 s44, s17, 5
	v_mov_b32_e32 v18, v37
	v_dual_add_nc_u32 v38, v5, v3 :: v_dual_lshrrev_b32 v42, 8, v1
	...
	v_dual_add_nc_u32 v6, 2, v42 :: v_dual_add_nc_u32 v1, 2, v40
	...
	v_dual_mov_b32 v39, v42 :: v_dual_bitop2_b32 v47, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v46, v5, v3 :: v_dual_bitop2_b32 v50, 14, v6 bitop3:0x40
	v_dual_mov_b32 v19, v37 :: v_dual_add_nc_u32 v44, v4, v2
...
; %bb.29:                               ;   in Loop: Header=BB0_28 Depth=2
	...
	v_lshl_add_u64 v[52:53], v[36:37], 2, s[12:13]
	flat_store_b32 v[52:53], v37
...
.LBB0_33:                               ;   in Loop: Header=BB0_34 Depth=2
	...
	s_add_co_i32 s6, s6, 2
	v_add_nc_u32_e32 v49, 0x200, v49
	v_cmp_eq_u32_e32 vcc_lo, s6, v50
	v_add_nc_u32_e32 v48, 0x200, v48
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
; %bb.43:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v49, s14 :: v_dual_mov_b32 v48, s12
...
.LBB0_46:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_lshl_add_u32 v48, v46, 1, s2
	v_lshl_add_u32 v49, v44, 1, s0
	ds_load_b128 v[52:55], v36
	ds_load_b128 v[56:59], v36 offset:16
	ds_load_b128 v[60:63], v48 offset:1024
	ds_load_b128 v[64:67], v48 offset:1040
	v_lshl_add_u32 v36, v38, 1, s2
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[52:59], v[60:67], v[26:33] matrix_a_reuse
	ds_load_b128 v[68:71], v49 offset:1024
	ds_load_b128 v[72:75], v49 offset:1040
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[68:75], v[60:67], v[10:17]
	ds_load_b128 v[60:63], v36
	ds_load_b128 v[64:67], v36 offset:16
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[52:59], v[60:67], v[18:25]
...
; %bb.48:
	...
	v_dual_lshlrev_b32 v1, 1, v1 :: v_dual_lshrrev_b32 v4, 3, v26
	v_dual_lshrrev_b32 v5, 3, v27 :: v_dual_lshrrev_b32 v6, 3, v28
	v_lshrrev_b32_e32 v27, 3, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_and_b32_e32 v4, 0x3f0, v4
	v_and_b32_e32 v5, 0x3f0, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v28, 0x7f0, v6
	v_add_nc_u32_e32 v27, v27, v1
	v_cvt_pk_bf16_f32 v6, v2, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v29, v4, v1 :: v_dual_add_nc_u32 v1, v5, v1
	v_lshl_add_u32 v26, v26, 1, v28
	...
	ds_store_b128 v26, v[2:5] offset:32
.LBB0_49:
...
.LBB0_60:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn064_bk032_wm4_wn2_mc0, .Lfunc_end0-bm128_bn064_bk032_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn064_bk032_wm4_wn2_mc0
	...
	.section	.text.bm128_bn064_bk032_wm4_wn2_mc0,"axG",@progbits,bm128_bn064_bk032_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn064_bk032_wm4_wn2_mc0.num_vgpr, 76
	.set .Lbm128_bn064_bk032_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm128_bn064_bk032_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm128_bn064_bk032_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm128_bn064_bk032_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm128_bn064_bk032_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm128_bn064_bk032_wm4_wn2_mc0.uses_flat_scratch, 0
	.set .Lbm128_bn064_bk032_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn064_bk032_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm128_bn064_bk032_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_70f97c38b9f2f3d9,@object ; @__hip_cuid_70f97c38b9f2f3d9
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_70f97c38b9f2f3d9
__hip_cuid_70f97c38b9f2f3d9:
	.byte	0                               ; 0x0
	.size	__hip_cuid_70f97c38b9f2f3d9, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_70f97c38b9f2f3d9
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn064_bk032_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn064_bk032_wm4_wn2_mc0.kd
