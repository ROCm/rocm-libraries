	...
	.section	.text.bm064_bn192_bk096_wm4_wn2_mc0,"axG",@progbits,bm064_bn192_bk096_wm4_wn2_mc0,comdat
	.protected	bm064_bn192_bk096_wm4_wn2_mc0 ; -- Begin function bm064_bn192_bk096_wm4_wn2_mc0
	.globl	bm064_bn192_bk096_wm4_wn2_mc0
	.p2align	8
	.type	bm064_bn192_bk096_wm4_wn2_mc0,@function
bm064_bn192_bk096_wm4_wn2_mc0: ; @bm064_bn192_bk096_wm4_wn2_mc0
; %bb.0:
...
.LBB0_18:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 3, v57 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	s_and_b32 s41, s29, s25
	v_mov_b32_e32 v9, 0
	v_cndmask_b32_e64 v55, 0, 1, s41
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v59, 48, v1
...
; %bb.19:
	v_mul_u32_u24_e32 v1, 0x60, v61
	v_dual_mov_b32 v53, 0 :: v_dual_bitop2_b32 v5, 16, v0 bitop3:0x40
	...
	v_mad_u32_u24 v9, 0x60, v59, v9
	s_cselect_b32 s4, s4, 0
	s_mul_hi_i32 s6, s16, 0x2aaaaaab
	v_and_b32_e32 v8, 0x3f8, v2
	v_add_nc_u32_e32 v2, 0x600, v19
	s_lshl2_add_u32 s1, s4, s1
	v_add_nc_u32_e32 v54, v6, v19
	v_add_nc_u32_e32 v6, 0x1200, v19
	v_add_nc_u32_e32 v50, v8, v4
	v_add_nc_u32_e32 v4, 0xc00, v19
	v_dual_lshrrev_b32 v8, 4, v2 :: v_dual_bitop2_b32 v10, 32, v5 bitop3:0x54
	s_add_co_i32 s4, s1, 0xff00
	s_add_co_i32 s43, s1, 0xcc00
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_lshrrev_b32 v12, 4, v4 :: v_dual_add_nc_u32 v7, v7, v11
	v_or_b32_e32 v14, v1, v10
	v_and_b32_e32 v13, 0x7f8, v8
	v_add_nc_u32_e32 v8, 0x1e00, v19
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_and_b32_e32 v15, 0x7f8, v12
	v_dual_lshrrev_b32 v12, 4, v6 :: v_dual_lshrrev_b32 v7, 4, v7
	v_mad_u32_u24 v16, 0x60, v3, v14
	v_dual_add_nc_u32 v58, v13, v19 :: v_dual_add_nc_u32 v60, v15, v19
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v17, 0x7f8, v12
	v_and_b32_e32 v7, 0x7f8, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v13, v53 :: v_dual_add_nc_u32 v12, 0x600, v16
	v_dual_add_nc_u32 v10, v9, v10 :: v_dual_lshrrev_b32 v18, 4, v8
	v_dual_mov_b32 v15, v53 :: v_dual_add_nc_u32 v20, 0xc00, v16
	v_dual_add_nc_u32 v64, v7, v19 :: v_dual_bitop2_b32 v30, v9, v5 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v10, 4, v10 :: v_dual_lshrrev_b32 v21, 4, v16
	v_dual_mov_b32 v7, v53 :: v_dual_lshrrev_b32 v12, 4, v12
	v_add_nc_u32_e32 v14, v14, v11
	v_and_b32_e32 v25, 0x7f8, v10
	v_lshrrev_b32_e32 v10, 4, v20
	v_and_b32_e32 v23, 0x7f8, v18
	v_and_b32_e32 v52, 0xff8, v12
	v_or_b32_e32 v12, 64, v5
	v_add_nc_u32_e32 v18, 0x1200, v16
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v62, v17, v19 :: v_dual_add_nc_u32 v66, v23, v19
	v_mov_b32_e32 v17, v53
	v_dual_lshrrev_b32 v18, 4, v18 :: v_dual_bitop2_b32 v1, v1, v12 bitop3:0x54
	v_dual_add_nc_u32 v20, v9, v12 :: v_dual_lshrrev_b32 v14, 4, v14
	v_dual_mov_b32 v9, v53 :: v_dual_add_nc_u32 v16, 0x1e00, v16
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mad_u32_u24 v3, 0x60, v3, v1
	v_and_b32_e32 v12, 0xff8, v18
	s_delay_alu instid0(VALU_DEP_4)
	v_lshrrev_b32_e32 v18, 4, v20
	v_and_b32_e32 v21, 0x7f8, v21
	v_lshrrev_b32_e32 v16, 4, v16
	v_add_nc_u32_e32 v20, 0x600, v3
	v_add_nc_u32_e32 v22, 0xc00, v3
	v_dual_mov_b32 v23, v53 :: v_dual_add_nc_u32 v24, 0x1200, v3
	s_and_b32 s10, s4, 15
	s_delay_alu instid0(VALU_DEP_3)
	v_lshrrev_b32_e32 v20, 4, v20
	v_and_b32_e32 v27, 0x7f8, v18
	v_lshrrev_b32_e32 v18, 4, v3
	v_add_nc_u32_e32 v3, 0x1e00, v3
	s_sub_co_i32 s7, 16, s10
	v_and_b32_e32 v10, 0xff8, v10
	s_lshr_b32 s1, s7, 2
	v_and_b32_e32 v28, 0x7f8, v18
	v_add_nc_u32_e32 v72, v21, v19
	v_mov_b32_e32 v21, v53
	v_dual_add_nc_u32 v1, v1, v11 :: v_dual_lshrrev_b32 v11, 4, v22
	...
	v_sub_nc_u32_e32 v11, 0x263f, v0
	...
	v_and_b32_e32 v65, 30, v1
	v_dual_add_nc_u32 v51, -1, v56 :: v_dual_bitop2_b32 v63, 46, v3 bitop3:0x40
	s_ashr_i32 s5, s4, 31
	...
	v_lshl_or_b32 v29, v63, 8, v0
	v_dual_add_nc_u32 v68, v25, v30 :: v_dual_add_nc_u32 v82, v27, v30
	v_add_nc_u64_e32 v[70:71], v[52:53], v[2:3]
	v_dual_mov_b32 v11, v53 :: v_dual_mov_b32 v5, v53
	v_dual_mov_b32 v25, v53 :: v_dual_add_nc_u32 v52, 0x1800, v19
	v_dual_mov_b32 v19, v53 :: v_dual_add_nc_u32 v84, v28, v19
	v_dual_mov_b32 v27, v53 :: v_dual_lshlrev_b32 v96, 2, v29
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u64_e32 v[74:75], v[10:11], v[4:5]
	v_add_nc_u64_e32 v[76:77], v[12:13], v[6:7]
	v_add_nc_u64_e32 v[78:79], v[14:15], v[52:53]
	v_add_nc_u64_e32 v[80:81], v[16:17], v[8:9]
	v_add_nc_u64_e32 v[86:87], v[18:19], v[2:3]
	v_add_nc_u64_e32 v[88:89], v[20:21], v[4:5]
	v_add_nc_u64_e32 v[90:91], v[22:23], v[6:7]
	v_add_nc_u64_e32 v[92:93], v[24:25], v[52:53]
	v_add_nc_u64_e32 v[94:95], v[26:27], v[8:9]
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v6, v53 :: v_dual_add_nc_u32 v67, 0xffffff00, v29
	v_dual_mov_b32 v97, v53 :: v_dual_mov_b32 v8, v53
	v_dual_mov_b32 v2, v53 :: v_dual_mov_b32 v4, v53
	v_dual_mov_b32 v10, v53 :: v_dual_mov_b32 v12, v53
	v_dual_mov_b32 v14, v53 :: v_dual_mov_b32 v16, v53
	v_dual_mov_b32 v18, v53 :: v_dual_mov_b32 v20, v53
	v_dual_mov_b32 v22, v53 :: v_dual_mov_b32 v24, v53
	...
	v_dual_mov_b32 v26, v53 :: v_dual_mov_b32 v28, v53
...
; %bb.25:                               ;   in Loop: Header=BB0_24 Depth=2
	...
	v_lshl_add_u64 v[100:101], v[52:53], 2, s[6:7]
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v52, v98 :: v_dual_add_nc_u32 v69, -2, v69
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v69, s2 :: v_dual_mov_b32 v98, s12
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v69, v54, 1, s1
	v_lshl_add_u32 v71, v68, 1, s2
	v_lshl_add_u32 v73, v72, 1, s1
	v_lshl_add_u32 v75, v70, 1, s1
	ds_load_b128 v[98:101], v52
	ds_load_b128 v[102:105], v52 offset:16
	v_lshl_add_u32 v52, v58, 1, s1
	ds_load_b128 v[106:109], v69
	ds_load_b128 v[110:113], v69 offset:16
	v_lshl_add_u32 v69, v66, 1, s1
	...
	v_lshl_add_u32 v79, v78, 1, s1
	v_lshl_add_u32 v81, v80, 1, s1
	ds_load_b128 v[130:133], v73 offset:64
	ds_load_b128 v[134:137], v73 offset:80
	ds_load_b128 v[122:125], v52 offset:6144
	ds_load_b128 v[138:141], v75 offset:64
	ds_load_b128 v[142:145], v75 offset:80
	ds_load_b128 v[162:165], v79 offset:64
	ds_load_b128 v[166:169], v79 offset:80
	ds_load_b128 v[170:173], v81 offset:64
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[42:49], v[98:105], v[106:113], v[42:49]
	ds_load_b128 v[174:177], v81 offset:80
	...
	ds_load_b128 v[106:109], v69 offset:15360
	ds_load_b128 v[110:113], v69 offset:15376
	v_lshl_add_u32 v69, v64, 1, s1
	ds_load_b128 v[146:149], v69 offset:12288
	ds_load_b128 v[150:153], v69 offset:12304
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[98:105], v[146:153], v[2:9] matrix_a_reuse
	ds_load_b128 v[126:129], v52 offset:6160
	v_lshl_add_u32 v52, v62, 1, s1
	ds_load_b128 v[114:117], v71 offset:64
	ds_load_b128 v[118:121], v71 offset:80
	...
	v_lshl_add_u32 v52, v76, 1, s1
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	ds_load_b128 v[154:157], v52 offset:64
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[18:25], v[98:105], v[122:129], v[18:25] matrix_a_reuse
	ds_load_b128 v[122:125], v77 offset:64
	ds_load_b128 v[126:129], v77 offset:80
	ds_load_b128 v[158:161], v52 offset:80
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[10:17], v[98:105], v[106:113], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v52, v82, 1, s2
	v_lshl_add_u32 v69, v84, 1, s1
	v_lshl_add_u32 v71, v86, 1, s1
	v_lshl_add_u32 v73, v88, 1, s1
	ds_load_b128 v[98:101], v52 offset:128
	ds_load_b128 v[102:105], v52 offset:144
	ds_load_b128 v[106:109], v69 offset:128
	ds_load_b128 v[110:113], v69 offset:144
	ds_load_b128 v[146:149], v71 offset:128
	ds_load_b128 v[150:153], v71 offset:144
	v_lshl_add_u32 v52, v90, 1, s1
	v_lshl_add_u32 v69, v92, 1, s1
	v_lshl_add_u32 v71, v94, 1, s1
	ds_load_b128 v[178:181], v73 offset:128
	...
	ds_load_b128 v[182:185], v73 offset:144
	ds_load_b128 v[122:125], v52 offset:128
	ds_load_b128 v[126:129], v52 offset:144
	ds_load_b128 v[130:133], v69 offset:128
	ds_load_b128 v[134:137], v69 offset:144
	ds_load_b128 v[138:141], v71 offset:128
	ds_load_b128 v[142:145], v71 offset:144
	s_wait_dscnt 0xe
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn192_bk096_wm4_wn2_mc0, .Lfunc_end0-bm064_bn192_bk096_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn192_bk096_wm4_wn2_mc0
	...
	.section	.text.bm064_bn192_bk096_wm4_wn2_mc0,"axG",@progbits,bm064_bn192_bk096_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn192_bk096_wm4_wn2_mc0.num_vgpr, 186
	.set .Lbm064_bn192_bk096_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm064_bn192_bk096_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm064_bn192_bk096_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm064_bn192_bk096_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm064_bn192_bk096_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm064_bn192_bk096_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn192_bk096_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn192_bk096_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm064_bn192_bk096_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_86e20b14d5b1d480,@object ; @__hip_cuid_86e20b14d5b1d480
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_86e20b14d5b1d480
__hip_cuid_86e20b14d5b1d480:
	.byte	0                               ; 0x0
	.size	__hip_cuid_86e20b14d5b1d480, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_86e20b14d5b1d480
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn192_bk096_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn192_bk096_wm4_wn2_mc0.kd
