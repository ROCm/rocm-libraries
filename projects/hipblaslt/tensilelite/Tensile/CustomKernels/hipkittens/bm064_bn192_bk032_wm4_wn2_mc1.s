	...
	.section	.text.bm064_bn192_bk032_wm4_wn2_mc1,"axG",@progbits,bm064_bn192_bk032_wm4_wn2_mc1,comdat
	.protected	bm064_bn192_bk032_wm4_wn2_mc1 ; -- Begin function bm064_bn192_bk032_wm4_wn2_mc1
	.globl	bm064_bn192_bk032_wm4_wn2_mc1
	.p2align	8
	.type	bm064_bn192_bk032_wm4_wn2_mc1,@function
bm064_bn192_bk032_wm4_wn2_mc1: ; @bm064_bn192_bk032_wm4_wn2_mc1
; %bb.0:
...
.LBB0_24:
	s_or_b32 exec_lo, exec_lo, s4
	v_dual_lshlrev_b32 v1, 3, v59 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s43, s35, s29
	s_mov_b32 s11, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v61, 48, v1
	v_cmp_ne_u32_e32 vcc_lo, 0, v2
	v_cndmask_b32_e64 v57, 0, 1, s43
	v_dual_mov_b32 v8, v9 :: v_dual_mov_b32 v7, v9
	v_dual_mov_b32 v6, v9 :: v_dual_mov_b32 v5, v9
	v_cndmask_b32_e64 v63, 0, 0x60, vcc_lo
...
; %bb.25:
	...
	v_and_b32_e32 v4, 0xd8, v4
	s_lshl2_add_u32 s1, s4, s1
	s_mov_b32 s8, 64
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v53, 0 :: v_dual_add_nc_u32 v50, v1, v2
	...
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_lshrrev_b32 v2, 4, v2
	v_add_nc_u32_e32 v6, 0xa00, v3
	s_add_co_i32 s4, s1, 0x5500
	s_add_co_i32 s45, s1, 0x4400
	...
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_add_nc_u32 v60, v7, v3 :: v_dual_add_nc_u32 v62, v2, v3
	...
	s_lshl_b32 s10, s1, 2
	s_lshr_b32 s7, s7, 27
	v_add_nc_u32_e32 v66, v5, v3
	v_dual_mov_b32 v5, v53 :: v_dual_lshrrev_b32 v4, 4, v4
	...
	v_dual_add_nc_u32 v64, v4, v3 :: v_dual_mov_b32 v4, v53
	v_dual_lshrrev_b32 v56, 8, v51 :: v_dual_lshrrev_b32 v58, 8, v1
	s_ashr_i32 s19, s18, 31
	s_mul_u64 s[6:7], s[20:21], s[6:7]
	s_bfe_i64 s[20:21], s[24:25], 0x200000
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_dual_add_nc_u32 v1, 2, v56 :: v_dual_add_nc_u32 v8, 2, v58
	s_mul_u64 s[18:19], s[20:21], s[18:19]
	s_or_b32 s12, s0, 0x7510000
	v_cmp_eq_u32_e64 s0, 0, v59
	v_dual_add_nc_u32 v68, v6, v3 :: v_dual_bitop2_b32 v65, 14, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v6, v53 :: v_dual_bitop2_b32 v67, 30, v8 bitop3:0x40
	v_dual_mov_b32 v3, v53 :: v_dual_mov_b32 v8, v53
	...
	v_dual_mov_b32 v33, v53 :: v_dual_add_nc_u32 v55, -1, v58
...
; %bb.31:                               ;   in Loop: Header=BB0_30 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[72:73], v[52:53], 2, s[14:15]
...
.LBB0_35:                               ;   in Loop: Header=BB0_36 Depth=2
	...
	v_add_nc_u32_e32 v71, 0x200, v71
	v_cmp_eq_u32_e32 vcc_lo, s13, v67
	v_add_nc_u32_e32 v70, 0x200, v70
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
.LBB0_36:                               ;   Parent Loop BB0_27 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s13, v55
	v_cmpx_le_u32_e64 s13, v58
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	ds_load_b128 v[78:81], v69
	ds_load_b128 v[82:85], v69 offset:16
	...
	ds_load_b128 v[78:81], v69 offset:3072
	ds_load_b128 v[82:85], v69 offset:3088
	...
	ds_load_b128 v[78:81], v69 offset:4096
	ds_load_b128 v[82:85], v69 offset:4112
	v_lshl_add_u32 v69, v68, 1, s2
	ds_load_b128 v[86:89], v69 offset:5120
	ds_load_b128 v[90:93], v69 offset:5136
	s_wait_dscnt 0x2
...
; %bb.48:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v69, s13 :: v_dual_mov_b32 v70, s14
...
.LBB0_50:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v69, s5 :: v_dual_mov_b32 v70, s6
...
; %bb.52:
	...
	ds_store_b128 v37, v[38:41] offset:2048
	ds_store_b128 v42, v[6:9] offset:4096
	ds_store_b128 v43, v[2:5] offset:6144
	ds_store_b128 v36, v[10:13] offset:8192
	ds_store_b128 v1, v[14:17] offset:10240
.LBB0_53:
...
.LBB0_64:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn192_bk032_wm4_wn2_mc1, .Lfunc_end0-bm064_bn192_bk032_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn192_bk032_wm4_wn2_mc1
	...
	.section	.text.bm064_bn192_bk032_wm4_wn2_mc1,"axG",@progbits,bm064_bn192_bk032_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn192_bk032_wm4_wn2_mc1.num_vgpr, 102
	.set .Lbm064_bn192_bk032_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm064_bn192_bk032_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm064_bn192_bk032_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm064_bn192_bk032_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm064_bn192_bk032_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm064_bn192_bk032_wm4_wn2_mc1.uses_flat_scratch, 0
	.set .Lbm064_bn192_bk032_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn192_bk032_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm064_bn192_bk032_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_90971a659f416ece,@object ; @__hip_cuid_90971a659f416ece
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_90971a659f416ece
__hip_cuid_90971a659f416ece:
	.byte	0                               ; 0x0
	.size	__hip_cuid_90971a659f416ece, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_90971a659f416ece
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn192_bk032_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn192_bk032_wm4_wn2_mc1.kd
