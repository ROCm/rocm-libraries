	...
	.section	.text.bm064_bn224_bk032_wm4_wn2_mc1,"axG",@progbits,bm064_bn224_bk032_wm4_wn2_mc1,comdat
	.protected	bm064_bn224_bk032_wm4_wn2_mc1 ; -- Begin function bm064_bn224_bk032_wm4_wn2_mc1
	.globl	bm064_bn224_bk032_wm4_wn2_mc1
	.p2align	8
	.type	bm064_bn224_bk032_wm4_wn2_mc1,@function
bm064_bn224_bk032_wm4_wn2_mc1: ; @bm064_bn224_bk032_wm4_wn2_mc1
; %bb.0:
...
.LBB0_24:
	s_or_b32 exec_lo, exec_lo, s4
	v_dual_lshlrev_b32 v1, 3, v67 :: v_dual_mov_b32 v9, 0
	v_and_b32_e32 v58, 32, v0
	s_and_b32 s43, s35, s29
	s_mov_b32 s11, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v7, v9 :: v_dual_bitop2_b32 v69, 48, v1 bitop3:0x40
	v_mov_b32_e32 v8, v9
	...
	v_dual_mov_b32 v50, v9 :: v_dual_mov_b32 v17, v9
	...
	v_cndmask_b32_e64 v71, 0, 0x70, vcc_lo
...
; %bb.25:
	...
	v_dual_lshlrev_b32 v1, 5, v71 :: v_dual_lshlrev_b32 v2, 5, v69
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s1, 0x4c80
	s_delay_alu instid0(VALU_DEP_2)
	...
	v_add_nc_u32_e32 v6, 0xa00, v3
	v_lshrrev_b32_e32 v5, 4, v5
	s_and_b32 s10, s4, 15
	s_add_co_i32 s45, s1, 0x4c80
	...
	s_lshl_b32 s10, s1, 2
	v_dual_add_nc_u32 v72, v4, v3 :: v_dual_mov_b32 v4, v61
	...
	v_sub_nc_u32_e32 v1, 0xedf, v0
	v_dual_add_nc_u32 v76, v6, v3 :: v_dual_mov_b32 v6, v61
	v_lshrrev_b32_e32 v5, 4, v5
	s_ashr_i32 s47, s12, 5
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_dual_lshrrev_b32 v66, 8, v1 :: v_dual_lshrrev_b32 v64, 8, v59
	s_cmp_lt_i32 s3, 0xe0
	v_and_b32_e32 v5, 0x1f8, v5
	v_dual_add_nc_u32 v70, v8, v3 :: v_dual_mov_b32 v8, v61
	...
	v_dual_add_nc_u32 v9, 2, v66 :: v_dual_add_nc_u32 v1, 2, v64
	...
	v_and_b32_e32 v75, 30, v9
	v_dual_add_nc_u32 v68, v2, v3 :: v_dual_bitop2_b32 v73, 14, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v74, v5, v3 :: v_dual_add_nc_u32 v78, v7, v3
	v_dual_mov_b32 v7, v61 :: v_dual_mov_b32 v2, v61
	v_dual_mov_b32 v3, v61 :: v_dual_mov_b32 v5, v61
	v_dual_mov_b32 v9, v61 :: v_dual_mov_b32 v27, v61
	...
	v_dual_mov_b32 v59, v64 :: v_dual_add_nc_u32 v63, -1, v66
...
.LBB0_35:                               ;   in Loop: Header=BB0_36 Depth=2
	...
	v_add_nc_u32_e32 v81, 0x200, v81
	v_cmp_eq_u32_e32 vcc_lo, s13, v75
	v_add_nc_u32_e32 v80, 0x200, v80
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
.LBB0_36:                               ;   Parent Loop BB0_27 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s13, v63
	v_cmpx_le_u32_e64 s13, v66
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_lshl_add_u32 v79, v72, 1, s2
	v_lshl_add_u32 v124, v74, 1, s2
	v_lshl_add_u32 v132, v76, 1, s2
	ds_load_b128 v[80:83], v60
	ds_load_b128 v[84:87], v60 offset:16
	v_lshl_add_u32 v60, v68, 1, s2
	...
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[42:49], v[80:87], v[96:103], v[42:49] matrix_a_reuse
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[26:33], v[80:87], v[104:111], v[26:33] matrix_a_reuse
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[2:9], v[80:87], v[112:119], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[10:17], v[80:87], v[120:127], v[10:17] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[18:25], v[80:87], v[128:135], v[18:25] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[80:87], v[136:143], v[34:41] matrix_a_reuse
...
; %bb.52:
	...
	v_dual_lshrrev_b32 v26, 3, v28 :: v_dual_lshrrev_b32 v28, 3, v42
	...
	v_dual_add_nc_u32 v26, v26, v42 :: v_dual_lshrrev_b32 v43, 3, v43
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_and_b32_e32 v28, 0x7f0, v28
	ds_store_b128 v27, v[54:57]
	ds_store_b128 v26, v[46:49] offset:2048
	v_add_nc_u32_e32 v26, 0x1400, v1
	v_add_nc_u32_e32 v1, 0x1800, v1
	v_and_b32_e32 v29, 0x7f0, v29
	v_and_b32_e32 v27, 0x7f0, v43
	v_cvt_pk_bf16_f32 v5, v16, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v4, 3, v26 :: v_dual_lshrrev_b32 v1, 3, v1
	v_dual_add_nc_u32 v28, v28, v42 :: v_dual_add_nc_u32 v29, v29, v42
	v_cvt_pk_bf16_f32 v6, v2, v3
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v16, 0x7f0, v4
	v_and_b32_e32 v1, 0x7f0, v1
	v_add_nc_u32_e32 v26, v27, v42
	v_cvt_pk_bf16_f32 v4, v14, v15
	v_cvt_pk_bf16_f32 v3, v12, v13
	v_cvt_pk_bf16_f32 v2, v10, v11
	v_add_nc_u32_e32 v27, v16, v42
	...
	ds_store_b128 v28, v[30:33] offset:4096
	ds_store_b128 v29, v[6:9] offset:6144
	ds_store_b128 v26, v[2:5] offset:8192
	ds_store_b128 v27, v[10:13] offset:10240
	ds_store_b128 v1, v[14:17] offset:12288
.LBB0_53:
...
.LBB0_64:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn224_bk032_wm4_wn2_mc1, .Lfunc_end0-bm064_bn224_bk032_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn224_bk032_wm4_wn2_mc1
	...
	.section	.text.bm064_bn224_bk032_wm4_wn2_mc1,"axG",@progbits,bm064_bn224_bk032_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn224_bk032_wm4_wn2_mc1.num_vgpr, 144
	.set .Lbm064_bn224_bk032_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm064_bn224_bk032_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm064_bn224_bk032_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm064_bn224_bk032_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm064_bn224_bk032_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm064_bn224_bk032_wm4_wn2_mc1.uses_flat_scratch, 0
	.set .Lbm064_bn224_bk032_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn224_bk032_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm064_bn224_bk032_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_3bba7ed403731c0b,@object ; @__hip_cuid_3bba7ed403731c0b
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_3bba7ed403731c0b
__hip_cuid_3bba7ed403731c0b:
	.byte	0                               ; 0x0
	.size	__hip_cuid_3bba7ed403731c0b, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_3bba7ed403731c0b
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn224_bk032_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn224_bk032_wm4_wn2_mc1.kd
