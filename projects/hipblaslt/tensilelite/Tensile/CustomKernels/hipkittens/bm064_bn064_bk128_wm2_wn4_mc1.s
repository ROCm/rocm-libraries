	...
	.section	.text.bm064_bn064_bk128_wm2_wn4_mc1,"axG",@progbits,bm064_bn064_bk128_wm2_wn4_mc1,comdat
	.protected	bm064_bn064_bk128_wm2_wn4_mc1 ; -- Begin function bm064_bn064_bk128_wm2_wn4_mc1
	.globl	bm064_bn064_bk128_wm2_wn4_mc1
	.p2align	8
	.type	bm064_bn064_bk128_wm2_wn4_mc1,@function
bm064_bn064_bk128_wm2_wn4_mc1: ; @bm064_bn064_bk128_wm2_wn4_mc1
; %bb.0:
...
.LBB0_16:
	...
	v_dual_lshlrev_b32 v1, 3, v19 :: v_dual_lshlrev_b32 v2, 4, v19
	v_mov_b32_e32 v9, 0
	s_and_b32 s40, s3, s25
	s_and_not1_b32 vcc_lo, exec_lo, s13
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_and_b32_e32 v25, 32, v1
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v27, 48, v2 bitop3:0x40
...
; %bb.17:
	...
	v_dual_lshlrev_b32 v2, 7, v27 :: v_dual_lshlrev_b32 v1, 7, v25
	...
	v_dual_mov_b32 v21, 0 :: v_dual_bitop2_b32 v3, v3, v1 bitop3:0x54
	...
	v_dual_lshrrev_b32 v8, 4, v6 :: v_dual_bitop2_b32 v5, v1, v4 bitop3:0x54
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v20, v32 :: v_dual_add_nc_u32 v34, -2, v34
	v_dual_mov_b32 v36, v33 :: v_dual_mov_b32 v37, v21
	v_add_nc_u32_e32 v33, 0x200, v33
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[38:39], v[20:21], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v34
	v_add_nc_u32_e32 v32, 0x200, v32
	v_lshl_add_u64 v[36:37], v[36:37], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[38:39], v21
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_lshl_add_u32 v52, v22, 1, s6
	v_lshl_add_u32 v80, v26, 1, s6
	ds_load_b128 v[32:35], v20
	ds_load_b128 v[36:39], v20 offset:16
	ds_load_b128 v[40:43], v20 offset:4352
	ds_load_b128 v[48:51], v52
	ds_load_b128 v[52:55], v52 offset:16
	...
	ds_load_b128 v[44:47], v20 offset:4368
	...
	ds_load_b128 v[64:67], v20 offset:4416
	ds_load_b128 v[68:71], v20 offset:4432
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[10:17], v[40:47], v[48:55], v[10:17] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v20, v28, 1, s5
	ds_load_b128 v[32:35], v20 offset:128
	ds_load_b128 v[36:39], v20 offset:144
	ds_load_b128 v[40:43], v20 offset:4480
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[2:9], v[56:63], v[72:79], v[2:9]
	ds_load_b128 v[44:47], v20 offset:4496
	ds_load_b128 v[48:51], v80 offset:128
	ds_load_b128 v[52:55], v80 offset:144
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[10:17], v[64:71], v[72:79], v[10:17] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[56:59], v20 offset:192
	ds_load_b128 v[60:63], v20 offset:208
	ds_load_b128 v[64:67], v20 offset:4544
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[2:9], v[32:39], v[48:55], v[2:9]
	ds_load_b128 v[68:71], v20 offset:4560
	ds_load_b128 v[32:35], v80 offset:192
	ds_load_b128 v[36:39], v80 offset:208
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[40:47], v[48:55], v[10:17] matrix_b_reuse
	...
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[56:63], v[32:39], v[2:9]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_delay_alu instid0(TRANS32_DEP_2)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[64:71], v[32:39], v[10:17] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.42:
	...
	v_and_or_b32 v18, v0, 15, v27
	v_nop
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_and_or_b32 v1, v1, 8, v25
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn064_bk128_wm2_wn4_mc1, .Lfunc_end0-bm064_bn064_bk128_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn064_bk128_wm2_wn4_mc1
	...
	.section	.text.bm064_bn064_bk128_wm2_wn4_mc1,"axG",@progbits,bm064_bn064_bk128_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn064_bk128_wm2_wn4_mc1.num_vgpr, 81
	.set .Lbm064_bn064_bk128_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm064_bn064_bk128_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm064_bn064_bk128_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm064_bn064_bk128_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm064_bn064_bk128_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm064_bn064_bk128_wm2_wn4_mc1.uses_flat_scratch, 1
	.set .Lbm064_bn064_bk128_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn064_bk128_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm064_bn064_bk128_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_29c16ca64ee0e618,@object ; @__hip_cuid_29c16ca64ee0e618
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_29c16ca64ee0e618
__hip_cuid_29c16ca64ee0e618:
	.byte	0                               ; 0x0
	.size	__hip_cuid_29c16ca64ee0e618, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_29c16ca64ee0e618
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn064_bk128_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn064_bk128_wm2_wn4_mc1.kd
