	...
	.section	.text.bm256_bn064_bk064_wm8_wn1_mc1,"axG",@progbits,bm256_bn064_bk064_wm8_wn1_mc1,comdat
	.protected	bm256_bn064_bk064_wm8_wn1_mc1 ; -- Begin function bm256_bn064_bk064_wm8_wn1_mc1
	.globl	bm256_bn064_bk064_wm8_wn1_mc1
	.p2align	8
	.type	bm256_bn064_bk064_wm8_wn1_mc1,@function
bm256_bn064_bk064_wm8_wn1_mc1: ; @bm256_bn064_bk064_wm8_wn1_mc1
; %bb.0:
...
; %bb.21:
	...
	s_mov_b32 s46, s5
	v_dual_add_nc_u32 v68, v4, v3 :: v_dual_lshrrev_b32 v4, 4, v5
	v_and_b32_e32 v7, 56, v66
	v_or_b32_e32 v5, 0x400, v1
	v_or_b32_e32 v1, 0xc00, v1
	v_lshrrev_b32_e32 v6, 4, v6
	v_and_b32_e32 v4, 0x3f8, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v70, v2, v7 :: v_dual_lshrrev_b32 v5, 4, v5
	...
	v_add_nc_u32_e32 v74, v3, v4
	s_lshr_b32 s7, s7, 26
	v_add_nc_u32_e32 v76, v5, v2
	s_add_co_i32 s12, s12, s7
	v_dual_add_nc_u32 v78, v6, v2 :: v_dual_add_nc_u32 v80, v8, v2
	v_dual_mov_b32 v2, v67 :: v_dual_lshrrev_b32 v72, 8, v7
	s_lshl_b32 s10, s6, 2
	...
	v_dual_mov_b32 v69, v72 :: v_dual_bitop2_b32 v75, 30, v7 bitop3:0x40
	v_dual_mov_b32 v85, v67 :: v_dual_add_nc_u32 v82, 0x400, v74
...
.LBB0_25:                               ;   Parent Loop BB0_23 Depth=1
	...
	v_dual_mov_b32 v66, v86 :: v_dual_add_nc_u32 v79, -2, v79
	v_dual_mov_b32 v88, v87 :: v_dual_mov_b32 v89, v67
	v_add_nc_u32_e32 v87, 0x200, v87
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[90:91], v[66:67], 2, s[6:7]
...
.LBB0_31:                               ;   Parent Loop BB0_23 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s19, v69
	v_cmpx_le_u32_e64 s18, v72
	s_cbranch_execz .LBB0_33
; %bb.32:                               ;   in Loop: Header=BB0_31 Depth=2
	v_mov_b32_e32 v66, v86
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[88:89], v[66:67], 2, s[14:15]
	flat_store_b32 v[88:89], v67
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_lshl_add_u32 v79, v74, 1, s1
	v_lshl_add_u32 v83, v78, 1, s2
	v_lshl_add_u32 v81, v76, 1, s2
	v_lshl_add_u32 v154, v80, 1, s2
	ds_load_b128 v[86:89], v66
	ds_load_b128 v[90:93], v66 offset:16
	ds_load_b128 v[94:97], v79 offset:2048
	ds_load_b128 v[98:101], v79 offset:2064
	v_lshl_add_u32 v79, v70, 1, s2
	v_lshl_add_u32 v130, v82, 1, s1
	ds_load_b128 v[118:121], v66 offset:64
	ds_load_b128 v[122:125], v66 offset:80
	ds_load_b128 v[134:137], v81 offset:2112
	ds_load_b128 v[110:113], v79
	ds_load_b128 v[114:117], v79 offset:16
	ds_load_b128 v[126:129], v130 offset:64
	ds_load_b128 v[130:133], v130 offset:80
	ds_load_b128 v[138:141], v81 offset:2128
	ds_load_b128 v[142:145], v83 offset:4160
	ds_load_b128 v[146:149], v83 offset:4176
	ds_load_b128 v[150:153], v154 offset:6208
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[18:25], v[94:101], v[110:117], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[86:93], v[110:117], v[58:65]
	ds_load_b128 v[110:113], v83 offset:4096
	ds_load_b128 v[114:117], v83 offset:4112
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[86:93], v[110:117], v[42:49] matrix_a_reuse
	ds_load_b128 v[102:105], v81 offset:2048
	ds_load_b128 v[106:109], v81 offset:2064
	s_wait_dscnt 0x0
	...
	ds_load_b128 v[102:105], v154 offset:6144
	ds_load_b128 v[106:109], v154 offset:6160
	ds_load_b128 v[154:157], v154 offset:6224
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[26:33], v[86:93], v[102:109], v[26:33] matrix_a_reuse
	...
	ds_load_b128 v[94:97], v79 offset:64
	ds_load_b128 v[98:101], v79 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	...
	v_wmma_f32_16x16x32_bf16 v[26:33], v[118:125], v[150:157], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	...
	v_wmma_f32_16x16x32_bf16 v[18:25], v[126:133], v[94:101], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_dual_mov_b32 v79, s13 :: v_dual_mov_b32 v86, s14
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_dual_mov_b32 v79, s5 :: v_dual_mov_b32 v86, s6
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn064_bk064_wm8_wn1_mc1, .Lfunc_end0-bm256_bn064_bk064_wm8_wn1_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn064_bk064_wm8_wn1_mc1
	...
	.section	.text.bm256_bn064_bk064_wm8_wn1_mc1,"axG",@progbits,bm256_bn064_bk064_wm8_wn1_mc1,comdat
                                        ; -- End function
	.set .Lbm256_bn064_bk064_wm8_wn1_mc1.num_vgpr, 158
	.set .Lbm256_bn064_bk064_wm8_wn1_mc1.num_agpr, 0
	.set .Lbm256_bn064_bk064_wm8_wn1_mc1.numbered_sgpr, 56
	.set .Lbm256_bn064_bk064_wm8_wn1_mc1.num_named_barrier, 0
	.set .Lbm256_bn064_bk064_wm8_wn1_mc1.private_seg_size, 0
	.set .Lbm256_bn064_bk064_wm8_wn1_mc1.uses_vcc, 1
	.set .Lbm256_bn064_bk064_wm8_wn1_mc1.uses_flat_scratch, 1
	.set .Lbm256_bn064_bk064_wm8_wn1_mc1.has_dyn_sized_stack, 0
	.set .Lbm256_bn064_bk064_wm8_wn1_mc1.has_recursion, 0
	.set .Lbm256_bn064_bk064_wm8_wn1_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_fc6df4bd17982a81,@object ; @__hip_cuid_fc6df4bd17982a81
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_fc6df4bd17982a81
__hip_cuid_fc6df4bd17982a81:
	.byte	0                               ; 0x0
	.size	__hip_cuid_fc6df4bd17982a81, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_fc6df4bd17982a81
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn064_bk064_wm8_wn1_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn064_bk064_wm8_wn1_mc1.kd
