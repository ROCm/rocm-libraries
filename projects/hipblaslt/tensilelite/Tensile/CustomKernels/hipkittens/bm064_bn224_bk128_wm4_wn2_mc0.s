	...
	.section	.text.bm064_bn224_bk128_wm4_wn2_mc0,"axG",@progbits,bm064_bn224_bk128_wm4_wn2_mc0,comdat
	.protected	bm064_bn224_bk128_wm4_wn2_mc0 ; -- Begin function bm064_bn224_bk128_wm4_wn2_mc0
	.globl	bm064_bn224_bk128_wm4_wn2_mc0
	.p2align	8
	.type	bm064_bn224_bk128_wm4_wn2_mc0,@function
bm064_bn224_bk128_wm4_wn2_mc0: ; @bm064_bn224_bk128_wm4_wn2_mc0
; %bb.0:
...
.LBB0_14:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 3, v63 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	s_and_b32 s40, s3, s25
	v_mov_b32_e32 v9, 0
	v_cndmask_b32_e64 v59, 0, 1, s40
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v65, 48, v1
	v_cmp_ne_u32_e32 vcc_lo, 0, v2
	s_mov_b32 s11, 0
	v_dual_mov_b32 v8, v9 :: v_dual_mov_b32 v7, v9
	v_dual_mov_b32 v6, v9 :: v_dual_mov_b32 v5, v9
	v_cndmask_b32_e64 v67, 0, 0x70, vcc_lo
...
; %bb.15:
	v_dual_lshlrev_b32 v3, 7, v0 :: v_dual_lshlrev_b32 v2, 7, v67
	v_lshlrev_b32_e32 v1, 7, v65
	s_mov_b64 s[4:5], src_shared_base
	s_add_co_i32 s6, s39, 0xee00
	...
	v_dual_mov_b32 v61, 0 :: v_dual_bitop2_b32 v3, v3, v1 bitop3:0x54
	s_lshr_b32 s4, s4, 2
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_2)
	v_or_b32_e32 v6, v2, v4
	v_or_b32_e32 v5, v1, v4
	s_cmp_lg_u64 s[6:7], 0
	v_sub_nc_u32_e32 v9, 0x3b7f, v0
	s_cselect_b32 s4, s4, 0
	v_dual_lshrrev_b32 v8, 4, v6 :: v_dual_lshrrev_b32 v7, 4, v5
	s_lshl2_add_u32 s7, s4, s39
	...
	v_add3_u32 v66, v4, v2, v8
	v_dual_add_nc_u32 v58, v7, v5 :: v_dual_mov_b32 v2, v61
	v_dual_add_nc_u32 v62, v8, v6 :: v_dual_lshrrev_b32 v5, 8, v9
	s_lshr_b32 s0, s0, 2
	...
	v_dual_mov_b32 v71, v61 :: v_dual_add_nc_u32 v6, v4, v1
	s_lshr_b32 s7, s7, 25
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v69, 62, v5
	...
	s_lshl_b32 s4, s30, 6
	v_add_nc_u32_e32 v64, v3, v6
	v_lshl_or_b32 v9, v69, 8, v0
	s_ashr_i32 s7, s6, 31
	s_ashr_i32 s5, s4, 31
	s_wait_kmcnt 0x0
	...
	v_cmp_ne_u32_e64 s0, v5, v69
	v_dual_add_nc_u32 v68, v7, v6 :: v_dual_lshlrev_b32 v72, 2, v9
	v_lshl_or_b32 v70, v0, 2, 0x4000
	v_dual_mov_b32 v4, v61 :: v_dual_add_nc_u32 v77, 0xffffff00, v9
	v_dual_mov_b32 v73, v61 :: v_dual_mov_b32 v3, v61
	v_dual_mov_b32 v5, v61 :: v_dual_mov_b32 v6, v61
	v_dual_mov_b32 v7, v61 :: v_dual_mov_b32 v8, v61
	v_dual_mov_b32 v9, v61 :: v_dual_mov_b32 v10, v61
	v_dual_mov_b32 v11, v61 :: v_dual_mov_b32 v12, v61
	v_dual_mov_b32 v13, v61 :: v_dual_mov_b32 v14, v61
	v_dual_mov_b32 v15, v61 :: v_dual_mov_b32 v16, v61
	v_dual_mov_b32 v17, v61 :: v_dual_mov_b32 v18, v61
	v_dual_mov_b32 v19, v61 :: v_dual_mov_b32 v20, v61
	v_dual_mov_b32 v21, v61 :: v_dual_mov_b32 v22, v61
	v_dual_mov_b32 v23, v61 :: v_dual_mov_b32 v24, v61
	v_dual_mov_b32 v25, v61 :: v_dual_mov_b32 v34, v61
	...
	v_dual_mov_b32 v27, v61 :: v_dual_mov_b32 v28, v61
	v_dual_mov_b32 v29, v61 :: v_dual_mov_b32 v30, v61
	v_dual_mov_b32 v31, v61 :: v_dual_mov_b32 v32, v61
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v60, v74 :: v_dual_add_nc_u32 v78, -2, v78
	v_dual_mov_b32 v80, v75 :: v_dual_mov_b32 v81, v61
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[74:75], s[6:7], v[70:71]
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v75, s14 :: v_dual_mov_b32 v74, s12
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_lshl_add_u32 v74, v62, 1, s6
	ds_load_b128 v[78:81], v60
	ds_load_b128 v[82:85], v60 offset:16
	...
	ds_load_b128 v[118:121], v74 offset:17408
	ds_load_b128 v[122:125], v74 offset:17424
	ds_load_b128 v[126:129], v74 offset:21760
	ds_load_b128 v[130:133], v74 offset:21776
	ds_load_b128 v[134:137], v74 offset:26112
	ds_load_b128 v[138:141], v74 offset:26128
	v_lshl_add_u32 v60, v64, 1, s5
	v_lshl_add_u32 v74, v66, 1, s6
	; sched_group_barrier mask(0x00000100) size(16) SyncID(0)
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[50:57], v[78:85], v[86:93], v[50:57]
	ds_load_b128 v[86:89], v60 offset:64
	ds_load_b128 v[90:93], v60 offset:80
	ds_load_b128 v[142:145], v74 offset:17472
	ds_load_b128 v[146:149], v74 offset:17488
	ds_load_b128 v[150:153], v74 offset:21824
	ds_load_b128 v[154:157], v74 offset:21840
	ds_load_b128 v[158:161], v74 offset:26176
	s_wait_dscnt 0x11
	v_wmma_f32_16x16x32_bf16 v[42:49], v[78:85], v[94:101], v[42:49] matrix_a_reuse
	ds_load_b128 v[94:97], v74 offset:64
	ds_load_b128 v[98:101], v74 offset:80
	ds_load_b128 v[162:165], v74 offset:26192
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[34:41], v[78:85], v[102:109], v[34:41] matrix_a_reuse
	ds_load_b128 v[102:105], v74 offset:4416
	ds_load_b128 v[106:109], v74 offset:4432
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[18:25], v[78:85], v[110:117], v[18:25] matrix_a_reuse
	ds_load_b128 v[110:113], v74 offset:8768
	ds_load_b128 v[114:117], v74 offset:8784
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[10:17], v[78:85], v[118:125], v[10:17] matrix_a_reuse
	ds_load_b128 v[118:121], v74 offset:13120
	ds_load_b128 v[122:125], v74 offset:13136
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[2:9], v[78:85], v[126:133], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[26:33], v[78:85], v[134:141], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v60, v68, 1, s5
	ds_load_b128 v[78:81], v74 offset:128
	ds_load_b128 v[82:85], v74 offset:144
	ds_load_b128 v[126:129], v74 offset:4480
	ds_load_b128 v[130:133], v74 offset:4496
	ds_load_b128 v[134:137], v60 offset:128
	ds_load_b128 v[138:141], v60 offset:144
	ds_load_b128 v[166:169], v74 offset:8832
	ds_load_b128 v[170:173], v74 offset:8848
	ds_load_b128 v[174:177], v74 offset:13184
	ds_load_b128 v[178:181], v74 offset:13200
	ds_load_b128 v[182:185], v74 offset:17536
	ds_load_b128 v[186:189], v74 offset:17552
	ds_load_b128 v[190:193], v74 offset:21888
	ds_load_b128 v[194:197], v74 offset:21904
	ds_load_b128 v[198:201], v74 offset:26240
	ds_load_b128 v[202:205], v74 offset:26256
	s_wait_dscnt 0x17
	v_wmma_f32_16x16x32_bf16 v[50:57], v[86:93], v[94:101], v[50:57]
	; sched_group_barrier mask(0x00000100) size(16) SyncID(0)
	s_wait_dscnt 0x14
	v_wmma_f32_16x16x32_bf16 v[42:49], v[86:93], v[102:109], v[42:49] matrix_a_reuse
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[34:41], v[86:93], v[110:117], v[34:41] matrix_a_reuse
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[18:25], v[86:93], v[118:125], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[86:93], v[142:149], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[86:93], v[150:157], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[86:93], v[158:165], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[86:89], v60 offset:192
	ds_load_b128 v[90:93], v60 offset:208
	ds_load_b128 v[94:97], v74 offset:192
	ds_load_b128 v[98:101], v74 offset:208
	ds_load_b128 v[102:105], v74 offset:4544
	ds_load_b128 v[106:109], v74 offset:4560
	ds_load_b128 v[110:113], v74 offset:8896
	ds_load_b128 v[114:117], v74 offset:8912
	ds_load_b128 v[118:121], v74 offset:13248
	ds_load_b128 v[122:125], v74 offset:13264
	ds_load_b128 v[142:145], v74 offset:17600
	ds_load_b128 v[146:149], v74 offset:17616
	ds_load_b128 v[150:153], v74 offset:21952
	ds_load_b128 v[154:157], v74 offset:21968
	ds_load_b128 v[158:161], v74 offset:26304
	ds_load_b128 v[162:165], v74 offset:26320
	s_wait_dscnt 0x1a
	v_wmma_f32_16x16x32_bf16 v[50:57], v[134:141], v[78:85], v[50:57]
	; sched_group_barrier mask(0x00000100) size(16) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[134:141], v[126:133], v[42:49] matrix_a_reuse
	s_wait_dscnt 0x18
	v_wmma_f32_16x16x32_bf16 v[34:41], v[134:141], v[166:173], v[34:41] matrix_a_reuse
	s_wait_dscnt 0x16
	v_wmma_f32_16x16x32_bf16 v[18:25], v[134:141], v[174:181], v[18:25] matrix_a_reuse
	s_wait_dscnt 0x14
	v_wmma_f32_16x16x32_bf16 v[10:17], v[134:141], v[182:189], v[10:17] matrix_a_reuse
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[2:9], v[134:141], v[190:197], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[26:33], v[134:141], v[198:205], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[50:57], v[86:93], v[94:101], v[50:57]
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn224_bk128_wm4_wn2_mc0, .Lfunc_end0-bm064_bn224_bk128_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn224_bk128_wm4_wn2_mc0
	...
	.section	.text.bm064_bn224_bk128_wm4_wn2_mc0,"axG",@progbits,bm064_bn224_bk128_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn224_bk128_wm4_wn2_mc0.num_vgpr, 206
	.set .Lbm064_bn224_bk128_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm064_bn224_bk128_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm064_bn224_bk128_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm064_bn224_bk128_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm064_bn224_bk128_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm064_bn224_bk128_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn224_bk128_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn224_bk128_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm064_bn224_bk128_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_60be651ac350f403,@object ; @__hip_cuid_60be651ac350f403
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_60be651ac350f403
__hip_cuid_60be651ac350f403:
	.byte	0                               ; 0x0
	.size	__hip_cuid_60be651ac350f403, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_60be651ac350f403
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn224_bk128_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn224_bk128_wm4_wn2_mc0.kd
