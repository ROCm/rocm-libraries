	...
	.section	.text.bm128_bn160_bk032_wm4_wn2_mc0,"axG",@progbits,bm128_bn160_bk032_wm4_wn2_mc0,comdat
	.protected	bm128_bn160_bk032_wm4_wn2_mc0 ; -- Begin function bm128_bn160_bk032_wm4_wn2_mc0
	.globl	bm128_bn160_bk032_wm4_wn2_mc0
	.p2align	8
	.type	bm128_bn160_bk032_wm4_wn2_mc0,@function
bm128_bn160_bk032_wm4_wn2_mc0: ; @bm128_bn160_bk032_wm4_wn2_mc0
; %bb.0:
...
.LBB0_22:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 4, v93 :: v_dual_mov_b32 v9, 0
	v_and_b32_e32 v82, 32, v0
	s_and_b32 s40, s29, s25
	s_mov_b32 s11, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v91, 0x60, v1
	v_mov_b32_e32 v8, v9
	...
	v_cndmask_b32_e64 v95, 0, 0x50, vcc_lo
	v_cndmask_b32_e64 v89, 0, 1, s40
	s_and_not1_b32 vcc_lo, exec_lo, s16
	s_barrier_wait -1
	s_cbranch_vccnz .LBB0_47
; %bb.23:
	v_dual_lshlrev_b32 v2, 5, v91 :: v_dual_lshlrev_b32 v4, 5, v0
	v_dual_lshlrev_b32 v1, 5, v95 :: v_dual_bitop2_b32 v3, 16, v0 bitop3:0x40
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s0, 0x4c80
	s_delay_alu instid0(VALU_DEP_2)
	...
	s_movk_i32 s16, 0xa0
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v85, 0 :: v_dual_lshrrev_b32 v5, 4, v2
	...
	v_dual_add_nc_u32 v1, 2, v88 :: v_dual_add_nc_u32 v9, 2, v90
	s_ashr_i32 s7, s6, 31
	s_ashr_i32 s5, s4, 31
	s_wait_kmcnt 0x0
	...
	v_dual_add_nc_u32 v96, v8, v3 :: v_dual_bitop2_b32 v97, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v98, v7, v3 :: v_dual_bitop2_b32 v99, 14, v9 bitop3:0x40
	v_dual_mov_b32 v83, v88 :: v_dual_add_nc_u32 v100, v5, v3
	v_dual_mov_b32 v3, v85 :: v_dual_mov_b32 v5, v85
	...
	v_dual_mov_b32 v57, v85 :: v_dual_mov_b32 v87, v90
...
; %bb.29:                               ;   in Loop: Header=BB0_28 Depth=2
	...
	v_lshl_add_u64 v[104:105], v[84:85], 2, s[12:13]
...
.LBB0_33:                               ;   in Loop: Header=BB0_34 Depth=2
	...
	s_add_co_i32 s6, s6, 2
	v_add_nc_u32_e32 v103, 0x200, v103
	v_cmp_eq_u32_e32 vcc_lo, s6, v99
	v_add_nc_u32_e32 v102, 0x200, v102
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
; %bb.43:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_dual_mov_b32 v101, s14 :: v_dual_mov_b32 v102, s12
...
.LBB0_45:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v101, s5 :: v_dual_mov_b32 v102, s6
...
; %bb.48:
	...
	v_dual_lshrrev_b32 v58, 3, v58 :: v_dual_lshrrev_b32 v61, 3, v61
	...
	v_dual_add_nc_u32 v59, v59, v66 :: v_dual_lshrrev_b32 v67, 3, v67
	v_cvt_pk_bf16_f32 v71, v68, v69
	v_dual_add_nc_u32 v60, v60, v66 :: v_dual_add_nc_u32 v68, 16, v1
	...
	v_and_b32_e32 v10, 0xff0, v18
	v_dual_lshlrev_b32 v18, 1, v68 :: v_dual_add_nc_u32 v59, v61, v66
	v_cvt_pk_bf16_f32 v46, v42, v43
	v_add_nc_u32_e32 v42, v60, v66
	v_cvt_pk_bf16_f32 v23, v20, v21
	v_add_nc_u32_e32 v11, 0x1010, v1
	ds_store_b128 v58, v[62:65] offset:8192
	ds_store_b128 v59, v[46:49] offset:12288
	ds_store_b128 v42, v[22:25] offset:16384
	v_add_nc_u32_e32 v22, v10, v18
	v_add_nc_u32_e32 v10, 0x1810, v1
	v_add_nc_u32_e32 v1, 0x2010, v1
	v_dual_lshrrev_b32 v61, 3, v68 :: v_dual_lshrrev_b32 v11, 3, v11
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_dual_lshrrev_b32 v4, 3, v10 :: v_dual_lshrrev_b32 v1, 3, v1
	v_and_b32_e32 v43, 0x7f0, v61
	v_and_b32_e32 v11, 0xff0, v11
	v_cvt_pk_bf16_f32 v15, v12, v13
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v10, 0xff0, v4
	v_and_b32_e32 v1, 0xff0, v1
	v_add_nc_u32_e32 v43, v43, v66
	v_cvt_pk_bf16_f32 v6, v2, v3
	v_add_nc_u32_e32 v23, v11, v18
	...
	ds_store_b128 v24, v[10:13] offset:12288
...
.LBB0_60:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn160_bk032_wm4_wn2_mc0, .Lfunc_end0-bm128_bn160_bk032_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn160_bk032_wm4_wn2_mc0
	...
	.section	.text.bm128_bn160_bk032_wm4_wn2_mc0,"axG",@progbits,bm128_bn160_bk032_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn160_bk032_wm4_wn2_mc0.num_vgpr, 142
	.set .Lbm128_bn160_bk032_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm128_bn160_bk032_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm128_bn160_bk032_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm128_bn160_bk032_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm128_bn160_bk032_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm128_bn160_bk032_wm4_wn2_mc0.uses_flat_scratch, 0
	.set .Lbm128_bn160_bk032_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn160_bk032_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm128_bn160_bk032_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_cc3eb10ecb283135,@object ; @__hip_cuid_cc3eb10ecb283135
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_cc3eb10ecb283135
__hip_cuid_cc3eb10ecb283135:
	.byte	0                               ; 0x0
	.size	__hip_cuid_cc3eb10ecb283135, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_cc3eb10ecb283135
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn160_bk032_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn160_bk032_wm4_wn2_mc0.kd
