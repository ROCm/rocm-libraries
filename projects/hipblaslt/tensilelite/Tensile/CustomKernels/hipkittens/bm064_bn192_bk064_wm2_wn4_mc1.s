	...
	.section	.text.bm064_bn192_bk064_wm2_wn4_mc1,"axG",@progbits,bm064_bn192_bk064_wm2_wn4_mc1,comdat
	.protected	bm064_bn192_bk064_wm2_wn4_mc1 ; -- Begin function bm064_bn192_bk064_wm2_wn4_mc1
	.globl	bm064_bn192_bk064_wm2_wn4_mc1
	.p2align	8
	.type	bm064_bn192_bk064_wm2_wn4_mc1,@function
bm064_bn192_bk064_wm2_wn4_mc1: ; @bm064_bn192_bk064_wm2_wn4_mc1
; %bb.0:
...
.LBB0_20:
	...
	v_dual_lshlrev_b32 v1, 3, v57 :: v_dual_bitop2_b32 v61, 3, v57 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s43, s35, s29
	s_and_not1_b32 vcc_lo, exec_lo, s13
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v59, 32, v1
	v_cndmask_b32_e64 v55, 0, 1, s43
...
; %bb.21:
	v_mul_u32_u24_e32 v1, 0xc00, v61
	v_dual_lshlrev_b32 v2, 6, v59 :: v_dual_bitop2_b32 v3, 16, v0 bitop3:0x40
	v_dual_lshlrev_b32 v4, 6, v0 :: v_dual_lshrrev_b32 v56, 8, v51
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s16, 0x8800
	s_mov_b32 s7, s5
	...
	v_dual_mov_b32 v53, 0 :: v_dual_bitop2_b32 v4, v2, v3 bitop3:0x54
	v_mov_b32_e32 v51, v56
	s_lshr_b32 s4, s4, 2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add_nc_u32_e32 v8, 0x400, v6
	v_dual_lshrrev_b32 v5, 4, v4 :: v_dual_bitop2_b32 v9, 32, v3 bitop3:0x54
	v_dual_mov_b32 v75, v53 :: v_dual_add_nc_u32 v10, 0x800, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_dual_add_nc_u32 v2, v3, v2 :: v_dual_add_nc_u32 v50, v5, v4
	v_lshrrev_b32_e32 v5, 4, v6
	v_or_b32_e32 v9, 0x400, v11
	...
	v_add_nc_u32_e32 v54, v5, v6
	v_dual_lshrrev_b32 v5, 4, v10 :: v_dual_lshrrev_b32 v10, 4, v11
	...
	s_and_b32 s10, s4, 15
	v_add3_u32 v66, v2, v9, 0x400
	s_sub_co_i32 s7, 16, s10
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v3, v53 :: v_dual_add_nc_u32 v64, v10, v2
	v_dual_mov_b32 v2, v53 :: v_dual_lshrrev_b32 v11, 4, v11
	v_add_nc_u32_e32 v12, 0x800, v1
	v_lshrrev_b32_e32 v1, 4, v1
	v_and_b32_e32 v5, 0x7f8, v5
	v_dual_add_nc_u32 v58, v7, v4 :: v_dual_mov_b32 v4, v53
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshrrev_b32_e32 v12, 4, v12
	v_and_b32_e32 v14, 0x3f8, v1
	v_lshrrev_b32_e32 v1, 8, v13
	s_add_co_i32 s45, s6, 0x8800
	s_lshr_b32 s6, s7, 2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_add_nc_u32 v1, 2, v56 :: v_dual_bitop2_b32 v63, 26, v13 bitop3:0x40
	...
	v_dual_add_nc_u32 v60, v8, v6 :: v_dual_bitop2_b32 v65, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_cmp_ne_u32_e64 s1, v13, v63
	v_dual_add_nc_u32 v62, v5, v6 :: v_dual_add_nc_u32 v68, v14, v6
	v_add3_u32 v70, v6, v11, 0x400
	v_add3_u32 v72, v6, v12, 0x800
	v_dual_mov_b32 v8, v53 :: v_dual_add_nc_u32 v67, 0xffffff00, v15
	v_dual_mov_b32 v5, v53 :: v_dual_lshlrev_b32 v74, 2, v15
	v_dual_mov_b32 v6, v53 :: v_dual_mov_b32 v7, v53
...
.LBB0_25:                               ;   in Loop: Header=BB0_26 Depth=2
	...
	v_cmp_eq_u32_e32 vcc_lo, s6, v65
...
.LBB0_26:                               ;   Parent Loop BB0_23 Depth=1
	...
	v_cmpx_le_u32_e64 s18, v56
	s_cbranch_execz .LBB0_28
; %bb.27:                               ;   in Loop: Header=BB0_26 Depth=2
	v_mov_b32_e32 v52, v76
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[78:79], v[52:53], 2, s[14:15]
	flat_store_b32 v[78:79], v53
...
.LBB0_31:                               ;   Parent Loop BB0_23 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v52, v76 :: v_dual_add_nc_u32 v69, -2, v69
	v_dual_mov_b32 v78, v77 :: v_dual_mov_b32 v79, v53
	v_add_nc_u32_e32 v77, 0x200, v77
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[80:81], v[52:53], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v69
	v_add_nc_u32_e32 v76, 0x200, v76
	v_lshl_add_u64 v[78:79], v[78:79], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[80:81], v53
	flat_store_b32 v[78:79], v53
	s_or_b32 s2, vcc_lo, s2
	s_wait_xcnt 0x0
	s_and_not1_b32 exec_lo, exec_lo, s2
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	ds_load_b128 v[88:91], v69 offset:2064
	ds_load_b128 v[92:95], v71
	v_lshl_add_u32 v69, v66, 1, s2
	ds_load_b128 v[100:103], v52 offset:2048
	ds_load_b128 v[104:107], v52 offset:2064
	v_lshl_add_u32 v52, v62, 1, s5
	ds_load_b128 v[116:119], v73 offset:64
	ds_load_b128 v[120:123], v73 offset:80
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[84:91], v[100:107], v[2:9] matrix_a_reuse
	ds_load_b128 v[108:111], v52 offset:4096
	ds_load_b128 v[112:115], v52 offset:4112
	v_lshl_add_u32 v52, v64, 1, s2
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[84:91], v[108:115], v[26:33]
	ds_load_b128 v[96:99], v71 offset:16
	v_lshl_add_u32 v71, v68, 1, s5
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[84:91], v[92:99], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[76:83], v[92:99], v[42:49]
	v_wmma_f32_16x16x32_bf16 v[34:41], v[76:83], v[100:107], v[34:41] matrix_a_reuse
	ds_load_b128 v[100:103], v71 offset:64
	ds_load_b128 v[104:107], v71 offset:80
	v_wmma_f32_16x16x32_bf16 v[18:25], v[76:83], v[108:115], v[18:25] matrix_a_reuse
	ds_load_b128 v[76:79], v52 offset:64
	ds_load_b128 v[80:83], v52 offset:80
	v_lshl_add_u32 v52, v72, 1, s5
	ds_load_b128 v[108:111], v69 offset:64
	ds_load_b128 v[112:115], v69 offset:80
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	ds_load_b128 v[84:87], v52 offset:64
	ds_load_b128 v[88:91], v52 offset:80
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[42:49], v[76:83], v[100:107], v[42:49]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[76:83], v[116:123], v[34:41] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[76:83], v[84:91], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[108:115], v[84:91], v[26:33]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[108:115], v[116:123], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[108:115], v[100:107], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_dual_mov_b32 v69, s13 :: v_dual_mov_b32 v76, s14
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v69, s5 :: v_dual_mov_b32 v76, s6
	s_bitset1_b32 s7, 31
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn192_bk064_wm2_wn4_mc1, .Lfunc_end0-bm064_bn192_bk064_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn192_bk064_wm2_wn4_mc1
	...
	.section	.text.bm064_bn192_bk064_wm2_wn4_mc1,"axG",@progbits,bm064_bn192_bk064_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn192_bk064_wm2_wn4_mc1.num_vgpr, 124
	.set .Lbm064_bn192_bk064_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm064_bn192_bk064_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm064_bn192_bk064_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm064_bn192_bk064_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm064_bn192_bk064_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm064_bn192_bk064_wm2_wn4_mc1.uses_flat_scratch, 1
	.set .Lbm064_bn192_bk064_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn192_bk064_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm064_bn192_bk064_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_d56e82a19d0f30e3,@object ; @__hip_cuid_d56e82a19d0f30e3
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_d56e82a19d0f30e3
__hip_cuid_d56e82a19d0f30e3:
	.byte	0                               ; 0x0
	.size	__hip_cuid_d56e82a19d0f30e3, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_d56e82a19d0f30e3
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn192_bk064_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn192_bk064_wm2_wn4_mc1.kd
