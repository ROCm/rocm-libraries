	...
	.section	.text.bm128_bn096_bk032_wm8_wn1_mc0,"axG",@progbits,bm128_bn096_bk032_wm8_wn1_mc0,comdat
	.protected	bm128_bn096_bk032_wm8_wn1_mc0 ; -- Begin function bm128_bn096_bk032_wm8_wn1_mc0
	.globl	bm128_bn096_bk032_wm8_wn1_mc0
	.p2align	8
	.type	bm128_bn096_bk032_wm8_wn1_mc0,@function
bm128_bn096_bk032_wm8_wn1_mc0: ; @bm128_bn096_bk032_wm8_wn1_mc0
; %bb.0:
...
.LBB0_22:
	...
	v_dual_mov_b32 v42, v9 :: v_dual_mov_b32 v17, v9
...
; %bb.23:
	v_dual_lshlrev_b32 v3, 5, v0 :: v_dual_lshlrev_b32 v1, 9, v57
	v_and_b32_e32 v2, 16, v0
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s0, 0x3b80
	s_delay_alu instid0(VALU_DEP_2)
	...
	s_lshr_b32 s4, s4, 2
	v_dual_mov_b32 v53, 0 :: v_dual_bitop2_b32 v5, 24, v5 bitop3:0x40
	...
	s_mov_b32 s43, s5
	s_add_co_i32 s4, s0, 0x5d80
	s_add_co_i32 s42, s0, 0x3b80
	v_add_nc_u32_e32 v50, v4, v1
	v_or_b32_e32 v1, 0x200, v3
	v_or_b32_e32 v4, 0x400, v3
	v_add_nc_u32_e32 v54, v2, v5
	...
	v_dual_lshrrev_b32 v1, 4, v3 :: v_dual_bitop2_b32 v7, 56, v1 bitop3:0x40
	s_lshr_b32 s0, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_and_b32_e32 v3, 0x78, v5
	v_and_b32_e32 v5, 0x98, v6
	v_sub_nc_u32_e32 v6, 0x65f, v0
	s_cselect_b32 s0, s0, 0
	s_ashr_i32 s7, s17, 31
	v_lshrrev_b32_e32 v4, 4, v4
	s_lshr_b32 s7, s7, 27
	v_dual_add_nc_u32 v64, v2, v3 :: v_dual_add_nc_u32 v66, v2, v5
	s_add_co_i32 s17, s17, s7
	v_dual_mov_b32 v3, v53 :: v_dual_lshrrev_b32 v56, 8, v51
	...
	s_lshl_b32 s4, s2, 7
	v_and_b32_e32 v4, 0x58, v4
	v_and_b32_e32 v8, 0xb8, v1
	v_dual_add_nc_u32 v1, 2, v56 :: v_dual_add_nc_u32 v6, 2, v58
	s_ashr_i32 s7, s6, 31
	s_ashr_i32 s5, s4, 31
	s_wait_kmcnt 0x0
	...
	v_dual_add_nc_u32 v60, v2, v7 :: v_dual_bitop2_b32 v61, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v62, v2, v4 :: v_dual_bitop2_b32 v63, 14, v6 bitop3:0x40
	v_dual_add_nc_u32 v68, v2, v8 :: v_dual_mov_b32 v2, v53
	v_dual_mov_b32 v4, v53 :: v_dual_mov_b32 v5, v53
...
.LBB0_27:                               ;   in Loop: Header=BB0_28 Depth=2
	...
	v_cmp_eq_u32_e32 vcc_lo, s6, v61
...
.LBB0_28:                               ;   Parent Loop BB0_25 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s15, v51
	v_cmpx_le_u32_e64 s14, v56
	s_cbranch_execz .LBB0_30
; %bb.29:                               ;   in Loop: Header=BB0_28 Depth=2
	v_mov_b32_e32 v52, v70
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[72:73], v[52:53], 2, s[12:13]
...
.LBB0_33:                               ;   in Loop: Header=BB0_34 Depth=2
	...
	s_add_co_i32 s6, s6, 2
	v_add_nc_u32_e32 v71, 0x200, v71
	v_cmp_eq_u32_e32 vcc_lo, s6, v63
	v_add_nc_u32_e32 v70, 0x200, v70
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
.LBB0_34:                               ;   Parent Loop BB0_25 Depth=1
	...
	s_or_b64 s[14:15], s[6:7], 0x100000000
	s_mov_b32 s7, exec_lo
	v_cmp_le_u32_e32 vcc_lo, s15, v55
	v_cmpx_le_u32_e64 s14, v58
...
; %bb.43:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v65, s14 :: v_dual_mov_b32 v70, s12
...
.LBB0_45:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v65, s5 :: v_dual_mov_b32 v70, s6
...
.LBB0_46:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_lshl_add_u32 v65, v54, 1, s2
	ds_load_b128 v[70:73], v52
	ds_load_b128 v[74:77], v52 offset:16
	v_lshl_add_u32 v52, v60, 1, s2
	ds_load_b128 v[78:81], v65
	ds_load_b128 v[82:85], v65 offset:16
	v_lshl_add_u32 v65, v64, 1, s2
	ds_load_b128 v[86:89], v52 offset:1024
	ds_load_b128 v[90:93], v52 offset:1040
	v_lshl_add_u32 v52, v62, 1, s2
	ds_load_b128 v[94:97], v52 offset:2048
	...
	ds_load_b128 v[98:101], v52 offset:2064
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[70:77], v[94:101], v[2:9] matrix_a_reuse
	ds_load_b128 v[78:81], v65 offset:3072
	ds_load_b128 v[82:85], v65 offset:3088
	v_lshl_add_u32 v65, v66, 1, s2
	...
	ds_load_b128 v[78:81], v65 offset:4096
	ds_load_b128 v[82:85], v65 offset:4112
	v_lshl_add_u32 v65, v68, 1, s2
	ds_load_b128 v[86:89], v65 offset:5120
	ds_load_b128 v[90:93], v65 offset:5136
	s_wait_dscnt 0x2
...
; %bb.48:
	...
	v_cvt_pk_bf16_f32 v16, v38, v39
	v_cvt_pk_bf16_f32 v15, v36, v37
	v_cvt_pk_bf16_f32 v14, v34, v35
	ds_store_b128 v19, v[46:49]
	ds_store_b128 v21, v[22:25] offset:4096
	ds_store_b128 v42, v[6:9] offset:8192
	ds_store_b128 v18, v[2:5] offset:12288
	ds_store_b128 v43, v[10:13] offset:16384
	ds_store_b128 v1, v[14:17] offset:20480
.LBB0_49:
...
.LBB0_60:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn096_bk032_wm8_wn1_mc0, .Lfunc_end0-bm128_bn096_bk032_wm8_wn1_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn096_bk032_wm8_wn1_mc0
	...
	.section	.text.bm128_bn096_bk032_wm8_wn1_mc0,"axG",@progbits,bm128_bn096_bk032_wm8_wn1_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn096_bk032_wm8_wn1_mc0.num_vgpr, 102
	.set .Lbm128_bn096_bk032_wm8_wn1_mc0.num_agpr, 0
	.set .Lbm128_bn096_bk032_wm8_wn1_mc0.numbered_sgpr, 56
	.set .Lbm128_bn096_bk032_wm8_wn1_mc0.num_named_barrier, 0
	.set .Lbm128_bn096_bk032_wm8_wn1_mc0.private_seg_size, 0
	.set .Lbm128_bn096_bk032_wm8_wn1_mc0.uses_vcc, 1
	.set .Lbm128_bn096_bk032_wm8_wn1_mc0.uses_flat_scratch, 0
	.set .Lbm128_bn096_bk032_wm8_wn1_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn096_bk032_wm8_wn1_mc0.has_recursion, 0
	.set .Lbm128_bn096_bk032_wm8_wn1_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_e8a7d1743d3377e8,@object ; @__hip_cuid_e8a7d1743d3377e8
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_e8a7d1743d3377e8
__hip_cuid_e8a7d1743d3377e8:
	.byte	0                               ; 0x0
	.size	__hip_cuid_e8a7d1743d3377e8, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_e8a7d1743d3377e8
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn096_bk032_wm8_wn1_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn096_bk032_wm8_wn1_mc0.kd
