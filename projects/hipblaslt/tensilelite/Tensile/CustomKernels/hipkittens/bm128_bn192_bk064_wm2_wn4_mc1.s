	...
	.section	.text.bm128_bn192_bk064_wm2_wn4_mc1,"axG",@progbits,bm128_bn192_bk064_wm2_wn4_mc1,comdat
	.protected	bm128_bn192_bk064_wm2_wn4_mc1 ; -- Begin function bm128_bn192_bk064_wm2_wn4_mc1
	.globl	bm128_bn192_bk064_wm2_wn4_mc1
	.p2align	8
	.type	bm128_bn192_bk064_wm2_wn4_mc1,@function
bm128_bn192_bk064_wm2_wn4_mc1: ; @bm128_bn192_bk064_wm2_wn4_mc1
; %bb.0:
...
.LBB0_12:
	s_or_saveexec_b32 s36, s38
	s_min_i32 s18, s17, s18
...
; %bb.17:
	v_dual_lshlrev_b32 v2, 6, v103 :: v_dual_bitop2_b32 v3, 16, v0 bitop3:0x40
	v_lshlrev_b32_e32 v4, 6, v0
	v_mul_u32_u24_e32 v1, 0xc00, v105
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s16, 0xaa00
	s_mov_b32 s7, s5
	...
	s_lshr_b32 s4, s4, 2
	v_sub_nc_u32_e32 v17, 0x197f, v0
	...
	v_lshl_or_b32 v128, v0, 2, 0x4000
	v_lshrrev_b32_e32 v7, 4, v7
	s_add_co_i32 s4, s6, 0xee00
	v_dual_add_nc_u32 v98, v5, v4 :: v_dual_lshrrev_b32 v5, 4, v6
	v_or_b32_e32 v6, v3, v1
	v_dual_lshrrev_b32 v8, 4, v8 :: v_dual_bitop2_b32 v10, 32, v3 bitop3:0x54
	v_and_b32_e32 v7, 0x1b8, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v5, 0x178, v5
	v_lshrrev_b32_e32 v9, 4, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_or_b32_e32 v13, v10, v2
	v_dual_mov_b32 v129, v101 :: v_dual_add_nc_u32 v12, 0x800, v6
	v_and_b32_e32 v8, 0x1f8, v8
	v_and_b32_e32 v9, 0x3f8, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_or_b32_e32 v14, 0x800, v13
	v_dual_add_nc_u32 v104, v5, v4 :: v_dual_add_nc_u32 v2, v3, v2
	v_dual_add_nc_u32 v106, v7, v4 :: v_dual_add_nc_u32 v108, v8, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v102, v9, v6 :: v_dual_lshrrev_b32 v9, 4, v12
	v_or_b32_e32 v12, 0x400, v13
	v_dual_lshrrev_b32 v15, 4, v13 :: v_dual_lshrrev_b32 v14, 4, v14
	v_or_b32_e32 v1, v10, v1
	v_or_b32_e32 v13, 0xc00, v13
	v_lshrrev_b32_e32 v12, 4, v12
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v10, 0x138, v15
	v_dual_mov_b32 v4, v101 :: v_dual_add_nc_u32 v15, 0x400, v1
	s_delay_alu instid0(VALU_DEP_4)
	v_lshrrev_b32_e32 v13, 4, v13
	v_add_nc_u32_e32 v11, 0x400, v6
	v_and_b32_e32 v12, 0x1f8, v12
	v_and_b32_e32 v14, 0x1f8, v14
	v_dual_mov_b32 v131, v101 :: v_dual_add_nc_u32 v16, 0x800, v1
	v_lshrrev_b32_e32 v15, 4, v15
	v_and_b32_e32 v13, 0x1f8, v13
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_lshrrev_b32 v16, 4, v16
	v_dual_mov_b32 v5, v101 :: v_dual_add_nc_u32 v114, v10, v2
	v_add3_u32 v116, v2, v12, 0x400
	v_add3_u32 v118, v2, v14, 0x800
	v_add3_u32 v120, v2, v13, 0xc00
	v_dual_mov_b32 v2, v101 :: v_dual_lshrrev_b32 v11, 4, v11
	...
	s_and_b32 s10, s4, 15
	v_dual_add_nc_u32 v112, v9, v6 :: v_dual_add_nc_u32 v122, v18, v6
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v7, v101 :: v_dual_add_nc_u32 v110, v11, v6
	v_add3_u32 v124, v6, v15, 0x400
	v_add3_u32 v126, v6, v16, 0x800
	v_dual_mov_b32 v6, v101 :: v_dual_lshrrev_b32 v1, 8, v17
	s_sub_co_i32 s7, 16, s10
	s_add_co_i32 s45, s6, 0xaa00
	s_lshr_b32 s6, s7, 2
	...
	s_lshl_b32 s10, s6, 2
	s_lshr_b32 s7, s7, 26
	v_dual_mov_b32 v3, v101 :: v_dual_bitop2_b32 v109, 26, v17 bitop3:0x40
	s_add_co_i32 s12, s12, s7
	s_mul_i32 s6, s0, 0xc0
	s_ashr_i32 s47, s12, 6
	s_cmp_lt_i32 s37, 0xc0
	v_lshl_or_b32 v19, v109, 8, v0
	...
	v_dual_mov_b32 v8, v101 :: v_dual_add_nc_u32 v113, 0xffffff00, v19
	v_lshlrev_b32_e32 v130, 2, v19
	v_cmp_ne_u32_e64 s1, v17, v109
...
; %bb.23:                               ;   in Loop: Header=BB0_19 Depth=1
	v_add_nc_u64_e32 v[132:133], s[6:7], v[128:129]
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_lshl_add_u32 v100, v110, 1, s6
	v_lshl_add_u32 v115, v116, 1, s5
	v_lshl_add_u32 v117, v118, 1, s5
	v_lshl_add_u32 v119, v120, 1, s5
	v_lshl_add_u32 v123, v124, 1, s6
	v_lshl_add_u32 v125, v126, 1, s6
	...
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[10:17], v[156:163], v[164:171], v[10:17] matrix_b_reuse
	ds_load_b128 v[164:167], v100 offset:2048
	ds_load_b128 v[168:171], v100 offset:2064
	v_lshl_add_u32 v100, v112, 1, s6
	s_wait_dscnt 0x0
	...
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[164:171], v[180:187], v[10:17] matrix_b_reuse
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn192_bk064_wm2_wn4_mc1, .Lfunc_end0-bm128_bn192_bk064_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn192_bk064_wm2_wn4_mc1
	...
	.section	.text.bm128_bn192_bk064_wm2_wn4_mc1,"axG",@progbits,bm128_bn192_bk064_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn192_bk064_wm2_wn4_mc1.num_vgpr, 188
	.set .Lbm128_bn192_bk064_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm128_bn192_bk064_wm2_wn4_mc1.numbered_sgpr, 60
	.set .Lbm128_bn192_bk064_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm128_bn192_bk064_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm128_bn192_bk064_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm128_bn192_bk064_wm2_wn4_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn192_bk064_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn192_bk064_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm128_bn192_bk064_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_6300e5364e3b458d,@object ; @__hip_cuid_6300e5364e3b458d
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_6300e5364e3b458d
__hip_cuid_6300e5364e3b458d:
	.byte	0                               ; 0x0
	.size	__hip_cuid_6300e5364e3b458d, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_6300e5364e3b458d
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn192_bk064_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     62
    .sgpr_spill_count: 0
    .symbol:         bm128_bn192_bk064_wm2_wn4_mc1.kd
