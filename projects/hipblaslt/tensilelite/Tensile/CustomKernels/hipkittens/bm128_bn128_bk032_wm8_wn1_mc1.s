	...
	.section	.text.bm128_bn128_bk032_wm8_wn1_mc1,"axG",@progbits,bm128_bn128_bk032_wm8_wn1_mc1,comdat
	.protected	bm128_bn128_bk032_wm8_wn1_mc1 ; -- Begin function bm128_bn128_bk032_wm8_wn1_mc1
	.globl	bm128_bn128_bk032_wm8_wn1_mc1
	.p2align	8
	.type	bm128_bn128_bk032_wm8_wn1_mc1,@function
bm128_bn128_bk032_wm8_wn1_mc1: ; @bm128_bn128_bk032_wm8_wn1_mc1
; %bb.0:
...
; %bb.25:
	...
	s_mov_b32 s7, s5
	v_dual_lshlrev_b32 v1, 9, v71 :: v_dual_bitop2_b32 v2, 16, v0 bitop3:0x40
	...
	s_and_b32 s10, s4, 15
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_bitop2_b32 v5, 24, v5 bitop3:0x40
	...
	v_dual_mov_b32 v69, 0 :: v_dual_add_nc_u32 v66, v4, v1
	v_add_nc_u32_e32 v70, v2, v5
	v_and_b32_e32 v5, 0x58, v7
	v_or_b32_e32 v1, 0x600, v3
	v_and_b32_e32 v4, 56, v6
	v_or_b32_e32 v6, 0x800, v3
	v_or_b32_e32 v7, 0xa00, v3
	v_or_b32_e32 v8, 0xc00, v3
	v_or_b32_e32 v3, 0xe00, v3
	...
	v_dual_lshrrev_b32 v8, 4, v8 :: v_dual_lshrrev_b32 v3, 4, v3
	...
	v_dual_add_nc_u32 v1, 2, v72 :: v_dual_add_nc_u32 v76, v2, v5
	s_ashr_i32 s7, s6, 31
	...
	v_and_b32_e32 v75, 30, v1
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v74, v2, v4 :: v_dual_add_nc_u32 v78, v2, v9
	v_dual_add_nc_u32 v80, v2, v6 :: v_dual_add_nc_u32 v82, v2, v7
	v_dual_add_nc_u32 v84, v2, v8 :: v_dual_add_nc_u32 v86, v2, v3
...
; %bb.31:                               ;   in Loop: Header=BB0_30 Depth=2
	...
	v_lshl_add_u64 v[90:91], v[68:69], 2, s[14:15]
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_lshl_add_u32 v77, v70, 1, s2
	ds_load_b128 v[88:91], v68
	ds_load_b128 v[92:95], v68 offset:16
	v_lshl_add_u32 v68, v74, 1, s2
	ds_load_b128 v[96:99], v77
	ds_load_b128 v[100:103], v77 offset:16
	v_lshl_add_u32 v77, v78, 1, s2
	ds_load_b128 v[104:107], v68 offset:1024
	ds_load_b128 v[108:111], v68 offset:1040
	v_lshl_add_u32 v68, v76, 1, s2
	ds_load_b128 v[120:123], v77 offset:3072
	ds_load_b128 v[112:115], v68 offset:2048
	ds_load_b128 v[116:119], v68 offset:2064
	v_lshl_add_u32 v68, v82, 1, s2
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[58:65], v[88:95], v[96:103], v[58:65]
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[50:57], v[88:95], v[104:111], v[50:57] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[88:95], v[112:119], v[26:33] matrix_a_reuse
	ds_load_b128 v[96:99], v68 offset:5120
	ds_load_b128 v[100:103], v68 offset:5136
	v_lshl_add_u32 v68, v84, 1, s2
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[88:95], v[96:103], v[18:25] matrix_a_reuse
	ds_load_b128 v[96:99], v68 offset:6144
	ds_load_b128 v[100:103], v68 offset:6160
	v_lshl_add_u32 v68, v86, 1, s2
	ds_load_b128 v[104:107], v68 offset:7168
	ds_load_b128 v[108:111], v68 offset:7184
	v_lshl_add_u32 v68, v80, 1, s2
	ds_load_b128 v[112:115], v68 offset:4096
	ds_load_b128 v[116:119], v68 offset:4112
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[88:95], v[112:119], v[2:9] matrix_a_reuse
	ds_load_b128 v[124:127], v77 offset:3088
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[88:95], v[96:103], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[88:95], v[104:111], v[42:49] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[88:95], v[120:127], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
...
; %bb.48:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v77, s13 :: v_dual_mov_b32 v88, s14
...
.LBB0_50:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v77, s5 :: v_dual_mov_b32 v88, s6
...
; %bb.52:
	...
	v_dual_lshlrev_b32 v67, 4, v0 :: v_dual_lshrrev_b32 v50, 3, v50
	s_delay_alu instid0(VALU_DEP_4)
	v_lshrrev_b32_e32 v32, 3, v58
	v_or_b32_e32 v58, 0x2000, v1
	v_lshl_or_b32 v51, v71, 5, v51
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_and_b32_e32 v59, 0x3f0, v32
	v_cvt_pk_bf16_f32 v32, v30, v31
	v_cvt_pk_bf16_f32 v30, v26, v27
	v_or_b32_e32 v27, 0x2800, v1
	...
	ds_store_b128 v50, v[30:33] offset:8192
	ds_store_b128 v26, v[14:17] offset:12288
	ds_store_b128 v27, v[6:9] offset:16384
	ds_store_b128 v28, v[2:5] offset:20480
	ds_store_b128 v22, v[10:13] offset:24576
...
.LBB0_64:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn128_bk032_wm8_wn1_mc1, .Lfunc_end0-bm128_bn128_bk032_wm8_wn1_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn128_bk032_wm8_wn1_mc1
	...
	.section	.text.bm128_bn128_bk032_wm8_wn1_mc1,"axG",@progbits,bm128_bn128_bk032_wm8_wn1_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn128_bk032_wm8_wn1_mc1.num_vgpr, 128
	.set .Lbm128_bn128_bk032_wm8_wn1_mc1.num_agpr, 0
	.set .Lbm128_bn128_bk032_wm8_wn1_mc1.numbered_sgpr, 56
	.set .Lbm128_bn128_bk032_wm8_wn1_mc1.num_named_barrier, 0
	.set .Lbm128_bn128_bk032_wm8_wn1_mc1.private_seg_size, 0
	.set .Lbm128_bn128_bk032_wm8_wn1_mc1.uses_vcc, 1
	.set .Lbm128_bn128_bk032_wm8_wn1_mc1.uses_flat_scratch, 0
	.set .Lbm128_bn128_bk032_wm8_wn1_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn128_bk032_wm8_wn1_mc1.has_recursion, 0
	.set .Lbm128_bn128_bk032_wm8_wn1_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_51fdc39f18244f60,@object ; @__hip_cuid_51fdc39f18244f60
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_51fdc39f18244f60
__hip_cuid_51fdc39f18244f60:
	.byte	0                               ; 0x0
	.size	__hip_cuid_51fdc39f18244f60, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_51fdc39f18244f60
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn128_bk032_wm8_wn1_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn128_bk032_wm8_wn1_mc1.kd
