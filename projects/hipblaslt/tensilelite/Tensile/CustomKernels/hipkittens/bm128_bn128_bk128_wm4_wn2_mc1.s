	...
	.section	.text.bm128_bn128_bk128_wm4_wn2_mc1,"axG",@progbits,bm128_bn128_bk128_wm4_wn2_mc1,comdat
	.protected	bm128_bn128_bk128_wm4_wn2_mc1 ; -- Begin function bm128_bn128_bk128_wm4_wn2_mc1
	.globl	bm128_bn128_bk128_wm4_wn2_mc1
	.p2align	8
	.type	bm128_bn128_bk128_wm4_wn2_mc1,@function
bm128_bn128_bk128_wm4_wn2_mc1: ; @bm128_bn128_bk128_wm4_wn2_mc1
; %bb.0:
...
; %bb.10:
	s_cmp_gt_i32 s26, 0
	v_dual_mov_b32 v7, s39 :: v_dual_lshlrev_b32 v1, 16, v1
	...
	s_mov_b32 s47, s46
	s_delay_alu instid0(SALU_CYCLE_1)
	tensor_load_to_lds s[48:51], s[40:47]
.LBB0_11:
...
.LBB0_16:
	...
	v_dual_lshlrev_b32 v1, 4, v75 :: v_dual_lshlrev_b32 v2, 6, v75
	s_and_b32 s40, s3, s25
	s_cmp_lt_i32 s26, 1
	v_cndmask_b32_e64 v67, 0, 1, s40
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v71, 0x60, v1
	v_and_b32_e32 v73, 64, v2
	s_barrier_wait -1
	s_barrier_wait -3
	s_cbranch_scc1 .LBB0_41
; %bb.17:
	s_mov_b64 s[14:15], src_shared_base
	s_add_co_i32 s10, s39, 0x8800
	s_mov_b32 s11, s15
	v_dual_lshlrev_b32 v1, 7, v0 :: v_dual_lshlrev_b32 v2, 7, v73
	s_and_b64 s[34:35], s[10:11], 15
	s_mov_b32 s11, 0
	s_sub_co_i32 s8, 16, s34
	s_delay_alu instid0(VALU_DEP_1)
	...
	s_lshl2_add_u32 s8, s8, s39
	v_lshlrev_b32_e32 v3, 7, v71
	...
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_mov_b32 v69, 0
	...
	v_and_b32_e32 v8, 0x278, v8
	v_add_nc_u32_e32 v66, v7, v5
	v_and_b32_e32 v5, 0x378, v1
	v_dual_add_nc_u32 v3, v4, v3 :: v_dual_mov_b32 v79, v69
	s_ashr_i32 s15, s14, 31
	...
	v_add_nc_u32_e32 v70, v8, v6
	v_cmp_eq_u32_e64 s0, 0, v75
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v72, v5, v3 :: v_dual_add_nc_u32 v76, v7, v3
	v_add3_u32 v74, v4, v2, v8
	v_or_b32_e32 v77, 0x2100, v0
	v_lshl_or_b32 v78, v0, 2, 0x8800
	v_dual_mov_b32 v2, v69 :: v_dual_mov_b32 v3, v69
	v_dual_mov_b32 v4, v69 :: v_dual_mov_b32 v5, v69
	v_dual_mov_b32 v6, v69 :: v_dual_mov_b32 v7, v69
	v_dual_mov_b32 v8, v69 :: v_dual_mov_b32 v9, v69
	v_dual_mov_b32 v10, v69 :: v_dual_mov_b32 v11, v69
	v_dual_mov_b32 v12, v69 :: v_dual_mov_b32 v13, v69
	v_dual_mov_b32 v14, v69 :: v_dual_mov_b32 v15, v69
	v_dual_mov_b32 v16, v69 :: v_dual_mov_b32 v17, v69
	...
	v_dual_mov_b32 v18, v69 :: v_dual_mov_b32 v19, v69
	v_dual_mov_b32 v20, v69 :: v_dual_mov_b32 v21, v69
	v_dual_mov_b32 v22, v69 :: v_dual_mov_b32 v23, v69
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v68, v80 :: v_dual_add_nc_u32 v82, -2, v82
	v_dual_mov_b32 v84, v81 :: v_dual_mov_b32 v85, v69
	v_add_nc_u32_e32 v81, 0x200, v81
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[86:87], v[68:69], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v82
	v_add_nc_u32_e32 v80, 0x200, v80
	v_lshl_add_u64 v[84:85], v[84:85], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[86:87], v69
	flat_store_b32 v[84:85], v69
...
; %bb.23:                               ;   in Loop: Header=BB0_19 Depth=1
	v_add_nc_u64_e32 v[80:81], s[6:7], v[78:79]
...
.LBB0_24:                               ;   Parent Loop BB0_19 Depth=1
	...
	flat_store_b32 v[80:81], v69
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[80:81], 0x400, v[80:81]
	v_cmp_lt_u32_e32 vcc_lo, 0x20ff, v68
	s_or_b32 s6, vcc_lo, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s6
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_lshl_add_u32 v112, v70, 1, s6
	v_lshl_add_u32 v160, v74, 1, s6
	ds_load_b128 v[80:83], v68
	ds_load_b128 v[84:87], v68 offset:16
	ds_load_b128 v[88:91], v68 offset:4352
	ds_load_b128 v[92:95], v68 offset:4368
	ds_load_b128 v[104:107], v112
	ds_load_b128 v[108:111], v112 offset:16
	v_lshl_add_u32 v68, v72, 1, s5
	ds_load_b128 v[128:131], v160 offset:4416
	ds_load_b128 v[132:135], v160 offset:4432
	ds_load_b128 v[136:139], v160 offset:8768
	ds_load_b128 v[140:143], v160 offset:8784
	ds_load_b128 v[116:119], v68 offset:80
	ds_load_b128 v[120:123], v68 offset:4416
	ds_load_b128 v[124:127], v68 offset:4432
	ds_load_b128 v[144:147], v160 offset:13120
	ds_load_b128 v[148:151], v160 offset:13136
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[26:33], v[88:95], v[104:111], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[80:87], v[104:111], v[58:65]
	ds_load_b128 v[104:107], v112 offset:8704
	ds_load_b128 v[108:111], v112 offset:8720
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[80:87], v[104:111], v[42:49] matrix_a_reuse
	ds_load_b128 v[96:99], v112 offset:4352
	ds_load_b128 v[100:103], v112 offset:4368
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[88:95], v[96:103], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[80:87], v[96:103], v[50:57] matrix_a_reuse
	ds_load_b128 v[96:99], v112 offset:13056
	ds_load_b128 v[100:103], v112 offset:13072
	ds_load_b128 v[112:115], v68 offset:64
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[18:25], v[80:87], v[96:103], v[18:25] matrix_a_reuse
	...
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[88:95], v[104:111], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[88:95], v[96:103], v[34:41]
	ds_load_b128 v[88:91], v160 offset:64
	ds_load_b128 v[92:95], v160 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v68, v76, 1, s5
	ds_load_b128 v[80:83], v68 offset:128
	ds_load_b128 v[84:87], v68 offset:144
	ds_load_b128 v[96:99], v68 offset:4480
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[58:65], v[112:119], v[88:95], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[112:119], v[128:135], v[50:57] matrix_a_reuse
	ds_load_b128 v[100:103], v68 offset:4496
	ds_load_b128 v[104:107], v160 offset:128
	ds_load_b128 v[108:111], v160 offset:144
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[112:119], v[136:143], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[112:119], v[144:151], v[18:25] matrix_a_reuse
	ds_load_b128 v[112:115], v160 offset:4480
	ds_load_b128 v[116:119], v160 offset:4496
	ds_load_b128 v[152:155], v160 offset:8832
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[120:127], v[144:151], v[34:41]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[120:127], v[136:143], v[2:9] matrix_a_reuse
	ds_load_b128 v[156:159], v160 offset:8848
	ds_load_b128 v[136:139], v160 offset:13184
	ds_load_b128 v[140:143], v160 offset:13200
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[120:127], v[128:135], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[120:127], v[88:95], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[88:91], v68 offset:192
	ds_load_b128 v[92:95], v68 offset:208
	ds_load_b128 v[120:123], v68 offset:4544
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[58:65], v[80:87], v[104:111], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[50:57], v[80:87], v[112:119], v[50:57] matrix_a_reuse
	ds_load_b128 v[124:127], v68 offset:4560
	ds_load_b128 v[128:131], v160 offset:192
	ds_load_b128 v[132:135], v160 offset:208
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[42:49], v[80:87], v[152:159], v[42:49] matrix_a_reuse
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[18:25], v[80:87], v[136:143], v[18:25] matrix_a_reuse
	ds_load_b128 v[80:83], v160 offset:4544
	ds_load_b128 v[84:87], v160 offset:4560
	ds_load_b128 v[144:147], v160 offset:8896
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[96:103], v[136:143], v[34:41]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[96:103], v[152:159], v[2:9] matrix_a_reuse
	ds_load_b128 v[148:151], v160 offset:8912
	ds_load_b128 v[136:139], v160 offset:13248
	ds_load_b128 v[140:143], v160 offset:13264
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[96:103], v[112:119], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[96:103], v[104:111], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x6
	...
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[50:57], v[88:95], v[80:87], v[50:57] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[42:49], v[88:95], v[144:151], v[42:49] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[88:95], v[136:143], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[120:127], v[136:143], v[34:41]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[120:127], v[144:151], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[120:127], v[80:87], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[120:127], v[128:135], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_40:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_nop
	v_dual_mov_b32 v81, s5 :: v_dual_mov_b32 v80, s6
	s_bitset1_b32 s7, 31
	v_readfirstlane_b32 s16, v68
	v_mov_b32_e32 v83, s7
	s_delay_alu instid0(VALU_DEP_3)
	v_readfirstlane_b32 s17, v81
	v_readfirstlane_b32 s18, v80
	s_lshr_b64 s[6:7], s[28:29], 16
	s_lshl_b32 s5, s28, 16
	v_readfirstlane_b32 s19, v83
	s_mov_b32 s7, s47
	s_mov_b32 s10, s11
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
; %bb.43:
	...
	v_add_nc_u32_e32 v50, 0x1800, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v45, 16, v1 :: v_dual_lshrrev_b32 v44, 3, v51
	v_dual_lshrrev_b32 v42, 3, v42 :: v_dual_lshlrev_b32 v51, 1, v1
	v_cvt_pk_bf16_f32 v55, v52, v53
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v52, 3, v45 :: v_dual_lshrrev_b32 v50, 3, v50
	v_and_b32_e32 v44, 0xff0, v44
	...
	v_add_nc_u32_e32 v28, 0x1010, v1
	ds_store_b128 v43, v[62:65]
	ds_store_b128 v44, v[54:57] offset:4096
	v_add_nc_u32_e32 v44, 0x810, v1
	v_add_nc_u32_e32 v1, 0x1810, v1
	...
	v_and_b32_e32 v52, 0x5f0, v52
	v_add_nc_u32_e32 v27, v50, v51
	v_and_b32_e32 v26, 0xff0, v26
	v_cvt_pk_bf16_f32 v22, v18, v19
	v_and_b32_e32 v19, 0xff0, v20
	v_and_b32_e32 v1, 0xff0, v1
	v_dual_add_nc_u32 v42, v42, v51 :: v_dual_add_nc_u32 v43, v52, v51
	...
	ds_store_b128 v42, v[46:49] offset:8192
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn128_bk128_wm4_wn2_mc1, .Lfunc_end0-bm128_bn128_bk128_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn128_bk128_wm4_wn2_mc1
	...
	.section	.text.bm128_bn128_bk128_wm4_wn2_mc1,"axG",@progbits,bm128_bn128_bk128_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn128_bk128_wm4_wn2_mc1.num_vgpr, 161
	.set .Lbm128_bn128_bk128_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm128_bn128_bk128_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm128_bn128_bk128_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm128_bn128_bk128_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm128_bn128_bk128_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm128_bn128_bk128_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn128_bk128_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn128_bk128_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm128_bn128_bk128_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_85f6c460a9a6de52,@object ; @__hip_cuid_85f6c460a9a6de52
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_85f6c460a9a6de52
__hip_cuid_85f6c460a9a6de52:
	.byte	0                               ; 0x0
	.size	__hip_cuid_85f6c460a9a6de52, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_85f6c460a9a6de52
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn128_bk128_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn128_bk128_wm4_wn2_mc1.kd
