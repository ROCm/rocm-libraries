	...
	.section	.text.bm128_bn064_bk096_wm2_wn4_mc1,"axG",@progbits,bm128_bn064_bk096_wm2_wn4_mc1,comdat
	.protected	bm128_bn064_bk096_wm2_wn4_mc1 ; -- Begin function bm128_bn064_bk096_wm2_wn4_mc1
	.globl	bm128_bn064_bk096_wm2_wn4_mc1
	.p2align	8
	.type	bm128_bn064_bk096_wm2_wn4_mc1,@function
bm128_bn064_bk096_wm2_wn4_mc1: ; @bm128_bn064_bk096_wm2_wn4_mc1
; %bb.0:
...
.LBB0_20:
	...
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v43, 64, v1 bitop3:0x40
	v_dual_mov_b32 v7, v9 :: v_dual_bitop2_b32 v45, 48, v1 bitop3:0x40
...
; %bb.21:
	...
	s_lshl2_add_u32 s6, s4, s17
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v5, 0x3f8, v5
	s_add_co_i32 s4, s6, 0xff00
	s_add_co_i32 s45, s6, 0x9900
	s_and_b32 s10, s4, 15
	v_dual_mov_b32 v31, v37 :: v_dual_mov_b32 v32, v37
	v_dual_add_nc_u32 v34, v5, v9 :: v_dual_bitop2_b32 v4, v4, v3 bitop3:0x54
	s_sub_co_i32 s7, 16, s10
	v_mov_b32_e32 v33, v37
	s_lshr_b32 s6, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_mad_u32_u24 v4, 0x60, v2, v4
	...
	v_add_nc_u32_e32 v44, v14, v9
	v_dual_mov_b32 v11, v37 :: v_dual_add_nc_u32 v14, 0x1200, v20
	...
	v_add_nc_u32_e32 v15, 2, v40
	v_cmp_eq_u32_e64 s0, 0, v39
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v23, v37 :: v_dual_mov_b32 v24, v37
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v15, v37 :: v_dual_bitop2_b32 v51, 30, v15 bitop3:0x40
	v_dual_lshrrev_b32 v3, 4, v3 :: v_dual_lshrrev_b32 v10, 4, v10
	v_dual_add_nc_u32 v35, -1, v40 :: v_dual_mov_b32 v69, v37
	v_mov_b32_e32 v25, v37
	v_and_b32_e32 v6, 0x3ff8, v3
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v8, 0x3ff8, v10
	v_and_b32_e32 v10, 0x3ff8, v12
	v_add_nc_u32_e32 v12, 0x600, v20
	v_add_nc_u32_e32 v48, v16, v9
	s_lshr_b32 s49, s3, 16
	s_lshr_b32 s50, s37, 16
	v_add_nc_u64_e32 v[64:65], v[10:11], v[14:15]
	v_dual_mov_b32 v10, v37 :: v_dual_lshrrev_b32 v3, 8, v13
	v_mov_b32_e32 v13, v37
	s_add_nc_u64 s[20:21], s[26:27], s[6:7]
	v_dual_mov_b32 v16, v37 :: v_dual_mov_b32 v22, v37
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add_nc_u32_e32 v3, 1, v3
	v_add_nc_u64_e32 v[46:47], v[36:37], v[12:13]
	v_add_nc_u32_e32 v36, 0xc00, v20
	v_mov_b32_e32 v26, v37
	s_lshl_b64 s[6:7], s[18:19], 1
	v_and_b32_e32 v49, 26, v3
	s_mov_b32 s44, s5
	s_add_nc_u64 s[40:41], s[4:5], s[10:11]
	s_mov_b32 s47, s39
	s_or_b32 s49, s49, 0x600000
	v_cmp_ne_u32_e64 s1, v3, v49
	...
	v_dual_mov_b32 v7, v37 :: v_dual_add_nc_u32 v58, v18, v20
	v_add_nc_u32_e32 v47, 0xffffff00, v21
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_dual_lshlrev_b32 v68, 2, v21 :: v_dual_add_nc_u32 v56, v17, v2
	v_dual_add_nc_u32 v66, v19, v2 :: v_dual_mov_b32 v2, v37
	v_dual_lshrrev_b32 v5, 4, v5 :: v_dual_mov_b32 v17, v37
	...
	v_add_nc_u32_e32 v42, v5, v9
	v_dual_mov_b32 v5, v37 :: v_dual_mov_b32 v9, v37
	v_add_nc_u64_e32 v[60:61], v[6:7], v[12:13]
	v_dual_mov_b32 v6, v37 :: v_dual_mov_b32 v12, v37
	v_add_nc_u64_e32 v[54:55], v[4:5], v[14:15]
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u64_e32 v[62:63], v[8:9], v[36:37]
	v_dual_mov_b32 v4, v37 :: v_dual_mov_b32 v8, v37
...
.LBB0_30:                               ;   in Loop: Header=BB0_31 Depth=2
	...
	v_add_nc_u32_e32 v71, 0x200, v71
	v_cmp_eq_u32_e32 vcc_lo, s14, v51
	v_add_nc_u32_e32 v70, 0x200, v70
...
; %bb.47:
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_lshlrev_b32 v34, 7, v34 :: v_dual_bitop2_b32 v1, 8, v1 bitop3:0x40
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn064_bk096_wm2_wn4_mc1, .Lfunc_end0-bm128_bn064_bk096_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn064_bk096_wm2_wn4_mc1
	...
	.section	.text.bm128_bn064_bk096_wm2_wn4_mc1,"axG",@progbits,bm128_bn064_bk096_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn064_bk096_wm2_wn4_mc1.num_vgpr, 138
	.set .Lbm128_bn064_bk096_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm128_bn064_bk096_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm128_bn064_bk096_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm128_bn064_bk096_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm128_bn064_bk096_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm128_bn064_bk096_wm2_wn4_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn064_bk096_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn064_bk096_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm128_bn064_bk096_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_d7f76b4825837d27,@object ; @__hip_cuid_d7f76b4825837d27
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_d7f76b4825837d27
__hip_cuid_d7f76b4825837d27:
	.byte	0                               ; 0x0
	.size	__hip_cuid_d7f76b4825837d27, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_d7f76b4825837d27
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn064_bk096_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn064_bk096_wm2_wn4_mc1.kd
