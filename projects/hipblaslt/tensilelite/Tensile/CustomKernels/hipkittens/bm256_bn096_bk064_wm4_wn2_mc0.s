	...
	.section	.text.bm256_bn096_bk064_wm4_wn2_mc0,"axG",@progbits,bm256_bn096_bk064_wm4_wn2_mc0,comdat
	.protected	bm256_bn096_bk064_wm4_wn2_mc0 ; -- Begin function bm256_bn096_bk064_wm4_wn2_mc0
	.globl	bm256_bn096_bk064_wm4_wn2_mc0
	.p2align	8
	.type	bm256_bn096_bk064_wm4_wn2_mc0,@function
bm256_bn096_bk064_wm4_wn2_mc0: ; @bm256_bn096_bk064_wm4_wn2_mc0
; %bb.0:
...
.LBB0_4:                                ; =>This Inner Loop Header: Depth=1
	...
	v_cmp_lt_u32_e32 vcc_lo, 0x20ff, v2
...
; %bb.19:
	...
	v_dual_lshlrev_b32 v2, 6, v107 :: v_dual_lshlrev_b32 v3, 6, v105
	s_mov_b64 s[6:7], src_shared_base
	s_or_b32 s4, s0, 0xbb00
	s_delay_alu instid0(VALU_DEP_2)
	v_and_or_b32 v4, 0x3c0, v4, v1
	s_mov_b32 s5, s7
	s_mov_b32 s43, s7
	s_and_b64 s[4:5], s[4:5], 15
	v_or_b32_e32 v113, 0x2100, v0
	v_or_b32_e32 v5, v4, v3
	s_sub_co_i32 s6, 16, s4
	v_lshl_or_b32 v130, v0, 2, 0x8800
	s_lshr_b32 s6, s6, 2
	...
	s_mul_i32 s4, s34, 0x60
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_lshrrev_b32 v1, 4, v5
	v_or_b32_e32 v7, 0x800, v5
	v_or_b32_e32 v8, 0xc00, v5
	s_add_co_i32 s6, s0, 0x14300
	s_add_co_i32 s42, s0, 0xbb00
	v_and_b32_e32 v1, 0x338, v1
	s_and_b32 s10, s6, 15
	v_and_b32_e32 v6, 0x378, v6
	s_sub_co_i32 s5, 16, s10
	s_movk_i32 s16, 0x60
	v_dual_add_nc_u32 v98, v1, v5 :: v_dual_lshrrev_b32 v1, 4, v7
	v_dual_mov_b32 v101, 0 :: v_dual_bitop2_b32 v7, v2, v4 bitop3:0x54
	s_lshr_b32 s0, s5, 2
	s_cmp_lg_u64 s[10:11], 0
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_and_b32_e32 v9, 0x3b8, v1
	v_lshrrev_b32_e32 v1, 4, v7
	v_add_nc_u32_e32 v11, 0x400, v7
	v_or_b32_e32 v10, 32, v4
	v_dual_mov_b32 v131, v101 :: v_dual_add_nc_u32 v12, 0x800, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v1, 0xf8, v1
	v_dual_lshrrev_b32 v11, 4, v11 :: v_dual_lshrrev_b32 v8, 4, v8
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v12, 4, v12 :: v_dual_bitop2_b32 v13, v10, v3 bitop3:0x54
	v_dual_add_nc_u32 v102, v1, v7 :: v_dual_bitop2_b32 v10, v10, v2 bitop3:0x54
	v_sub_nc_u32_e32 v18, 0xcbf, v0
	s_delay_alu instid0(VALU_DEP_3)
	v_or_b32_e32 v1, 0x400, v13
	v_lshrrev_b32_e32 v14, 4, v13
	v_or_b32_e32 v15, 0x800, v13
	v_or_b32_e32 v13, 0xc00, v13
	...
	v_dual_mov_b32 v4, v101 :: v_dual_add_nc_u32 v1, 0x400, v10
	...
	v_dual_add_nc_u32 v106, v6, v5 :: v_dual_add_nc_u32 v108, v9, v5
	s_lshr_b32 s5, s5, 26
	v_add_nc_u32_e32 v116, v14, v3
	s_add_co_i32 s17, s17, s5
	v_add3_u32 v118, v3, v16, 0x400
	v_add3_u32 v120, v3, v15, 0x800
	v_add3_u32 v122, v3, v13, 0xc00
	v_dual_mov_b32 v3, v101 :: v_dual_lshrrev_b32 v1, 4, v1
	v_dual_lshrrev_b32 v104, 8, v18 :: v_dual_mov_b32 v6, v101
	...
	v_dual_add_nc_u32 v99, -1, v104 :: v_dual_bitop2_b32 v111, 30, v18 bitop3:0x40
	v_dual_add_nc_u32 v110, v8, v5 :: v_dual_add_nc_u32 v112, v11, v7
	v_dual_add_nc_u32 v114, v12, v7 :: v_dual_add_nc_u32 v124, v10, v2
	v_add3_u32 v126, v2, v19, 0x400
	v_add3_u32 v128, v2, v17, 0x800
	v_dual_mov_b32 v2, v101 :: v_dual_mov_b32 v5, v101
...
.LBB0_23:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_dual_mov_b32 v100, v132 :: v_dual_add_nc_u32 v115, -2, v115
	v_dual_mov_b32 v134, v133 :: v_dual_mov_b32 v135, v101
	v_add_nc_u32_e32 v133, 0x200, v133
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[136:137], v[100:101], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v115
	v_add_nc_u32_e32 v132, 0x200, v132
	v_lshl_add_u64 v[134:135], v[134:135], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[136:137], v101
	flat_store_b32 v[134:135], v101
...
.LBB0_26:                               ;   Parent Loop BB0_21 Depth=1
	...
	flat_store_b32 v[132:133], v101
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[132:133], 0x400, v[132:133]
	v_cmp_lt_u32_e32 vcc_lo, 0x20ff, v100
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s12, v99
	v_cmpx_le_u32_e64 s12, v104
	s_cbranch_execz .LBB0_31
; %bb.30:                               ;   in Loop: Header=BB0_29 Depth=2
	v_mov_b32_e32 v100, v132
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[134:135], v[100:101], 2, s[6:7]
	flat_store_b32 v[134:135], v101
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_dual_mov_b32 v115, s5 :: v_dual_mov_b32 v132, s6
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v115, v106, 1, s0
	v_lshl_add_u32 v117, v108, 1, s0
	v_lshl_add_u32 v119, v110, 1, s0
	v_lshl_add_u32 v121, v124, 1, s2
	ds_load_b128 v[132:135], v100
	ds_load_b128 v[136:139], v100 offset:16
	v_lshl_add_u32 v100, v102, 1, s2
	ds_load_b128 v[140:143], v115 offset:2048
	ds_load_b128 v[144:147], v115 offset:2064
	ds_load_b128 v[148:151], v117 offset:4096
	ds_load_b128 v[152:155], v117 offset:4112
	ds_load_b128 v[156:159], v119 offset:6144
	ds_load_b128 v[164:167], v100
	ds_load_b128 v[168:171], v100 offset:16
	ds_load_b128 v[160:163], v119 offset:6160
	v_lshl_add_u32 v100, v112, 1, s2
	v_lshl_add_u32 v115, v118, 1, s0
	v_lshl_add_u32 v117, v120, 1, s0
	v_lshl_add_u32 v119, v122, 1, s0
	v_lshl_add_u32 v123, v126, 1, s2
	v_lshl_add_u32 v125, v128, 1, s2
	ds_load_b128 v[180:183], v121 offset:64
	ds_load_b128 v[184:187], v121 offset:80
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[90:97], v[132:139], v[164:171], v[90:97]
	v_wmma_f32_16x16x32_bf16 v[66:73], v[140:147], v[164:171], v[66:73] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[148:155], v[164:171], v[34:41] matrix_b_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[18:25], v[156:163], v[164:171], v[18:25] matrix_b_reuse
	ds_load_b128 v[164:167], v100 offset:2048
	ds_load_b128 v[168:171], v100 offset:2064
	v_lshl_add_u32 v100, v114, 1, s2
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[140:147], v[164:171], v[58:65] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[132:139], v[164:171], v[82:89] matrix_b_reuse
	ds_load_b128 v[172:175], v100 offset:4096
	ds_load_b128 v[176:179], v100 offset:4112
	v_lshl_add_u32 v100, v116, 1, s0
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[74:81], v[132:139], v[172:179], v[74:81] matrix_a_reuse
	ds_load_b128 v[132:135], v100 offset:64
	ds_load_b128 v[136:139], v100 offset:80
	v_wmma_f32_16x16x32_bf16 v[42:49], v[140:147], v[172:179], v[42:49] matrix_b_reuse
	ds_load_b128 v[140:143], v115 offset:64
	ds_load_b128 v[144:147], v115 offset:80
	v_wmma_f32_16x16x32_bf16 v[10:17], v[148:155], v[172:179], v[10:17] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[156:163], v[172:179], v[50:57] matrix_b_reuse
	ds_load_b128 v[172:175], v125 offset:64
	ds_load_b128 v[176:179], v125 offset:80
	; sched_group_barrier mask(0x00000008) size(6) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[156:163], v[164:171], v[2:9] matrix_a_reuse
	ds_load_b128 v[156:159], v123 offset:64
	ds_load_b128 v[160:163], v123 offset:80
	v_wmma_f32_16x16x32_bf16 v[26:33], v[148:155], v[164:171], v[26:33] matrix_b_reuse
	ds_load_b128 v[148:151], v117 offset:64
	ds_load_b128 v[152:155], v117 offset:80
	ds_load_b128 v[164:167], v119 offset:64
	ds_load_b128 v[168:171], v119 offset:80
	; sched_group_barrier mask(0x00000008) size(6) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[90:97], v[132:139], v[180:187], v[90:97]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[66:73], v[140:147], v[180:187], v[66:73] matrix_b_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[34:41], v[148:155], v[180:187], v[34:41] matrix_b_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[164:171], v[180:187], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[164:171], v[156:163], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[148:155], v[156:163], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(6) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[140:147], v[156:163], v[58:65] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[132:139], v[156:163], v[82:89] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[74:81], v[132:139], v[172:179], v[74:81] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[140:147], v[172:179], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[148:155], v[172:179], v[10:17] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[164:171], v[172:179], v[50:57] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(6) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn096_bk064_wm4_wn2_mc0, .Lfunc_end0-bm256_bn096_bk064_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn096_bk064_wm4_wn2_mc0
	...
	.section	.text.bm256_bn096_bk064_wm4_wn2_mc0,"axG",@progbits,bm256_bn096_bk064_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm256_bn096_bk064_wm4_wn2_mc0.num_vgpr, 188
	.set .Lbm256_bn096_bk064_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm256_bn096_bk064_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm256_bn096_bk064_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm256_bn096_bk064_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm256_bn096_bk064_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm256_bn096_bk064_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm256_bn096_bk064_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm256_bn096_bk064_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm256_bn096_bk064_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_eedf3c30f8e6fb90,@object ; @__hip_cuid_eedf3c30f8e6fb90
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_eedf3c30f8e6fb90
__hip_cuid_eedf3c30f8e6fb90:
	.byte	0                               ; 0x0
	.size	__hip_cuid_eedf3c30f8e6fb90, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_eedf3c30f8e6fb90
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn096_bk064_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn096_bk064_wm4_wn2_mc0.kd
