	...
	.section	.text.bm256_bn128_bk128_wm4_wn2_mc1,"axG",@progbits,bm256_bn128_bk128_wm4_wn2_mc1,comdat
	.protected	bm256_bn128_bk128_wm4_wn2_mc1 ; -- Begin function bm256_bn128_bk128_wm4_wn2_mc1
	.globl	bm256_bn128_bk128_wm4_wn2_mc1
	.p2align	8
	.type	bm256_bn128_bk128_wm4_wn2_mc1,@function
bm256_bn128_bk128_wm4_wn2_mc1: ; @bm256_bn128_bk128_wm4_wn2_mc1
; %bb.0:
...
.LBB0_8:
	...
	s_and_b32 s0, s0, 12
	s_lshl2_add_u32 s42, s5, 0x11000
...
; %bb.17:
	...
	s_lshl2_add_u32 s6, s4, s42
	v_or_b32_e32 v1, v4, v3
	s_add_co_i32 s4, s6, 0x19800
	s_add_co_i32 s44, s6, 0x8800
	s_and_b32 s10, s4, 15
	...
	v_dual_mov_b32 v133, 0 :: v_dual_add_nc_u32 v130, v6, v1
	...
	v_dual_mov_b32 v141, v133 :: v_dual_add_nc_u32 v134, v7, v5
	v_cmp_eq_u32_e64 s0, 0, v139
	v_or_b32_e32 v1, 0x100, v0
	v_add3_u32 v136, v4, v3, v6
	v_add3_u32 v138, v4, v2, v7
	v_or_b32_e32 v146, 0x4300, v0
	v_or_b32_e32 v140, 0x11000, v132
	v_or_b32_e32 v147, 0x2100, v0
	v_or_b32_e32 v142, 0x8800, v132
	v_dual_mov_b32 v143, v133 :: v_dual_mov_b32 v2, v133
	...
	v_dual_mov_b32 v17, v133 :: v_dual_mov_b32 v26, v133
	...
	v_dual_mov_b32 v25, v133 :: v_dual_mov_b32 v34, v133
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v132, v144 :: v_dual_add_nc_u32 v148, -2, v148
	v_dual_mov_b32 v150, v145 :: v_dual_mov_b32 v151, v133
	v_add_nc_u32_e32 v145, 0x200, v145
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[152:153], v[132:133], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v148
	v_add_nc_u32_e32 v144, 0x200, v144
	v_lshl_add_u64 v[150:151], v[150:151], 2, s[6:7]
	s_clause 0x1
...
; %bb.23:                               ;   in Loop: Header=BB0_19 Depth=1
	v_add_nc_u64_e32 v[144:145], s[6:7], v[140:141]
...
.LBB0_24:                               ;   Parent Loop BB0_19 Depth=1
	...
	flat_store_b32 v[144:145], v133
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[144:145], 0x400, v[144:145]
...
; %bb.28:                               ;   in Loop: Header=BB0_19 Depth=1
	v_add_nc_u64_e32 v[144:145], s[6:7], v[142:143]
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_cselect_b32 s6, s38, s42
	v_lshl_add_u32 v132, v130, 1, s5
	v_lshl_add_u32 v144, v134, 1, s6
	ds_load_b128 v[148:151], v132
	ds_load_b128 v[152:155], v132 offset:16
	ds_load_b128 v[156:159], v132 offset:4352
	ds_load_b128 v[160:163], v132 offset:4368
	ds_load_b128 v[180:183], v144 offset:8704
	ds_load_b128 v[184:187], v144 offset:8720
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[106:113], v[148:155], v[180:187], v[106:113] matrix_a_reuse
	ds_load_b128 v[172:175], v144 offset:13056
	ds_load_b128 v[176:179], v144 offset:13072
	v_wmma_f32_16x16x32_bf16 v[66:73], v[156:163], v[180:187], v[66:73] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[98:105], v[148:155], v[172:179], v[98:105] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[156:163], v[172:179], v[50:57]
	ds_load_b128 v[164:167], v132 offset:13056
	ds_load_b128 v[168:171], v132 offset:13072
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[74:81], v[164:171], v[172:179], v[74:81]
	ds_load_b128 v[196:199], v144
	ds_load_b128 v[200:203], v144 offset:16
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[90:97], v[156:163], v[196:203], v[90:97] matrix_a_reuse
	ds_load_b128 v[188:191], v144 offset:4352
	ds_load_b128 v[192:195], v144 offset:4368
	v_lshl_add_u32 v144, v138, 1, s6
	ds_load_b128 v[212:215], v144 offset:4416
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[114:121], v[148:155], v[188:195], v[114:121] matrix_a_reuse
	ds_load_b128 v[216:219], v144 offset:4432
	ds_load_b128 v[220:223], v144 offset:8768
	ds_load_b128 v[224:227], v144 offset:8784
	ds_load_b128 v[228:231], v144 offset:13120
	ds_load_b128 v[232:235], v144 offset:13136
	v_wmma_f32_16x16x32_bf16 v[82:89], v[156:163], v[188:195], v[82:89] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[164:171], v[180:187], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[164:171], v[188:195], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[122:129], v[148:155], v[196:203], v[122:129]
	ds_load_b128 v[148:151], v144 offset:64
	ds_load_b128 v[152:155], v144 offset:80
	v_wmma_f32_16x16x32_bf16 v[26:33], v[164:171], v[196:203], v[26:33] matrix_a_reuse
	ds_load_b128 v[164:167], v132 offset:8704
	ds_load_b128 v[168:171], v132 offset:8720
	v_lshl_add_u32 v132, v136, 1, s5
	ds_load_b128 v[204:207], v132 offset:13120
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[18:25], v[164:171], v[172:179], v[18:25] matrix_a_reuse
	ds_load_b128 v[208:211], v132 offset:13136
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[164:171], v[196:203], v[58:65]
	ds_load_b128 v[196:199], v132 offset:8768
	ds_load_b128 v[200:203], v132 offset:8784
	v_wmma_f32_16x16x32_bf16 v[42:49], v[164:171], v[188:195], v[42:49] matrix_a_reuse
	ds_load_b128 v[188:191], v132 offset:4416
	ds_load_b128 v[192:195], v132 offset:4432
	v_wmma_f32_16x16x32_bf16 v[34:41], v[164:171], v[180:187], v[34:41] matrix_a_reuse
	ds_load_b128 v[164:167], v132 offset:64
	ds_load_b128 v[168:171], v132 offset:80
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[156:159], v132 offset:128
	ds_load_b128 v[160:163], v132 offset:144
	ds_load_b128 v[172:175], v132 offset:4480
	ds_load_b128 v[176:179], v132 offset:4496
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[122:129], v[164:171], v[148:155], v[122:129]
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[114:121], v[164:171], v[212:219], v[114:121] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[106:113], v[164:171], v[220:227], v[106:113] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[98:105], v[164:171], v[228:235], v[98:105] matrix_a_reuse
	ds_load_b128 v[164:167], v132 offset:8832
	ds_load_b128 v[168:171], v132 offset:8848
	ds_load_b128 v[180:183], v132 offset:13184
	ds_load_b128 v[184:187], v132 offset:13200
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[188:195], v[228:235], v[50:57]
	v_wmma_f32_16x16x32_bf16 v[66:73], v[188:195], v[220:227], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[188:195], v[212:219], v[82:89] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[90:97], v[188:195], v[148:155], v[90:97] matrix_a_reuse
	ds_load_b128 v[188:191], v144 offset:128
	ds_load_b128 v[192:195], v144 offset:144
	ds_load_b128 v[236:239], v144 offset:4480
	ds_load_b128 v[240:243], v144 offset:4496
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[196:203], v[148:155], v[58:65]
	v_wmma_f32_16x16x32_bf16 v[42:49], v[196:203], v[212:219], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[196:203], v[220:227], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[196:203], v[228:235], v[18:25] matrix_a_reuse
	ds_load_b128 v[196:199], v144 offset:8832
	ds_load_b128 v[200:203], v144 offset:8848
	ds_load_b128 v[244:247], v144 offset:13184
	ds_load_b128 v[248:251], v144 offset:13200
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[74:81], v[204:211], v[228:235], v[74:81]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[204:211], v[220:227], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[204:211], v[212:219], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[204:211], v[148:155], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[148:151], v132 offset:192
	ds_load_b128 v[152:155], v132 offset:208
	ds_load_b128 v[204:207], v132 offset:4544
	ds_load_b128 v[208:211], v132 offset:4560
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[122:129], v[156:163], v[188:195], v[122:129]
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[114:121], v[156:163], v[236:243], v[114:121] matrix_a_reuse
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[106:113], v[156:163], v[196:203], v[106:113] matrix_a_reuse
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[98:105], v[156:163], v[244:251], v[98:105] matrix_a_reuse
	ds_load_b128 v[156:159], v132 offset:8896
	ds_load_b128 v[160:163], v132 offset:8912
	ds_load_b128 v[212:215], v132 offset:13248
	ds_load_b128 v[216:219], v132 offset:13264
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[172:179], v[244:251], v[50:57]
	v_wmma_f32_16x16x32_bf16 v[66:73], v[172:179], v[196:203], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[172:179], v[236:243], v[82:89] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[90:97], v[172:179], v[188:195], v[90:97] matrix_a_reuse
	ds_load_b128 v[172:175], v144 offset:192
	ds_load_b128 v[176:179], v144 offset:208
	ds_load_b128 v[220:223], v144 offset:4544
	ds_load_b128 v[224:227], v144 offset:4560
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[164:171], v[188:195], v[58:65]
	v_wmma_f32_16x16x32_bf16 v[42:49], v[164:171], v[236:243], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[164:171], v[196:203], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[164:171], v[244:251], v[18:25] matrix_a_reuse
	ds_load_b128 v[164:167], v144 offset:8896
	ds_load_b128 v[168:171], v144 offset:8912
	ds_load_b128 v[228:231], v144 offset:13248
	ds_load_b128 v[232:235], v144 offset:13264
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[74:81], v[180:187], v[244:251], v[74:81]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[180:187], v[196:203], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[180:187], v[236:243], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[180:187], v[188:195], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[122:129], v[148:155], v[172:179], v[122:129]
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[114:121], v[148:155], v[220:227], v[114:121] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[106:113], v[148:155], v[164:171], v[106:113] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[98:105], v[148:155], v[228:235], v[98:105] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[204:211], v[228:235], v[50:57]
	v_wmma_f32_16x16x32_bf16 v[66:73], v[204:211], v[164:171], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[204:211], v[220:227], v[82:89] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[90:97], v[204:211], v[172:179], v[90:97] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[156:163], v[172:179], v[58:65]
	v_wmma_f32_16x16x32_bf16 v[42:49], v[156:163], v[220:227], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[156:163], v[164:171], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[156:163], v[228:235], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[74:81], v[212:219], v[228:235], v[74:81]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[212:219], v[164:171], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[212:219], v[220:227], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[212:219], v[172:179], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.38:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_dual_mov_b32 v145, s13 :: v_dual_mov_b32 v144, s14
...
.LBB0_40:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v145, s5 :: v_dual_mov_b32 v144, s6
	s_bitset1_b32 s7, 31
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn128_bk128_wm4_wn2_mc1, .Lfunc_end0-bm256_bn128_bk128_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn128_bk128_wm4_wn2_mc1
	...
	.section	.text.bm256_bn128_bk128_wm4_wn2_mc1,"axG",@progbits,bm256_bn128_bk128_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm256_bn128_bk128_wm4_wn2_mc1.num_vgpr, 252
	.set .Lbm256_bn128_bk128_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm256_bn128_bk128_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm256_bn128_bk128_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm256_bn128_bk128_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm256_bn128_bk128_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm256_bn128_bk128_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm256_bn128_bk128_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm256_bn128_bk128_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm256_bn128_bk128_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_7f31d3b404efb074,@object ; @__hip_cuid_7f31d3b404efb074
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_7f31d3b404efb074
__hip_cuid_7f31d3b404efb074:
	.byte	0                               ; 0x0
	.size	__hip_cuid_7f31d3b404efb074, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_7f31d3b404efb074
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn128_bk128_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn128_bk128_wm4_wn2_mc1.kd
