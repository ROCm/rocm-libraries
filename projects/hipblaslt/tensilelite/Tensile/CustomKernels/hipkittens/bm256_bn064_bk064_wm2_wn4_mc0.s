	...
	.section	.text.bm256_bn064_bk064_wm2_wn4_mc0,"axG",@progbits,bm256_bn064_bk064_wm2_wn4_mc0,comdat
	.protected	bm256_bn064_bk064_wm2_wn4_mc0 ; -- Begin function bm256_bn064_bk064_wm2_wn4_mc0
	.globl	bm256_bn064_bk064_wm2_wn4_mc0
	.p2align	8
	.type	bm256_bn064_bk064_wm2_wn4_mc0,@function
bm256_bn064_bk064_wm2_wn4_mc0: ; @bm256_bn064_bk064_wm2_wn4_mc0
; %bb.0:
...
; %bb.19:
	...
	v_add_nc_u32_e32 v66, v9, v5
	v_and_b32_e32 v8, 0x278, v1
	v_or_b32_e32 v14, 0x1400, v5
	v_or_b32_e32 v15, 0x1800, v5
	v_or_b32_e32 v16, 0x1c00, v5
	v_add_nc_u32_e32 v70, v17, v12
	v_and_b32_e32 v12, 0x3f8, v1
	v_sub_nc_u32_e32 v1, 0x87f, v0
	s_cselect_b32 s6, s6, 0
	s_ashr_i32 s7, s17, 31
	v_and_b32_e32 v11, 0x2f8, v7
	s_lshr_b32 s7, s7, 26
	v_dual_lshrrev_b32 v14, 4, v14 :: v_dual_lshrrev_b32 v15, 4, v15
	s_add_co_i32 s17, s17, s7
	v_add3_u32 v104, v4, v2, v17
	v_dual_mov_b32 v2, v69 :: v_dual_lshrrev_b32 v16, 4, v16
	...
	s_lshl_b32 s6, s0, 6
	s_lshl_b32 s4, s2, 8
	v_and_b32_e32 v10, 0x2b8, v6
	v_and_b32_e32 v18, 0x338, v13
	v_and_b32_e32 v19, 0x378, v14
	v_and_b32_e32 v20, 0x3b8, v15
	...
	v_dual_add_nc_u32 v21, 2, v72 :: v_dual_mov_b32 v67, v72
	v_dual_add_nc_u32 v78, v11, v5 :: v_dual_add_nc_u32 v3, v4, v3
	s_ashr_i32 s7, s6, 31
	s_ashr_i32 s5, s4, 31
	s_wait_kmcnt 0x0
	...
	v_and_b32_e32 v79, 30, v21
	v_dual_add_nc_u32 v74, v8, v5 :: v_dual_add_nc_u32 v76, v10, v5
	v_dual_add_nc_u32 v80, v18, v5 :: v_dual_add_nc_u32 v82, v19, v5
	v_dual_add_nc_u32 v84, v20, v5 :: v_dual_add_nc_u32 v88, v9, v3
	v_dual_mov_b32 v107, v69 :: v_dual_add_nc_u32 v86, v16, v5
	v_add3_u32 v90, v3, v12, 0x400
	v_add3_u32 v92, v3, v6, 0x800
	v_add3_u32 v94, v3, v7, 0xc00
	v_add3_u32 v96, v3, v13, 0x1000
	v_add3_u32 v98, v3, v14, 0x1400
	v_add3_u32 v100, v3, v15, 0x1800
	v_add3_u32 v102, v3, v16, 0x1c00
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v83, v74, 1, s0
	v_lshl_add_u32 v85, v76, 1, s0
	v_lshl_add_u32 v87, v70, 1, s2
	v_lshl_add_u32 v89, v94, 1, s0
	ds_load_b128 v[108:111], v68
	ds_load_b128 v[112:115], v68 offset:16
	ds_load_b128 v[116:119], v83 offset:2048
	ds_load_b128 v[120:123], v83 offset:2064
	v_lshl_add_u32 v68, v78, 1, s0
	v_lshl_add_u32 v83, v80, 1, s0
	ds_load_b128 v[124:127], v85 offset:4096
	ds_load_b128 v[128:131], v85 offset:4112
	v_lshl_add_u32 v85, v88, 1, s0
	ds_load_b128 v[132:135], v68 offset:6144
	ds_load_b128 v[136:139], v68 offset:6160
	ds_load_b128 v[140:143], v83 offset:8192
	ds_load_b128 v[148:151], v87
	ds_load_b128 v[152:155], v87 offset:16
	ds_load_b128 v[144:147], v83 offset:8208
	v_lshl_add_u32 v68, v86, 1, s0
	v_lshl_add_u32 v87, v90, 1, s0
	v_lshl_add_u32 v83, v96, 1, s0
	v_lshl_add_u32 v91, v98, 1, s0
	v_lshl_add_u32 v93, v100, 1, s0
	v_lshl_add_u32 v95, v102, 1, s0
	v_lshl_add_u32 v97, v104, 1, s2
	ds_load_b128 v[156:159], v89 offset:64
	ds_load_b128 v[160:163], v89 offset:80
	ds_load_b128 v[164:167], v83 offset:64
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[18:25], v[140:147], v[148:155], v[18:25] matrix_b_reuse
	ds_load_b128 v[168:171], v83 offset:80
	ds_load_b128 v[172:175], v93 offset:64
	ds_load_b128 v[176:179], v93 offset:80
	ds_load_b128 v[180:183], v95 offset:64
	ds_load_b128 v[184:187], v95 offset:80
	ds_load_b128 v[188:191], v97 offset:64
	ds_load_b128 v[192:195], v97 offset:80
	v_wmma_f32_16x16x32_bf16 v[58:65], v[108:115], v[148:155], v[58:65]
	ds_load_b128 v[108:111], v68 offset:14336
	ds_load_b128 v[112:115], v68 offset:14352
	v_lshl_add_u32 v68, v84, 1, s0
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[108:115], v[148:155], v[34:41] matrix_b_reuse
	ds_load_b128 v[108:111], v85 offset:64
	ds_load_b128 v[112:115], v85 offset:80
	v_wmma_f32_16x16x32_bf16 v[50:57], v[116:123], v[148:155], v[50:57] matrix_b_reuse
	ds_load_b128 v[116:119], v68 offset:12288
	ds_load_b128 v[120:123], v68 offset:12304
	v_lshl_add_u32 v68, v82, 1, s0
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[116:123], v[148:155], v[2:9] matrix_b_reuse
	...
	ds_load_b128 v[124:127], v68 offset:10240
	ds_load_b128 v[128:131], v68 offset:10256
	v_lshl_add_u32 v68, v92, 1, s0
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[124:131], v[148:155], v[10:17] matrix_b_reuse
	ds_load_b128 v[124:127], v91 offset:64
	ds_load_b128 v[128:131], v91 offset:80
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[132:139], v[148:155], v[26:33] matrix_b_reuse
	ds_load_b128 v[132:135], v68 offset:64
	ds_load_b128 v[136:139], v68 offset:80
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[108:115], v[188:195], v[58:65]
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[116:123], v[188:195], v[50:57] matrix_b_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[132:139], v[188:195], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[156:163], v[188:195], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[164:171], v[188:195], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[124:131], v[188:195], v[10:17] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[172:179], v[188:195], v[2:9] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[180:187], v[188:195], v[34:41] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn064_bk064_wm2_wn4_mc0, .Lfunc_end0-bm256_bn064_bk064_wm2_wn4_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn064_bk064_wm2_wn4_mc0
	...
	.section	.text.bm256_bn064_bk064_wm2_wn4_mc0,"axG",@progbits,bm256_bn064_bk064_wm2_wn4_mc0,comdat
                                        ; -- End function
	.set .Lbm256_bn064_bk064_wm2_wn4_mc0.num_vgpr, 196
	.set .Lbm256_bn064_bk064_wm2_wn4_mc0.num_agpr, 0
	.set .Lbm256_bn064_bk064_wm2_wn4_mc0.numbered_sgpr, 56
	.set .Lbm256_bn064_bk064_wm2_wn4_mc0.num_named_barrier, 0
	.set .Lbm256_bn064_bk064_wm2_wn4_mc0.private_seg_size, 0
	.set .Lbm256_bn064_bk064_wm2_wn4_mc0.uses_vcc, 1
	.set .Lbm256_bn064_bk064_wm2_wn4_mc0.uses_flat_scratch, 1
	.set .Lbm256_bn064_bk064_wm2_wn4_mc0.has_dyn_sized_stack, 0
	.set .Lbm256_bn064_bk064_wm2_wn4_mc0.has_recursion, 0
	.set .Lbm256_bn064_bk064_wm2_wn4_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_4b12313a7f86c178,@object ; @__hip_cuid_4b12313a7f86c178
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_4b12313a7f86c178
__hip_cuid_4b12313a7f86c178:
	.byte	0                               ; 0x0
	.size	__hip_cuid_4b12313a7f86c178, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_4b12313a7f86c178
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn064_bk064_wm2_wn4_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn064_bk064_wm2_wn4_mc0.kd
