	...
	.section	.text.bm128_bn192_bk096_wm2_wn4_mc0,"axG",@progbits,bm128_bn192_bk096_wm2_wn4_mc0,comdat
	.protected	bm128_bn192_bk096_wm2_wn4_mc0 ; -- Begin function bm128_bn192_bk096_wm2_wn4_mc0
	.globl	bm128_bn192_bk096_wm2_wn4_mc0
	.p2align	8
	.type	bm128_bn192_bk096_wm2_wn4_mc0,@function
bm128_bn192_bk096_wm2_wn4_mc0: ; @bm128_bn192_bk096_wm2_wn4_mc0
; %bb.0:
...
.LBB0_14:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 4, v107 :: v_dual_bitop2_b32 v103, 3, v107 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s34, s3, s25
	s_and_not1_b32 vcc_lo, exec_lo, s17
	v_cndmask_b32_e64 v99, 0, 1, s34
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v105, 64, v1 bitop3:0x40
...
; %bb.15:
	...
	s_mov_b32 s7, s5
	v_mul_u32_u24_e32 v3, 0x60, v105
	...
	s_and_b32 s10, s4, 15
	v_mul_u32_u24_e32 v1, 0x1200, v103
	...
	v_mad_u32_u24 v30, 0x60, v5, v7
	s_lshl_b64 s[0:1], s[0:1], 1
	s_bfe_i64 s[6:7], s[12:13], 0x200000
	s_add_nc_u64 s[20:21], s[14:15], s[0:1]
	v_and_b32_e32 v6, 0x3f8, v6
	v_dual_mov_b32 v21, v101 :: v_dual_add_nc_u32 v20, 0x600, v30
	s_mul_u64 s[4:5], s[6:7], s[4:5]
	v_dual_mov_b32 v143, v101 :: v_dual_mov_b32 v145, v101
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v98, v6, v4 :: v_dual_lshrrev_b32 v6, 4, v10
	v_dual_add_nc_u32 v4, v7, v11 :: v_dual_bitop2_b32 v8, v1, v2 bitop3:0x54
	v_dual_mov_b32 v7, v101 :: v_dual_add_nc_u32 v10, 0xc00, v10
	v_and_b32_e32 v15, 0x7f8, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshrrev_b32_e32 v4, 4, v4
	v_mad_u32_u24 v26, 0x60, v5, v8
	v_or_b32_e32 v12, 32, v2
	v_dual_lshrrev_b32 v6, 4, v10 :: v_dual_mov_b32 v34, v101
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v35, v101 :: v_dual_lshrrev_b32 v13, 4, v26
	v_and_b32_e32 v17, 0x7f8, v4
	v_add_nc_u32_e32 v24, 0xc00, v26
	v_dual_mov_b32 v36, v101 :: v_dual_mov_b32 v37, v101
	v_and_b32_e32 v10, 0x7f8, v13
	v_dual_add_nc_u32 v13, v8, v9 :: v_dual_bitop2_b32 v4, v3, v12 bitop3:0x54
	v_dual_mov_b32 v38, v101 :: v_dual_mov_b32 v39, v101
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_add_nc_u32 v102, v10, v26 :: v_dual_lshrrev_b32 v10, 4, v13
	v_and_b32_e32 v19, 0xff8, v6
	v_add_nc_u32_e32 v6, v8, v11
	v_mad_u32_u24 v8, 0x60, v5, v4
	v_dual_add_nc_u32 v13, v4, v9 :: v_dual_add_nc_u32 v4, v4, v11
	v_and_b32_e32 v22, 0x7f8, v10
	v_dual_add_nc_u32 v106, v17, v30 :: v_dual_add_nc_u32 v110, v19, v30
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v14, 4, v8 :: v_dual_lshrrev_b32 v6, 4, v6
	v_dual_lshrrev_b32 v10, 4, v13 :: v_dual_lshrrev_b32 v4, 4, v4
	v_add_nc_u32_e32 v8, 0x1200, v8
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v23, 0x7f8, v14
	v_and_b32_e32 v13, 0x7f8, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v100, 0x7f8, v10
	v_dual_lshrrev_b32 v8, 4, v8 :: v_dual_bitop2_b32 v10, 64, v2 bitop3:0x54
	v_and_b32_e32 v2, 0x7f8, v4
	v_add_nc_u32_e32 v116, v23, v30
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add_nc_u64_e32 v[108:109], v[100:101], v[20:21]
	v_or_b32_e32 v3, v3, v10
	v_or_b32_e32 v6, v1, v12
	v_dual_mov_b32 v23, v101 :: v_dual_add_nc_u32 v100, 0xc00, v30
	v_dual_add_nc_u32 v112, v22, v26 :: v_dual_add_nc_u32 v114, v13, v26
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_mad_u32_u24 v4, 0x60, v5, v6
	v_dual_add_nc_u32 v12, v6, v9 :: v_dual_add_nc_u32 v6, v6, v11
	v_mad_u32_u24 v16, 0x60, v5, v3
	v_add_nc_u32_e32 v22, 0x600, v26
	v_lshrrev_b32_e32 v14, 4, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_lshrrev_b32_e32 v12, 4, v12
	v_and_b32_e32 v4, 0xff8, v8
	v_dual_mov_b32 v13, v101 :: v_dual_lshrrev_b32 v8, 4, v6
	v_and_b32_e32 v27, 0x7f8, v14
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_and_b32_e32 v6, 0x7f8, v12
	v_dual_add_nc_u32 v12, v3, v9 :: v_dual_lshrrev_b32 v14, 4, v16
	v_dual_add_nc_u32 v3, v3, v11 :: v_dual_bitop2_b32 v1, v1, v10 bitop3:0x54
	v_and_b32_e32 v8, 0x7f8, v8
	v_lshrrev_b32_e32 v10, 4, v12
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v28, 0x7f8, v14
	v_add_nc_u32_e32 v12, 0x1200, v16
	v_dual_lshrrev_b32 v3, 4, v3 :: v_dual_add_nc_u32 v9, v1, v9
	v_mad_u32_u24 v14, 0x60, v5, v1
	v_add_nc_u32_e32 v1, v1, v11
	v_sub_nc_u32_e32 v11, 0x197f, v0
	v_dual_mov_b32 v5, v101 :: v_dual_lshrrev_b32 v16, 4, v12
	v_and_b32_e32 v12, 0x7f8, v3
	v_dual_lshrrev_b32 v3, 4, v14 :: v_dual_lshrrev_b32 v9, 4, v9
	v_lshrrev_b32_e32 v1, 4, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_and_b32_e32 v14, 0xff8, v16
	v_mov_b32_e32 v25, v101
	v_and_b32_e32 v29, 0x7f8, v3
	v_lshrrev_b32_e32 v3, 8, v11
	v_and_b32_e32 v16, 0x7f8, v9
	v_sub_nc_u32_e32 v9, 0x263f, v0
	v_and_b32_e32 v18, 0x7f8, v1
	v_and_b32_e32 v10, 0x7f8, v10
	v_dual_add_nc_u32 v3, 1, v3 :: v_dual_add_nc_u32 v122, v27, v26
	v_dual_mov_b32 v11, v101 :: v_dual_add_nc_u32 v128, v28, v30
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v17, v101 :: v_dual_bitop2_b32 v111, 26, v3 bitop3:0x40
	v_dual_mov_b32 v15, v101 :: v_dual_add_nc_u32 v104, v15, v30
	v_add_nc_u64_e32 v[124:125], v[6:7], v[22:23]
	v_add_nc_u64_e32 v[130:131], v[10:11], v[20:21]
	s_delay_alu instid0(VALU_DEP_4)
	v_cmp_ne_u32_e64 s0, v3, v111
	v_mov_b32_e32 v3, v101
	v_add_nc_u64_e32 v[132:133], v[12:13], v[100:101]
	v_add_nc_u64_e32 v[138:139], v[16:17], v[22:23]
	v_dual_mov_b32 v6, v101 :: v_dual_mov_b32 v10, v101
	v_mov_b32_e32 v12, v101
	v_add_nc_u64_e32 v[118:119], v[2:3], v[100:101]
	v_add_nc_u32_e32 v2, 0x1200, v30
	v_dual_mov_b32 v16, v101 :: v_dual_mov_b32 v20, v101
	v_dual_mov_b32 v22, v101 :: v_dual_mov_b32 v27, v101
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_add_nc_u64_e32 v[120:121], v[4:5], v[2:3]
	v_dual_mov_b32 v4, v101 :: v_dual_lshrrev_b32 v1, 8, v9
	v_add_nc_u64_e32 v[134:135], v[14:15], v[2:3]
	v_dual_mov_b32 v2, v101 :: v_dual_mov_b32 v14, v101
	v_dual_mov_b32 v28, v101 :: v_dual_add_nc_u32 v9, 1, v1
	v_lshl_or_b32 v31, v111, 8, v0
	v_mov_b32_e32 v19, v101
	v_or_b32_e32 v1, 0x100, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v30, v101 :: v_dual_bitop2_b32 v113, 46, v9 bitop3:0x40
	v_lshlrev_b32_e32 v142, 2, v31
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_add_nc_u64_e32 v[140:141], v[18:19], v[24:25]
	v_dual_mov_b32 v18, v101 :: v_dual_add_nc_u32 v109, 0xffffff00, v31
	v_cmp_ne_u32_e64 s1, v9, v113
	v_mov_b32_e32 v9, v101
	v_lshl_or_b32 v32, v113, 8, v0
	v_add_nc_u32_e32 v136, v29, v26
	v_dual_mov_b32 v26, v101 :: v_dual_mov_b32 v29, v101
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add_nc_u64_e32 v[126:127], v[8:9], v[24:25]
	v_dual_mov_b32 v8, v101 :: v_dual_add_nc_u32 v115, 0xffffff00, v32
	v_dual_lshlrev_b32 v144, 2, v32 :: v_dual_mov_b32 v24, v101
	v_dual_mov_b32 v31, v101 :: v_dual_mov_b32 v32, v101
	v_dual_mov_b32 v33, v101 :: v_dual_mov_b32 v40, v101
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v100, v146 :: v_dual_add_nc_u32 v117, -2, v117
	v_dual_mov_b32 v148, v147 :: v_dual_mov_b32 v149, v101
	v_add_nc_u32_e32 v147, 0x200, v147
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[150:151], v[100:101], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v117
	v_add_nc_u32_e32 v146, 0x200, v146
	v_lshl_add_u64 v[148:149], v[148:149], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[150:151], v101
	flat_store_b32 v[148:149], v101
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[146:147], s[6:7], v[142:143]
...
; %bb.26:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[146:147], s[6:7], v[144:145]
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v117, s14 :: v_dual_mov_b32 v146, s12
...
.LBB0_35:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v117, s5 :: v_dual_mov_b32 v146, s6
	s_bitset1_b32 s7, 31
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_lshl_add_u32 v117, v104, 1, s6
	v_lshl_add_u32 v119, v106, 1, s6
	v_lshl_add_u32 v121, v110, 1, s6
	v_lshl_add_u32 v123, v122, 1, s5
	ds_load_b128 v[146:149], v100
	ds_load_b128 v[150:153], v100 offset:16
	v_lshl_add_u32 v100, v114, 1, s5
	ds_load_b128 v[154:157], v117 offset:3072
	ds_load_b128 v[158:161], v117 offset:3088
	ds_load_b128 v[162:165], v119 offset:6144
	ds_load_b128 v[166:169], v119 offset:6160
	ds_load_b128 v[170:173], v121 offset:9216
	ds_load_b128 v[178:181], v100 offset:6144
	ds_load_b128 v[182:185], v100 offset:6160
	v_lshl_add_u32 v100, v112, 1, s5
	ds_load_b128 v[174:177], v121 offset:9232
	v_lshl_add_u32 v117, v108, 1, s6
	v_lshl_add_u32 v119, v118, 1, s6
	v_lshl_add_u32 v121, v120, 1, s6
	ds_load_b128 v[186:189], v100 offset:3072
	ds_load_b128 v[190:193], v100 offset:3088
	v_lshl_add_u32 v100, v102, 1, s5
	v_lshl_add_u32 v125, v124, 1, s5
	v_lshl_add_u32 v127, v126, 1, s5
	ds_load_b128 v[194:197], v119 offset:64
	ds_load_b128 v[198:201], v119 offset:80
	ds_load_b128 v[202:205], v121 offset:64
	ds_load_b128 v[206:209], v121 offset:80
	ds_load_b128 v[210:213], v123 offset:64
	ds_load_b128 v[214:217], v123 offset:80
	ds_load_b128 v[218:221], v125 offset:64
	ds_load_b128 v[222:225], v125 offset:80
	ds_load_b128 v[226:229], v127 offset:64
	ds_load_b128 v[230:233], v127 offset:80
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[2:9], v[170:177], v[186:193], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[74:81], v[146:153], v[178:185], v[74:81] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[154:161], v[178:185], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[162:169], v[178:185], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[170:177], v[178:185], v[50:57] matrix_b_reuse
	ds_load_b128 v[178:181], v100
	ds_load_b128 v[182:185], v100 offset:16
	v_lshl_add_u32 v100, v116, 1, s6
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[90:97], v[146:153], v[178:185], v[90:97]
	v_wmma_f32_16x16x32_bf16 v[66:73], v[154:161], v[178:185], v[66:73] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[162:169], v[178:185], v[34:41] matrix_b_reuse
	...
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[154:161], v[186:193], v[58:65] matrix_b_reuse
	ds_load_b128 v[154:157], v117 offset:64
	ds_load_b128 v[158:161], v117 offset:80
	v_wmma_f32_16x16x32_bf16 v[82:89], v[146:153], v[186:193], v[82:89] matrix_b_reuse
	ds_load_b128 v[146:149], v100 offset:64
	ds_load_b128 v[150:153], v100 offset:80
	; sched_group_barrier mask(0x00000008) size(6) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[162:169], v[186:193], v[26:33] matrix_b_reuse
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v100, v128, 1, s6
	v_lshl_add_u32 v117, v130, 1, s6
	v_lshl_add_u32 v119, v132, 1, s6
	v_lshl_add_u32 v121, v134, 1, s6
	ds_load_b128 v[162:165], v100 offset:128
	ds_load_b128 v[166:169], v100 offset:144
	ds_load_b128 v[170:173], v117 offset:128
	ds_load_b128 v[174:177], v117 offset:144
	ds_load_b128 v[178:181], v119 offset:128
	ds_load_b128 v[182:185], v119 offset:144
	v_lshl_add_u32 v100, v136, 1, s5
	v_lshl_add_u32 v117, v138, 1, s5
	v_lshl_add_u32 v119, v140, 1, s5
	ds_load_b128 v[186:189], v121 offset:128
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[90:97], v[146:153], v[210:217], v[90:97]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[66:73], v[154:161], v[210:217], v[66:73] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[194:201], v[210:217], v[34:41] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[202:209], v[210:217], v[10:17] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[202:209], v[218:225], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[194:201], v[218:225], v[26:33] matrix_b_reuse
	ds_load_b128 v[190:193], v121 offset:144
	ds_load_b128 v[210:213], v100 offset:128
	ds_load_b128 v[214:217], v100 offset:144
	ds_load_b128 v[234:237], v117 offset:128
	ds_load_b128 v[238:241], v117 offset:144
	ds_load_b128 v[242:245], v119 offset:128
	ds_load_b128 v[246:249], v119 offset:144
	v_wmma_f32_16x16x32_bf16 v[58:65], v[154:161], v[218:225], v[58:65] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(6) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[82:89], v[146:153], v[218:225], v[82:89] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[74:81], v[146:153], v[226:233], v[74:81] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[154:161], v[226:233], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[194:201], v[226:233], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[202:209], v[226:233], v[50:57] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(6) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[90:97], v[162:169], v[210:217], v[90:97]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[66:73], v[170:177], v[210:217], v[66:73] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[178:185], v[210:217], v[34:41] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[186:193], v[210:217], v[10:17] matrix_b_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[186:193], v[234:241], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[178:185], v[234:241], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(6) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[170:177], v[234:241], v[58:65] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[162:169], v[234:241], v[82:89] matrix_b_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[74:81], v[162:169], v[242:249], v[74:81] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[170:177], v[242:249], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[178:185], v[242:249], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[186:193], v[242:249], v[50:57] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(6) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.38:
	...
	v_add_nc_u32_e32 v34, 0x1020, v90
	v_and_b32_e32 v35, 0xffffff0, v43
	v_dual_lshlrev_b32 v36, 1, v68 :: v_dual_add_nc_u32 v1, v1, v67
	v_cvt_pk_bf16_f32 v47, v44, v45
	ds_store_b128 v74, v[70:73] offset:32
	ds_store_b128 v66, v[62:65] offset:4096
	ds_store_b128 v1, v[46:49] offset:8192
	v_dual_lshrrev_b32 v1, 3, v34 :: v_dual_add_nc_u32 v34, v35, v36
	v_add_nc_u32_e32 v35, 48, v90
	v_cvt_pk_bf16_f32 v33, v32, v33
	v_cvt_pk_bf16_f32 v32, v30, v31
	v_cvt_pk_bf16_f32 v30, v26, v27
	v_add_nc_u32_e32 v27, 0x830, v90
	v_cvt_pk_bf16_f32 v25, v24, v25
	v_cvt_pk_bf16_f32 v24, v22, v23
	v_cvt_pk_bf16_f32 v22, v18, v19
	v_add_nc_u32_e32 v18, 0x1030, v90
	v_dual_lshrrev_b32 v69, 3, v68 :: v_dual_lshrrev_b32 v26, 3, v35
	v_cvt_pk_bf16_f32 v23, v20, v21
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v20, 3, v27 :: v_dual_lshrrev_b32 v18, 3, v18
	...
	v_add_nc_u32_e32 v42, v58, v77
	v_cvt_pk_bf16_f32 v31, v28, v29
	v_dual_add_nc_u32 v1, v1, v36 :: v_dual_add_nc_u32 v19, v26, v77
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn192_bk096_wm2_wn4_mc0, .Lfunc_end0-bm128_bn192_bk096_wm2_wn4_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn192_bk096_wm2_wn4_mc0
	...
	.section	.text.bm128_bn192_bk096_wm2_wn4_mc0,"axG",@progbits,bm128_bn192_bk096_wm2_wn4_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn192_bk096_wm2_wn4_mc0.num_vgpr, 250
	.set .Lbm128_bn192_bk096_wm2_wn4_mc0.num_agpr, 0
	.set .Lbm128_bn192_bk096_wm2_wn4_mc0.numbered_sgpr, 56
	.set .Lbm128_bn192_bk096_wm2_wn4_mc0.num_named_barrier, 0
	.set .Lbm128_bn192_bk096_wm2_wn4_mc0.private_seg_size, 0
	.set .Lbm128_bn192_bk096_wm2_wn4_mc0.uses_vcc, 1
	.set .Lbm128_bn192_bk096_wm2_wn4_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn192_bk096_wm2_wn4_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn192_bk096_wm2_wn4_mc0.has_recursion, 0
	.set .Lbm128_bn192_bk096_wm2_wn4_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_982d2482bde637f4,@object ; @__hip_cuid_982d2482bde637f4
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_982d2482bde637f4
__hip_cuid_982d2482bde637f4:
	.byte	0                               ; 0x0
	.size	__hip_cuid_982d2482bde637f4, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_982d2482bde637f4
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn192_bk096_wm2_wn4_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn192_bk096_wm2_wn4_mc0.kd
