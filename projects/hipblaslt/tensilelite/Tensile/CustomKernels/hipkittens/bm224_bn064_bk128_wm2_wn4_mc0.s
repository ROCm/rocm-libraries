	...
	.section	.text.bm224_bn064_bk128_wm2_wn4_mc0,"axG",@progbits,bm224_bn064_bk128_wm2_wn4_mc0,comdat
	.protected	bm224_bn064_bk128_wm2_wn4_mc0 ; -- Begin function bm224_bn064_bk128_wm2_wn4_mc0
	.globl	bm224_bn064_bk128_wm2_wn4_mc0
	.p2align	8
	.type	bm224_bn064_bk128_wm2_wn4_mc0,@function
bm224_bn064_bk128_wm2_wn4_mc0: ; @bm224_bn064_bk128_wm2_wn4_mc0
; %bb.0:
...
.LBB0_12:
	s_or_saveexec_b32 s28, s31
	s_min_i32 s4, s36, s30
	s_delay_alu instid0(SALU_CYCLE_1)
...
.LBB0_14:
	...
	s_barrier_signal -1
	v_dual_lshrrev_b32 v65, 7, v0 :: v_dual_lshlrev_b32 v1, 4, v63
	v_mov_b32_e32 v9, 0
	s_and_b32 s40, s37, s25
	s_and_not1_b32 vcc_lo, exec_lo, s16
	v_cndmask_b32_e64 v59, 0, 1, s40
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v72, 48, v1 bitop3:0x40
...
; %bb.15:
	...
	s_add_co_i32 s6, s39, 0x4400
	s_mov_b32 s7, s5
	v_mul_u32_u24_e32 v1, 0x3800, v65
	s_and_b64 s[6:7], s[6:7], 15
	v_and_or_b32 v3, 0x780, v4, v3
	s_sub_co_i32 s2, 16, s6
	v_lshlrev_b32_e32 v2, 7, v72
	s_lshr_b32 s2, s2, 2
	s_cmp_lg_u64 s[6:7], 0
	v_or_b32_e32 v1, v3, v1
	s_cselect_b32 s2, s2, 0
	v_or_b32_e32 v4, v2, v3
	s_lshl2_add_u32 s2, s2, s39
	v_dual_mov_b32 v61, 0 :: v_dual_sub_nc_u32 v6, 0x3b7f, v0
	s_add_co_i32 s4, s2, 0x13200
	v_lshrrev_b32_e32 v5, 4, v1
	s_and_b32 s10, s4, 15
	s_mov_b32 s11, 0
	s_sub_co_i32 s6, 16, s10
	v_dual_lshrrev_b32 v7, 4, v4 :: v_dual_lshrrev_b32 v6, 8, v6
	v_and_b32_e32 v5, 0x3f8, v5
	s_add_co_i32 s42, s2, 0x4400
	s_lshr_b32 s2, s6, 2
	s_cmp_lg_u64 s[10:11], 0
	v_and_b32_e32 v7, 0x1f8, v7
	s_cselect_b32 s2, s2, 0
	s_ashr_i32 s6, s17, 31
	v_dual_add_nc_u32 v58, v5, v1 :: v_dual_add_nc_u32 v5, 1, v6
	s_lshr_b32 s6, s6, 25
	s_lshl_b32 s10, s2, 2
	s_add_co_i32 s17, s17, s6
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_add_nc_u32 v62, v7, v4 :: v_dual_bitop2_b32 v73, 62, v5 bitop3:0x40
	...
	s_wait_kmcnt 0x0
	s_bfe_i64 s[6:7], s[20:21], 0x200000
	v_lshl_or_b32 v4, v73, 8, v0
	s_ashr_i32 s35, s34, 31
	s_mul_u64 s[4:5], s[6:7], s[4:5]
	s_bfe_i64 s[6:7], s[12:13], 0x200000
	s_lshl_b64 s[4:5], s[4:5], 1
	s_mul_u64 s[6:7], s[6:7], s[34:35]
	v_or_b32_e32 v1, 0x100, v0
	v_cmp_ne_u32_e64 s0, v5, v73
	v_add3_u32 v64, v3, v2, v7
	v_dual_mov_b32 v67, v61 :: v_dual_add_nc_u32 v74, 0xffffff00, v4
	v_dual_mov_b32 v69, v61 :: v_dual_lshlrev_b32 v66, 2, v4
	v_or_b32_e32 v75, 0xf00, v0
	v_lshl_or_b32 v68, v0, 2, 0x4000
	v_dual_mov_b32 v2, v61 :: v_dual_mov_b32 v3, v61
	v_dual_mov_b32 v4, v61 :: v_dual_mov_b32 v5, v61
	v_dual_mov_b32 v6, v61 :: v_dual_mov_b32 v7, v61
	v_dual_mov_b32 v8, v61 :: v_dual_mov_b32 v9, v61
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v60, v70 :: v_dual_add_nc_u32 v76, -2, v76
	v_dual_mov_b32 v78, v71 :: v_dual_mov_b32 v79, v61
	v_add_nc_u32_e32 v71, 0x200, v71
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[80:81], v[60:61], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v76
	v_add_nc_u32_e32 v70, 0x200, v70
	v_lshl_add_u64 v[78:79], v[78:79], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[80:81], v61
	flat_store_b32 v[78:79], v61
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[70:71], s[6:7], v[66:67]
...
.LBB0_22:                               ;   Parent Loop BB0_17 Depth=1
	...
	flat_store_b32 v[70:71], v61
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[70:71], 0x400, v[70:71]
	v_cmp_lt_u32_e32 vcc_lo, 0x3a7f, v60
...
.LBB0_27:                               ;   Parent Loop BB0_17 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[70:71], 0x400, v[70:71]
	v_cmp_lt_u32_e32 vcc_lo, 0xfff, v60
	s_or_b32 s6, vcc_lo, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s6
...
.LBB0_35:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_dual_mov_b32 v71, s5 :: v_dual_mov_b32 v70, s6
	s_bitset1_b32 s7, 31
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_cselect_b32 s5, s30, s39
	v_lshl_add_u32 v60, v58, 1, s2
	v_lshl_add_u32 v70, v62, 1, s5
	ds_load_b128 v[76:79], v60
	ds_load_b128 v[80:83], v60 offset:16
	ds_load_b128 v[84:87], v70
	ds_load_b128 v[88:91], v70 offset:16
	ds_load_b128 v[92:95], v60 offset:4352
	ds_load_b128 v[96:99], v60 offset:4368
	ds_load_b128 v[100:103], v60 offset:8704
	ds_load_b128 v[104:107], v60 offset:8720
	ds_load_b128 v[108:111], v60 offset:13056
	ds_load_b128 v[112:115], v60 offset:13072
	ds_load_b128 v[116:119], v60 offset:17408
	ds_load_b128 v[120:123], v60 offset:17424
	ds_load_b128 v[124:127], v60 offset:21760
	ds_load_b128 v[128:131], v60 offset:21776
	ds_load_b128 v[132:135], v60 offset:26112
	ds_load_b128 v[136:139], v60 offset:26128
	v_lshl_add_u32 v70, v64, 1, s5
	ds_load_b128 v[140:143], v60 offset:17472
	ds_load_b128 v[144:147], v60 offset:17488
	ds_load_b128 v[148:151], v60 offset:26176
	s_wait_dscnt 0xf
	v_wmma_f32_16x16x32_bf16 v[50:57], v[76:83], v[84:91], v[50:57]
	ds_load_b128 v[76:79], v60 offset:64
	ds_load_b128 v[80:83], v60 offset:80
	ds_load_b128 v[152:155], v60 offset:26192
	ds_load_b128 v[156:159], v70 offset:64
	ds_load_b128 v[160:163], v70 offset:80
	; sched_group_barrier mask(0x00000100) size(16) SyncID(0)
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[42:49], v[92:99], v[84:91], v[42:49] matrix_b_reuse
	ds_load_b128 v[92:95], v60 offset:4416
	ds_load_b128 v[96:99], v60 offset:4432
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[34:41], v[100:107], v[84:91], v[34:41] matrix_b_reuse
	ds_load_b128 v[100:103], v60 offset:8768
	ds_load_b128 v[104:107], v60 offset:8784
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[18:25], v[108:115], v[84:91], v[18:25] matrix_b_reuse
	ds_load_b128 v[108:111], v60 offset:13120
	ds_load_b128 v[112:115], v60 offset:13136
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[10:17], v[116:123], v[84:91], v[10:17] matrix_b_reuse
	ds_load_b128 v[116:119], v60 offset:21824
	ds_load_b128 v[120:123], v60 offset:21840
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[2:9], v[124:131], v[84:91], v[2:9] matrix_b_reuse
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[26:33], v[132:139], v[84:91], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[84:87], v60 offset:128
	ds_load_b128 v[88:91], v60 offset:144
	ds_load_b128 v[124:127], v60 offset:4480
	ds_load_b128 v[128:131], v60 offset:4496
	ds_load_b128 v[132:135], v60 offset:8832
	ds_load_b128 v[136:139], v60 offset:8848
	ds_load_b128 v[164:167], v60 offset:13184
	ds_load_b128 v[168:171], v60 offset:13200
	ds_load_b128 v[172:175], v60 offset:17536
	ds_load_b128 v[176:179], v60 offset:17552
	ds_load_b128 v[180:183], v60 offset:21888
	ds_load_b128 v[184:187], v60 offset:21904
	ds_load_b128 v[188:191], v60 offset:26240
	ds_load_b128 v[192:195], v60 offset:26256
	ds_load_b128 v[196:199], v70 offset:128
	ds_load_b128 v[200:203], v70 offset:144
	s_wait_dscnt 0x18
	v_wmma_f32_16x16x32_bf16 v[50:57], v[76:83], v[156:163], v[50:57]
	; sched_group_barrier mask(0x00000100) size(16) SyncID(0)
	s_wait_dscnt 0x16
	v_wmma_f32_16x16x32_bf16 v[42:49], v[92:99], v[156:163], v[42:49] matrix_b_reuse
	s_wait_dscnt 0x14
	v_wmma_f32_16x16x32_bf16 v[34:41], v[100:107], v[156:163], v[34:41] matrix_b_reuse
	s_wait_dscnt 0x12
	v_wmma_f32_16x16x32_bf16 v[18:25], v[108:115], v[156:163], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[140:147], v[156:163], v[10:17] matrix_b_reuse
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[2:9], v[116:123], v[156:163], v[2:9] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[148:155], v[156:163], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[76:79], v60 offset:192
	ds_load_b128 v[80:83], v60 offset:208
	ds_load_b128 v[92:95], v60 offset:4544
	ds_load_b128 v[96:99], v60 offset:4560
	ds_load_b128 v[100:103], v60 offset:8896
	ds_load_b128 v[104:107], v60 offset:8912
	ds_load_b128 v[108:111], v60 offset:13248
	ds_load_b128 v[112:115], v60 offset:13264
	ds_load_b128 v[116:119], v60 offset:17600
	ds_load_b128 v[120:123], v60 offset:17616
	ds_load_b128 v[140:143], v60 offset:21952
	ds_load_b128 v[144:147], v60 offset:21968
	ds_load_b128 v[148:151], v60 offset:26304
	ds_load_b128 v[152:155], v60 offset:26320
	ds_load_b128 v[156:159], v70 offset:192
	ds_load_b128 v[160:163], v70 offset:208
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[50:57], v[84:91], v[196:203], v[50:57]
	; sched_group_barrier mask(0x00000100) size(16) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[124:131], v[196:203], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[132:139], v[196:203], v[34:41] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[164:171], v[196:203], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[172:179], v[196:203], v[10:17] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[180:187], v[196:203], v[2:9] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[188:195], v[196:203], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[50:57], v[76:83], v[156:163], v[50:57]
	...
	v_wmma_f32_16x16x32_bf16 v[34:41], v[100:107], v[156:163], v[34:41] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[108:115], v[156:163], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[116:123], v[156:163], v[10:17] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[140:147], v[156:163], v[2:9] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[148:155], v[156:163], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
...
; %bb.38:
	v_mul_u32_u24_e32 v1, 0x70, v65
	v_lshrrev_b32_e32 v58, 1, v0
	v_and_or_b32 v60, v0, 15, v72
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm224_bn064_bk128_wm2_wn4_mc0, .Lfunc_end0-bm224_bn064_bk128_wm2_wn4_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm224_bn064_bk128_wm2_wn4_mc0
	...
	.section	.text.bm224_bn064_bk128_wm2_wn4_mc0,"axG",@progbits,bm224_bn064_bk128_wm2_wn4_mc0,comdat
                                        ; -- End function
	.set .Lbm224_bn064_bk128_wm2_wn4_mc0.num_vgpr, 204
	.set .Lbm224_bn064_bk128_wm2_wn4_mc0.num_agpr, 0
	.set .Lbm224_bn064_bk128_wm2_wn4_mc0.numbered_sgpr, 56
	.set .Lbm224_bn064_bk128_wm2_wn4_mc0.num_named_barrier, 0
	.set .Lbm224_bn064_bk128_wm2_wn4_mc0.private_seg_size, 0
	.set .Lbm224_bn064_bk128_wm2_wn4_mc0.uses_vcc, 1
	.set .Lbm224_bn064_bk128_wm2_wn4_mc0.uses_flat_scratch, 1
	.set .Lbm224_bn064_bk128_wm2_wn4_mc0.has_dyn_sized_stack, 0
	.set .Lbm224_bn064_bk128_wm2_wn4_mc0.has_recursion, 0
	.set .Lbm224_bn064_bk128_wm2_wn4_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_a1dfd7fafbcd673d,@object ; @__hip_cuid_a1dfd7fafbcd673d
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_a1dfd7fafbcd673d
__hip_cuid_a1dfd7fafbcd673d:
	.byte	0                               ; 0x0
	.size	__hip_cuid_a1dfd7fafbcd673d, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_a1dfd7fafbcd673d
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm224_bn064_bk128_wm2_wn4_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm224_bn064_bk128_wm2_wn4_mc0.kd
