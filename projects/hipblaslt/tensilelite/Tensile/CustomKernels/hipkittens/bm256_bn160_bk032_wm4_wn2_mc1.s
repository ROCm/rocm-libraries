	...
	.section	.text.bm256_bn160_bk032_wm4_wn2_mc1,"axG",@progbits,bm256_bn160_bk032_wm4_wn2_mc1,comdat
	.protected	bm256_bn160_bk032_wm4_wn2_mc1 ; -- Begin function bm256_bn160_bk032_wm4_wn2_mc1
	.globl	bm256_bn160_bk032_wm4_wn2_mc1
	.p2align	8
	.type	bm256_bn160_bk032_wm4_wn2_mc1,@function
bm256_bn160_bk032_wm4_wn2_mc1: ; @bm256_bn160_bk032_wm4_wn2_mc1
; %bb.0:
...
.LBB0_20:
	...
	v_dual_mov_b32 v82, v9 :: v_dual_mov_b32 v113, v9
	...
	v_cndmask_b32_e64 v173, 0, 0x50, vcc_lo
...
; %bb.21:
	...
	v_dual_lshlrev_b32 v1, 5, v173 :: v_dual_lshlrev_b32 v2, 5, v171
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s1, 0x6e80
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v4, 0x1e0, v4
	s_mov_b32 s7, s5
	v_lshl_or_b32 v184, v0, 2, 0x4000
	s_and_b64 s[6:7], s[6:7], 15
	v_or_b32_e32 v177, 0xf00, v0
	...
	s_movk_i32 s16, 0xa0
	v_dual_lshrrev_b32 v1, 4, v8 :: v_dual_mov_b32 v165, 0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_add_nc_u32_e32 v162, v5, v2
	...
	v_dual_mov_b32 v185, v165 :: v_dual_add_nc_u32 v10, 0x800, v3
	v_dual_add_nc_u32 v170, v4, v2 :: v_dual_add_nc_u32 v172, v5, v2
	v_dual_mov_b32 v4, v165 :: v_dual_lshrrev_b32 v8, 4, v8
	v_lshrrev_b32_e32 v9, 4, v9
	s_add_co_i32 s4, s1, 0xb280
	s_add_co_i32 s45, s1, 0x6e80
	s_and_b32 s10, s4, 15
	v_and_b32_e32 v8, 0xf8, v8
	v_dual_add_nc_u32 v174, v7, v2 :: v_dual_mov_b32 v2, v165
	v_dual_lshrrev_b32 v6, 4, v3 :: v_dual_lshrrev_b32 v1, 4, v1
	s_sub_co_i32 s7, 16, s10
	v_and_b32_e32 v9, 0x1f8, v9
	s_lshr_b32 s1, s7, 2
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v6, 0xb8, v6
	s_cmp_lg_u64 s[10:11], 0
	v_add_nc_u32_e32 v178, v8, v3
	s_cselect_b32 s1, s1, 0
	s_ashr_i32 s7, s12, 31
	v_dual_add_nc_u32 v166, v6, v3 :: v_dual_lshrrev_b32 v6, 4, v10
	...
	v_add_nc_u32_e32 v180, v9, v3
	s_ashr_i32 s47, s12, 5
	s_cmp_lt_i32 s3, 0xa0
	v_dual_add_nc_u32 v182, v6, v3 :: v_dual_mov_b32 v6, v165
	v_lshrrev_b32_e32 v168, 8, v1
	s_cselect_b32 s48, -1, 0
	s_lshl_b32 s18, s18, 8
	s_ashr_i32 s7, s6, 31
	s_ashr_i32 s19, s18, 31
	v_dual_add_nc_u32 v11, 2, v168 :: v_dual_add_nc_u32 v176, v10, v3
	s_wait_kmcnt 0x0
	...
	v_dual_mov_b32 v3, v165 :: v_dual_bitop2_b32 v175, 14, v11 bitop3:0x40
	v_dual_mov_b32 v5, v165 :: v_dual_mov_b32 v7, v165
	v_dual_mov_b32 v8, v165 :: v_dual_mov_b32 v9, v165
	...
	v_dual_mov_b32 v12, v165 :: v_dual_mov_b32 v13, v165
...
.LBB0_25:                               ;   Parent Loop BB0_23 Depth=1
	...
	v_dual_mov_b32 v164, v186 :: v_dual_add_nc_u32 v179, -2, v179
	v_dual_mov_b32 v188, v187 :: v_dual_mov_b32 v189, v165
	v_add_nc_u32_e32 v187, 0x200, v187
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[190:191], v[164:165], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v179
	v_add_nc_u32_e32 v186, 0x200, v186
	v_lshl_add_u64 v[188:189], v[188:189], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[190:191], v165
	flat_store_b32 v[188:189], v165
...
; %bb.27:                               ;   in Loop: Header=BB0_23 Depth=1
	v_add_nc_u64_e32 v[186:187], s[6:7], v[184:185]
...
.LBB0_28:                               ;   Parent Loop BB0_23 Depth=1
	...
	flat_store_b32 v[186:187], v165
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[186:187], 0x400, v[186:187]
...
.LBB0_30:                               ;   in Loop: Header=BB0_31 Depth=2
	...
	v_add_nc_u32_e32 v187, 0x200, v187
	v_cmp_eq_u32_e32 vcc_lo, s6, v175
	v_add_nc_u32_e32 v186, 0x200, v186
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
.LBB0_31:                               ;   Parent Loop BB0_23 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s19, v163
	v_cmpx_le_u32_e64 s18, v168
	s_cbranch_execz .LBB0_33
; %bb.32:                               ;   in Loop: Header=BB0_31 Depth=2
	v_mov_b32_e32 v164, v186
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[188:189], v[164:165], 2, s[14:15]
	flat_store_b32 v[188:189], v165
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_lshl_add_u32 v164, v162, 1, s1
	v_lshl_add_u32 v179, v170, 1, s1
	v_lshl_add_u32 v181, v172, 1, s1
	v_lshl_add_u32 v183, v174, 1, s1
	s_cselect_b32 s1, s40, s38
	ds_load_b128 v[186:189], v164
	ds_load_b128 v[190:193], v164 offset:16
	v_lshl_add_u32 v164, v166, 1, s1
	ds_load_b128 v[194:197], v179 offset:1024
	ds_load_b128 v[198:201], v179 offset:1040
	ds_load_b128 v[202:205], v181 offset:2048
	ds_load_b128 v[206:209], v181 offset:2064
	ds_load_b128 v[210:213], v183 offset:3072
	ds_load_b128 v[214:217], v183 offset:3088
	ds_load_b128 v[218:221], v164
	ds_load_b128 v[222:225], v164 offset:16
	v_lshl_add_u32 v179, v182, 1, s1
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[154:161], v[186:193], v[218:225], v[154:161]
	v_wmma_f32_16x16x32_bf16 v[114:121], v[194:201], v[218:225], v[114:121] matrix_a_reuse
	ds_load_b128 v[226:229], v179 offset:4096
	ds_load_b128 v[230:233], v179 offset:4112
	v_lshl_add_u32 v179, v180, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[122:129], v[186:193], v[226:233], v[122:129] matrix_a_reuse
	ds_load_b128 v[234:237], v179 offset:3072
	ds_load_b128 v[238:241], v179 offset:3088
	v_lshl_add_u32 v179, v178, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[130:137], v[186:193], v[234:241], v[130:137] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[194:201], v[234:241], v[66:73] matrix_a_reuse
	ds_load_b128 v[242:245], v179 offset:2048
	ds_load_b128 v[246:249], v179 offset:2064
	v_lshl_add_u32 v179, v176, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[138:145], v[186:193], v[242:249], v[138:145] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[194:201], v[242:249], v[82:89] matrix_a_reuse
	ds_load_b128 v[250:253], v179 offset:1024
	ds_load_b128 v[254:257], v179 offset:1040
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[146:153], v[186:193], v[250:257], v[146:153] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[106:113], v[194:201], v[250:257], v[106:113] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(10) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[202:209], v[226:233], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[98:105], v[210:217], v[226:233], v[98:105]
	v_wmma_f32_16x16x32_bf16 v[18:25], v[202:209], v[234:241], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[90:97], v[210:217], v[234:241], v[90:97] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[202:209], v[242:249], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[74:81], v[210:217], v[242:249], v[74:81] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[202:209], v[250:257], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[210:217], v[250:257], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[202:209], v[218:225], v[58:65]
	v_wmma_f32_16x16x32_bf16 v[26:33], v[210:217], v[218:225], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(10) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[194:201], v[226:233], v[50:57]
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_dual_mov_b32 v179, s13 :: v_dual_mov_b32 v186, s14
...
; %bb.47:
	...
	v_add_nc_u32_e32 v82, 0x3010, v1
	...
	v_add_nc_u32_e32 v60, 0x4010, v1
	...
	v_add_nc_u32_e32 v60, v26, v115
	v_cvt_pk_bf16_f32 v29, v72, v73
	v_and_b32_e32 v61, 0x1ff0, v27
	v_cvt_pk_bf16_f32 v28, v70, v71
	...
	v_add_nc_u32_e32 v44, 0x3020, v1
	v_add_nc_u32_e32 v124, v131, v141
	v_add_nc_u32_e32 v83, v107, v141
	v_cvt_pk_bf16_f32 v57, v56, v57
	v_cvt_pk_bf16_f32 v56, v54, v55
	v_cvt_pk_bf16_f32 v55, v52, v53
	v_add_nc_u32_e32 v52, 0x2020, v1
	ds_store_b128 v139, v[142:145] offset:16384
	ds_store_b128 v124, v[118:121] offset:32
	ds_store_b128 v138, v[134:137] offset:24576
	ds_store_b128 v83, v[62:65] offset:64
	ds_store_b128 v130, v[126:129] offset:32768
	ds_store_b128 v114, v[110:113] offset:8192
	ds_store_b128 v106, v[86:89] offset:16384
	v_add_nc_u32_e32 v59, 0x1020, v1
	ds_store_b128 v60, v[26:29] offset:24576
	v_lshrrev_b32_e32 v27, 3, v44
	v_cvt_pk_bf16_f32 v54, v50, v51
	v_lshrrev_b32_e32 v51, 3, v52
	v_cvt_pk_bf16_f32 v46, v42, v43
	v_add_nc_u32_e32 v42, 0x4020, v1
	v_lshrrev_b32_e32 v59, 3, v59
	v_cvt_pk_bf16_f32 v29, v40, v41
	v_and_b32_e32 v40, 0x1ff0, v27
	v_cvt_pk_bf16_f32 v27, v36, v37
	v_add_nc_u32_e32 v36, 0x1030, v1
	v_lshlrev_b32_e32 v62, 1, v117
	v_and_b32_e32 v26, 0x1ff0, v51
	v_cvt_pk_bf16_f32 v28, v38, v39
	v_dual_lshrrev_b32 v38, 3, v42 :: v_dual_add_nc_u32 v108, 48, v1
	v_and_b32_e32 v59, 0x1ff0, v59
	v_cvt_pk_bf16_f32 v25, v24, v25
	v_cvt_pk_bf16_f32 v24, v22, v23
	v_cvt_pk_bf16_f32 v22, v18, v19
	v_dual_lshrrev_b32 v19, 3, v36 :: v_dual_add_nc_u32 v43, v26, v62
	v_cvt_pk_bf16_f32 v26, v34, v35
	v_and_b32_e32 v35, 0x1ff0, v38
	v_dual_add_nc_u32 v61, v61, v115 :: v_dual_add_nc_u32 v50, v59, v62
	v_cvt_pk_bf16_f32 v17, v16, v17
	v_cvt_pk_bf16_f32 v16, v14, v15
	v_cvt_pk_bf16_f32 v14, v10, v11
	v_and_b32_e32 v10, 0x1ff0, v19
	v_dual_lshlrev_b32 v19, 1, v108 :: v_dual_add_nc_u32 v34, v40, v62
	v_cvt_pk_bf16_f32 v23, v20, v21
	v_add_nc_u32_e32 v18, v35, v62
	v_cvt_pk_bf16_f32 v15, v12, v13
	v_add_nc_u32_e32 v11, 0x2030, v1
	ds_store_b128 v61, v[54:57] offset:32768
	ds_store_b128 v50, v[46:49] offset:8192
	ds_store_b128 v43, v[26:29] offset:16384
	ds_store_b128 v34, v[22:25] offset:24576
	ds_store_b128 v18, v[14:17] offset:32768
	v_add_nc_u32_e32 v18, v10, v19
	v_add_nc_u32_e32 v10, 0x3030, v1
	v_add_nc_u32_e32 v1, 0x4030, v1
	v_dual_lshrrev_b32 v84, 3, v108 :: v_dual_lshrrev_b32 v11, 3, v11
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_dual_lshrrev_b32 v4, 3, v10 :: v_dual_lshrrev_b32 v1, 3, v1
	v_and_b32_e32 v58, 0xff0, v84
	v_and_b32_e32 v11, 0x1ff0, v11
	v_cvt_pk_bf16_f32 v6, v2, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_and_b32_e32 v10, 0x1ff0, v4
	v_and_b32_e32 v1, 0x1ff0, v1
	v_dual_add_nc_u32 v58, v58, v141 :: v_dual_add_nc_u32 v20, v11, v19
	...
	ds_store_b128 v20, v[2:5] offset:16384
	ds_store_b128 v21, v[10:13] offset:24576
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn160_bk032_wm4_wn2_mc1, .Lfunc_end0-bm256_bn160_bk032_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn160_bk032_wm4_wn2_mc1
	...
	.section	.text.bm256_bn160_bk032_wm4_wn2_mc1,"axG",@progbits,bm256_bn160_bk032_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm256_bn160_bk032_wm4_wn2_mc1.num_vgpr, 258
	.set .Lbm256_bn160_bk032_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm256_bn160_bk032_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm256_bn160_bk032_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm256_bn160_bk032_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm256_bn160_bk032_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm256_bn160_bk032_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm256_bn160_bk032_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm256_bn160_bk032_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm256_bn160_bk032_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_cb22da47713b803e,@object ; @__hip_cuid_cb22da47713b803e
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_cb22da47713b803e
__hip_cuid_cb22da47713b803e:
	.byte	0                               ; 0x0
	.size	__hip_cuid_cb22da47713b803e, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_cb22da47713b803e
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn160_bk032_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn160_bk032_wm4_wn2_mc1.kd
