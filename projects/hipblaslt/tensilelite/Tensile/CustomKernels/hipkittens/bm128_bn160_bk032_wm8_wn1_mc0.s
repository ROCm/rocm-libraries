	...
	.section	.text.bm128_bn160_bk032_wm8_wn1_mc0,"axG",@progbits,bm128_bn160_bk032_wm8_wn1_mc0,comdat
	.protected	bm128_bn160_bk032_wm8_wn1_mc0 ; -- Begin function bm128_bn160_bk032_wm8_wn1_mc0
	.globl	bm128_bn160_bk032_wm8_wn1_mc0
	.p2align	8
	.type	bm128_bn160_bk032_wm8_wn1_mc0,@function
bm128_bn160_bk032_wm8_wn1_mc0: ; @bm128_bn160_bk032_wm8_wn1_mc0
; %bb.0:
...
; %bb.23:
	v_dual_lshlrev_b32 v1, 9, v89 :: v_dual_lshlrev_b32 v2, 5, v0
	v_and_b32_e32 v3, 16, v0
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s34, 0x4c80
	s_mov_b32 s7, s5
	...
	s_add_co_i32 s4, s6, 0x6e80
	s_add_co_i32 s42, s6, 0x4c80
	s_and_b32 s10, s4, 15
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_add_nc_u32 v82, v4, v1 :: v_dual_bitop2_b32 v3, v2, v3 bitop3:0x54
	v_dual_mov_b32 v85, 0 :: v_dual_lshlrev_b32 v1, 1, v0
	v_or_b32_e32 v4, 0x200, v2
	s_sub_co_i32 s7, 16, s10
	v_or_b32_e32 v10, 0x1000, v2
	s_lshr_b32 s6, s7, 2
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_dual_lshrrev_b32 v4, 4, v4 :: v_dual_bitop2_b32 v1, 24, v1 bitop3:0x40
	s_cmp_lg_u64 s[10:11], 0
	v_dual_lshrrev_b32 v5, 4, v5 :: v_dual_lshrrev_b32 v6, 4, v6
	v_dual_add_nc_u32 v86, v3, v1 :: v_dual_bitop2_b32 v4, 56, v4 bitop3:0x40
	v_lshrrev_b32_e32 v1, 4, v7
	v_or_b32_e32 v7, 0xa00, v2
	s_cselect_b32 s6, s6, 0
	s_ashr_i32 s7, s17, 31
	v_dual_lshrrev_b32 v10, 4, v10 :: v_dual_lshrrev_b32 v88, 8, v83
	s_delay_alu instid0(VALU_DEP_2)
	v_lshrrev_b32_e32 v7, 4, v7
	v_and_b32_e32 v9, 0x98, v1
	...
	v_and_b32_e32 v5, 0x58, v5
	v_and_b32_e32 v6, 0x78, v6
	v_and_b32_e32 v7, 0xb8, v7
	v_and_b32_e32 v8, 0xd8, v8
	v_and_b32_e32 v10, 0x118, v10
	v_and_b32_e32 v2, 0x138, v2
	v_dual_add_nc_u32 v1, 2, v88 :: v_dual_add_nc_u32 v12, 2, v90
	s_ashr_i32 s5, s4, 31
	s_ashr_i32 s7, s6, 31
	s_wait_kmcnt 0x0
	...
	v_dual_add_nc_u32 v92, v3, v4 :: v_dual_bitop2_b32 v93, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v94, v3, v5 :: v_dual_bitop2_b32 v95, 14, v12 bitop3:0x40
	v_dual_add_nc_u32 v96, v3, v6 :: v_dual_add_nc_u32 v98, v3, v9
	v_dual_add_nc_u32 v100, v3, v7 :: v_dual_add_nc_u32 v102, v3, v8
	v_dual_add_nc_u32 v104, v3, v11 :: v_dual_add_nc_u32 v106, v3, v10
	v_dual_mov_b32 v3, v85 :: v_dual_add_nc_u32 v108, v3, v2
	...
	v_dual_mov_b32 v25, v85 :: v_dual_mov_b32 v42, v85
	...
	v_dual_mov_b32 v49, v85 :: v_dual_mov_b32 v58, v85
	...
	v_dual_mov_b32 v81, v85 :: v_dual_mov_b32 v26, v85
	...
	v_dual_mov_b32 v57, v85 :: v_dual_mov_b32 v83, v88
...
.LBB0_27:                               ;   in Loop: Header=BB0_28 Depth=2
	...
	v_cmp_eq_u32_e32 vcc_lo, s6, v93
...
; %bb.29:                               ;   in Loop: Header=BB0_28 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[112:113], v[84:85], 2, s[12:13]
...
.LBB0_33:                               ;   in Loop: Header=BB0_34 Depth=2
	...
	s_add_co_i32 s6, s6, 2
	v_add_nc_u32_e32 v111, 0x200, v111
	v_cmp_eq_u32_e32 vcc_lo, s6, v95
	v_add_nc_u32_e32 v110, 0x200, v110
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
.LBB0_34:                               ;   Parent Loop BB0_25 Depth=1
	...
	s_or_b64 s[14:15], s[6:7], 0x100000000
	s_mov_b32 s7, exec_lo
	v_cmp_le_u32_e32 vcc_lo, s15, v87
	v_cmpx_le_u32_e64 s14, v90
...
; %bb.43:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v97, s14 :: v_dual_mov_b32 v110, s12
...
.LBB0_45:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v97, s5 :: v_dual_mov_b32 v110, s6
	s_and_b32 s0, s7, 0x1ffffff
	s_and_b32 s7, s29, s12
	s_bitset1_b32 s0, 31
	v_cndmask_b32_e64 v84, 0, 1, s7
	v_mov_b32_e32 v99, s0
	v_readfirstlane_b32 s13, v97
	v_readfirstlane_b32 s14, v110
	s_lshr_b64 s[6:7], s[30:31], 16
...
.LBB0_46:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_lshl_add_u32 v84, v82, 1, s0
	v_lshl_add_u32 v97, v86, 1, s2
	v_lshl_add_u32 v99, v98, 1, s2
	v_lshl_add_u32 v101, v104, 1, s2
	ds_load_b128 v[110:113], v84
	ds_load_b128 v[114:117], v84 offset:16
	v_lshl_add_u32 v84, v92, 1, s2
	ds_load_b128 v[118:121], v97
	ds_load_b128 v[122:125], v97 offset:16
	v_lshl_add_u32 v97, v96, 1, s2
	ds_load_b128 v[150:153], v99 offset:4096
	ds_load_b128 v[126:129], v84 offset:1024
	ds_load_b128 v[130:133], v84 offset:1040
	v_lshl_add_u32 v84, v94, 1, s2
	ds_load_b128 v[142:145], v97 offset:3072
	ds_load_b128 v[146:149], v97 offset:3088
	v_lshl_add_u32 v97, v102, 1, s2
	ds_load_b128 v[134:137], v84 offset:2048
	ds_load_b128 v[138:141], v84 offset:2064
	v_lshl_add_u32 v84, v106, 1, s2
	...
	ds_load_b128 v[118:121], v84 offset:8192
	ds_load_b128 v[122:125], v84 offset:8208
	v_lshl_add_u32 v84, v108, 1, s2
	ds_load_b128 v[154:157], v99 offset:4112
	ds_load_b128 v[142:145], v97 offset:6144
	ds_load_b128 v[146:149], v97 offset:6160
	ds_load_b128 v[158:161], v101 offset:7168
	ds_load_b128 v[126:129], v84 offset:9216
	ds_load_b128 v[130:133], v84 offset:9232
	v_lshl_add_u32 v84, v100, 1, s2
	ds_load_b128 v[162:165], v101 offset:7184
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[110:117], v[158:165], v[26:33] matrix_a_reuse
	ds_load_b128 v[134:137], v84 offset:5120
	ds_load_b128 v[138:141], v84 offset:5136
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(11) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[110:117], v[118:125], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[110:117], v[126:133], v[50:57] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[110:117], v[150:157], v[18:25] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[110:117], v[134:141], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[110:117], v[142:149], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
...
; %bb.48:
	...
	v_lshl_or_b32 v68, v89, 5, v68
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_and_b32_e32 v10, 0x7f0, v10
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_lshrrev_b32_e32 v4, 3, v11
	v_and_b32_e32 v74, 0xf0, v83
	v_and_b32_e32 v42, 0x4f0, v59
	v_lshrrev_b32_e32 v1, 3, v1
	v_and_b32_e32 v69, 0x1f0, v69
	v_and_b32_e32 v66, 0x3f0, v66
	v_and_b32_e32 v43, 0x5f0, v43
	v_and_b32_e32 v19, 0x6f0, v20
	v_add_nc_u32_e32 v45, v10, v68
	v_and_b32_e32 v10, 0x8f0, v4
	...
	ds_store_b128 v43, v[14:17] offset:20480
	ds_store_b128 v44, v[6:9] offset:24576
	ds_store_b128 v45, v[2:5] offset:28672
	ds_store_b128 v26, v[10:13] offset:32768
	ds_store_b128 v1, v[18:21] offset:36864
.LBB0_49:
...
.LBB0_60:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn160_bk032_wm8_wn1_mc0, .Lfunc_end0-bm128_bn160_bk032_wm8_wn1_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn160_bk032_wm8_wn1_mc0
	...
	.section	.text.bm128_bn160_bk032_wm8_wn1_mc0,"axG",@progbits,bm128_bn160_bk032_wm8_wn1_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn160_bk032_wm8_wn1_mc0.num_vgpr, 166
	.set .Lbm128_bn160_bk032_wm8_wn1_mc0.num_agpr, 0
	.set .Lbm128_bn160_bk032_wm8_wn1_mc0.numbered_sgpr, 56
	.set .Lbm128_bn160_bk032_wm8_wn1_mc0.num_named_barrier, 0
	.set .Lbm128_bn160_bk032_wm8_wn1_mc0.private_seg_size, 0
	.set .Lbm128_bn160_bk032_wm8_wn1_mc0.uses_vcc, 1
	.set .Lbm128_bn160_bk032_wm8_wn1_mc0.uses_flat_scratch, 0
	.set .Lbm128_bn160_bk032_wm8_wn1_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn160_bk032_wm8_wn1_mc0.has_recursion, 0
	.set .Lbm128_bn160_bk032_wm8_wn1_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_e30890ed8a54ca43,@object ; @__hip_cuid_e30890ed8a54ca43
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_e30890ed8a54ca43
__hip_cuid_e30890ed8a54ca43:
	.byte	0                               ; 0x0
	.size	__hip_cuid_e30890ed8a54ca43, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_e30890ed8a54ca43
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn160_bk032_wm8_wn1_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn160_bk032_wm8_wn1_mc0.kd
