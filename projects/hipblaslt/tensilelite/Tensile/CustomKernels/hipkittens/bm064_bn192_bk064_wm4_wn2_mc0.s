	...
	.section	.text.bm064_bn192_bk064_wm4_wn2_mc0,"axG",@progbits,bm064_bn192_bk064_wm4_wn2_mc0,comdat
	.protected	bm064_bn192_bk064_wm4_wn2_mc0 ; -- Begin function bm064_bn192_bk064_wm4_wn2_mc0
	.globl	bm064_bn192_bk064_wm4_wn2_mc0
	.p2align	8
	.type	bm064_bn192_bk064_wm4_wn2_mc0,@function
bm064_bn192_bk064_wm4_wn2_mc0: ; @bm064_bn192_bk064_wm4_wn2_mc0
; %bb.0:
...
; %bb.19:
	...
	s_movk_i32 s16, 0xc0
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mov_b32 v53, 0 :: v_dual_lshrrev_b32 v7, 4, v6
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_add_nc_u32_e32 v50, v5, v1
	v_or_b32_e32 v1, 0x400, v6
	v_add_nc_u32_e32 v10, 0x1000, v6
	v_add_nc_u32_e32 v54, v7, v6
	v_add_nc_u32_e32 v12, 0x820, v6
	v_add_nc_u32_e32 v13, 0xc20, v6
	v_lshrrev_b32_e32 v1, 4, v1
	v_add_nc_u32_e32 v14, 0x1020, v6
	v_add_nc_u32_e32 v15, 0x1420, v6
	v_add3_u32 v68, v4, v3, v5
	v_mov_b32_e32 v4, v53
	v_and_b32_e32 v11, 0x1f8, v1
	v_add_nc_u32_e32 v1, 0x1400, v6
	...
	v_dual_mov_b32 v5, v53 :: v_dual_lshrrev_b32 v12, 4, v12
	s_and_b32 s10, s4, 15
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v16, 0x3f8, v1
	v_dual_lshrrev_b32 v1, 4, v13 :: v_dual_lshrrev_b32 v13, 4, v14
	v_lshrrev_b32_e32 v14, 4, v15
	v_sub_nc_u32_e32 v15, 0x197f, v0
	s_mul_i32 s0, s1, 0xc0
	s_sub_co_i32 s1, 16, s10
	s_add_co_i32 s43, s6, 0x8800
	s_lshr_b32 s1, s1, 2
	v_and_b32_e32 v17, 0x3f8, v1
	v_dual_add_nc_u32 v64, v10, v6 :: v_dual_mov_b32 v10, v53
	...
	v_dual_lshrrev_b32 v56, 8, v51 :: v_dual_add_nc_u32 v15, 1, v1
	v_add_nc_u32_e32 v8, 0x800, v6
	s_add_co_i32 s17, s17, s6
	s_lshl_b32 s10, s1, 2
	s_ashr_i32 s45, s17, 6
	s_cmp_lt_i32 s3, 0xc0
	v_dual_mov_b32 v51, v56 :: v_dual_bitop2_b32 v63, 26, v15 bitop3:0x40
	v_dual_mov_b32 v7, v53 :: v_dual_add_nc_u32 v70, v7, v2
	v_add3_u32 v72, v2, v11, 0x400
	v_add3_u32 v74, v2, v12, 0x800
	v_add3_u32 v76, v2, v17, 0xc00
	v_add3_u32 v78, v2, v13, 0x1000
	v_add3_u32 v80, v2, v14, 0x1400
	v_dual_mov_b32 v2, v53 :: v_dual_lshrrev_b32 v8, 4, v8
	...
	v_dual_add_nc_u32 v1, 2, v56 :: v_dual_add_nc_u32 v58, v11, v6
	v_lshl_or_b32 v18, v63, 8, v0
	...
	v_cmp_ne_u32_e64 s0, v15, v63
	v_dual_add_nc_u32 v62, v9, v6 :: v_dual_add_nc_u32 v66, v16, v6
	v_dual_mov_b32 v12, v53 :: v_dual_add_nc_u32 v67, 0xffffff00, v18
	v_dual_mov_b32 v13, v53 :: v_dual_lshlrev_b32 v82, 2, v18
	v_dual_mov_b32 v6, v53 :: v_dual_mov_b32 v8, v53
	v_dual_mov_b32 v9, v53 :: v_dual_mov_b32 v11, v53
...
; %bb.25:                               ;   in Loop: Header=BB0_24 Depth=2
	...
	v_lshl_add_u64 v[86:87], v[52:53], 2, s[12:13]
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v52, v84 :: v_dual_add_nc_u32 v69, -2, v69
	v_dual_mov_b32 v86, v85 :: v_dual_mov_b32 v87, v53
	v_add_nc_u32_e32 v85, 0x200, v85
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_dual_mov_b32 v69, s14 :: v_dual_mov_b32 v84, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v69, s5 :: v_dual_mov_b32 v84, s6
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v71, v72, 1, s1
	v_lshl_add_u32 v73, v74, 1, s1
	v_lshl_add_u32 v75, v76, 1, s1
	ds_load_b128 v[84:87], v52
	ds_load_b128 v[88:91], v52 offset:16
	v_lshl_add_u32 v52, v58, 1, s1
	ds_load_b128 v[92:95], v69
	ds_load_b128 v[96:99], v69 offset:16
	v_lshl_add_u32 v69, v64, 1, s1
	v_lshl_add_u32 v77, v78, 1, s1
	ds_load_b128 v[100:103], v52 offset:2048
	ds_load_b128 v[104:107], v52 offset:2064
	v_lshl_add_u32 v52, v60, 1, s1
	v_lshl_add_u32 v79, v80, 1, s1
	ds_load_b128 v[124:127], v73 offset:64
	ds_load_b128 v[128:131], v73 offset:80
	ds_load_b128 v[132:135], v75 offset:64
	ds_load_b128 v[108:111], v52 offset:4096
	ds_load_b128 v[136:139], v75 offset:80
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[42:49], v[84:91], v[92:99], v[42:49]
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[34:41], v[84:91], v[100:107], v[34:41] matrix_a_reuse
	ds_load_b128 v[112:115], v52 offset:4112
	v_lshl_add_u32 v52, v62, 1, s1
	ds_load_b128 v[100:103], v52 offset:6144
	ds_load_b128 v[104:107], v52 offset:6160
	v_lshl_add_u32 v52, v68, 1, s2
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[84:91], v[100:107], v[10:17] matrix_a_reuse
	ds_load_b128 v[92:95], v69 offset:8192
	ds_load_b128 v[96:99], v69 offset:8208
	v_lshl_add_u32 v69, v66, 1, s1
	ds_load_b128 v[100:103], v79 offset:64
	ds_load_b128 v[104:107], v79 offset:80
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[84:91], v[92:99], v[2:9] matrix_a_reuse
	ds_load_b128 v[92:95], v69 offset:10240
	ds_load_b128 v[96:99], v69 offset:10256
	v_lshl_add_u32 v69, v70, 1, s1
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	ds_load_b128 v[116:119], v69 offset:64
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[26:33], v[84:91], v[92:99], v[26:33] matrix_a_reuse
	ds_load_b128 v[92:95], v52 offset:64
	ds_load_b128 v[96:99], v52 offset:80
	ds_load_b128 v[120:123], v69 offset:80
	v_wmma_f32_16x16x32_bf16 v[18:25], v[84:91], v[108:115], v[18:25] matrix_a_reuse
	ds_load_b128 v[108:111], v71 offset:64
	ds_load_b128 v[112:115], v71 offset:80
	ds_load_b128 v[84:87], v77 offset:64
	ds_load_b128 v[88:91], v77 offset:80
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[42:49], v[92:99], v[116:123], v[42:49]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[34:41], v[92:99], v[108:115], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[92:99], v[124:131], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[92:99], v[132:139], v[10:17] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[2:9], v[92:99], v[84:91], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[92:99], v[100:107], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn192_bk064_wm4_wn2_mc0, .Lfunc_end0-bm064_bn192_bk064_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn192_bk064_wm4_wn2_mc0
	...
	.section	.text.bm064_bn192_bk064_wm4_wn2_mc0,"axG",@progbits,bm064_bn192_bk064_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn192_bk064_wm4_wn2_mc0.num_vgpr, 140
	.set .Lbm064_bn192_bk064_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm064_bn192_bk064_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm064_bn192_bk064_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm064_bn192_bk064_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm064_bn192_bk064_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm064_bn192_bk064_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn192_bk064_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn192_bk064_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm064_bn192_bk064_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_1ab810a5558bc150,@object ; @__hip_cuid_1ab810a5558bc150
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_1ab810a5558bc150
__hip_cuid_1ab810a5558bc150:
	.byte	0                               ; 0x0
	.size	__hip_cuid_1ab810a5558bc150, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_1ab810a5558bc150
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn192_bk064_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn192_bk064_wm4_wn2_mc0.kd
