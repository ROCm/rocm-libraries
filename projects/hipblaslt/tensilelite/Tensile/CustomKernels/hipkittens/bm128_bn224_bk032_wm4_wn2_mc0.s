	...
	.section	.text.bm128_bn224_bk032_wm4_wn2_mc0,"axG",@progbits,bm128_bn224_bk032_wm4_wn2_mc0,comdat
	.protected	bm128_bn224_bk032_wm4_wn2_mc0 ; -- Begin function bm128_bn224_bk032_wm4_wn2_mc0
	.globl	bm128_bn224_bk032_wm4_wn2_mc0
	.p2align	8
	.type	bm128_bn224_bk032_wm4_wn2_mc0,@function
bm128_bn224_bk032_wm4_wn2_mc0: ; @bm128_bn224_bk032_wm4_wn2_mc0
; %bb.0:
...
; %bb.1:
	...
	s_or_b32 s2, s4, s2
.LBB0_2:
	v_sub_nc_u32_e32 v115, 0x87f, v0
...
.LBB0_22:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 4, v125 :: v_dual_mov_b32 v9, 0
	v_and_b32_e32 v114, 32, v0
	s_and_b32 s40, s29, s25
	s_mov_b32 s11, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v123, 0x60, v1
	v_mov_b32_e32 v8, v9
	...
	v_cndmask_b32_e64 v127, 0, 0x70, vcc_lo
	v_cndmask_b32_e64 v121, 0, 1, s40
	s_and_not1_b32 vcc_lo, exec_lo, s16
	s_barrier_wait -1
	s_cbranch_vccnz .LBB0_47
; %bb.23:
	v_dual_lshlrev_b32 v2, 5, v123 :: v_dual_lshlrev_b32 v4, 5, v0
	v_dual_lshlrev_b32 v1, 5, v127 :: v_dual_bitop2_b32 v3, 16, v0 bitop3:0x40
	...
	s_movk_i32 s16, 0xe0
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mov_b32 v117, 0 :: v_dual_lshrrev_b32 v1, 4, v2
	...
	v_add_nc_u32_e32 v8, 0xa00, v3
	v_add_nc_u32_e32 v114, v1, v2
	v_dual_lshrrev_b32 v1, 4, v6 :: v_dual_add_nc_u32 v118, v5, v3
	v_and_b32_e32 v4, 0xf8, v4
	v_add_nc_u32_e32 v5, 0x400, v3
	v_add_nc_u32_e32 v6, 0x600, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_and_b32_e32 v7, 0x1f8, v1
	s_cselect_b32 s4, s4, 0
	v_dual_add_nc_u32 v124, v4, v2 :: v_dual_mov_b32 v2, v117
	v_dual_lshrrev_b32 v5, 4, v5 :: v_dual_lshrrev_b32 v6, 4, v6
	s_lshl2_add_u32 s0, s4, s0
	v_dual_mov_b32 v4, v117 :: v_dual_add_nc_u32 v1, 0x800, v3
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v5, 0x1f8, v5
	s_add_co_i32 s4, s0, 0x7f80
	v_and_b32_e32 v6, 0x1f8, v6
	s_and_b32 s10, s4, 15
	s_add_co_i32 s42, s0, 0x5d80
	v_add_nc_u32_e32 v128, v5, v3
	v_dual_mov_b32 v5, v117 :: v_dual_lshrrev_b32 v1, 4, v1
	...
	s_lshr_b32 s7, s7, 27
	v_add_nc_u32_e32 v130, v6, v3
	s_add_co_i32 s17, s17, s7
	v_dual_add_nc_u32 v132, v10, v3 :: v_dual_add_nc_u32 v134, v8, v3
	v_dual_mov_b32 v6, v117 :: v_dual_lshrrev_b32 v9, 4, v9
	v_dual_mov_b32 v8, v117 :: v_dual_lshrrev_b32 v122, 8, v1
	v_add_nc_u32_e32 v1, 2, v120
	s_lshl_b32 s10, s0, 2
	s_ashr_i32 s44, s17, 5
	s_cmp_lt_i32 s3, 0xe0
	s_mul_i32 s6, s34, 0xe0
	s_add_nc_u64 s[34:35], s[4:5], s[10:11]
	s_cselect_b32 s45, -1, 0
	s_lshl_b32 s4, s2, 7
	v_and_b32_e32 v9, 0x1f8, v9
	v_dual_add_nc_u32 v11, 2, v122 :: v_dual_bitop2_b32 v129, 30, v1 bitop3:0x40
	s_ashr_i32 s7, s6, 31
	s_ashr_i32 s5, s4, 31
	s_wait_kmcnt 0x0
	...
	v_and_b32_e32 v131, 30, v11
	v_dual_add_nc_u32 v126, v7, v3 :: v_dual_add_nc_u32 v136, v9, v3
	v_dual_mov_b32 v115, v120 :: v_dual_mov_b32 v3, v117
	v_dual_mov_b32 v7, v117 :: v_dual_mov_b32 v9, v117
...
.LBB0_28:                               ;   Parent Loop BB0_25 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s15, v115
	v_cmpx_le_u32_e64 s14, v120
	s_cbranch_execz .LBB0_30
; %bb.29:                               ;   in Loop: Header=BB0_28 Depth=2
	v_mov_b32_e32 v116, v138
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[140:141], v[116:117], 2, s[12:13]
...
.LBB0_34:                               ;   Parent Loop BB0_25 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s12, v119
	v_cmpx_le_u32_e64 s12, v122
...
; %bb.43:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v133, s14 :: v_dual_mov_b32 v138, s12
...
.LBB0_45:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_nop
	v_dual_mov_b32 v133, s5 :: v_dual_mov_b32 v138, s6
	s_and_b32 s0, s7, 0x1ffffff
	s_and_b32 s7, s29, s12
	s_bitset1_b32 s0, 31
	v_cndmask_b32_e64 v116, 0, 1, s7
	v_mov_b32_e32 v135, s0
	v_readfirstlane_b32 s13, v133
	v_readfirstlane_b32 s14, v138
	s_lshr_b64 s[6:7], s[30:31], 16
	v_readfirstlane_b32 s12, v116
	v_readfirstlane_b32 s15, v135
	s_lshl_b32 s5, s30, 16
	s_mov_b32 s7, s47
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
.LBB0_46:                               ;   in Loop: Header=BB0_25 Depth=1
	...
	v_lshl_add_u32 v116, v114, 1, s0
	v_lshl_add_u32 v133, v126, 1, s2
	v_lshl_add_u32 v135, v134, 1, s2
	ds_load_b128 v[138:141], v116
	ds_load_b128 v[142:145], v116 offset:16
	v_lshl_add_u32 v116, v124, 1, s0
	ds_load_b128 v[146:149], v133 offset:1024
	ds_load_b128 v[150:153], v133 offset:1040
	v_lshl_add_u32 v133, v128, 1, s2
	ds_load_b128 v[154:157], v116 offset:1024
	ds_load_b128 v[158:161], v116 offset:1040
	v_lshl_add_u32 v116, v118, 1, s2
	ds_load_b128 v[170:173], v133 offset:2048
	ds_load_b128 v[162:165], v116
	ds_load_b128 v[166:169], v116 offset:16
	v_lshl_add_u32 v116, v130, 1, s2
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[98:105], v[138:145], v[146:153], v[98:105] matrix_a_reuse
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[18:25], v[154:161], v[146:153], v[18:25] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[106:113], v[138:145], v[162:169], v[106:113]
	v_wmma_f32_16x16x32_bf16 v[42:49], v[154:161], v[162:169], v[42:49] matrix_a_reuse
	ds_load_b128 v[174:177], v133 offset:2064
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[154:161], v[170:177], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[90:97], v[138:145], v[170:177], v[90:97] matrix_a_reuse
	ds_load_b128 v[146:149], v116 offset:3072
	ds_load_b128 v[150:153], v116 offset:3088
	v_lshl_add_u32 v116, v132, 1, s2
	ds_load_b128 v[186:189], v135 offset:5120
	ds_load_b128 v[190:193], v135 offset:5136
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	ds_load_b128 v[162:165], v116 offset:4096
	ds_load_b128 v[166:169], v116 offset:4112
	v_lshl_add_u32 v116, v136, 1, s2
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[50:57], v[138:145], v[186:193], v[50:57] matrix_a_reuse
	ds_load_b128 v[178:181], v116 offset:6144
	ds_load_b128 v[182:185], v116 offset:6160
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[82:89], v[138:145], v[146:153], v[82:89] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[74:81], v[138:145], v[162:169], v[74:81] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[154:161], v[162:169], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[154:161], v[146:153], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[138:145], v[178:185], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[154:161], v[178:185], v[66:73]
...
; %bb.48:
	...
	v_add_nc_u32_e32 v42, 0x2800, v1
	...
	v_dual_add_nc_u32 v98, 16, v1 :: v_dual_lshrrev_b32 v92, 3, v100
	...
	v_add_nc_u32_e32 v45, 0x1010, v1
	...
	v_dual_add_nc_u32 v82, v88, v93 :: v_dual_add_nc_u32 v43, v50, v93
	v_cvt_pk_bf16_f32 v31, v28, v29
	v_add_nc_u32_e32 v26, v42, v44
	v_cvt_pk_bf16_f32 v25, v24, v25
	v_cvt_pk_bf16_f32 v24, v22, v23
	v_cvt_pk_bf16_f32 v23, v20, v21
	v_cvt_pk_bf16_f32 v22, v18, v19
	v_and_b32_e32 v18, 0xff0, v27
	v_dual_add_nc_u32 v99, v101, v93 :: v_dual_add_nc_u32 v74, v83, v93
	v_cvt_pk_bf16_f32 v55, v52, v53
	ds_store_b128 v82, v[78:81] offset:16384
	ds_store_b128 v74, v[54:57] offset:20480
	ds_store_b128 v43, v[30:33] offset:24576
	ds_store_b128 v99, v[46:49] offset:32
	ds_store_b128 v26, v[22:25] offset:4096
	v_add_nc_u32_e32 v22, v18, v44
	v_add_nc_u32_e32 v18, 0x2010, v1
	v_add_nc_u32_e32 v20, 0x1810, v1
	v_cvt_pk_bf16_f32 v17, v16, v17
	v_cvt_pk_bf16_f32 v16, v14, v15
	v_cvt_pk_bf16_f32 v14, v10, v11
	v_lshrrev_b32_e32 v10, 3, v18
	v_add_nc_u32_e32 v11, 0x2810, v1
	...
	v_cvt_pk_bf16_f32 v21, v72, v73
	v_cvt_pk_bf16_f32 v20, v70, v71
	v_cvt_pk_bf16_f32 v19, v68, v69
	v_cvt_pk_bf16_f32 v18, v66, v67
	ds_store_b128 v22, v[14:17] offset:8192
	ds_store_b128 v23, v[6:9] offset:12288
	ds_store_b128 v24, v[2:5] offset:16384
	ds_store_b128 v25, v[10:13] offset:20480
	ds_store_b128 v1, v[18:21] offset:24576
.LBB0_49:
...
.LBB0_60:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn224_bk032_wm4_wn2_mc0, .Lfunc_end0-bm128_bn224_bk032_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn224_bk032_wm4_wn2_mc0
	...
	.section	.text.bm128_bn224_bk032_wm4_wn2_mc0,"axG",@progbits,bm128_bn224_bk032_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn224_bk032_wm4_wn2_mc0.num_vgpr, 194
	.set .Lbm128_bn224_bk032_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm128_bn224_bk032_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm128_bn224_bk032_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm128_bn224_bk032_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm128_bn224_bk032_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm128_bn224_bk032_wm4_wn2_mc0.uses_flat_scratch, 0
	.set .Lbm128_bn224_bk032_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn224_bk032_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm128_bn224_bk032_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_d8b280cd1c2b0e5e,@object ; @__hip_cuid_d8b280cd1c2b0e5e
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_d8b280cd1c2b0e5e
__hip_cuid_d8b280cd1c2b0e5e:
	.byte	0                               ; 0x0
	.size	__hip_cuid_d8b280cd1c2b0e5e, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_d8b280cd1c2b0e5e
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn224_bk032_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn224_bk032_wm4_wn2_mc0.kd
