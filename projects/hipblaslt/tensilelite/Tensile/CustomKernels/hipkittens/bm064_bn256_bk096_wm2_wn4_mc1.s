	...
	.section	.text.bm064_bn256_bk096_wm2_wn4_mc1,"axG",@progbits,bm064_bn256_bk096_wm2_wn4_mc1,comdat
	.protected	bm064_bn256_bk096_wm2_wn4_mc1 ; -- Begin function bm064_bn256_bk096_wm2_wn4_mc1
	.globl	bm064_bn256_bk096_wm2_wn4_mc1
	.p2align	8
	.type	bm064_bn256_bk096_wm2_wn4_mc1,@function
bm064_bn256_bk096_wm2_wn4_mc1: ; @bm064_bn256_bk096_wm2_wn4_mc1
; %bb.0:
...
.LBB0_20:
	...
	v_dual_lshlrev_b32 v1, 3, v73 :: v_dual_lshlrev_b32 v2, 6, v73
	v_mov_b32_e32 v9, 0
	s_and_b32 s43, s35, s29
	s_and_not1_b32 vcc_lo, exec_lo, s13
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v75, 32, v1
	v_and_b32_e32 v77, 0xc0, v2
...
; %bb.21:
	...
	v_dual_lshrrev_b32 v6, 4, v13 :: v_dual_add_nc_u32 v4, v4, v8
	v_dual_add_nc_u32 v7, v9, v8 :: v_dual_mov_b32 v69, 0
	v_mad_u32_u24 v26, 0x60, v5, v9
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_and_b32_e32 v6, 0x7f8, v6
	v_dual_lshrrev_b32 v4, 4, v4 :: v_dual_lshrrev_b32 v7, 4, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v17, v69 :: v_dual_add_nc_u32 v12, 0xc00, v13
	v_or_b32_e32 v3, 64, v3
	v_and_b32_e32 v15, 0x3f8, v4
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v12, 4, v12 :: v_dual_bitop2_b32 v4, v2, v10 bitop3:0x54
	v_add_nc_u32_e32 v70, v6, v13
	v_add_nc_u32_e32 v6, 0x1200, v13
	v_and_b32_e32 v7, 0xff8, v7
	v_mad_u32_u24 v14, 0x60, v5, v4
	v_dual_add_nc_u32 v4, v4, v8 :: v_dual_bitop2_b32 v10, v1, v10 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_lshrrev_b32_e32 v6, 4, v6
	v_and_b32_e32 v18, 0xff8, v12
	v_dual_lshrrev_b32 v4, 4, v4 :: v_dual_bitop2_b32 v1, v1, v3 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_4)
	v_mad_u32_u24 v12, 0x60, v5, v10
	v_lshrrev_b32_e32 v14, 4, v14
	v_and_b32_e32 v19, 0xff8, v6
	v_dual_mov_b32 v21, v69 :: v_dual_add_nc_u32 v16, 0x600, v11
	v_and_b32_e32 v68, 0x3f8, v4
	v_lshrrev_b32_e32 v4, 4, v12
	v_and_b32_e32 v22, 0x3f8, v14
	v_or_b32_e32 v14, v2, v3
	v_add_nc_u32_e32 v2, 0x1200, v12
	v_dual_mov_b32 v9, v69 :: v_dual_add_nc_u32 v80, v19, v13
	v_dual_mov_b32 v19, v69 :: v_dual_add_nc_u32 v6, v10, v8
	v_add_nc_u32_e32 v10, 0xc00, v12
	v_and_b32_e32 v23, 0xff8, v4
	v_lshrrev_b32_e32 v12, 4, v2
	v_dual_add_nc_u32 v76, v7, v26 :: v_dual_add_nc_u32 v84, v22, v11
	v_lshrrev_b32_e32 v4, 4, v6
	v_lshrrev_b32_e32 v6, 4, v10
	v_mad_u32_u24 v10, 0x60, v5, v14
	v_dual_mov_b32 v7, v69 :: v_dual_add_nc_u32 v74, v15, v11
	v_add_nc_u32_e32 v78, v18, v13
	v_and_b32_e32 v2, 0xff8, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_lshrrev_b32_e32 v3, 4, v10
	v_mad_u32_u24 v10, 0x60, v5, v1
	v_and_b32_e32 v4, 0x1ff8, v6
	v_and_b32_e32 v6, 0x1ff8, v12
	v_add_nc_u32_e32 v12, v14, v8
	v_and_b32_e32 v24, 0x3f8, v3
	v_add_nc_u32_e32 v1, v1, v8
	v_add_nc_u32_e32 v3, 0xc00, v10
	v_add_nc_u32_e32 v8, 0x1200, v10
	...
	v_and_b32_e32 v8, 0x3f8, v12
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v10, 0xff8, v1
	v_and_b32_e32 v12, 0x1ff8, v3
	v_and_b32_e32 v14, 0x1ff8, v14
	v_add_nc_u64_e32 v[82:83], v[68:69], v[16:17]
	v_dual_mov_b32 v3, v69 :: v_dual_add_nc_u32 v68, 0x600, v26
	v_dual_mov_b32 v5, v69 :: v_dual_add_nc_u32 v18, 0xc00, v26
	v_dual_mov_b32 v13, v69 :: v_dual_add_nc_u32 v20, 0x1200, v26
	v_dual_mov_b32 v15, v69 :: v_dual_add_nc_u32 v86, v23, v26
	v_dual_mov_b32 v11, v69 :: v_dual_add_nc_u32 v94, v24, v11
	v_add_nc_u32_e32 v1, 2, v72
	s_mul_u64 s[18:19], s[20:21], s[18:19]
	v_add_nc_u64_e32 v[88:89], v[2:3], v[68:69]
	v_add_nc_u64_e32 v[90:91], v[4:5], v[18:19]
	v_add_nc_u64_e32 v[92:93], v[6:7], v[20:21]
	v_add_nc_u64_e32 v[96:97], v[8:9], v[16:17]
	v_add_nc_u64_e32 v[100:101], v[10:11], v[68:69]
	v_add_nc_u64_e32 v[102:103], v[12:13], v[18:19]
	v_add_nc_u64_e32 v[104:105], v[14:15], v[20:21]
	v_cmp_eq_u32_e64 s0, 0, v73
	v_and_b32_e32 v79, 30, v1
	v_or_b32_e32 v1, 0x100, v0
	v_dual_add_nc_u32 v67, -1, v72 :: v_dual_add_nc_u32 v98, v25, v26
	v_lshl_or_b32 v106, v0, 2, 0xc800
	v_dual_mov_b32 v107, v69 :: v_dual_mov_b32 v4, v69
	...
	v_dual_mov_b32 v16, v69 :: v_dual_mov_b32 v26, v69
	...
	v_dual_mov_b32 v33, v69 :: v_dual_mov_b32 v18, v69
...
.LBB0_31:                               ;   Parent Loop BB0_23 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v68, v108 :: v_dual_add_nc_u32 v83, -2, v83
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_lshl_add_u32 v87, v88, 1, s1
	v_lshl_add_u32 v89, v90, 1, s1
	ds_load_b128 v[108:111], v68
	ds_load_b128 v[112:115], v68 offset:16
	v_lshl_add_u32 v68, v70, 1, s1
	ds_load_b128 v[116:119], v83 offset:3072
	ds_load_b128 v[120:123], v83 offset:3088
	v_lshl_add_u32 v83, v82, 1, s2
	v_lshl_add_u32 v91, v92, 1, s1
	ds_load_b128 v[132:135], v68
	ds_load_b128 v[136:139], v68 offset:16
	v_lshl_add_u32 v68, v78, 1, s1
	ds_load_b128 v[148:151], v83 offset:64
	ds_load_b128 v[152:155], v83 offset:80
	ds_load_b128 v[156:159], v87 offset:64
	ds_load_b128 v[160:163], v87 offset:80
	ds_load_b128 v[164:167], v89 offset:64
	ds_load_b128 v[168:171], v89 offset:80
	ds_load_b128 v[172:175], v91 offset:64
	ds_load_b128 v[176:179], v91 offset:80
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[26:33], v[116:123], v[132:139], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[108:115], v[132:139], v[58:65]
	ds_load_b128 v[132:135], v68 offset:6144
	ds_load_b128 v[136:139], v68 offset:6160
	v_lshl_add_u32 v68, v80, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[108:115], v[132:139], v[42:49] matrix_a_reuse
	ds_load_b128 v[124:127], v85 offset:3072
	ds_load_b128 v[128:131], v85 offset:3088
	v_lshl_add_u32 v85, v86, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[116:123], v[124:131], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[108:115], v[124:131], v[50:57] matrix_a_reuse
	ds_load_b128 v[128:131], v68 offset:9232
	ds_load_b128 v[124:127], v68 offset:9216
	v_lshl_add_u32 v68, v84, 1, s2
	ds_load_b128 v[140:143], v68 offset:64
	ds_load_b128 v[144:147], v68 offset:80
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[18:25], v[108:115], v[124:131], v[18:25] matrix_a_reuse
	...
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[116:123], v[132:139], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[116:123], v[124:131], v[34:41]
	ds_load_b128 v[116:119], v85 offset:64
	ds_load_b128 v[120:123], v85 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v68, v94, 1, s2
	v_lshl_add_u32 v83, v96, 1, s2
	ds_load_b128 v[108:111], v68 offset:128
	ds_load_b128 v[112:115], v68 offset:144
	v_lshl_add_u32 v68, v98, 1, s1
	ds_load_b128 v[124:127], v83 offset:128
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[58:65], v[140:147], v[116:123], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[140:147], v[156:163], v[50:57] matrix_a_reuse
	ds_load_b128 v[132:135], v68 offset:128
	ds_load_b128 v[136:139], v68 offset:144
	v_lshl_add_u32 v68, v100, 1, s1
	ds_load_b128 v[128:131], v83 offset:144
	v_lshl_add_u32 v83, v102, 1, s1
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[140:147], v[164:171], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[140:147], v[172:179], v[18:25] matrix_a_reuse
	ds_load_b128 v[140:143], v68 offset:128
	ds_load_b128 v[144:147], v68 offset:144
	v_lshl_add_u32 v68, v104, 1, s1
	ds_load_b128 v[180:183], v83 offset:128
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[148:155], v[172:179], v[34:41]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[148:155], v[164:171], v[2:9] matrix_a_reuse
	ds_load_b128 v[184:187], v83 offset:144
	...
	v_wmma_f32_16x16x32_bf16 v[26:33], v[148:155], v[116:123], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[58:65], v[108:115], v[132:139], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[50:57], v[108:115], v[140:147], v[50:57] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[42:49], v[108:115], v[180:187], v[42:49] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[108:115], v[164:171], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[124:131], v[164:171], v[34:41]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[124:131], v[180:187], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[124:131], v[140:147], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[124:131], v[132:139], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_dual_mov_b32 v83, s2 :: v_dual_mov_b32 v108, s14
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v83, s5 :: v_dual_mov_b32 v108, s6
	s_bitset1_b32 s7, 31
...
; %bb.47:
	...
	v_add_nc_u32_e32 v28, 0x810, v1
	v_dual_add_nc_u32 v44, v44, v51 :: v_dual_lshrrev_b32 v42, 3, v42
	v_dual_lshrrev_b32 v50, 3, v50 :: v_dual_lshrrev_b32 v52, 3, v45
	ds_store_b128 v43, v[62:65]
	ds_store_b128 v44, v[54:57] offset:2048
	v_add_nc_u32_e32 v44, 0x410, v1
	v_add_nc_u32_e32 v1, 0xc10, v1
	...
	v_dual_add_nc_u32 v27, v50, v51 :: v_dual_add_nc_u32 v43, v52, v51
	...
	ds_store_b128 v42, v[46:49] offset:4096
	ds_store_b128 v27, v[22:25] offset:6144
	ds_store_b128 v43, v[30:33] offset:32
	ds_store_b128 v18, v[14:17] offset:2048
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn256_bk096_wm2_wn4_mc1, .Lfunc_end0-bm064_bn256_bk096_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn256_bk096_wm2_wn4_mc1
	...
	.section	.text.bm064_bn256_bk096_wm2_wn4_mc1,"axG",@progbits,bm064_bn256_bk096_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn256_bk096_wm2_wn4_mc1.num_vgpr, 188
	.set .Lbm064_bn256_bk096_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm064_bn256_bk096_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm064_bn256_bk096_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm064_bn256_bk096_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm064_bn256_bk096_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm064_bn256_bk096_wm2_wn4_mc1.uses_flat_scratch, 1
	.set .Lbm064_bn256_bk096_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn256_bk096_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm064_bn256_bk096_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_4c2bf31584a9e6b4,@object ; @__hip_cuid_4c2bf31584a9e6b4
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_4c2bf31584a9e6b4
__hip_cuid_4c2bf31584a9e6b4:
	.byte	0                               ; 0x0
	.size	__hip_cuid_4c2bf31584a9e6b4, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_4c2bf31584a9e6b4
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn256_bk096_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn256_bk096_wm2_wn4_mc1.kd
