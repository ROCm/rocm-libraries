	...
	.section	.text.bm064_bn128_bk128_wm4_wn2_mc1,"axG",@progbits,bm064_bn128_bk128_wm4_wn2_mc1,comdat
	.protected	bm064_bn128_bk128_wm4_wn2_mc1 ; -- Begin function bm064_bn128_bk128_wm4_wn2_mc1
	.globl	bm064_bn128_bk128_wm4_wn2_mc1
	.p2align	8
	.type	bm064_bn128_bk128_wm4_wn2_mc1,@function
bm064_bn128_bk128_wm4_wn2_mc1: ; @bm064_bn128_bk128_wm4_wn2_mc1
; %bb.0:
...
; %bb.3:
	...
	v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v3, v36
	s_mov_b32 s8, 0
	v_mov_b32_e32 v4, v1
...
.LBB0_16:
	...
	v_dual_lshlrev_b32 v1, 3, v35 :: v_dual_lshlrev_b32 v2, 6, v35
	v_mov_b32_e32 v9, 0
	s_and_b32 s42, s3, s29
	s_and_not1_b32 vcc_lo, exec_lo, s13
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_and_b32_e32 v41, 48, v1
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v43, 64, v2 bitop3:0x40
...
; %bb.17:
	...
	v_dual_lshlrev_b32 v2, 7, v43 :: v_dual_lshlrev_b32 v1, 7, v41
	...
	v_dual_mov_b32 v37, 0 :: v_dual_bitop2_b32 v3, v3, v1 bitop3:0x54
	...
	s_ashr_i32 s7, s6, 31
	s_or_b32 s4, s18, 0x7510000
	v_dual_add_nc_u32 v34, v7, v5 :: v_dual_add_nc_u32 v38, v8, v6
	v_lshrrev_b32_e32 v3, 4, v3
	s_wait_kmcnt 0x0
	s_bfe_i64 s[18:19], s[20:21], 0x200000
	v_dual_add_nc_u32 v5, v4, v1 :: v_dual_mov_b32 v47, v37
	...
	v_dual_mov_b32 v49, v37 :: v_dual_add_nc_u32 v40, v3, v5
	v_add3_u32 v42, v4, v2, v8
	v_dual_add_nc_u32 v44, v7, v5 :: v_dual_mov_b32 v2, v37
	v_or_b32_e32 v45, 0xf00, v0
	v_or_b32_e32 v46, 0x4000, v36
	v_or_b32_e32 v52, 0x2100, v0
	v_or_b32_e32 v48, 0x8800, v36
	v_dual_mov_b32 v3, v37 :: v_dual_mov_b32 v4, v37
	v_dual_mov_b32 v5, v37 :: v_dual_mov_b32 v6, v37
	v_dual_mov_b32 v7, v37 :: v_dual_mov_b32 v8, v37
	v_dual_mov_b32 v9, v37 :: v_dual_mov_b32 v18, v37
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v36, v50 :: v_dual_add_nc_u32 v53, -2, v53
	v_dual_mov_b32 v54, v51 :: v_dual_mov_b32 v55, v37
	v_add_nc_u32_e32 v51, 0x200, v51
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[56:57], v[36:37], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v53
	v_add_nc_u32_e32 v50, 0x200, v50
	v_lshl_add_u64 v[54:55], v[54:55], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[56:57], v37
	flat_store_b32 v[54:55], v37
...
; %bb.23:                               ;   in Loop: Header=BB0_19 Depth=1
	v_add_nc_u64_e32 v[50:51], s[6:7], v[46:47]
...
.LBB0_24:                               ;   Parent Loop BB0_19 Depth=1
	...
	flat_store_b32 v[50:51], v37
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[50:51], 0x400, v[50:51]
...
.LBB0_29:                               ;   Parent Loop BB0_19 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[50:51], 0x400, v[50:51]
	v_cmp_lt_u32_e32 vcc_lo, 0x20ff, v36
	s_or_b32 s6, vcc_lo, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s6
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_cselect_b32 s6, s38, s41
	v_lshl_add_u32 v36, v34, 1, s5
	v_lshl_add_u32 v50, v38, 1, s6
	v_lshl_add_u32 v51, v42, 1, s6
	ds_load_b128 v[54:57], v36
	ds_load_b128 v[58:61], v36 offset:16
	ds_load_b128 v[62:65], v50
	ds_load_b128 v[66:69], v50 offset:16
	ds_load_b128 v[86:89], v50 offset:8704
	ds_load_b128 v[90:93], v50 offset:8720
	ds_load_b128 v[70:73], v50 offset:4352
	v_lshl_add_u32 v36, v40, 1, s5
	ds_load_b128 v[78:81], v51 offset:64
	ds_load_b128 v[82:85], v51 offset:80
	ds_load_b128 v[94:97], v51 offset:4416
	ds_load_b128 v[98:101], v51 offset:4432
	ds_load_b128 v[102:105], v51 offset:8768
	ds_load_b128 v[106:109], v51 offset:8784
	ds_load_b128 v[110:113], v51 offset:13120
	ds_load_b128 v[114:117], v51 offset:13136
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0xb
	v_wmma_f32_16x16x32_bf16 v[26:33], v[54:61], v[62:69], v[26:33]
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[2:9], v[54:61], v[86:93], v[2:9] matrix_a_reuse
	ds_load_b128 v[62:65], v50 offset:13056
	ds_load_b128 v[66:69], v50 offset:13072
	ds_load_b128 v[74:77], v50 offset:4368
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[10:17], v[54:61], v[62:69], v[10:17] matrix_a_reuse
	ds_load_b128 v[62:65], v36 offset:64
	ds_load_b128 v[66:69], v36 offset:80
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[18:25], v[54:61], v[70:77], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v36, v44, 1, s5
	ds_load_b128 v[54:57], v51 offset:128
	ds_load_b128 v[58:61], v51 offset:144
	ds_load_b128 v[70:73], v51 offset:4480
	ds_load_b128 v[86:89], v36 offset:128
	ds_load_b128 v[90:93], v36 offset:144
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[26:33], v[62:69], v[78:85], v[26:33]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[62:69], v[94:101], v[18:25] matrix_a_reuse
	ds_load_b128 v[74:77], v51 offset:4496
	ds_load_b128 v[78:81], v51 offset:8832
	ds_load_b128 v[82:85], v51 offset:8848
	ds_load_b128 v[94:97], v51 offset:13184
	ds_load_b128 v[98:101], v51 offset:13200
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[62:69], v[102:109], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[62:69], v[110:117], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[62:65], v36 offset:192
	ds_load_b128 v[66:69], v36 offset:208
	ds_load_b128 v[102:105], v51 offset:192
	ds_load_b128 v[106:109], v51 offset:208
	ds_load_b128 v[110:113], v51 offset:4544
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[26:33], v[86:93], v[54:61], v[26:33]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[18:25], v[86:93], v[70:77], v[18:25] matrix_a_reuse
	ds_load_b128 v[114:117], v51 offset:4560
	ds_load_b128 v[54:57], v51 offset:8896
	ds_load_b128 v[58:61], v51 offset:8912
	ds_load_b128 v[70:73], v51 offset:13248
	ds_load_b128 v[74:77], v51 offset:13264
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[2:9], v[86:93], v[78:85], v[2:9] matrix_a_reuse
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[10:17], v[86:93], v[94:101], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[26:33], v[62:69], v[102:109], v[26:33]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[18:25], v[62:69], v[110:117], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[62:69], v[54:61], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[62:69], v[70:77], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.38:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_dual_mov_b32 v51, s13 :: v_dual_mov_b32 v50, s14
...
.LBB0_40:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v51, s5 :: v_dual_mov_b32 v50, s6
	s_bitset1_b32 s7, 31
...
; %bb.42:
	...
	v_and_or_b32 v34, v0, 15, v43
	v_nop
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_cvt_pk_bf16_f32 v25, v24, v25
	v_and_or_b32 v1, v1, 8, v41
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn128_bk128_wm4_wn2_mc1, .Lfunc_end0-bm064_bn128_bk128_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn128_bk128_wm4_wn2_mc1
	...
	.section	.text.bm064_bn128_bk128_wm4_wn2_mc1,"axG",@progbits,bm064_bn128_bk128_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn128_bk128_wm4_wn2_mc1.num_vgpr, 118
	.set .Lbm064_bn128_bk128_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm064_bn128_bk128_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm064_bn128_bk128_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm064_bn128_bk128_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm064_bn128_bk128_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm064_bn128_bk128_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm064_bn128_bk128_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn128_bk128_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm064_bn128_bk128_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_243a483500be9276,@object ; @__hip_cuid_243a483500be9276
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_243a483500be9276
__hip_cuid_243a483500be9276:
	.byte	0                               ; 0x0
	.size	__hip_cuid_243a483500be9276, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_243a483500be9276
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn128_bk128_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn128_bk128_wm4_wn2_mc1.kd
