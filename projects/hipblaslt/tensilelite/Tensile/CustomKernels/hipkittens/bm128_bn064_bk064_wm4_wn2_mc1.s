	...
	.section	.text.bm128_bn064_bk064_wm4_wn2_mc1,"axG",@progbits,bm128_bn064_bk064_wm4_wn2_mc1,comdat
	.protected	bm128_bn064_bk064_wm4_wn2_mc1 ; -- Begin function bm128_bn064_bk064_wm4_wn2_mc1
	.globl	bm128_bn064_bk064_wm4_wn2_mc1
	.p2align	8
	.type	bm128_bn064_bk064_wm4_wn2_mc1,@function
bm128_bn064_bk064_wm4_wn2_mc1: ; @bm128_bn064_bk064_wm4_wn2_mc1
; %bb.0:
...
.LBB0_20:
	...
	v_dual_lshlrev_b32 v1, 4, v39 :: v_dual_mov_b32 v9, 0
	s_and_b32 s43, s35, s29
	s_and_not1_b32 vcc_lo, exec_lo, s13
	v_cndmask_b32_e64 v41, 0, 1, s43
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v43, 0x60, v1
...
; %bb.21:
	v_dual_lshlrev_b32 v1, 6, v0 :: v_dual_lshlrev_b32 v2, 6, v43
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_mov_b32 v37, 0 :: v_dual_bitop2_b32 v8, 32, v3 bitop3:0x54
	...
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_lshrrev_b32 v9, 4, v6 :: v_dual_lshrrev_b32 v1, 4, v5
	...
	s_and_b32 s10, s4, 15
	v_dual_add_nc_u32 v34, v1, v5 :: v_dual_lshrrev_b32 v1, 4, v7
	v_or_b32_e32 v7, v8, v2
	v_or_b32_e32 v10, 0x400, v6
	v_dual_add_nc_u32 v38, v9, v6 :: v_dual_bitop2_b32 v4, v8, v4 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v8, 0x1f8, v1
	v_or_b32_e32 v1, 0x400, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v9, 4, v10 :: v_dual_lshrrev_b32 v7, 4, v7
	...
	s_lshl_b32 s10, s6, 2
	s_lshr_b32 s7, s7, 26
	v_dual_mov_b32 v55, v37 :: v_dual_add_nc_u32 v46, v7, v2
	s_add_co_i32 s12, s12, s7
	v_add3_u32 v48, v2, v11, 0x400
	v_dual_mov_b32 v2, v37 :: v_dual_lshrrev_b32 v10, 4, v10
	...
	v_dual_mov_b32 v35, v40 :: v_dual_add_nc_u32 v12, 2, v40
	s_ashr_i32 s7, s6, 31
	...
	v_dual_add_nc_u32 v42, v8, v5 :: v_dual_bitop2_b32 v45, 30, v12 bitop3:0x40
	v_dual_add_nc_u32 v44, v9, v6 :: v_dual_add_nc_u32 v50, v4, v6
	v_mov_b32_e32 v3, v37
	v_add3_u32 v52, v6, v10, 0x400
...
.LBB0_25:                               ;   Parent Loop BB0_23 Depth=1
	...
	v_dual_mov_b32 v36, v56 :: v_dual_add_nc_u32 v49, -2, v49
	v_dual_mov_b32 v58, v57 :: v_dual_mov_b32 v59, v37
...
; %bb.32:                               ;   in Loop: Header=BB0_31 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[58:59], v[36:37], 2, s[14:15]
	flat_store_b32 v[58:59], v37
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_lshl_add_u32 v49, v44, 1, s2
	v_lshl_add_u32 v51, v50, 1, s2
	v_lshl_add_u32 v53, v52, 1, s2
	ds_load_b128 v[56:59], v36
	ds_load_b128 v[60:63], v36 offset:16
	v_lshl_add_u32 v36, v42, 1, s1
	ds_load_b128 v[64:67], v49 offset:2048
	ds_load_b128 v[68:71], v49 offset:2064
	v_lshl_add_u32 v49, v38, 1, s2
	ds_load_b128 v[88:91], v51 offset:64
	ds_load_b128 v[72:75], v36 offset:2048
	ds_load_b128 v[76:79], v36 offset:2064
	v_lshl_add_u32 v36, v46, 1, s1
	ds_load_b128 v[92:95], v51 offset:80
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[10:17], v[72:79], v[64:71], v[10:17]
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[56:63], v[64:71], v[18:25] matrix_a_reuse
	ds_load_b128 v[80:83], v49
	ds_load_b128 v[84:87], v49 offset:16
	v_lshl_add_u32 v49, v48, 1, s1
	ds_load_b128 v[64:67], v53 offset:64
	ds_load_b128 v[68:71], v53 offset:80
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	s_wait_dscnt 0x2
	...
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[56:63], v[80:87], v[26:33]
	ds_load_b128 v[56:59], v36 offset:64
	ds_load_b128 v[60:63], v36 offset:80
	ds_load_b128 v[80:83], v49 offset:64
	ds_load_b128 v[84:87], v49 offset:80
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[56:63], v[88:95], v[26:33]
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[56:63], v[64:71], v[18:25] matrix_a_reuse
	...
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[80:87], v[64:71], v[10:17]
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[80:87], v[88:95], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_dual_mov_b32 v49, s13 :: v_dual_mov_b32 v56, s14
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_nop
	v_dual_mov_b32 v49, s5 :: v_dual_mov_b32 v56, s6
...
; %bb.47:
	...
	v_add_nc_u32_e32 v20, 0x810, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_lshlrev_b32 v1, 1, v1 :: v_dual_lshrrev_b32 v4, 3, v18
	v_dual_lshrrev_b32 v5, 3, v19 :: v_dual_lshrrev_b32 v6, 3, v20
	v_lshrrev_b32_e32 v19, 3, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_and_b32_e32 v4, 0x3f0, v4
	v_and_b32_e32 v5, 0x3f0, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v20, 0x7f0, v6
	v_add_nc_u32_e32 v19, v19, v1
	v_cvt_pk_bf16_f32 v6, v2, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v21, v4, v1 :: v_dual_add_nc_u32 v1, v5, v1
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn064_bk064_wm4_wn2_mc1, .Lfunc_end0-bm128_bn064_bk064_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn064_bk064_wm4_wn2_mc1
	...
	.section	.text.bm128_bn064_bk064_wm4_wn2_mc1,"axG",@progbits,bm128_bn064_bk064_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn064_bk064_wm4_wn2_mc1.num_vgpr, 96
	.set .Lbm128_bn064_bk064_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm128_bn064_bk064_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm128_bn064_bk064_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm128_bn064_bk064_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm128_bn064_bk064_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm128_bn064_bk064_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn064_bk064_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn064_bk064_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm128_bn064_bk064_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_327b03d65240bc8e,@object ; @__hip_cuid_327b03d65240bc8e
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_327b03d65240bc8e
__hip_cuid_327b03d65240bc8e:
	.byte	0                               ; 0x0
	.size	__hip_cuid_327b03d65240bc8e, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_327b03d65240bc8e
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn064_bk064_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn064_bk064_wm4_wn2_mc1.kd
