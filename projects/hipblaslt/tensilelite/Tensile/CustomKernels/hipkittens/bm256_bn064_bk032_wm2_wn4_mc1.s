	...
	.section	.text.bm256_bn064_bk032_wm2_wn4_mc1,"axG",@progbits,bm256_bn064_bk032_wm2_wn4_mc1,comdat
	.protected	bm256_bn064_bk032_wm2_wn4_mc1 ; -- Begin function bm256_bn064_bk032_wm2_wn4_mc1
	.globl	bm256_bn064_bk032_wm2_wn4_mc1
	.p2align	8
	.type	bm256_bn064_bk032_wm2_wn4_mc1,@function
bm256_bn064_bk032_wm2_wn4_mc1: ; @bm256_bn064_bk032_wm2_wn4_mc1
; %bb.0:
...
; %bb.5:
	...
	v_dual_mov_b32 v5, 0 :: v_dual_sub_nc_u32 v2, 0x43f, v0
...
.LBB0_20:
	...
	v_and_b32_e32 v77, 0x80, v0
	v_cndmask_b32_e64 v73, 0, 1, s43
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v75, 48, v1 bitop3:0x40
...
; %bb.21:
	...
	v_dual_lshlrev_b32 v1, 5, v75 :: v_dual_lshlrev_b32 v2, 5, v77
	...
	s_and_b32 s10, s4, 15
	v_dual_mov_b32 v69, 0 :: v_dual_add_nc_u32 v66, v5, v2
	...
	v_dual_lshrrev_b32 v8, 4, v8 :: v_dual_lshrrev_b32 v10, 4, v1
	v_sub_nc_u32_e32 v11, 0x43f, v0
	s_cselect_b32 s6, s6, 0
	s_ashr_i32 s7, s12, 31
	v_dual_lshrrev_b32 v3, 4, v3 :: v_dual_lshrrev_b32 v4, 4, v4
	s_lshr_b32 s7, s7, 27
	v_dual_lshrrev_b32 v9, 4, v9 :: v_dual_lshrrev_b32 v72, 8, v11
	...
	v_dual_add_nc_u32 v70, v10, v1 :: v_dual_add_nc_u32 v10, 2, v72
	s_ashr_i32 s7, s6, 31
	...
	v_dual_mov_b32 v89, v69 :: v_dual_bitop2_b32 v79, 14, v10 bitop3:0x40
	v_dual_add_nc_u32 v74, v5, v2 :: v_dual_add_nc_u32 v76, v6, v2
	v_dual_add_nc_u32 v78, v7, v2 :: v_dual_add_nc_u32 v80, v8, v2
	v_dual_add_nc_u32 v82, v3, v2 :: v_dual_add_nc_u32 v84, v4, v2
	v_dual_mov_b32 v67, v72 :: v_dual_add_nc_u32 v86, v9, v2
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	ds_load_b128 v[98:101], v83 offset:1024
	ds_load_b128 v[102:105], v83 offset:1040
	v_lshl_add_u32 v68, v78, 1, s1
	v_lshl_add_u32 v83, v80, 1, s1
	ds_load_b128 v[106:109], v85 offset:2048
	ds_load_b128 v[110:113], v85 offset:2064
	v_lshl_add_u32 v85, v82, 1, s1
	ds_load_b128 v[114:117], v68 offset:3072
	ds_load_b128 v[118:121], v68 offset:3088
	ds_load_b128 v[122:125], v83 offset:4096
	ds_load_b128 v[130:133], v87
	ds_load_b128 v[134:137], v87 offset:16
	v_lshl_add_u32 v68, v84, 1, s1
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[98:105], v[130:137], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[106:113], v[130:137], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[114:121], v[130:137], v[10:17] matrix_b_reuse
	ds_load_b128 v[138:141], v85 offset:5120
	ds_load_b128 v[142:145], v85 offset:5136
	ds_load_b128 v[126:129], v83 offset:4112
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[26:33], v[138:145], v[130:137], v[26:33] matrix_b_reuse
	ds_load_b128 v[138:141], v68 offset:6144
	ds_load_b128 v[142:145], v68 offset:6160
	v_lshl_add_u32 v68, v86, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[138:145], v[130:137], v[34:41] matrix_b_reuse
	ds_load_b128 v[138:141], v68 offset:7168
	ds_load_b128 v[142:145], v68 offset:7184
	; sched_group_barrier mask(0x00000100) size(9) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[50:57], v[138:145], v[130:137], v[50:57] matrix_b_reuse
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn064_bk032_wm2_wn4_mc1, .Lfunc_end0-bm256_bn064_bk032_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn064_bk032_wm2_wn4_mc1
	...
	.section	.text.bm256_bn064_bk032_wm2_wn4_mc1,"axG",@progbits,bm256_bn064_bk032_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm256_bn064_bk032_wm2_wn4_mc1.num_vgpr, 146
	.set .Lbm256_bn064_bk032_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm256_bn064_bk032_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm256_bn064_bk032_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm256_bn064_bk032_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm256_bn064_bk032_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm256_bn064_bk032_wm2_wn4_mc1.uses_flat_scratch, 1
	.set .Lbm256_bn064_bk032_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm256_bn064_bk032_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm256_bn064_bk032_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_49825cd1dfde875f,@object ; @__hip_cuid_49825cd1dfde875f
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_49825cd1dfde875f
__hip_cuid_49825cd1dfde875f:
	.byte	0                               ; 0x0
	.size	__hip_cuid_49825cd1dfde875f, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_49825cd1dfde875f
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn064_bk032_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn064_bk032_wm2_wn4_mc1.kd
