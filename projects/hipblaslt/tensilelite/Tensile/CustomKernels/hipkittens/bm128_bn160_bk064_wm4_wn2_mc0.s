	...
	.section	.text.bm128_bn160_bk064_wm4_wn2_mc0,"axG",@progbits,bm128_bn160_bk064_wm4_wn2_mc0,comdat
	.protected	bm128_bn160_bk064_wm4_wn2_mc0 ; -- Begin function bm128_bn160_bk064_wm4_wn2_mc0
	.globl	bm128_bn160_bk064_wm4_wn2_mc0
	.p2align	8
	.type	bm128_bn160_bk064_wm4_wn2_mc0,@function
bm128_bn160_bk064_wm4_wn2_mc0: ; @bm128_bn160_bk064_wm4_wn2_mc0
; %bb.0:
...
; %bb.15:
	...
	v_dual_lshlrev_b32 v2, 6, v89 :: v_dual_lshlrev_b32 v3, 6, v87
	s_mov_b64 s[6:7], src_shared_base
	s_or_b32 s4, s0, 0x9900
	s_delay_alu instid0(VALU_DEP_2)
	...
	v_lshl_or_b32 v112, v0, 2, 0x4000
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v85, 0 :: v_dual_lshrrev_b32 v8, 4, v6
	v_lshrrev_b32_e32 v1, 4, v5
	v_or_b32_e32 v7, 0x400, v5
	v_sub_nc_u32_e32 v18, 0x153f, v0
	s_lshr_b32 s6, s6, 2
	...
	v_dual_add_nc_u32 v82, v1, v5 :: v_dual_bitop2_b32 v10, 32, v4 bitop3:0x54
	v_lshrrev_b32_e32 v1, 4, v7
	v_and_b32_e32 v7, 0x178, v8
	v_dual_mov_b32 v113, v85 :: v_dual_add_nc_u32 v8, 0x400, v6
	v_or_b32_e32 v9, 0x800, v6
	v_and_b32_e32 v11, 0x1f8, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v86, v7, v6 :: v_dual_lshrrev_b32 v1, 4, v8
	v_dual_lshrrev_b32 v7, 4, v9 :: v_dual_bitop2_b32 v8, v10, v3 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v88, v11, v5 :: v_dual_bitop2_b32 v10, v10, v2 bitop3:0x54
	v_add_nc_u32_e32 v3, v4, v3
	v_and_b32_e32 v13, 0x1f8, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_or_b32_e32 v1, 0x400, v8
	v_dual_lshrrev_b32 v8, 4, v8 :: v_dual_lshrrev_b32 v14, 4, v10
	v_or_b32_e32 v16, 0x800, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v2, v4, v2 :: v_dual_lshrrev_b32 v1, 4, v1
	v_dual_mov_b32 v4, v85 :: v_dual_mov_b32 v5, v85
	...
	s_add_co_i32 s6, s0, 0xdd00
	v_lshrrev_b32_e32 v1, 4, v1
	s_and_b32 s10, s6, 15
	v_add_nc_u32_e32 v90, v13, v6
	v_and_b32_e32 v14, 0x178, v14
	v_add3_u32 v100, v3, v15, 0x400
	v_and_b32_e32 v19, 0x3f8, v1
	v_lshrrev_b32_e32 v1, 8, v18
	s_sub_co_i32 s5, 16, s10
	s_add_co_i32 s42, s0, 0x9900
	s_lshr_b32 s0, s5, 2
	s_cmp_lg_u64 s[10:11], 0
	v_add_nc_u32_e32 v18, 1, v1
	v_add_nc_u32_e32 v9, 0xc00, v6
	v_dual_mov_b32 v115, v85 :: v_dual_add_nc_u32 v12, 0x1000, v6
	v_and_b32_e32 v16, 0x1f8, v16
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v93, 22, v18
	s_cselect_b32 s0, s0, 0
	s_ashr_i32 s5, s17, 31
	s_lshl_b32 s10, s0, 2
	s_lshr_b32 s5, s5, 26
	v_lshl_or_b32 v20, v93, 8, v0
	s_add_co_i32 s17, s17, s5
	s_mul_i32 s4, s34, 0xa0
	s_ashr_i32 s44, s17, 6
	s_cmp_lt_i32 s31, 0xa0
	v_dual_lshlrev_b32 v114, 2, v20 :: v_dual_add_nc_u32 v98, v8, v3
	v_dual_mov_b32 v3, v85 :: v_dual_add_nc_u32 v102, v14, v2
	v_dual_lshrrev_b32 v17, 4, v17 :: v_dual_lshrrev_b32 v10, 4, v10
	v_lshrrev_b32_e32 v12, 4, v12
	v_add3_u32 v104, v2, v19, 0x400
	v_add3_u32 v106, v2, v16, 0x800
	s_delay_alu instid0(VALU_DEP_4)
	...
	s_lshl_b32 s6, s30, 7
	v_add3_u32 v108, v2, v17, 0xc00
	v_add3_u32 v110, v2, v10, 0x1000
	...
	v_cmp_ne_u32_e64 s0, v18, v93
	v_dual_add_nc_u32 v92, v7, v6 :: v_dual_add_nc_u32 v94, v9, v6
	v_dual_mov_b32 v7, v85 :: v_dual_add_nc_u32 v96, v12, v6
	v_dual_mov_b32 v8, v85 :: v_dual_add_nc_u32 v97, 0xffffff00, v20
	v_dual_mov_b32 v6, v85 :: v_dual_mov_b32 v9, v85
	v_dual_mov_b32 v10, v85 :: v_dual_mov_b32 v11, v85
	v_dual_mov_b32 v12, v85 :: v_dual_mov_b32 v13, v85
	v_dual_mov_b32 v14, v85 :: v_dual_mov_b32 v15, v85
	v_dual_mov_b32 v16, v85 :: v_dual_mov_b32 v17, v85
	v_dual_mov_b32 v18, v85 :: v_dual_mov_b32 v19, v85
	v_dual_mov_b32 v20, v85 :: v_dual_mov_b32 v23, v85
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v84, v116 :: v_dual_add_nc_u32 v99, -2, v99
	v_dual_mov_b32 v118, v117 :: v_dual_mov_b32 v119, v85
	v_add_nc_u32_e32 v117, 0x200, v117
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[120:121], v[84:85], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v99
	v_add_nc_u32_e32 v116, 0x200, v116
	v_lshl_add_u64 v[118:119], v[118:119], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[120:121], v85
	flat_store_b32 v[118:119], v85
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[116:117], s[6:7], v[112:113]
...
.LBB0_22:                               ;   Parent Loop BB0_17 Depth=1
	...
	flat_store_b32 v[116:117], v85
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[116:117], 0x400, v[116:117]
...
; %bb.26:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[116:117], s[6:7], v[114:115]
...
.LBB0_27:                               ;   Parent Loop BB0_17 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[116:117], 0x400, v[116:117]
	v_cmp_lt_u32_e32 vcc_lo, 0x143f, v84
	s_or_b32 s6, vcc_lo, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s6
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v99, s14 :: v_dual_mov_b32 v116, s12
...
.LBB0_35:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v99, s5 :: v_dual_mov_b32 v116, s6
	s_bitset1_b32 s7, 31
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	v_lshl_add_u32 v99, v86, 1, s5
	v_lshl_add_u32 v101, v102, 1, s5
	v_lshl_add_u32 v103, v104, 1, s5
	v_lshl_add_u32 v105, v106, 1, s5
	ds_load_b128 v[116:119], v84
	ds_load_b128 v[120:123], v84 offset:16
	v_lshl_add_u32 v84, v88, 1, s6
	ds_load_b128 v[124:127], v99
	ds_load_b128 v[128:131], v99 offset:16
	v_lshl_add_u32 v99, v96, 1, s5
	v_lshl_add_u32 v107, v108, 1, s5
	ds_load_b128 v[132:135], v84 offset:2048
	ds_load_b128 v[136:139], v84 offset:2064
	v_lshl_add_u32 v84, v90, 1, s5
	v_lshl_add_u32 v109, v110, 1, s5
	ds_load_b128 v[164:167], v101 offset:64
	ds_load_b128 v[168:171], v101 offset:80
	ds_load_b128 v[172:175], v105 offset:64
	ds_load_b128 v[140:143], v84 offset:2048
	ds_load_b128 v[176:179], v105 offset:80
	ds_load_b128 v[180:183], v107 offset:64
	ds_load_b128 v[184:187], v107 offset:80
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x9
	v_wmma_f32_16x16x32_bf16 v[74:81], v[116:123], v[124:131], v[74:81]
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[26:33], v[132:139], v[124:131], v[26:33] matrix_a_reuse
	ds_load_b128 v[144:147], v84 offset:2064
	v_lshl_add_u32 v84, v98, 1, s6
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[132:139], v[140:147], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[116:123], v[140:147], v[66:73] matrix_a_reuse
	ds_load_b128 v[124:127], v99 offset:8192
	ds_load_b128 v[128:131], v99 offset:8208
	v_lshl_add_u32 v99, v94, 1, s5
	ds_load_b128 v[140:143], v109 offset:64
	ds_load_b128 v[144:147], v109 offset:80
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[34:41], v[116:123], v[124:131], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[132:139], v[124:131], v[42:49]
	ds_load_b128 v[124:127], v99 offset:6144
	ds_load_b128 v[128:131], v99 offset:6160
	v_lshl_add_u32 v99, v92, 1, s5
	ds_load_b128 v[148:151], v99 offset:4096
	ds_load_b128 v[152:155], v99 offset:4112
	v_lshl_add_u32 v99, v100, 1, s6
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[116:123], v[148:155], v[58:65] matrix_a_reuse
	ds_load_b128 v[156:159], v99 offset:64
	ds_load_b128 v[160:163], v99 offset:80
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[116:123], v[124:131], v[50:57] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[132:139], v[124:131], v[2:9] matrix_a_reuse
	ds_load_b128 v[124:127], v84 offset:64
	ds_load_b128 v[128:131], v84 offset:80
	v_wmma_f32_16x16x32_bf16 v[10:17], v[132:139], v[148:155], v[10:17] matrix_a_reuse
	ds_load_b128 v[132:135], v103 offset:64
	ds_load_b128 v[136:139], v103 offset:80
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[74:81], v[124:131], v[164:171], v[74:81]
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[66:73], v[124:131], v[132:139], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[124:131], v[172:179], v[58:65] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[124:131], v[180:187], v[50:57] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[124:131], v[140:147], v[34:41] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(7) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[156:163], v[140:147], v[42:49]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[156:163], v[180:187], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[156:163], v[172:179], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[156:163], v[132:139], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[156:163], v[164:171], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn160_bk064_wm4_wn2_mc0, .Lfunc_end0-bm128_bn160_bk064_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn160_bk064_wm4_wn2_mc0
	...
	.section	.text.bm128_bn160_bk064_wm4_wn2_mc0,"axG",@progbits,bm128_bn160_bk064_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn160_bk064_wm4_wn2_mc0.num_vgpr, 188
	.set .Lbm128_bn160_bk064_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm128_bn160_bk064_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm128_bn160_bk064_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm128_bn160_bk064_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm128_bn160_bk064_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm128_bn160_bk064_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn160_bk064_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn160_bk064_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm128_bn160_bk064_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_2e9cc6cb9274fbf,@object ; @__hip_cuid_2e9cc6cb9274fbf
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_2e9cc6cb9274fbf
__hip_cuid_2e9cc6cb9274fbf:
	.byte	0                               ; 0x0
	.size	__hip_cuid_2e9cc6cb9274fbf, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_2e9cc6cb9274fbf
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn160_bk064_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn160_bk064_wm4_wn2_mc0.kd
