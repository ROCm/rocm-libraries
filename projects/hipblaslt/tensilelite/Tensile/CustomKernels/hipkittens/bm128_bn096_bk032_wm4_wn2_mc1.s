	...
	.section	.text.bm128_bn096_bk032_wm4_wn2_mc1,"axG",@progbits,bm128_bn096_bk032_wm4_wn2_mc1,comdat
	.protected	bm128_bn096_bk032_wm4_wn2_mc1 ; -- Begin function bm128_bn096_bk032_wm4_wn2_mc1
	.globl	bm128_bn096_bk032_wm4_wn2_mc1
	.p2align	8
	.type	bm128_bn096_bk032_wm4_wn2_mc1,@function
bm128_bn096_bk032_wm4_wn2_mc1: ; @bm128_bn096_bk032_wm4_wn2_mc1
; %bb.0:
...
.LBB0_24:
	...
	v_dual_lshlrev_b32 v1, 4, v59 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s43, s35, s29
	s_movk_i32 s16, 0x60
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v61, 0x60, v1
	v_cmp_ne_u32_e32 vcc_lo, 0, v2
	v_cndmask_b32_e64 v57, 0, 1, s43
	v_dual_mov_b32 v8, v9 :: v_dual_mov_b32 v7, v9
	v_dual_mov_b32 v6, v9 :: v_dual_mov_b32 v5, v9
	v_cndmask_b32_e64 v63, 0, 48, vcc_lo
	v_dual_mov_b32 v4, v9 :: v_dual_mov_b32 v3, v9
	v_dual_mov_b32 v2, v9 :: v_dual_mov_b32 v41, v9
...
; %bb.25:
	...
	v_dual_lshlrev_b32 v1, 5, v63 :: v_dual_lshlrev_b32 v2, 5, v61
	...
	v_dual_mov_b32 v53, 0 :: v_dual_add_nc_u32 v6, 0x200, v3
	v_and_b32_e32 v1, 0xd8, v5
	v_lshrrev_b32_e32 v5, 4, v3
	s_add_co_i32 s4, s1, 0x5d80
	v_add_nc_u32_e32 v7, 0x400, v3
	s_and_b32 s10, s4, 15
	v_dual_add_nc_u32 v50, v1, v2 :: v_dual_lshrrev_b32 v1, 4, v4
	...
	v_dual_add_nc_u32 v60, v7, v2 :: v_dual_bitop2_b32 v65, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_add_nc_u32_e32 v64, v5, v3
	v_dual_mov_b32 v2, v53 :: v_dual_mov_b32 v3, v53
	v_dual_mov_b32 v5, v53 :: v_dual_mov_b32 v6, v53
	v_dual_mov_b32 v7, v53 :: v_dual_mov_b32 v8, v53
	v_dual_mov_b32 v9, v53 :: v_dual_mov_b32 v34, v53
	...
	v_dual_mov_b32 v49, v53 :: v_dual_mov_b32 v10, v53
	...
	v_dual_mov_b32 v25, v53 :: v_dual_mov_b32 v26, v53
	...
	v_dual_mov_b32 v33, v53 :: v_dual_mov_b32 v51, v56
...
; %bb.31:                               ;   in Loop: Header=BB0_30 Depth=2
	...
	v_lshl_add_u64 v[70:71], v[52:53], 2, s[14:15]
...
.LBB0_35:                               ;   in Loop: Header=BB0_36 Depth=2
	...
	s_add_co_i32 s6, s6, 2
	v_add_nc_u32_e32 v67, 0x200, v67
	v_cmp_eq_u32_e32 vcc_lo, s6, v68
	v_add_nc_u32_e32 v66, 0x200, v66
	s_or_b32 s10, vcc_lo, s10
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s10
...
.LBB0_36:                               ;   Parent Loop BB0_27 Depth=1
	...
	s_or_b64 s[18:19], s[6:7], 0x100000000
	s_mov_b32 s7, exec_lo
	v_cmp_le_u32_e32 vcc_lo, s19, v55
	v_cmpx_le_u32_e64 s18, v58
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_lshl_add_u32 v52, v50, 1, s1
	v_lshl_add_u32 v66, v60, 1, s1
	v_lshl_add_u32 v67, v54, 1, s2
	v_lshl_add_u32 v69, v64, 1, s2
	ds_load_b128 v[70:73], v52
	ds_load_b128 v[74:77], v52 offset:16
	ds_load_b128 v[78:81], v66 offset:1024
	ds_load_b128 v[82:85], v66 offset:1040
	ds_load_b128 v[86:89], v67
	ds_load_b128 v[90:93], v67 offset:16
	...
	ds_load_b128 v[102:105], v52 offset:1024
	ds_load_b128 v[106:109], v52 offset:1040
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[70:77], v[102:109], v[34:41] matrix_a_reuse
	ds_load_b128 v[94:97], v69 offset:2048
	ds_load_b128 v[98:101], v69 offset:2064
	s_wait_dscnt 0x0
	...
	v_wmma_f32_16x16x32_bf16 v[18:25], v[78:85], v[102:109], v[18:25] matrix_a_reuse
...
; %bb.52:
	...
	v_dual_lshrrev_b32 v5, 3, v34 :: v_dual_lshrrev_b32 v6, 3, v35
	...
	v_add_nc_u32_e32 v42, v5, v35
	v_cvt_pk_bf16_f32 v5, v16, v17
	v_and_b32_e32 v16, 0x7f0, v37
	v_dual_lshlrev_b32 v17, 1, v4 :: v_dual_add_nc_u32 v34, v34, v35
	v_and_b32_e32 v1, 0x7f0, v1
	v_add_nc_u32_e32 v43, v6, v35
	...
	ds_store_b128 v35, v[2:5] offset:32
	ds_store_b128 v36, v[10:13] offset:4096
...
.LBB0_64:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn096_bk032_wm4_wn2_mc1, .Lfunc_end0-bm128_bn096_bk032_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn096_bk032_wm4_wn2_mc1
	...
	.section	.text.bm128_bn096_bk032_wm4_wn2_mc1,"axG",@progbits,bm128_bn096_bk032_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn096_bk032_wm4_wn2_mc1.num_vgpr, 110
	.set .Lbm128_bn096_bk032_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm128_bn096_bk032_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm128_bn096_bk032_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm128_bn096_bk032_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm128_bn096_bk032_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm128_bn096_bk032_wm4_wn2_mc1.uses_flat_scratch, 0
	.set .Lbm128_bn096_bk032_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn096_bk032_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm128_bn096_bk032_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_795e1580320d8b63,@object ; @__hip_cuid_795e1580320d8b63
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_795e1580320d8b63
__hip_cuid_795e1580320d8b63:
	.byte	0                               ; 0x0
	.size	__hip_cuid_795e1580320d8b63, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_795e1580320d8b63
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn096_bk032_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn096_bk032_wm4_wn2_mc1.kd
