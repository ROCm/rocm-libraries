	...
	.section	.text.bm224_bn064_bk096_wm2_wn4_mc0,"axG",@progbits,bm224_bn064_bk096_wm2_wn4_mc0,comdat
	.protected	bm224_bn064_bk096_wm2_wn4_mc0 ; -- Begin function bm224_bn064_bk096_wm2_wn4_mc0
	.globl	bm224_bn064_bk096_wm2_wn4_mc0
	.p2align	8
	.type	bm224_bn064_bk096_wm2_wn4_mc0,@function
bm224_bn064_bk096_wm2_wn4_mc0: ; @bm224_bn064_bk096_wm2_wn4_mc0
; %bb.0:
...
; %bb.8:                                ;   in Loop: Header=BB0_7 Depth=1
	ds_store_b32 v3, v5 offset:45696
; %bb.9:                                ;   in Loop: Header=BB0_7 Depth=1
	s_or_b32 exec_lo, exec_lo, s11
	s_and_saveexec_b32 s2, vcc_lo
	s_cbranch_execz .LBB0_6
; %bb.10:                               ;   in Loop: Header=BB0_7 Depth=1
	ds_store_b32 v3, v5 offset:46720
	s_branch .LBB0_6
.LBB0_11:
...
; %bb.14:
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v1, s30 :: v_dual_mov_b32 v4, s6
...
.LBB0_18:
	...
	s_barrier_signal -1
	v_dual_lshrrev_b32 v67, 7, v0 :: v_dual_lshlrev_b32 v1, 4, v65
	v_mov_b32_e32 v9, 0
	s_and_b32 s41, s39, s25
...
; %bb.19:
	v_mul_u32_u24_e32 v3, 0x2a00, v67
	v_and_b32_e32 v19, 16, v0
	v_and_b32_e32 v5, 15, v0
	v_mul_u32_u24_e32 v1, 0x60, v69
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s34, 0xe580
	v_or_b32_e32 v2, v3, v19
	s_mov_b32 s7, s5
	s_mov_b32 s11, 0
	s_and_b64 s[6:7], s[6:7], 15
	s_mul_hi_i32 s2, s16, 0x2aaaaaab
	v_mad_u32_u24 v58, 0x60, v5, v2
	s_sub_co_i32 s1, 16, s6
	s_mov_b32 s44, s5
	s_lshr_b32 s1, s1, 2
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_mov_b32 v59, 0 :: v_dual_add_nc_u32 v6, 0x600, v58
	v_lshrrev_b32_e32 v4, 4, v58
	v_mul_u32_u24_e32 v9, 0x60, v5
	v_add_nc_u32_e32 v7, 0xc00, v58
	v_add_nc_u32_e32 v8, 0x1200, v58
	v_lshrrev_b32_e32 v6, 4, v6
	v_and_b32_e32 v4, 0x7f8, v4
	v_or_b32_e32 v13, 0x1800, v9
	v_mad_u32_u24 v25, 0x60, v69, v9
	s_cmp_lg_u64 s[6:7], 0
	v_and_b32_e32 v11, 0xff8, v6
	v_dual_add_nc_u32 v60, v4, v58 :: v_dual_lshrrev_b32 v4, 4, v7
	v_dual_lshrrev_b32 v7, 4, v8 :: v_dual_bitop2_b32 v1, v1, v19 bitop3:0x54
	v_dual_add_nc_u32 v2, v2, v13 :: v_dual_bitop2_b32 v12, 32, v19 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_and_b32_e32 v15, 0xff8, v4
	v_and_b32_e32 v7, 0xff8, v7
	v_add_nc_u32_e32 v4, 0x1e00, v58
	v_add_nc_u32_e32 v6, 0x2400, v58
	v_mad_u32_u24 v1, 0x60, v5, v1
	v_dual_lshrrev_b32 v2, 4, v2 :: v_dual_bitop2_b32 v14, v12, v3 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v4, 4, v4 :: v_dual_add_nc_u32 v70, v7, v58
	v_dual_mov_b32 v7, v59 :: v_dual_lshrrev_b32 v8, 4, v1
	v_lshrrev_b32_e32 v6, 4, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mad_u32_u24 v16, 0x60, v5, v14
	v_and_b32_e32 v17, 0xff8, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v4, 0x3f8, v8
	v_or_b32_e32 v23, 64, v19
	v_and_b32_e32 v21, 0xff8, v6
	v_add_nc_u32_e32 v6, 0x600, v16
	v_add_nc_u32_e32 v8, 0xc00, v16
	v_dual_lshrrev_b32 v18, 4, v16 :: v_dual_add_nc_u32 v62, v4, v1
	v_dual_add_nc_u32 v66, v11, v58 :: v_dual_add_nc_u32 v74, v17, v58
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v11, v59 :: v_dual_lshrrev_b32 v1, 4, v6
	v_lshrrev_b32_e32 v8, 4, v8
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v4, 0x7f8, v18
	v_dual_add_nc_u32 v18, v25, v12 :: v_dual_add_nc_u32 v68, v15, v58
	v_add_nc_u32_e32 v76, v21, v58
	v_and_b32_e32 v6, 0xff8, v1
	v_dual_add_nc_u32 v1, v14, v13 :: v_dual_bitop2_b32 v3, v3, v23 bitop3:0x54
	v_dual_mov_b32 v15, v59 :: v_dual_add_nc_u32 v14, 0x1e00, v16
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v21, v59 :: v_dual_lshrrev_b32 v1, 4, v1
	v_mad_u32_u24 v5, 0x60, v5, v3
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v9, 4, v14 :: v_dual_add_nc_u32 v3, v3, v13
	v_add_nc_u32_e32 v10, 0x1200, v16
	v_and_b32_e32 v12, 0x7f8, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add_nc_u32_e32 v1, 0x600, v5
	v_and_b32_e32 v14, 0xff8, v9
	v_dual_lshrrev_b32 v9, 4, v18 :: v_dual_lshrrev_b32 v18, 4, v5
	v_add_nc_u32_e32 v22, 0xc00, v5
	v_add_nc_u32_e32 v24, 0x1200, v5
	v_lshrrev_b32_e32 v1, 4, v1
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v27, 0x3f8, v9
	v_add_nc_u32_e32 v13, 0x1e00, v5
	s_cselect_b32 s1, s1, 0
	v_lshrrev_b32_e32 v9, 4, v24
	v_and_b32_e32 v20, 0xff8, v1
	v_lshrrev_b32_e32 v1, 4, v22
	v_dual_mov_b32 v17, v59 :: v_dual_add_nc_u32 v16, 0x2400, v16
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_and_b32_e32 v24, 0xff8, v9
	v_sub_nc_u32_e32 v9, 0x2c9f, v0
	v_and_b32_e32 v22, 0xff8, v1
	v_dual_lshrrev_b32 v1, 4, v3 :: v_dual_lshrrev_b32 v3, 4, v13
	v_add_nc_u32_e32 v13, v25, v23
	s_lshl2_add_u32 s1, s1, s34
	v_add_nc_u64_e32 v[34:35], 0x1200, v[58:59]
	s_add_co_i32 s4, s1, 0x19800
	v_and_b32_e32 v28, 0xff8, v3
	v_dual_lshrrev_b32 v3, 4, v13 :: v_dual_mov_b32 v13, v59
	v_dual_lshrrev_b32 v10, 4, v10 :: v_dual_lshrrev_b32 v16, 4, v16
	s_and_b32 s10, s4, 15
	s_add_co_i32 s43, s1, 0xe580
	...
	s_cselect_b32 s1, s1, 0
	v_add_nc_u64_e32 v[84:85], v[10:11], v[34:35]
	v_dual_mov_b32 v10, v59 :: v_dual_lshrrev_b32 v1, 8, v9
	s_lshr_b32 s6, s2, 31
	s_ashr_i32 s45, s2, 4
	s_lshl_b32 s10, s1, 2
	...
	s_bfe_i64 s[6:7], s[20:21], 0x200000
	s_ashr_i32 s5, s4, 31
	v_and_b32_e32 v71, 62, v9
	s_ashr_i32 s1, s0, 31
	s_mul_u64 s[4:5], s[6:7], s[4:5]
	s_bfe_i64 s[6:7], s[12:13], 0x200000
	s_lshl_b64 s[4:5], s[4:5], 1
	s_mul_u64 s[0:1], s[6:7], s[0:1]
	v_add_nc_u64_e32 v[32:33], 0xc00, v[58:59]
	v_and_b32_e32 v8, 0xff8, v8
	s_add_nc_u64 s[20:21], s[14:15], s[4:5]
	s_lshl_b64 s[4:5], s[0:1], 1
	v_cmp_ne_u32_e64 s0, v9, v71
	v_mov_b32_e32 v9, v59
	v_add_nc_u32_e32 v5, 0x2400, v5
	v_and_b32_e32 v38, 0x3f8, v3
	v_add_nc_u64_e32 v[36:37], 0x1800, v[58:59]
	v_mov_b32_e32 v23, v59
	v_add_nc_u64_e32 v[82:83], v[8:9], v[32:33]
	v_or_b32_e32 v8, v25, v19
	v_and_b32_e32 v2, 0x7f8, v2
	v_and_b32_e32 v16, 0xff8, v16
	v_add_nc_u64_e32 v[86:87], v[12:13], v[36:37]
	v_mov_b32_e32 v12, v59
	v_add_nc_u32_e32 v92, v27, v8
	v_lshl_or_b32 v39, v71, 8, v0
	v_dual_add_nc_u32 v108, v38, v8 :: v_dual_mov_b32 v8, v59
	v_lshrrev_b32_e32 v5, 4, v5
	v_and_b32_e32 v18, 0x7f8, v18
	v_dual_mov_b32 v19, v59 :: v_dual_mov_b32 v25, v59
	v_mov_b32_e32 v27, v59
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_and_b32_e32 v30, 0xff8, v5
	v_sub_nc_u32_e32 v5, 0xcbf, v0
	v_dual_mov_b32 v29, v59 :: v_dual_mov_b32 v31, v59
	v_add_nc_u64_e32 v[94:95], v[18:19], v[58:59]
	v_add_nc_u64_e32 v[98:99], v[22:23], v[32:33]
	v_dual_mov_b32 v5, v59 :: v_dual_lshrrev_b32 v64, 8, v5
	v_add_nc_u64_e32 v[100:101], v[24:25], v[34:35]
	v_add_nc_u64_e32 v[102:103], v[26:27], v[36:37]
	v_or_b32_e32 v1, 0x100, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_add_nc_u32_e32 v3, 2, v64
	v_add_nc_u64_e32 v[78:79], v[4:5], v[58:59]
	v_add_nc_u64_e32 v[4:5], 0x1e00, v[58:59]
	v_dual_add_nc_u32 v61, -1, v64 :: v_dual_lshlrev_b32 v110, 2, v39
	v_dual_mov_b32 v3, v59 :: v_dual_bitop2_b32 v75, 30, v3 bitop3:0x40
	v_mov_b32_e32 v111, v59
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u64_e32 v[88:89], v[14:15], v[4:5]
	v_add_nc_u64_e32 v[104:105], v[28:29], v[4:5]
	v_mov_b32_e32 v4, v59
	v_add_nc_u64_e32 v[72:73], v[2:3], v[58:59]
	v_add_nc_u64_e32 v[2:3], 0x600, v[58:59]
	v_dual_mov_b32 v14, v59 :: v_dual_add_nc_u32 v73, 0xffffff00, v39
	v_dual_mov_b32 v5, v59 :: v_dual_mov_b32 v18, v59
	v_mov_b32_e32 v22, v59
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u64_e32 v[80:81], v[6:7], v[2:3]
	v_add_nc_u64_e32 v[6:7], 0x2400, v[58:59]
	v_add_nc_u64_e32 v[96:97], v[20:21], v[2:3]
	v_dual_mov_b32 v2, v59 :: v_dual_mov_b32 v3, v59
	v_dual_mov_b32 v20, v59 :: v_dual_mov_b32 v24, v59
	v_mov_b32_e32 v34, v59
	v_add_nc_u64_e32 v[90:91], v[16:17], v[6:7]
	v_add_nc_u64_e32 v[106:107], v[30:31], v[6:7]
	v_dual_mov_b32 v6, v59 :: v_dual_mov_b32 v7, v59
	v_dual_mov_b32 v16, v59 :: v_dual_mov_b32 v35, v59
	v_dual_mov_b32 v36, v59 :: v_dual_mov_b32 v37, v59
	v_dual_mov_b32 v38, v59 :: v_dual_mov_b32 v39, v59
	v_dual_mov_b32 v40, v59 :: v_dual_mov_b32 v41, v59
	v_dual_mov_b32 v42, v59 :: v_dual_mov_b32 v43, v59
	v_dual_mov_b32 v44, v59 :: v_dual_mov_b32 v45, v59
	v_dual_mov_b32 v46, v59 :: v_dual_mov_b32 v47, v59
	v_dual_mov_b32 v48, v59 :: v_dual_mov_b32 v49, v59
	v_dual_mov_b32 v50, v59 :: v_dual_mov_b32 v51, v59
	v_dual_mov_b32 v52, v59 :: v_dual_mov_b32 v53, v59
	v_dual_mov_b32 v54, v59 :: v_dual_mov_b32 v55, v59
	v_dual_mov_b32 v56, v59 :: v_dual_mov_b32 v57, v59
	v_dual_mov_b32 v26, v59 :: v_dual_mov_b32 v28, v59
	v_dual_mov_b32 v30, v59 :: v_dual_mov_b32 v32, v59
...
.LBB0_23:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_dual_mov_b32 v58, v112 :: v_dual_add_nc_u32 v77, -2, v77
	v_dual_mov_b32 v114, v113 :: v_dual_mov_b32 v115, v59
	v_add_nc_u32_e32 v113, 0x200, v113
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[116:117], v[58:59], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v77
	v_add_nc_u32_e32 v112, 0x200, v112
	v_lshl_add_u64 v[114:115], v[114:115], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[116:117], v59
	flat_store_b32 v[114:115], v59
...
.LBB0_26:                               ;   Parent Loop BB0_21 Depth=1
	...
	flat_store_b32 v[112:113], v59
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[112:113], 0x400, v[112:113]
	v_cmp_lt_u32_e32 vcc_lo, 0x2b9f, v58
...
.LBB0_28:                               ;   in Loop: Header=BB0_29 Depth=2
	...
	v_add_nc_u32_e32 v113, 0x200, v113
	v_cmp_eq_u32_e32 vcc_lo, s12, v75
	v_add_nc_u32_e32 v112, 0x200, v112
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s12, v61
	v_cmpx_le_u32_e64 s12, v64
	s_cbranch_execz .LBB0_31
; %bb.30:                               ;   in Loop: Header=BB0_29 Depth=2
	v_mov_b32_e32 v58, v112
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[114:115], v[58:59], 2, s[6:7]
	flat_store_b32 v[114:115], v59
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v58, v60, 1, s2
	v_lshl_add_u32 v77, v62, 1, s1
	v_lshl_add_u32 v79, v70, 1, s2
	v_lshl_add_u32 v81, v72, 1, s2
	v_lshl_add_u32 v83, v74, 1, s2
	ds_load_b128 v[112:115], v58
	ds_load_b128 v[116:119], v58 offset:16
	v_lshl_add_u32 v58, v66, 1, s2
	ds_load_b128 v[120:123], v77
	ds_load_b128 v[124:127], v77 offset:16
	v_lshl_add_u32 v77, v68, 1, s2
	ds_load_b128 v[144:147], v79 offset:9216
	ds_load_b128 v[128:131], v58 offset:3072
	ds_load_b128 v[132:135], v58 offset:3088
	ds_load_b128 v[148:151], v79 offset:9232
	ds_load_b128 v[136:139], v77 offset:6144
	ds_load_b128 v[140:143], v77 offset:6160
	v_lshl_add_u32 v58, v76, 1, s2
	ds_load_b128 v[152:155], v81 offset:12288
	ds_load_b128 v[156:159], v81 offset:12304
	v_lshl_add_u32 v77, v80, 1, s2
	ds_load_b128 v[160:163], v83 offset:15360
	ds_load_b128 v[168:171], v58 offset:18432
	ds_load_b128 v[172:175], v58 offset:18448
	v_lshl_add_u32 v58, v78, 1, s2
	ds_load_b128 v[164:167], v83 offset:15376
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[50:57], v[112:119], v[120:127], v[50:57]
	ds_load_b128 v[112:115], v58 offset:64
	ds_load_b128 v[116:119], v58 offset:80
	v_lshl_add_u32 v58, v82, 1, s2
	v_lshl_add_u32 v79, v86, 1, s2
	; sched_group_barrier mask(0x00000100) size(16) SyncID(0)
	ds_load_b128 v[176:179], v79 offset:64
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[42:49], v[128:135], v[120:127], v[42:49] matrix_b_reuse
	ds_load_b128 v[128:131], v77 offset:64
	ds_load_b128 v[132:135], v77 offset:80
	v_lshl_add_u32 v77, v84, 1, s2
	ds_load_b128 v[180:183], v79 offset:80
	v_lshl_add_u32 v79, v92, 1, s1
	ds_load_b128 v[192:195], v79 offset:64
	s_wait_dscnt 0xd
	v_wmma_f32_16x16x32_bf16 v[34:41], v[136:143], v[120:127], v[34:41] matrix_b_reuse
	ds_load_b128 v[136:139], v58 offset:64
	ds_load_b128 v[140:143], v58 offset:80
	v_lshl_add_u32 v58, v88, 1, s2
	ds_load_b128 v[196:199], v79 offset:80
	v_wmma_f32_16x16x32_bf16 v[18:25], v[144:151], v[120:127], v[18:25] matrix_b_reuse
	...
	s_wait_dscnt 0x11
	v_wmma_f32_16x16x32_bf16 v[10:17], v[152:159], v[120:127], v[10:17] matrix_b_reuse
	ds_load_b128 v[152:155], v58 offset:64
	ds_load_b128 v[156:159], v58 offset:80
	ds_load_b128 v[188:191], v77 offset:80
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[2:9], v[160:167], v[120:127], v[2:9] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[168:175], v[120:127], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v58, v94, 1, s2
	v_lshl_add_u32 v77, v96, 1, s2
	v_lshl_add_u32 v79, v98, 1, s2
	ds_load_b128 v[120:123], v58 offset:128
	ds_load_b128 v[124:127], v58 offset:144
	ds_load_b128 v[160:163], v77 offset:128
	v_lshl_add_u32 v58, v100, 1, s2
	ds_load_b128 v[164:167], v77 offset:144
	v_lshl_add_u32 v77, v102, 1, s2
	ds_load_b128 v[168:171], v79 offset:128
	ds_load_b128 v[172:175], v79 offset:144
	ds_load_b128 v[200:203], v58 offset:128
	ds_load_b128 v[204:207], v58 offset:144
	v_lshl_add_u32 v58, v104, 1, s2
	ds_load_b128 v[208:211], v77 offset:128
	v_lshl_add_u32 v79, v106, 1, s2
	ds_load_b128 v[212:215], v77 offset:144
	v_lshl_add_u32 v77, v108, 1, s1
	ds_load_b128 v[216:219], v58 offset:128
	ds_load_b128 v[220:223], v58 offset:144
	...
	s_wait_dscnt 0x16
	v_wmma_f32_16x16x32_bf16 v[50:57], v[112:119], v[192:199], v[50:57]
	; sched_group_barrier mask(0x00000100) size(16) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[128:135], v[192:199], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[136:143], v[192:199], v[34:41] matrix_b_reuse
	s_wait_dscnt 0x14
	v_wmma_f32_16x16x32_bf16 v[18:25], v[144:151], v[192:199], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[176:183], v[192:199], v[10:17] matrix_b_reuse
	s_wait_dscnt 0x11
	v_wmma_f32_16x16x32_bf16 v[2:9], v[152:159], v[192:199], v[2:9] matrix_b_reuse
	s_wait_dscnt 0x10
	v_wmma_f32_16x16x32_bf16 v[26:33], v[184:191], v[192:199], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(7) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[50:57], v[120:127], v[232:239], v[50:57]
	; sched_group_barrier mask(0x00000100) size(16) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[160:167], v[232:239], v[42:49] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[168:175], v[232:239], v[34:41] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[200:207], v[232:239], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[208:215], v[232:239], v[10:17] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[216:223], v[232:239], v[2:9] matrix_b_reuse
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm224_bn064_bk096_wm2_wn4_mc0, .Lfunc_end0-bm224_bn064_bk096_wm2_wn4_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm224_bn064_bk096_wm2_wn4_mc0
	...
	.section	.text.bm224_bn064_bk096_wm2_wn4_mc0,"axG",@progbits,bm224_bn064_bk096_wm2_wn4_mc0,comdat
                                        ; -- End function
	.set .Lbm224_bn064_bk096_wm2_wn4_mc0.num_vgpr, 240
	.set .Lbm224_bn064_bk096_wm2_wn4_mc0.num_agpr, 0
	.set .Lbm224_bn064_bk096_wm2_wn4_mc0.numbered_sgpr, 56
	.set .Lbm224_bn064_bk096_wm2_wn4_mc0.num_named_barrier, 0
	.set .Lbm224_bn064_bk096_wm2_wn4_mc0.private_seg_size, 0
	.set .Lbm224_bn064_bk096_wm2_wn4_mc0.uses_vcc, 1
	.set .Lbm224_bn064_bk096_wm2_wn4_mc0.uses_flat_scratch, 1
	.set .Lbm224_bn064_bk096_wm2_wn4_mc0.has_dyn_sized_stack, 0
	.set .Lbm224_bn064_bk096_wm2_wn4_mc0.has_recursion, 0
	.set .Lbm224_bn064_bk096_wm2_wn4_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_5630863280b7f413,@object ; @__hip_cuid_5630863280b7f413
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_5630863280b7f413
__hip_cuid_5630863280b7f413:
	.byte	0                               ; 0x0
	.size	__hip_cuid_5630863280b7f413, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_5630863280b7f413
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm224_bn064_bk096_wm2_wn4_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm224_bn064_bk096_wm2_wn4_mc0.kd
