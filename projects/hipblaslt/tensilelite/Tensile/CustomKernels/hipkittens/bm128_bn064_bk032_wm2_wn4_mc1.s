	...
	.section	.text.bm128_bn064_bk032_wm2_wn4_mc1,"axG",@progbits,bm128_bn064_bk032_wm2_wn4_mc1,comdat
	.protected	bm128_bn064_bk032_wm2_wn4_mc1 ; -- Begin function bm128_bn064_bk032_wm2_wn4_mc1
	.globl	bm128_bn064_bk032_wm2_wn4_mc1
	.p2align	8
	.type	bm128_bn064_bk032_wm2_wn4_mc1,@function
bm128_bn064_bk032_wm2_wn4_mc1: ; @bm128_bn064_bk032_wm2_wn4_mc1
; %bb.0:
...
.LBB0_24:
	...
	v_dual_lshlrev_b32 v1, 4, v41 :: v_dual_mov_b32 v9, 0
	s_and_b32 s43, s35, s29
	s_and_not1_b32 vcc_lo, exec_lo, s13
	v_cndmask_b32_e64 v43, 0, 1, s43
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v45, 64, v1 bitop3:0x40
	v_dual_mov_b32 v7, v9 :: v_dual_bitop2_b32 v47, 48, v1 bitop3:0x40
...
; %bb.25:
	...
	v_and_b32_e32 v3, 0x98, v5
	v_or_b32_e32 v5, 0x400, v2
	s_add_co_i32 s4, s6, 0x5500
	s_add_co_i32 s45, s6, 0x3300
	s_and_b32 s10, s4, 15
	v_dual_add_nc_u32 v34, v3, v2 :: v_dual_lshrrev_b32 v3, 4, v4
	...
	v_add_nc_u32_e32 v38, v6, v1
	v_sub_nc_u32_e32 v1, 0x43f, v0
	s_cselect_b32 s6, s6, 0
	s_ashr_i32 s7, s12, 31
	v_dual_add_nc_u32 v44, v3, v2 :: v_dual_add_nc_u32 v46, v4, v2
	s_lshr_b32 s7, s7, 27
	v_add_nc_u32_e32 v48, v5, v2
	s_add_co_i32 s12, s12, s7
	v_dual_mov_b32 v2, v37 :: v_dual_lshrrev_b32 v40, 8, v35
	v_lshrrev_b32_e32 v42, 8, v1
	s_lshl_b32 s10, s6, 2
	...
	v_dual_mov_b32 v35, v40 :: v_dual_bitop2_b32 v49, 30, v1 bitop3:0x40
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v3, v37 :: v_dual_bitop2_b32 v52, 14, v6 bitop3:0x40
...
; %bb.31:                               ;   in Loop: Header=BB0_30 Depth=2
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[54:55], v[36:37], 2, s[14:15]
...
.LBB0_44:                               ;   in Loop: Header=BB0_27 Depth=1
	...
	v_wmma_f32_16x16x32_bf16 v[2:9], v[54:61], v[78:85], v[2:9]
	ds_load_b128 v[54:57], v36 offset:3072
	ds_load_b128 v[58:61], v36 offset:3088
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[54:61], v[78:85], v[26:33] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[62:69], v[78:85], v[10:17] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
...
.LBB0_64:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn064_bk032_wm2_wn4_mc1, .Lfunc_end0-bm128_bn064_bk032_wm2_wn4_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn064_bk032_wm2_wn4_mc1
	...
	.section	.text.bm128_bn064_bk032_wm2_wn4_mc1,"axG",@progbits,bm128_bn064_bk032_wm2_wn4_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn064_bk032_wm2_wn4_mc1.num_vgpr, 86
	.set .Lbm128_bn064_bk032_wm2_wn4_mc1.num_agpr, 0
	.set .Lbm128_bn064_bk032_wm2_wn4_mc1.numbered_sgpr, 56
	.set .Lbm128_bn064_bk032_wm2_wn4_mc1.num_named_barrier, 0
	.set .Lbm128_bn064_bk032_wm2_wn4_mc1.private_seg_size, 0
	.set .Lbm128_bn064_bk032_wm2_wn4_mc1.uses_vcc, 1
	.set .Lbm128_bn064_bk032_wm2_wn4_mc1.uses_flat_scratch, 0
	.set .Lbm128_bn064_bk032_wm2_wn4_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn064_bk032_wm2_wn4_mc1.has_recursion, 0
	.set .Lbm128_bn064_bk032_wm2_wn4_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_2ce9f3ba33c2f18b,@object ; @__hip_cuid_2ce9f3ba33c2f18b
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_2ce9f3ba33c2f18b
__hip_cuid_2ce9f3ba33c2f18b:
	.byte	0                               ; 0x0
	.size	__hip_cuid_2ce9f3ba33c2f18b, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_2ce9f3ba33c2f18b
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn064_bk032_wm2_wn4_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn064_bk032_wm2_wn4_mc1.kd
