	...
	.section	.text.bm128_bn256_bk064_wm4_wn2_mc1,"axG",@progbits,bm128_bn256_bk064_wm4_wn2_mc1,comdat
	.protected	bm128_bn256_bk064_wm4_wn2_mc1 ; -- Begin function bm128_bn256_bk064_wm4_wn2_mc1
	.globl	bm128_bn256_bk064_wm4_wn2_mc1
	.p2align	8
	.type	bm128_bn256_bk064_wm4_wn2_mc1,@function
bm128_bn256_bk064_wm4_wn2_mc1: ; @bm128_bn256_bk064_wm4_wn2_mc1
; %bb.0:
...
.LBB0_12:
	...
	s_min_i32 s18, s18, s19
	s_lshl_b32 s36, 0x1111, s38
...
; %bb.17:
	...
	v_or_b32_e32 v22, 0x1400, v13
	v_or_b32_e32 v23, 0x1800, v13
	v_or_b32_e32 v13, 0x1c00, v13
	v_dual_lshrrev_b32 v14, 4, v14 :: v_dual_lshrrev_b32 v12, 4, v12
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_lshrrev_b32 v17, 4, v17 :: v_dual_lshrrev_b32 v22, 4, v22
	v_dual_lshrrev_b32 v18, 4, v18 :: v_dual_lshrrev_b32 v1, 4, v1
	v_dual_lshrrev_b32 v23, 4, v23 :: v_dual_lshrrev_b32 v21, 4, v21
	v_dual_add_nc_u32 v138, v6, v7 :: v_dual_lshrrev_b32 v13, 4, v13
	v_add_nc_u32_e32 v140, v8, v7
	s_lshl_b32 s10, s6, 2
	...
	v_dual_add_nc_u32 v136, v11, v5 :: v_dual_add_nc_u32 v142, v9, v7
	v_dual_add_nc_u32 v144, v15, v7 :: v_dual_add_nc_u32 v146, v16, v7
	v_dual_add_nc_u32 v148, v10, v7 :: v_dual_add_nc_u32 v156, v19, v2
	v_dual_mov_b32 v173, v133 :: v_dual_add_nc_u32 v150, v14, v7
	v_dual_mov_b32 v175, v133 :: v_dual_add_nc_u32 v152, v12, v3
	v_add3_u32 v154, v3, v20, 0x400
	v_add3_u32 v158, v2, v17, 0x400
	v_add3_u32 v160, v2, v18, 0x800
	v_add3_u32 v162, v2, v24, 0xc00
	v_add3_u32 v164, v2, v21, 0x1000
	v_add3_u32 v166, v2, v22, 0x1400
	v_add3_u32 v168, v2, v23, 0x1800
	v_add3_u32 v170, v2, v13, 0x1c00
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v132, v176 :: v_dual_add_nc_u32 v145, -2, v145
	v_dual_mov_b32 v178, v177 :: v_dual_mov_b32 v179, v133
	v_add_nc_u32_e32 v177, 0x200, v177
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[180:181], v[132:133], 2, s[6:7]
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	ds_load_b128 v[184:187], v145 offset:2048
	ds_load_b128 v[188:191], v145 offset:2064
	ds_load_b128 v[192:195], v147
	ds_load_b128 v[216:219], v149 offset:6144
	ds_load_b128 v[220:223], v149 offset:6160
	v_lshl_add_u32 v145, v144, 1, s5
	v_lshl_add_u32 v157, v150, 1, s5
	v_lshl_add_u32 v155, v148, 1, s5
	v_lshl_add_u32 v151, v140, 1, s5
	v_lshl_add_u32 v132, v138, 1, s5
	v_lshl_add_u32 v159, v152, 1, s6
	v_lshl_add_u32 v161, v154, 1, s6
	v_lshl_add_u32 v163, v156, 1, s5
	v_lshl_add_u32 v165, v158, 1, s5
	ds_load_b128 v[236:239], v132 offset:2064
	v_lshl_add_u32 v149, v160, 1, s5
	v_lshl_add_u32 v167, v170, 1, s5
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[26:33], v[184:191], v[216:223], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[98:105], v[176:183], v[216:223], v[98:105] matrix_a_reuse
	ds_load_b128 v[216:219], v145 offset:8192
	ds_load_b128 v[220:223], v145 offset:8208
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[184:191], v[216:223], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[90:97], v[176:183], v[216:223], v[90:97] matrix_a_reuse
	ds_load_b128 v[208:211], v153 offset:10240
	ds_load_b128 v[212:215], v153 offset:10256
	v_lshl_add_u32 v153, v164, 1, s5
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[184:191], v[208:215], v[10:17] matrix_a_reuse
	ds_load_b128 v[196:199], v157 offset:14336
	ds_load_b128 v[200:203], v157 offset:14352
	ds_load_b128 v[204:207], v155 offset:12304
	v_lshl_add_u32 v157, v168, 1, s5
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[50:57], v[176:183], v[196:203], v[50:57] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[184:191], v[196:203], v[58:65]
	ds_load_b128 v[200:203], v155 offset:12288
	ds_load_b128 v[196:199], v147 offset:16
	v_lshl_add_u32 v155, v166, 1, s5
	ds_load_b128 v[248:251], v155 offset:64
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[2:9], v[184:191], v[200:207], v[2:9] matrix_a_reuse
	ds_load_b128 v[252:255], v155 offset:80
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[82:89], v[176:183], v[208:215], v[82:89] matrix_a_reuse
	ds_load_b128 v[208:211], v167 offset:64
	ds_load_b128 v[212:215], v167 offset:80
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[66:73], v[184:191], v[192:199], v[66:73] matrix_a_reuse
	ds_load_b128 v[224:227], v151 offset:4096
	ds_load_b128 v[228:231], v151 offset:4112
	v_lshl_add_u32 v151, v162, 1, s5
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	ds_load_b128 v[216:219], v151 offset:64
	v_wmma_f32_16x16x32_bf16 v[74:81], v[176:183], v[200:207], v[74:81] matrix_a_reuse
	ds_load_b128 v[220:223], v151 offset:80
	ds_load_b128 v[200:203], v153 offset:64
	ds_load_b128 v[204:207], v153 offset:80
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[34:41], v[184:191], v[224:231], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[106:113], v[176:183], v[224:231], v[106:113] matrix_a_reuse
	ds_load_b128 v[232:235], v132 offset:2048
	ds_load_b128 v[224:227], v159 offset:64
	ds_load_b128 v[228:231], v159 offset:80
	ds_load_b128 v[240:243], v161 offset:64
	ds_load_b128 v[244:247], v161 offset:80
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[42:49], v[184:191], v[232:239], v[42:49] matrix_a_reuse
	ds_load_b128 v[184:187], v157 offset:64
	ds_load_b128 v[188:191], v157 offset:80
	v_wmma_f32_16x16x32_bf16 v[122:129], v[176:183], v[192:199], v[122:129]
	ds_load_b128 v[192:195], v163 offset:64
	ds_load_b128 v[196:199], v163 offset:80
	v_wmma_f32_16x16x32_bf16 v[114:121], v[176:183], v[232:239], v[114:121] matrix_a_reuse
	ds_load_b128 v[232:235], v165 offset:64
	ds_load_b128 v[236:239], v165 offset:80
	ds_load_b128 v[176:179], v149 offset:64
	ds_load_b128 v[180:183], v149 offset:80
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[122:129], v[224:231], v[192:199], v[122:129]
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[114:121], v[224:231], v[232:239], v[114:121] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[106:113], v[224:231], v[176:183], v[106:113] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[98:105], v[224:231], v[216:223], v[98:105] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[90:97], v[224:231], v[200:207], v[90:97] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[224:231], v[248:255], v[82:89] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[74:81], v[224:231], v[184:191], v[74:81] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[224:231], v[208:215], v[50:57] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[58:65], v[240:247], v[208:215], v[58:65]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[240:247], v[184:191], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[240:247], v[248:255], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[18:25], v[240:247], v[200:207], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[240:247], v[216:223], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[240:247], v[176:183], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[240:247], v[232:239], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[240:247], v[192:199], v[66:73] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(4) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.38:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_dual_mov_b32 v145, s13 :: v_dual_mov_b32 v176, s14
...
.LBB0_40:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v145, s5 :: v_dual_mov_b32 v176, s6
	s_bitset1_b32 s7, 31
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn256_bk064_wm4_wn2_mc1, .Lfunc_end0-bm128_bn256_bk064_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn256_bk064_wm4_wn2_mc1
	...
	.section	.text.bm128_bn256_bk064_wm4_wn2_mc1,"axG",@progbits,bm128_bn256_bk064_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn256_bk064_wm4_wn2_mc1.num_vgpr, 256
	.set .Lbm128_bn256_bk064_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm128_bn256_bk064_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm128_bn256_bk064_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm128_bn256_bk064_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm128_bn256_bk064_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm128_bn256_bk064_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn256_bk064_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn256_bk064_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm128_bn256_bk064_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_1642a44bc16cbda9,@object ; @__hip_cuid_1642a44bc16cbda9
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_1642a44bc16cbda9
__hip_cuid_1642a44bc16cbda9:
	.byte	0                               ; 0x0
	.size	__hip_cuid_1642a44bc16cbda9, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_1642a44bc16cbda9
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn256_bk064_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn256_bk064_wm4_wn2_mc1.kd
