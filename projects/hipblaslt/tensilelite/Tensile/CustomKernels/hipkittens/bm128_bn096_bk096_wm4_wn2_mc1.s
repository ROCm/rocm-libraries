	...
	.section	.text.bm128_bn096_bk096_wm4_wn2_mc1,"axG",@progbits,bm128_bn096_bk096_wm4_wn2_mc1,comdat
	.protected	bm128_bn096_bk096_wm4_wn2_mc1 ; -- Begin function bm128_bn096_bk096_wm4_wn2_mc1
	.globl	bm128_bn096_bk096_wm4_wn2_mc1
	.p2align	8
	.type	bm128_bn096_bk096_wm4_wn2_mc1,@function
bm128_bn096_bk096_wm4_wn2_mc1: ; @bm128_bn096_bk096_wm4_wn2_mc1
; %bb.0:
...
; %bb.17:
	...
	v_mul_u32_u24_e32 v3, 0x60, v57
	v_and_b32_e32 v4, 16, v0
	s_or_b32 s6, s1, 0xb280
	s_mov_b32 s7, s5
	v_and_b32_e32 v5, 15, v0
	s_and_b64 s[6:7], s[6:7], 15
	v_dual_mov_b32 v53, 0 :: v_dual_bitop2_b32 v2, v3, v4 bitop3:0x54
	s_sub_co_i32 s4, 16, s6
	v_mul_u32_u24_e32 v1, 0x60, v59
	s_lshr_b32 s4, s4, 2
	...
	s_mul_hi_i32 s8, s12, 0x2aaaaaab
	...
	v_add_nc_u32_e32 v54, v6, v17
	v_dual_add_nc_u32 v2, v2, v8 :: v_dual_add_nc_u32 v7, v7, v8
	v_mov_b32_e32 v15, v53
	s_mul_u64 s[18:19], s[18:19], s[0:1]
	s_ashr_i32 s7, s6, 31
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_lshrrev_b32 v2, 4, v2 :: v_dual_lshrrev_b32 v7, 4, v7
	...
	v_dual_lshrrev_b32 v12, 4, v2 :: v_dual_bitop2_b32 v10, v3, v9 bitop3:0x54
	v_or_b32_e32 v9, v1, v9
	v_dual_add_nc_u32 v58, v7, v17 :: v_dual_bitop2_b32 v4, 64, v4 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v18, 0x3f8, v12
	v_mad_u32_u24 v6, 0x60, v5, v10
	v_add_nc_u32_e32 v10, v10, v8
	v_mad_u32_u24 v13, 0x60, v5, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v56, v11, v16 :: v_dual_add_nc_u32 v60, v18, v17
	v_lshrrev_b32_e32 v6, 4, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v7, v53 :: v_dual_lshrrev_b32 v10, 4, v10
	v_dual_mov_b32 v11, v53 :: v_dual_mov_b32 v18, v53
	v_and_b32_e32 v19, 0x7f8, v6
	v_lshrrev_b32_e32 v6, 4, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_and_b32_e32 v52, 0x7f8, v10
	v_add_nc_u32_e32 v10, 0xc00, v13
	v_add_nc_u32_e32 v9, v9, v8
	v_dual_mov_b32 v34, v53 :: v_dual_mov_b32 v35, v53
	v_and_b32_e32 v13, 0x3f8, v6
	v_dual_lshrrev_b32 v10, 4, v10 :: v_dual_bitop2_b32 v3, v3, v4 bitop3:0x54
	s_delay_alu instid0(VALU_DEP_4)
	v_lshrrev_b32_e32 v6, 4, v9
	v_add_nc_u64_e32 v[62:63], v[52:53], v[14:15]
	v_add_nc_u32_e32 v52, 0x600, v17
	v_dual_add_nc_u32 v64, v19, v16 :: v_dual_add_nc_u32 v66, v13, v17
	v_mad_u32_u24 v9, 0x60, v5, v3
	v_or_b32_e32 v1, v1, v4
	v_and_b32_e32 v4, 0x3f8, v6
	v_and_b32_e32 v6, 0x7f8, v10
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v13, v53 :: v_dual_lshrrev_b32 v9, 4, v9
	v_add_nc_u32_e32 v3, v3, v8
	v_mad_u32_u24 v5, 0x60, v5, v1
	v_add_nc_u32_e32 v1, v1, v8
	v_mov_b32_e32 v19, v53
	v_and_b32_e32 v20, 0x7f8, v9
	v_lshrrev_b32_e32 v3, 4, v3
	v_add_nc_u32_e32 v9, 0xc00, v5
	v_lshrrev_b32_e32 v5, 4, v5
	v_dual_mov_b32 v36, v53 :: v_dual_lshrrev_b32 v1, 4, v1
	v_mov_b32_e32 v37, v53
	v_and_b32_e32 v8, 0x7f8, v3
	v_sub_nc_u32_e32 v3, 0x197f, v0
	v_lshrrev_b32_e32 v9, 4, v9
	v_and_b32_e32 v21, 0x3f8, v5
	v_sub_nc_u32_e32 v5, 0x131f, v0
	v_and_b32_e32 v10, 0x3f8, v1
	v_lshrrev_b32_e32 v1, 8, v3
	v_and_b32_e32 v12, 0x7f8, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v9, v53 :: v_dual_lshrrev_b32 v3, 8, v5
	v_add_nc_u64_e32 v[78:79], v[10:11], v[52:53]
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_add_nc_u32_e32 v5, 1, v1
	v_or_b32_e32 v1, 0x100, v0
	v_add_nc_u64_e32 v[74:75], v[8:9], v[14:15]
	v_dual_add_nc_u32 v72, v20, v16 :: v_dual_add_nc_u32 v76, v21, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v3, 1, v3 :: v_dual_bitop2_b32 v61, 26, v5 bitop3:0x40
	v_dual_mov_b32 v83, v53 :: v_dual_mov_b32 v85, v53
	v_mov_b32_e32 v8, v53
	v_lshl_or_b32 v22, v61, 8, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_and_b32_e32 v65, 22, v3
	v_cmp_ne_u32_e64 s1, v5, v61
	v_dual_mov_b32 v5, v53 :: v_dual_mov_b32 v10, v53
	v_add_nc_u32_e32 v63, 0xffffff00, v22
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_cmp_ne_u32_e64 s2, v3, v65
	v_mov_b32_e32 v3, v53
	v_lshl_or_b32 v23, v65, 8, v0
	v_add_nc_u64_e32 v[68:69], v[4:5], v[52:53]
	v_dual_lshlrev_b32 v82, 2, v22 :: v_dual_mov_b32 v4, v53
	v_add_nc_u64_e32 v[70:71], v[6:7], v[2:3]
	v_add_nc_u64_e32 v[80:81], v[12:13], v[2:3]
	v_add_nc_u32_e32 v67, 0xffffff00, v23
	v_dual_lshlrev_b32 v84, 2, v23 :: v_dual_mov_b32 v2, v53
	v_dual_mov_b32 v6, v53 :: v_dual_mov_b32 v12, v53
	v_dual_mov_b32 v14, v53 :: v_dual_mov_b32 v16, v53
	v_dual_mov_b32 v17, v53 :: v_dual_mov_b32 v20, v53
	v_dual_mov_b32 v21, v53 :: v_dual_mov_b32 v22, v53
	v_dual_mov_b32 v23, v53 :: v_dual_mov_b32 v38, v53
...
; %bb.23:                               ;   in Loop: Header=BB0_19 Depth=1
	v_add_nc_u64_e32 v[86:87], s[6:7], v[82:83]
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_lshl_add_u32 v69, v56, 1, s6
	v_lshl_add_u32 v71, v54, 1, s5
	v_lshl_add_u32 v73, v60, 1, s5
	v_lshl_add_u32 v75, v70, 1, s5
	...
	v_lshl_add_u32 v69, v62, 1, s6
	v_lshl_add_u32 v71, v66, 1, s5
	...
	v_lshl_add_u32 v52, v72, 1, s6
	v_lshl_add_u32 v69, v74, 1, s6
	v_lshl_add_u32 v71, v76, 1, s5
	...
	v_lshl_add_u32 v52, v78, 1, s5
	v_lshl_add_u32 v69, v80, 1, s5
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn096_bk096_wm4_wn2_mc1, .Lfunc_end0-bm128_bn096_bk096_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn096_bk096_wm4_wn2_mc1
	...
	.section	.text.bm128_bn096_bk096_wm4_wn2_mc1,"axG",@progbits,bm128_bn096_bk096_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm128_bn096_bk096_wm4_wn2_mc1.num_vgpr, 158
	.set .Lbm128_bn096_bk096_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm128_bn096_bk096_wm4_wn2_mc1.numbered_sgpr, 60
	.set .Lbm128_bn096_bk096_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm128_bn096_bk096_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm128_bn096_bk096_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm128_bn096_bk096_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm128_bn096_bk096_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm128_bn096_bk096_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm128_bn096_bk096_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_6a0769d8536c068c,@object ; @__hip_cuid_6a0769d8536c068c
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_6a0769d8536c068c
__hip_cuid_6a0769d8536c068c:
	.byte	0                               ; 0x0
	.size	__hip_cuid_6a0769d8536c068c, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_6a0769d8536c068c
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn096_bk096_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     62
    .sgpr_spill_count: 0
    .symbol:         bm128_bn096_bk096_wm4_wn2_mc1.kd
