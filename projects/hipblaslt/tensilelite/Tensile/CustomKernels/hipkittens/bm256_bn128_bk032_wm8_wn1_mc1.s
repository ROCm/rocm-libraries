	...
	.section	.text.bm256_bn128_bk032_wm8_wn1_mc1,"axG",@progbits,bm256_bn128_bk032_wm8_wn1_mc1,comdat
	.protected	bm256_bn128_bk032_wm8_wn1_mc1 ; -- Begin function bm256_bn128_bk032_wm8_wn1_mc1
	.globl	bm256_bn128_bk032_wm8_wn1_mc1
	.p2align	8
	.type	bm256_bn128_bk032_wm8_wn1_mc1,@function
bm256_bn128_bk032_wm8_wn1_mc1: ; @bm256_bn128_bk032_wm8_wn1_mc1
; %bb.0:
...
; %bb.21:
	v_dual_lshlrev_b32 v3, 5, v0 :: v_dual_lshlrev_b32 v1, 10, v137
	...
	v_dual_add_nc_u32 v130, v1, v4 :: v_dual_bitop2_b32 v2, v3, v2 bitop3:0x54
	v_lshlrev_b32_e32 v1, 1, v0
	s_and_b32 s10, s4, 15
	v_or_b32_e32 v10, 0xc00, v3
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_lshrrev_b32 v9, 4, v9
	v_and_b32_e32 v1, 24, v1
	s_sub_co_i32 s7, 16, s10
	s_add_co_i32 s45, s6, 0x6600
	s_lshr_b32 s6, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_dual_add_nc_u32 v134, v2, v1 :: v_dual_bitop2_b32 v6, 56, v6 bitop3:0x40
	v_or_b32_e32 v1, 0x600, v3
	v_or_b32_e32 v3, 0xe00, v3
	v_dual_mov_b32 v133, 0 :: v_dual_lshrrev_b32 v8, 4, v8
	...
	v_and_b32_e32 v3, 0x98, v8
	v_and_b32_e32 v8, 0xb8, v9
	v_sub_nc_u32_e32 v9, 0x87f, v0
	s_lshr_b32 s7, s7, 27
	v_and_b32_e32 v5, 0x1f8, v5
	s_add_co_i32 s12, s12, s7
	v_and_b32_e32 v7, 0x58, v7
	v_lshrrev_b32_e32 v136, 8, v9
	...
	v_dual_add_nc_u32 v9, 2, v136 :: v_dual_add_nc_u32 v140, v2, v6
	s_ashr_i32 s7, s6, 31
	...
	v_dual_add_nc_u32 v138, v5, v4 :: v_dual_bitop2_b32 v139, 30, v9 bitop3:0x40
	v_dual_add_nc_u32 v142, v2, v7 :: v_dual_add_nc_u32 v148, v2, v8
	v_dual_add_nc_u32 v144, v2, v11 :: v_dual_add_nc_u32 v150, v2, v10
	v_dual_add_nc_u32 v146, v2, v3 :: v_dual_add_nc_u32 v152, v2, v12
	v_dual_mov_b32 v155, v133 :: v_dual_mov_b32 v3, v133
	v_dual_mov_b32 v2, v133 :: v_dual_mov_b32 v4, v133
	...
	v_dual_mov_b32 v65, v133 :: v_dual_mov_b32 v90, v133
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_lshl_add_u32 v143, v138, 1, s2
	v_lshl_add_u32 v145, v134, 1, s1
	v_lshl_add_u32 v147, v146, 1, s1
	...
	ds_load_b128 v[176:179], v147 offset:4096
	ds_load_b128 v[180:183], v147 offset:4112
	v_lshl_add_u32 v132, v150, 1, s1
	v_lshl_add_u32 v143, v140, 1, s1
	...
	v_lshl_add_u32 v132, v152, 1, s1
	ds_load_b128 v[184:187], v132 offset:7168
	ds_load_b128 v[188:191], v132 offset:7184
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[74:81], v[164:171], v[176:183], v[74:81] matrix_a_reuse
	v_lshl_add_u32 v132, v148, 1, s1
	v_wmma_f32_16x16x32_bf16 v[50:57], v[156:163], v[176:183], v[50:57] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[42:49], v[156:163], v[184:191], v[42:49] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[82:89], v[164:171], v[184:191], v[82:89]
	ds_load_b128 v[180:183], v143 offset:1024
	ds_load_b128 v[184:187], v143 offset:1040
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[164:171], v[180:187], v[26:33] matrix_a_reuse
	ds_load_b128 v[176:179], v145 offset:16
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[164:171], v[172:179], v[34:41] matrix_a_reuse
	...
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[66:73], v[164:171], v[192:199], v[66:73] matrix_a_reuse
	...
	v_wmma_f32_16x16x32_bf16 v[58:65], v[156:163], v[192:199], v[58:65] matrix_a_reuse
...
; %bb.47:
	...
	v_dual_lshrrev_b32 v114, 3, v114 :: v_dual_lshrrev_b32 v99, 3, v99
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_lshrrev_b32 v115, 3, v115 :: v_dual_lshrrev_b32 v101, 3, v101
	...
	ds_store_b128 v106, v[38:41] offset:32
	ds_store_b128 v107, v[118:121] offset:8192
	ds_store_b128 v107, v[30:33] offset:8224
	ds_store_b128 v108, v[110:113] offset:16384
	ds_store_b128 v108, v[22:25] offset:16416
	ds_store_b128 v98, v[102:105] offset:24576
	ds_store_b128 v98, v[14:17] offset:24608
	ds_store_b128 v100, v[94:97] offset:32768
	ds_store_b128 v100, v[6:9] offset:32800
	v_cvt_pk_bf16_f32 v9, v80, v81
	v_cvt_pk_bf16_f32 v8, v78, v79
	v_cvt_pk_bf16_f32 v7, v76, v77
	...
	ds_store_b128 v58, v[62:65] offset:40960
	ds_store_b128 v58, v[2:5] offset:40992
	ds_store_b128 v59, v[54:57] offset:49152
	ds_store_b128 v59, v[6:9] offset:49184
	ds_store_b128 v1, v[46:49] offset:57344
	ds_store_b128 v1, v[10:13] offset:57376
.LBB0_48:
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm256_bn128_bk032_wm8_wn1_mc1, .Lfunc_end0-bm256_bn128_bk032_wm8_wn1_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm256_bn128_bk032_wm8_wn1_mc1
	...
	.section	.text.bm256_bn128_bk032_wm8_wn1_mc1,"axG",@progbits,bm256_bn128_bk032_wm8_wn1_mc1,comdat
                                        ; -- End function
	.set .Lbm256_bn128_bk032_wm8_wn1_mc1.num_vgpr, 216
	.set .Lbm256_bn128_bk032_wm8_wn1_mc1.num_agpr, 0
	.set .Lbm256_bn128_bk032_wm8_wn1_mc1.numbered_sgpr, 56
	.set .Lbm256_bn128_bk032_wm8_wn1_mc1.num_named_barrier, 0
	.set .Lbm256_bn128_bk032_wm8_wn1_mc1.private_seg_size, 0
	.set .Lbm256_bn128_bk032_wm8_wn1_mc1.uses_vcc, 1
	.set .Lbm256_bn128_bk032_wm8_wn1_mc1.uses_flat_scratch, 1
	.set .Lbm256_bn128_bk032_wm8_wn1_mc1.has_dyn_sized_stack, 0
	.set .Lbm256_bn128_bk032_wm8_wn1_mc1.has_recursion, 0
	.set .Lbm256_bn128_bk032_wm8_wn1_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_679d35a799d0e91e,@object ; @__hip_cuid_679d35a799d0e91e
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_679d35a799d0e91e
__hip_cuid_679d35a799d0e91e:
	.byte	0                               ; 0x0
	.size	__hip_cuid_679d35a799d0e91e, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_679d35a799d0e91e
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm256_bn128_bk032_wm8_wn1_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm256_bn128_bk032_wm8_wn1_mc1.kd
