	...
	.section	.text.bm064_bn128_bk096_wm2_wn4_mc0,"axG",@progbits,bm064_bn128_bk096_wm2_wn4_mc0,comdat
	.protected	bm064_bn128_bk096_wm2_wn4_mc0 ; -- Begin function bm064_bn128_bk096_wm2_wn4_mc0
	.globl	bm064_bn128_bk096_wm2_wn4_mc0
	.p2align	8
	.type	bm064_bn128_bk096_wm2_wn4_mc0,@function
bm064_bn128_bk096_wm2_wn4_mc0: ; @bm064_bn128_bk096_wm2_wn4_mc0
; %bb.0:
...
.LBB0_18:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 3, v39 :: v_dual_mov_b32 v9, 0
	s_and_b32 s41, s29, s25
	s_and_not1_b32 vcc_lo, exec_lo, s17
	v_cndmask_b32_e64 v41, 0, 1, s41
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v8, v9 :: v_dual_bitop2_b32 v43, 32, v1 bitop3:0x40
...
; %bb.19:
	...
	v_mad_u32_u24 v10, 0x60, v4, v5
	s_add_co_i32 s4, s1, 0xcc00
	s_add_co_i32 s43, s1, 0x9900
	s_and_b32 s10, s4, 15
	s_mul_hi_i32 s6, s16, 0x2aaaaaab
	v_dual_lshrrev_b32 v7, 4, v10 :: v_dual_bitop2_b32 v6, v1, v3 bitop3:0x54
	s_sub_co_i32 s7, 16, s10
	s_mov_b32 s44, s5
	s_lshr_b32 s1, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_mad_u32_u24 v11, 0x60, v4, v6
	s_cselect_b32 s1, s1, 0
	v_and_b32_e32 v7, 0x3f8, v7
	s_lshl_b32 s10, s1, 2
	s_movk_i32 s1, 0x600
	v_lshrrev_b32_e32 v9, 4, v11
	v_mad_u32_u24 v8, 0x60, v4, s1
	v_dual_add_nc_u32 v34, v7, v10 :: v_dual_bitop2_b32 v12, 32, v3 bitop3:0x54
	s_lshr_b32 s7, s6, 31
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_and_b32_e32 v7, 0x7f8, v9
	v_dual_add_nc_u32 v5, v5, v8 :: v_dual_mov_b32 v37, 0
	s_ashr_i32 s45, s6, 4
	s_add_nc_u64 s[36:37], s[4:5], s[10:11]
	s_add_co_i32 s45, s45, s7
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v5, 4, v5 :: v_dual_add_nc_u32 v6, v6, v8
	v_or_b32_e32 v9, v2, v12
	s_cmp_lt_i32 s3, 0x80
	v_dual_mov_b32 v18, v37 :: v_dual_mov_b32 v19, v37
	v_dual_lshrrev_b32 v6, 4, v6 :: v_dual_add_nc_u32 v38, v7, v11
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_mad_u32_u24 v7, 0x60, v4, v9
	v_dual_add_nc_u32 v9, v9, v8 :: v_dual_bitop2_b32 v12, v12, v1 bitop3:0x54
	v_or_b32_e32 v3, 64, v3
	v_and_b32_e32 v13, 0x7f8, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v6, 4, v7 :: v_dual_lshrrev_b32 v7, 4, v9
	v_mad_u32_u24 v9, 0x60, v4, v12
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_nc_u32 v12, v12, v8 :: v_dual_bitop2_b32 v2, v2, v3 bitop3:0x54
	v_and_b32_e32 v14, 0x3f8, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v6, 4, v9 :: v_dual_bitop2_b32 v1, v1, v3 bitop3:0x54
	v_and_b32_e32 v36, 0x3f8, v7
	v_mad_u32_u24 v9, 0x60, v4, v2
	v_add_nc_u32_e32 v3, v2, v8
	v_lshrrev_b32_e32 v7, 4, v12
	v_and_b32_e32 v12, 0x7f8, v6
	v_mad_u32_u24 v4, 0x60, v4, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_dual_lshrrev_b32 v6, 4, v9 :: v_dual_lshrrev_b32 v3, 4, v3
	v_dual_add_nc_u32 v1, v1, v8 :: v_dual_lshrrev_b32 v40, 8, v35
	s_cselect_b32 s46, -1, 0
	v_and_b32_e32 v15, 0x3f8, v6
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v6, 4, v4 :: v_dual_lshrrev_b32 v1, 4, v1
	v_and_b32_e32 v4, 0x3f8, v3
	v_sub_nc_u32_e32 v3, 0x197f, v0
	s_lshl_b32 s4, s0, 7
	v_and_b32_e32 v16, 0x7f8, v6
	v_and_b32_e32 v6, 0x7f8, v1
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_nc_u32 v1, 2, v40 :: v_dual_lshrrev_b32 v3, 8, v3
	s_ashr_i32 s5, s4, 31
	s_lshl_b32 s0, s2, 6
	s_wait_kmcnt 0x0
	s_bfe_i64 s[6:7], s[20:21], 0x200000
	v_and_b32_e32 v5, 0x3f8, v5
	v_dual_add_nc_u32 v3, 1, v3 :: v_dual_bitop2_b32 v45, 30, v1 bitop3:0x40
	v_dual_mov_b32 v9, v37 :: v_dual_add_nc_u32 v8, 0x600, v10
	s_ashr_i32 s1, s0, 31
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_add_nc_u32 v35, -1, v40 :: v_dual_bitop2_b32 v49, 26, v3 bitop3:0x40
	s_mul_u64 s[4:5], s[6:7], s[4:5]
	s_bfe_i64 s[6:7], s[12:13], 0x200000
	s_lshl_b64 s[4:5], s[4:5], 1
	...
	v_cmp_ne_u32_e64 s0, v3, v49
	v_dual_add_nc_u32 v42, v5, v10 :: v_dual_add_nc_u32 v48, v14, v10
	v_add_nc_u64_e32 v[46:47], v[36:37], v[8:9]
	v_dual_mov_b32 v3, v37 :: v_dual_add_nc_u32 v36, 0x600, v11
	v_dual_mov_b32 v5, v37 :: v_dual_mov_b32 v7, v37
	v_lshl_or_b32 v17, v49, 8, v0
	v_or_b32_e32 v1, 0x100, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add_nc_u64_e32 v[52:53], v[2:3], v[36:37]
	v_add_nc_u64_e32 v[56:57], v[4:5], v[8:9]
	v_add_nc_u64_e32 v[60:61], v[6:7], v[36:37]
	v_dual_add_nc_u32 v44, v13, v11 :: v_dual_add_nc_u32 v50, v12, v11
	v_dual_add_nc_u32 v54, v15, v10 :: v_dual_add_nc_u32 v58, v16, v11
	v_dual_mov_b32 v4, v37 :: v_dual_add_nc_u32 v47, 0xffffff00, v17
	v_dual_mov_b32 v63, v37 :: v_dual_lshlrev_b32 v62, 2, v17
	v_dual_mov_b32 v2, v37 :: v_dual_mov_b32 v6, v37
	v_dual_mov_b32 v8, v37 :: v_dual_mov_b32 v20, v37
	v_dual_mov_b32 v21, v37 :: v_dual_mov_b32 v22, v37
	v_dual_mov_b32 v23, v37 :: v_dual_mov_b32 v24, v37
	v_dual_mov_b32 v25, v37 :: v_dual_mov_b32 v26, v37
	v_dual_mov_b32 v27, v37 :: v_dual_mov_b32 v28, v37
	v_dual_mov_b32 v29, v37 :: v_dual_mov_b32 v30, v37
	v_dual_mov_b32 v31, v37 :: v_dual_mov_b32 v32, v37
	v_dual_mov_b32 v33, v37 :: v_dual_mov_b32 v10, v37
	v_dual_mov_b32 v11, v37 :: v_dual_mov_b32 v12, v37
	v_dual_mov_b32 v13, v37 :: v_dual_mov_b32 v14, v37
	v_dual_mov_b32 v15, v37 :: v_dual_mov_b32 v16, v37
...
; %bb.25:                               ;   in Loop: Header=BB0_24 Depth=2
	...
	v_lshl_add_u64 v[66:67], v[36:37], 2, s[6:7]
	flat_store_b32 v[66:67], v37
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v36, v64 :: v_dual_add_nc_u32 v51, -2, v51
	v_dual_mov_b32 v66, v65 :: v_dual_mov_b32 v67, v37
	v_add_nc_u32_e32 v65, 0x200, v65
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[68:69], v[36:37], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v51
	v_add_nc_u32_e32 v64, 0x200, v64
	v_lshl_add_u64 v[66:67], v[66:67], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[68:69], v37
	flat_store_b32 v[66:67], v37
...
; %bb.31:                               ;   in Loop: Header=BB0_21 Depth=1
	v_add_nc_u64_e32 v[64:65], s[6:7], v[62:63]
...
.LBB0_32:                               ;   Parent Loop BB0_21 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[64:65], 0x400, v[64:65]
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v51, s2 :: v_dual_mov_b32 v64, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v51, s5 :: v_dual_mov_b32 v64, s6
	s_bitset1_b32 s7, 31
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	s_cmp_lg_u32 s50, 0
	s_cselect_b32 s1, s43, 0
	s_cselect_b32 s2, s36, s34
	v_lshl_add_u32 v36, v34, 1, s1
	v_lshl_add_u32 v51, v42, 1, s1
	v_lshl_add_u32 v53, v38, 1, s2
	v_lshl_add_u32 v55, v52, 1, s2
	ds_load_b128 v[64:67], v36
	ds_load_b128 v[68:71], v36 offset:16
	v_lshl_add_u32 v36, v44, 1, s2
	ds_load_b128 v[112:115], v55 offset:64
	ds_load_b128 v[116:119], v55 offset:80
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	ds_load_b128 v[88:91], v36 offset:3072
	ds_load_b128 v[92:95], v36 offset:3088
	v_lshl_add_u32 v36, v48, 1, s1
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[64:71], v[88:95], v[18:25] matrix_a_reuse
	ds_load_b128 v[72:75], v51 offset:3072
	ds_load_b128 v[76:79], v51 offset:3088
	ds_load_b128 v[80:83], v53
	ds_load_b128 v[84:87], v53 offset:16
	v_lshl_add_u32 v51, v46, 1, s1
	v_lshl_add_u32 v53, v50, 1, s2
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	ds_load_b128 v[96:99], v51 offset:64
	ds_load_b128 v[100:103], v51 offset:80
	ds_load_b128 v[104:107], v53 offset:64
	ds_load_b128 v[108:111], v53 offset:80
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[26:33], v[64:71], v[80:87], v[26:33]
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[72:79], v[80:87], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[72:79], v[88:95], v[10:17]
	ds_load_b128 v[72:75], v36 offset:64
	ds_load_b128 v[76:79], v36 offset:80
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v36, v54, 1, s1
	v_lshl_add_u32 v51, v60, 1, s2
	ds_load_b128 v[64:67], v36 offset:128
	ds_load_b128 v[68:71], v36 offset:144
	v_lshl_add_u32 v36, v56, 1, s1
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[72:79], v[104:111], v[26:33]
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	ds_load_b128 v[80:83], v36 offset:128
	ds_load_b128 v[84:87], v36 offset:144
	v_lshl_add_u32 v36, v58, 1, s2
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[72:79], v[112:119], v[18:25] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	ds_load_b128 v[72:75], v36 offset:128
	ds_load_b128 v[76:79], v36 offset:144
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[96:103], v[112:119], v[10:17]
	ds_load_b128 v[88:91], v51 offset:128
	ds_load_b128 v[92:95], v51 offset:144
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[96:103], v[104:111], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[26:33], v[64:71], v[72:79], v[26:33]
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	s_wait_dscnt 0x0
	...
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[10:17], v[80:87], v[88:95], v[10:17]
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(2) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[80:87], v[72:79], v[2:9] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.43:
	...
	v_add_nc_u32_e32 v20, 0x410, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_lshlrev_b32 v1, 1, v1 :: v_dual_lshrrev_b32 v6, 3, v18
	v_dual_lshrrev_b32 v7, 3, v19 :: v_dual_lshrrev_b32 v20, 3, v20
	v_and_b32_e32 v19, 0x370, v35
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_and_b32_e32 v6, 0x3f0, v6
	v_and_b32_e32 v21, 0x3f0, v7
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_and_b32_e32 v4, 0x7f0, v20
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v19, v19, v1 :: v_dual_add_nc_u32 v20, v6, v1
	v_add_nc_u32_e32 v1, v21, v1
	v_cvt_pk_bf16_f32 v6, v2, v3
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_add_u32 v18, v18, 1, v4
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn128_bk096_wm2_wn4_mc0, .Lfunc_end0-bm064_bn128_bk096_wm2_wn4_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn128_bk096_wm2_wn4_mc0
	...
	.section	.text.bm064_bn128_bk096_wm2_wn4_mc0,"axG",@progbits,bm064_bn128_bk096_wm2_wn4_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn128_bk096_wm2_wn4_mc0.num_vgpr, 120
	.set .Lbm064_bn128_bk096_wm2_wn4_mc0.num_agpr, 0
	.set .Lbm064_bn128_bk096_wm2_wn4_mc0.numbered_sgpr, 56
	.set .Lbm064_bn128_bk096_wm2_wn4_mc0.num_named_barrier, 0
	.set .Lbm064_bn128_bk096_wm2_wn4_mc0.private_seg_size, 0
	.set .Lbm064_bn128_bk096_wm2_wn4_mc0.uses_vcc, 1
	.set .Lbm064_bn128_bk096_wm2_wn4_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn128_bk096_wm2_wn4_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn128_bk096_wm2_wn4_mc0.has_recursion, 0
	.set .Lbm064_bn128_bk096_wm2_wn4_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_4b4ebf49e922870c,@object ; @__hip_cuid_4b4ebf49e922870c
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_4b4ebf49e922870c
__hip_cuid_4b4ebf49e922870c:
	.byte	0                               ; 0x0
	.size	__hip_cuid_4b4ebf49e922870c, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_4b4ebf49e922870c
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn128_bk096_wm2_wn4_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn128_bk096_wm2_wn4_mc0.kd
