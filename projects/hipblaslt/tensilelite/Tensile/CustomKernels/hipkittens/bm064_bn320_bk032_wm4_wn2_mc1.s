	...
	.section	.text.bm064_bn320_bk032_wm4_wn2_mc1,"axG",@progbits,bm064_bn320_bk032_wm4_wn2_mc1,comdat
	.protected	bm064_bn320_bk032_wm4_wn2_mc1 ; -- Begin function bm064_bn320_bk032_wm4_wn2_mc1
	.globl	bm064_bn320_bk032_wm4_wn2_mc1
	.p2align	8
	.type	bm064_bn320_bk032_wm4_wn2_mc1,@function
bm064_bn320_bk032_wm4_wn2_mc1: ; @bm064_bn320_bk032_wm4_wn2_mc1
; %bb.0:
...
.LBB0_10:                               ; =>This Inner Loop Header: Depth=1
	...
	v_cmp_lt_u32_e32 vcc_lo, 0x143f, v2
...
.LBB0_12:
	...
	s_or_b32 s38, s1, 0x1100
	s_add_co_i32 s18, s7, -1
	s_min_i32 s17, s33, s8
	s_and_b32 s19, s16, 3
	s_lshl_b32 s0, 15, s0
...
.LBB0_20:
	...
	v_dual_lshlrev_b32 v1, 3, v89 :: v_dual_mov_b32 v9, 0
	v_and_b32_e32 v82, 32, v0
	s_and_b32 s43, s35, s29
	s_mov_b32 s11, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v7, v9 :: v_dual_bitop2_b32 v91, 48, v1 bitop3:0x40
	v_mov_b32_e32 v8, v9
	...
	v_dual_mov_b32 v74, v9 :: v_dual_mov_b32 v33, v9
	...
	v_cndmask_b32_e64 v93, 0, 0xa0, vcc_lo
...
; %bb.21:
	...
	v_dual_lshlrev_b32 v1, 5, v93 :: v_dual_lshlrev_b32 v2, 5, v91
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s1, 0x6600
	s_delay_alu instid0(VALU_DEP_2)
	...
	v_dual_lshrrev_b32 v5, 4, v2 :: v_dual_lshrrev_b32 v4, 4, v3
	v_or_b32_e32 v6, 0x800, v3
	s_cmp_lg_u64 s[6:7], 0
	s_mul_i32 s6, s17, 0x140
	v_and_b32_e32 v1, 0x78, v5
	s_cselect_b32 s4, s4, 0
	s_mov_b32 s8, 64
	s_lshl2_add_u32 s1, s4, s1
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v85, 0 :: v_dual_add_nc_u32 v82, v1, v2
	v_or_b32_e32 v1, 0x200, v3
	v_and_b32_e32 v2, 0x158, v4
	v_dual_mov_b32 v109, v85 :: v_dual_add_nc_u32 v4, 0x400, v3
	v_add_nc_u32_e32 v5, 0x600, v3
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_lshrrev_b32 v1, 4, v1 :: v_dual_add_nc_u32 v86, v2, v3
	v_lshrrev_b32_e32 v2, 4, v4
	v_add_nc_u32_e32 v7, 0xc00, v3
	v_add_nc_u32_e32 v8, 0xe00, v3
	v_add_nc_u32_e32 v9, 0x1000, v3
	v_add_nc_u32_e32 v10, 0x1200, v3
	v_and_b32_e32 v2, 0x3f8, v2
	s_add_co_i32 s4, s1, 0x7700
	s_add_co_i32 s45, s1, 0x6600
	s_and_b32 s10, s4, 15
	v_dual_mov_b32 v15, v85 :: v_dual_mov_b32 v16, v85
	v_dual_add_nc_u32 v92, v2, v3 :: v_dual_mov_b32 v2, v85
	v_dual_lshrrev_b32 v4, 4, v5 :: v_dual_lshrrev_b32 v5, 4, v6
	v_and_b32_e32 v6, 0x1f8, v1
	v_or_b32_e32 v1, 0xa00, v3
	s_sub_co_i32 s7, 16, s10
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_and_b32_e32 v4, 0x3f8, v4
	s_lshr_b32 s1, s7, 2
	v_dual_add_nc_u32 v90, v6, v3 :: v_dual_lshrrev_b32 v1, 4, v1
	v_and_b32_e32 v5, 0x1f8, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_add_nc_u32 v94, v4, v3 :: v_dual_mov_b32 v4, v85
	v_lshrrev_b32_e32 v7, 4, v7
	v_and_b32_e32 v11, 0x1f8, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_lshrrev_b32 v1, 4, v8 :: v_dual_add_nc_u32 v96, v5, v3
	v_mov_b32_e32 v5, v85
	v_and_b32_e32 v7, 0x3f8, v7
	v_dual_mov_b32 v6, v85 :: v_dual_lshrrev_b32 v8, 4, v9
	v_lshrrev_b32_e32 v9, 4, v10
	v_sub_nc_u32_e32 v10, 0x153f, v0
	v_and_b32_e32 v12, 0x3f8, v1
	s_cmp_lg_u64 s[10:11], 0
	v_and_b32_e32 v8, 0x3f8, v8
	v_dual_mov_b32 v7, v85 :: v_dual_add_nc_u32 v100, v7, v3
	v_dual_lshrrev_b32 v1, 8, v10 :: v_dual_lshrrev_b32 v88, 8, v83
	s_cselect_b32 s1, s1, 0
	s_ashr_i32 s7, s12, 31
	s_lshl_b32 s10, s1, 2
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_dual_add_nc_u32 v10, 1, v1 :: v_dual_add_nc_u32 v1, 2, v88
	s_lshr_b32 s7, s7, 27
	v_and_b32_e32 v9, 0x3f8, v9
	s_add_co_i32 s12, s12, s7
	v_dual_add_nc_u32 v98, v11, v3 :: v_dual_bitop2_b32 v95, 22, v10 bitop3:0x40
	s_ashr_i32 s47, s12, 5
	s_cmp_lt_i32 s3, 0x140
	v_dual_add_nc_u32 v102, v12, v3 :: v_dual_bitop2_b32 v97, 14, v1 bitop3:0x40
	s_cselect_b32 s48, -1, 0
	s_ashr_i32 s7, s6, 31
	s_lshl_b32 s18, s18, 6
	s_wait_kmcnt 0x0
	s_bfe_i64 s[20:21], s[20:21], 0x200000
	v_lshl_or_b32 v13, v95, 8, v0
	...
	v_cmp_ne_u32_e64 s1, v10, v95
	v_dual_add_nc_u32 v104, v8, v3 :: v_dual_add_nc_u32 v106, v9, v3
	v_lshlrev_b32_e32 v108, 2, v13
	v_dual_mov_b32 v8, v85 :: v_dual_add_nc_u32 v99, 0xffffff00, v13
	v_dual_mov_b32 v3, v85 :: v_dual_mov_b32 v9, v85
	v_dual_mov_b32 v10, v85 :: v_dual_mov_b32 v11, v85
	v_dual_mov_b32 v12, v85 :: v_dual_mov_b32 v13, v85
	v_dual_mov_b32 v14, v85 :: v_dual_mov_b32 v17, v85
	...
	s_add_nc_u64 s[20:21], s[26:27], s[24:25]
...
; %bb.27:                               ;   in Loop: Header=BB0_26 Depth=2
	...
	v_lshl_add_u64 v[112:113], v[84:85], 2, s[14:15]
	flat_store_b32 v[112:113], v85
...
.LBB0_31:                               ;   Parent Loop BB0_23 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v84, v110 :: v_dual_add_nc_u32 v101, -2, v101
	v_dual_mov_b32 v112, v111 :: v_dual_mov_b32 v113, v85
	v_add_nc_u32_e32 v111, 0x200, v111
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[114:115], v[84:85], 2, s[6:7]
...
; %bb.33:                               ;   in Loop: Header=BB0_23 Depth=1
	v_add_nc_u64_e32 v[110:111], s[6:7], v[108:109]
...
.LBB0_34:                               ;   Parent Loop BB0_23 Depth=1
	...
	flat_store_b32 v[110:111], v85
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[110:111], 0x400, v[110:111]
...
.LBB0_39:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_lshl_add_u32 v101, v86, 1, s5
	v_lshl_add_u32 v103, v90, 1, s5
	ds_load_b128 v[110:113], v84
	ds_load_b128 v[114:117], v84 offset:16
	v_lshl_add_u32 v84, v92, 1, s5
	ds_load_b128 v[118:121], v101
	ds_load_b128 v[122:125], v101 offset:16
	ds_load_b128 v[126:129], v103 offset:1024
	ds_load_b128 v[130:133], v103 offset:1040
	ds_load_b128 v[134:137], v84 offset:2048
	ds_load_b128 v[138:141], v84 offset:2064
	v_lshl_add_u32 v84, v94, 1, s5
	v_lshl_add_u32 v101, v106, 1, s5
	ds_load_b128 v[142:145], v84 offset:3072
	ds_load_b128 v[146:149], v84 offset:3088
	v_lshl_add_u32 v84, v96, 1, s5
	ds_load_b128 v[150:153], v84 offset:4096
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[74:81], v[110:117], v[118:125], v[74:81]
	; sched_group_barrier mask(0x00000100) size(11) SyncID(0)
	s_wait_dscnt 0x5
	v_wmma_f32_16x16x32_bf16 v[66:73], v[110:117], v[126:133], v[66:73] matrix_a_reuse
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[58:65], v[110:117], v[134:141], v[58:65] matrix_a_reuse
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[42:49], v[110:117], v[142:149], v[42:49] matrix_a_reuse
	ds_load_b128 v[118:121], v101 offset:9216
	ds_load_b128 v[122:125], v101 offset:9232
	ds_load_b128 v[154:157], v84 offset:4112
	v_lshl_add_u32 v84, v100, 1, s5
	v_lshl_add_u32 v101, v98, 1, s5
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	ds_load_b128 v[126:129], v84 offset:6144
	ds_load_b128 v[130:133], v84 offset:6160
	v_lshl_add_u32 v84, v102, 1, s5
	ds_load_b128 v[134:137], v84 offset:7168
	ds_load_b128 v[138:141], v84 offset:7184
	v_lshl_add_u32 v84, v104, 1, s5
	ds_load_b128 v[142:145], v84 offset:8192
	ds_load_b128 v[146:149], v84 offset:8208
	s_wait_dscnt 0x7
	v_wmma_f32_16x16x32_bf16 v[50:57], v[110:117], v[118:125], v[50:57] matrix_a_reuse
	ds_load_b128 v[118:121], v101 offset:5120
	ds_load_b128 v[122:125], v101 offset:5136
	; sched_group_barrier mask(0x00000100) size(11) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[18:25], v[110:117], v[150:157], v[18:25] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[110:117], v[118:125], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[110:117], v[126:133], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[110:117], v[134:141], v[26:33] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(5) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[110:117], v[142:149], v[34:41] matrix_a_reuse
...
; %bb.43:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v101, s13 :: v_dual_mov_b32 v110, s14
...
.LBB0_45:                               ;   in Loop: Header=BB0_23 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v101, s5 :: v_dual_mov_b32 v110, s6
	s_bitset1_b32 s7, 31
	v_readfirstlane_b32 s52, v84
...
; %bb.47:
	...
	v_dual_lshlrev_b32 v66, 1, v1 :: v_dual_lshrrev_b32 v61, 3, v67
	...
	v_dual_lshrrev_b32 v67, 3, v67 :: v_dual_add_nc_u32 v58, v58, v66
	...
	ds_store_b128 v22, v[14:17] offset:10240
	ds_store_b128 v23, v[6:9] offset:12288
	ds_store_b128 v24, v[2:5] offset:14336
	ds_store_b128 v25, v[10:13] offset:16384
	ds_store_b128 v1, v[18:21] offset:18432
.LBB0_48:
...
.LBB0_59:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn320_bk032_wm4_wn2_mc1, .Lfunc_end0-bm064_bn320_bk032_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn320_bk032_wm4_wn2_mc1
	...
	.section	.text.bm064_bn320_bk032_wm4_wn2_mc1,"axG",@progbits,bm064_bn320_bk032_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn320_bk032_wm4_wn2_mc1.num_vgpr, 158
	.set .Lbm064_bn320_bk032_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm064_bn320_bk032_wm4_wn2_mc1.numbered_sgpr, 56
	.set .Lbm064_bn320_bk032_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm064_bn320_bk032_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm064_bn320_bk032_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm064_bn320_bk032_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm064_bn320_bk032_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn320_bk032_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm064_bn320_bk032_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_ba8f2d1b30e32603,@object ; @__hip_cuid_ba8f2d1b30e32603
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_ba8f2d1b30e32603
__hip_cuid_ba8f2d1b30e32603:
	.byte	0                               ; 0x0
	.size	__hip_cuid_ba8f2d1b30e32603, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_ba8f2d1b30e32603
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn320_bk032_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn320_bk032_wm4_wn2_mc1.kd
