	...
	.section	.text.bm064_bn256_bk064_wm1_wn8_mc0,"axG",@progbits,bm064_bn256_bk064_wm1_wn8_mc0,comdat
	.protected	bm064_bn256_bk064_wm1_wn8_mc0 ; -- Begin function bm064_bn256_bk064_wm1_wn8_mc0
	.globl	bm064_bn256_bk064_wm1_wn8_mc0
	.p2align	8
	.type	bm064_bn256_bk064_wm1_wn8_mc0,@function
bm064_bn256_bk064_wm1_wn8_mc0: ; @bm064_bn256_bk064_wm1_wn8_mc0
; %bb.0:
...
; %bb.1:
	...
	s_or_b32 s2, s4, s2
.LBB0_2:
	v_sub_nc_u32_e32 v69, 0x87f, v0
	v_lshlrev_b32_e32 v66, 2, v0
	s_and_not1_b32 vcc_lo, exec_lo, s2
	s_cbranch_vccnz .LBB0_12
; %bb.3:
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_dual_mov_b32 v3, 0 :: v_dual_lshrrev_b32 v2, 8, v69
	s_mov_b32 s4, 0
	s_mov_b32 s11, 0
	v_dual_mov_b32 v5, v66 :: v_dual_add_nc_u32 v4, 2, v2
...
.LBB0_18:
	...
	s_barrier_signal -1
	v_dual_mov_b32 v9, 0 :: v_dual_lshlrev_b32 v75, 6, v0
...
; %bb.19:
	v_and_b32_e32 v1, 0x3c0, v75
	s_mov_b64 s[4:5], src_shared_base
	s_or_b32 s6, s35, 0xaa00
	s_mov_b32 s7, s5
	v_dual_mov_b32 v67, 0 :: v_dual_bitop2_b32 v3, 56, v66 bitop3:0x40
	...
	s_lshr_b32 s4, s4, 2
	v_and_or_b32 v4, 0x3800, v75, v2
	s_cmp_lg_u64 s[6:7], 0
	v_add_nc_u32_e32 v68, v3, v2
	...
	s_and_b32 s10, s4, 15
	s_mov_b32 s11, 0
	v_and_b32_e32 v3, 0x3b8, v3
	s_sub_co_i32 s7, 16, s10
	s_add_co_i32 s42, s6, 0xaa00
	s_lshr_b32 s6, s7, 2
	s_cmp_lg_u64 s[10:11], 0
	v_dual_lshrrev_b32 v5, 4, v5 :: v_dual_lshrrev_b32 v6, 4, v6
	v_dual_lshrrev_b32 v7, 4, v7 :: v_dual_lshrrev_b32 v1, 4, v1
	v_dual_add_nc_u32 v70, v3, v4 :: v_dual_lshrrev_b32 v72, 8, v69
	...
	v_dual_add_nc_u32 v7, 2, v72 :: v_dual_mov_b32 v69, v72
	s_lshl_b32 s10, s6, 2
	...
	s_lshl_b32 s4, s0, 8
	s_lshl_b32 s6, s2, 6
	v_dual_add_nc_u32 v74, v5, v2 :: v_dual_bitop2_b32 v77, 30, v7 bitop3:0x40
	v_dual_add_nc_u32 v76, v6, v2 :: v_dual_add_nc_u32 v78, v1, v2
	v_dual_mov_b32 v91, v67 :: v_dual_add_nc_u32 v80, v4, v3
	s_mov_b32 s43, s5
	s_ashr_i32 s5, s4, 31
	s_ashr_i32 s7, s6, 31
	s_wait_kmcnt 0x0
	...
	v_dual_mov_b32 v3, v67 :: v_dual_add_nc_u32 v82, 0x400, v74
	v_or_b32_e32 v84, 0x800, v76
	v_dual_mov_b32 v5, v67 :: v_dual_add_nc_u32 v86, 0xc00, v78
	v_dual_mov_b32 v7, v67 :: v_dual_add_nc_u32 v88, 0x400, v80
	v_or_b32_e32 v79, 0x2100, v0
	v_or_b32_e32 v90, 0x8800, v66
	v_dual_mov_b32 v2, v67 :: v_dual_mov_b32 v4, v67
	v_dual_mov_b32 v6, v67 :: v_dual_mov_b32 v8, v67
	...
	v_dual_mov_b32 v33, v67 :: v_dual_mov_b32 v42, v67
	...
	v_dual_mov_b32 v49, v67 :: v_dual_mov_b32 v50, v67
	...
	v_dual_mov_b32 v65, v67 :: v_dual_mov_b32 v34, v67
...
.LBB0_24:                               ;   Parent Loop BB0_21 Depth=1
	...
	v_cmp_le_u32_e32 vcc_lo, s15, v69
	v_cmpx_le_u32_e64 s14, v72
	s_cbranch_execz .LBB0_26
; %bb.25:                               ;   in Loop: Header=BB0_24 Depth=2
	v_mov_b32_e32 v66, v92
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_add_u64 v[94:95], v[66:67], 2, s[12:13]
...
.LBB0_29:                               ;   Parent Loop BB0_21 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	v_dual_mov_b32 v66, v92 :: v_dual_add_nc_u32 v81, -2, v81
	v_dual_mov_b32 v94, v93 :: v_dual_mov_b32 v95, v67
	v_add_nc_u32_e32 v93, 0x200, v93
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[96:97], v[66:67], 2, s[6:7]
	v_cmp_eq_u32_e32 vcc_lo, 0, v81
	v_add_nc_u32_e32 v92, 0x200, v92
	v_lshl_add_u64 v[94:95], v[94:95], 2, s[6:7]
	s_clause 0x1
	flat_store_b32 v[96:97], v67
	flat_store_b32 v[94:95], v67
...
; %bb.38:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v81, s14 :: v_dual_mov_b32 v92, s12
...
.LBB0_40:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_nop
	v_nop
	v_dual_mov_b32 v81, s5 :: v_dual_mov_b32 v92, s6
	...
	v_readfirstlane_b32 s14, v92
	s_lshr_b64 s[6:7], s[30:31], 16
	v_readfirstlane_b32 s12, v66
...
.LBB0_41:                               ;   in Loop: Header=BB0_21 Depth=1
	...
	v_lshl_add_u32 v66, v68, 1, s0
	v_lshl_add_u32 v81, v74, 1, s0
	v_lshl_add_u32 v83, v80, 1, s2
	v_lshl_add_u32 v85, v84, 1, s0
	v_lshl_add_u32 v87, v86, 1, s0
	ds_load_b128 v[92:95], v66
	ds_load_b128 v[96:99], v66 offset:16
	ds_load_b128 v[100:103], v81 offset:2048
	ds_load_b128 v[108:111], v83 offset:2048
	ds_load_b128 v[112:115], v83 offset:2064
	ds_load_b128 v[104:107], v81 offset:2064
	v_lshl_add_u32 v81, v76, 1, s0
	v_lshl_add_u32 v83, v82, 1, s0
	v_lshl_add_u32 v89, v88, 1, s2
	ds_load_b128 v[140:143], v87 offset:64
	ds_load_b128 v[144:147], v87 offset:80
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	s_wait_dscnt 0x3
	v_wmma_f32_16x16x32_bf16 v[50:57], v[92:99], v[108:115], v[50:57] matrix_b_reuse
	ds_load_b128 v[132:135], v83 offset:64
	ds_load_b128 v[136:139], v83 offset:80
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[26:33], v[100:107], v[108:115], v[26:33] matrix_b_reuse
	ds_load_b128 v[116:119], v81 offset:4096
	ds_load_b128 v[120:123], v81 offset:4112
	v_lshl_add_u32 v81, v78, 1, s0
	ds_load_b128 v[124:127], v81 offset:6144
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[10:17], v[116:123], v[108:115], v[10:17] matrix_b_reuse
	ds_load_b128 v[128:131], v81 offset:6160
	v_lshl_add_u32 v81, v70, 1, s2
	ds_load_b128 v[148:151], v81 offset:64
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[34:41], v[124:131], v[108:115], v[34:41] matrix_a_reuse
	ds_load_b128 v[108:111], v81
	ds_load_b128 v[112:115], v81 offset:16
	ds_load_b128 v[152:155], v81 offset:80
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[58:65], v[92:99], v[108:115], v[58:65]
	ds_load_b128 v[92:95], v89 offset:64
	ds_load_b128 v[96:99], v89 offset:80
	v_wmma_f32_16x16x32_bf16 v[42:49], v[100:107], v[108:115], v[42:49] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[124:131], v[108:115], v[2:9] matrix_b_reuse
	ds_load_b128 v[124:127], v85 offset:64
	ds_load_b128 v[128:131], v85 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[116:123], v[108:115], v[18:25] matrix_b_reuse
	ds_load_b128 v[116:119], v66 offset:64
	ds_load_b128 v[120:123], v66 offset:80
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[116:123], v[148:155], v[58:65]
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[42:49], v[132:139], v[148:155], v[42:49] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[124:131], v[148:155], v[18:25] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[2:9], v[140:147], v[148:155], v[2:9] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[34:41], v[140:147], v[92:99], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[124:131], v[92:99], v[10:17] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(3) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[26:33], v[132:139], v[92:99], v[26:33] matrix_b_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[116:123], v[92:99], v[50:57] matrix_b_reuse
	; sched_group_barrier mask(0x00000008) size(2) SyncID(0)
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
	s_wait_dscnt 0
...
; %bb.43:
	...
	ds_store_b128 v26, v[30:33] offset:32
	ds_store_b128 v26, v[14:17] offset:64
...
.LBB0_55:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn256_bk064_wm1_wn8_mc0, .Lfunc_end0-bm064_bn256_bk064_wm1_wn8_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn256_bk064_wm1_wn8_mc0
	...
	.section	.text.bm064_bn256_bk064_wm1_wn8_mc0,"axG",@progbits,bm064_bn256_bk064_wm1_wn8_mc0,comdat
                                        ; -- End function
	.set .Lbm064_bn256_bk064_wm1_wn8_mc0.num_vgpr, 156
	.set .Lbm064_bn256_bk064_wm1_wn8_mc0.num_agpr, 0
	.set .Lbm064_bn256_bk064_wm1_wn8_mc0.numbered_sgpr, 56
	.set .Lbm064_bn256_bk064_wm1_wn8_mc0.num_named_barrier, 0
	.set .Lbm064_bn256_bk064_wm1_wn8_mc0.private_seg_size, 0
	.set .Lbm064_bn256_bk064_wm1_wn8_mc0.uses_vcc, 1
	.set .Lbm064_bn256_bk064_wm1_wn8_mc0.uses_flat_scratch, 1
	.set .Lbm064_bn256_bk064_wm1_wn8_mc0.has_dyn_sized_stack, 0
	.set .Lbm064_bn256_bk064_wm1_wn8_mc0.has_recursion, 0
	.set .Lbm064_bn256_bk064_wm1_wn8_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_22eeb5f1e41bb27,@object ; @__hip_cuid_22eeb5f1e41bb27
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_22eeb5f1e41bb27
__hip_cuid_22eeb5f1e41bb27:
	.byte	0                               ; 0x0
	.size	__hip_cuid_22eeb5f1e41bb27, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_22eeb5f1e41bb27
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn256_bk064_wm1_wn8_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm064_bn256_bk064_wm1_wn8_mc0.kd
