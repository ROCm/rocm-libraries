	...
	.section	.text.bm064_bn096_bk128_wm4_wn2_mc1,"axG",@progbits,bm064_bn096_bk128_wm4_wn2_mc1,comdat
	.protected	bm064_bn096_bk128_wm4_wn2_mc1 ; -- Begin function bm064_bn096_bk128_wm4_wn2_mc1
	.globl	bm064_bn096_bk128_wm4_wn2_mc1
	.p2align	8
	.type	bm064_bn096_bk128_wm4_wn2_mc1,@function
bm064_bn096_bk128_wm4_wn2_mc1: ; @bm064_bn096_bk128_wm4_wn2_mc1
; %bb.0:
...
.LBB0_16:
	...
	v_dual_lshlrev_b32 v1, 3, v27 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s43, s3, s29
	s_mov_b32 s11, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v33, 48, v1
	v_cmp_ne_u32_e32 vcc_lo, 0, v2
	v_cndmask_b32_e64 v31, 0, 1, s43
	v_dual_mov_b32 v8, v9 :: v_dual_mov_b32 v7, v9
	v_dual_mov_b32 v6, v9 :: v_dual_mov_b32 v5, v9
	v_cndmask_b32_e64 v35, 0, 48, vcc_lo
...
; %bb.17:
	...
	v_dual_lshlrev_b32 v2, 7, v35 :: v_dual_lshlrev_b32 v1, 7, v33
	s_or_b32 s6, s1, 0xaa00
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v3, 0x780, v3
	s_mov_b32 s7, s5
	v_or_b32_e32 v44, 0xf00, v0
	s_and_b64 s[6:7], s[6:7], 15
	v_lshl_or_b32 v38, v0, 2, 0x4000
	v_and_or_b32 v4, v0, 16, v3
	s_sub_co_i32 s4, 16, s6
	v_dual_mov_b32 v29, 0 :: v_dual_bitop2_b32 v3, v3, v1 bitop3:0x54
	s_lshr_b32 s4, s4, 2
	...
	s_add_co_i32 s4, s1, 0xee00
	s_delay_alu instid0(VALU_DEP_1)
	v_and_b32_e32 v8, 0x1f8, v8
	v_and_b32_e32 v7, 0x1f8, v7
	s_and_b32 s10, s4, 15
	s_add_co_i32 s45, s1, 0xaa00
	s_sub_co_i32 s7, 16, s10
	v_add3_u32 v34, v4, v2, v8
	v_dual_add_nc_u32 v26, v7, v5 :: v_dual_mov_b32 v2, v29
	v_dual_add_nc_u32 v30, v8, v6 :: v_dual_lshrrev_b32 v5, 8, v9
	s_lshr_b32 s1, s7, 2
	...
	v_dual_mov_b32 v39, v29 :: v_dual_add_nc_u32 v6, v4, v1
	s_ashr_i32 s47, s12, 7
	v_and_b32_e32 v37, 26, v5
	s_cmp_lt_i32 s37, 0x60
	s_add_nc_u64 s[40:41], s[4:5], s[10:11]
	s_cselect_b32 s48, -1, 0
	s_ashr_i32 s7, s6, 31
	s_lshl_b32 s52, s19, 6
	s_or_b32 s4, s18, 0x7510000
	s_wait_kmcnt 0x0
	s_bfe_i64 s[18:19], s[20:21], 0x200000
	v_add_nc_u32_e32 v32, v3, v6
	s_mul_u64 s[6:7], s[18:19], s[6:7]
	v_lshl_or_b32 v9, v37, 8, v0
	...
	v_cmp_ne_u32_e64 s1, v5, v37
	v_dual_add_nc_u32 v36, v7, v6 :: v_dual_lshlrev_b32 v40, 2, v9
	v_dual_mov_b32 v4, v29 :: v_dual_add_nc_u32 v45, 0xffffff00, v9
	v_dual_mov_b32 v41, v29 :: v_dual_mov_b32 v3, v29
...
.LBB0_21:                               ;   Parent Loop BB0_19 Depth=1
	...
	v_dual_mov_b32 v28, v42 :: v_dual_add_nc_u32 v46, -2, v46
	v_dual_mov_b32 v48, v43 :: v_dual_mov_b32 v49, v29
...
.LBB0_24:                               ;   Parent Loop BB0_19 Depth=1
	...
	flat_store_b32 v[42:43], v29
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[42:43], 0x400, v[42:43]
	v_cmp_lt_u32_e32 vcc_lo, 0xfff, v28
...
.LBB0_29:                               ;   Parent Loop BB0_19 Depth=1
	...
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[42:43], 0x400, v[42:43]
	v_cmp_lt_u32_e32 vcc_lo, 0x187f, v28
	s_or_b32 s6, vcc_lo, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_and_not1_b32 exec_lo, exec_lo, s6
...
.LBB0_34:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_cselect_b32 s6, s40, s38
	v_lshl_add_u32 v28, v26, 1, s5
	v_lshl_add_u32 v42, v30, 1, s6
	v_lshl_add_u32 v43, v34, 1, s6
	ds_load_b128 v[46:49], v28
	ds_load_b128 v[50:53], v28 offset:16
	ds_load_b128 v[54:57], v42
	ds_load_b128 v[58:61], v42 offset:16
	ds_load_b128 v[62:65], v42 offset:4352
	ds_load_b128 v[66:69], v42 offset:4368
	ds_load_b128 v[70:73], v42 offset:8704
	ds_load_b128 v[74:77], v42 offset:8720
	v_lshl_add_u32 v28, v32, 1, s5
	ds_load_b128 v[78:81], v43 offset:64
	ds_load_b128 v[82:85], v43 offset:80
	ds_load_b128 v[86:89], v43 offset:4416
	ds_load_b128 v[90:93], v43 offset:4432
	ds_load_b128 v[94:97], v43 offset:8768
	ds_load_b128 v[98:101], v43 offset:8784
	; sched_group_barrier mask(0x00000100) size(8) SyncID(0)
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[18:25], v[46:53], v[54:61], v[18:25]
	ds_load_b128 v[54:57], v28 offset:64
	ds_load_b128 v[58:61], v28 offset:80
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[2:9], v[46:53], v[62:69], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[10:17], v[46:53], v[70:77], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v28, v36, 1, s5
	ds_load_b128 v[46:49], v43 offset:128
	ds_load_b128 v[50:53], v43 offset:144
	ds_load_b128 v[62:65], v43 offset:4480
	ds_load_b128 v[66:69], v43 offset:4496
	ds_load_b128 v[70:73], v28 offset:128
	ds_load_b128 v[74:77], v28 offset:144
	ds_load_b128 v[102:105], v43 offset:8832
	ds_load_b128 v[106:109], v43 offset:8848
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[18:25], v[54:61], v[78:85], v[18:25]
	; sched_group_barrier mask(0x00000100) size(8) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[54:61], v[86:93], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[54:61], v[94:101], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[54:57], v28 offset:192
	ds_load_b128 v[58:61], v28 offset:208
	ds_load_b128 v[78:81], v43 offset:192
	ds_load_b128 v[82:85], v43 offset:208
	ds_load_b128 v[86:89], v43 offset:4544
	ds_load_b128 v[90:93], v43 offset:4560
	ds_load_b128 v[94:97], v43 offset:8896
	ds_load_b128 v[98:101], v43 offset:8912
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[18:25], v[70:77], v[46:53], v[18:25]
	; sched_group_barrier mask(0x00000100) size(8) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[70:77], v[62:69], v[2:9] matrix_a_reuse
	s_wait_dscnt 0x8
...
; %bb.38:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	v_dual_mov_b32 v43, s13 :: v_dual_mov_b32 v42, s14
	s_and_b32 s10, s15, 0x1ffffff
	s_and_b32 s13, s29, s17
	s_bitset1_b32 s10, 31
	v_cndmask_b32_e64 v28, 0, 1, s13
	v_mov_b32_e32 v47, s10
	v_readfirstlane_b32 s57, v43
	v_readfirstlane_b32 s58, v42
	s_lshr_b64 s[14:15], s[36:37], 16
	v_readfirstlane_b32 s56, v28
	v_readfirstlane_b32 s59, v47
...
.LBB0_40:                               ;   in Loop: Header=BB0_19 Depth=1
	...
	s_and_b32 s7, s7, 0x1ffffff
	v_dual_mov_b32 v43, s5 :: v_dual_mov_b32 v42, s6
	s_bitset1_b32 s7, 31
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_readfirstlane_b32 s52, v28
	v_mov_b32_e32 v47, s7
	v_readfirstlane_b32 s53, v43
...
; %bb.42:
	...
	v_and_or_b32 v26, v0, 15, v35
	v_nop
	v_cvt_pk_bf16_f32 v9, v8, v9
	v_cvt_pk_bf16_f32 v8, v6, v7
	v_cvt_pk_bf16_f32 v7, v4, v5
	v_and_or_b32 v1, v1, 8, v33
...
.LBB0_54:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm064_bn096_bk128_wm4_wn2_mc1, .Lfunc_end0-bm064_bn096_bk128_wm4_wn2_mc1
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm064_bn096_bk128_wm4_wn2_mc1
	...
	.section	.text.bm064_bn096_bk128_wm4_wn2_mc1,"axG",@progbits,bm064_bn096_bk128_wm4_wn2_mc1,comdat
                                        ; -- End function
	.set .Lbm064_bn096_bk128_wm4_wn2_mc1.num_vgpr, 110
	.set .Lbm064_bn096_bk128_wm4_wn2_mc1.num_agpr, 0
	.set .Lbm064_bn096_bk128_wm4_wn2_mc1.numbered_sgpr, 60
	.set .Lbm064_bn096_bk128_wm4_wn2_mc1.num_named_barrier, 0
	.set .Lbm064_bn096_bk128_wm4_wn2_mc1.private_seg_size, 0
	.set .Lbm064_bn096_bk128_wm4_wn2_mc1.uses_vcc, 1
	.set .Lbm064_bn096_bk128_wm4_wn2_mc1.uses_flat_scratch, 1
	.set .Lbm064_bn096_bk128_wm4_wn2_mc1.has_dyn_sized_stack, 0
	.set .Lbm064_bn096_bk128_wm4_wn2_mc1.has_recursion, 0
	.set .Lbm064_bn096_bk128_wm4_wn2_mc1.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_4110ad376be76adf,@object ; @__hip_cuid_4110ad376be76adf
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_4110ad376be76adf
__hip_cuid_4110ad376be76adf:
	.byte	0                               ; 0x0
	.size	__hip_cuid_4110ad376be76adf, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_4110ad376be76adf
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm064_bn096_bk128_wm4_wn2_mc1
    .private_segment_fixed_size: 0
    .sgpr_count:     62
    .sgpr_spill_count: 0
    .symbol:         bm064_bn096_bk128_wm4_wn2_mc1.kd
