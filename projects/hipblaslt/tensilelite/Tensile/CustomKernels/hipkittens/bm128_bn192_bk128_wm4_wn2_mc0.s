	...
	.section	.text.bm128_bn192_bk128_wm4_wn2_mc0,"axG",@progbits,bm128_bn192_bk128_wm4_wn2_mc0,comdat
	.protected	bm128_bn192_bk128_wm4_wn2_mc0 ; -- Begin function bm128_bn192_bk128_wm4_wn2_mc0
	.globl	bm128_bn192_bk128_wm4_wn2_mc0
	.p2align	8
	.type	bm128_bn192_bk128_wm4_wn2_mc0,@function
bm128_bn192_bk128_wm4_wn2_mc0: ; @bm128_bn192_bk128_wm4_wn2_mc0
; %bb.0:
...
; %bb.3:
	...
	v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v3, v100
	s_mov_b32 s6, 0
	v_mov_b32_e32 v4, v1
...
.LBB0_14:
	...
	s_barrier_signal -1
	v_dual_lshlrev_b32 v1, 4, v107 :: v_dual_bitop2_b32 v2, 32, v0 bitop3:0x40
	v_mov_b32_e32 v9, 0
	s_and_b32 s30, s25, s21
	s_mov_b32 s7, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_and_b32_e32 v103, 0x60, v1
	v_cmp_ne_u32_e32 vcc_lo, 0, v2
	v_cndmask_b32_e64 v99, 0, 1, s30
	v_dual_mov_b32 v8, v9 :: v_dual_mov_b32 v7, v9
	v_dual_mov_b32 v6, v9 :: v_dual_mov_b32 v5, v9
	v_cndmask_b32_e64 v105, 0, 0x60, vcc_lo
	...
	v_dual_mov_b32 v42, v9 :: v_dual_mov_b32 v41, v9
...
; %bb.15:
	...
	v_dual_lshlrev_b32 v2, 7, v105 :: v_dual_lshlrev_b32 v1, 7, v103
	...
	s_lshl_b32 s0, s28, 7
	v_add_nc_u32_e32 v98, v7, v5
	v_and_b32_e32 v3, 0x378, v3
	v_dual_add_nc_u32 v5, v4, v1 :: v_dual_mov_b32 v111, v101
	s_mov_b32 s42, s1
	s_ashr_i32 s3, s2, 31
	s_ashr_i32 s1, s0, 31
	s_wait_kmcnt 0x0
	...
	v_add_nc_u32_e32 v102, v8, v6
	v_or_b32_e32 v1, 0x100, v0
	v_dual_mov_b32 v113, v101 :: v_dual_add_nc_u32 v104, v3, v5
	v_add3_u32 v106, v4, v2, v8
	v_dual_add_nc_u32 v108, v7, v5 :: v_dual_mov_b32 v2, v101
	v_or_b32_e32 v109, 0x2100, v0
	v_or_b32_e32 v110, 0x8800, v100
	v_or_b32_e32 v116, 0x3100, v0
	v_or_b32_e32 v112, 0xc800, v100
	...
	v_dual_mov_b32 v33, v101 :: v_dual_mov_b32 v42, v101
	...
	v_dual_mov_b32 v49, v101 :: v_dual_mov_b32 v34, v101
	...
	v_dual_mov_b32 v41, v101 :: v_dual_mov_b32 v58, v101
...
.LBB0_19:                               ;   Parent Loop BB0_17 Depth=1
	...
	v_dual_mov_b32 v100, v114 :: v_dual_add_nc_u32 v117, -2, v117
	v_dual_mov_b32 v118, v115 :: v_dual_mov_b32 v119, v101
	v_add_nc_u32_e32 v115, 0x200, v115
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_add_u64 v[120:121], v[100:101], 2, s[2:3]
	v_cmp_eq_u32_e32 vcc_lo, 0, v117
	v_add_nc_u32_e32 v114, 0x200, v114
	v_lshl_add_u64 v[118:119], v[118:119], 2, s[2:3]
	s_clause 0x1
...
; %bb.21:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[114:115], s[2:3], v[110:111]
...
.LBB0_22:                               ;   Parent Loop BB0_17 Depth=1
	...
	flat_store_b32 v[114:115], v101
	s_wait_xcnt 0x0
	v_add_nc_u64_e32 v[114:115], 0x400, v[114:115]
...
; %bb.26:                               ;   in Loop: Header=BB0_17 Depth=1
	v_add_nc_u64_e32 v[114:115], s[2:3], v[112:113]
...
; %bb.33:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v115, s10 :: v_dual_mov_b32 v114, s8
...
.LBB0_35:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_and_b32 s3, s3, 0x1ffffff
	v_dual_mov_b32 v115, s1 :: v_dual_mov_b32 v114, s2
	s_bitset1_b32 s3, 31
...
.LBB0_36:                               ;   in Loop: Header=BB0_17 Depth=1
	...
	s_cselect_b32 s1, s41, 0
	s_cselect_b32 s2, s34, s39
	v_lshl_add_u32 v100, v98, 1, s1
	v_lshl_add_u32 v114, v102, 1, s2
	...
	ds_load_b128 v[142:145], v114 offset:4352
	ds_load_b128 v[146:149], v114 offset:4368
	v_lshl_add_u32 v100, v104, 1, s1
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[26:33], v[126:133], v[142:149], v[26:33] matrix_a_reuse
	ds_load_b128 v[158:161], v100 offset:4416
	ds_load_b128 v[162:165], v100 offset:4432
	v_wmma_f32_16x16x32_bf16 v[82:89], v[118:125], v[142:149], v[82:89] matrix_a_reuse
	ds_load_b128 v[142:145], v114 offset:13056
	ds_load_b128 v[146:149], v114 offset:13072
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[10:17], v[126:133], v[142:149], v[10:17] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[66:73], v[118:125], v[142:149], v[66:73] matrix_a_reuse
	ds_load_b128 v[142:145], v114 offset:21760
	ds_load_b128 v[146:149], v114 offset:21776
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[118:125], v[142:149], v[34:41] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[50:57], v[126:133], v[142:149], v[50:57]
	ds_load_b128 v[134:137], v114 offset:8704
	ds_load_b128 v[138:141], v114 offset:8720
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[18:25], v[126:133], v[134:141], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[74:81], v[118:125], v[134:141], v[74:81] matrix_a_reuse
	ds_load_b128 v[134:137], v114 offset:17408
	ds_load_b128 v[138:141], v114 offset:17424
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[58:65], v[118:125], v[134:141], v[58:65] matrix_a_reuse
	ds_load_b128 v[150:153], v114
	ds_load_b128 v[154:157], v114 offset:16
	v_lshl_add_u32 v114, v106, 1, s2
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	ds_load_b128 v[166:169], v114 offset:64
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x32_bf16 v[42:49], v[126:133], v[150:157], v[42:49] matrix_a_reuse
	ds_load_b128 v[170:173], v114 offset:80
	ds_load_b128 v[174:177], v114 offset:4416
	ds_load_b128 v[178:181], v114 offset:4432
	ds_load_b128 v[182:185], v114 offset:13120
	ds_load_b128 v[186:189], v114 offset:13136
	ds_load_b128 v[190:193], v114 offset:17472
	ds_load_b128 v[194:197], v114 offset:17488
	v_wmma_f32_16x16x32_bf16 v[90:97], v[118:125], v[150:157], v[90:97]
	ds_load_b128 v[150:153], v100 offset:64
	ds_load_b128 v[154:157], v100 offset:80
	ds_load_b128 v[198:201], v114 offset:21824
	ds_load_b128 v[202:205], v114 offset:21840
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[2:9], v[126:133], v[134:141], v[2:9] matrix_a_reuse
	ds_load_b128 v[134:137], v114 offset:8768
	ds_load_b128 v[138:141], v114 offset:8784
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	v_lshl_add_u32 v100, v108, 1, s1
	ds_load_b128 v[118:121], v100 offset:128
	ds_load_b128 v[122:125], v100 offset:144
	ds_load_b128 v[126:129], v100 offset:4480
	ds_load_b128 v[130:133], v100 offset:4496
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[90:97], v[150:157], v[166:173], v[90:97]
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[82:89], v[150:157], v[174:181], v[82:89] matrix_a_reuse
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[74:81], v[150:157], v[134:141], v[74:81] matrix_a_reuse
	ds_load_b128 v[142:145], v114 offset:128
	ds_load_b128 v[146:149], v114 offset:144
	ds_load_b128 v[206:209], v114 offset:4480
	ds_load_b128 v[210:213], v114 offset:4496
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[66:73], v[150:157], v[182:189], v[66:73] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[58:65], v[150:157], v[190:197], v[58:65] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[34:41], v[150:157], v[198:205], v[34:41] matrix_a_reuse
	ds_load_b128 v[150:153], v114 offset:8832
	ds_load_b128 v[154:157], v114 offset:8848
	ds_load_b128 v[214:217], v114 offset:13184
	ds_load_b128 v[218:221], v114 offset:13200
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[158:165], v[198:205], v[50:57]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[158:165], v[190:197], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[158:165], v[182:189], v[10:17] matrix_a_reuse
	ds_load_b128 v[182:185], v114 offset:17536
	ds_load_b128 v[186:189], v114 offset:17552
	ds_load_b128 v[190:193], v114 offset:21888
	ds_load_b128 v[194:197], v114 offset:21904
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[158:165], v[134:141], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[158:165], v[174:181], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[158:165], v[166:173], v[42:49] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	ds_load_b128 v[134:137], v100 offset:192
	ds_load_b128 v[138:141], v100 offset:208
	ds_load_b128 v[158:161], v100 offset:4544
	ds_load_b128 v[162:165], v100 offset:4560
	s_wait_dscnt 0xe
	v_wmma_f32_16x16x32_bf16 v[90:97], v[118:125], v[142:149], v[90:97]
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[82:89], v[118:125], v[206:213], v[82:89] matrix_a_reuse
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[74:81], v[118:125], v[150:157], v[74:81] matrix_a_reuse
	ds_load_b128 v[166:169], v114 offset:192
	ds_load_b128 v[170:173], v114 offset:208
	ds_load_b128 v[174:177], v114 offset:4544
	ds_load_b128 v[178:181], v114 offset:4560
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0xc
	v_wmma_f32_16x16x32_bf16 v[66:73], v[118:125], v[214:221], v[66:73] matrix_a_reuse
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[58:65], v[118:125], v[182:189], v[58:65] matrix_a_reuse
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[34:41], v[118:125], v[190:197], v[34:41] matrix_a_reuse
	ds_load_b128 v[118:121], v114 offset:8896
	ds_load_b128 v[122:125], v114 offset:8912
	ds_load_b128 v[198:201], v114 offset:13248
	ds_load_b128 v[202:205], v114 offset:13264
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[126:133], v[190:197], v[50:57]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[126:133], v[182:189], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[126:133], v[214:221], v[10:17] matrix_a_reuse
	ds_load_b128 v[182:185], v114 offset:17600
	ds_load_b128 v[186:189], v114 offset:17616
	ds_load_b128 v[190:193], v114 offset:21952
	ds_load_b128 v[194:197], v114 offset:21968
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[126:133], v[150:157], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[126:133], v[206:213], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[126:133], v[142:149], v[42:49] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[90:97], v[134:141], v[166:173], v[90:97]
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x8
	v_wmma_f32_16x16x32_bf16 v[82:89], v[134:141], v[174:181], v[82:89] matrix_a_reuse
	s_wait_dscnt 0x6
	v_wmma_f32_16x16x32_bf16 v[74:81], v[134:141], v[118:125], v[74:81] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	s_wait_dscnt 0x4
	v_wmma_f32_16x16x32_bf16 v[66:73], v[134:141], v[198:205], v[66:73] matrix_a_reuse
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x32_bf16 v[58:65], v[134:141], v[182:189], v[58:65] matrix_a_reuse
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[34:41], v[134:141], v[190:197], v[34:41] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[50:57], v[158:165], v[190:197], v[50:57]
	v_wmma_f32_16x16x32_bf16 v[2:9], v[158:165], v[182:189], v[2:9] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[10:17], v[158:165], v[198:205], v[10:17] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_group_barrier mask(0x00000100) size(4) SyncID(0)
	v_wmma_f32_16x16x32_bf16 v[18:25], v[158:165], v[118:125], v[18:25] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[26:33], v[158:165], v[174:181], v[26:33] matrix_a_reuse
	v_wmma_f32_16x16x32_bf16 v[42:49], v[158:165], v[166:173], v[42:49] matrix_a_reuse
	; sched_group_barrier mask(0x00000008) size(3) SyncID(0)
	; sched_barrier mask(0x00000000)
...
; %bb.38:
	...
	v_add_nc_u32_e32 v83, 0x2000, v1
	v_cvt_pk_bf16_f32 v87, v84, v85
	v_cvt_pk_bf16_f32 v79, v76, v77
	v_add_nc_u32_e32 v76, 0x1000, v1
	v_dual_lshrrev_b32 v74, 3, v82 :: v_dual_lshlrev_b32 v82, 1, v1
	v_add_nc_u32_e32 v84, 16, v1
	v_cvt_pk_bf16_f32 v49, v48, v49
	v_cvt_pk_bf16_f32 v48, v46, v47
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v74, 0xff0, v74
	v_add_nc_u32_e32 v75, v75, v82
	v_cvt_pk_bf16_f32 v47, v44, v45
	v_cvt_pk_bf16_f32 v44, v62, v63
	v_add_nc_u32_e32 v62, 0x810, v1
	v_add_nc_u32_e32 v74, v74, v82
	v_add_nc_u32_e32 v77, 0x1800, v1
	v_cvt_pk_bf16_f32 v41, v40, v41
	ds_store_b128 v75, v[94:97]
	ds_store_b128 v74, v[86:89] offset:4096
	v_lshrrev_b32_e32 v75, 3, v83
	v_add_nc_u32_e32 v83, 0x2800, v1
	v_cvt_pk_bf16_f32 v40, v38, v39
	v_cvt_pk_bf16_f32 v38, v34, v35
	v_add_nc_u32_e32 v34, 0x1010, v1
	...
	v_add_nc_u32_e32 v28, 0x2010, v1
	v_add_nc_u32_e32 v1, 0x2810, v1
	v_lshrrev_b32_e32 v76, 3, v76
	v_lshrrev_b32_e32 v74, 3, v84
	v_cvt_pk_bf16_f32 v46, v42, v43
	v_cvt_pk_bf16_f32 v42, v58, v59
	v_dual_lshrrev_b32 v59, 3, v62 :: v_dual_lshrrev_b32 v77, 3, v77
	v_cvt_pk_bf16_f32 v73, v72, v73
	v_cvt_pk_bf16_f32 v72, v70, v71
	v_cvt_pk_bf16_f32 v70, v66, v67
	v_dual_lshrrev_b32 v67, 3, v83 :: v_dual_lshrrev_b32 v34, 3, v34
	...
	v_add_nc_u32_e32 v68, v74, v82
	v_add_nc_u32_e32 v66, v66, v82
	v_cvt_pk_bf16_f32 v43, v60, v61
	v_dual_add_nc_u32 v35, v35, v36 :: v_dual_add_nc_u32 v77, v77, v82
	v_dual_add_nc_u32 v58, v64, v82 :: v_dual_add_nc_u32 v27, v34, v36
	...
	ds_store_b128 v76, v[78:81] offset:8192
	ds_store_b128 v77, v[70:73] offset:12288
	ds_store_b128 v66, v[42:45] offset:16384
	ds_store_b128 v58, v[38:41] offset:20480
	ds_store_b128 v68, v[46:49] offset:32
	ds_store_b128 v35, v[30:33] offset:4096
...
.LBB0_50:
	...
	s_endpgm
.Lfunc_end0:
	.size	bm128_bn192_bk128_wm4_wn2_mc0, .Lfunc_end0-bm128_bn192_bk128_wm4_wn2_mc0
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel bm128_bn192_bk128_wm4_wn2_mc0
	...
	.section	.text.bm128_bn192_bk128_wm4_wn2_mc0,"axG",@progbits,bm128_bn192_bk128_wm4_wn2_mc0,comdat
                                        ; -- End function
	.set .Lbm128_bn192_bk128_wm4_wn2_mc0.num_vgpr, 222
	.set .Lbm128_bn192_bk128_wm4_wn2_mc0.num_agpr, 0
	.set .Lbm128_bn192_bk128_wm4_wn2_mc0.numbered_sgpr, 56
	.set .Lbm128_bn192_bk128_wm4_wn2_mc0.num_named_barrier, 0
	.set .Lbm128_bn192_bk128_wm4_wn2_mc0.private_seg_size, 0
	.set .Lbm128_bn192_bk128_wm4_wn2_mc0.uses_vcc, 1
	.set .Lbm128_bn192_bk128_wm4_wn2_mc0.uses_flat_scratch, 1
	.set .Lbm128_bn192_bk128_wm4_wn2_mc0.has_dyn_sized_stack, 0
	.set .Lbm128_bn192_bk128_wm4_wn2_mc0.has_recursion, 0
	.set .Lbm128_bn192_bk128_wm4_wn2_mc0.has_indirect_call, 0
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_3ce66a768024630e,@object ; @__hip_cuid_3ce66a768024630e
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_3ce66a768024630e
__hip_cuid_3ce66a768024630e:
	.byte	0                               ; 0x0
	.size	__hip_cuid_3ce66a768024630e, 1

	.ident	"AMD clang version 23.0.0git (https://github.com/ROCm/llvm-project.git aa451e1fe6a793394d6733051b1778633063ae96+PATCHED:d17c5aa0e3ea29cde402f58f27e39b6034effa27)"
	.section	".note.GNU-stack","",@progbits
	.addrsig
	.addrsig_sym __hip_cuid_3ce66a768024630e
	.amdgpu_metadata
---
custom.config:
  Source:
...
amdhsa.kernels:
  - .args:
    ...
    .name:           bm128_bn192_bk128_wm4_wn2_mc0
    .private_segment_fixed_size: 0
    .sgpr_count:     58
    .sgpr_spill_count: 0
    .symbol:         bm128_bn192_bk128_wm4_wn2_mc0.kd
