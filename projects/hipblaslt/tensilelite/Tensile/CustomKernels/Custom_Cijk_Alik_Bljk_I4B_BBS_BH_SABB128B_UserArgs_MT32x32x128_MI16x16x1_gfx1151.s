...
.text
.protected Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB128B_UserArgs_MT32x32x128_MI16x16x1_gfx1151
.globl Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB128B_UserArgs_MT32x32x128_MI16x16x1_gfx1151
.p2align 8
.type Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB128B_UserArgs_MT32x32x128_MI16x16x1_gfx1151,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB128B_UserArgs_MT32x32x128_MI16x16x1_gfx1151
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB128B_UserArgs_MT32x32x128_MI16x16x1_gfx1151
    .symbol: 'Custom_Cijk_Alik_Bljk_I4B_BBS_BH_SABB128B_UserArgs_MT32x32x128_MI16x16x1_gfx1151.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
v_cvt_f64_u32 v[28:29], s61                        // s57 = s[sgprWorkGroup0] / s61
v_rcp_f64 v[28:29], v[28:29]                       // s57 = s[sgprWorkGroup0] / s61
v_cvt_f64_u32 v[30:31], s[sgprWorkGroup0]          // s57 = s[sgprWorkGroup0] / s61
v_mul_f64 v[28:29], v[28:29], v[30:31]             // s57 = s[sgprWorkGroup0] / s61
v_cvt_u32_f64 v28, v[28:29]                        // s57 = s[sgprWorkGroup0] / s61
v_mul_lo_u32 v29, v28, s61                         // s57 = s[sgprWorkGroup0] / s61
v_sub_nc_u32 v30, s[sgprWorkGroup0], v29           // s57 = s[sgprWorkGroup0] / s61
v_cmp_ge_u32 vcc_lo, v30, s61                      // s57 = s[sgprWorkGroup0] / s61
s_mov_b32 exec_lo, vcc_lo                          // s57 = s[sgprWorkGroup0] / s61
v_add_nc_u32 v28, v28, 1                           // s57 = s[sgprWorkGroup0] / s61
s_mov_b32 exec_lo, -1                              // Reset exec
v_mul_lo_u32 v29, v28, s61                         // s57 = s[sgprWorkGroup0] / s61
v_sub_nc_u32 v30, s[sgprWorkGroup0], v29           // s57 = s[sgprWorkGroup0] / s61
v_readfirstlane_b32 s57, v28                       // quotient
v_readfirstlane_b32 s58, v30                       // remainder
...
v_cvt_f64_u32 v[28:29], s61                        // s58 = s23 / s61
v_rcp_f64 v[28:29], v[28:29]                       // s58 = s23 / s61
v_cvt_f64_u32 v[30:31], s23                        // s58 = s23 / s61
v_mul_f64 v[28:29], v[28:29], v[30:31]             // s58 = s23 / s61
v_cvt_u32_f64 v28, v[28:29]                        // s58 = s23 / s61
v_mul_lo_u32 v29, v28, s61                         // s58 = s23 / s61
v_sub_nc_u32 v30, s23, v29                         // s58 = s23 / s61
v_cmp_ge_u32 vcc_lo, v30, s61                      // s58 = s23 / s61
s_mov_b32 exec_lo, vcc_lo                          // s58 = s23 / s61
v_add_nc_u32 v28, v28, 1                           // s58 = s23 / s61
s_mov_b32 exec_lo, -1                              // Reset exec
v_readfirstlane_b32 s58, v28                       // quotient
...
v_mov_b32 v30, MT0                                 // set MT0 into sgpr
v_mov_b32 v29, s[sgprSizesFree+0]                  // set Free0 size
v_cvt_f32_u32 v28, v30                             // v28 = ceil(v29 / v30)
v_rcp_iflag_f32 v28, v28                           // v28 = ceil(v29 / v30)
v_cvt_f32_u32 v31, v29                             // v28 = ceil(v29 / v30)
v_mul_f32 v28, v28, v31                            // v28 = ceil(v29 / v30)
v_cvt_u32_f32 v28, v28                             // v28 = ceil(v29 / v30)
v_mul_u32_u24 v31, v28, v30                        // v28 = ceil(v29 / v30)
v_sub_nc_u32 v31, v29, v31                         // v28 = ceil(v29 / v30)
v_cmp_ne_u32 vcc_lo, v31, 0                        // v28 = ceil(v29 / v30)
v_add_co_ci_u32 v28, vcc_lo, v28, 0, vcc_lo        // ceil
v_mov_b32 v30, MT1                                 // set MT1 into sgpr
v_mov_b32 v29, s[sgprSizesFree+1]                  // set Free1 size
v_readfirstlane_b32 s[sgprNumWorkGroups0], v28     // set back to numWorkGroup0
v_cvt_f32_u32 v28, v30                             // v28 = ceil(v29 / v30)
v_rcp_iflag_f32 v28, v28                           // v28 = ceil(v29 / v30)
v_cvt_f32_u32 v31, v29                             // v28 = ceil(v29 / v30)
v_mul_f32 v28, v28, v31                            // v28 = ceil(v29 / v30)
...
v_cmp_ne_u32 vcc_lo, v31, 0                        // v28 = ceil(v29 / v30)
v_add_co_ci_u32 v28, vcc_lo, v28, 0, vcc_lo        // ceil
v_readfirstlane_b32 s[sgprNumWorkGroups1], v28     // set back to numWorkGroup1
...
s_waitcnt lgkmcnt(0)
s_lshr_b32 s60, s24, 5                             // s60 = s24 / 32
s_and_b32 s58, 31, s24                             // s58 = s24 % 32
s_addc_u32 s60, s60, 0
s_lshr_b32 s61, s25, 5                             // s61 = s25 / 32
s_and_b32 s58, 31, s25                             // s58 = s25 % 32
...
v_cvt_f64_u32 v[28:29], s16                        // s17 = s[sgprWorkGroup0] / s16
v_rcp_f64 v[28:29], v[28:29]                       // s17 = s[sgprWorkGroup0] / s16
v_cvt_f64_u32 v[30:31], s[sgprWorkGroup0]          // s17 = s[sgprWorkGroup0] / s16
v_mul_f64 v[28:29], v[28:29], v[30:31]             // s17 = s[sgprWorkGroup0] / s16
v_cvt_u32_f64 v28, v[28:29]                        // s17 = s[sgprWorkGroup0] / s16
v_mul_lo_u32 v29, v28, s16                         // s17 = s[sgprWorkGroup0] / s16
v_sub_nc_u32 v30, s[sgprWorkGroup0], v29           // s17 = s[sgprWorkGroup0] / s16
v_cmp_ge_u32 vcc_lo, v30, s16                      // s17 = s[sgprWorkGroup0] / s16
s_mov_b32 exec_lo, vcc_lo                          // s17 = s[sgprWorkGroup0] / s16
v_add_nc_u32 v28, v28, 1                           // s17 = s[sgprWorkGroup0] / s16
s_mov_b32 exec_lo, -1                              // Reset exec
v_readfirstlane_b32 s17, v28                       // quotient
...
v_cvt_f64_u32 v[28:29], s16                        // s18 = s[sgprNumWorkGroups0] / s16
v_rcp_f64 v[28:29], v[28:29]                       // s18 = s[sgprNumWorkGroups0] / s16
v_cvt_f64_u32 v[30:31], s[sgprNumWorkGroups0]      // s18 = s[sgprNumWorkGroups0] / s16
v_mul_f64 v[28:29], v[28:29], v[30:31]             // s18 = s[sgprNumWorkGroups0] / s16
v_cvt_u32_f64 v28, v[28:29]                        // s18 = s[sgprNumWorkGroups0] / s16
v_mul_lo_u32 v29, v28, s16                         // s18 = s[sgprNumWorkGroups0] / s16
v_sub_nc_u32 v30, s[sgprNumWorkGroups0], v29       // s18 = s[sgprNumWorkGroups0] / s16
v_cmp_ge_u32 vcc_lo, v30, s16                      // s18 = s[sgprNumWorkGroups0] / s16
s_mov_b32 exec_lo, vcc_lo                          // s18 = s[sgprNumWorkGroups0] / s16
v_add_nc_u32 v28, v28, 1                           // s18 = s[sgprNumWorkGroups0] / s16
s_mov_b32 exec_lo, -1                              // Reset exec
v_readfirstlane_b32 s18, v28                       // quotient
...
v_cvt_f64_u32 v[28:29], s18                        // s[sgprWorkGroup1] = s20 / s18
v_rcp_f64 v[28:29], v[28:29]                       // s[sgprWorkGroup1] = s20 / s18
v_cvt_f64_u32 v[30:31], s20                        // s[sgprWorkGroup1] = s20 / s18
v_mul_f64 v[28:29], v[28:29], v[30:31]             // s[sgprWorkGroup1] = s20 / s18
v_cvt_u32_f64 v28, v[28:29]                        // s[sgprWorkGroup1] = s20 / s18
v_mul_lo_u32 v29, v28, s18                         // s[sgprWorkGroup1] = s20 / s18
v_sub_nc_u32 v30, s20, v29                         // s[sgprWorkGroup1] = s20 / s18
v_cmp_ge_u32 vcc_lo, v30, s18                      // s[sgprWorkGroup1] = s20 / s18
s_mov_b32 exec_lo, vcc_lo                          // s[sgprWorkGroup1] = s20 / s18
v_add_nc_u32 v28, v28, 1                           // s[sgprWorkGroup1] = s20 / s18
s_mov_b32 exec_lo, -1                              // Reset exec
v_mul_lo_u32 v29, v28, s18                         // s[sgprWorkGroup1] = s20 / s18
v_sub_nc_u32 v30, s20, v29                         // s[sgprWorkGroup1] = s20 / s18
v_readfirstlane_b32 s[sgprWorkGroup1], v28         // quotient
v_readfirstlane_b32 s[sgprWorkGroup0], v30         // remainder
...
v_cvt_f64_u32 v[28:29], s16                        // s17 = s[sgprWorkGroup1] / s16
v_rcp_f64 v[28:29], v[28:29]                       // s17 = s[sgprWorkGroup1] / s16
v_cvt_f64_u32 v[30:31], s[sgprWorkGroup1]          // s17 = s[sgprWorkGroup1] / s16
v_mul_f64 v[28:29], v[28:29], v[30:31]             // s17 = s[sgprWorkGroup1] / s16
v_cvt_u32_f64 v28, v[28:29]                        // s17 = s[sgprWorkGroup1] / s16
v_mul_lo_u32 v29, v28, s16                         // s17 = s[sgprWorkGroup1] / s16
v_sub_nc_u32 v30, s[sgprWorkGroup1], v29           // s17 = s[sgprWorkGroup1] / s16
v_cmp_ge_u32 vcc_lo, v30, s16                      // s17 = s[sgprWorkGroup1] / s16
s_mov_b32 exec_lo, vcc_lo                          // s17 = s[sgprWorkGroup1] / s16
v_add_nc_u32 v28, v28, 1                           // s17 = s[sgprWorkGroup1] / s16
s_mov_b32 exec_lo, -1                              // Reset exec
v_readfirstlane_b32 s17, v28                       // quotient
s_mul_i32 s20, s17, s16                            // quotient * non-magic divisor
...
v_cvt_f64_u32 v[28:29], s16                        // s18 = s[sgprNumWorkGroups1] / s16
v_rcp_f64 v[28:29], v[28:29]                       // s18 = s[sgprNumWorkGroups1] / s16
v_cvt_f64_u32 v[30:31], s[sgprNumWorkGroups1]      // s18 = s[sgprNumWorkGroups1] / s16
v_mul_f64 v[28:29], v[28:29], v[30:31]             // s18 = s[sgprNumWorkGroups1] / s16
v_cvt_u32_f64 v28, v[28:29]                        // s18 = s[sgprNumWorkGroups1] / s16
v_mul_lo_u32 v29, v28, s16                         // s18 = s[sgprNumWorkGroups1] / s16
v_sub_nc_u32 v30, s[sgprNumWorkGroups1], v29       // s18 = s[sgprNumWorkGroups1] / s16
v_cmp_ge_u32 vcc_lo, v30, s16                      // s18 = s[sgprNumWorkGroups1] / s16
s_mov_b32 exec_lo, vcc_lo                          // s18 = s[sgprNumWorkGroups1] / s16
v_add_nc_u32 v28, v28, 1                           // s18 = s[sgprNumWorkGroups1] / s16
s_mov_b32 exec_lo, -1                              // Reset exec
v_readfirstlane_b32 s18, v28                       // quotient
s_mul_i32 s19, s16, s18                            // quotient * non-magic divisor
...
s_cmp_ge_u32 s17, s18                              // blockId >= numFullBlocks ?
s_cselect_b32 s18, s19, s16
v_cvt_f64_u32 v[28:29], s18                        // s[sgprWorkGroup0] = s20 / s18
v_rcp_f64 v[28:29], v[28:29]                       // s[sgprWorkGroup0] = s20 / s18
v_cvt_f64_u32 v[30:31], s20                        // s[sgprWorkGroup0] = s20 / s18
v_mul_f64 v[28:29], v[28:29], v[30:31]             // s[sgprWorkGroup0] = s20 / s18
v_cvt_u32_f64 v28, v[28:29]                        // s[sgprWorkGroup0] = s20 / s18
v_mul_lo_u32 v29, v28, s18                         // s[sgprWorkGroup0] = s20 / s18
v_sub_nc_u32 v30, s20, v29                         // s[sgprWorkGroup0] = s20 / s18
v_cmp_ge_u32 vcc_lo, v30, s18                      // s[sgprWorkGroup0] = s20 / s18
s_mov_b32 exec_lo, vcc_lo                          // s[sgprWorkGroup0] = s20 / s18
v_add_nc_u32 v28, v28, 1                           // s[sgprWorkGroup0] = s20 / s18
s_mov_b32 exec_lo, -1                              // Reset exec
v_mul_lo_u32 v29, v28, s18                         // s[sgprWorkGroup0] = s20 / s18
v_sub_nc_u32 v30, s20, v29                         // s[sgprWorkGroup0] = s20 / s18
v_readfirstlane_b32 s[sgprWorkGroup0], v28         // quotient
v_readfirstlane_b32 s[sgprWorkGroup1], v30         // remainder
...
v_mov_b32 v28, v0                                  // groA0I_0
v_add_co_u32 v29, vcc_lo, 8, v28                   // groA0I_1 += LSPA
v_add_co_u32 v30, vcc_lo, 8, v29                   // groA0I_2 += LSPA
v_add_co_u32 v31, vcc_lo, 8, v30                   // groA0I_3 += LSPA

/* global read addresses: tile offsets b */
v_mov_b32 v32, v2                                  // groB1J_0
v_add_co_u32 v33, vcc_lo, 8, v32                   // groB1J_1 += LSPB
v_add_co_u32 v34, vcc_lo, 8, v33                   // groB1J_2 += LSPB
v_add_co_u32 v35, vcc_lo, 8, v34                   // groB1J_3 += LSPB
...
v_cvt_f32_u32 v36, s[sgprGSUSumIdx+1]              // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSUSumIdx+1]
v_rcp_iflag_f32 v36, v36                           // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSUSumIdx+1]
v_cvt_f32_u32 v37, s[sgprLoopCounterL]             // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSUSumIdx+1]
v_mul_f32 v36, v36, v37                            // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSUSumIdx+1]
v_cvt_u32_f32 v36, v36                             // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSUSumIdx+1]
v_mul_u32_u24 v37, v36, s[sgprGSUSumIdx+1]         // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSUSumIdx+1]
v_sub_nc_u32 v37, s[sgprLoopCounterL], v37         // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSUSumIdx+1]
v_cmp_eq_u32 vcc_lo, v37, s[sgprGSUSumIdx+1]       // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSUSumIdx+1]
s_mov_b32 exec_lo, vcc_lo                          // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSUSumIdx+1]
v_add_nc_u32 v36, 1, v36                           // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSUSumIdx+1]
v_mov_b32 v37, 0                                   // s[sgprGSUSumIdx+1] = s[sgprLoopCounterL] % s[sgprGSUSumIdx+1]
s_mov_b32 exec_lo, -1                              // Reset exec
v_cmp_gt_u32 vcc_lo, v37, s[sgprGSUSumIdx+1]       // overflow happened in remainder
s_mov_b32 exec_lo, vcc_lo                          // overflow happened in remainder
v_sub_nc_u32 v36, v36, 1                           // quotient - 1
v_mul_u32_u24 v37, v36, s[sgprGSUSumIdx+1]         // re-calculate remainder
v_sub_nc_u32 v37, s[sgprLoopCounterL], v37         // re-calculate remainder
s_mov_b32 exec_lo, -1                              // Reset exec
v_readfirstlane_b32 s[sgprLoopCounterL], v36       // quotient
...
/* ============================================================= */
v_mul_lo_u32 v36, s[sgprStrideA0I], v[28]          // mul d1 lower
v_add_co_u32 v[vgprGlobalReadOffsetA+0+0], vcc_lo, v[6], v[36+0] // accumulate K lower
v_add_nc_u32 v[vgprGlobalReadOffsetA+0+0], 0x8, v[vgprGlobalReadOffsetA+0+0] // add prepad for pointer shift
v_lshrrev_b32 v36, 7, v6                           // scaleA: kGroup = k/128
v_mul_lo_u32 v[vgprGlobalReadOffsetScaleA+0], s[sgprStrideScaleA], v28 // scaleA: row * StrideScaleA
v_add_nc_u32 v[vgprGlobalReadOffsetScaleA+0], v36, v[vgprGlobalReadOffsetScaleA+0] // scaleA: + kGroup
...
v_mul_lo_u32 v36, s[sgprStrideA0I], v[29]          // mul d1 lower
v_add_co_u32 v[vgprGlobalReadOffsetA+1+0], vcc_lo, v[6], v[36+0] // accumulate K lower
v_add_nc_u32 v[vgprGlobalReadOffsetA+1+0], 0x8, v[vgprGlobalReadOffsetA+1+0] // add prepad for pointer shift
v_lshrrev_b32 v36, 7, v6                           // scaleA: kGroup = k/128
v_mul_lo_u32 v[vgprGlobalReadOffsetScaleA+1], s[sgprStrideScaleA], v29 // scaleA: row * StrideScaleA
v_add_nc_u32 v[vgprGlobalReadOffsetScaleA+1], v36, v[vgprGlobalReadOffsetScaleA+1] // scaleA: + kGroup
...
v_mul_lo_u32 v36, s[sgprStrideA0I], v[30]          // mul d1 lower
v_add_co_u32 v[vgprGlobalReadOffsetA+2+0], vcc_lo, v[6], v[36+0] // accumulate K lower
v_add_nc_u32 v[vgprGlobalReadOffsetA+2+0], 0x8, v[vgprGlobalReadOffsetA+2+0] // add prepad for pointer shift
v_lshrrev_b32 v36, 7, v6                           // scaleA: kGroup = k/128
v_mul_lo_u32 v[vgprGlobalReadOffsetScaleA+2], s[sgprStrideScaleA], v30 // scaleA: row * StrideScaleA
v_add_nc_u32 v[vgprGlobalReadOffsetScaleA+2], v36, v[vgprGlobalReadOffsetScaleA+2] // scaleA: + kGroup
...
v_mul_lo_u32 v36, s[sgprStrideA0I], v[31]          // mul d1 lower
v_add_co_u32 v[vgprGlobalReadOffsetA+3+0], vcc_lo, v[6], v[36+0] // accumulate K lower
v_add_nc_u32 v[vgprGlobalReadOffsetA+3+0], 0x8, v[vgprGlobalReadOffsetA+3+0] // add prepad for pointer shift
v_lshrrev_b32 v36, 7, v6                           // scaleA: kGroup = k/128
v_mul_lo_u32 v[vgprGlobalReadOffsetScaleA+3], s[sgprStrideScaleA], v31 // scaleA: row * StrideScaleA
v_add_nc_u32 v[vgprGlobalReadOffsetScaleA+3], v36, v[vgprGlobalReadOffsetScaleA+3] // scaleA: + kGroup
...
/* ============================================================= */
v_mul_lo_u32 v28, s[sgprStrideB1J], v[32]          // mul d1 lower
v_add_co_u32 v[vgprGlobalReadOffsetB+0+0], vcc_lo, v[7], v[28+0] // accumulate K lower
...
v_mul_lo_u32 v28, s[sgprStrideB1J], v[33]          // mul d1 lower
v_add_co_u32 v[vgprGlobalReadOffsetB+1+0], vcc_lo, v[7], v[28+0] // accumulate K lower
...
v_mul_lo_u32 v28, s[sgprStrideB1J], v[34]          // mul d1 lower
v_add_co_u32 v[vgprGlobalReadOffsetB+2+0], vcc_lo, v[7], v[28+0] // accumulate K lower
...
v_mul_lo_u32 v28, s[sgprStrideB1J], v[35]          // mul d1 lower
v_add_co_u32 v[vgprGlobalReadOffsetB+3+0], vcc_lo, v[7], v[28+0] // accumulate K lower
...
/* initC: remove ValuA/B vgpr buffer [28...157) from pool */
...
/* local write a */
v_mov_b32 v196, 0x7fff                             // w4a16: round-to-nearest-even bias for bf16
v_mov_b32 v197, 0x7fff0000                         // w4a16: bf16 Nan pattern
v_lshlrev_b32 v194, 16, v[vgprG2LScaleA+0]         // scaleA: bf16 -> f32
v_mov_b32 v193, v[vgprG2LA+2+0]                    // w4a16: save packed int4 dword 0
v_bfe_i32 v191, v193, 0x0, 0x4                     // w4a16: sign-extend int4 #0
v_bfe_i32 v192, v193, 0x4, 0x4                     // w4a16: sign-extend int4 #1
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
v_mul_f32 v191, v194, v191                         // w4a16: dequantize
v_mul_f32 v192, v194, v192                         // w4a16: dequantize
v_cmp_u_f32 s8, v191, v191                         // w4a16: check Nan
v_bfe_u32 v195, v191, 16, 1                        // w4a16: lsb of the bf16 mantissa
v_add3_u32 v195, v191, v195, v196                  // w4a16: add lsb + rounding bias
v_cndmask_b32 v191, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v191, 16, v191                       // w4a16: f32 -> bf16
v_cmp_u_f32 s8, v192, v192                         // w4a16: check Nan
v_bfe_u32 v195, v192, 16, 1                        // w4a16: lsb of the bf16 mantissa
v_add3_u32 v195, v192, v195, v196                  // w4a16: add lsb + rounding bias
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+0+0], v191, v192         // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x8, 0x4                     // w4a16: sign-extend int4 #2
v_bfe_i32 v192, v193, 0xc, 0x4                     // w4a16: sign-extend int4 #3
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
v_mul_f32 v191, v194, v191                         // w4a16: dequantize
v_mul_f32 v192, v194, v192                         // w4a16: dequantize
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+0+1], v191, v192         // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x10, 0x4                    // w4a16: sign-extend int4 #4
v_bfe_i32 v192, v193, 0x14, 0x4                    // w4a16: sign-extend int4 #5
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
v_mul_f32 v191, v194, v191                         // w4a16: dequantize
v_mul_f32 v192, v194, v192                         // w4a16: dequantize
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+0+2], v191, v192         // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x18, 0x4                    // w4a16: sign-extend int4 #6
v_bfe_i32 v192, v193, 0x1c, 0x4                    // w4a16: sign-extend int4 #7
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
v_mul_f32 v191, v194, v191                         // w4a16: dequantize
v_mul_f32 v192, v194, v192                         // w4a16: dequantize
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+0+3], v191, v192         // w4a16: pack 2 bf16
ds_store_b128 v[vgprLocalWriteAddrA+0], v[vgprG2LA+0:vgprG2LA+0+3] offset:0 // lwoA_0_0_0_0 = (0*LSCA)*(MT0I+PAD) + (0*LSPA) = 0 sync LDS0
v_mov_b32 v196, 0x7fff                             // w4a16: round-to-nearest-even bias for bf16
v_mov_b32 v197, 0x7fff0000                         // w4a16: bf16 Nan pattern
v_lshlrev_b32 v194, 16, v[vgprG2LScaleA+1]         // scaleA: bf16 -> f32
v_mov_b32 v193, v[vgprG2LA+6+0]                    // w4a16: save packed int4 dword 0
v_bfe_i32 v191, v193, 0x0, 0x4                     // w4a16: sign-extend int4 #0
v_bfe_i32 v192, v193, 0x4, 0x4                     // w4a16: sign-extend int4 #1
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+4+0], v191, v192         // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x8, 0x4                     // w4a16: sign-extend int4 #2
v_bfe_i32 v192, v193, 0xc, 0x4                     // w4a16: sign-extend int4 #3
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+4+1], v191, v192         // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x10, 0x4                    // w4a16: sign-extend int4 #4
v_bfe_i32 v192, v193, 0x14, 0x4                    // w4a16: sign-extend int4 #5
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+4+2], v191, v192         // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x18, 0x4                    // w4a16: sign-extend int4 #6
v_bfe_i32 v192, v193, 0x1c, 0x4                    // w4a16: sign-extend int4 #7
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+4+3], v191, v192         // w4a16: pack 2 bf16
...
v_mov_b32 v196, 0x7fff                             // w4a16: round-to-nearest-even bias for bf16
v_mov_b32 v197, 0x7fff0000                         // w4a16: bf16 Nan pattern
v_lshlrev_b32 v194, 16, v[vgprG2LScaleA+2]         // scaleA: bf16 -> f32
v_mov_b32 v193, v[vgprG2LA+10+0]                   // w4a16: save packed int4 dword 0
v_bfe_i32 v191, v193, 0x0, 0x4                     // w4a16: sign-extend int4 #0
v_bfe_i32 v192, v193, 0x4, 0x4                     // w4a16: sign-extend int4 #1
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+8+0], v191, v192         // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x8, 0x4                     // w4a16: sign-extend int4 #2
v_bfe_i32 v192, v193, 0xc, 0x4                     // w4a16: sign-extend int4 #3
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+8+1], v191, v192         // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x10, 0x4                    // w4a16: sign-extend int4 #4
v_bfe_i32 v192, v193, 0x14, 0x4                    // w4a16: sign-extend int4 #5
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+8+2], v191, v192         // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x18, 0x4                    // w4a16: sign-extend int4 #6
v_bfe_i32 v192, v193, 0x1c, 0x4                    // w4a16: sign-extend int4 #7
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+8+3], v191, v192         // w4a16: pack 2 bf16
...
v_mov_b32 v196, 0x7fff                             // w4a16: round-to-nearest-even bias for bf16
v_mov_b32 v197, 0x7fff0000                         // w4a16: bf16 Nan pattern
v_lshlrev_b32 v194, 16, v[vgprG2LScaleA+3]         // scaleA: bf16 -> f32
v_mov_b32 v193, v[vgprG2LA+14+0]                   // w4a16: save packed int4 dword 0
v_bfe_i32 v191, v193, 0x0, 0x4                     // w4a16: sign-extend int4 #0
v_bfe_i32 v192, v193, 0x4, 0x4                     // w4a16: sign-extend int4 #1
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+12+0], v191, v192        // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x8, 0x4                     // w4a16: sign-extend int4 #2
v_bfe_i32 v192, v193, 0xc, 0x4                     // w4a16: sign-extend int4 #3
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+12+1], v191, v192        // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x10, 0x4                    // w4a16: sign-extend int4 #4
v_bfe_i32 v192, v193, 0x14, 0x4                    // w4a16: sign-extend int4 #5
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+12+2], v191, v192        // w4a16: pack 2 bf16
v_bfe_i32 v191, v193, 0x18, 0x4                    // w4a16: sign-extend int4 #6
v_bfe_i32 v192, v193, 0x1c, 0x4                    // w4a16: sign-extend int4 #7
v_cvt_f32_i32 v191, v191                           // w4a16: int4 -> f32
v_cvt_f32_i32 v192, v192                           // w4a16: int4 -> f32
...
v_cndmask_b32 v192, v195, v197, s8                 // w4a16: keep Nan
v_lshrrev_b32 v192, 16, v192                       // w4a16: f32 -> bf16
v_pack_b32_f16 v[vgprG2LA+12+3], v191, v192        // w4a16: pack 2 bf16
...
/* Tail: add ValuA/B vgpr buffer [28...157) to pool */

/* Tail: add address/G2L vgpr [157...190) to pool */
...
/* computeStoreVgprs */
v_lshrrev_b32 v32, 5, v[vgprSerial]                // 32 = Serial / 32
v_lshrrev_b32 v33, 1, v32                          // 33 = 32 / 2
v_lshlrev_b32 v29, 4, v33                          // wave coordination offset 1
v_and_b32 v33, 15, v[vgprSerial]                   // v33 = v[vgprSerial] % 16
v_add_lshl_u32 v29, v33, v29, 0                    // coordination 1 = vwB *(wave_id1 + tid1)
v_mul_lo_u32 v30, v29, s[sgprStrideC1J]            //  offset 1
v_mul_lo_u32 v31, v29, s[sgprStrideD1J]            //  offset 1
v_and_b32 v33, 1, v32                              // v33 = v32 % 2
v_lshlrev_b32 v33, 4, v33                          // wave coordination offset 0
v_and_b32 v28, 31, v[vgprSerial]                   // v28 = v[vgprSerial] % 32
v_lshrrev_b32 v28, 4, v28                          // 28 = 28 / 16
                                                   // thread0 * continuous_output (multiplier is 1, do nothing)
v_add_lshl_u32 v28, v33, v28, 0                    // coordination 0 = vwA *(wave_id0 + tid0)
s_mul_i32 s8, 32, s[sgprWorkGroup0]                // wgp0 * MT0
v_add_nc_u32 v28, s8, v28                          // coord 0 = (tid0/MI_m)*4 + waveG0*MIB_m + MT0*SG0
s_mul_i32 s8, 32, s[sgprWorkGroup1]                // wgp1 * MT1
v_add_nc_u32 v29, s8, v29                          // coord 1 = (tid0%MI_m) + waveG1*MIB_n + MT1*SG1
...
/* edge=0, allocate 1 sgpr. perBatchTmpS=1 perBatchMaskS=0 perElementMaskS=0 elementsPerBatch=214 */
...
v_add_lshl_u32 v39, v31, v28, 2                    // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=28, coord0Vgpr=28 (multiple bpe)

/* rC *= alpha batchElements=[(0, 0, 0, 0), (0, 1, 0, 0), (0, 2, 0, 0), (0, 3, 0, 0), (0, 4, 0, 0), (0, 5, 0, 0), (0, 6, 0, 0), (0, 7, 0, 0)] */
v_mov_b32 v[vgprValuC+41], v[vgprValuC+0]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+42], v[vgprValuC+1]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+43], v[vgprValuC+2]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+44], v[vgprValuC+3]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+45], v[vgprValuC+4]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+46], v[vgprValuC+5]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+47], v[vgprValuC+6]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+48], v[vgprValuC+7]          // Rearrange MI out reg

/* apply mask, calc new C and issue writes */
buffer_store_b32 v41, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
buffer_store_b32 v42, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:8 // store D
buffer_store_b32 v43, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:16 // store D
buffer_store_b32 v44, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:24 // store D
buffer_store_b32 v45, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:32 // store D
buffer_store_b32 v46, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:40 // store D
buffer_store_b32 v47, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:48 // store D
buffer_store_b32 v48, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:56 // store D
...
/* edge=1, allocate 3 sgpr. perBatchTmpS=2 perBatchMaskS=1 perElementMaskS=0 elementsPerBatch=106 */
...
/* (d1,vc1,d0,vc0)=(0,0,0,0) */
v_cmp_lt_u32 s28, v28, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v47, v31, v28, 2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v47, v34, v47, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,1,0) */
v_add_co_u32 v32, vcc_lo, v28, 2                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v48, v31, v32, 2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v48, v34, v48, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,2,0) */
v_add_co_u32 v32, vcc_lo, v28, 4                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v49, v31, v32, 2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v49, v34, v49, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,3,0) */
v_add_co_u32 v32, vcc_lo, v28, 6                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v50, v31, v32, 2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v50, v34, v50, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,4,0) */
v_add_co_u32 v32, vcc_lo, v28, 8                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v51, v31, v32, 2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v51, v34, v51, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,5,0) */
v_add_co_u32 v32, vcc_lo, v28, 10                  // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v52, v31, v32, 2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v52, v34, v52, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,6,0) */
v_add_co_u32 v32, vcc_lo, v28, 12                  // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v53, v31, v32, 2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v53, v34, v53, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,7,0) */
v_add_co_u32 v32, vcc_lo, v28, 14                  // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v54, v31, v32, 2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v54, v34, v54, s30                   // LDD clip if OOB. offset

/* rC *= alpha batchElements=[(0, 0, 0, 0), (0, 1, 0, 0), (0, 2, 0, 0), (0, 3, 0, 0), (0, 4, 0, 0), (0, 5, 0, 0), (0, 6, 0, 0), (0, 7, 0, 0)] */
v_mov_b32 v[vgprValuC+39], v[vgprValuC+0]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+40], v[vgprValuC+1]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+41], v[vgprValuC+2]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+42], v[vgprValuC+3]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+43], v[vgprValuC+4]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+44], v[vgprValuC+5]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+45], v[vgprValuC+6]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+46], v[vgprValuC+7]          // Rearrange MI out reg

/* apply mask, calc new C and issue writes */
buffer_store_b32 v39, v47, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
buffer_store_b32 v40, v48, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
buffer_store_b32 v41, v49, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
buffer_store_b32 v42, v50, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
buffer_store_b32 v43, v51, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
buffer_store_b32 v44, v52, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
buffer_store_b32 v45, v53, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
buffer_store_b32 v46, v54, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_branch label_GW_End                              // jump to end
label_GW_End:
...
/* (d1,vc1,d0,vc0)=(0,0,6,0) */
/* (d1,vc1,d0,vc0)=(0,0,7,0) */
v_add_lshl_u32 v39, v31, v28, 1                    // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=28, coord0Vgpr=28 (multiple bpe)

/* rC *= alpha batchElements=[(0, 0, 0, 0), (0, 1, 0, 0), (0, 2, 0, 0), (0, 3, 0, 0), (0, 4, 0, 0), (0, 5, 0, 0), (0, 6, 0, 0), (0, 7, 0, 0)] */
v_mul_f32 v[vgprValuC+41], s[sgprAlpha], v[vgprValuC+0] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+42], s[sgprAlpha], v[vgprValuC+1] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+43], s[sgprAlpha], v[vgprValuC+2] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+44], s[sgprAlpha], v[vgprValuC+3] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+45], s[sgprAlpha], v[vgprValuC+4] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+46], s[sgprAlpha], v[vgprValuC+5] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+47], s[sgprAlpha], v[vgprValuC+6] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+48], s[sgprAlpha], v[vgprValuC+7] // Multiply MI out reg with alpha

/* apply mask, calc new C and issue writes */
v_mov_b32 v36, 0xffff0000                          // mask for pack two bfloat16 element to 32bit
v_mov_b32 v37, 0x7fff0000                          // fp32 Nan
v_mov_b32 v38, 0x7fff                              // rounding bias for bfloat16
v_cmp_u_f32 s8, v[vgprValuC+41], v[vgprValuC+41]   // check Nan
v_bfe_u32 v35, v[vgprValuC+41], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+41], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+41], v35, v37, s8
v_lshrrev_b32 v41, 16, v[vgprValuC+41]             // convert C to bf16
buffer_store_b16 v41, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s8, v[vgprValuC+42], v[vgprValuC+42]   // check Nan
v_bfe_u32 v35, v[vgprValuC+42], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+42], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+42], v35, v37, s8
v_lshrrev_b32 v42, 16, v[vgprValuC+42]             // convert C to bf16
buffer_store_b16 v42, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:4 // store D
v_cmp_u_f32 s8, v[vgprValuC+43], v[vgprValuC+43]   // check Nan
v_bfe_u32 v35, v[vgprValuC+43], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+43], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+43], v35, v37, s8
v_lshrrev_b32 v43, 16, v[vgprValuC+43]             // convert C to bf16
buffer_store_b16 v43, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:8 // store D
v_cmp_u_f32 s8, v[vgprValuC+44], v[vgprValuC+44]   // check Nan
v_bfe_u32 v35, v[vgprValuC+44], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+44], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+44], v35, v37, s8
v_lshrrev_b32 v44, 16, v[vgprValuC+44]             // convert C to bf16
buffer_store_b16 v44, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:12 // store D
v_cmp_u_f32 s8, v[vgprValuC+45], v[vgprValuC+45]   // check Nan
v_bfe_u32 v35, v[vgprValuC+45], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+45], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+45], v35, v37, s8
v_lshrrev_b32 v45, 16, v[vgprValuC+45]             // convert C to bf16
buffer_store_b16 v45, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:16 // store D
v_cmp_u_f32 s8, v[vgprValuC+46], v[vgprValuC+46]   // check Nan
v_bfe_u32 v35, v[vgprValuC+46], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+46], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+46], v35, v37, s8
v_lshrrev_b32 v46, 16, v[vgprValuC+46]             // convert C to bf16
buffer_store_b16 v46, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:20 // store D
v_cmp_u_f32 s8, v[vgprValuC+47], v[vgprValuC+47]   // check Nan
v_bfe_u32 v35, v[vgprValuC+47], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+47], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+47], v35, v37, s8
v_lshrrev_b32 v47, 16, v[vgprValuC+47]             // convert C to bf16
buffer_store_b16 v47, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:24 // store D
v_cmp_u_f32 s8, v[vgprValuC+48], v[vgprValuC+48]   // check Nan
v_bfe_u32 v35, v[vgprValuC+48], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+48], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+48], v35, v37, s8
v_lshrrev_b32 v48, 16, v[vgprValuC+48]             // convert C to bf16
buffer_store_b16 v48, v39, s[sgprSrdD:sgprSrdD+3], 0 offen offset:28 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
...
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v47, v31, v28, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v47, v34, v47, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,1,0) */
v_add_co_u32 v32, vcc_lo, v28, 2                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v48, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v48, v34, v48, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,2,0) */
v_add_co_u32 v32, vcc_lo, v28, 4                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v49, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v49, v34, v49, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,3,0) */
v_add_co_u32 v32, vcc_lo, v28, 6                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v50, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v50, v34, v50, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,4,0) */
v_add_co_u32 v32, vcc_lo, v28, 8                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v51, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v51, v34, v51, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,5,0) */
v_add_co_u32 v32, vcc_lo, v28, 10                  // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v52, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v52, v34, v52, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,6,0) */
v_add_co_u32 v32, vcc_lo, v28, 12                  // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v53, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v53, v34, v53, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,7,0) */
v_add_co_u32 v32, vcc_lo, v28, 14                  // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v54, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v54, v34, v54, s30                   // LDD clip if OOB. offset

/* rC *= alpha batchElements=[(0, 0, 0, 0), (0, 1, 0, 0), (0, 2, 0, 0), (0, 3, 0, 0), (0, 4, 0, 0), (0, 5, 0, 0), (0, 6, 0, 0), (0, 7, 0, 0)] */
v_mul_f32 v[vgprValuC+39], s[sgprAlpha], v[vgprValuC+0] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+40], s[sgprAlpha], v[vgprValuC+1] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+41], s[sgprAlpha], v[vgprValuC+2] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+42], s[sgprAlpha], v[vgprValuC+3] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+43], s[sgprAlpha], v[vgprValuC+4] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+44], s[sgprAlpha], v[vgprValuC+5] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+45], s[sgprAlpha], v[vgprValuC+6] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+46], s[sgprAlpha], v[vgprValuC+7] // Multiply MI out reg with alpha

/* apply mask, calc new C and issue writes */
v_mov_b32 v36, 0xffff0000                          // mask for pack two bfloat16 element to 32bit
v_mov_b32 v37, 0x7fff0000                          // fp32 Nan
v_mov_b32 v38, 0x7fff                              // rounding bias for bfloat16
v_cmp_u_f32 s28, v[vgprValuC+39], v[vgprValuC+39]  // check Nan
v_bfe_u32 v35, v[vgprValuC+39], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+39], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+39], v35, v37, s28
v_lshrrev_b32 v39, 16, v[vgprValuC+39]             // convert C to bf16
buffer_store_b16 v39, v47, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+40], v[vgprValuC+40]  // check Nan
v_bfe_u32 v35, v[vgprValuC+40], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+40], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+40], v35, v37, s28
v_lshrrev_b32 v40, 16, v[vgprValuC+40]             // convert C to bf16
buffer_store_b16 v40, v48, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+41], v[vgprValuC+41]  // check Nan
v_bfe_u32 v35, v[vgprValuC+41], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+41], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+41], v35, v37, s28
v_lshrrev_b32 v41, 16, v[vgprValuC+41]             // convert C to bf16
buffer_store_b16 v41, v49, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+42], v[vgprValuC+42]  // check Nan
v_bfe_u32 v35, v[vgprValuC+42], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+42], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+42], v35, v37, s28
v_lshrrev_b32 v42, 16, v[vgprValuC+42]             // convert C to bf16
buffer_store_b16 v42, v50, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+43], v[vgprValuC+43]  // check Nan
v_bfe_u32 v35, v[vgprValuC+43], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+43], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+43], v35, v37, s28
v_lshrrev_b32 v43, 16, v[vgprValuC+43]             // convert C to bf16
buffer_store_b16 v43, v51, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+44], v[vgprValuC+44]  // check Nan
v_bfe_u32 v35, v[vgprValuC+44], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+44], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+44], v35, v37, s28
v_lshrrev_b32 v44, 16, v[vgprValuC+44]             // convert C to bf16
buffer_store_b16 v44, v52, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+45], v[vgprValuC+45]  // check Nan
v_bfe_u32 v35, v[vgprValuC+45], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+45], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+45], v35, v37, s28
v_lshrrev_b32 v45, 16, v[vgprValuC+45]             // convert C to bf16
buffer_store_b16 v45, v53, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_u_f32 s28, v[vgprValuC+46], v[vgprValuC+46]  // check Nan
v_bfe_u32 v35, v[vgprValuC+46], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+46], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+46], v35, v37, s28
v_lshrrev_b32 v46, 16, v[vgprValuC+46]             // convert C to bf16
buffer_store_b16 v46, v54, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_branch label_GW_End_1                            // jump to end
label_GW_B1_GSU1:
...
/* edge=0, allocate 1 sgpr. perBatchTmpS=1 perBatchMaskS=0 perElementMaskS=0 elementsPerBatch=106 */
/* optSingleColVgpr=1 optSharedColVgpr=0 optSGPRUsage=BufferLoad_Mask optSrdIncForRow=1 factorDim=0 */
...
/* calc coords, apply mask, and issue loads (if necessary) */
/* (d1,vc1,d0,vc0)=(0,0,0,0) */
v_add_lshl_u32 v40, v30, v28, 1                    // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=28, coord0Vgpr=28 (multiple bpe)
buffer_load_d16_b16 v49, v40, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
/* (d1,vc1,d0,vc0)=(0,0,1,0) */
buffer_load_d16_b16 v50, v40, s[sgprSrdC:sgprSrdC+3], 0 offen offset:4 // load C
/* (d1,vc1,d0,vc0)=(0,0,2,0) */
buffer_load_d16_b16 v51, v40, s[sgprSrdC:sgprSrdC+3], 0 offen offset:8 // load C
/* (d1,vc1,d0,vc0)=(0,0,3,0) */
buffer_load_d16_b16 v52, v40, s[sgprSrdC:sgprSrdC+3], 0 offen offset:12 // load C
/* (d1,vc1,d0,vc0)=(0,0,4,0) */
buffer_load_d16_b16 v53, v40, s[sgprSrdC:sgprSrdC+3], 0 offen offset:16 // load C
/* (d1,vc1,d0,vc0)=(0,0,5,0) */
buffer_load_d16_b16 v54, v40, s[sgprSrdC:sgprSrdC+3], 0 offen offset:20 // load C
/* (d1,vc1,d0,vc0)=(0,0,6,0) */
buffer_load_d16_b16 v55, v40, s[sgprSrdC:sgprSrdC+3], 0 offen offset:24 // load C
/* (d1,vc1,d0,vc0)=(0,0,7,0) */
buffer_load_d16_b16 v56, v40, s[sgprSrdC:sgprSrdC+3], 0 offen offset:28 // load C
v_add_lshl_u32 v39, v31, v28, 1                    // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=28, coord0Vgpr=28 (multiple bpe)
...
v_lshlrev_b32 v32, 16, v49                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+41], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+41], v[vgprValuC+41]   // check Nan
v_bfe_u32 v35, v[vgprValuC+41], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+41], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+41], v35, v37, s8
...
v_lshlrev_b32 v32, 16, v50                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+42], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+42], v[vgprValuC+42]   // check Nan
v_bfe_u32 v35, v[vgprValuC+42], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+42], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+42], v35, v37, s8
...
v_lshlrev_b32 v32, 16, v51                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+43], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+43], v[vgprValuC+43]   // check Nan
v_bfe_u32 v35, v[vgprValuC+43], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+43], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+43], v35, v37, s8
...
v_lshlrev_b32 v32, 16, v52                         // cvt bf16 to fp32. 
...
v_lshlrev_b32 v32, 16, v53                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+45], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+45], v[vgprValuC+45]   // check Nan
v_bfe_u32 v35, v[vgprValuC+45], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+45], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+45], v35, v37, s8
...
v_lshlrev_b32 v32, 16, v54                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+46], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+46], v[vgprValuC+46]   // check Nan
v_bfe_u32 v35, v[vgprValuC+46], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+46], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+46], v35, v37, s8
...
v_lshlrev_b32 v32, 16, v55                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+47], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+47], v[vgprValuC+47]   // check Nan
v_bfe_u32 v35, v[vgprValuC+47], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+47], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+47], v35, v37, s8
...
v_lshlrev_b32 v32, 16, v56                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+48], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s8, v[vgprValuC+48], v[vgprValuC+48]   // check Nan
v_bfe_u32 v35, v[vgprValuC+48], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+48], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+48], v35, v37, s8
...
/* edge=1, allocate 3 sgpr. perBatchTmpS=2 perBatchMaskS=1 perElementMaskS=0 elementsPerBatch=70 */
/* optSingleColVgpr=0 optSharedColVgpr=0 optSGPRUsage=BufferLoad_Edge_Mask optSrdIncForRow=0 factorDim=0 */
...
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v48, v30, v28, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v48, v34, v48, s30                   // LDC clip if OOB. offset
buffer_load_d16_b16 v47, v48, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v48, v31, v28, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v48, v34, v48, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,1,0) */
v_add_co_u32 v32, vcc_lo, v28, 2                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v50, v30, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v50, v34, v50, s30                   // LDC clip if OOB. offset
buffer_load_d16_b16 v49, v50, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v50, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v50, v34, v50, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,2,0) */
v_add_co_u32 v32, vcc_lo, v28, 4                   // coord0.1: coord0 += d0*sg0*VW + vc0
...
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v52, v30, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v52, v34, v52, s30                   // LDC clip if OOB. offset
buffer_load_d16_b16 v51, v52, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v52, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v52, v34, v52, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,3,0) */
v_add_co_u32 v32, vcc_lo, v28, 6                   // coord0.1: coord0 += d0*sg0*VW + vc0
...
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v54, v30, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v54, v34, v54, s30                   // LDC clip if OOB. offset
buffer_load_d16_b16 v53, v54, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v54, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v54, v34, v54, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,4,0) */
v_add_co_u32 v32, vcc_lo, v28, 8                   // coord0.1: coord0 += d0*sg0*VW + vc0
...
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v56, v30, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v56, v34, v56, s30                   // LDC clip if OOB. offset
buffer_load_d16_b16 v55, v56, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v56, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v56, v34, v56, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,5,0) */
v_add_co_u32 v32, vcc_lo, v28, 10                  // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v58, v30, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v58, v34, v58, s30                   // LDC clip if OOB. offset
buffer_load_d16_b16 v57, v58, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v58, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v58, v34, v58, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,6,0) */
v_add_co_u32 v32, vcc_lo, v28, 12                  // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v60, v30, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v60, v34, v60, s30                   // LDC clip if OOB. offset
buffer_load_d16_b16 v59, v60, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v60, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v60, v34, v60, s30                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,7,0) */
v_add_co_u32 v32, vcc_lo, v28, 14                  // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s28, v32, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s30, v29, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s30, s28, s30                            // in0 && in1
v_add_lshl_u32 v62, v30, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v62, v34, v62, s30                   // LDC clip if OOB. offset
buffer_load_d16_b16 v61, v62, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v62, v31, v32, 1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr (multiple bpe)
v_cndmask_b32 v62, v34, v62, s30                   // LDD clip if OOB. offset
...
v_mov_b32 v37, 0x7fff0000                          // fp32 Nan
v_mov_b32 v38, 0x7fff                              // rounding bias for bfloat16
v_lshlrev_b32 v32, 16, v47                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+39], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+39], v[vgprValuC+39]  // check Nan
v_bfe_u32 v35, v[vgprValuC+39], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+39], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+39], v35, v37, s28
v_lshrrev_b32 v39, 16, v[vgprValuC+39]             // convert C to bf16
buffer_store_b16 v39, v48, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_lshlrev_b32 v32, 16, v49                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+40], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+40], v[vgprValuC+40]  // check Nan
v_bfe_u32 v35, v[vgprValuC+40], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+40], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+40], v35, v37, s28
v_lshrrev_b32 v40, 16, v[vgprValuC+40]             // convert C to bf16
buffer_store_b16 v40, v50, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_lshlrev_b32 v32, 16, v51                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+41], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+41], v[vgprValuC+41]  // check Nan
v_bfe_u32 v35, v[vgprValuC+41], 16, 1              // Non-Nan case: store lsb of bf16
...
v_cndmask_b32 v[vgprValuC+41], v35, v37, s28
v_lshrrev_b32 v41, 16, v[vgprValuC+41]             // convert C to bf16
buffer_store_b16 v41, v52, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_lshlrev_b32 v32, 16, v53                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+42], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+42], v[vgprValuC+42]  // check Nan
v_bfe_u32 v35, v[vgprValuC+42], 16, 1              // Non-Nan case: store lsb of bf16
...
v_cndmask_b32 v[vgprValuC+42], v35, v37, s28
v_lshrrev_b32 v42, 16, v[vgprValuC+42]             // convert C to bf16
buffer_store_b16 v42, v54, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_lshlrev_b32 v32, 16, v55                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+43], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+43], v[vgprValuC+43]  // check Nan
v_bfe_u32 v35, v[vgprValuC+43], 16, 1              // Non-Nan case: store lsb of bf16
...
v_cndmask_b32 v[vgprValuC+43], v35, v37, s28
v_lshrrev_b32 v43, 16, v[vgprValuC+43]             // convert C to bf16
buffer_store_b16 v43, v56, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_lshlrev_b32 v32, 16, v57                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+44], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+44], v[vgprValuC+44]  // check Nan
v_bfe_u32 v35, v[vgprValuC+44], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+44], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+44], v35, v37, s28
v_lshrrev_b32 v44, 16, v[vgprValuC+44]             // convert C to bf16
buffer_store_b16 v44, v58, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_lshlrev_b32 v32, 16, v59                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+45], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+45], v[vgprValuC+45]  // check Nan
v_bfe_u32 v35, v[vgprValuC+45], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+45], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+45], v35, v37, s28
v_lshrrev_b32 v45, 16, v[vgprValuC+45]             // convert C to bf16
buffer_store_b16 v45, v60, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_lshlrev_b32 v32, 16, v61                         // cvt bf16 to fp32. 
v_fmac_f32 v[vgprValuC+46], v32, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_cmp_u_f32 s28, v[vgprValuC+46], v[vgprValuC+46]  // check Nan
v_bfe_u32 v35, v[vgprValuC+46], 16, 1              // Non-Nan case: store lsb of bf16
v_add3_u32 v35, v[vgprValuC+46], v35, v38          // Non-Nan case: add lsb and the increment for rounding
v_cndmask_b32 v[vgprValuC+46], v35, v37, s28
v_lshrrev_b32 v46, 16, v[vgprValuC+46]             // convert C to bf16
buffer_store_b16 v46, v62, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_branch label_GW_End_1                            // jump to end
label_GW_End_1:
label_KernelEnd:
