...
# TODO: Add an option to read tile sizes from the existing library (use injection tool)
# TODO: how about b8f8 datatype?
# TODO: Adjust based on the new changes
# Usage:
# indivitual size: $ python3 origami_test.py -m 2048 -n 2048 -k 2048 --trans_a T --trans_b N --debug --print
# read sizes from a file: $ python3 origami_test.py -m 1 -n 1 -k 1 -b 1 --trans_a T --trans_b N --type_a bf16 --type_b bf16 --type_d  bf16 --sizes Ture --path ./sizes.csv --arch "gfx950" --debug --print
...
def parseArguments():
    ...
    parser.add_argument("--device", type=int, default=0) # to get hardware specs. No need to change
    ...
    parser.add_argument("--sizes", type=bool, default=False) # to load the sizes from a csv file. m/n/k will be ignored if True (still using transA/B).
            ...
            for wave in LIST_OF_WAVEs_TO_INCLUDE:
                ...
                while True:
                    ...
                    while True:
                        ...
                        if MT0*MT1 > 256*256:
                            continue
                        for DU in [32, 64, 128, 256, 512]: # TODO: probably add 16, 1024?
...
def main():
    ...
    if args.sizes: # sizes from a file
      try:
        ...
        raise(f"Error: The size file: '{args.path}' does not exist.")
