...
Production callers (boundary contract per docs/subtile_cpp_boundary.md):
  ...
  geometry           — Kernel.py (_cppgeo): C++ subtile geometry, exposed directly
  ...
  module_builder     — Kernel.py
  tile_info          — Kernel.py (_CPP_TI)
"""

from tensile_writer import _tensile_writer as _ext
geometry = _ext.subtile.geometry  # expose C++ geometry submodule directly (no Python shim)
