...
; llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx950 -mattr='-fma-mix-insts' -O3 <.optimized.ll> -o <out.rocmasm>
	...
	.text
	.globl	wave_mxfp4_static_gemm_256x160x256_6656x2560x3328
	.p2align	8
	.type	wave_mxfp4_static_gemm_256x160x256_6656x2560x3328,@function
wave_mxfp4_static_gemm_256x160x256_6656x2560x3328:
...
.LBB0_0:
	...
	s_mov_b32 m0, s33
	s_or_b32 s34, s33, 0x2000
	v_xor_b32_e32 v9, v10, v9
	buffer_load_dwordx4 v5, s[24:27], 0 offen lds
	v_add_u32_e32 v6, 0x1a000, v5
	s_mov_b32 m0, s34
	s_or_b32 s35, s33, 0x4000
	v_ashrrev_i32_e32 v11, 31, v9
	buffer_load_dwordx4 v6, s[24:27], 0 offen lds
	v_add_u32_e32 v6, 0x34000, v5
	s_mov_b32 m0, s35
	s_or_b32 s36, s33, 0x6000
	v_lshrrev_b32_e32 v11, 29, v11
	buffer_load_dwordx4 v6, s[24:27], 0 offen lds
	v_add_u32_e32 v5, 0x4e000, v5
	s_mov_b32 m0, s36
	...
	s_mov_b32 s37, 0x4ec4ec4f
	v_mul_hi_i32 v14, v14, s37
	...
	s_add_u32 s4, s4, s3
	v_mul_lo_u16_e32 v19, 10, v19
	s_movk_i32 s48, 0xff98
	s_movk_i32 s49, 0xffc0
	s_addc_u32 s2, s5, s2
	s_and_b32 s3, s14, 0x3fff
	v_mul_i32_i24_sdwa v23, v19, s48 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:DWORD
	v_lshlrev_b32_e32 v19, 6, v80
	v_mad_i32_i24 v25, v21, s49, v85
	s_bitset1_b32 s3, 14
	...
	v_mad_u64_u32 v[28:29], s[2:3], v33, s48, v[28:29]
	...
	buffer_load_ubyte v123, v26, s[28:31], 0 offen
	buffer_load_ubyte v117, v27, s[28:31], 0 offen offset:2
	buffer_load_ubyte v122, v32, s[28:31], 0 offen offset:1
	buffer_load_ubyte v116, v34, s[28:31], 0 offen offset:3
	buffer_load_ubyte v115, v35, s[28:31], 0 offen
	buffer_load_ubyte v97, v37, s[28:31], 0 offen offset:2
	buffer_load_ubyte v111, v30, s[28:31], 0 offen offset:1
	buffer_load_ubyte v94, v28, s[28:31], 0 offen offset:3
	v_add_u32_e32 v26, s6, v35
	v_add_u32_e32 v27, s6, v37
	buffer_load_ubyte v114, v26, s[28:31], 0 offen
	buffer_load_ubyte v96, v27, s[28:31], 0 offen offset:2
...
.LBB0_2:
	...
	v_or_b32_e32 v93, v3, v27
	v_or_b32_e32 v95, v21, v3
	...
	v_sub_u32_e32 v101, v0, v11
	v_add3_u32 v0, v20, v22, v19
	v_sub_u32_e32 v104, 0, v0
	v_add_u32_e32 v0, v24, v20
	v_add_u32_e32 v105, v20, v19
	v_add3_u32 v0, v0, v23, v19
	s_mov_b32 s0, 0x4e100
	v_add_u32_e32 v106, v105, v22
	v_add3_u32 v109, v25, v19, v23
	v_sub_u32_e32 v110, 0, v0
	v_add_u32_e32 v0, v18, v17
	v_mov_b32_e32 v12, 0
	v_sub_u32_e32 v99, 0, v83
	v_add3_u32 v102, v2, v1, s0
	v_sub_u32_e32 v103, 0, v85
	v_add_u32_e32 v107, 32, v88
	v_add_u32_e32 v108, 64, v88
	v_add_u32_e32 v112, 32, v81
	v_sub_u32_e32 v113, 0, v0
	s_add_i32 s0, s33, 0x8000
	s_add_i32 s1, s34, 0x8000
	s_add_i32 s17, s35, 0x8000
	s_add_i32 s51, s36, 0x8000
	...
	s_add_i32 s60, s60, 0x15000
	s_add_i32 s61, s61, 0x15000
	v_add_u32_e32 v118, 0x10000, v93
	s_movk_i32 s62, 0x4ec5
	s_mov_b32 s6, s26
	s_mov_b32 s7, s27
	...
	s_mov_b32 s30, s26
	s_mov_b32 s31, s27
	s_movk_i32 s65, 0xfefd
	s_movk_i32 s66, 0xfefe
	s_movk_i32 s67, 0xffcf
	v_add_u32_e32 v119, 0x10000, v95
	v_add_u32_e32 v120, 0x15000, v93
	v_add_u32_e32 v121, 0x15000, v95
...
.LBB0_3:
	s_mov_b32 m0, s0
	v_add_u32_e32 v126, 0xfffb1f80, v102
	s_waitcnt vmcnt(0)
	s_barrier
	buffer_load_dwordx4 v126, s[24:27], 0 offen lds
	v_add_u32_e32 v126, 0xfffcbf80, v102
	s_mov_b32 m0, s1
	v_add_u32_e32 v164, v83, v101
	buffer_load_dwordx4 v126, s[24:27], 0 offen lds
	v_add_u32_e32 v126, 0xfffe5f80, v102
	s_mov_b32 m0, s17
	v_add_u32_e32 v165, v99, v100
	buffer_load_dwordx4 v126, s[24:27], 0 offen lds
	v_add_u32_e32 v126, 0xffffff80, v102
	s_mov_b32 m0, s51
	...
	v_add_u32_e32 v127, 0x60, v164
	v_add_u32_e32 v128, 0xffffff9f, v165
	v_cmp_gt_i32_e32 vcc, 0, v127
	v_mul_lo_u32 v126, v126, s19
	s_nop 0
	v_cndmask_b32_e32 v128, v127, v128, vcc
	v_mul_hi_i32 v128, v128, s37
	v_lshrrev_b32_e32 v129, 31, v128
	v_lshrrev_b32_e32 v128, 7, v128
	v_add_u32_e32 v128, v128, v129
	v_ashrrev_i32_e32 v127, 31, v127
	v_xor_b32_e32 v127, v128, v127
	v_mul_i32_i24_e32 v127, 0xfffff980, v127
	v_add3_u32 v126, v127, v126, v166
	v_add_u32_e32 v127, 0x180, v126
	buffer_load_dword v127, s[20:23], 0 offen lds
	v_add_u32_e32 v127, 0x6980, v126
	s_mov_b32 m0, s53
	s_nop 0
	buffer_load_dword v127, s[20:23], 0 offen lds
	v_add_u32_e32 v127, 0xd180, v126
	s_mov_b32 m0, s54
	s_nop 0
	buffer_load_dword v127, s[20:23], 0 offen lds
	v_add_u32_e32 v127, 0x13980, v126
	s_mov_b32 m0, s55
	s_nop 0
	buffer_load_dword v127, s[20:23], 0 offen lds
	v_add_u32_e32 v127, 0x1a180, v126
	s_mov_b32 m0, s56
	s_nop 0
	buffer_load_dword v127, s[20:23], 0 offen lds
	v_add_u32_e32 v127, 0x20980, v126
	s_mov_b32 m0, s57
	s_nop 0
	buffer_load_dword v127, s[20:23], 0 offen lds
	v_add_u32_e32 v127, 0x27180, v126
	s_mov_b32 m0, s58
	s_nop 0
	buffer_load_dword v127, s[20:23], 0 offen lds
	v_add_u32_e32 v127, 0x2d980, v126
	s_mov_b32 m0, s59
	s_nop 0
	buffer_load_dword v127, s[20:23], 0 offen lds
	v_add_u32_e32 v127, 0x34180, v126
	s_mov_b32 m0, s60
	v_add_u32_e32 v126, 0x3a980, v126
	buffer_load_dword v127, s[20:23], 0 offen lds
	s_mov_b32 m0, s61
	s_nop 0
	buffer_load_dword v126, s[20:23], 0 offen lds
	v_add_u32_e32 v167, v83, v86
	v_add_u32_e32 v169, v99, v113
	v_add_u32_e32 v168, 64, v167
	v_add_u32_e32 v126, 0xffbf, v169
	v_cmp_gt_i32_e32 vcc, s49, v167
	v_add_u32_e32 v128, 12, v167
	v_add_u32_e32 v129, 0xfff3, v169
	v_cndmask_b32_e32 v126, v168, v126, vcc
	v_mul_i32_i24_sdwa v126, sext(v126), s62 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	v_lshrrev_b32_e32 v127, 31, v126
	v_ashrrev_i32_e32 v126, 19, v126
	v_add_u16_e32 v126, v126, v127
	v_cndmask_b32_e64 v127, 0, -1, vcc
	v_cmp_gt_i32_e32 vcc, -12, v167
	...
	v_mul_i32_i24_sdwa v128, sext(v128), s62 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	v_lshrrev_b32_e32 v129, 31, v128
	v_ashrrev_i32_e32 v128, 19, v128
	v_add_u16_e32 v128, v128, v129
	v_cndmask_b32_e64 v129, 0, -1, vcc
	v_xor_b32_e32 v128, v128, v129
	v_add_u32_sdwa v126, v112, sext(v126) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_bfe_i32 v128, v128, 0, 16
	v_mul_lo_u32 v127, v127, s14
	v_mul_lo_u32 v126, s14, v126
	v_add_u32_e32 v170, v85, v106
	v_add_u32_e32 v172, v103, v104
	v_mad_i32_i24 v127, v128, s48, v127
	v_mad_i32_i24 v126, v128, s48, v126
	v_add_u32_e32 v171, 0x100, v170
	v_add_u32_e32 v128, 0xfffffeff, v172
	v_cmp_gt_i32_e32 vcc, s63, v170
	v_add_u32_e32 v130, 48, v170
	v_subrev_u32_e32 v131, 49, v172
	...
	v_add_u32_e32 v128, v128, v129
	v_cndmask_b32_e64 v129, 0, -1, vcc
	v_cmp_gt_i32_e32 vcc, s13, v170
	v_add_u32_e32 v132, 0xfffffefd, v172
	v_add_u32_e32 v174, v85, v109
	v_cndmask_b32_e32 v130, v130, v131, vcc
	v_mul_hi_i32 v130, v130, s37
	...
	v_add_u32_e32 v142, v107, v128
	v_add_u32_e32 v143, v107, v133
	...
	buffer_load_ubyte v177, v129, s[28:31], 0 offen offset:48
	buffer_load_ubyte v178, v132, s[28:31], 0 offen offset:258
	buffer_load_ubyte v179, v135, s[28:31], 0 offen offset:49
	buffer_load_ubyte v180, v141, s[28:31], 0 offen offset:259
	buffer_load_ubyte v181, v142, s[28:31], 0 offen offset:48
	buffer_load_ubyte v182, v143, s[28:31], 0 offen offset:258
	buffer_load_ubyte v183, v134, s[28:31], 0 offen offset:49
	buffer_load_ubyte v184, v136, s[28:31], 0 offen offset:259
	v_add_u32_e32 v128, v108, v128
	v_mul_lo_u32 v128, s12, v128
	v_add_u32_e32 v129, v108, v133
	v_sub_u32_e32 v128, v128, v130
	v_mul_lo_u32 v129, s12, v129
	v_add3_u32 v127, v85, v127, v105
	v_add3_u32 v126, v85, v126, v105
	v_add_u32_e32 v128, v173, v128
	v_sub_u32_e32 v129, v129, v131
	buffer_load_dword v127, v127, s[4:7], 0 offen offset:48
	s_nop 0
	buffer_load_dword v126, v126, s[4:7], 0 offen offset:48
	v_add3_u32 v129, v85, v129, v125
	buffer_load_ubyte v185, v128, s[28:31], 0 offen offset:48
	buffer_load_ubyte v186, v129, s[28:31], 0 offen offset:258
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[72:75], v[128:131], v[152:155], v[72:75], v87, v115 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[68:71], v[128:131], v[156:159], v[68:71], v87, v111 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[64:67], v[128:131], v[188:191], v[64:67], v87, v114 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[52:55], v[132:135], v[152:155], v[52:55], v87, v115 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[48:51], v[132:135], v[156:159], v[48:51], v87, v111 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[44:47], v[132:135], v[188:191], v[44:47], v87, v114 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[132:135], v[140:143], v[152:155], v[20:23], v84, v115 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[136:139], v[140:143], v[156:159], v[16:19], v84, v111 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[140:143], v[140:143], v[188:191], v[24:27], v84, v114 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[152:155], v[160:163], v[152:155], v[8:11], v84, v115 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[156:159], v[160:163], v[156:159], v[4:7], v84, v111 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[160:163], v[160:163], v[188:191], v[0:3], v84, v114 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_setprio 0
	s_barrier
	...
	v_and_b32_e32 v111, 0xff, v117
	s_waitcnt lgkmcnt(3)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[4:7], v[16:19], v[200:203], v[76:79], v87, v114 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	s_nop 2
	v_and_b32_e32 v76, 0xff, v97
	v_and_b32_e32 v77, 0xff, v96
	v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[16:19], v[196:199], v[12:15], v87, v111 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[8:11], v[16:19], v[204:207], v[72:75], v87, v76 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	s_nop 2
	v_and_b32_e32 v72, 0xff, v94
	v_mfma_scale_f32_16x16x128_f8f6f4 v[20:23], v[36:39], v[196:199], v[60:63], v87, v111 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(1)
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[24:27], v[36:39], v[200:203], v[56:59], v87, v114 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[40:43], v[188:191], v[196:199], v[40:43], v84, v111 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[44:47], v[188:191], v[200:203], v[128:131], v84, v114 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[60:63], v[192:195], v[196:199], v[144:147], v84, v111 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[64:67], v[192:195], v[200:203], v[148:151], v84, v114 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	...
	s_setprio 0
	s_mov_b32 m0, s33
	v_add_u32_e32 v84, 0xfffb2000, v102
	s_waitcnt vmcnt(0)
	s_barrier
	buffer_load_dwordx4 v84, s[24:27], 0 offen lds
	v_add_u32_e32 v84, 0xfffcc000, v102
	s_mov_b32 m0, s34
	v_add_u32_e32 v87, 0xfffffbff, v165
	buffer_load_dwordx4 v84, s[24:27], 0 offen lds
	v_add_u32_e32 v84, 0xfffe6000, v102
	s_mov_b32 m0, s35
	s_nop 0
	buffer_load_dwordx4 v84, s[24:27], 0 offen lds
	...
	v_mul_hi_i32 v87, v87, s37
	v_lshrrev_b32_e32 v94, 31, v87
	v_lshrrev_b32_e32 v87, 7, v87
	v_add_u32_e32 v87, v87, v94
	v_ashrrev_i32_e32 v84, 31, v84
	v_xor_b32_e32 v84, v87, v84
	v_add_u32_e32 v87, 0x260, v164
	v_add_u32_e32 v94, 0xfffffd9f, v165
	v_cmp_gt_i32_e32 vcc, 0, v87
	v_mul_lo_u32 v84, v84, s19
	buffer_load_dwordx4 v102, s[24:27], 0 offen lds
	v_cndmask_b32_e32 v94, v87, v94, vcc
	v_mul_hi_i32 v94, v94, s37
	v_lshrrev_b32_e32 v96, 31, v94
	v_lshrrev_b32_e32 v94, 7, v94
	v_add_u32_e32 v94, v94, v96
	v_ashrrev_i32_e32 v87, 31, v87
	v_xor_b32_e32 v87, v94, v87
	v_mul_i32_i24_e32 v87, 0xfffff980, v87
	v_add3_u32 v84, v87, v84, v166
	v_add_u32_e32 v87, 0x980, v84
	s_mov_b32 m0, s38
	s_nop 0
	buffer_load_dword v87, s[20:23], 0 offen lds
	v_add_u32_e32 v87, 0x7180, v84
	s_mov_b32 m0, s39
	s_nop 0
	buffer_load_dword v87, s[20:23], 0 offen lds
	v_add_u32_e32 v87, 0xd980, v84
	s_mov_b32 m0, s40
	s_nop 0
	buffer_load_dword v87, s[20:23], 0 offen lds
	v_add_u32_e32 v87, 0x14180, v84
	s_mov_b32 m0, s41
	s_nop 0
	buffer_load_dword v87, s[20:23], 0 offen lds
	v_add_u32_e32 v87, 0x1a980, v84
	s_mov_b32 m0, s42
	s_nop 0
	buffer_load_dword v87, s[20:23], 0 offen lds
	v_add_u32_e32 v87, 0x21180, v84
	s_mov_b32 m0, s43
	s_nop 0
	buffer_load_dword v87, s[20:23], 0 offen lds
	v_add_u32_e32 v87, 0x27980, v84
	s_mov_b32 m0, s44
	s_nop 0
	buffer_load_dword v87, s[20:23], 0 offen lds
	v_add_u32_e32 v87, 0x2e180, v84
	s_mov_b32 m0, s45
	s_nop 0
	buffer_load_dword v87, s[20:23], 0 offen lds
	v_add_u32_e32 v87, 0x34980, v84
	s_mov_b32 m0, s46
	v_add_u32_e32 v84, 0x3b180, v84
	buffer_load_dword v87, s[20:23], 0 offen lds
	s_mov_b32 m0, s47
	s_nop 0
	...
	v_cmp_gt_i32_e32 vcc, s49, v168
	v_add_u32_e32 v94, 0x4c, v167
	v_add_u32_e32 v96, 0xffb3, v169
	v_cndmask_b32_e32 v84, v84, v87, vcc
	v_mul_i32_i24_sdwa v84, sext(v84), s62 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	v_lshrrev_b32_e32 v87, 31, v84
	v_ashrrev_i32_e32 v84, 19, v84
	v_add_u16_e32 v84, v84, v87
	v_cndmask_b32_e64 v87, 0, -1, vcc
	v_cmp_gt_i32_e32 vcc, -12, v168
	...
	v_mul_i32_i24_sdwa v94, sext(v94), s62 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	v_lshrrev_b32_e32 v96, 31, v94
	v_ashrrev_i32_e32 v94, 19, v94
	v_add_u16_e32 v94, v94, v96
	v_cndmask_b32_e64 v96, 0, -1, vcc
	v_xor_b32_e32 v94, v94, v96
	v_add_u32_sdwa v84, v112, sext(v84) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_bfe_i32 v94, v94, 0, 16
	v_mul_lo_u32 v87, v87, s14
	v_mul_lo_u32 v84, s14, v84
	v_mad_i32_i24 v87, v94, s48, v87
	v_mad_i32_i24 v84, v94, s48, v84
	v_add_u32_e32 v94, 0x200, v170
	v_add_u32_e32 v96, 0xfffffdff, v172
	v_cmp_gt_i32_e32 vcc, s63, v171
	v_add_u32_e32 v111, 0x130, v170
	v_add_u32_e32 v114, 0xfffffecf, v172
	v_cndmask_b32_e32 v96, v94, v96, vcc
	v_cmp_gt_i32_e32 vcc, s13, v171
	v_mul_hi_i32 v96, v96, s37
	v_lshrrev_b32_e32 v97, 31, v96
	v_cndmask_b32_e32 v114, v111, v114, vcc
	v_mul_hi_i32 v114, v114, s37
	v_lshrrev_b32_e32 v115, 31, v114
	v_ashrrev_i32_e32 v114, 5, v114
	v_add_u32_e32 v114, v114, v115
	v_ashrrev_i32_e32 v111, 31, v111
	v_xor_b32_e32 v111, v114, v111
	v_ashrrev_i32_e32 v96, 5, v96
	v_mul_lo_u32 v114, v111, s15
	v_add_u32_e32 v111, 0x202, v170
	v_add_u32_e32 v115, 0xfffffdfd, v172
	v_cmp_gt_i32_e32 vcc, -2, v94
	v_add_u32_e32 v96, v96, v97
	v_ashrrev_i32_e32 v97, 31, v94
	v_cndmask_b32_e32 v94, v111, v115, vcc
	v_mul_hi_i32 v94, v94, s37
	v_lshrrev_b32_e32 v116, 31, v94
	v_ashrrev_i32_e32 v94, 5, v94
	v_cmp_gt_i32_e32 vcc, s66, v171
	v_add_u32_e32 v94, v94, v116
	v_ashrrev_i32_e32 v116, 31, v111
	v_cndmask_b32_e32 v111, v111, v115, vcc
	v_mul_hi_i32 v111, v111, s37
	v_lshrrev_b32_e32 v115, 31, v111
	v_ashrrev_i32_e32 v111, 5, v111
	v_add_u32_e32 v111, v111, v115
	v_xor_b32_e32 v111, v111, v116
	v_mul_lo_u32 v129, v111, s15
	v_add_u32_e32 v111, 0x201, v174
	v_add_u32_e32 v115, 0xfffffdfe, v175
	v_cmp_gt_i32_e32 vcc, s64, v176
	v_xor_b32_e32 v128, v94, v116
	v_add_u32_e32 v117, 0xfffffece, v175
	v_cndmask_b32_e32 v115, v111, v115, vcc
	v_mul_hi_i32 v115, v115, s37
	v_lshrrev_b32_e32 v116, 31, v115
	v_ashrrev_i32_e32 v115, 5, v115
	v_add_u32_e32 v115, v115, v116
	v_add_u32_e32 v116, 0x131, v174
	v_cmp_gt_i32_e32 vcc, s67, v176
	v_ashrrev_i32_e32 v111, 31, v111
	v_xor_b32_e32 v111, v115, v111
	v_cndmask_b32_e32 v117, v116, v117, vcc
	v_mul_hi_i32 v117, v117, s37
	v_lshrrev_b32_e32 v122, 31, v117
	v_ashrrev_i32_e32 v117, 5, v117
	v_add_u32_e32 v117, v117, v122
	v_ashrrev_i32_e32 v116, 31, v116
	v_add_u32_e32 v115, v111, v89
	v_xor_b32_e32 v116, v117, v116
	v_add_u32_e32 v111, v111, v90
	v_mul_lo_u32 v115, v115, s12
	v_mul_lo_u32 v116, v116, s15
	v_mul_lo_u32 v111, v111, s12
	v_sub_u32_e32 v115, v115, v116
	v_add_u32_e32 v117, 0x203, v174
	v_add_u32_e32 v122, 0xfffffdfc, v175
	v_cmp_gt_i32_e32 vcc, s65, v176
	v_sub_u32_e32 v111, v111, v116
	v_add_u32_e32 v116, 0x200, v174
	v_cndmask_b32_e32 v123, v117, v122, vcc
	v_cmp_gt_i32_e32 vcc, -3, v116
	v_mul_hi_i32 v123, v123, s37
	v_lshrrev_b32_e32 v130, 31, v123
	v_cndmask_b32_e32 v116, v117, v122, vcc
	v_ashrrev_i32_e32 v123, 5, v123
	v_mul_hi_i32 v116, v116, s37
	v_xor_b32_e32 v96, v96, v97
	v_add_u32_e32 v123, v123, v130
	v_ashrrev_i32_e32 v130, 31, v117
	v_lshrrev_b32_e32 v117, 31, v116
	v_ashrrev_i32_e32 v116, 5, v116
	v_add_u32_e32 v97, v96, v88
	v_add_u32_e32 v94, v128, v88
	...
	v_add_u32_e32 v132, v107, v96
	v_add_u32_e32 v133, v107, v128
	v_xad_u32 v116, v116, v130, v90
	v_sub_u32_e32 v97, v97, v114
	v_sub_u32_e32 v94, v94, v129
	...
	v_add_u32_e32 v97, v173, v97
	v_add3_u32 v94, v85, v94, v125
	v_add3_u32 v115, v85, v115, v124
	v_sub_u32_e32 v131, v131, v123
	v_sub_u32_e32 v132, v132, v114
	v_sub_u32_e32 v133, v133, v129
	v_add3_u32 v111, v85, v111, v124
	...
	buffer_load_ubyte v123, v97, s[28:31], 0 offen offset:304
	buffer_load_ubyte v117, v94, s[28:31], 0 offen offset:514
	buffer_load_ubyte v122, v115, s[28:31], 0 offen offset:305
	buffer_load_ubyte v116, v131, s[28:31], 0 offen offset:515
	s_nop 0
	buffer_load_ubyte v115, v132, s[28:31], 0 offen offset:304
	buffer_load_ubyte v97, v133, s[28:31], 0 offen offset:514
	s_nop 0
	buffer_load_ubyte v111, v111, s[28:31], 0 offen offset:305
	s_nop 0
	buffer_load_ubyte v94, v130, s[28:31], 0 offen offset:515
	v_add_u32_e32 v96, v108, v96
	v_mul_lo_u32 v96, s12, v96
	v_sub_u32_e32 v96, v96, v114
	v_add_u32_e32 v114, v108, v128
	v_mul_lo_u32 v114, s12, v114
	v_add3_u32 v87, v85, v87, v105
	v_add3_u32 v84, v85, v84, v105
	v_add_u32_e32 v96, v173, v96
	v_sub_u32_e32 v114, v114, v129
	buffer_load_dword v87, v87, s[4:7], 0 offen offset:304
	s_nop 0
	buffer_load_dword v84, v84, s[4:7], 0 offen offset:304
	v_add3_u32 v128, v85, v114, v125
	buffer_load_ubyte v114, v96, s[28:31], 0 offen offset:304
	s_nop 0
	buffer_load_ubyte v96, v128, s[28:31], 0 offen offset:514
	...
	v_add_u32_e32 v101, 0x400, v101
	v_add_u32_e32 v102, 0x100, v102
	v_add_u32_e32 v104, 0xfffffe00, v104
	v_add_u32_e32 v106, 0x200, v106
	v_add_u32_e32 v125, 0x200, v125
	v_add_u32_e32 v109, 0x200, v109
	v_add_u32_e32 v110, 0xfffffe00, v110
	v_add_u32_e32 v124, 0x200, v124
	v_add_u32_e32 v105, 0x200, v105
	v_add_u32_e32 v113, 0xffffff80, v113
	s_cmp_lt_u32 s50, 10
	...
	s_barrier
.LBB0_6:
	v_add_u32_e32 v83, 0x10000, v93
	s_barrier
	ds_read_b128 v[118:121], v83
	ds_read_b128 v[124:127], v83 offset:2048
	v_add_u32_e32 v85, 0x10000, v95
	ds_read_b128 v[128:131], v85
	ds_read_b128 v[132:135], v83 offset:8192
	ds_read_b128 v[136:139], v85 offset:2048
	ds_read_b128 v[140:143], v85 offset:4096
	ds_read_b128 v[144:147], v83 offset:4096
	ds_read_b128 v[148:151], v83 offset:6144
	ds_read_b128 v[152:155], v85 offset:6144
	ds_read_b128 v[156:159], v85 offset:8192
	ds_read_b128 v[102:105], v91
	ds_read_b128 v[160:163], v91 offset:2048
	ds_read_b128 v[106:109], v92
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[102:105], v[118:121], v[12:15], v87, v123 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_movk_i32 s0, 0x7fff
	v_mov_b32_e32 v83, 0x7fc0
	s_mul_hi_u32 s1, s8, s16
	s_waitcnt lgkmcnt(5)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[106:109], v[128:131], v[12:15], v87, v117 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_lshl_or_b32 v80, v80, 2, v81
	v_mul_lo_u32 v80, s8, v80
	v_lshlrev_b32_e32 v81, 1, v82
	v_mfma_scale_f32_16x16x128_f8f6f4 v[72:75], v[102:105], v[144:147], v[72:75], v87, v115 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_add3_u32 v93, v13, v88, s0
	v_lshrrev_b32_e32 v86, 16, v86
	v_mfma_scale_f32_16x16x128_f8f6f4 v[88:91], v[106:109], v[140:143], v[72:75], v87, v97 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_lshl_add_u32 v82, v80, 1, v81
	s_nop 1
	v_cndmask_b32_e32 v72, v83, v85, vcc
	v_cmp_o_f32_e32 vcc, v14, v14
	v_lshrrev_b32_e32 v73, 16, v93
	v_mfma_scale_f32_16x16x128_f8f6f4 v[98:101], v[102:105], v[148:151], v[68:71], v87, v111 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_lshrrev_b32_e32 v74, 16, v92
	s_nop 1
	v_cndmask_b32_e32 v68, v83, v86, vcc
	v_cmp_o_f32_e32 vcc, v13, v13
	v_mfma_scale_f32_16x16x128_f8f6f4 v[76:79], v[102:105], v[124:127], v[76:79], v87, v122 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_nop 0
	v_cndmask_b32_e32 v69, v83, v73, vcc
	v_cmp_o_f32_e32 vcc, v12, v12
	s_waitcnt vmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[102:105], v[132:135], v[64:67], v87, v114 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_cndmask_b32_e32 v70, v83, v74, vcc
	s_waitcnt vmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[64:67], v[106:109], v[156:159], v[12:15], v87, v96 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[160:163], v[118:121], v[60:63], v87, v123 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(4)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[102:105], v[164:167], v[128:131], v[12:15], v87, v117 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[160:163], v[124:127], v[56:59], v87, v122 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[76:79], v[106:109], v[136:139], v[76:79], v87, v116 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	s_nop 1
	v_bfe_u32 v59, v91, 16, 1
	v_mfma_scale_f32_16x16x128_f8f6f4 v[98:101], v[106:109], v[152:155], v[98:101], v87, v94 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[106:109], v[164:167], v[136:139], v[12:15], v87, v116 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	s_nop 2
	v_bfe_u32 v71, v79, 16, 1
	v_bfe_u32 v73, v78, 16, 1
	v_add3_u32 v60, v79, v71, s0
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[160:163], v[144:147], v[52:55], v87, v115 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_bfe_u32 v74, v77, 16, 1
	v_add3_u32 v73, v78, v73, s0
	v_lshrrev_b32_e32 v60, 16, v60
	v_mfma_scale_f32_16x16x128_f8f6f4 v[52:55], v[164:167], v[140:143], v[12:15], v87, v97 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_cmp_o_f32_e32 vcc, v79, v79
	v_bfe_u32 v75, v76, 16, 1
	v_add3_u32 v74, v77, v74, s0
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[160:163], v[148:151], v[48:51], v87, v111 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[74:77], v[164:167], v[152:155], v[12:15], v87, v94 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_bfe_u32 v61, v90, 16, 1
	v_cndmask_b32_e32 v58, v83, v63, vcc
	v_lshrrev_b32_e32 v48, 16, v48
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[160:163], v[132:135], v[44:47], v87, v114 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[90:93], v[164:167], v[156:159], v[12:15], v87, v96 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_bfe_u32 v63, v88, 16, 1
	v_add3_u32 v62, v89, v62, s0
	v_lshrrev_b32_e32 v49, 16, v61
	s_waitcnt lgkmcnt(3)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[168:171], v[118:121], v[40:43], v84, v123 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[48:51], v[176:179], v[128:131], v[12:15], v84, v117 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_bfe_u32 v42, v98, 16, 1
	v_add3_u32 v42, v98, v42, s0
	v_add3_u32 v41, v99, v41, s0
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[168:171], v[124:127], v[32:35], v84, v122 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add3_u32 v40, v100, v40, s0
	v_lshrrev_b32_e32 v71, 16, v41
	v_lshrrev_b32_e32 v73, 16, v42
	v_add3_u32 v32, v101, v44, s0
	v_mfma_scale_f32_16x16x128_f8f6f4 v[44:47], v[176:179], v[136:139], v[12:15], v84, v116 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_lshrrev_b32_e32 v33, 16, v40
	v_lshrrev_b32_e32 v32, 16, v32
	v_cmp_o_f32_e32 vcc, v101, v101
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[168:171], v[144:147], v[20:23], v84, v115 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_bfe_u32 v85, v50, 16, 1
	v_cndmask_b32_e32 v78, v83, v32, vcc
	v_cmp_o_f32_e32 vcc, v100, v100
	v_mfma_scale_f32_16x16x128_f8f6f4 v[40:43], v[176:179], v[140:143], v[12:15], v84, v97 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_bfe_u32 v86, v49, 16, 1
	v_cndmask_b32_e32 v79, v83, v33, vcc
	v_cmp_o_f32_e32 vcc, v99, v99
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[168:171], v[148:151], v[16:19], v84, v111 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add3_u32 v85, v50, v85, s0
	v_bfe_u32 v87, v48, 16, 1
	v_add3_u32 v86, v49, v86, s0
	v_mfma_scale_f32_16x16x128_f8f6f4 v[32:35], v[176:179], v[152:155], v[12:15], v84, v94 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_lshrrev_b32_e32 v85, 16, v85
	v_add3_u32 v87, v48, v87, s0
	v_lshrrev_b32_e32 v86, 16, v86
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[168:171], v[132:135], v[24:27], v84, v114 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[20:23], v[176:179], v[156:159], v[12:15], v84, v96 op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_cndmask_b32_e32 v25, v83, v73, vcc
	v_add3_u32 v27, v66, v27, s0
	v_lshrrev_b32_e32 v26, 16, v26
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[172:175], v[118:121], v[28:31], v84, v123 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_bfe_u32 v30, v105, 16, 1
	v_lshrrev_b32_e32 v29, 16, v29
	v_cndmask_b32_e32 v28, v83, v28, vcc
	v_cmp_o_f32_e32 vcc, v64, v64
	v_bfe_u32 v31, v104, 16, 1
	v_add3_u32 v30, v105, v30, s0
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[16:19], v[180:183], v[128:131], v[12:15], v84, v117 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_cndmask_b32_e32 v29, v83, v29, vcc
	v_add3_u32 v31, v104, v31, s0
	v_lshrrev_b32_e32 v30, 16, v30
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[172:175], v[124:127], v[36:39], v84, v122 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_cmp_o_f32_e32 vcc, v105, v105
	v_lshrrev_b32_e32 v31, 16, v31
	v_bfe_u32 v64, v107, 16, 1
	v_bfe_u32 v36, v103, 16, 1
	v_bfe_u32 v37, v102, 16, 1
	v_add3_u32 v36, v103, v36, s0
	v_cndmask_b32_e32 v30, v83, v30, vcc
	v_cmp_o_f32_e32 vcc, v104, v104
	v_add3_u32 v37, v102, v37, s0
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[8:11], v[172:175], v[144:147], v[8:11], v84, v115 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add3_u32 v73, v74, v73, s0
	v_cndmask_b32_e32 v71, v83, v71, vcc
	v_cmp_o_f32_e32 vcc, v74, v74
	v_mfma_scale_f32_16x16x128_f8f6f4 v[4:7], v[172:175], v[148:151], v[4:7], v84, v111 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_bfe_u32 v74, v93, 16, 1
	v_lshrrev_b32_e32 v73, 16, v73
	v_bfe_u32 v75, v92, 16, 1
	v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[172:175], v[132:135], v[0:3], v84, v114 op_sel:[1,0,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add3_u32 v74, v93, v74, s0
	v_cndmask_b32_e32 v73, v83, v73, vcc
	v_bfe_u32 v76, v91, 16, 1
	v_add3_u32 v75, v92, v75, s0
	v_lshrrev_b32_e32 v74, 16, v74
	v_cmp_o_f32_e32 vcc, v93, v93
	v_bfe_u32 v77, v90, 16, 1
	v_add3_u32 v76, v91, v76, s0
	v_lshrrev_b32_e32 v75, 16, v75
	v_cndmask_b32_e32 v74, v83, v74, vcc
	v_cmp_o_f32_e32 vcc, v92, v92
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[180:183], v[136:139], v[12:15], v84, v116 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_add3_u32 v77, v90, v77, s0
	v_lshrrev_b32_e32 v76, 16, v76
	v_cndmask_b32_e32 v75, v83, v75, vcc
	v_mfma_scale_f32_16x16x128_f8f6f4 v[8:11], v[180:183], v[140:143], v[8:11], v84, v97 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_cmp_o_f32_e32 vcc, v91, v91
	v_lshrrev_b32_e32 v77, 16, v77
	v_mfma_scale_f32_16x16x128_f8f6f4 v[4:7], v[180:183], v[152:155], v[4:7], v84, v94 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	v_cndmask_b32_e32 v76, v83, v76, vcc
	v_cmp_o_f32_e32 vcc, v90, v90
	v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[180:183], v[156:159], v[0:3], v84, v96 op_sel:[1,0,0] op_sel_hi:[1,0,0] cbsz:4 blgp:4
	...
	.p2align	6, 0x0
	.amdhsa_kernel wave_mxfp4_static_gemm_256x160x256_6656x2560x3328
	...
	.text
.Lfunc_end0:
	.size	wave_mxfp4_static_gemm_256x160x256_6656x2560x3328, .Lfunc_end0-wave_mxfp4_static_gemm_256x160x256_6656x2560x3328

	.set wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.num_vgpr, 216
	.set wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.num_agpr, 0
	.set wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.numbered_sgpr, 68
	.set wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.num_named_barrier, 0
	.set wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.private_seg_size, 0
	.set wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.uses_vcc, 1
	.set wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.uses_flat_scratch, 0
	.set wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.has_dyn_sized_stack, 0
	.set wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.has_recursion, 0
	.set wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.has_indirect_call, 0
...
amdhsa.kernels:
  - .agpr_count:     0
    ...
    .name:           wave_mxfp4_static_gemm_256x160x256_6656x2560x3328
    ...
    .sgpr_count:     74
    .sgpr_spill_count: 0
    .symbol:         wave_mxfp4_static_gemm_256x160x256_6656x2560x3328.kd
