...
; llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx950 -mattr='-fma-mix-insts' -O3 <.optimized.ll> -o <out.rocmasm>
	...
	.text
	.globl	wave_mxfp4_static_gemm_64x64x256_128x256x1024
	.p2align	8
	.type	wave_mxfp4_static_gemm_64x64x256_128x256x1024,@function
wave_mxfp4_static_gemm_64x64x256_128x256x1024:
...
.LBB0_0:
	...
	v_mad_i32_i24 v0, v4, s2, v16
	v_bfe_u32 v5, v9, 6, 1
	v_ashrrev_i32_e32 v13, 31, v0
	v_bitop3_b32 v6, v0, v13, v5 bitop3:0x36
	...
	v_and_or_b32 v14, v12, 32, v18
	v_xad_u32 v12, v6, v13, v14
	v_bitop3_b32 v6, v0, 29, v5 bitop3:0xc8
	v_or_b32_e32 v7, 2, v7
	v_bitop3_b32 v5, v0, -3, v5 bitop3:0x36
	...
	s_or_b32 s5, s2, s3
	v_mad_u64_u32 v[14:15], s[2:3], v13, s14, v[0:1]
	...
	buffer_load_ubyte v5, v14, s[4:7], 0 offen
	v_bfe_u32 v14, v9, 3, 1
	s_add_u32 s16, s8, s2
	v_mul_i32_i24_e32 v17, 0xffffffc0, v4
	v_or3_b32 v15, v14, v8, v18
	...
	s_mov_b32 s23, s27
	s_mov_b32 m0, s31
	buffer_load_dword v16, v16, s[16:19], 0 offen
...
.LBB0_2:
	...
	v_add3_u32 v28, v12, s33, v6
	v_add_u32_e32 v6, 8, v13
	v_mad_u64_u32 v[26:27], s[8:9], v6, s14, v[0:1]
	s_mov_b32 s6, s26
	s_mov_b32 s7, s27
	s_lshl_b32 s8, s12, 3
	buffer_load_ubyte v0, v28, s[4:7], 0 offen
	buffer_load_ubyte v27, v26, s[4:7], 0 offen
	v_add3_u32 v29, v15, s8, v14
	s_mov_b32 s18, s26
	s_mov_b32 s19, s27
	buffer_load_dword v30, v29, s[16:19], 0 offen
	v_lshlrev_b32_e32 v12, 7, v9
	v_lshlrev_b32_e32 v4, 11, v4
	v_bitop3_b32 v6, v11, v9, 7 bitop3:0x78
	v_sub_u32_e32 v4, v12, v4
	v_lshl_add_u32 v14, v10, 11, v4
	v_lshlrev_b32_e32 v6, 4, v6
	v_or_b32_e32 v12, v14, v6
	v_lshl_add_u32 v3, v3, 12, v4
	v_or_b32_e32 v13, v3, v6
	ds_read_b128 v[22:25], v12
	ds_read_b128 v[18:21], v13 offset:16384
	ds_read_b128 v[32:35], v13 offset:18432
	s_barrier
	s_setprio 1
	v_and_b32_e32 v4, 0xffff, v7
	s_waitcnt lgkmcnt(0)
	s_nop 0
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[22:25], v[18:21], 0, v4, v16 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[22:25], v[32:35], 0, v4, v16 op_sel:[0,1,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_setprio 0
	s_barrier
	v_bitop3_b32 v4, v11, v17, 4 bitop3:0x36
	v_lshlrev_b32_e32 v4, 4, v4
	v_or_b32_e32 v15, v4, v14
	v_or_b32_e32 v14, v4, v3
	ds_read_b128 v[32:35], v15
	ds_read_b128 v[36:39], v14 offset:16384
	...
	s_waitcnt lgkmcnt(1)
	s_nop 0
	v_mfma_scale_f32_16x16x128_f8f6f4 v[4:7], v[32:35], v[36:39], v[18:21], v3, v16 op_sel_hi:[0,1,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[16:19], v[32:35], v[40:43], v[22:25], v3, v16 op_sel:[0,1,0] op_sel_hi:[0,1,0] cbsz:4 blgp:4
	s_setprio 0
	s_mov_b32 m0, s30
	...
	v_add_u32_e32 v3, s33, v28
	v_add_u32_e32 v24, s33, v26
	buffer_load_ubyte v25, v3, s[4:7], 0 offen
	buffer_load_ubyte v26, v24, s[4:7], 0 offen
	v_add_u32_e32 v28, s8, v29
	buffer_load_dword v29, v28, s[16:19], 0 offen
	ds_read_b128 v[20:23], v12 offset:8192
	ds_read_b128 v[32:35], v13 offset:24576
	ds_read_b128 v[36:39], v13 offset:26624
	s_barrier
	s_setprio 1
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[4:7], v[20:23], v[32:35], v[4:7], v0, v30 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[16:19], v[20:23], v[36:39], v[16:19], v0, v30 op_sel:[0,1,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_setprio 0
	s_barrier
	ds_read_b128 v[20:23], v15 offset:8192
	ds_read_b128 v[32:35], v14 offset:24576
	ds_read_b128 v[36:39], v14 offset:26624
	s_waitcnt vmcnt(3)
	s_barrier
	s_setprio 1
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[4:7], v[20:23], v[32:35], v[4:7], v27, v30 op_sel_hi:[0,1,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[20:23], v[20:23], v[36:39], v[16:19], v27, v30 op_sel:[0,1,0] op_sel_hi:[0,1,0] cbsz:4 blgp:4
	s_setprio 0
	s_mov_b32 m0, s13
	...
	ds_read_b128 v[34:37], v13 offset:18432
	s_barrier
	s_setprio 1
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[30:33], v[0:3], v[4:7], v25, v29 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[20:23], v[30:33], v[34:37], v[20:23], v25, v29 op_sel:[0,1,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_setprio 0
	s_barrier
	ds_read_b128 v[30:33], v15
	ds_read_b128 v[4:7], v14 offset:16384
	ds_read_b128 v[34:37], v14 offset:18432
	s_waitcnt vmcnt(3)
	s_barrier
	s_setprio 1
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[4:7], v[30:33], v[4:7], v[0:3], v26, v29 op_sel_hi:[0,1,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[30:33], v[34:37], v[20:23], v26, v29 op_sel:[0,1,0] op_sel_hi:[0,1,0] cbsz:4 blgp:4
	s_setprio 0
...
.LBB0_4:
	s_barrier
	ds_read_b128 v[20:23], v12 offset:8192
	ds_read_b128 v[24:27], v13 offset:24576
	ds_read_b128 v[28:31], v13 offset:26624
	s_waitcnt vmcnt(2)
	v_and_b32_e32 v12, 0xffff, v18
	s_movk_i32 s2, 0x7fff
	s_mul_i32 s1, s1, s28
	s_waitcnt vmcnt(0) lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[4:7], v[20:23], v[24:27], v[4:7], v12, v17 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[24:27], v15 offset:8192
	v_lshlrev_b32_e32 v10, 4, v10
	v_lshl_or_b32 v10, v11, 2, v10
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[20:23], v[28:31], v[0:3], v12, v17 op_sel:[0,1,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[18:21], v14 offset:24576
	ds_read_b128 v[28:31], v14 offset:26624
	...
	.p2align	6, 0x0
	.amdhsa_kernel wave_mxfp4_static_gemm_64x64x256_128x256x1024
	...
	.text
.Lfunc_end0:
	.size	wave_mxfp4_static_gemm_64x64x256_128x256x1024, .Lfunc_end0-wave_mxfp4_static_gemm_64x64x256_128x256x1024

	.set wave_mxfp4_static_gemm_64x64x256_128x256x1024.num_vgpr, 44
	.set wave_mxfp4_static_gemm_64x64x256_128x256x1024.num_agpr, 0
	.set wave_mxfp4_static_gemm_64x64x256_128x256x1024.numbered_sgpr, 34
	.set wave_mxfp4_static_gemm_64x64x256_128x256x1024.num_named_barrier, 0
	.set wave_mxfp4_static_gemm_64x64x256_128x256x1024.private_seg_size, 0
	.set wave_mxfp4_static_gemm_64x64x256_128x256x1024.uses_vcc, 1
	.set wave_mxfp4_static_gemm_64x64x256_128x256x1024.uses_flat_scratch, 0
	.set wave_mxfp4_static_gemm_64x64x256_128x256x1024.has_dyn_sized_stack, 0
	.set wave_mxfp4_static_gemm_64x64x256_128x256x1024.has_recursion, 0
	.set wave_mxfp4_static_gemm_64x64x256_128x256x1024.has_indirect_call, 0
...
amdhsa.kernels:
  - .agpr_count:     0
    ...
    .name:           wave_mxfp4_static_gemm_64x64x256_128x256x1024
    ...
    .sgpr_count:     40
    .sgpr_spill_count: 0
    .symbol:         wave_mxfp4_static_gemm_64x64x256_128x256x1024.kd
