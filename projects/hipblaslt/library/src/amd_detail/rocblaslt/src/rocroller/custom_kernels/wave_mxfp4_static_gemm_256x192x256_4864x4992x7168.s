...
; llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx950 -mattr='-fma-mix-insts' -O3 <.optimized.ll> -o <out.rocmasm>
	...
	.text
	.globl	wave_mxfp4_static_gemm_256x192x256_4864x4992x7168
	.p2align	8
	.type	wave_mxfp4_static_gemm_256x192x256_4864x4992x7168,@function
wave_mxfp4_static_gemm_256x192x256_4864x4992x7168:
...
.LBB0_6:
	...
	.p2align	6, 0x0
	.amdhsa_kernel wave_mxfp4_static_gemm_256x192x256_4864x4992x7168
	...
	.text
.Lfunc_end0:
	.size	wave_mxfp4_static_gemm_256x192x256_4864x4992x7168, .Lfunc_end0-wave_mxfp4_static_gemm_256x192x256_4864x4992x7168

	.set wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.num_vgpr, 204
	.set wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.num_agpr, 0
	.set wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.numbered_sgpr, 51
	.set wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.num_named_barrier, 0
	.set wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.private_seg_size, 0
	.set wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.uses_vcc, 1
	.set wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.uses_flat_scratch, 0
	.set wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.has_dyn_sized_stack, 0
	.set wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.has_recursion, 0
	.set wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.has_indirect_call, 0
...
amdhsa.kernels:
  - .agpr_count:     0
    ...
    .name:           wave_mxfp4_static_gemm_256x192x256_4864x4992x7168
    ...
    .sgpr_count:     57
    .sgpr_spill_count: 0
    .symbol:         wave_mxfp4_static_gemm_256x192x256_4864x4992x7168.kd
