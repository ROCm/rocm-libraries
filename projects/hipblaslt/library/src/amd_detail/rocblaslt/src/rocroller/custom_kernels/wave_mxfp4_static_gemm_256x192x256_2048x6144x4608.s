...
; llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx950 -mattr='-fma-mix-insts' -O3 <.optimized.ll> -o <out.rocmasm>
	...
	.text
	.globl	wave_mxfp4_static_gemm_256x192x256_2048x6144x4608
	.p2align	8
	.type	wave_mxfp4_static_gemm_256x192x256_2048x6144x4608,@function
wave_mxfp4_static_gemm_256x192x256_2048x6144x4608:
...
.LBB0_0:
	...
	v_mul_u32_u24_e32 v110, 0x900, v3
	s_and_b32 s6, s21, 0xffff
	s_lshl_b32 s30, s2, 7
	s_or_b32 s21, s6, 0x49000000
	s_mov_b32 s23, 0x27000
	s_mov_b32 s22, 0x7ffffffe
	v_or_b32_e32 v6, v110, v104
	s_mov_b32 m0, s30
	s_movk_i32 s3, 0x900
	buffer_load_dwordx4 v6, s[20:23], 0 offen lds
	v_mov_b32_e32 v6, 0x24000
...
.LBB0_2:
	...
	s_mov_b32 s46, 0xe38f
	s_movk_i32 s47, 0xf700
	s_mov_b32 s48, 0xfffb7800
	...
	s_movk_i32 s50, 0xe39
	s_movk_i32 s51, 0xffe4
	s_mov_b32 s6, s22
	s_mov_b32 s7, s23
	s_mov_b32 s18, s22
	s_mov_b32 s19, s23
	v_add_u32_e32 v132, 0x10000, v109
	s_mov_b32 s52, 0xfffb8000
	v_add_u32_e32 v133, 0x16000, v108
	v_add_u32_e32 v134, 0x16000, v109
...
.LBB0_3:
	...
	v_add_u32_e32 v139, 0x24080, v138
	s_mov_b32 m0, s44
	s_nop 0
	buffer_load_dwordx4 v139, s[20:23], 0 offen lds
	v_add_u32_e32 v139, 0x48080, v138
	s_mov_b32 m0, s42
	s_nop 0
	buffer_load_dwordx4 v139, s[20:23], 0 offen lds
	v_add_u32_e32 v139, 0x6c080, v138
	s_mov_b32 m0, s41
	s_nop 0
	buffer_load_dwordx4 v139, s[20:23], 0 offen lds
	...
	v_add_u32_e32 v144, 28, v137
	v_add_u32_e32 v145, 0xffe3, v141
	v_cndmask_b32_e32 v142, v140, v142, vcc
	v_mul_i32_i24_sdwa v142, sext(v142), s50 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	v_lshrrev_b32_e32 v143, 31, v142
	v_ashrrev_i32_e32 v142, 17, v142
	v_add_u16_e32 v142, v142, v143
	v_cndmask_b32_e64 v143, 0, -1, vcc
	v_cmp_gt_i32_e32 vcc, s51, v137
	...
	v_mul_i32_i24_sdwa v144, sext(v144), s50 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	v_lshrrev_b32_e32 v145, 31, v144
	v_ashrrev_i32_e32 v144, 17, v144
	...
	buffer_load_dword v144, v146, s[16:19], 0 offen offset:112
	s_nop 0
	buffer_load_dword v146, v147, s[16:19], 0 offen offset:112
	s_nop 0
	buffer_load_dword v142, v142, s[16:19], 0 offen offset:112
	s_nop 0
	buffer_load_dword v143, v143, s[4:7], 0 offen offset:112
	s_nop 0
	buffer_load_dword v145, v145, s[4:7], 0 offen offset:112
	...
	v_add_u32_e32 v117, 0x24100, v138
	s_mov_b32 m0, s31
	s_nop 0
	buffer_load_dwordx4 v117, s[20:23], 0 offen lds
	v_add_u32_e32 v117, 0x48100, v138
	s_mov_b32 m0, s33
	s_nop 0
	buffer_load_dwordx4 v117, s[20:23], 0 offen lds
	v_add_u32_e32 v117, 0x6c100, v138
	s_mov_b32 m0, s34
	s_nop 0
	buffer_load_dwordx4 v117, s[20:23], 0 offen lds
	...
	v_mul_u32_u24_e32 v118, 0x900, v118
	v_mul_i32_i24_e32 v120, 0xfffff700, v117
	v_mad_i32_i24 v118, v117, s47, v118
	v_add_u32_e32 v117, v116, v117
	v_mul_u32_u24_e32 v117, 0x900, v117
	v_add3_u32 v118, v124, v118, s52
	s_mov_b32 m0, s35
	v_add3_u32 v117, v120, v117, v124
	buffer_load_dwordx4 v118, s[24:27], 0 offen lds
	v_add_u32_e32 v118, 0xfffdc000, v117
	s_mov_b32 m0, s36
	s_nop 0
	buffer_load_dwordx4 v118, s[24:27], 0 offen lds
	s_mov_b32 m0, s37
	...
	v_add_u32_e32 v121, 0xffa3, v141
	...
	v_mul_i32_i24_sdwa v117, sext(v117), s50 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	v_lshrrev_b32_e32 v118, 31, v117
	v_ashrrev_i32_e32 v117, 17, v117
	v_add_u16_e32 v117, v117, v118
	v_cndmask_b32_e64 v118, 0, -1, vcc
	v_xor_b32_e32 v120, v117, v118
	v_add_u32_e32 v118, 0x5c, v137
	v_cmp_gt_i32_e32 vcc, s51, v140
	...
	v_mul_i32_i24_sdwa v118, sext(v118), s50 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	v_lshrrev_b32_e32 v121, 31, v118
	v_ashrrev_i32_e32 v118, 17, v118
	...
	buffer_load_dword v118, v117, s[4:7], 0 offen offset:368
	s_nop 0
	buffer_load_dword v117, v122, s[4:7], 0 offen offset:368
	...
	buffer_load_dword v122, v122, s[16:19], 0 offen offset:368
	s_nop 0
	buffer_load_dword v121, v137, s[16:19], 0 offen offset:368
	s_nop 0
	buffer_load_dword v120, v120, s[16:19], 0 offen offset:368
	s_waitcnt vmcnt(7)
	s_barrier
	s_setprio 1
	s_waitcnt lgkmcnt(5)
	...
	s_movk_i32 s6, 0x880
	s_mov_b32 m0, s45
	v_add3_u32 v110, v104, v110, s6
	s_waitcnt vmcnt(5)
	s_barrier
	buffer_load_dwordx4 v110, s[20:23], 0 offen lds
	v_add3_u32 v110, v104, v112, s6
	s_mov_b32 m0, s44
	v_or3_b32 v103, s29, v103, 15
	buffer_load_dwordx4 v110, s[20:23], 0 offen lds
	v_add3_u32 v110, v104, v113, s6
	s_mov_b32 m0, s42
	v_add3_u32 v104, v104, v114, s6
	buffer_load_dwordx4 v110, s[20:23], 0 offen lds
	s_mov_b32 m0, s41
	v_mul_u32_u24_e32 v103, 0x900, v103
	s_movk_i32 s6, 0x100
	...
	v_add_u32_e32 v103, 0x2c700, v123
	v_add_u32_e32 v103, v103, v111
	v_add_u32_e32 v103, 0x100, v103
	s_mov_b32 m0, s40
	s_nop 0
	buffer_load_dwordx4 v103, s[24:27], 0 offen lds
	v_add_u32_e32 v103, 0x50700, v123
	v_add_u32_e32 v103, v103, v111
	v_add_u32_e32 v103, 0x100, v103
	s_mov_b32 m0, s0
	s_nop 0
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[110:113], v[144:147], v[0:3], v118, v122 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[4:7], v[110:113], v[148:151], v[4:7], v118, v122 op_sel:[0,1,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt vmcnt(8)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[8:11], v[110:113], v[152:155], v[8:11], v118, v121 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[12:15], v[110:113], v[156:159], v[12:15], v118, v121 op_sel:[0,1,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt vmcnt(7)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[16:19], v[110:113], v[160:163], v[16:19], v118, v120 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[20:23], v[110:113], v[168:171], v[20:23], v118, v120 op_sel:[0,1,0] op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(2)
	...
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[110:113], v[140:143], v[144:147], v[48:51], v117, v122 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	s_setprio 0
	s_barrier
	v_add_u16_e32 v48, 0x440, v105
	v_mul_u32_u24_e32 v48, 0xe38f, v48
	v_lshrrev_b32_e32 v49, 21, v48
	v_add_u16_e32 v48, 0x41c, v106
	v_mul_u32_u24_e32 v48, 0x71d, v48
	s_movk_i32 s0, 0xff70
	v_mul_i32_i24_sdwa v48, v48, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
	s_movk_i32 s0, 0x1070
	...
	v_add_u32_e32 v48, 0x10000, v109
	...
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[44:47], v[172:175], v[180:183], v[110:113], v117, v122 op_sel_hi:[1,1,0] cbsz:4 blgp:4
...
.LBB0_6:
	...
	v_add_u32_e32 v109, 0x16000, v109
	...
	.p2align	6, 0x0
	.amdhsa_kernel wave_mxfp4_static_gemm_256x192x256_2048x6144x4608
	...
	.text
.Lfunc_end0:
	.size	wave_mxfp4_static_gemm_256x192x256_2048x6144x4608, .Lfunc_end0-wave_mxfp4_static_gemm_256x192x256_2048x6144x4608

	.set wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.num_vgpr, 204
	.set wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.num_agpr, 0
	.set wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.numbered_sgpr, 53
	.set wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.num_named_barrier, 0
	.set wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.private_seg_size, 0
	.set wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.uses_vcc, 1
	.set wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.uses_flat_scratch, 0
	.set wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.has_dyn_sized_stack, 0
	.set wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.has_recursion, 0
	.set wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.has_indirect_call, 0
...
amdhsa.kernels:
  - .agpr_count:     0
    ...
    .name:           wave_mxfp4_static_gemm_256x192x256_2048x6144x4608
    ...
    .sgpr_count:     59
    .sgpr_spill_count: 0
    .symbol:         wave_mxfp4_static_gemm_256x192x256_2048x6144x4608.kd
