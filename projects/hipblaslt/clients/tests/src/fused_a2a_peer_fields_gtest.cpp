...
namespace
{
    ...
    TEST(FusedA2ADrain, inKernelCompletionAsksForBothDrains)
    {
        EXPECT_EQ(rocblaslt::fusedA2ADrainFor(HIPBLASLT_A2A_COMPLETION_IN_KERNEL_FULL),
                  TensileLite::FUSED_A2A_DRAIN_RECV | TensileLite::FUSED_A2A_DRAIN_SEND);
    }

    TEST(FusedA2ADrain, inKernelCompletionCoversDReuse)
    {
        EXPECT_EQ(rocblaslt::fusedA2ADrainFor(HIPBLASLT_A2A_COMPLETION_IN_KERNEL_FULL)
