...
namespace hipblaslt_client
{
    ...
    template <typename ReadSizeFn>
    size_t cgroup_available_memory_from(cgroup_paths const& paths, ReadSizeFn read_size)
    {
    ...
    inline size_t cgroup_available_memory_live()
    {
        ...
        return cgroup_available_memory_from(parse_proc_self_cgroup(content), read_cgroup_size_file);
    }
#endif
