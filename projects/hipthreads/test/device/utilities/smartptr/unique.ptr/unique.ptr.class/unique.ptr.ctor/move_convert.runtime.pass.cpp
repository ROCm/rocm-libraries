...
struct GenericConvertingDeleter {
  template <int OID>
  __device__ GenericConvertingDeleter(GenericConvertingDeleter<OID>) {}
  __device__ void operator()(void*) const {}
};

__device__ TEST_CONSTEXPR_CXX23 void test_sfinae() {
  { // Disallow copying
    using U1 = gpu::unique_ptr<A[], GenericConvertingDeleter<0> >;
    using U2 = gpu::unique_ptr<A[], GenericConvertingDeleter<1> >;
  ...
  { // Disallow illegal qualified conversions
    using U1 = gpu::unique_ptr<const A[]>;
    using U2 = gpu::unique_ptr<A[]>;
    static_assert(std::is_constructible<U1, U2&&>::value, "");
  ...
  { // Disallow base-to-derived conversions.
    using UA = gpu::unique_ptr<A[], GenericConvertingDeleter<0> >;
    using UB = gpu::unique_ptr<B[], GenericConvertingDeleter<1> >;
    static_assert(!std::is_constructible<UA, UB&&>::value, "");
  }
  { // Disallow invalid deleter initialization
    using U1 = gpu::unique_ptr<A[], GenericDeleter<0> >;
    using U2 = gpu::unique_ptr<A[], GenericDeleter<1> >;
    static_assert(!std::is_constructible<U1, U2&&>::value, "");
  }
  { // Disallow reference deleters with different qualifiers
    using U1 = gpu::unique_ptr<A[], Deleter<A[]>&>;
    using U2 = gpu::unique_ptr<A[], const Deleter<A[]>&>;
    static_assert(!std::is_constructible<U1, U2&&>::value, "");
    static_assert(!std::is_constructible<U2, U1&&>::value, "");
  }
  {
    using U1 = gpu::unique_ptr<A[]>;
    using U2 = gpu::unique_ptr<A>;
    static_assert(!std::is_constructible<U1, U2&&>::value, "");
    static_assert(!std::is_constructible<U2, U1&&>::value, "");
  }
