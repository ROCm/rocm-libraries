...
#if TEST_STD_VER >= 11
TEST_CONSTINIT gpu::unique_ptr_h<int> global_static_unique_ptr_single(nullptr);
TEST_CONSTINIT gpu::unique_ptr_h<int[]> global_static_unique_ptr_runtime(nullptr);
