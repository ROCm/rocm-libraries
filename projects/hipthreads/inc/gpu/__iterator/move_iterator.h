...
public:
    ...
    _LIBGPU_DEPRECATED_IN_CXX20 _LIBGPU_HIDE_FROM_ABI _LIBGPU_CONSTEXPR_SINCE_CXX17
    ...
    _LIBGPU_HIDE_FROM_ABI constexpr const _Iter& base() const & noexcept { return __current_; }
    _LIBGPU_HIDE_FROM_ABI constexpr _Iter base() && { return std::move(__current_); }
    ...
    friend _LIBGPU_HIDE_FROM_ABI constexpr
...
inline _LIBGPU_HIDE_FROM_ABI _LIBGPU_CONSTEXPR_SINCE_CXX17
...
inline _LIBGPU_HIDE_FROM_ABI constexpr
