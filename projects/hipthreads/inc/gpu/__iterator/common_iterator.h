...
#ifndef __GPU___ITERATOR_COMMON_ITERATOR_H
#define __GPU___ITERATOR_COMMON_ITERATOR_H
...
concept __denotes_forward_iter =
  ...
  derived_from<typename std::iterator_traits<_Iter>::iterator_category, std::forward_iterator_tag>;
...
struct std::iterator_traits<common_iterator<_Iter, _Sent>> {
  using iterator_concept = std::conditional_t<forward_iterator<_Iter>,
                               std::forward_iterator_tag,
                               std::input_iterator_tag>;
  using iterator_category = std::conditional_t<__denotes_forward_iter<_Iter>,
                                std::forward_iterator_tag,
                                std::input_iterator_tag>;
...
#endif // __GPU___ITERATOR_COMMON_ITERATOR_H
