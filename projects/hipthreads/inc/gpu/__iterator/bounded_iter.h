...
#ifndef __GPU___ITERATOR_BOUNDED_ITER_H
#define __GPU___ITERATOR_BOUNDED_ITER_H
...
template <class _Iterator, class = std::enable_if_t< __is_cpp17_contiguous_iterator<_Iterator>::value > >
...
private:
  ...
  template <class _It>
  friend _LIBGPU_CONSTEXPR __bounded_iter<_It> __make_bounded_iter(_It, _It, _It);
...
struct __is_cpp17_contiguous_iterator<__bounded_iter<_Iterator> > : std::true_type {};
#endif
...
#endif // __GPU___ITERATOR_BOUNDED_ITER_H
