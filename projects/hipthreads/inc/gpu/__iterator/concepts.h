...
#ifndef __GPU___ITERATOR_CONCEPTS_H
#define __GPU___ITERATOR_CONCEPTS_H
...
template<class _In>
concept indirectly_readable = __indirectly_readable_impl<std::remove_cv_t<std::remove_reference_t<_In>>>;

template<indirectly_readable _Tp>
using iter_common_reference_t = std::common_reference_t<iter_reference_t<_Tp>, iter_value_t<_Tp>&>;
...
concept sized_sentinel_for =
  ...
  !disable_sized_sentinel_for<std::remove_cv_t<_Sp>, std::remove_cv_t<_Ip>> &&
...
concept input_iterator =
  ...
  derived_from<_ITER_CONCEPT<_Ip>, std::input_iterator_tag>;
...
concept forward_iterator =
  input_iterator<_Ip> &&
  derived_from<_ITER_CONCEPT<_Ip>, std::forward_iterator_tag> &&
  incrementable<_Ip> &&
...
concept bidirectional_iterator =
  ...
  derived_from<_ITER_CONCEPT<_Ip>, std::bidirectional_iterator_tag> &&
  requires(_Ip __i) {
    { --__i } -> same_as<_Ip&>;
    { __i-- } -> same_as<_Ip>;
  };
...
concept random_access_iterator =
  ...
  derived_from<_ITER_CONCEPT<_Ip>, std::random_access_iterator_tag> &&
  totally_ordered<_Ip> &&
...
concept contiguous_iterator =
  ...
  derived_from<_ITER_CONCEPT<_Ip>, std::contiguous_iterator_tag> &&
...
template<class _Ip>
concept __has_arrow = input_iterator<_Ip> && (std::is_pointer_v<_Ip> || requires(_Ip __i) { __i.operator->(); });
...
concept indirectly_unary_invocable =
  ...
  common_reference_with<
    std::invoke_result_t<_Fp&, iter_value_t<_It>&>,
    std::invoke_result_t<_Fp&, iter_reference_t<_It>>>;
...
using indirect_result_t = std::invoke_result_t<_Fp, iter_reference_t<_Its>...>;
...
#endif // __GPU___ITERATOR_CONCEPTS_H
