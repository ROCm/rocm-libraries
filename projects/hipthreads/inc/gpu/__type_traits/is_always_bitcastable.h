#ifndef __GPU___TYPE_TRAITS_IS_ALWAYS_BITCASTABLE_H__
#define __GPU___TYPE_TRAITS_IS_ALWAYS_BITCASTABLE_H__
...
//====================================================================================================================//
//      Adapted from libc++ std::is_always_bitcastable
//====================================================================================================================//
...
struct __is_always_bitcastable {
  using _UnqualFrom = std::remove_cv_t<_From>;
  using _UnqualTo = std::remove_cv_t<_To>;

  static const bool value =
    // First, the simple case -- `From` and `To` are the same object type.
    (std::is_same<_UnqualFrom, _UnqualTo>::value && std::is_trivially_copyable<_UnqualFrom>::value) ||
    ...
    (
      ...
      std::is_integral<_From>::value &&
      std::is_integral<_To>::value &&
      !std::is_same<_UnqualTo, bool>::value
    );
};

} // namespace gpu

#endif // __GPU___TYPE_TRAITS_IS_ALWAYS_BITCASTABLE_H__
