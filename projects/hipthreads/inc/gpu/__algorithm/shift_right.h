...
#ifndef __GPU___ALGORITHM_SHIFT_RIGHT_H
#define __GPU___ALGORITHM_SHIFT_RIGHT_H
            ...
            typename std::iterator_traits<_ForwardIterator>::difference_type __n)
{
    ...
    if constexpr (__is_cpp17_random_access_iterator<_ForwardIterator>::value) {
        ...
        return gpu::move_backward(__first, __m, __last);
...
#endif // __GPU___ALGORITHM_SHIFT_RIGHT_H
