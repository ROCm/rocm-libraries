...
function(fetch_dep method repo_name repo_path package_min_ver_variable download_branch)
  ...
  elseif(${method_value} STREQUAL "MONOREPO")
    ...
    # rocm-libraries/projects/hipccl/hipccl3/rocthrust, where rocPRIM is a
    # direct sibling (hipccl3/rocprim), not nested another "projects/" layer
    ...
    if(${found_path} STREQUAL "found_path-NOTFOUND")
      ...
      # (rocthrust -> hipccl3 -> hipccl -> projects -> rocm-libraries), not
      # two as upstream assumes, and this hipccl3 copy of rocPRIM lives at
