...
function(fetch_dep method repo_name repo_path package_min_ver_variable download_branch)
  ...
  elseif(${method_value} STREQUAL "MONOREPO")
    ...
    # this file lives at rocm-libraries/projects/rocthrust (two levels below
    # the monorepo root, so ".." twice reaches it, then back down into
    # "projects/<repo_name>"). This hipccl2 copy instead lives at
    # rocm-libraries/projects/hipccl/hipccl2/rocthrust, where rocPRIM is a
    # direct sibling (hipccl2/rocprim), not nested another "projects/" layer
    # down - so the corrected path is just "../${repo_name}/".
    ...
    if(${found_path} STREQUAL "found_path-NOTFOUND")
      ...
      # (rocthrust -> hipccl2 -> hipccl -> projects -> rocm-libraries), not
      # two as upstream assumes, and this hipccl2 copy of rocPRIM lives at
...
if(${LINK_HIP_DEVICE_LIBS} AND NOT GRAFT_THRUST_ONTO_BINARIES)
  ...
  # hipccl2 superbuild, which runs add_subdirectory(rocprim) before
