                                       ...
                                       = hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT)
{
    ...
    auto bnormAttributes
        = hipdnn_flatbuffers_sdk::data_objects::CreateBatchnormInferenceAttributes(builder,
                                                                            1, // x uid
                                                                            5, // mean uid
                                                                            6, // inv_variance uid
                                                                            3, // scale uid
    ...
    = hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT)
{
    ...
    auto node = hipdnn_flatbuffers_sdk::data_objects::CreateNodeDirect(
        ...
        computeDataType,
        hipdnn_flatbuffers_sdk::data_objects::NodeAttributes::BatchnormInferenceAttributesVarianceExt,
        bnormAttributes.Union());
    nodes.push_back(node);
    ...
    const std::vector<int64_t>& dims = {1, 3, 14, 14})
{
    ...
    tensorAttributes.push_back(hipdnn_flatbuffers_sdk::data_objects::CreateTensorAttributesDirect(
        builder, xTensorUid, "x", hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT, &strides, &dims));
    ...
    tensorAttributes.push_back(hipdnn_flatbuffers_sdk::data_objects::CreateTensorAttributesDirect(
        builder, yTensorUid, "y", hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT, &strides, &dims));
                            ...
                            = hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT)
{
    ...
    auto convAttributes = hipdnn_flatbuffers_sdk::data_objects::CreateConvolutionFwdAttributesDirect(
        builder,
        1, // x tensor uid
        2, // w tensor uid
        3, // y tensor uid
                            ...
                            = hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT)
{
    ...
    auto convAttributes = hipdnn_flatbuffers_sdk::data_objects::CreateConvolutionBwdAttributesDirect(
        builder,
        1, // dy tensor uid
        2, // w tensor uid
        3, // dx tensor uid
                            ...
                            = hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT)
{
    ...
    auto convAttributes = hipdnn_flatbuffers_sdk::data_objects::CreateConvolutionWrwAttributesDirect(
        builder,
        1, // x tensor uid
        2, // dy tensor uid
        3, // w tensor uid
...
inline flatbuffers::FlatBufferBuilder createPointwiseGraph()
{
    ...
    std::vector<flatbuffers::Offset<hipdnn_flatbuffers_sdk::data_objects::TensorAttributes>> tensors;
                           ...
                           = hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT)
{
    ...
    auto matmulAttributes = hipdnn_flatbuffers_sdk::data_objects::CreateMatmulAttributes(builder,
                                                                                  1, // A tensor uid
                                                                                  2, // B tensor uid
                                                                                  3 // C tensor uid
    );
                               ...
                               = hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT)
{
    ...
    auto rmsnormBwdAttributes = hipdnn_flatbuffers_sdk::data_objects::CreateRMSNormBackwardAttributes(
        builder,
        1, // dy uid
        2, // x uid
        3, // scale uid
                                       ...
                                       flatbuffers::Optional<int64_t> axis = 1)
{
    ...
    auto blockScaleQuantizeAttributes
        = hipdnn_flatbuffers_sdk::data_objects::CreateBlockScaleQuantizeAttributes(builder,
                                                                            1, // x uid
                                                                            2, // y uid
                                                                            3, // scale uid
                                                                            32, // block_size
...
inline flatbuffers::FlatBufferBuilder createValidCustomOpGraph()
{
    ...
    tensorAttributes.push_back(hipdnn_flatbuffers_sdk::data_objects::CreateTensorAttributesDirect(
        builder, 1, "input_0", hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT, &strides, &dims));
    tensorAttributes.push_back(hipdnn_flatbuffers_sdk::data_objects::CreateTensorAttributesDirect(
        builder, 2, "output_0", hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT, &strides, &dims));
...
inline flatbuffers::FlatBufferBuilder createValidReductionGraph()
{
    ...
    tensorAttributes.push_back(hipdnn_flatbuffers_sdk::data_objects::CreateTensorAttributesDirect(
        builder, 1, "input", hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT, &inStrides, &inDims));
    tensorAttributes.push_back(hipdnn_flatbuffers_sdk::data_objects::CreateTensorAttributesDirect(
        builder,
        2,
        "output",
...
{
    flatbuffers::FlatBufferBuilder builder;
    auto engineConfigOffset = hipdnn_flatbuffers_sdk::data_objects::CreateEngineConfig(builder, configId);
