...
#ifndef FLATBUFFERS_GENERATED_POINTWISEATTRIBUTES_HIPDNN_DATA_SDK_DATA_OBJECTS_H_
#define FLATBUFFERS_GENERATED_POINTWISEATTRIBUTES_HIPDNN_DATA_SDK_DATA_OBJECTS_H_
...
struct PointwiseAttributesT : public ::flatbuffers::NativeTable {
  ...
  hipdnn_flatbuffers_sdk::data_objects::PointwiseMode operation = hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::UNSET;
...
struct PointwiseAttributes FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  hipdnn_flatbuffers_sdk::data_objects::PointwiseMode operation() const {
    return static_cast<hipdnn_flatbuffers_sdk::data_objects::PointwiseMode>(GetField<int8_t>(VT_OPERATION, 0));
  }
  bool mutate_operation(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode _operation = static_cast<hipdnn_flatbuffers_sdk::data_objects::PointwiseMode>(0)) {
...
struct PointwiseAttributesBuilder {
  ...
  void add_operation(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode operation) {
...
inline ::flatbuffers::Offset<PointwiseAttributes> CreatePointwiseAttributes(::flatbuffers::FlatBufferBuilder &_fbb, const PointwiseAttributesT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return hipdnn_flatbuffers_sdk::data_objects::CreatePointwiseAttributes(
      _fbb,
      _operation,
      _relu_lower_clip,
      _relu_upper_clip,
...
#endif  // FLATBUFFERS_GENERATED_POINTWISEATTRIBUTES_HIPDNN_DATA_SDK_DATA_OBJECTS_H_
