...
{
using IEngineDetails = hipdnn_flatbuffers_sdk::flatbuffer_utilities::IEngineDetails;
using EngineDetailsWrapper = hipdnn_flatbuffers_sdk::flatbuffer_utilities::EngineDetailsWrapper;
} // namespace hipdnn_plugin_sdk
