...
/// `hipdnn_plugin_sdk::NativeRegistry<T>`, and this is an
/// instantiation of it.
///
...
///
/// Inherits the shared registry's semantics: thread-safe, duplicate
...
/// image, subject to the visibility settings documented by NativeRegistry.
