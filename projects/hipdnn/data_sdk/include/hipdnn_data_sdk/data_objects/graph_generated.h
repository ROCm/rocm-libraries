    ...
    const std::vector<::flatbuffers::Offset<hipdnn_data_sdk::data_objects::Node>>* nodes = nullptr)
{
    ...
    return hipdnn_data_sdk::data_objects::CreateGraph(
        _fbb, name__, compute_data_type, intermediate_data_type, io_data_type, tensors__, nodes__);
}
                                                ...
                                                const ::flatbuffers::rehasher_function_t* _rehasher)
{
    ...
    auto _nodes
        = _o->nodes.size()
              ...
              : 0;
    return hipdnn_data_sdk::data_objects::CreateGraph(
        _fbb, _name, _compute_data_type, _intermediate_data_type, _io_data_type, _tensors, _nodes);
}
