...
#ifndef FLATBUFFERS_GENERATED_BATCHNORMATTRIBUTES_HIPDNN_DATA_SDK_DATA_OBJECTS_H_
#define FLATBUFFERS_GENERATED_BATCHNORMATTRIBUTES_HIPDNN_DATA_SDK_DATA_OBJECTS_H_
...
struct BatchnormAttributes FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
{
    ...
    {
        return SetField<int64_t>(VT_PREV_RUNNING_VARIANCE_TENSOR_UID,
    ...
    {
        return SetField<int64_t>(VT_NEXT_RUNNING_VARIANCE_TENSOR_UID,
    ...
    BatchnormAttributesT* UnPack(const ::flatbuffers::resolver_function_t* _resolver
                                 = nullptr) const;
    void UnPackTo(BatchnormAttributesT* _o,
                  const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
    static ::flatbuffers::Offset<BatchnormAttributes>
        Pack(::flatbuffers::FlatBufferBuilder& _fbb,
             const BatchnormAttributesT* _o,
...
struct BatchnormAttributesBuilder
{
    ...
    {
        fbb_.AddElement<int64_t>(BatchnormAttributes::VT_PREV_RUNNING_MEAN_TENSOR_UID,
                                 prev_running_mean_tensor_uid);
    }
    void add_prev_running_variance_tensor_uid(int64_t prev_running_variance_tensor_uid)
    {
        fbb_.AddElement<int64_t>(BatchnormAttributes::VT_PREV_RUNNING_VARIANCE_TENSOR_UID,
    ...
    {
        fbb_.AddElement<int64_t>(BatchnormAttributes::VT_INV_VARIANCE_TENSOR_UID,
                                 inv_variance_tensor_uid);
    }
    void add_next_running_mean_tensor_uid(int64_t next_running_mean_tensor_uid)
    {
        fbb_.AddElement<int64_t>(BatchnormAttributes::VT_NEXT_RUNNING_MEAN_TENSOR_UID,
                                 next_running_mean_tensor_uid);
    }
    void add_next_running_variance_tensor_uid(int64_t next_running_variance_tensor_uid)
    {
        fbb_.AddElement<int64_t>(BatchnormAttributes::VT_NEXT_RUNNING_VARIANCE_TENSOR_UID,
    ...
    ::flatbuffers::Optional<int64_t> next_running_variance_tensor_uid = ::flatbuffers::nullopt)
{
    ...
    if(next_running_variance_tensor_uid)
    {
        builder_.add_next_running_variance_tensor_uid(*next_running_variance_tensor_uid);
    }
    if(next_running_mean_tensor_uid)
    {
        builder_.add_next_running_mean_tensor_uid(*next_running_mean_tensor_uid);
    }
    ...
    if(momentum_tensor_uid)
    {
        builder_.add_momentum_tensor_uid(*momentum_tensor_uid);
    }
    if(prev_running_variance_tensor_uid)
    {
        builder_.add_prev_running_variance_tensor_uid(*prev_running_variance_tensor_uid);
    }
    if(prev_running_mean_tensor_uid)
    {
        builder_.add_prev_running_mean_tensor_uid(*prev_running_mean_tensor_uid);
    }
...
::flatbuffers::Offset<BatchnormAttributes>
    CreateBatchnormAttributes(::flatbuffers::FlatBufferBuilder& _fbb,
                              const BatchnormAttributesT* _o,
                              const ::flatbuffers::rehasher_function_t* _rehasher = nullptr);

inline bool operator==(const BatchnormAttributesT& lhs, const BatchnormAttributesT& rhs)
{
    return (lhs.x_tensor_uid == rhs.x_tensor_uid) && (lhs.scale_tensor_uid == rhs.scale_tensor_uid)
           ...
           && (lhs.y_tensor_uid == rhs.y_tensor_uid) && (lhs.mean_tensor_uid == rhs.mean_tensor_uid)
...
inline BatchnormAttributesT*
    BatchnormAttributes::UnPack(const ::flatbuffers::resolver_function_t* _resolver) const
{
...
inline void BatchnormAttributes::UnPackTo(BatchnormAttributesT* _o,
                                          const ::flatbuffers::resolver_function_t* _resolver) const
{
    ...
    {
        auto _e = prev_running_mean_tensor_uid();
        _o->prev_running_mean_tensor_uid = _e;
    }
    {
        auto _e = prev_running_variance_tensor_uid();
        _o->prev_running_variance_tensor_uid = _e;
    }
    {
        auto _e = momentum_tensor_uid();
        _o->momentum_tensor_uid = _e;
    }
    {
    ...
    {
        auto _e = next_running_mean_tensor_uid();
        _o->next_running_mean_tensor_uid = _e;
    }
    {
        auto _e = next_running_variance_tensor_uid();
        _o->next_running_variance_tensor_uid = _e;
    }
}

inline ::flatbuffers::Offset<BatchnormAttributes>
    BatchnormAttributes::Pack(::flatbuffers::FlatBufferBuilder& _fbb,
                              const BatchnormAttributesT* _o,
                              ...
                              const ::flatbuffers::rehasher_function_t* _rehasher)
{
    ...
    struct _VectorArgs
    {
        ...
        const BatchnormAttributesT* __o;
...
#endif // FLATBUFFERS_GENERATED_BATCHNORMATTRIBUTES_HIPDNN_DATA_SDK_DATA_OBJECTS_H_
