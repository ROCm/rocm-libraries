...
{
    static const TensorValue values[] = {TensorValue::NONE,
...
{
    if(::flatbuffers::IsOutRange(e, TensorValue::NONE, TensorValue::Float64Value))
        return "";
...
template <typename T>
struct TensorValueTraits
{
    static const TensorValue enum_value = TensorValue::NONE;
};

template <>
struct TensorValueTraits<hipdnn_data_sdk::data_objects::Float32Value>
{
    static const TensorValue enum_value = TensorValue::Float32Value;
};

template <>
struct TensorValueTraits<hipdnn_data_sdk::data_objects::Float16Value>
{
    static const TensorValue enum_value = TensorValue::Float16Value;
};

template <>
struct TensorValueTraits<hipdnn_data_sdk::data_objects::BFloat16Value>
{
    static const TensorValue enum_value = TensorValue::BFloat16Value;
};

template <>
struct TensorValueTraits<hipdnn_data_sdk::data_objects::Float8Value>
{
    static const TensorValue enum_value = TensorValue::Float8Value;
};

template <>
struct TensorValueTraits<hipdnn_data_sdk::data_objects::Int32Value>
{
    static const TensorValue enum_value = TensorValue::Int32Value;
};

template <>
struct TensorValueTraits<hipdnn_data_sdk::data_objects::Float64Value>
{
    static const TensorValue enum_value = TensorValue::Float64Value;
};

template <typename T>
struct TensorValueUnionTraits
{
    static const TensorValue enum_value = TensorValue::NONE;
};

template <>
struct TensorValueUnionTraits<hipdnn_data_sdk::data_objects::Float32Value>
{
    static const TensorValue enum_value = TensorValue::Float32Value;
};

template <>
struct TensorValueUnionTraits<hipdnn_data_sdk::data_objects::Float16Value>
{
    static const TensorValue enum_value = TensorValue::Float16Value;
};

template <>
struct TensorValueUnionTraits<hipdnn_data_sdk::data_objects::BFloat16Value>
{
    static const TensorValue enum_value = TensorValue::BFloat16Value;
};

template <>
struct TensorValueUnionTraits<hipdnn_data_sdk::data_objects::Float8Value>
{
    static const TensorValue enum_value = TensorValue::Float8Value;
};

template <>
struct TensorValueUnionTraits<hipdnn_data_sdk::data_objects::Int32Value>
{
    static const TensorValue enum_value = TensorValue::Int32Value;
};

template <>
struct TensorValueUnionTraits<hipdnn_data_sdk::data_objects::Float64Value>
{
    static const TensorValue enum_value = TensorValue::Float64Value;
};
...
struct TensorValueUnion
{
    ...
    TensorValueUnion(TensorValueUnion&& u) FLATBUFFERS_NOEXCEPT : type(TensorValue::NONE),
                                                                  value(nullptr)
    {
...
inline bool operator==(const TensorValueUnion& lhs, const TensorValueUnion& rhs)
{
    ...
    case TensorValue::BFloat16Value:
    {
        return *(reinterpret_cast<const hipdnn_data_sdk::data_objects::BFloat16Value*>(lhs.value))
               == *(reinterpret_cast<const hipdnn_data_sdk::data_objects::BFloat16Value*>(
                   rhs.value));
    }
...
bool VerifyTensorValueVector(::flatbuffers::Verifier& verifier,
                             const ::flatbuffers::Vector<::flatbuffers::Offset<void>>* values,
                             const ::flatbuffers::Vector<TensorValue>* types);
...
struct TensorAttributesT : public ::flatbuffers::NativeTable
{
    ...
    int64_t uid = 0;
    std::string name{};
    hipdnn_data_sdk::data_objects::DataType data_type
...
struct TensorAttributes FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
{
    ...
    hipdnn_data_sdk::data_objects::DataType data_type() const
    {
        return static_cast<hipdnn_data_sdk::data_objects::DataType>(
            GetField<int8_t>(VT_DATA_TYPE, 0));
    }
    bool mutate_data_type(hipdnn_data_sdk::data_objects::DataType _data_type
    ...
    {
        return static_cast<hipdnn_data_sdk::data_objects::TensorValue>(
    ...
    {
        return value_type() == hipdnn_data_sdk::data_objects::TensorValue::Float32Value
                   ? static_cast<const hipdnn_data_sdk::data_objects::Float32Value*>(value())
                   : nullptr;
    }
    const hipdnn_data_sdk::data_objects::Float16Value* value_as_Float16Value() const
    {
        return value_type() == hipdnn_data_sdk::data_objects::TensorValue::Float16Value
                   ? static_cast<const hipdnn_data_sdk::data_objects::Float16Value*>(value())
                   : nullptr;
    }
    const hipdnn_data_sdk::data_objects::BFloat16Value* value_as_BFloat16Value() const
    {
        return value_type() == hipdnn_data_sdk::data_objects::TensorValue::BFloat16Value
                   ? static_cast<const hipdnn_data_sdk::data_objects::BFloat16Value*>(value())
                   : nullptr;
    }
    const hipdnn_data_sdk::data_objects::Float8Value* value_as_Float8Value() const
    {
        return value_type() == hipdnn_data_sdk::data_objects::TensorValue::Float8Value
                   ? static_cast<const hipdnn_data_sdk::data_objects::Float8Value*>(value())
                   : nullptr;
    }
    const hipdnn_data_sdk::data_objects::Int32Value* value_as_Int32Value() const
    {
        return value_type() == hipdnn_data_sdk::data_objects::TensorValue::Int32Value
                   ? static_cast<const hipdnn_data_sdk::data_objects::Int32Value*>(value())
                   : nullptr;
    }
    const hipdnn_data_sdk::data_objects::Float64Value* value_as_Float64Value() const
    {
        return value_type() == hipdnn_data_sdk::data_objects::TensorValue::Float64Value
                   ? static_cast<const hipdnn_data_sdk::data_objects::Float64Value*>(value())
                   : nullptr;
    }
    void* mutable_value()
    {
    ...
    {
        return VerifyTableStart(verifier) && VerifyField<int64_t>(verifier, VT_UID, 8)
               && VerifyOffset(verifier, VT_NAME) && verifier.VerifyString(name())
               && VerifyField<int8_t>(verifier, VT_DATA_TYPE, 1)
               && VerifyOffset(verifier, VT_STRIDES) && verifier.VerifyVector(strides())
               && VerifyOffset(verifier, VT_DIMS) && verifier.VerifyVector(dims())
               && VerifyField<uint8_t>(verifier, VT_VIRTUAL_, 1)
               && VerifyField<uint8_t>(verifier, VT_VALUE_TYPE, 1)
               && VerifyOffset(verifier, VT_VALUE)
               && VerifyTensorValue(verifier, value(), value_type()) && verifier.EndTable();
    }
    TensorAttributesT* UnPack(const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
    void UnPackTo(TensorAttributesT* _o,
                  const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
    static ::flatbuffers::Offset<TensorAttributes>
        Pack(::flatbuffers::FlatBufferBuilder& _fbb,
             const TensorAttributesT* _o,
             const ::flatbuffers::rehasher_function_t* _rehasher = nullptr);
};

template <>
inline const hipdnn_data_sdk::data_objects::Float32Value*
    TensorAttributes::value_as<hipdnn_data_sdk::data_objects::Float32Value>() const
{
    return value_as_Float32Value();
}

template <>
inline const hipdnn_data_sdk::data_objects::Float16Value*
    TensorAttributes::value_as<hipdnn_data_sdk::data_objects::Float16Value>() const
{
    return value_as_Float16Value();
}

template <>
inline const hipdnn_data_sdk::data_objects::BFloat16Value*
    TensorAttributes::value_as<hipdnn_data_sdk::data_objects::BFloat16Value>() const
{
    return value_as_BFloat16Value();
}

template <>
inline const hipdnn_data_sdk::data_objects::Float8Value*
    TensorAttributes::value_as<hipdnn_data_sdk::data_objects::Float8Value>() const
{
    return value_as_Float8Value();
}

template <>
inline const hipdnn_data_sdk::data_objects::Int32Value*
    TensorAttributes::value_as<hipdnn_data_sdk::data_objects::Int32Value>() const
{
    return value_as_Int32Value();
}

template <>
inline const hipdnn_data_sdk::data_objects::Float64Value*
    TensorAttributes::value_as<hipdnn_data_sdk::data_objects::Float64Value>() const
{
...
struct TensorAttributesBuilder
{
    ...
    void add_value_type(hipdnn_data_sdk::data_objects::TensorValue value_type)
    {
        fbb_.AddElement<uint8_t>(
            TensorAttributes::VT_VALUE_TYPE, static_cast<uint8_t>(value_type), 0);
    }
...
inline ::flatbuffers::Offset<TensorAttributes>
    CreateTensorAttributes(::flatbuffers::FlatBufferBuilder& _fbb,
                           int64_t uid = 0,
                           ...
                           bool virtual_ = false,
                           hipdnn_data_sdk::data_objects::TensorValue value_type
...
inline ::flatbuffers::Offset<TensorAttributes>
    CreateTensorAttributesDirect(::flatbuffers::FlatBufferBuilder& _fbb,
                                 int64_t uid = 0,
                                 ...
                                 ::flatbuffers::Offset<void> value = 0)
{
    ...
    return hipdnn_data_sdk::data_objects::CreateTensorAttributes(
        _fbb, uid, name__, data_type, strides__, dims__, virtual_, value_type, value);
}
...
{
    return (lhs.uid == rhs.uid) && (lhs.name == rhs.name) && (lhs.data_type == rhs.data_type)
           && (lhs.strides == rhs.strides) && (lhs.dims == rhs.dims)
           && (lhs.virtual_ == rhs.virtual_) && (lhs.value == rhs.value);
}
...
inline TensorAttributesT*
    TensorAttributes::UnPack(const ::flatbuffers::resolver_function_t* _resolver) const
{
...
inline void TensorAttributes::UnPackTo(TensorAttributesT* _o,
                                       const ::flatbuffers::resolver_function_t* _resolver) const
{
    ...
    }
    {
        auto _e = value();
        if(_e)
            _o->value.value = hipdnn_data_sdk::data_objects::TensorValueUnion::UnPack(
                _e, value_type(), _resolver);
    }
}

inline ::flatbuffers::Offset<TensorAttributes>
    TensorAttributes::Pack(::flatbuffers::FlatBufferBuilder& _fbb,
                           const TensorAttributesT* _o,
                           const ::flatbuffers::rehasher_function_t* _rehasher)
{
                           ...
                           const ::flatbuffers::rehasher_function_t* _rehasher)
{
    ...
    return hipdnn_data_sdk::data_objects::CreateTensorAttributes(
        _fbb, _uid, _name, _data_type, _strides, _dims, _virtual_, _value_type, _value);
}
...
inline bool VerifyTensorValue(::flatbuffers::Verifier& verifier, const void* obj, TensorValue type)
{
    ...
    case TensorValue::Float32Value:
    {
        return verifier.VerifyField<hipdnn_data_sdk::data_objects::Float32Value>(
            static_cast<const uint8_t*>(obj), 0, 4);
    }
    case TensorValue::Float16Value:
    {
        return verifier.VerifyField<hipdnn_data_sdk::data_objects::Float16Value>(
            static_cast<const uint8_t*>(obj), 0, 4);
    }
    case TensorValue::BFloat16Value:
    {
        return verifier.VerifyField<hipdnn_data_sdk::data_objects::BFloat16Value>(
            static_cast<const uint8_t*>(obj), 0, 4);
    }
    case TensorValue::Float8Value:
    {
        return verifier.VerifyField<hipdnn_data_sdk::data_objects::Float8Value>(
            static_cast<const uint8_t*>(obj), 0, 1);
    }
    case TensorValue::Int32Value:
    {
        return verifier.VerifyField<hipdnn_data_sdk::data_objects::Int32Value>(
            static_cast<const uint8_t*>(obj), 0, 4);
    }
    case TensorValue::Float64Value:
    {
        return verifier.VerifyField<hipdnn_data_sdk::data_objects::Float64Value>(
...
inline bool
    VerifyTensorValueVector(::flatbuffers::Verifier& verifier,
                            const ::flatbuffers::Vector<::flatbuffers::Offset<void>>* values,
                            const ::flatbuffers::Vector<TensorValue>* types)
{
    if(!values || !types)
    ...
    {
        if(!VerifyTensorValue(verifier, values->Get(i), types->GetEnum<TensorValue>(i)))
        {
            return false;
        }
    }
...
inline void* TensorValueUnion::UnPack(const void* obj,
                                      TensorValue type,
                                      const ::flatbuffers::resolver_function_t* resolver)
{
    (void)resolver;
...
inline ::flatbuffers::Offset<void>
    TensorValueUnion::Pack(::flatbuffers::FlatBufferBuilder& _fbb,
...
inline TensorValueUnion::TensorValueUnion(const TensorValueUnion& u)
    : type(u.type)
    , value(nullptr)
{
    switch(type)
    ...
    case TensorValue::Float32Value:
    {
        value = new hipdnn_data_sdk::data_objects::Float32Value(
            *reinterpret_cast<hipdnn_data_sdk::data_objects::Float32Value*>(u.value));
        break;
    }
    case TensorValue::Float16Value:
    {
        value = new hipdnn_data_sdk::data_objects::Float16Value(
            *reinterpret_cast<hipdnn_data_sdk::data_objects::Float16Value*>(u.value));
        break;
    }
    case TensorValue::BFloat16Value:
    {
        value = new hipdnn_data_sdk::data_objects::BFloat16Value(
            *reinterpret_cast<hipdnn_data_sdk::data_objects::BFloat16Value*>(u.value));
        break;
    }
    case TensorValue::Float8Value:
    {
        value = new hipdnn_data_sdk::data_objects::Float8Value(
            *reinterpret_cast<hipdnn_data_sdk::data_objects::Float8Value*>(u.value));
        break;
    }
    case TensorValue::Int32Value:
    {
        value = new hipdnn_data_sdk::data_objects::Int32Value(
            *reinterpret_cast<hipdnn_data_sdk::data_objects::Int32Value*>(u.value));
        break;
    }
    case TensorValue::Float64Value:
    {
        value = new hipdnn_data_sdk::data_objects::Float64Value(
            *reinterpret_cast<hipdnn_data_sdk::data_objects::Float64Value*>(u.value));
        break;
    }
    default:
        break;
