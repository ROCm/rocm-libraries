...
#ifndef FLATBUFFERS_GENERATED_BATCHNORMBACKWARDATTRIBUTES_HIPDNN_DATA_SDK_DATA_OBJECTS_H_
#define FLATBUFFERS_GENERATED_BATCHNORMBACKWARDATTRIBUTES_HIPDNN_DATA_SDK_DATA_OBJECTS_H_
...
struct BatchnormBackwardAttributes FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
{
    ...
    {
        return VerifyTableStart(verifier) && VerifyField<int64_t>(verifier, VT_DY_TENSOR_UID, 8)
               ...
               && VerifyField<int64_t>(verifier, VT_DBIAS_TENSOR_UID, 8) && verifier.EndTable();
    }
    BatchnormBackwardAttributesT* UnPack(const ::flatbuffers::resolver_function_t* _resolver
                                         = nullptr) const;
    void UnPackTo(BatchnormBackwardAttributesT* _o,
                  const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
    static ::flatbuffers::Offset<BatchnormBackwardAttributes>
        Pack(::flatbuffers::FlatBufferBuilder& _fbb,
             const BatchnormBackwardAttributesT* _o,
...
struct BatchnormBackwardAttributesBuilder
{
    ...
    {
        fbb_.AddElement<int64_t>(BatchnormBackwardAttributes::VT_INV_VARIANCE_TENSOR_UID,
                                 inv_variance_tensor_uid);
    }
    void add_scale_tensor_uid(int64_t scale_tensor_uid)
    {
        fbb_.AddElement<int64_t>(
            BatchnormBackwardAttributes::VT_SCALE_TENSOR_UID, scale_tensor_uid, 0);
    }
    void add_peer_stats_tensor_uid(
        ::flatbuffers::Offset<::flatbuffers::Vector<int64_t>> peer_stats_tensor_uid)
    {
        fbb_.AddOffset(BatchnormBackwardAttributes::VT_PEER_STATS_TENSOR_UID,
    ...
    {
        fbb_.AddElement<int64_t>(
            BatchnormBackwardAttributes::VT_DSCALE_TENSOR_UID, dscale_tensor_uid, 0);
    }
    void add_dbias_tensor_uid(int64_t dbias_tensor_uid)
    {
        fbb_.AddElement<int64_t>(
            BatchnormBackwardAttributes::VT_DBIAS_TENSOR_UID, dbias_tensor_uid, 0);
    }
...
inline ::flatbuffers::Offset<BatchnormBackwardAttributes> CreateBatchnormBackwardAttributesDirect(
    ...
    int64_t dbias_tensor_uid = 0)
{
    auto peer_stats_tensor_uid__
        = peer_stats_tensor_uid ? _fbb.CreateVector<int64_t>(*peer_stats_tensor_uid) : 0;
    return hipdnn_data_sdk::data_objects::CreateBatchnormBackwardAttributes(_fbb,
                                                                            dy_tensor_uid,
                                                                            x_tensor_uid,
                                                                            mean_tensor_uid,
                                                                            inv_variance_tensor_uid,
...
::flatbuffers::Offset<BatchnormBackwardAttributes>
    CreateBatchnormBackwardAttributes(::flatbuffers::FlatBufferBuilder& _fbb,
                                      const BatchnormBackwardAttributesT* _o,
                                      const ::flatbuffers::rehasher_function_t* _rehasher
                                      = nullptr);

inline bool operator==(const BatchnormBackwardAttributesT& lhs,
                       const BatchnormBackwardAttributesT& rhs)
{
    return (lhs.dy_tensor_uid == rhs.dy_tensor_uid) && (lhs.x_tensor_uid == rhs.x_tensor_uid)
...
inline BatchnormBackwardAttributesT*
    BatchnormBackwardAttributes::UnPack(const ::flatbuffers::resolver_function_t* _resolver) const
{
...
inline void
    BatchnormBackwardAttributes::UnPackTo(BatchnormBackwardAttributesT* _o,
                                          const ::flatbuffers::resolver_function_t* _resolver) const
{
    (void)_o;
    (void)_resolver;
    {
        auto _e = dy_tensor_uid();
        _o->dy_tensor_uid = _e;
    }
    {
    ...
    {
        auto _e = inv_variance_tensor_uid();
        _o->inv_variance_tensor_uid = _e;
    }
    {
    ...
    {
        auto _e = peer_stats_tensor_uid();
        if(_e)
        {
            _o->peer_stats_tensor_uid.resize(_e->size());
            for(::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++)
            {
                _o->peer_stats_tensor_uid[_i] = _e->Get(_i);
            }
        }
        else
        {
            _o->peer_stats_tensor_uid.resize(0);
        }
    }
    {
        auto _e = dx_tensor_uid();
        _o->dx_tensor_uid = _e;
    }
    {
        auto _e = dscale_tensor_uid();
        _o->dscale_tensor_uid = _e;
    }
    {
        auto _e = dbias_tensor_uid();
        _o->dbias_tensor_uid = _e;
    }
}

inline ::flatbuffers::Offset<BatchnormBackwardAttributes>
    BatchnormBackwardAttributes::Pack(::flatbuffers::FlatBufferBuilder& _fbb,
                                      const BatchnormBackwardAttributesT* _o,
                                      const ::flatbuffers::rehasher_function_t* _rehasher)
{
                                      ...
                                      const ::flatbuffers::rehasher_function_t* _rehasher)
{
    ...
    struct _VectorArgs
    {
        ...
        const BatchnormBackwardAttributesT* __o;
    ...
    auto _peer_stats_tensor_uid
        = _o->peer_stats_tensor_uid.size() ? _fbb.CreateVector(_o->peer_stats_tensor_uid) : 0;
...
#endif // FLATBUFFERS_GENERATED_BATCHNORMBACKWARDATTRIBUTES_HIPDNN_DATA_SDK_DATA_OBJECTS_H_
