...
struct KnobSetting FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
{
    ...
    {
        return static_cast<hipdnn_data_sdk::data_objects::KnobValue>(
    ...
    {
        return value_type() == hipdnn_data_sdk::data_objects::KnobValue::IntValue
                   ? static_cast<const hipdnn_data_sdk::data_objects::IntValue*>(value())
                   : nullptr;
    }
    const hipdnn_data_sdk::data_objects::FloatValue* value_as_FloatValue() const
    {
        return value_type() == hipdnn_data_sdk::data_objects::KnobValue::FloatValue
                   ? static_cast<const hipdnn_data_sdk::data_objects::FloatValue*>(value())
                   : nullptr;
    }
    const hipdnn_data_sdk::data_objects::StringValue* value_as_StringValue() const
    {
        return value_type() == hipdnn_data_sdk::data_objects::KnobValue::StringValue
                   ? static_cast<const hipdnn_data_sdk::data_objects::StringValue*>(value())
                   : nullptr;
    }
    void* mutable_value()
    {
    ...
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_KNOB_ID)
               && verifier.VerifyString(knob_id())
               && VerifyField<uint8_t>(verifier, VT_VALUE_TYPE, 1)
               && VerifyOffset(verifier, VT_VALUE)
               && VerifyKnobValue(verifier, value(), value_type()) && verifier.EndTable();
    }
    KnobSettingT* UnPack(const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
    void UnPackTo(KnobSettingT* _o,
                  const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
    static ::flatbuffers::Offset<KnobSetting>
        Pack(::flatbuffers::FlatBufferBuilder& _fbb,
             const KnobSettingT* _o,
             const ::flatbuffers::rehasher_function_t* _rehasher = nullptr);
};

template <>
inline const hipdnn_data_sdk::data_objects::IntValue*
    KnobSetting::value_as<hipdnn_data_sdk::data_objects::IntValue>() const
{
    return value_as_IntValue();
}

template <>
inline const hipdnn_data_sdk::data_objects::FloatValue*
    KnobSetting::value_as<hipdnn_data_sdk::data_objects::FloatValue>() const
{
    return value_as_FloatValue();
}

template <>
inline const hipdnn_data_sdk::data_objects::StringValue*
    KnobSetting::value_as<hipdnn_data_sdk::data_objects::StringValue>() const
{
...
inline ::flatbuffers::Offset<KnobSetting>
    CreateKnobSetting(::flatbuffers::FlatBufferBuilder& _fbb,
                      ::flatbuffers::Offset<::flatbuffers::String> knob_id = 0,
                      hipdnn_data_sdk::data_objects::KnobValue value_type
...
inline ::flatbuffers::Offset<KnobSetting>
    CreateKnobSettingDirect(::flatbuffers::FlatBufferBuilder& _fbb,
                            ...
                            ::flatbuffers::Offset<void> value = 0)
{
    ...
    return hipdnn_data_sdk::data_objects::CreateKnobSetting(_fbb, knob_id__, value_type, value);
}

::flatbuffers::Offset<KnobSetting>
    CreateKnobSetting(::flatbuffers::FlatBufferBuilder& _fbb,
                      const KnobSettingT* _o,
                      const ::flatbuffers::rehasher_function_t* _rehasher = nullptr);
...
struct EngineConfig FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
{
    ...
    const ::flatbuffers::Vector<::flatbuffers::Offset<hipdnn_data_sdk::data_objects::KnobSetting>>*
        knobs() const
    {
        return GetPointer<const ::flatbuffers::Vector<
            ::flatbuffers::Offset<hipdnn_data_sdk::data_objects::KnobSetting>>*>(VT_KNOBS);
    }
    ::flatbuffers::Vector<::flatbuffers::Offset<hipdnn_data_sdk::data_objects::KnobSetting>>*
        mutable_knobs()
    {
    ...
    bool Verify(::flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<int64_t>(verifier, VT_ENGINE_ID, 8)
               && VerifyOffset(verifier, VT_KNOBS) && verifier.VerifyVector(knobs())
               && verifier.VerifyVectorOfTables(knobs()) && verifier.EndTable();
    }
    EngineConfigT* UnPack(const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
    void UnPackTo(EngineConfigT* _o,
                  const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
    static ::flatbuffers::Offset<EngineConfig>
        Pack(::flatbuffers::FlatBufferBuilder& _fbb,
             const EngineConfigT* _o,
             const ::flatbuffers::rehasher_function_t* _rehasher = nullptr);
};
...
struct EngineConfigBuilder
{
    ...
    void add_knobs(::flatbuffers::Offset<::flatbuffers::Vector<
                       ::flatbuffers::Offset<hipdnn_data_sdk::data_objects::KnobSetting>>> knobs)
    {
...
inline ::flatbuffers::Offset<EngineConfig>
    CreateEngineConfig(::flatbuffers::FlatBufferBuilder& _fbb,
                       int64_t engine_id = 0,
...
inline ::flatbuffers::Offset<EngineConfig> CreateEngineConfigDirect(
    ...
    int64_t engine_id = 0,
    const std::vector<::flatbuffers::Offset<hipdnn_data_sdk::data_objects::KnobSetting>>* knobs
    = nullptr)
{
    auto knobs__
        = knobs ? _fbb.CreateVector<
                      ::flatbuffers::Offset<hipdnn_data_sdk::data_objects::KnobSetting>>(*knobs)
                : 0;
    return hipdnn_data_sdk::data_objects::CreateEngineConfig(_fbb, engine_id, knobs__);
}

::flatbuffers::Offset<EngineConfig>
    CreateEngineConfig(::flatbuffers::FlatBufferBuilder& _fbb,
                       const EngineConfigT* _o,
                       const ::flatbuffers::rehasher_function_t* _rehasher = nullptr);
...
{
    return (lhs.knob_id == rhs.knob_id) && (lhs.value == rhs.value);
}
...
inline void KnobSetting::UnPackTo(KnobSettingT* _o,
                                  const ::flatbuffers::resolver_function_t* _resolver) const
{
    ...
    }
    {
        auto _e = value();
        if(_e)
            _o->value.value = hipdnn_data_sdk::data_objects::KnobValueUnion::UnPack(
                _e, value_type(), _resolver);
    }
}

inline ::flatbuffers::Offset<KnobSetting>
    KnobSetting::Pack(::flatbuffers::FlatBufferBuilder& _fbb,
                      const KnobSettingT* _o,
                      ...
                      const ::flatbuffers::rehasher_function_t* _rehasher)
{
    ...
    return hipdnn_data_sdk::data_objects::CreateKnobSetting(_fbb, _knob_id, _value_type, _value);
}

inline bool operator==(const EngineConfigT& lhs, const EngineConfigT& rhs)
{
    return (lhs.engine_id == rhs.engine_id)
           && (lhs.knobs.size() == rhs.knobs.size()
               && std::equal(
                   lhs.knobs.cbegin(),
                   lhs.knobs.cend(),
                   rhs.knobs.cbegin(),
                   [](std::unique_ptr<hipdnn_data_sdk::data_objects::KnobSettingT> const& a,
                      std::unique_ptr<hipdnn_data_sdk::data_objects::KnobSettingT> const& b) {
                       return (a == b) || (a && b && *a == *b);
                   }));
}
    ...
    : engine_id(o.engine_id)
{
    ...
    for(const auto& knobs_ : o.knobs)
    {
        knobs.emplace_back((knobs_) ? new hipdnn_data_sdk::data_objects::KnobSettingT(*knobs_)
                                    : nullptr);
    }
}
...
inline EngineConfigT*
    EngineConfig::UnPack(const ::flatbuffers::resolver_function_t* _resolver) const
{
...
inline void EngineConfig::UnPackTo(EngineConfigT* _o,
                                   const ::flatbuffers::resolver_function_t* _resolver) const
{
    (void)_o;
    (void)_resolver;
    ...
    }
    {
        ...
        if(_e)
        {
            _o->knobs.resize(_e->size());
            for(::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++)
            {
                if(_o->knobs[_i])
                {
                    _e->Get(_i)->UnPackTo(_o->knobs[_i].get(), _resolver);
                }
                else
                {
                    _o->knobs[_i] = std::unique_ptr<hipdnn_data_sdk::data_objects::KnobSettingT>(
...
inline ::flatbuffers::Offset<EngineConfig>
    EngineConfig::Pack(::flatbuffers::FlatBufferBuilder& _fbb,
                       const EngineConfigT* _o,
                       const ::flatbuffers::rehasher_function_t* _rehasher)
{
                       ...
                       const ::flatbuffers::rehasher_function_t* _rehasher)
{
    ...
    {
        ::flatbuffers::FlatBufferBuilder* __fbb;
        const EngineConfigT* __o;
        const ::flatbuffers::rehasher_function_t* __rehasher;
    } _va = {&_fbb, _o, _rehasher};
    (void)_va;
    auto _engine_id = _o->engine_id;
    auto _knobs = _o->knobs.size()
                      ? _fbb.CreateVector<
                            ::flatbuffers::Offset<hipdnn_data_sdk::data_objects::KnobSetting>>(
                            _o->knobs.size(),
                            [](size_t i, _VectorArgs* __va) {
                                return CreateKnobSetting(
                                    *__va->__fbb, __va->__o->knobs[i].get(), __va->__rehasher);
                            },
                            &_va)
                      : 0;
    return hipdnn_data_sdk::data_objects::CreateEngineConfig(_fbb, _engine_id, _knobs);
}
...
inline const hipdnn_data_sdk::data_objects::EngineConfig*
    GetSizePrefixedEngineConfig(const void* buf)
{
...
{
    return ::flatbuffers::GetMutableSizePrefixedRoot<hipdnn_data_sdk::data_objects::EngineConfig>(
        buf);
}

inline bool VerifyEngineConfigBuffer(::flatbuffers::Verifier& verifier)
{
    return verifier.VerifyBuffer<hipdnn_data_sdk::data_objects::EngineConfig>(nullptr);
}

inline bool VerifySizePrefixedEngineConfigBuffer(::flatbuffers::Verifier& verifier)
{
...
inline std::unique_ptr<hipdnn_data_sdk::data_objects::EngineConfigT>
    UnPackEngineConfig(const void* buf, const ::flatbuffers::resolver_function_t* res = nullptr)
{
    return std::unique_ptr<hipdnn_data_sdk::data_objects::EngineConfigT>(
        GetEngineConfig(buf)->UnPack(res));
}

inline std::unique_ptr<hipdnn_data_sdk::data_objects::EngineConfigT>
    UnPackSizePrefixedEngineConfig(const void* buf,
                                   const ::flatbuffers::resolver_function_t* res = nullptr)
{
    return std::unique_ptr<hipdnn_data_sdk::data_objects::EngineConfigT>(
        GetSizePrefixedEngineConfig(buf)->UnPack(res));
}
