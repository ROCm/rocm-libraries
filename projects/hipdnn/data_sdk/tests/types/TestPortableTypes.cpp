...
TYPED_TEST(StorageFloatTypes, Equality)
{
    using T = TypeParam;
...
TYPED_TEST(StorageFloatTypes, Inequality)
{
    using T = TypeParam;
...
TYPED_TEST(StorageFloatTypes, LessThan)
{
    using T = TypeParam;
...
TYPED_TEST(StorageFloatTypes, GreaterThan)
{
    using T = TypeParam;
...
TYPED_TEST(StorageFloatTypes, LessThanOrEqual)
{
    using T = TypeParam;
...
TYPED_TEST(StorageFloatTypes, GreaterThanOrEqual)
{
    using T = TypeParam;
...
TYPED_TEST(StorageFloatTypes, NanComparisonSemantics)
{
    using T = TypeParam;
