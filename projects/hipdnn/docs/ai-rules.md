...
- **[Design Overview](./Design.md)** - Core architecture and component interactions
- **[Building](./Building.md)** - Build system and dependencies
- **[Testing](./Testing.md)** - Testing strategy and organization
- **[Plugin Development](./PluginDevelopment.md)** - Plugin API and extension points
...
- **Prefer TYPED_TEST for multi-datatype tests** - When testing functionality across multiple data types (float, half, bfloat16), use TYPED_TEST instead of duplicating test code
