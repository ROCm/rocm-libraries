...
See [Testing Strategy](TESTING.md#2-integration-tests) for more information on integration tests. Integration tests should be named to reflect the feature or component under test.
