...
Following the [Testing Strategy](./TESTING.md#detailed-testing-layer-reference), plugins should organize tests as follows:
...
Moreover, see our [general testing requirements](./TESTING.md#3-general-testing-requirements).
