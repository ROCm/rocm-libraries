...
2. Add it to the registry. Submit a PR to add your engine name to [`plugin_sdk/include/hipdnn_plugin_sdk/EngineNames.hpp`](../plugin_sdk/include/hipdnn_plugin_sdk/EngineNames.hpp):
   
  .. code:: cpp

    HIPDNN_REGISTER_ENGINE(MY_NEW_ENGINE, "MY_NEW_ENGINE")

1. Test it locally. You can use unregistered names during development; they'll generate a warning, but they'll work correctly.
...
2. Implement the plugin API functions.
  ...
  - **Engine name and ID**: Name your engine and place it in the [EngineNames](../plugin_sdk/include/hipdnn_plugin_sdk/EngineNames.hpp) registry
...
[MIOpen Provider Plugin](../../../dnn-providers/miopen-provider/)
