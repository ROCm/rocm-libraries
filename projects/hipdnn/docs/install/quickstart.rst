...
.. important::
  ...
  This guide is appropriate for most general-purpose userss. Advanced users (i.e., plugin developers) who want to build from source should refer to :ref:`prerequisites`.
