...
| `miopen-provider-<category>-check` | Run miopen-provider tests labeled by a category from its test category YAML files; current categories include `quick`, `standard`, `comprehensive`, `full`, `unit`, and `integration` |
