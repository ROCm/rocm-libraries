.. meta::
  :description: Follow these best practices for coding style and naming guidelines when interacting with the hipDNN frontend.
...
Follow these best practices for coding style and naming guidelines when interacting with the hipDNN frontend.
