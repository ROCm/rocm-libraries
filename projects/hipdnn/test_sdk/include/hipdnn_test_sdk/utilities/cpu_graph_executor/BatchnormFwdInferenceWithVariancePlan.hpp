...
struct BatchnormFwdInferenceWithVarianceParams
{
    ...
    BatchnormFwdInferenceWithVarianceParams(
        ...
        const hipdnn_sdk::data_objects::TensorAttributes& varianceAttributes,
        double epsilon)
    ...
    hipdnn_sdk::data_objects::TensorAttributesT varianceTensor;
    double epsilon;
};
...
class BatchnormFwdWithVariancePlan : public IGraphNodePlanExecutor
{
public:
    BatchnormFwdWithVariancePlan(BatchnormFwdInferenceWithVarianceParams&& params)
...
public:
            ...
            tensorMap) const override
    {
        ...
        const auto* nodeAttributes = node.attributes_as_BatchnormInferenceWithVarianceAttributes();
                      ...
                      const hipdnn_sdk::data_objects::Node& node) const override
    {
        ...
        if(nodeAttributes == nullptr)
        {
            throw std::runtime_error(
                "Node attributes are not of type BatchnormInferenceWithVarianceAttributes");
        }
        ...
        BatchnormFwdInferenceWithVarianceParams params(
            ...
            *tensorMap.at(nodeAttributes->variance_tensor_uid()),
            nodeAttributes->epsilon());

        return std::make_unique<BatchnormFwdWithVariancePlan<XDataType,
                                                             ScaleBiasDataType,
