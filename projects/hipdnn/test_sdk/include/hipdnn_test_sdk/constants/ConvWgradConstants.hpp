...
constexpr int64_t K_WGRAD_INTEG_TENSOR_X_UID = 1250;
constexpr int64_t K_WGRAD_INTEG_TENSOR_DY_UID = 1251;
constexpr int64_t K_WGRAD_INTEG_TENSOR_DW_UID = 1252;

constexpr std::array<int64_t, 4> K_WGRAD_INTEG_TENSOR_X_DIMS = {2, 3, 14, 14};
constexpr std::array<int64_t, 4> K_WGRAD_INTEG_TENSOR_X_STRIDES = {588, 196, 14, 1};
constexpr std::array<int64_t, 4> K_WGRAD_INTEG_TENSOR_DY_DIMS = {2, 8, 7, 7};
constexpr std::array<int64_t, 4> K_WGRAD_INTEG_TENSOR_DY_STRIDES = {392, 49, 7, 1};

constexpr std::array<int64_t, 2> K_WGRAD_INTEG_CONV_PRE_PADDING = {1, 1};
constexpr std::array<int64_t, 2> K_WGRAD_INTEG_CONV_POST_PADDING = {1, 1};
constexpr std::array<int64_t, 2> K_WGRAD_INTEG_CONV_STRIDE = {2, 2};
constexpr std::array<int64_t, 2> K_WGRAD_INTEG_CONV_DILATION = {1, 1};
