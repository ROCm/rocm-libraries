...
constexpr int64_t K_LAYERNORM_TENSOR_X_UID = 80;
...
constexpr int64_t K_LAYERNORM_TENSOR_SCALE_UID = 81;
...
constexpr int64_t K_LAYERNORM_TENSOR_BIAS_UID = 82;
...
constexpr int64_t K_LAYERNORM_TENSOR_MEAN_UID = 85;
...
constexpr int64_t K_LAYERNORM_TENSOR_INV_VARIANCE_UID = 86;
