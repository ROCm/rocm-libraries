...
TEST_F(TestLogRecorder, GetRecordedLogsAsStringFormatsLogs)
{
    ...
    std::string const output = recorder.getRecordedLogsAsString();
...
TEST_F(TestLogRecorder, GetRecordedLogsAsStringWithMaxLogsLimitsOutput)
{
    ...
    std::string const output = recorder.getRecordedLogsAsString(3);
...
TEST_F(TestLogRecorder, GetRecordedLogsAsStringSkipMessageSingular)
{
    ...
    std::string const output = recorder.getRecordedLogsAsString(1);
...
TEST_F(TestLogRecorder, GetRecordedLogsAsStringNoLimitShowsAll)
{
    ...
    std::string const output = recorder.getRecordedLogsAsString(0); // 0 = no limit
...
TEST_F(TestLogRecorder, GetRecordedLogsAsStringMaxLogsGreaterThanCountShowsAll)
{
    ...
    std::string const output = recorder.getRecordedLogsAsString(10); // More than available
...
TEST_F(TestLogRecorder, SimpleStderrOutputCallbackOutputsValidMessage)
{
    ...
    std::stringstream const capturedOutput;
    ...
    std::string const output = capturedOutput.str();
