...
class TestBatchnormFwdInferenceWithVariancePlan : public ::testing::Test
{
protected:
...
TEST_F(TestBatchnormFwdInferenceWithVariancePlan, ExecutePlan)
{
...
TEST(TestBatchnormFwdInferenceWithVariancePlanBuilder, IsApplicable)
{
    ...
    tensorMapCopy.erase(7); // Remove Y tensor (output) to test failure case
