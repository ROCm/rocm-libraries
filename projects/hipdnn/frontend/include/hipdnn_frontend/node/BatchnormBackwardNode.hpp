...
class BatchnormBackwardNode : public BaseNode<BatchnormBackwardNode, NodeType::BatchnormBackward>
{
public:
    ...
    {
        BaseNode<BatchnormBackwardNode, NodeType::BatchnormBackward>::gather_hipdnn_tensors(
            allTensors);
