...
public:
    ...
    SdpaFpropNode(SdpaAttributes&& sdpaAttributes, const GraphAttributes& graphAttrs)
        : BaseNode(graphAttrs)
    ...
    Error pre_validate_node() const override
    {
        ...
        HIPDNN_RETURN_IF_FALSE(
            q, ErrorCode::ATTRIBUTE_NOT_SET, std::string("SdpaFpropNode missing Q input"));
        HIPDNN_RETURN_IF_FALSE(
            k, ErrorCode::ATTRIBUTE_NOT_SET, std::string("SdpaFpropNode missing K input"));
        HIPDNN_RETURN_IF_FALSE(
            v, ErrorCode::ATTRIBUTE_NOT_SET, std::string("SdpaFpropNode missing V input"));
        HIPDNN_RETURN_IF_FALSE(
            o, ErrorCode::ATTRIBUTE_NOT_SET, std::string("SdpaFpropNode missing O output"));
        ...
        HIPDNN_RETURN_IF_NE(qDims.size(),
                            ...
                            "SdpaFpropNode: Query tensor Q must be rank-4, got rank="
                                + std::to_string(qDims.size()));
        HIPDNN_RETURN_IF_NE(kDims.size(),
                            reqRank,
                            ErrorCode::INVALID_VALUE,
                            "SdpaFpropNode: Key tensor K must be rank-4, got rank="
        ...
        HIPDNN_RETURN_IF_NE(headDimQ,
                            headDimK,
                            ErrorCode::INVALID_VALUE,
                            "SdpaFpropNode: head_dim mismatch between Q and K: "
        ...
        if(attnMask)
        {
            ...
            HIPDNN_RETURN_IF_TRUE(maskRank > static_cast<size_t>(4),
                                  ErrorCode::INVALID_VALUE,
                                  "SdpaFpropNode: ATTN_MASK rank must be <= 4, got rank="
            ...
            HIPDNN_RETURN_IF_TRUE(maskLast != seqKv && maskLast != 1,
                                  ErrorCode::INVALID_VALUE,
                                  "SdpaFpropNode: ATTN_MASK last dim must equal seq_kv ("
            ...
            if(maskRank >= 2)
            {
                ...
                HIPDNN_RETURN_IF_TRUE(maskSecondLast != seqQ && maskSecondLast != 1,
                                      ErrorCode::INVALID_VALUE,
                                      "SdpaFpropNode: ATTN_MASK second-to-last dim must equal "
                                      "seq_q ("
