...
#include <hipdnn_sdk/data_objects/batchnorm_inference_with_variance_attributes_generated.h>
#include <memory>
#include <unordered_map>

namespace hipdnn_frontend::graph
{
class BatchnormInferenceWithVarianceAttributes
    : public Attributes<BatchnormInferenceWithVarianceAttributes>
{
public:
    ...
    // NOLINTNEXTLINE(readability-identifier-naming)
    BatchnormInferenceWithVarianceAttributes& set_x(const std::shared_ptr<TensorAttributes>& value)
    {
        return setInput(InputNames::X, value);
    }
    // NOLINTNEXTLINE(readability-identifier-naming)
    BatchnormInferenceWithVarianceAttributes& set_x(std::shared_ptr<TensorAttributes>&& value)
    {
    ...
    // NOLINTNEXTLINE(readability-identifier-naming)
    BatchnormInferenceWithVarianceAttributes& set_mean(std::shared_ptr<TensorAttributes>&& value)
    {
    ...
    // NOLINTNEXTLINE(readability-identifier-naming)
    BatchnormInferenceWithVarianceAttributes& set_scale(std::shared_ptr<TensorAttributes>&& value)
    {
    ...
    // NOLINTNEXTLINE(readability-identifier-naming)
    BatchnormInferenceWithVarianceAttributes& set_bias(std::shared_ptr<TensorAttributes>&& value)
    {
        return setInput(InputNames::BIAS, std::move(value));
    }
    // NOLINTNEXTLINE(readability-identifier-naming)
    BatchnormInferenceWithVarianceAttributes& set_y(const std::shared_ptr<TensorAttributes>& value)
    {
        return setOutput(OutputNames::Y, value);
    }
    // NOLINTNEXTLINE(readability-identifier-naming)
    BatchnormInferenceWithVarianceAttributes& set_y(std::shared_ptr<TensorAttributes>&& value)
    {
    ...
    // NOLINTNEXTLINE(readability-identifier-naming)
    BatchnormInferenceWithVarianceAttributes& set_epsilon(std::shared_ptr<TensorAttributes>&& value)
    {
        epsilon = std::move(value);
        return *this;
    }

    flatbuffers::Offset<hipdnn_sdk::data_objects::BatchnormInferenceWithVarianceAttributes>
        pack_attributes(flatbuffers::FlatBufferBuilder& builder) const // NOLINT
    {
        auto mean = get_mean();
        auto variance = get_variance();
        double epsilonValue = epsilon ? epsilon->get_pass_by_value<double>().value_or(0.0) : 0.0;
...
private:
    ...
    BatchnormInferenceWithVarianceAttributes& setInput(InputNames name,
    ...
    BatchnormInferenceWithVarianceAttributes& setOutput(OutputNames name,
                                                        std::shared_ptr<TensorAttributes>&& value)
    {
...
typedef BatchnormInferenceWithVarianceAttributes Batchnorm_inference_with_variance_attributes;
} // namespace hipdnn_frontend::graph
