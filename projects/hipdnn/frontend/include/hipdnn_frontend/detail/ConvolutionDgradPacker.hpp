...
// Builds a convolutionbwd operation descriptor from ConvDgradAttributes.
    ...
    std::vector<ScopedHipdnnBackendDescriptor>& operations)
{
    ...
    if(!opDesc.valid())
    {
        return {ErrorCode::HIPDNN_BACKEND_ERROR,
                "Failed to create convolutionbwd operation descriptor"};
    }
    ...
    HIPDNN_CHECK_ERROR(setDescriptorAttrDataType(opDesc.get(),
                                                 ...
                                                 "convolutionbwd compute data type"));

    // Finalize operation descriptor
    HIPDNN_CHECK_ERROR(finalizeDescriptor(opDesc.get(), "convolutionbwd operation descriptor"));
