...
TEST(TestBatchnormBackwardAttributes, LogicalAndStrictEquality)
{
    ...
    structuralMismatchDy->set_uid(99)
    .set_name("MismatchedDY"); 
    ...
    logicalMatchDy->set_uid(555)   // Diverges from attr1's dy1 (uid: 1)
    ...
    logicalMatchPeer->set_uid(999) // Diverges from attr1's peer (uid: 10)
