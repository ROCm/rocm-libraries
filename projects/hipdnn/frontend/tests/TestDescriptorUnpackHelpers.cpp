                                  ...
                                  const std::array<int64_t, 4>& strides)
{
    ...
    EXPECT_CALL(
        mock,
        backendGetAttribute(
            fakeDesc, HIPDNN_ATTR_TENSOR_IS_RUNTIME_PASS_BY_VALUE, HIPDNN_TYPE_BOOLEAN, 1, _, _))
        .WillOnce(DoAll(SetArgPointee<4>(int64_t{1}),
                        Invoke([](hipdnnBackendDescriptor_t,
                                  hipdnnBackendAttributeName_t,
                                  hipdnnBackendAttributeType_t,
...
TEST_F(TestUnpackTensorAttributes, UnpackTensorAttributesPassByValuePreserves4dDims)
{
    ...
    EXPECT_CALL(
        *_mockBackend,
        backendGetAttribute(
            _fakeDesc, HIPDNN_ATTR_TENSOR_IS_RUNTIME_PASS_BY_VALUE, HIPDNN_TYPE_BOOLEAN, 1, _, _))
        .WillOnce(DoAll(SetArgPointee<4>(int64_t{1}),
                        Invoke([](hipdnnBackendDescriptor_t,
                                  hipdnnBackendAttributeName_t,
                                  hipdnnBackendAttributeType_t,
