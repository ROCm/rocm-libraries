...
TEST(TestBatchnormInferenceNode, PreValidateNode)
{
    ...
    GraphAttributes const graphAttributes;
    BatchnormInferenceNode const node(std::move(batchnormAttributes), graphAttributes);
...
TEST(TestBatchnormInferenceNode, PreValidateNodeMissingValues)
{
    ...
    BatchnormInferenceNode const nodeWithX(std::move(batchnormAttributesCopy), graphAttributes);
    ...
    BatchnormInferenceNode const nodeWithY(std::move(batchnormAttributesCopy), graphAttributes);
    ...
    batchnormAttributes.set_scale(std::make_shared<TensorAttributes>());
    batchnormAttributesCopy = batchnormAttributes;
    BatchnormInferenceNode const nodeWithScale(std::move(batchnormAttributesCopy), graphAttributes);
    ...
    batchnormAttributes.set_bias(std::make_shared<TensorAttributes>());
    batchnormAttributesCopy = batchnormAttributes;
    BatchnormInferenceNode const nodeWithBias(std::move(batchnormAttributesCopy), graphAttributes);
    ...
    batchnormAttributes.set_mean(std::make_shared<TensorAttributes>());
    batchnormAttributesCopy = batchnormAttributes;
    BatchnormInferenceNode const nodeWithMean(std::move(batchnormAttributesCopy), graphAttributes);
...
TEST(TestBatchnormInferenceNode, GatherHipdnnTensors)
{
    ...
    GraphAttributes const graphAttributes;
    BatchnormInferenceNode const node(std::move(bnAttributes), graphAttributes);
