...
MiopenContainer::MiopenContainer()
{
    ...
    auto batchnormFwdTrainingActivPlanBuilder
        = std::make_unique<MiopenBatchnormFwdTrainingActivPlanBuilder>();
    miopenEngine->addPlanBuilder(std::move(batchnormFwdTrainingActivPlanBuilder));
