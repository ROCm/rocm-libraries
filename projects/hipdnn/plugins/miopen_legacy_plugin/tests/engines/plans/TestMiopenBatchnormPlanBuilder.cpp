...
TEST_F(TestMiopenBatchnormPlanBuilder, IsApplicableReturnsFalseForTwoNodeFusionUnsupportedActivatio)
{
    ...
    // BN inference
    auto bnInfAttr
        = hipdnn_data_sdk::data_objects::CreateBatchnormInferenceAttributes(builder, 1, 4, 5, 2, 3, 6);
...
TEST_F(TestMiopenBatchnormPlanBuilder, IsApplicableReturnsFalseForThreeNodeUnsupportedActivation)
{
    ...
    // BN inference
    auto bnInfAttr
        = hipdnn_data_sdk::data_objects::CreateBatchnormInferenceAttributes(builder, 1, 4, 5, 2, 3, 10);
    nodes.push_back(hipdnn_data_sdk::data_objects::CreateNodeDirect(
        builder,
        "bn_inf",
        hipdnn_data_sdk::data_objects::DataType::UNSET,
...
TEST_F(TestMiopenBatchnormPlanBuilder, BuildPlanThrowsForUnsupportedNodeType)
{
    ...
    auto node
        = hipdnn_data_sdk::data_objects::CreateNodeDirect(builder,
                                                     "unsupported",
                                                     hipdnn_data_sdk::data_objects::DataType::FLOAT,
