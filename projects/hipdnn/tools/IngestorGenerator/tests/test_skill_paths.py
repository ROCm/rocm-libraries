...
# The six files the tightening pass leaves in place; prompt.md is being
# deleted (its content redistributed) and is deliberately not in this list --
# a resurrected prompt.md would need adding back here explicitly, not picked
# up by a glob, so an accidental revert is a visible test-file diff.
_SKILL_FILES = (
    "SKILL.md",
    "RUNBOOK.md",
    "graph-contract.md",
