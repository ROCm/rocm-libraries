...
(`Knowledge/hipdnn/integration-tests-green-is-not-coverage.md`) — which is why this
...
(`Knowledge/hipdnn/harness-reference-input-parity.md`). Reproduce the pattern; do not
improve on it.
