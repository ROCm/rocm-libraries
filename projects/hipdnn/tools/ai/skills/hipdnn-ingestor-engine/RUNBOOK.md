...
`$GEN/configs/gfx942_attention_dense.profile.yaml` is a worked authoring profile to copy
for `PROFILE`: a second arch was driven end to end by copying it and changing about six
values, and it carries a worked six-surface block at the bottom.
