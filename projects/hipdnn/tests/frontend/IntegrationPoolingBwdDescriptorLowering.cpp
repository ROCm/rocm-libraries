...
class IntegrationPoolingBwdDescriptorLowering : public ::testing::Test
{
protected:
    void SetUp() override
    {
        ...
        PoolingBwdAttributes& attrs)
    {
        ...
        graph->set_name("PoolingBwdIntegrationTest")
...
TEST_F(IntegrationPoolingBwdDescriptorLowering, PoolingBwdLoweringRoundTrip)
{
    PoolingBwdAttributes attrs;
    ...
    EXPECT_EQ(node->attributes.type, NodeAttrType::PoolingBwdAttributes);

    auto* opNode = node->attributes.AsPoolingBwdAttributes();
