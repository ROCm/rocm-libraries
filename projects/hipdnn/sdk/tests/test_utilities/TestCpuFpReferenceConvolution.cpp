...
TEST(TestCpuFpReferenceConvolutionFp32, ConvolutionFwdInferenceBasic)
{
    ...
    CpuFpReferenceConvolutionImpl<float, float, float, float>::convFwdInference(
...
TEST(TestCpuFpReferenceConvolutionBfp16, ConvolutionFwdInferenceBasic)
{
    ...
    CpuFpReferenceConvolutionImpl<hip_bfloat16, hip_bfloat16, float, hip_bfloat16>::
        convFwdInference(inputTensor, weightTensor, outputTensor, strides, dilations, padding);
...
TEST(TestCpuFpReferenceConvolutionFp16, ConvolutionFwdInferenceBasic)
{
    ...
    CpuFpReferenceConvolutionImpl<half, half, float, half>::convFwdInference(
        inputTensor, weightTensor, outputTensor, strides, dilations, padding);
...
TEST(TestCpuFpReferenceConvolutionFp64, ConvolutionFwdInferenceBasic)
{
    ...
    CpuFpReferenceConvolutionImpl<double, double, double, double>::convFwdInference(
        inputTensor, weightTensor, outputTensor, strides, dilations, padding);
...
TEST(TestCpuFpReferenceConvolutionFp16, ConvolutionBwdDataBasic)
{
    ...
    CpuFpReferenceConvolutionImpl<half, half, float, half>::convBwdData(
        inputTensor, weightTensor, outputTensor, strides, dilations, padding);
}
...
TEST(TestCpuFpReferenceConvolutionBfp16, ConvolutionBwdDataBasic)
{
    ...
    CpuFpReferenceConvolutionImpl<hip_bfloat16, hip_bfloat16, float, hip_bfloat16>::convBwdData(
        inputTensor, weightTensor, outputTensor, strides, dilations, padding);
}
...
TEST(TestCpuFpReferenceConvolutionFp64, ConvolutionBwdDataBasic)
{
    ...
    CpuFpReferenceConvolutionImpl<double, double, double, double>::convBwdData(
        inputTensor, weightTensor, outputTensor, strides, dilations, padding);
}
...
TEST(TestCpuFpReferenceConvolutionFp16, ConvolutionWrwBasic)
{
    ...
    CpuFpReferenceConvolutionImpl<half, half, float, half>::convBwdWeight(
        inputTensor, gradWeightTensor, gradOutputTensor, strides, dilations, padding);
...
TEST(TestCpuFpReferenceConvolutionBfp16, ConvolutionWrwBasic)
{
    ...
    CpuFpReferenceConvolutionImpl<hip_bfloat16, hip_bfloat16, float, hip_bfloat16>::convBwdWeight(
        inputTensor, gradWeightTensor, gradOutputTensor, strides, dilations, padding);
...
TEST(TestCpuFpReferenceConvolutionFp64, ConvolutionWrwBasic)
{
    ...
    CpuFpReferenceConvolutionImpl<double, double, double, double>::convBwdWeight(
        inputTensor, gradWeightTensor, gradOutputTensor, strides, dilations, padding);
...
TEST(TestCpuFpReferenceConvolutionFp32, ConvBwdWeightAsymmetricPadding)
{
    ...
    CpuFpReferenceConvolutionImpl<float, float, float, float>::convBwdWeight(inputTensor,
                                                                             gradWeightTensor,
                                                                             gradOutputTensor,
                                                                             strides,
                                                                             dilations,
