...
{
    ConvolutionFwdSignatureKey key1{DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    ConvolutionFwdSignatureKey key2{DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    EXPECT_TRUE(key1 == key2);

    ConvolutionFwdSignatureKey key3{DataType::HALF, DataType::FLOAT, DataType::HALF};
    ConvolutionFwdSignatureKey key4{DataType::HALF, DataType::FLOAT, DataType::HALF};
    EXPECT_TRUE(key3 == key4);

    ConvolutionFwdSignatureKey key5{DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    ConvolutionFwdSignatureKey key6{DataType::HALF, DataType::FLOAT, DataType::HALF};
    EXPECT_FALSE(key5 == key6);

    ConvolutionFwdSignatureKey key7{DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    ConvolutionFwdSignatureKey key8{DataType::FLOAT, DataType::HALF, DataType::FLOAT};
...
TEST(TestConvolutionFwdSignatureKey, HashFunction)
{
    ...
    ConvolutionFwdSignatureKey key3{DataType::HALF, DataType::FLOAT, DataType::HALF};
    ConvolutionFwdSignatureKey key4{DataType::FLOAT, DataType::HALF, DataType::FLOAT};
    ConvolutionFwdSignatureKey key5{DataType::FLOAT, DataType::FLOAT, DataType::HALF};
...
{
    ConvolutionFwdSignatureKey original{DataType::FLOAT, DataType::HALF, DataType::FLOAT};
...
{
    ConvolutionFwdSignatureKey expectedKey{DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
