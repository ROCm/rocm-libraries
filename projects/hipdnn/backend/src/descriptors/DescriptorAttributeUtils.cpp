...
void setOptionalBool(flatbuffers::Optional<bool>& target,
                     ...
                     const char* context)
{
    checkSetArgs(HIPDNN_TYPE_BOOLEAN, attributeType, arrayOfElements, context);
    THROW_IF_FALSE(elementCount == 1,
                   HIPDNN_STATUS_BAD_PARAM,
                   std::string(context) + ": expected elementCount=1, got "
                       + std::to_string(elementCount));
    bool value = false;
    std::memcpy(&value, arrayOfElements, sizeof(bool));
    target = value;
}
...
void getOptionalBool(const flatbuffers::Optional<bool>& source,
                     ...
                     const char* context)
{
    checkGetArgs(HIPDNN_TYPE_BOOLEAN, attributeType, context);
    ...
    auto value = source.value();
    std::memcpy(arrayOfElements, &value, sizeof(bool));
}
...
void setOptionalInt32(flatbuffers::Optional<int32_t>& target,
                      ...
                      const char* context)
{
    checkSetArgs(HIPDNN_TYPE_INT32, attributeType, arrayOfElements, context);
    THROW_IF_FALSE(elementCount == 1,
                   HIPDNN_STATUS_BAD_PARAM,
                   std::string(context) + ": expected elementCount=1, got "
                       + std::to_string(elementCount));
    int32_t value = 0;
    std::memcpy(&value, arrayOfElements, sizeof(int32_t));
    target = value;
}
...
void getOptionalInt32(const flatbuffers::Optional<int32_t>& source,
                      ...
                      const char* context)
{
    checkGetArgs(HIPDNN_TYPE_INT32, attributeType, context);
    ...
    auto value = source.value();
    std::memcpy(arrayOfElements, &value, sizeof(int32_t));
}
