    ...
    const void* arrayOfElements)
{
    THROW_IF_NULL(arrayOfElements,
                  ...
                  "BatchnormInferenceOperationDescriptor::setAttribute(): arrayOfElements is null");
    THROW_IF_FALSE(attributeType == HIPDNN_TYPE_BACKEND_DESCRIPTOR,
                   HIPDNN_STATUS_BAD_PARAM,
                   "BatchnormInferenceOperationDescriptor::setAttribute(): attributeType is not "
                   "BACKEND_DESCRIPTOR");
    ...
    void* arrayOfElements) const
{
    THROW_IF_NULL(arrayOfElements,
                  HIPDNN_STATUS_BAD_PARAM_NULL_POINTER,
                  "BatchnormInferenceOperationDescriptor::getAttribute(): arrayOfElements is null");
    THROW_IF_FALSE(attributeType == HIPDNN_TYPE_BACKEND_DESCRIPTOR,
                   HIPDNN_STATUS_BAD_PARAM,
                   "BatchnormInferenceOperationDescriptor::getAttribute(): attributeType is not "
                   "BACKEND_DESCRIPTOR");
    THROW_IF_FALSE(
    ...
    BatchnormInferenceOperationDescriptor::getTensorDescriptors() const
{
    std::vector<std::shared_ptr<TensorDescriptor>> result
        = {_xDesc, _meanDesc, _invVarianceDesc, _scaleDesc, _biasDesc, _yDesc};
    return result;
}
