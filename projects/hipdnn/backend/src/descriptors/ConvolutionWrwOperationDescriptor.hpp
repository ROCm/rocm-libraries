...
class ConvolutionWrwOperationDescriptor
    : public HipdnnBackendDescriptorImpl<ConvolutionWrwOperationDescriptor>,
...
public:
    ...
    std::shared_ptr<TensorDescriptor> getDwDesc() const
    {
        return _dwDesc;
    }
