                                                      ...
                                                      const void* arrayOfElements)
{
    THROW_IF_NULL(arrayOfElements,
                  ...
                  "ConvolutionWrwOperationDescriptor::setAttribute(): arrayOfElements is null");
    THROW_IF_FALSE(attributeType == HIPDNN_TYPE_BACKEND_DESCRIPTOR,
                   HIPDNN_STATUS_BAD_PARAM,
                   "ConvolutionWrwOperationDescriptor::setAttribute(): attributeType is not "
                   "BACKEND_DESCRIPTOR");
                                                    ...
                                                    const void* arrayOfElements)
{
    ...
    THROW_IF_FALSE(attributeType == HIPDNN_TYPE_INT64,
                   HIPDNN_STATUS_BAD_PARAM,
                   "ConvolutionWrwOperationDescriptor::setAttribute(): attributeType mismatch");
    THROW_IF_FALSE(elementCount == 1,
                   HIPDNN_STATUS_BAD_PARAM,
                   "ConvolutionWrwOperationDescriptor::setAttribute(): elementCount is not 1");
                                                      ...
                                                      void* arrayOfElements) const
{
    THROW_IF_NULL(arrayOfElements,
                  HIPDNN_STATUS_BAD_PARAM_NULL_POINTER,
                  "ConvolutionWrwOperationDescriptor::getAttribute(): arrayOfElements is null");
    THROW_IF_FALSE(attributeType == HIPDNN_TYPE_BACKEND_DESCRIPTOR,
                   HIPDNN_STATUS_BAD_PARAM,
                   "ConvolutionWrwOperationDescriptor::getAttribute(): attributeType is not "
                   "BACKEND_DESCRIPTOR");
                                                    ...
                                                    void* arrayOfElements) const
{
    ...
    THROW_IF_FALSE(attributeType == HIPDNN_TYPE_INT64,
                   HIPDNN_STATUS_BAD_PARAM,
                   "ConvolutionWrwOperationDescriptor::getAttribute(): attributeType mismatch");
    THROW_IF_FALSE(requestedElementCount >= 1,
                   HIPDNN_STATUS_BAD_PARAM,
                   "ConvolutionWrwOperationDescriptor::getAttribute(): requestedElementCount < 1");
...
{
    std::vector<std::shared_ptr<TensorDescriptor>> result = {_xDesc, _dyDesc, _dwDesc};
    return result;
}
