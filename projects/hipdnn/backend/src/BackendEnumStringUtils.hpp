...
inline const char* hipdnnGetAttributeNameString(hipdnnBackendAttributeName_t attr)
{
    ...
    case HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DY:
        return "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DY";
    case HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_X:
        return "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_X";
    case HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_SCALE:
        return "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_SCALE";
    case HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DX:
        return "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DX";
    case HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DSCALE:
        return "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DSCALE";
    case HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DBIAS:
        return "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DBIAS";
    case HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_MEAN:
        return "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_MEAN";
    case HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_INV_VARIANCE:
        return "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_INV_VARIANCE";
    case HIPDNN_ATTR_BATCHNORM_BWD_EXT_COMP_TYPE:
        return "HIPDNN_ATTR_BATCHNORM_BWD_EXT_COMP_TYPE";
    case HIPDNN_ATTR_OPERATION_BATCHNORM_BWD_EXT_PEER_STATS:
        return "HIPDNN_ATTR_OPERATION_BATCHNORM_BWD_EXT_PEER_STATS";
