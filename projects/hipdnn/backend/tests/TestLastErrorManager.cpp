...
TEST(TestLastErrorManager, StaticSetLastError)
{
    ...
    std::string const errorMessage = "An error occurred";
...
{
    std::string const mainError = "Main thread error";
    std::string const workerError = "Worker thread error";
...
{
    // Set an error
    std::string const errorMessage = "Test error";
