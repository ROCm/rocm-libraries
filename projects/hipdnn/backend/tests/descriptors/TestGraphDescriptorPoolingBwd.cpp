                          ...
                          hipdnnDataType_t computeType = HIPDNN_DATA_FLOAT)
{
    ...
    desc->setAttribute(
        HIPDNN_ATTR_OPERATION_POOLING_BACKWARD_DY, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, &dyDesc);
    desc->setAttribute(
        HIPDNN_ATTR_OPERATION_POOLING_BACKWARD_DX, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, &dxDesc);
...
TEST_F(TestGraphDescriptorPoolingBwd, PoolingBwdAttributesPreserved)
{
    ...
    opDesc->setAttribute(
        HIPDNN_ATTR_OPERATION_POOLING_BACKWARD_DY, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, &dyPtr);
    HipdnnBackendDescriptor* dxPtr = dxDesc.get();
    opDesc->setAttribute(
        HIPDNN_ATTR_OPERATION_POOLING_BACKWARD_DX, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, &dxPtr);
