...
TEST_F(TestBatchnormInferenceOperationDescriptor, GetAttributeTensorMeanQueryReturnsOne)
{
    ...
    int64_t elementCount = 0;
    ASSERT_NO_THROW(desc->getAttribute(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_MEAN,
                                       HIPDNN_TYPE_BACKEND_DESCRIPTOR,
                                       0,
                                       &elementCount,
                                       nullptr));
...
TEST_F(TestBatchnormInferenceOperationDescriptor, GetAttributeTensorInvVarianceQueryReturnsOne)
{
    ...
    int64_t elementCount = 0;
    ASSERT_NO_THROW(desc->getAttribute(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_INV_VARIANCE,
                                       HIPDNN_TYPE_BACKEND_DESCRIPTOR,
                                       0,
                                       &elementCount,
                                       nullptr));
...
TEST_F(TestBatchnormInferenceOperationDescriptor, GetAttributeTensorScaleQueryReturnsOne)
{
    ...
    int64_t elementCount = 0;
    ASSERT_NO_THROW(desc->getAttribute(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_SCALE,
                                       HIPDNN_TYPE_BACKEND_DESCRIPTOR,
                                       0,
                                       &elementCount,
                                       nullptr));
...
TEST_F(TestBatchnormInferenceOperationDescriptor, GetAttributeTensorBiasQueryReturnsOne)
{
    ...
    int64_t elementCount = 0;
    ASSERT_NO_THROW(desc->getAttribute(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_BIAS,
                                       HIPDNN_TYPE_BACKEND_DESCRIPTOR,
                                       0,
                                       &elementCount,
                                       nullptr));
...
TEST_F(TestBatchnormInferenceOperationDescriptor, GetAttributeTensorYQueryReturnsOne)
{
    ...
    int64_t elementCount = 0;
    ASSERT_NO_THROW(desc->getAttribute(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_Y,
                                       HIPDNN_TYPE_BACKEND_DESCRIPTOR,
                                       0,
                                       &elementCount,
                                       nullptr));
...
TEST_F(TestBatchnormInferenceOperationDescriptor, GetAttributeComputeTypeQueryReturnsOne)
{
    ...
    int64_t elementCount = 0;
    ASSERT_NO_THROW(desc->getAttribute(
        HIPDNN_ATTR_BATCHNORM_INF_COMP_TYPE, HIPDNN_TYPE_DATA_TYPE, 0, &elementCount, nullptr));
    ASSERT_EQ(elementCount, 1);
}
