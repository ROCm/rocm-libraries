...
{
    auto desc = getDescriptor();
    desc->setAttribute(HIPDNN_ATTR_OPERATION_MATMUL_B, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, &_bDesc);
    desc->setAttribute(HIPDNN_ATTR_OPERATION_MATMUL_C, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, &_cDesc);
    auto computeType = HIPDNN_DATA_FLOAT;
...
{
    auto desc = getDescriptor();
    desc->setAttribute(HIPDNN_ATTR_OPERATION_MATMUL_A, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, &_aDesc);
    desc->setAttribute(HIPDNN_ATTR_OPERATION_MATMUL_C, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, &_cDesc);
    auto computeType = HIPDNN_DATA_FLOAT;
    desc->setAttribute(HIPDNN_ATTR_MATMUL_COMP_TYPE, HIPDNN_TYPE_DATA_TYPE, 1, &computeType);
...
TEST_F(TestMatmulOperationDescriptor, SetTensorFailsNotFinalized)
{
    ...
    ASSERT_THROW_HIPDNN_STATUS(
        desc->setAttribute(
            HIPDNN_ATTR_OPERATION_MATMUL_A, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, &_unfinalizedTensor),
...
TEST_F(TestMatmulOperationDescriptor, SetTensorFailsWrongType)
{
    auto desc = getDescriptor();
    ASSERT_THROW_HIPDNN_STATUS(
        desc->setAttribute(HIPDNN_ATTR_OPERATION_MATMUL_A, HIPDNN_TYPE_INT64, 1, &_aDesc),
...
TEST_F(TestMatmulOperationDescriptor, SetTensorFailsWrongElementCount)
{
    ...
    ASSERT_THROW_HIPDNN_STATUS(
        desc->setAttribute(
            HIPDNN_ATTR_OPERATION_MATMUL_A, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 2, &_aDesc),
        HIPDNN_STATUS_BAD_PARAM);
}
...
TEST_F(TestMatmulOperationDescriptor, SetTensorFailsNullPointer)
{
    ...
    ASSERT_THROW_HIPDNN_STATUS(
        desc->setAttribute(
            HIPDNN_ATTR_OPERATION_MATMUL_A, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, nullptr),
...
TEST_F(TestMatmulOperationDescriptor, GetAttributeTensorDescriptor)
{
    ...
    ASSERT_NO_THROW(desc->getAttribute(HIPDNN_ATTR_OPERATION_MATMUL_A,
...
TEST_F(TestMatmulOperationDescriptor, GetAttributeFailsBeforeFinalize)
{
    ...
    ASSERT_THROW_HIPDNN_STATUS(
        desc->getAttribute(
            HIPDNN_ATTR_OPERATION_MATMUL_A, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, nullptr, &dummy),
        HIPDNN_STATUS_NOT_INITIALIZED);
}
...
TEST_F(TestMatmulOperationDescriptor, GetAttributeFailsNullPointer)
{
    ...
    ASSERT_THROW_HIPDNN_STATUS(
        desc->getAttribute(
            HIPDNN_ATTR_OPERATION_MATMUL_A, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, nullptr, nullptr),
        HIPDNN_STATUS_BAD_PARAM_NULL_POINTER);
}
...
TEST_F(TestMatmulOperationDescriptor, GetAttributeTensorAQueryReturnsOne)
{
    ...
    int64_t elementCount = 0;
    ASSERT_NO_THROW(desc->getAttribute(
        HIPDNN_ATTR_OPERATION_MATMUL_A, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 0, &elementCount, nullptr));
    ASSERT_EQ(elementCount, 1);
}
...
TEST_F(TestMatmulOperationDescriptor, GetAttributeTensorBQueryReturnsOne)
{
    ...
    int64_t elementCount = 0;
    ASSERT_NO_THROW(desc->getAttribute(
        HIPDNN_ATTR_OPERATION_MATMUL_B, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 0, &elementCount, nullptr));
    ASSERT_EQ(elementCount, 1);
}
...
TEST_F(TestMatmulOperationDescriptor, GetAttributeTensorCQueryReturnsOne)
{
    ...
    int64_t elementCount = 0;
    ASSERT_NO_THROW(desc->getAttribute(
        HIPDNN_ATTR_OPERATION_MATMUL_C, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 0, &elementCount, nullptr));
    ASSERT_EQ(elementCount, 1);
}
...
TEST_F(TestMatmulOperationDescriptor, GetAttributeTensorQueryFailsNullElementCount)
{
    ...
    ASSERT_THROW_HIPDNN_STATUS(
        desc->getAttribute(
            HIPDNN_ATTR_OPERATION_MATMUL_A, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 0, nullptr, nullptr),
        HIPDNN_STATUS_BAD_PARAM_NULL_POINTER);
}
