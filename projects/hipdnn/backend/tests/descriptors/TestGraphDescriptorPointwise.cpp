                               ...
                               hipdnnDataType_t computeType = HIPDNN_DATA_FLOAT)
{
    ...
    desc->setAttribute(
        HIPDNN_ATTR_OPERATION_POINTWISE_IN_0_EXT, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, static_cast<const void*>(&in0Desc));
    desc->setAttribute(
        HIPDNN_ATTR_OPERATION_POINTWISE_OUT_0_EXT, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, static_cast<const void*>(&out0Desc));
    desc->setAttribute(
        HIPDNN_ATTR_OPERATION_POINTWISE_IN_1_EXT, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, static_cast<const void*>(&in1Desc));
    desc->setAttribute(
        HIPDNN_ATTR_OPERATION_POINTWISE_IN_2_EXT, HIPDNN_TYPE_BACKEND_DESCRIPTOR, 1, static_cast<const void*>(&in2Desc));
