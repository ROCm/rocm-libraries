...
TEST(TestBackendEnumStringUtils, GetBackendDescriptorTypeName)
{
    ...
    EXPECT_STREQ(
        hipdnnGetBackendDescriptorTypeName(HIPDNN_BACKEND_OPERATION_SDPA_FPROP_DESCRIPTOR_EXT),
    ...
    EXPECT_STREQ(hipdnnGetBackendDescriptorTypeName(
                 ...
                 "HIPDNN_BACKEND_OPERATION_BLOCK_SCALE_DEQUANTIZE_DESCRIPTOR_EXT");
    EXPECT_STREQ(
        hipdnnGetBackendDescriptorTypeName(HIPDNN_BACKEND_OPERATION_SDPA_BPROP_DESCRIPTOR_EXT),
        "HIPDNN_BACKEND_OPERATION_SDPA_BPROP_DESCRIPTOR_EXT");
...
TEST(TestBackendEnumStringUtils, GetBackendAttributeName)
{
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_CHOICE_KNOB_TYPE_EXT),
                 "HIPDNN_ATTR_KNOB_CHOICE_KNOB_TYPE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_CHOICE_KNOB_VALUE_EXT),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_TYPE_EXT),
                 "HIPDNN_ATTR_KNOB_INFO_TYPE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_MAXIMUM_VALUE_EXT),
                 "HIPDNN_ATTR_KNOB_INFO_MAXIMUM_VALUE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_MINIMUM_VALUE_EXT),
                 "HIPDNN_ATTR_KNOB_INFO_MINIMUM_VALUE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_STRIDE_EXT),
                 "HIPDNN_ATTR_KNOB_INFO_STRIDE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_DESCRIPTION_EXT),
                 "HIPDNN_ATTR_KNOB_INFO_DESCRIPTION_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_DEFAULT_VALUE_EXT),
                 "HIPDNN_ATTR_KNOB_INFO_DEFAULT_VALUE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_DEPRECATED_EXT),
                 "HIPDNN_ATTR_KNOB_INFO_DEPRECATED_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_VALID_VALUES_INT_EXT),
                 "HIPDNN_ATTR_KNOB_INFO_VALID_VALUES_INT_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_VALID_VALUES_STRING_EXT),
                 "HIPDNN_ATTR_KNOB_INFO_VALID_VALUES_STRING_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_STRING_MAX_LENGTH_EXT),
                 "HIPDNN_ATTR_KNOB_INFO_STRING_MAX_LENGTH_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_KNOB_INFO_DEFAULT_VALUE_TYPE_EXT),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_CONVOLUTION_BACKWARD_FILTER_X),
                 "HIPDNN_ATTR_OPERATION_CONVOLUTION_BACKWARD_FILTER_X");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_CONVOLUTION_BACKWARD_FILTER_DY),
                 "HIPDNN_ATTR_OPERATION_CONVOLUTION_BACKWARD_FILTER_DY");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_CONVOLUTION_BACKWARD_FILTER_DW),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_CONVOLUTION_BACKWARD_DX),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_Q_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_Q_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_K_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_K_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_V_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_V_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_O_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_O_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_ATTN_MASK_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_ATTN_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_SCALE_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_SCALE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_SEQ_LEN_Q_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_SEQ_LEN_Q_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_SEQ_LEN_KV_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_SEQ_LEN_KV_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_SEED_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_SEED_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_OFFSET_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_OFFSET_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_DROPOUT_MASK_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_DROPOUT_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_DROPOUT_SCALE_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_DROPOUT_SCALE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_PAGE_TABLE_K_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_PAGE_TABLE_K_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_PAGE_TABLE_V_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_PAGE_TABLE_V_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_BLOCK_MASK_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_BLOCK_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_SINK_TOKEN_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_SINK_TOKEN_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_DESCALE_Q_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_DESCALE_Q_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_DESCALE_K_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_DESCALE_K_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_DESCALE_V_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_DESCALE_V_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_DESCALE_S_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_DESCALE_S_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_SCALE_S_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_SCALE_S_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_SCALE_O_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_SCALE_O_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_STATS_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_STATS_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_MAX_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_MAX_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_SUM_EXP_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_SUM_EXP_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_RNG_DUMP_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_RNG_DUMP_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_AMAX_S_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_AMAX_S_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_FPROP_AMAX_O_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_FPROP_AMAX_O_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_GENERATE_STATS_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_GENERATE_STATS_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_ALIBI_MASK_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_ALIBI_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_PADDING_MASK_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_PADDING_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_CAUSAL_MASK_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_CAUSAL_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_CAUSAL_MASK_BOTTOM_RIGHT_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_CAUSAL_MASK_BOTTOM_RIGHT_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_DROPOUT_PROBABILITY_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_DROPOUT_PROBABILITY_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_ATTN_SCALE_VALUE_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_ATTN_SCALE_VALUE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_LEFT_BOUND_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_LEFT_BOUND_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_RIGHT_BOUND_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_RIGHT_BOUND_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_MAX_SEQ_LEN_KV_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_MAX_SEQ_LEN_KV_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_DIAGONAL_ALIGNMENT_EXT),
                 "HIPDNN_ATTR_SDPA_FPROP_DIAGONAL_ALIGNMENT_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_FPROP_MMA_CORE_MODE_EXT),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_Q_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_Q_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_K_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_K_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_V_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_V_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_O_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_O_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_DO_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_DO_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_STATS_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_STATS_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_DQ_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_DQ_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_DK_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_DK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_DV_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_DV_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_SCALE_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_SCALE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_ATTN_MASK_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_ATTN_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_SEQ_LEN_Q_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_SEQ_LEN_Q_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_SEQ_LEN_KV_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_SEQ_LEN_KV_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_SEED_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_SEED_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_OFFSET_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_OFFSET_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_DROPOUT_MASK_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_DROPOUT_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_DROPOUT_SCALE_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_DROPOUT_SCALE_EXT");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_DROPOUT_SCALE_INV_EXT),
        "HIPDNN_ATTR_OPERATION_SDPA_BPROP_DROPOUT_SCALE_INV_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_SDPA_BPROP_DBIAS_EXT),
                 "HIPDNN_ATTR_OPERATION_SDPA_BPROP_DBIAS_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_BPROP_ALIBI_MASK_EXT),
                 "HIPDNN_ATTR_SDPA_BPROP_ALIBI_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_BPROP_PADDING_MASK_EXT),
                 "HIPDNN_ATTR_SDPA_BPROP_PADDING_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_BPROP_CAUSAL_MASK_EXT),
                 "HIPDNN_ATTR_SDPA_BPROP_CAUSAL_MASK_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_BPROP_CAUSAL_MASK_BOTTOM_RIGHT_EXT),
                 "HIPDNN_ATTR_SDPA_BPROP_CAUSAL_MASK_BOTTOM_RIGHT_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_BPROP_DROPOUT_PROBABILITY_EXT),
                 "HIPDNN_ATTR_SDPA_BPROP_DROPOUT_PROBABILITY_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_BPROP_ATTN_SCALE_VALUE_EXT),
                 "HIPDNN_ATTR_SDPA_BPROP_ATTN_SCALE_VALUE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_BPROP_LEFT_BOUND_EXT),
                 "HIPDNN_ATTR_SDPA_BPROP_LEFT_BOUND_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_BPROP_RIGHT_BOUND_EXT),
                 "HIPDNN_ATTR_SDPA_BPROP_RIGHT_BOUND_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_BPROP_DIAGONAL_ALIGNMENT_EXT),
                 "HIPDNN_ATTR_SDPA_BPROP_DIAGONAL_ALIGNMENT_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_SDPA_BPROP_MATH_PREC_EXT),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_Y_EXT),
                 "HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_Y_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_SCALE_EXT),
                 "HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_SCALE_EXT");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_BLOCK_SIZE_EXT),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_BLOCK_SCALE_QUANTIZE_MATH_PREC_EXT),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_BATCHNORM_MATH_PREC_EXT),
    ...
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BLOCK_SCALE_DEQUANTIZE_SCALE_EXT),
        "HIPDNN_ATTR_OPERATION_BLOCK_SCALE_DEQUANTIZE_SCALE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BLOCK_SCALE_DEQUANTIZE_Y_EXT),
                 "HIPDNN_ATTR_OPERATION_BLOCK_SCALE_DEQUANTIZE_Y_EXT");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BLOCK_SCALE_DEQUANTIZE_BLOCK_SIZE_EXT),
