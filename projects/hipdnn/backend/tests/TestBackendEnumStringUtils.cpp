...
TEST(TestBackendEnumStringUtils, GetBackendAttributeName)
{
    ...
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_X),
        "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_X");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_MEAN),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(
                 ...
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_VARIANCE");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_SCALE),
        "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_SCALE");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_BIAS),
        "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_BIAS");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_Y),
        "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_Y");
    EXPECT_STREQ(hipdnnGetAttributeNameString(
                     HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_EPSILON),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_VARIANCE_EXT_EPSILON");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_BATCHNORM_INF_VAR_EXT_COMP_TYPE),
