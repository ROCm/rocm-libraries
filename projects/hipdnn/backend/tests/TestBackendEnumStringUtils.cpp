...
TEST(TestBackendEnumStringUtils, GetBackendDescriptorTypeName)
{
    ...
    EXPECT_STREQ(
        hipdnnGetBackendDescriptorTypeName(HIPDNN_BACKEND_OPERATION_BATCHNORM_INFERENCE_DESCRIPTOR),
...
TEST(TestBackendEnumStringUtils, GetBackendAttributeName)
{
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_CONVOLUTION_FORWARD_ALPHA),
                 "HIPDNN_ATTR_OPERATION_CONVOLUTION_FORWARD_ALPHA");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_CONVOLUTION_FORWARD_BETA),
                 "HIPDNN_ATTR_OPERATION_CONVOLUTION_FORWARD_BETA");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_CONVOLUTION_FORWARD_CONV_DESC),
                 "HIPDNN_ATTR_OPERATION_CONVOLUTION_FORWARD_CONV_DESC");
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_CONVOLUTION_SPATIAL_DIMS),
                 "HIPDNN_ATTR_CONVOLUTION_SPATIAL_DIMS");

    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_X),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_X");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_MEAN),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_MEAN");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_INV_VARIANCE),
        "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_INV_VARIANCE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_SCALE),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_SCALE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_BIAS),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_BIAS");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_Y),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_Y");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_BATCHNORM_INF_COMP_TYPE),
