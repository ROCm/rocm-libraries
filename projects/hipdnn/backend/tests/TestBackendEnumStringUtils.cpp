...
TEST(TestBackendEnumStringUtils, GetBackendDescriptorTypeName)
{
    ...
    EXPECT_STREQ(
        hipdnnGetBackendDescriptorTypeName(HIPDNN_BACKEND_OPERATION_MOE_GROUPED_MATMUL_DESCRIPTOR),
        "HIPDNN_BACKEND_OPERATION_MOE_GROUPED_MATMUL_DESCRIPTOR");
    EXPECT_STREQ(hipdnnGetBackendDescriptorTypeName(
...
TEST(TestBackendEnumStringUtils, GetBackendAttributeName)
{
    ...
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATIONGRAPH_IS_OVERRIDE_SHAPE_ENABLED_EXT),
        "HIPDNN_ATTR_OPERATIONGRAPH_IS_OVERRIDE_SHAPE_ENABLED_EXT");
    EXPECT_NE(HIPDNN_ATTR_OPERATIONGRAPH_IS_DYNAMIC_SHAPE_ENABLED,
              HIPDNN_ATTR_OPERATIONGRAPH_IS_OVERRIDE_SHAPE_ENABLED_EXT);
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_VARIANT_PACK_OVERRIDE_UNIQUE_IDS_EXT),
                 "HIPDNN_ATTR_VARIANT_PACK_OVERRIDE_UNIQUE_IDS_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_VARIANT_PACK_OVERRIDE_SHAPES_EXT),
                 "HIPDNN_ATTR_VARIANT_PACK_OVERRIDE_SHAPES_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_VARIANT_PACK_OVERRIDE_STRIDES_EXT),
                 "HIPDNN_ATTR_VARIANT_PACK_OVERRIDE_STRIDES_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_VARIANT_PACK_OVERRIDE_LENGTHS_EXT),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_X_EXT),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_X_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_SCALE_EXT),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_SCALE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_MEAN_EXT),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DX_EXT),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DX_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DSCALE_EXT),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DSCALE_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DBIAS_EXT),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DBIAS_EXT");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_LAYERNORM_BACKWARD_NORMALIZED_DIM_COUNT_EXT),
        "HIPDNN_ATTR_LAYERNORM_BACKWARD_NORMALIZED_DIM_COUNT_EXT");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_LAYERNORM_BACKWARD_COMP_TYPE_EXT),
                 "HIPDNN_ATTR_LAYERNORM_BACKWARD_COMP_TYPE_EXT");

    // MoE grouped matmul operation attributes
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOKEN_DESC),
                 "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOKEN_DESC");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_WEIGHT_DESC),
                 "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_WEIGHT_DESC");
    EXPECT_STREQ(hipdnnGetAttributeNameString(
                     HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_FIRST_TOKEN_OFFSET_DESC),
                 "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_FIRST_TOKEN_OFFSET_DESC");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOKEN_INDEX_DESC),
        "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOKEN_INDEX_DESC");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOKEN_KS_DESC),
        "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOKEN_KS_DESC");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_OUTPUT_DESC),
                 "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_OUTPUT_DESC");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_MODE),
                 "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_MODE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOP_K),
                 "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOP_K");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_MATH_PREC),
                 "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_MATH_PREC");

    // MoE grouped matmul backward operation attributes
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_BWD_DOUTPUT_DESC),
        "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_BWD_DOUTPUT_DESC");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_BWD_TOKEN_DESC),
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(
                 ...
                 "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_BWD_FIRST_TOKEN_OFFSET_DESC");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_BWD_DWEIGHT_DESC),
        "HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_BWD_DWEIGHT_DESC");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_BWD_MATH_PREC),
...
TEST(TestBackendEnumStringUtils, GetOperationTypeString)
{
    ...
    EXPECT_STREQ(hipdnnGetOperationTypeString(HIPDNN_OPERATION_TYPE_MOE_GROUPED_MATMUL_EXT),
                 "HIPDNN_OPERATION_TYPE_MOE_GROUPED_MATMUL_EXT");
    EXPECT_STREQ(hipdnnGetOperationTypeString(HIPDNN_OPERATION_TYPE_MOE_GROUPED_MATMUL_BWD_EXT),
                 "HIPDNN_OPERATION_TYPE_MOE_GROUPED_MATMUL_BWD_EXT");
...
TEST(TestBackendEnumStringUtils, GetAttributeTypeString)
{
    ...
    EXPECT_STREQ(hipdnnGetAttributeTypeString(HIPDNN_TYPE_MOE_GROUPED_MATMUL_MODE),
