...
TEST(TestBackendEnumStringUtils, GetBackendDescriptorTypeName)
{
    ...
    EXPECT_STREQ(
        hipdnnGetBackendDescriptorTypeName(HIPDNN_BACKEND_OPERATION_LAYERNORM_BACKWARD_DESCRIPTOR),
...
TEST(TestBackendEnumStringUtils, GetBackendAttributeName)
{
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DY),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DY");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_X),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_X");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_SCALE),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_SCALE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_MEAN),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_MEAN");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_INV_VARIANCE),
        "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_INV_VARIANCE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_EPSILON),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_EPSILON");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DX),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DX");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DSCALE),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DSCALE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DBIAS),
                 "HIPDNN_ATTR_OPERATION_LAYERNORM_BACKWARD_DBIAS");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_LAYERNORM_BACKWARD_NORMALIZED_DIM_COUNT),
