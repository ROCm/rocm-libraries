...
TEST(TestBackendEnumStringUtils, GetBackendAttributeName)
{
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DY),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DY");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_X),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_X");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_SCALE),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_SCALE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DX),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DX");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DSCALE),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DSCALE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DBIAS),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_DBIAS");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_MEAN),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_MEAN");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_INV_VARIANCE),
        "HIPDNN_ATTR_OPERATION_BATCHNORM_BACKWARD_EXT_INV_VARIANCE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_BATCHNORM_BWD_EXT_COMP_TYPE),
                 "HIPDNN_ATTR_BATCHNORM_BWD_EXT_COMP_TYPE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_BWD_EXT_PEER_STATS),
