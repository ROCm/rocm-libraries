...
TEST(TestBackendEnumStringUtils, GetBackendAttributeName)
{
    ...
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_X),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_X");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_MEAN),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_MEAN");
    EXPECT_STREQ(
        hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_INV_VARIANCE),
        "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_INV_VARIANCE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_SCALE),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_SCALE");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_BIAS),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_BIAS");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_Y),
                 "HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_EXT_Y");
    EXPECT_STREQ(hipdnnGetAttributeNameString(HIPDNN_ATTR_BATCHNORM_INF_EXT_COMP_TYPE),
