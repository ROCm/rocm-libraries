 ...
 *
 * After retrieving the error message, this function clears the internal error state to match
 * cudnn behavior. Use hipdnnPeekLastErrorString_ext() if you need to retrieve the error without
 * clearing it.
 *
