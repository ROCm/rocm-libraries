...
typedef enum
{
    ...
    HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_X = 1700,
    HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_MEAN = 1701,
    HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_INV_VARIANCE = 1702,
    HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_SCALE = 1703,
    HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_BIAS = 1704,
    HIPDNN_ATTR_OPERATION_BATCHNORM_INFERENCE_Y = 1705,

    // Batchnorm inference compute data type
    HIPDNN_ATTR_BATCHNORM_INF_COMP_TYPE = 1800,
