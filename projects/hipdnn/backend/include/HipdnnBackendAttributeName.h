 ...
 * - 2800-2899: Block scale dequantize operation attributes
...
typedef enum
{
    ...
    /**
     * @name BlockScaleDequantize Operation Attributes (2800-2899)
    ...
    HIPDNN_ATTR_OPERATION_BLOCK_SCALE_DEQUANTIZE_X_EXT = 2800,

    /** @brief Scale tensor for block scale dequantize */
    HIPDNN_ATTR_OPERATION_BLOCK_SCALE_DEQUANTIZE_SCALE_EXT = 2801,

    /** @brief Output tensor for block scale dequantize */
    HIPDNN_ATTR_OPERATION_BLOCK_SCALE_DEQUANTIZE_Y_EXT = 2802,

    /** @brief Block sizes for each dimension */
    HIPDNN_ATTR_OPERATION_BLOCK_SCALE_DEQUANTIZE_BLOCK_SIZE_EXT = 2803,
