 ...
 * - 2600-2699: Block scale quantize operation attributes
...
typedef enum
{
    ...
    /**
     * @name Block Scale Quantize Operation Attributes (2600-2699)
     * Attributes for HIPDNN_BACKEND_OPERATION_BLOCK_SCALE_QUANTIZE_DESCRIPTOR_EXT
     * @{
     */

    /** @brief Input tensor (X) for block scale quantize */
    HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_X_EXT = 2600,

    /** @brief Output tensor (Y) for block scale quantize */
    HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_Y_EXT = 2601,

    /** @brief Scale tensor for block scale quantize */
    HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_SCALE_EXT = 2602,

    /** @brief Block size parameter for block scale quantize */
    HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_BLOCK_SIZE_EXT = 2603,

    /** @brief Axis parameter for block scale quantize (optional) */
    HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_AXIS_EXT = 2604,

    /** @brief Transpose parameter for block scale quantize */
    HIPDNN_ATTR_OPERATION_BLOCK_SCALE_QUANTIZE_TRANSPOSE_EXT = 2605,

    /** @brief Compute data type for block scale quantize */
    HIPDNN_ATTR_BLOCK_SCALE_QUANTIZE_COMP_TYPE_EXT = 2606,
