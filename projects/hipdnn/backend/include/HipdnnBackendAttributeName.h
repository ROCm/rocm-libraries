 ...
 * - 2600-2699: Layernorm operation attributes
...
typedef enum
{
    ...
    /**
     * @name Layernorm Operation Attributes (2600-2699)
     * Attributes for HIPDNN_BACKEND_OPERATION_LAYERNORM_DESCRIPTOR_EXT
     * @{
     */

    /** @brief Input tensor for layernorm */
    HIPDNN_ATTR_OPERATION_LAYERNORM_X_EXT = 2600,

    /** @brief Scale tensor for layernorm */
    HIPDNN_ATTR_OPERATION_LAYERNORM_SCALE_EXT = 2601,

    /** @brief Bias tensor for layernorm */
    HIPDNN_ATTR_OPERATION_LAYERNORM_BIAS_EXT = 2602,

    /** @brief Epsilon tensor for layernorm */
    HIPDNN_ATTR_OPERATION_LAYERNORM_EPSILON_EXT = 2603,

    /** @brief Output tensor for layernorm */
    HIPDNN_ATTR_OPERATION_LAYERNORM_Y_EXT = 2604,

    /** @brief Mean output tensor for layernorm (optional) */
    HIPDNN_ATTR_OPERATION_LAYERNORM_MEAN_EXT = 2605,
