        ...
        if (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
            ...
            block(SCOPE_FOR VARIABLES PROPAGATE TEST_ENVIRONMENT_MODIFICATION)
                ...
                if(_rocm_root)
                    ...
                    # DLL-shadowing workaround (remove once ROCm fixes this generally on Windows):
                    # a stale ROCm amd_comgr.dll in C:/Windows/System32 shadows the TheRock one and
                    # breaks MIOpen's runtime kernel JIT. A PATH prepend can't fix it (System32 is
                    # searched before PATH), but the exe's own dir is searched first, so stage the
                    # correct copy next to the test exes. May grow as more shadowed DLLs surface.
                    # The GLOBAL-property guard defines the target once across the
                    # many include()s of this file into one build tree.
