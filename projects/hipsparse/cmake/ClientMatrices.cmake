...
if(HIPSPARSE_ENABLE_ASAN)
  execute_process(COMMAND "${CMAKE_CXX_COMPILER}" "${CONVERT_SOURCE}" -O3 -fsanitize=address -o "${PROJECT_BINARY_DIR}/clients/mtx2csr.exe"
...
foreach(i RANGE 0 ${len1})
  ...
  if(NOT EXISTS "${CMAKE_MATRICES_DIR}/${mat}.csr")
    ...
    execute_process(COMMAND "${PROJECT_BINARY_DIR}/clients/mtx2csr.exe" "${mat}.mtx" "${mat}.csr"
      RESULT_VARIABLE STATUS
      WORKING_DIRECTORY "${CMAKE_MATRICES_DIR}")
    if(STATUS AND NOT STATUS EQUAL 0)
