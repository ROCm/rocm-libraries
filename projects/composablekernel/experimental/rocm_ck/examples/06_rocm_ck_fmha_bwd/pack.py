...
VARIANTS = [
    ...
    {
        "name": "fmha_bwd_ograd_dot_o_bf16_d128_group",
        "family": "ograd_dot_o",
        "dtype": "bf16",
        "hdim_v": 128,
        "mode": "group",
    ...
    {
        "name": "fmha_bwd_dqdkdv_bf16_d128_group",
        "family": "dqdkdv",
        "dtype": "bf16",
        "hdim_q": 128,
        "hdim_v": 128,
    ...
    {
        "name": "fmha_bwd_dqdkdv_fp16_d128_group_cmask",
        "family": "dqdkdv",
        "dtype": "fp16",
        "hdim_q": 128,
        "hdim_v": 128,
    ...
    {
        "name": "fmha_bwd_dqdkdv_fp16_d128_group_det",
        "family": "dqdkdv",
        "dtype": "fp16",
        "hdim_q": 128,
        "hdim_v": 128,
    ...
    {
        "name": "fmha_bwd_dqdkdv_fp16_d128_group_dropout",
        "family": "dqdkdv",
        "dtype": "fp16",
        "hdim_q": 128,
        "hdim_v": 128,
    ...
    {
        "name": "fmha_bwd_dqdkdv_fp16_d128_group_ebias",
        "family": "dqdkdv",
        "dtype": "fp16",
        "hdim_q": 128,
        "hdim_v": 128,
    ...
    {
        "name": "fmha_bwd_dqdkdv_fp16_d128_group_alibi",
        "family": "dqdkdv",
        "dtype": "fp16",
        "hdim_q": 128,
        "hdim_v": 128,
    ...
    {
        "name": "fmha_bwd_dqdkdv_bf16_d128_batch_ebias",
        "family": "dqdkdv",
        "dtype": "bf16",
        "hdim_q": 128,
        "hdim_v": 128,
    ...
    {
        "name": "fmha_bwd_dqdkdv_bf16_d128_batch_alibi",
        "family": "dqdkdv",
        "dtype": "bf16",
        "hdim_q": 128,
        "hdim_v": 128,
    ...
    {
        "name": "fmha_bwd_dqdkdv_bf16_d128_batch_ebias_dbias",
        "family": "dqdkdv",
        "dtype": "bf16",
        "hdim_q": 128,
        "hdim_v": 128,
    ...
    {
        "name": "fmha_bwd_convert_dq_fp16_d64_batch_det",
        "family": "convert_dq",
        "dtype": "fp16",
        "hdim_q": 64,
        "mode": "batch",
    ...
    {
        "name": "fmha_bwd_convert_dq_fp16_d64_group_det",
        "family": "convert_dq",
        "dtype": "fp16",
        "hdim_q": 64,
        "mode": "group",
    ...
    {
        "name": "fmha_bwd_convert_dq_bf16_d64_batch_det",
        "family": "convert_dq",
        "dtype": "bf16",
        "hdim_q": 64,
        "mode": "batch",
    ...
    {
        "name": "fmha_bwd_convert_dq_bf16_d64_group_det",
        "family": "convert_dq",
        "dtype": "bf16",
        "hdim_q": 64,
        "mode": "group",
    ...
    {
        "name": "fmha_bwd_convert_dq_fp16_d256_batch_det",
        "family": "convert_dq",
        "dtype": "fp16",
        "hdim_q": 256,
        "mode": "batch",
    ...
    {
        "name": "fmha_bwd_convert_dq_fp16_d256_group_det",
        "family": "convert_dq",
        "dtype": "fp16",
        "hdim_q": 256,
        "mode": "group",
    ...
    {
        "name": "fmha_bwd_convert_dq_bf16_d256_batch_det",
        "family": "convert_dq",
        "dtype": "bf16",
        "hdim_q": 256,
        "mode": "batch",
    ...
    {
        "name": "fmha_bwd_convert_dq_bf16_d256_group_det",
        "family": "convert_dq",
        "dtype": "bf16",
        "hdim_q": 256,
        "mode": "group",
