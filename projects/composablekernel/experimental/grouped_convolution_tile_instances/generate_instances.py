...
def parse_fwd_instances(instances, problem_name, warp_size=32):
    convs = []
...
def parse_bwd_weight_instances(instances, problem_name, warp_size=32):
    convs = []
...
def parse_bwd_data_instances(instances, problem_name, warp_size=32):
    convs = []
