                         ...
                         is_same_v<OutLayout, NHWGK>)
            {
                             ...
                             is_same_v<OutDataType, float>)
                {
                    ...
                    if constexpr(is_same_v<ComputeTypeA, float>)
                    {
                        ...
                        add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_f32_default_pipev2_large_tensors_instances(
                            op_ptrs);
                    }
#endif
                             ...
                             is_same_v<ComputeTypeB, half_t>)
                {
                    ...
                    add_device_grouped_conv2d_bwd_weight_two_stage_xdl_nhwgc_gkyxc_nhwgk_f16_pipev2_large_tensors_instances(
                        op_ptrs);
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_f16_default_pipev2_large_tensors_instances(
                        op_ptrs);
                    // Explicit GEMM
                             ...
                             is_same_v<ComputeTypeB, ck::bhalf_t>)
                {
                    ...
                    add_device_grouped_conv2d_bwd_weight_two_stage_xdl_nhwgc_gkyxc_nhwgk_bf16_pipev2_large_tensors_instances(
                        op_ptrs);
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_bf16_default_pipev2_large_tensors_instances(
                        op_ptrs);
                    // Explicit GEMM
