                                                           ...
                                                           PassThrough>>>& instances)
{
    add_explicit_gemm_device_operation_instances<
        ...
        PassThrough,
        PassThrough,
        device_gemm_xdl_universal_km_kn_mn_odd_n_instances<BF16, Intrawave, GemmMNKPadding> /*two-stage, C=F32*/,
        device_gemm_xdl_universal_km_kn_mn_odd_n_instances<BF16, Intrawave, GemmMNKPadding, BF16> /*direct, C=bf16*/>(
        instances);
}
