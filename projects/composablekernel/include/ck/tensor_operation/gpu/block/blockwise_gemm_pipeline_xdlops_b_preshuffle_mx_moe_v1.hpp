            ...
            do
            {
                auto LoopFunc = [&](auto scale_comp_buf, auto scale_mem_buf) {
                    ...
                    static_ford<Sequence<MRepeat, KRepeat, NRepeat>>{}([&](auto mkn) {
                        ...
                        constexpr auto im_major = Number<m0 / MXdlPack>{};
                        constexpr auto im_minor = Number<m0 % MXdlPack>{};
                        constexpr auto ik_major = Number<k0 / KXdlPack>{};
                        constexpr auto ik_minor = Number<k0 % KXdlPack>{};
                        constexpr auto in_major = Number<n0 / NXdlPack>{};
                        constexpr auto in_minor = Number<n0 % NXdlPack>{};
