        ...
        if constexpr(HasMainLoop)
        {
            ...
            do
            {
                auto LoopFunc = [&](auto mfma_reg_buf, auto local_read_buf) {
                    ...
                    static_for<0, MRepeat, 1>{}([&](auto m0) {
                        static_ford<Sequence<NRepeat, num_scale_k_block>>{}([&](auto nk) {
                            constexpr auto n0      = Number<nk[Number<0>{}]>{};
                                    ...
                                    b_thread_vec.template AsType<ComputeDataType>()(
                                        ...
                                        [mfma_reg_buf][Number<b_thread_desc_.CalculateOffset(
                                            make_tuple(n0,
                                                       ...
                                                       kscale0 * KRepeat / num_scale_k_block + k0,
                                                       ik))>{}];
                                    b_thread_vec_up.template AsType<ComputeDataType>()(
                                        ik) = b_thread_bufs_up
                                        [mfma_reg_buf][Number<b_thread_desc_.CalculateOffset(
                                            make_tuple(n0,
                                                       I0,
                ...
                static_ford<Sequence<NRepeat, num_scale_k_block>>{}([&](auto nk) {
                    ...
                    static_for<0, KRepeat / num_scale_k_block, 1>{}([&](auto k0) {
                        ...
                        static_for<0, KPack, 1>{}([&](auto ik) {
                            ...
                            b_thread_vec_up.template AsType<ComputeDataType>()(
                                ik) = b_thread_bufs_up
                                [I0][Number<b_thread_desc_.CalculateOffset(make_tuple(
                                    n0, I0, kscale0 * KRepeat / num_scale_k_block + k0, ik))>{}];
                        });
                ...
                static_ford<Sequence<NRepeat, num_scale_k_block>>{}([&](auto nk) {
                    ...
                    static_for<0, KRepeat / num_scale_k_block, 1>{}([&](auto k0) {
                        ...
                        static_for<0, KPack, 1>{}([&](auto ik) {
                            ...
                            b_thread_vec_up.template AsType<ComputeDataType>()(
                                ik) = b_thread_bufs_up
                                [I1][Number<b_thread_desc_.CalculateOffset(make_tuple(
                                    n0, I0, kscale0 * KRepeat / num_scale_k_block + k0, ik))>{}];
                        });
