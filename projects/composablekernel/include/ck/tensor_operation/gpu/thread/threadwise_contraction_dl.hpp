...
struct ThreadwiseGemmDl_km0m1_kn0n1_m0m1n0n1
{
                               ...
                               COriginIdx)
    {
        ...
        static_ford<Sequence<TK, TM0, TM1>>{}([&](auto tkm) {
            constexpr auto tk  = Number<tkm[Number<0>{}]>{};
            constexpr auto tm0 = Number<tkm[Number<1>{}]>{};
            constexpr auto tm1 = Number<tkm[Number<2>{}]>{};
            static_ford<Sequence<TN0, TN1>>{}([&](auto tn_id) {
                constexpr auto tn0         = Number<tn_id[Number<0>{}]>{};
                constexpr auto tn1         = Number<tn_id[Number<1>{}]>{};
...
struct ThreadwiseContractionDl_A_TK0_TM0_TM1_TK1_B_TK0_TN0_TN1_TK1_C_TM0_TM1_TN0_TN1
{
                               ...
                               COriginIdx)
    {
        ...
        static_ford<Sequence<TK0, TM0, TM1>>{}([&](auto tkm) {
            constexpr auto tk0 = Number<tkm[Number<0>{}]>{};
            constexpr auto tm0 = Number<tkm[Number<1>{}]>{};
            constexpr auto tm1 = Number<tkm[Number<2>{}]>{};
            static_ford<Sequence<TN0, TN1>>{}([&](auto tn_id) {
                constexpr auto tn0 = Number<tn_id[Number<0>{}]>{};
