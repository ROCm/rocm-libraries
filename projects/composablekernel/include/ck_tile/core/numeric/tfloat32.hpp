...
// TF32 tag type: 1 sign bit, 8 exponent bits, 10 mantissa bits (see numeric_traits<tf32_legacy_t>)
struct [[deprecated("use ck_tile::tf32_t instead")]] tf32_legacy_t
{
};

template <>
struct [[deprecated(
    "use ck_tile::numeric_traits<ck_tile::tf32_t> instead")]] numeric_traits<tf32_legacy_t>
{
    static constexpr int exp            = 8;
    static constexpr int mant           = 10;
    static constexpr int bias           = 127;
    static constexpr uint32_t nan_mask  = 0x7F800000u;
    static constexpr uint32_t head_mask = 0xFF800000u;
    static constexpr uint32_t mant_mask = 0x7FFFFFu;
    static constexpr uint32_t exp_mask  = 0xFFu;
    static constexpr uint32_t abs_mask  = 0x7FFFFFFFu;
    static constexpr uint32_t Inf       = 0x7F800000u;
    static constexpr uint32_t NegInf    = 0xFF800000u;
    static constexpr uint32_t NaN       = 0x7F800001u;
    static constexpr uint32_t Neg0      = 0x80000000u;
    static constexpr int PackedSize     = 1;
