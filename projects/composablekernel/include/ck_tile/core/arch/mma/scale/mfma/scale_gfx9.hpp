...
template <typename CompilerTarget>
// clang-format off
struct amdgcn_mma<fp8_t, bf8_t, fp32_t, 16u, 16u, 128u, CompilerTarget, MmaOpFamily::SCALE, enable_if_target_id_t<CompilerTarget, amdgcn_target_id::GFX950>>
: amdgcn_mma_base<fp8_t, bf8_t, fp32_t, 16u, 16u, 128u, 64u, 32, 2, 1, 2, 1, 4, 1, MfmaOp, MmaOpFamily::SCALE>
//               | A B C DataTypes    | MNK + WaveSize     |AParams  |BPar |CPar |
// clang-format on
{
    static constexpr const char* instruction_name =
...
template <typename CompilerTarget>
// clang-format off
struct amdgcn_mma<bf8_t, fp8_t, fp32_t, 16u, 16u, 128u, CompilerTarget, MmaOpFamily::SCALE, enable_if_target_id_t<CompilerTarget, amdgcn_target_id::GFX950>>
: amdgcn_mma_base<bf8_t, fp8_t, fp32_t, 16u, 16u, 128u, 64u, 32, 2, 1, 2, 1, 4, 1, MfmaOp, MmaOpFamily::SCALE>
//               | A B C DataTypes    | MNK + WaveSize     |AParams  |BPar |CPar |
// clang-format on
{
    static constexpr const char* instruction_name =
