...
// Configuration set for the 16-channel HIP (intrinsic) grouped direct
...
// implementation logic, live in kernel/impl/grouped_16c_fp16_hip_conv_impl.hpp,
...
static_assert(configs_map.is_valid(), "Duplicate or negative config key in grouped_16c configs_map");
