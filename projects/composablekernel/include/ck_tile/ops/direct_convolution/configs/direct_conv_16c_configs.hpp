...
static constexpr auto configs_map = make_config_map<Config<DT>>({
    ...
    {79, {.waves_per_wg = 8, .direction = Direction::Dgrad,
          .swizzle_type = SwizzleType::CyclicShift,
    ...
    {84, {.waves_per_wg = 8, .direction = Direction::Dgrad,
...
static_assert(configs_map.is_valid(), "Duplicate or negative config key in grouped_16c_tile configs_map");
