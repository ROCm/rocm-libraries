...
template <ck_tile::direct_hip_conv::grouped_16c::Config cfg>
__device__ void conv2d_grouped_16c_fp16_cdna4_nhwc_impl(const _Float16* __restrict__ in,
                                                        ...
                                                        int px)
{
    using namespace ck_tile::direct_hip_conv::grouped_16c;
    using namespace ck_tile::direct_conv;
...
template <ck_tile::direct_hip_conv::grouped_16c::Config cfg>
__global__ void conv2d_grouped_16c_fp16_nhwc_cdna4(const _Float16* __restrict__ in,
                                                   const _Float16* __restrict__ wei,
                                                   double alpha,
                                                   double beta,
                                                   _Float16* __restrict__ out,
                                                   ...
                                                   int px)
{
    conv2d_grouped_16c_fp16_cdna4_nhwc_impl<cfg>(in,
                                                 wei,
                                                 alpha,
                                                 beta,
                                                 out,
                          ...
                          hipStream_t stream)
{
    ...
    conv2d_grouped_16c_fp16_nhwc_cdna4<cfg>
