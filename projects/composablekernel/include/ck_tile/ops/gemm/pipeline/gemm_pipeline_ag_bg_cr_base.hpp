...
struct GemmPipelineAgBgCrImplBase
{
    ...
    CK_TILE_DEVICE auto GetABLdsTensorViews(void* p_smem) const
    {
        ...
        // lds_padded_sizeof<ALdsType>() == sizeof(ALdsType) for every type except
        // the 12-byte FP6 LDS type, which pads to a 16-byte per-element stride to
        // match the buffer_load_dwordx3 -> LDS async write.
