...
// Block size to launch with, for all three grouped-conv directions. See wavelet_utils.hpp.
template <typename Pipeline>
inline constexpr index_t GroupedConvLaunchBlockSize = GemmPipelineLaunchBlockSize<Pipeline>;
