...
template <typename T>
using WmmaGemmConfig = GemmConfigPreshuffleB_BQuant_Prefill_Wmma<T>;

template <typename T>
using GenericGemmConfig = GemmConfigPreshuffleB_BQuant_Prefill<T>;

#define RUN_GEMM_EXAMPLE_PREC_TYPE                                              \
    run_gemm_bquant_quantgrouped_preshuffleb<WmmaGemmConfig<ck_tile::bf8_t>,    \
                                             GenericGemmConfig<ck_tile::bf8_t>, \
                                             TypeConfig,                        \
