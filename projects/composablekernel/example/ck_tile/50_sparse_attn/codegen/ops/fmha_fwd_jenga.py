...
FMHA_FWD_API_INNER_DISPATCH = """            {F_if}((t.is_group_mode == {F_mode}) && (t.bias_type == {F_bias_check}) && (t.has_logits_soft_cap == {F_logits_cpp}) && (t.is_v_rowmajor == {F_vlayout}) && ({F_mask_check}) &&
                ...
                using trait_ = fmha_jenga_fwd_traits_<{F_hdim}, {F_dtype}, {F_bm0}, {F_bn0}, {F_bk0}, {F_bn1}, {F_bk1}, {F_bk0max}, {F_vlayout}, {F_pipeline_enum}, {F_logits_cpp}/*logits*/, {F_mask}, {F_spad}, {F_skpad}, {F_dpad}, {F_dvpad}, {F_trload}, {F_mode}, {F_bias}>;
        ...
        for ((hdim, hdim_v), tiles), mode in itertools.product(d.items(), MODE_MAP.keys()):
            for tile, pipeline in itertools.product(
                ...
                if tile.F_bm0 != 128 or tile.F_bn0 != 128:
                    continue
                if pipeline.tag != "qr_async_jenga":
                    continue
                k = FmhaFwdKernel(
                    F_idx=2,
                    F_hdim=hdim,
