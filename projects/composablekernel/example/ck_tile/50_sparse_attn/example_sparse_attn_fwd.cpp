...
auto run(const ck_tile::ArgParser& arg_parser)
{
    ...
    return sparse_attn_fwd_run<DataTypeConfig>(
        api, batch, nhead, nhead_k, seqlen_q, seqlen_k, hdim_q, hdim_v,
        sparsity, simthreshold, mask_str, attention_sink, block_size,
        i_perm, o_perm, is_v_rowmajor, seed, do_validation,
