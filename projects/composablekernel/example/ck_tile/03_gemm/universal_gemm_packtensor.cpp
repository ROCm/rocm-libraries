                                            ...
                                            const CLayout c_layout = CLayout{})
{
    ...
    return run_gemm_example_with_layouts<GemmConfig,
                                         ...
                                         ALayout,
                                         BLayout,
                                         CLayout>(arg_parser, a_layout, b_layout, c_layout);
}
...
struct GemmConfigComputeV3_2_PackTensor : GemmConfigComputeV3_2<PrecType>
{
    static constexpr bool kPadM              = true;
    static constexpr bool kPadN              = true;
    static constexpr bool TransposeC         = true;
    static constexpr bool PermutePackTensorC = true;
};

template <typename PrecType>
struct GemmConfigComputeV3_WMMA_PackTensor : GemmConfigComputeV3_WMMA<PrecType>
{
    static constexpr bool kPadM              = true;
    static constexpr bool kPadN              = true;
    static constexpr bool TransposeC         = true;
...
int main(int argc, char* argv[])
{
    ...
    {
#if CK_TILE_USE_WMMA
        return !run_gemm_example<GemmConfigComputeV3_WMMA_PackTensor>(arg_parser);
#else
        static_assert(false, "This example requires CK_TILE_USE_WMMA to be enabled.");
#endif
    }
