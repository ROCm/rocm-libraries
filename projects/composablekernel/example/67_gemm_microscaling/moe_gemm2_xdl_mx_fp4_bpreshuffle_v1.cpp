...
// Same instance as moe_gemm2_xdl_mx_fp4_bpreshuffle.cpp, but pinned to the v1 block-GEMM
// pipeline. This variant exercises the fp4x2 b-preshuffle v1 pipeline, which failed to
// compile before the IndexEval fix (CK #9400).
// clang-format off
