...
# preshuffle_tdm) are matched first; every other trait falls back to the legacy
# "_" split, so existing trait strings resolve exactly as before.
#
# Python mirror: trait_parse.py (split_trait).
function(ck_tile_gemm_split_trait trait out_pipeline out_epilogue out_scheduler)
    set(_ck_rest "${trait}")
    set(_ck_pipeline "")
    if("${trait}" MATCHES "^(comp_async_eight_waves|comp_tdm_v2|comp_async|comp_tdm|weight_preshuffle|preshuffle_tdm)_(.*)$")
