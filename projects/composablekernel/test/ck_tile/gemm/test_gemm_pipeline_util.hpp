...
template <typename Problem>
struct GemmPipelineTypeSelector<GemmPipelineType::CompAsyncEightWarps, Problem>
{
    using base_pipeline = ck_tile::BaseGemmPipelineAgBgCrCompV3<Problem>;
    using pipeline      = ck_tile::GemmPipelineAgBgCrCompAsyncEightWarps<Problem>;

    static constexpr auto GetName() { return "GemmPipelineAgBgCrCompAsyncEightWarps"; }
};
...
class TestCkTileGemmPipeline : public ::testing::Test
{
    ...
    void invoke_gemm(const ck_tile::GemmHostArgs& args, const ck_tile::stream_config& s)
    {
        constexpr ck_tile::index_t M_Warp =
            PipelineType == GemmPipelineType::CompAsyncEightWarps ? 4 : 2;
    ...
    void SetUp() override
    {
        ...
        if constexpr(PipelineType == GemmPipelineType::CompV4 ||
                     PipelineType == GemmPipelineType::CompAsyncEightWarps ||
