...
struct KernelConfigurations
{
    static constexpr auto configs_map = make_config_map<Config<DT>>({
        ...
        // Fprop (keys 15-19)
        {15,
         {.waves_c64 = 2, .waves_q4 = 8, .epilogue = EpilogueType::RegistersToLdsToGlobalMemory}},
        {16,
         {.waves_c64 = 2, .waves_q4 = 4, .epilogue = EpilogueType::RegistersToLdsToGlobalMemory}},
        {17,
         {.waves_c64 = 2, .waves_q4 = 2, .epilogue = EpilogueType::RegistersToLdsToGlobalMemory}},
        {18,
         {.waves_c64 = 2, .waves_q4 = 1, .epilogue = EpilogueType::RegistersToLdsToGlobalMemory}},
        {19,
         {.waves_c64 = 1, .waves_q4 = 1, .epilogue = EpilogueType::RegistersToLdsToGlobalMemory}},
        ...
        //  {52,
        //  {.waves_c64=2,.waves_q4=2,.direction=Direction::Dgrad,.swizzle_type=SwizzleType::CyclicShift,.vector_size=2}},
        //  {53,
        //  {.waves_c64=2,.waves_q4=2,.direction=Direction::Dgrad,.swizzle_type=SwizzleType::CyclicShift,.vector_size=1}},
        //  {54,
        //  {.waves_c64=2,.waves_q4=2,.direction=Direction::Fprop,.swizzle_type=SwizzleType::CyclicShift,.vector_size=2}},
        //  {55,
        //  {.waves_c64=2,.waves_q4=2,.direction=Direction::Fprop,.swizzle_type=SwizzleType::CyclicShift,.vector_size=1}},
    });
    static_assert(configs_map.is_valid(),
                  "Duplicate or negative config key in grouped_4c_tile configs_map");
