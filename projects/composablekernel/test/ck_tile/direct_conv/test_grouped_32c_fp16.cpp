...
struct HipConv32cKernelTraits
{
    ...
    using FwdKernel = ck_tile::direct_conv::DirectHipConvForward32CFp16Kernel<
        ck_tile::direct_hip_conv::grouped_32c::configs_map.get(ConfigIdx)>;
    template <int ConfigIdx>
    using BwdDataKernel = ck_tile::direct_conv::DirectHipConvBwdData32CFp16Kernel<
        ck_tile::direct_hip_conv::grouped_32c::configs_map.get(ConfigIdx)>;
};

class DirectConvGrouped32cFp16HipTest
    : public DirectConvGroupedTestHarness<HipConv32cKernelTraits>
{
};
