...
//
// KernelConfigurations<>::configs_map.get(9)  — Fprop, vector_size=8, waves_c64=1 (unpadded baseline)
// KernelConfigurations<>::configs_map.get(49) — Fprop, CyclicShift, vector_size=1, waves_c64=2 (any c)
// ============================================================================
