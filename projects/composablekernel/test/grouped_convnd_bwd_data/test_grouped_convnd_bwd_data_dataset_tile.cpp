...
// CSV-driven CK Tile backward-data dataset test (AICK-1277).
//
// This mirrors test_grouped_convnd_bwd_data_tile.cpp, but instead of hardcoding
// the convolution shapes it loads them from the same CSV catalogue consumed by
// the Old CK test_grouped_convnd_bwd_data_dataset_xdl test
...
class TestGroupedConvndBwdDataDatasetTile : public ::testing::Test
{
    protected:
...
template <typename SignatureDetailsType>
class TestGroupedConvndBwdDataDatasetTile2d
    : public TestGroupedConvndBwdDataDatasetTile<SignatureDetailsType>
{
};

template <typename SignatureDetailsType>
class TestGroupedConvndBwdDataDatasetTile3d
    : public TestGroupedConvndBwdDataDatasetTile<SignatureDetailsType>
{
};

TYPED_TEST_SUITE(TestGroupedConvndBwdDataDatasetTile2d, KernelTypes2d);
TYPED_TEST_SUITE(TestGroupedConvndBwdDataDatasetTile3d, KernelTypes3d);

TYPED_TEST(TestGroupedConvndBwdDataDatasetTile2d, Test2D)
{
...
TYPED_TEST(TestGroupedConvndBwdDataDatasetTile3d, Test3D)
{
    this->conv_args.clear();
