...
def main() -> int:
    ...
    conv.add_argument("--sD", type=int, default=1,    help="depth stride  (3-D only)")
    ...
    conv.add_argument("--pD", type=int, default=0,    help="depth padding  (3-D only)")
    ...
    conv.add_argument("--dD", type=int, default=1,    help="depth dilation  (3-D only)")
