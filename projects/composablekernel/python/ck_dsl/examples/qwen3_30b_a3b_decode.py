...
def _build_dsl_norm(M, N):
    ...
    from ck_dsl.instances.add_rmsnorm2d_bf16 import (
...
def bench_moe_sorting() -> LayerResult:
    ...
    try:
        from ck_dsl.instances.moe_sorting import MoeSortingSpec, MoeSortingLauncher
...
def bench_moe_e2e() -> LayerResult:
    ...
    try:
        from ck_dsl.instances.fused_moe_e2e import FusedMoeForwardSpec, FusedMoeForward
...
def bench_prefill_attn() -> List[LayerResult]:
    ...
    from ck_dsl.instances import attention_unified as _au
