...
class MoeShape:
    ...
    def to_fused_moe_forward_spec(self, *, use_static_offsets: bool = True):
        from ck_dsl.instances.common.fused_moe_e2e import FusedMoeForwardSpec
...
def add_rmsnorm_rdquant_specs(
    ...
    from ck_dsl.instances.common.add_rmsnorm2d_rdquant import AddRmsnorm2DRdquantSpec
...
def topk_softmax_spec(shape: MoeShape = QWEN3_30B_A3B_DECODE):
    from ck_dsl.instances.common.topk_softmax import TopkSoftmaxSpec
...
def moe_sorting_spec(shape: MoeShape = QWEN3_30B_A3B_DECODE):
    from ck_dsl.instances.common.moe_sorting import MoeSortingSpec
