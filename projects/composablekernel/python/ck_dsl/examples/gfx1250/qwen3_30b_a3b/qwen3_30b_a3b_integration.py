...
MASTER_ENV = "CK_DSL_GFX1250_QWEN_AITER_ATOM"
REGISTER_OPS_ENV = "CK_DSL_GFX1250_QWEN_REGISTER_OPS"
GATE_ENVS = {
    "gemm": "CK_DSL_GFX1250_QWEN_GEMM",
    "attention": "CK_DSL_GFX1250_QWEN_ATTENTION",
    "norm": "CK_DSL_GFX1250_QWEN_NORM",
    "routing": "CK_DSL_GFX1250_QWEN_ROUTING",
    "moe": "CK_DSL_GFX1250_QWEN_MOE",
}
...
def _selected_backend(shape: QwenOpShape) -> str:
    return f"ck_dsl.gfx1250.qwen3_30b_a3b.{shape.kind}"
...
def select_route(
    ...
    *,
    ...
    if shape.kind == "rmsnorm_add":
        custom_op = "ck_dsl_gfx1250_qwen::rmsnorm_add_out"
    elif shape.kind == "router_topk":
        custom_op = "ck_dsl_gfx1250_qwen::router_topk_out"
...
def register_torch_custom_ops(namespace: str = "ck_dsl_gfx1250_qwen") -> bool:
...
def maybe_register_torch_custom_ops(
    gates: GateConfig | None = None, namespace: str = "ck_dsl_gfx1250_qwen"
) -> bool:
    gates = GateConfig.from_env() if gates is None else gates
