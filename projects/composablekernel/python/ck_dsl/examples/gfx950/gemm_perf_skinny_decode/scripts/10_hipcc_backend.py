...
`ck_dsl.helpers.compile_kernel_via_hipcc` lowers the same IR to HIP C++
...
from ck_dsl.helpers import compile_kernel, make_gemm_manifest  # noqa: E402
from ck_dsl.helpers.compile import compile_kernel_via_hipcc  # noqa: E402
