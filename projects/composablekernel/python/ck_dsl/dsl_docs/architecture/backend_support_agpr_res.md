...
Kernels using HipKittens-style explicit asm: leave at default; do not constrain.
...
HipKittens-style inline-asm MFMA ops with explicit a[..] / v[..] register numbers. Useful for finer scheduling control, not needed for residency selection.
