...
The flow follows ``dsl_docs/development/ck_dsl_dispatcher_design.md``:
...
5. optionally run correctness/benchmark through ``ck_dsl.run_manifest``;
6. record all outcomes as structured JSON.

This harness intentionally lives under ``ck_dsl.benchmark.gemm`` rather than the
