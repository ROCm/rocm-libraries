...
"""CLI: build CK_DSL examples locally and run them on remote slurm compute nodes.
...
def _cmd_exec(args: argparse.Namespace) -> int:
    ...
    alloc._remote_pkg = slurm.push_ck_dsl_tree()
    env = {"CKDSL_NBITS_DEBUG": "1"} if args.debug else None
