...
def kernel_name(dtype: str = "i32") -> str:
    return f"ckdsl_multi_result_{dtype}"
...
def build_multi_result(dtype: str = "i32"):
    ...
    outs = b.inline_asm_multi("v_add_u32 $0, $2, $3\n\tv_sub_u32 $1, $2, $3",
                              "=v,=v,v,v", [tid, c], result_types=[I32, I32])
...
def main() -> int:
    ...
    if args.emit == "recipe":
        ...
        sys.stdout.write(lower_kernel_to_llvm(build_multi_result(args.dtype), arch=args.arch))
    return 0
