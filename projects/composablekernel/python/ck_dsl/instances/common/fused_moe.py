...
def _resolve_launch_arch(arch: "str | None") -> str:
    ...
    :func:`ck_dsl.runtime.hip_module.get_device_arch` and fall back to
...
class FusedMoeLauncher:
    ...
    in :mod:`ck_dsl.instances.common.moe_sorting` and chain analogously
    ...
    def _ensure_launchers(self) -> Dict[str, Any]:
        ...
        :mod:`ck_dsl.instances.common.fused_moe` import-time-safe (the
