...
def is_valid_spec(spec: UniversalGemmSpec, arch: str = "gfx950") -> Tuple[bool, str]:
    ...
    are sourced from :class:`ck_dsl.core.arch.ArchTarget`, so this predicate
...
def _atom_frag_lengths(op) -> Tuple[int, int, int]:
    ...
    vector lengths of the resolved :class:`~ck_dsl.core.arch.MmaOp`.
...
def _emit_mfma_acc_scatter(
    ...
    *,
    ...
    :mod:`ck_dsl.core.arch`) with the same hoisting the two epilogues used to
