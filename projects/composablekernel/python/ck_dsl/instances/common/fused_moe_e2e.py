...
* :class:`~ck_dsl.instances.common.topk_softmax.TopkSoftmaxSpec` (single
  launch) for the router.
* :class:`~ck_dsl.instances.common.moe_sorting.MoeSortingLauncher` for the
  3-phase sort (histogram -> scan -> scatter).
* :class:`~ck_dsl.instances.common.fused_moe.FusedMoeLauncher` for the
  3-phase MoE-specific chain (gather -> silu_mul -> topk_reduce).
* :class:`~ck_dsl.instances.common.grouped_gemm.GroupedGemmLauncher` for
...
class FusedMoeForwardSpec:
    ...
    :func:`ck_dsl.runtime.hip_module.get_device_arch`, falling back to
