...
Same per-batch algorithm as :mod:`ck_dsl.instances.common.transpose`:
...
Identical to the single-batch :mod:`ck_dsl.instances.common.transpose` writeup:
...
:mod:`ck_dsl.instances.common.transpose` module docstring). Everything else
...
def is_valid_spec(
    ...
    :mod:`ck_dsl.instances.common.transpose` plus a batch axis; no MFMA atom and
...
def build_batched_transpose2d(
    ...
    # Same scalar-gather residue as :mod:`ck_dsl.instances.common.transpose`;
