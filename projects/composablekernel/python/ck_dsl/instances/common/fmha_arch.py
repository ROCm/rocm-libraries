...
The MFMA-tiled attention body (:func:`ck_dsl.helpers.mfma_attention.
...
atom set from :class:`ck_dsl.core.arch.ArchTarget` (the same catalog
...
def validate_fmha_mfma_atom(dtype: str, arch: str = "gfx950") -> Tuple[bool, str]:
    ...
    Mirrors :func:`ck_dsl.instances.common.gemm_universal.is_valid_spec`'s
