...
The kernel body lives in :mod:`ck_dsl.instances.common.deep_fused_conv_pool`,
authored once and driven by the resolved :class:`~ck_dsl.core.arch.MmaOp` so the
...
``ck_dsl_gfx1201_deep_fused_conv_pool``).
...
_GFX1201_NAME = "ck_dsl_gfx1201_deep_fused_conv_pool"
