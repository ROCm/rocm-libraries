...
:mod:`ck_dsl.examples.common.ck_tile_parity`; the GEMM/attention parity drivers
live in :mod:`ck_dsl.examples.gfx950.attention.parity_unified_attention` and
:mod:`ck_dsl.examples.common.bake_off_implicit_gemm`.
"""
