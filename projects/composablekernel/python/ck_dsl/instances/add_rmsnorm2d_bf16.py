...
A simplified relative of :mod:`ck_dsl.instances.add_rmsnorm2d_rdquant`.
...
def is_valid_spec(spec: AddRMSNorm2DBF16Spec) -> Tuple[bool, str]:
    return validate_io(
        IOSpecRule(
            dtype=spec.dtype,
...
def build_add_rmsnorm2d_bf16(spec: AddRMSNorm2DBF16Spec) -> KernelDef:
