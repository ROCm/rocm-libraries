...
The kernel body now lives in :mod:`ck_dsl.instances.common.deep_fused_conv_pool`,
...
manifests keep working byte-for-byte (kernel name ``ck_dsl_gfx950_deep_fused_conv_pool``).
"""
