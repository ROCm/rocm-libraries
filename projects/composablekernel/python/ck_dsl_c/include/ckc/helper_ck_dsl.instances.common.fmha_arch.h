 ...
 *
 * ckc/helper_ck_dsl.instances.common.fmha_arch.h -- C99 port of the two
 * arch-awareness symbols from ck_dsl/instances/common/fmha_arch.py:
 *
 *   Python (ck_dsl.instances.common.fmha_arch)   C99 (this header)
 *   ------------------------------------------    ----------------------------
 *   FMHA_MFMA_ATTN_BLOCK = 16                     CKC_FMHA_MFMA_ATTN_BLOCK
 *   validate_fmha_mfma_atom(dtype, arch)          ckc_validate_fmha_mfma_atom()
 *
 * The Python helper sources its legal atom set from ck_dsl.core.arch.ArchTarget
 ...
 * ckc/helper_ck_dsl.core.arch.h: ArchTarget.from_gfx -> ckc_archtarget_from_gfx,
 * target.mma.has_shape(...) is reproduced via ckc_archtarget_op_for_shape (the
 ...
 */
#ifndef CKC_HELPER_CK_DSL_INSTANCES_COMMON_FMHA_ARCH_H
#define CKC_HELPER_CK_DSL_INSTANCES_COMMON_FMHA_ARCH_H
 ...
 */
#define CKC_FMHA_MFMA_ATTN_BLOCK 16
...
#endif /* CKC_HELPER_CK_DSL_INSTANCES_COMMON_FMHA_ARCH_H */
