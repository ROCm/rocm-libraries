 ...
 *
 * ckc/instance_gfx1151_wmma_gemm.h -- C99 port of the gfx1151 (RDNA3.5 / Strix
 * Halo) WMMA GEMM kernel instance builder ck_dsl/instances/gfx1151/wmma_gemm.py.
 *
 *   Python (gfx1151/wmma_gemm.py)         C99 (this header)
 *   -----------------------------------   --------------------------------------
 *   class WmmaGemmSpec                    ckc_wmma_gemm_gfx1151_spec_t
 *   WmmaGemmSpec.block_size               ckc_wmma_gemm_gfx1151_block_size(spec)
 *   WmmaGemmSpec.kernel_name()            ckc_wmma_gemm_gfx1151_kernel_name(...)
 *   is_valid_spec(spec, arch)             ckc_wmma_gemm_gfx1151_is_valid_spec(...)
 *   build_wmma_gemm(spec, arch)           ckc_build_wmma_gemm_gfx1151(...)
 *   wmma_gemm_grid(M, N)                  ckc_wmma_gemm_gfx1151_grid(...)
 *   (+ convenience: build -> lower .ll)   ckc_wmma_gemm_gfx1151_lower_to_llvm(...)
 *
 ...
 *     (ckc_b_wmma_f32_16x16x16_f16) -- not the wmma_gfx12_* variant.
 ...
 * ckc_b_global_load_vN_f16, ckc_b_wmma_f32_16x16x16_f16, ckc_b_scf_yield,
 ...
 * the caller fills a ckc_wmma_gemm_gfx1151_spec_t.
 * ckc_wmma_gemm_gfx1151_spec_default() returns a struct with every field set to
 ...
 */
#ifndef CKC_INSTANCE_GFX1151_WMMA_GEMM_H
#define CKC_INSTANCE_GFX1151_WMMA_GEMM_H
...
/* wmma_gemm_grid(M, N) -> ((M+15)//16, (N+15)//16, 1). Returns CKC_OK and
...
#endif /* CKC_INSTANCE_GFX1151_WMMA_GEMM_H */
