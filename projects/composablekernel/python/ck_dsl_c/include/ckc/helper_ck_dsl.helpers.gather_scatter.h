 ...
 *
 * ckc/helper_ck_dsl.helpers.gather_scatter.h -- C99 port of
 * ck_dsl.helpers.gather_scatter.
 *
 ...
 * unsupported pointer type records CKC_ERR_VALUE + the Python-matching message
 * on the builder and returns NULL; an already-errored builder is a NULL no-op.
 */
#ifndef CKC_HELPER_CK_DSL_HELPERS_GATHER_SCATTER_H
#define CKC_HELPER_CK_DSL_HELPERS_GATHER_SCATTER_H
...
/* C99 port of ck_dsl.helpers.gather_scatter.load_sorted_token_id:
 *
...
ckc_value_t* ckc_b_load_sorted_token_id(ckc_ir_builder_t* b,
                                        ckc_value_t* sorted_token_ids,
                                        ckc_value_t* bucket_idx);

/* C99 port of ck_dsl.helpers.gather_scatter.load_sorted_topk_weight:
 *
...
ckc_value_t* ckc_b_load_sorted_topk_weight(ckc_ir_builder_t* b,
                                           ckc_value_t* sorted_weights,
                                           ckc_value_t* bucket_idx);
...
#endif /* CKC_HELPER_CK_DSL_HELPERS_GATHER_SCATTER_H */
