 ...
 *
 * ckc/instance_gfx942_attention_tiled_3d.h -- PUBLIC C99 port surface for the
 * gfx942 (CDNA3) narrow-atom tiled split-KV 3D attention kernels
 * (ck_dsl/instances/gfx942/attention_tiled_3d.py, 1133 LOC).
 *
 ...
 *   supports_tiled_3d(...)                        ckc_gfx942_attention_tiled_3d_supports
 *   build_unified_attention_3d_tiled(spec, arch)  ckc_build_unified_attention_3d_tiled_gfx942
 *   build_unified_attention_reduce_tiled(...)     ckc_build_unified_attention_reduce_tiled_gfx942
 ...
 * exports the unprefixed ckc_build_unified_attention_3d_tiled name).
 *
 ...
 *   ckc/helper_ck_dsl.helpers.atoms.h              -- MfmaAtom.f16_16x16x16,
 ...
 *   ckc/helper_ck_dsl.instances.common.fmha_arch.h -- validate/require tiled
...
#define CKC_INSTANCE_GFX942_ATTENTION_TILED_3D_H
...
#define CKC_GFX942_ATTN_TILED_3D_MFMA_M 16
#define CKC_GFX942_ATTN_TILED_3D_MFMA_N 16
/* gfx942 narrow atom: K-step is 16 for both QK and PV (no wide-K atom). */
#define CKC_GFX942_ATTN_TILED_3D_QK_K_STEP 16
#define CKC_GFX942_ATTN_TILED_3D_PV_K_STEP 16
/* CDNA3 async global->LDS DMA caps at 1 DWORD (4 bytes = 2 halves) per lane. */
#define CKC_GFX942_ATTN_TILED_3D_ASYNC_LDS_DWORDS 1
/* THREADS: single wave. */
#define CKC_GFX942_ATTN_TILED_3D_THREADS 64
/* rcp(ln2) folded into the score (exp2 domain). */
#define CKC_GFX942_ATTN_TILED_3D_RCP_LN2 1.4426950408889634
 ...
 * (materialised by ckc_unified_attention_3d_tiled_spec_default).
 *
...
int ckc_unified_attention_3d_tiled_spec_kernel_name(const ckc_unified_attention_3d_tiled_spec_t* s,
                                                    char* buf,
                                                    size_t cap);
 ...
 * ckc_unified_attention_3d_tiled_spec_validate. */
...
#endif /* CKC_INSTANCE_GFX942_ATTENTION_TILED_3D_H */
