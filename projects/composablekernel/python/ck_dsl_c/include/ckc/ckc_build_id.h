 ...
 *
 * ckc/ckc_build_id.h -- engine freshness / provenance stamp.
 *
 ...
 *
 * NOTE ON THE FILE NAME: this pair is named with the ``ckc_`` prefix (mirroring
 * cmake/ckc_build_id.cmake) rather than ``build_id.*`` deliberately -- the
 ...
 * defines them (src/core/ckc_build_id.cpp) is intentionally never referenced by
