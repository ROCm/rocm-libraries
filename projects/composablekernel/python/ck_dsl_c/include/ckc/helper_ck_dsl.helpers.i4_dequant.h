 ...
 *
 * ckc/helper_ck_dsl.helpers.i4_dequant.h -- C99 port of four symbols from
 * ck_dsl/helpers/i4_dequant.py:
 *
 *   Python                              C99 (this header)
 *   ---------------------------------   ---------------------------------------
 *   unpack_i4_byte_to_pair_i32(b, byte) ckc_unpack_i4_byte_to_pair_i32(...)
 *   unpack_i4_byte_to_pair_f32(b, byte) ckc_unpack_i4_byte_to_pair_f32(...)
 *   unpack_i4_byte_to_pair_f16(b, byte) ckc_unpack_i4_byte_to_pair_f16(...)
 *   dequant_i4_byte_to_f16_pair(b, ...) ckc_dequant_i4_byte_to_f16_pair(...)
 *
 * SCOPE: only these four symbols. The fp8 / bf8 dequant siblings
 * (dequant_i4_byte_to_fp8_pair / _bf8_pair, which route through
 * ck_dsl.helpers.quant.quantize_scalar_f32), the i8 alias
 ...
 * builder (ckc_b_* op calls). The op sequence is reproduced byte-faithfully from
 ...
 * and returns a ckc_status_t. The Python type guard
 *
 *     if packed_byte.type.name != "i8": raise ValueError(...)
 *
 * (present only on unpack_i4_byte_to_pair_i32) maps onto a CKC_ERR_VALUE sticky
 ...
 */
#ifndef CKC_HELPER_CK_DSL_HELPERS_I4_DEQUANT_H
#define CKC_HELPER_CK_DSL_HELPERS_I4_DEQUANT_H
 ...
 * builder records CKC_ERR_VALUE and the function returns it. Out-params receive
...
#endif /* CKC_HELPER_CK_DSL_HELPERS_I4_DEQUANT_H */
