...
static void ckc_gfx1201_dfcp_decode_row_to_hw(
    ckc_ir_builder_t* b,
                                         ...
                                         const ckc_warp_grid_t* grid)
{
    ...
    ckc_gfx1201_dfcp_decode_row_to_hw(b, ctx->common_spec, row, &global_h,
                                      &global_w);
 ...
 * ===================================================================== */
ckc_value_t* ckc_gfx1201_dfcp_setup_input_cache(
 ...
 * ===================================================================== */
ckc_value_t* ckc_gfx1201_dfcp_setup_specialized_a_loader(
    ckc_gfx1201_dfcp_build_ctx_t* ctx,
    const ckc_implicit_gemm_conv_spec_t* conv_spec_,
    const ckc_warp_grid_t* grid,
    ckc_value_t* a_rsrc)
 ...
 *                                       cache)
 * ===================================================================== */
void ckc_gfx1201_dfcp_load_a_tile_from_cache(
    ckc_gfx1201_dfcp_build_ctx_t* ctx,
    const ckc_implicit_gemm_conv_spec_t* conv_spec_,
    ckc_value_t* k_off,
    ckc_value_t* a_dst,
 ...
 *                                  a_rsrc)
 * ===================================================================== */
void ckc_gfx1201_dfcp_load_a_tile_specialized(
    ckc_gfx1201_dfcp_build_ctx_t* ctx,
    const ckc_implicit_gemm_conv_spec_t* conv_spec_,
    ckc_value_t* k_off,
    ckc_value_t* a_dst,
 ...
 *                                                 frag_len, cache)
 * ===================================================================== */
ckc_value_t* ckc_gfx1201_dfcp_load_a_operand_from_cache(
    ckc_gfx1201_dfcp_build_ctx_t* ctx,
    const ckc_implicit_gemm_conv_spec_t* conv_spec_,
    ckc_value_t* row,
    ckc_value_t* k_off,
