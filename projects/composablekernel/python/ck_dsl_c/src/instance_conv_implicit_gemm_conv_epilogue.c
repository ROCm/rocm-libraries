                                   ...
                                   ckc_value_t* d_rsrc)
{
    ...
    ckc_direct_epilogue_store(b,
                              ...
                              (void*) D_desc,
                              d_rsrc,
                              ckc_b_const_i32(b, ckc_conv_problem_m(p)),
                              ckc_b_const_i32(b, ckc_conv_problem_n_gemm(p)),
                              false);
}
                                     ...
                                     ckc_value_t* d_rsrc)
{
    ...
    const ckc_mfma_atom_t* atom =
        ckc_mfma_atom("f16", spec->warp_tile_m, spec->warp_tile_n,
                      spec->warp_tile_k);
    /* CShuffleEpilogue.from_grid(atom=spec.atom, grid=grid) (default max_store_vec=8) */
    ckc_cshuffle_epilogue_t epi = ckc_cshuffle_epilogue_from_grid(atom, grid, 8);
