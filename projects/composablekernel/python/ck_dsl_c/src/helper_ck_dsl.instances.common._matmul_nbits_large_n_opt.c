                                                     ...
                                                     const char* arch)
{
    ...
    ckc_b_region_enter(b, loop.body);
    {
        ...
        ckc_value_t** gacc = ckc_arena_alloc(&b->arena, (size_t)n_acc * sizeof(*gacc));
        if (gacc == NULL)
        {
            return NULL;
        }
...

        {
            ...
            for (ks = 0; ks < n_ksub; ++ks)
            {
                ...
                ckc_value_t** a_frag =
                    ckc_arena_alloc(&b->arena, (size_t)n_sub_m * sizeof(*a_frag));
                if (a_frag == NULL)
                {
                    return NULL;
                }
                ...
                ckc_value_t** b_frag =
                    ckc_arena_alloc(&b->arena, (size_t)n_sub_n * sizeof(*b_frag));
                if (b_frag == NULL)
                {
                    return NULL;
                }
                {
                    ...
                    for (sn = 0; sn < n_sub_n; ++sn)
                    {
                        ...
                        ckc_value_t** comps = ckc_arena_alloc(
                ...
                {
                    ckc_value_t** ng =
                        ckc_arena_alloc(&b->arena, (size_t)n_acc * sizeof(*ng));
                    if (ng == NULL)
                    {
                        return NULL;
                    }
        ...
        ckc_value_t** scale_vec =
            ckc_arena_alloc(&b->arena, (size_t)n_sub_n * sizeof(*scale_vec));
        if (scale_vec == NULL)
        {
            return NULL;
        }
