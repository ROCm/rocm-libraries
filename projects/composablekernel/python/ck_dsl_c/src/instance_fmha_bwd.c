                                     ...
                                     const char* arch)
{
    ...
    /* ---------------- First K-loop: rowsum_dp via iter_arg ---------------- */
    {
        ...
        rs_arg.name = "rs";
        rs_arg.init = zero_f;
        k_loop_1 = ckc_b_scf_for_iter(b, ckc_b_const_i32(b, 0), seqlen_k,
                                      ckc_b_const_i32(b, 1), &rs_arg, 1, "k_idx",
                                      false, false);
    }
    ...
    /* ---------------- Second K-loop: atomic dV/dK, per-lane dQ regs --------- */
    {
        ...
        k_loop_2 = ckc_b_scf_for_iter(b, ckc_b_const_i32(b, 0), seqlen_k,
                                      ckc_b_const_i32(b, 1), iter_args2, ept,
                                      "k_idx2", false, false);
    }
