...
static ckc_status_t ckc_md_lowered_symbol_name(const ckc_gemm_multi_d_spec_t* spec,
                                               char* out,
                                               size_t out_cap)
{
    char md_name[512];
...
ckc_gemm_multi_d_spec_t* ckc_gemm_multi_d_spec_new(
    ckc_arena_t* arena,
...
static void ckc_md_owner_register(ckc_kernel_def_t* kernel,
                                  ckc_ir_builder_t* builder,
                                  ckc_arena_t* arena)
{
