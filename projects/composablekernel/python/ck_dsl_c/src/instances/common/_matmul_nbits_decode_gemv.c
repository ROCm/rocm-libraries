    ...
    const char* arch)
{
    ...
    /* ---- params ---- */
    {
        ...
        opts.noalias = true;  opts.noalias_set = true;
        opts.readonly = true; opts.readonly_set = true;
        opts.align = 8;       opts.align_set = true;
        ...
        memset(&opts, 0, sizeof(opts));
        opts.noalias = true;   opts.noalias_set = true;
        opts.writeonly = true; opts.writeonly_set = true;
        opts.align = 16;       opts.align_set = true;
    ...
    ckc_b_region_enter(b, nguard.then_region);
    {
        ...
        ckc_b_region_enter(b, mloop.body);
        {
            ...
            kloop = ckc_b_scf_for_iter(b, c0, c_half_k, c1,
                                       iter_args, 1, "j",
                                       /*unroll=*/false,
            ...
            ckc_b_region_enter(b, kloop.body);
            {
                ...
                byte = ckc_b_global_load(b, Bp, ckc_b_add(b, b_byte_base, j),
                                         ckc_i8(), /*align*/ 0);
                ...
                scale = ckc_b_global_load(b, Sp, ckc_b_add(b, b_scale_base, kgrp),
                                          scale_t, /*align*/ 0);
                ...
                a_lo = ckc_b_cast_to_f32(
                    b, ckc_b_global_load(b, A, ckc_b_add(b, a_row_base, k_even),
                                         ckc_f16(), /*align*/ 0));
            ...
            /* out_h = b.trunc_f32_to_f16(kloop.results[0]) */
            {
                ...
                /* b.global_store(C, b.add(b.mul(m, cN), n), out_h) */
                ckc_b_global_store(b, C,
                                   ckc_b_add(b, ckc_b_mul(b, m, cN), n),
                                   out_h, /*align*/ 0);
            }
        }
