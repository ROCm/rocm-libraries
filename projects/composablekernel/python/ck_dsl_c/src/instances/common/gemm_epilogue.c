...
static void ckc_gemm_fe_declare_and_record(ckc_ir_builder_t* b,
                                           void* fused_epilogue,
                                           ckc_value_t* N)
{
...
static ckc_value_t* ckc_gemm_fe_apply_scalar(ckc_ir_builder_t* b,
                                             void* fused_epilogue,
                                             ckc_value_t* v,
                                             ckc_value_t* m,
                                             ckc_value_t* n)
                                    ...
                                    bool n_base_first)
{
    ...
    ckc_value_t* col_in_atom = n_in_atom;
    {
        ...
        {
            ckc_value_t* ys[2] = {ckc_b_const_i32(b, i / kc_m1),
                                  ckc_b_const_i32(b, i % kc_m1)};
            ckc_value_t* x_out[2] = {NULL, NULL};
            if (!ckc_tile_distribution_calculate_x(b, c_dist, ys, 2, ps, ps_counts, 1,
                                                   x_out, 2))
                return;
     ...
     *       per_cell(c_m, c_n, acc_h, i) */
    {
        ...
        {
            ckc_value_t* base_m =
                ckc_b_add(b, m_base_off, ckc_b_const_i32(b, mi * t->warp_tile_m));
...
static void gemm_default_store_cell(ckc_ir_builder_t* b,
                                    ckc_value_t* c_m,
                                    ckc_value_t* c_n,
                                    ckc_value_t* acc_h,
                                    int i,
        ...
        for (e = 0; e < vecs_per_thread; ++e)
        {
            ...
            else
            {
                ...
                if (fused_epilogue != NULL)
                {
                    ...
                    hv = ckc_gemm_fe_apply_vec(b, fused_epilogue, fused_is_mde, hv, c_m, c_n,
                                               store_vec);
                }
                if (in_bounds != NULL)
                {
