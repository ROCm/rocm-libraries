...
ckc_kernel_def_t* ckc_build_moe_gather(ckc_ir_builder_t* b,
...
ckc_kernel_def_t* ckc_build_moe_silu_mul(ckc_ir_builder_t* b,
                                         const ckc_fused_moe_spec_t* spec,
                                         const char* arch)
{
    ckc_moe_stream_ctx_t ctx;
 ...
 * caller returns NULL. */
static ckc_status_t ckc_moe_init_named(ckc_ir_builder_t* b,
                                       const ckc_fused_moe_spec_t* spec,
                                       const char* phase)
{
