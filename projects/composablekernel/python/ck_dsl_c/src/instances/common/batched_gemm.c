 ...
 * ===================================================================== */
ckc_gemm_universal_spec_t ckc_batched_gemm_to_universal_spec(
 ...
 * ===================================================================== */
ckc_status_t ckc_batched_gemm_kernel_name(const ckc_batched_gemm_spec_t* spec,
                                          char* out,
                                          size_t out_cap)
{
 ...
 * ===================================================================== */
ckc_kernel_def_t* ckc_build_persistent_batched_gemm(
    ckc_ir_builder_t* b, const ckc_batched_gemm_spec_t* spec, const char* arch)
{
    ckc_gemm_universal_spec_t universal;
 ...
 * ===================================================================== */
ckc_status_t ckc_batched_gemm_grid(int batch,
                                   int m,
                                   int n,
                                   const ckc_batched_gemm_spec_t* spec,
                                   int out[3])
