 ...
 * rank 1). */
static void rms_view_load_vec_as_f32(ckc_ir_builder_t* b,
...
static ckc_value_t* rms_combine_fadd(ckc_ir_builder_t* b,
                                     ckc_value_t* a,
                                     ckc_value_t* c,
                                     void* user)
{
...
ckc_status_t ckc_add_rmsnorm2d_bf16_grid(int m,
                                         const ckc_add_rmsnorm2d_bf16_spec_t* spec,
                                         int out[3])
{
