...
ckc_status_t ckc_layernorm2d_kernel_name(const ckc_layernorm2d_spec_t* spec,
                                         char* out,
                                         size_t out_cap)
{
    char part_n[32];
                                   ...
                                   size_t reason_cap)
{
    ...
    two_pass = ckc_row_norm_needs_two_pass(elems,
...
static ckc_value_t* ln_fadd_combine(ckc_ir_builder_t* b,
                                    ckc_value_t* a,
                                    ckc_value_t* c,
                                    void* user)
{
...
static void ln_pass1_body(ckc_ir_builder_t* b,
                          ckc_value_t* n_off,
...
ckc_kernel_def_t* ckc_build_layernorm2d(ckc_ir_builder_t* b,
...
ckc_status_t ckc_layernorm2d_grid(int m,
                                  const ckc_layernorm2d_spec_t* spec,
                                  int out[3])
{
    int totals[1];
