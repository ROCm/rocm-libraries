                                                  ...
                                                  const char* arch)
{
    return ckc::guard_builder(b, [&]() -> ckc_kernel_def_t* {
        ...
        ckc_b_region_enter(b, loop.body);
        {
            ...
            a_frag = ckc_b_global_load_vN(
                b, A, ckc_b_add(b, a_base, k0), i32, CKC_WMMA_IU8_K_PER_I32, /*align=*/-1);
            /* b_frag = b.global_load_vN(Bp, b.add(b_base, k0), I32, _K_PER_I32) */
            b_frag = ckc_b_global_load_vN(
                b, Bp, ckc_b_add(b, b_base, k0), i32, CKC_WMMA_IU8_K_PER_I32, /*align=*/-1);
