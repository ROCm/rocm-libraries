...
static ckc_value_t*
dfcp_i8_global_to_f16(ckc_ir_builder_t* b, ckc_value_t* code_i8)
{
...
static void
dfcp_stage_tile_strided(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                        ckc_value_t* src_ptr,
...
void
ckc_gfx1151_dfcp_stage_conv0_a(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                               ckc_value_t* x_ptr,
                               ckc_value_t* a_smem)
{
    if (ctx == NULL)
        return;
    dfcp_stage_tile_strided(ctx, x_ptr, a_smem,
                            ctx->spec->tile_m,
...
void
ckc_gfx1151_dfcp_stage_conv0_a_int(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                                   ckc_value_t* x_ptr,
                                   ckc_value_t* a_smem)
{
    if (ctx == NULL)
...
void
ckc_gfx1151_dfcp_stage_conv0_w0(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                                ckc_value_t* w0_ptr,
                                ckc_value_t* w0_smem)
{
    ckc_ir_builder_t* b;
    ...
    /* Scalar fallback path. */
    {
        ...
        for (e = 0; e < ept; e++)
        {
            ...
            ckc_value_t* valid = ckc_b_land(
                b, in_range,
                ckc_b_land(b, ckc_b_cmp_lt(b, n, c_k0), ckc_b_cmp_lt(b, kg, c_kg)));
            ckc_value_t* off = ckc_b_add(b, ckc_b_mul(b, n, c_kg), kg);
            ckc_value_t* safe_off = ckc_b_select(b, valid, off, c0);
            ckc_value_t* raw_i8 = ckc_b_global_load(b, w0_ptr, safe_off, ckc_i8(), 0);
            ckc_value_t* v =
                ckc_b_select(b, valid, ckc_gfx1151_dfcp_i8_to_f32(b, raw_i8), zero_f);
            ckc_value_t* sidx2[2];
            ckc_if_t gate;
            sidx2[0] = n;
            sidx2[1] = kg;
...
void
ckc_gfx1151_dfcp_stage_conv0_w0_int(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                                    ckc_value_t* w0_ptr,
                                    ckc_value_t* w0_smem)
{
    if (ctx == NULL)
        return;
    dfcp_stage_tile_strided(ctx, w0_ptr, w0_smem,
                            ctx->spec->tile_n,
                            ckc_gfx1151_dfcp_kpad(ctx->spec),
                            /*convert_f16=*/false);
}
...
void
ckc_gfx1151_dfcp_stage_input_footprint(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                                       ckc_value_t* x_ptr,
                                       ckc_value_t* inp_smem)
{
    ...
    {
        ckc_value_t* t0 = ckc_b_mul(b, h_blk, ckc_b_const_i32(b, ckc_gfx1151_dfcp_conv_tile_h(ctx->spec)));
        ckc_value_t* t1 = ckc_b_mul(b, t0, ckc_b_const_i32(b, c->sH));
        ih0 = ckc_b_sub(b, t1, ckc_b_const_i32(b, c->pH));
    }
    {
        ckc_value_t* t0 = ckc_b_mul(b, w_blk, ckc_b_const_i32(b, ckc_gfx1151_dfcp_conv_tile_w(ctx->spec)));
    ...
    /* Scalar fallback path. */
    {
        ...
        for (e = 0; e < n_iters; e++)
        {
            ...
            ckc_value_t* off = ckc_b_add(
                b, ckc_b_mul(b, ckc_b_add(b, ckc_b_mul(b, ih, c_Wi), iw), c_cc), ci);
            ckc_value_t* safe_off = ckc_b_select(b, valid, off, c0);
...
void
ckc_gfx1151_dfcp_stage_input_footprint_int(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                                           ckc_value_t* x_ptr,
                                           ckc_value_t* inp_smem,
                                           ckc_value_t* h_blk,
                                           ckc_value_t* w_blk)
{
    ...
    foot_h = ckc_gfx1151_dfcp_foot_h(ctx->spec);
    foot_w = ckc_gfx1151_dfcp_foot_w(ctx->spec);
    dfcp_stage_tile_strided(ctx, x_ptr, inp_smem,
                            foot_h * foot_w,
                            ctx->c->C,
                            /*convert_f16=*/false);
}
...
void
ckc_gfx1151_dfcp_stage_conv1_w1_packed(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                                       ckc_value_t* w1_ptr,
                                       ckc_value_t* w1_smem)
{
    ckc_ir_builder_t* b;
...
void
ckc_gfx1151_dfcp_stage_conv1_w1(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                                ckc_value_t* w1_ptr,
                                ckc_value_t* w1_smem)
{
    ckc_ir_builder_t* b;
...
void
ckc_gfx1151_dfcp_stage_conv1_w1_i8(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                                   ckc_value_t* w1_ptr,
                                   ckc_value_t* w1_smem)
{
    ckc_ir_builder_t* b;
