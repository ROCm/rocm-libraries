 ...
 * _in_warp_row. */
static ckc_value_t* sc_state_row(ckc_gfx942_attn2d_build_ctx_t* ctx, ckc_value_t* lane_rg, int r)
{
...
void ckc_gfx942_attn2d_emit_loop_bounds_and_inits(ckc_gfx942_attn2d_build_ctx_t* ctx)
{
    ...
    if(ctx->USE_SINKS)
    {
        ...
        {
            ckc_value_t* row = ckc_b_add(B, ctx->wave_row_base, sc_state_row(ctx, lane_rg, r));
