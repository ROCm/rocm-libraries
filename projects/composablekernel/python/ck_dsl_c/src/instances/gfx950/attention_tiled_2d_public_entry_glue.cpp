                                          ...
                                          const char* arch)
{
    ...
    if(spec->use_register_pv)
    {
        ...
        {
            ckc_g950_fail(b, CKC_ERR_VALUE, "use_register_pv v1 is restricted to dtype='bf16'");
        }
        if(spec->kv_storage_dtype != NULL)
        {
            ckc_g950_fail(b, CKC_ERR_VALUE, "use_register_pv v1 does not support fp8 K/V cache");
        }
        ...
        {
            ckc_g950_fail(b, CKC_ERR_VALUE, "use_register_pv v1 does not support ALiBi or QQ bias");
        }
    }
