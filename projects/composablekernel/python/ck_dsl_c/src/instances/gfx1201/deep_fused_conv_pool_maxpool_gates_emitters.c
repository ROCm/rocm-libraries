 ...
 *          ckc_dfcp_emit_inline_maxpool_from_cshuffle
 *          ckc_dfcp_emit_wmma_maxpool_from_registers
 *     instance_deep_fused_conv_pool_epilogue_predicates_and_loaders.c
 *       -> ckc_dfcp_apply_epilogue_scalar
 *   and are declared in
 *     ckc/helper_ck_dsl.instances.common.deep_fused_conv_pool.h.
 *
 *   The gfx1201 epilogue driver (ckc_gfx1201_dfcp_epilogue_override) calls those
...
typedef int ckc_gfx1201_dfcp_maxpool_gates_emitters_translation_unit_marker;
