...
static int make_spec(int idx, ckc_img2col_spec_t *spec) {
    *spec = ckc_img2col_spec_default();
    ...
    switch (idx) {
    case 0:
        p.N = 1; p.Hi = 8; p.Wi = 8; p.C = 16; p.K = 16; p.Y = 3; p.X = 3;
        spec->block_tile_m = 4; spec->block_tile_k = 64; spec->vec_k = 1;
        break;
    case 1:
        p.N = 2; p.Hi = 16; p.Wi = 16; p.C = 32; p.K = 32; p.Y = 3; p.X = 3;
        p.pH = 1; p.pW = 1;
        spec->block_tile_m = 8; spec->block_tile_k = 128; spec->vec_k = 4;
        break;
    case 2:
        p.N = 4; p.Hi = 32; p.Wi = 32; p.C = 64; p.K = 64; p.Y = 3; p.X = 3;
        p.pH = 1; p.pW = 1;
        spec->block_tile_m = 16; spec->block_tile_k = 256; spec->vec_k = 8;
        break;
    case 3:
        p.N = 8; p.Hi = 56; p.Wi = 56; p.C = 64; p.K = 64; p.Y = 3; p.X = 3;
        p.pH = 1; p.pW = 1;
        spec->block_tile_m = 8; spec->block_tile_k = 128; spec->vec_k = 8;
        break;
    case 4:
        p.N = 2; p.Hi = 16; p.Wi = 16; p.C = 15; p.K = 32; p.Y = 3; p.X = 3;
        spec->block_tile_m = 8; spec->block_tile_k = 120; spec->vec_k = 8;
        break;
    case 5:
        p.N = 2; p.Hi = 32; p.Wi = 32; p.C = 32; p.K = 32; p.Y = 3; p.X = 3;
