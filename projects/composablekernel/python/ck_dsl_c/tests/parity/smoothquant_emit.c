...
static int make_spec(int idx, ckc_smoothquant_spec_t *s) {
    ...
    case 0: /* N1024 f16->i8 b256 v4 */
        s->n_per_block = 1024; s->dtype = "f16";  s->out_dtype = "i8";
        s->block_size = 256; s->vec = 4;
        break;
    case 1: /* N2048 bf16->i8 b256 v8 */
        s->n_per_block = 2048; s->dtype = "bf16"; s->out_dtype = "i8";
        s->block_size = 256; s->vec = 8;
        break;
    case 2: /* N512 f16->fp8e4m3 b128 v4 */
        s->n_per_block = 512;  s->dtype = "f16";  s->out_dtype = "fp8e4m3";
        s->block_size = 128; s->vec = 4;
        break;
    case 3: /* N1024 bf16->bf8e5m2 b64 v2 */
        s->n_per_block = 1024; s->dtype = "bf16"; s->out_dtype = "bf8e5m2";
        s->block_size = 64;  s->vec = 2;
        break;
    case 4: /* N2048 f16->i8 b512 v4 */
        s->n_per_block = 2048; s->dtype = "f16";  s->out_dtype = "i8";
        s->block_size = 512; s->vec = 4;
        break;
    case 5: /* N256 bf16->fp8e4m3 b256 v2 */
        s->n_per_block = 256;  s->dtype = "bf16"; s->out_dtype = "fp8e4m3";
        s->block_size = 256; s->vec = 2;
        break;
    default:
        return -1;
    }
