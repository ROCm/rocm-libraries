...
static int make_cfg(int idx, ckc_deep_fused_conv_pool_spec_t *spec,
                    const char **arch) {
    switch (idx) {
    case 0:
        *spec = ckc_make_deep_fused_conv_pool_spec(
            ...
            /*warp_m*/2, /*warp_n*/1, /*warp_tile_m*/32, /*warp_tile_n*/32,
            /*warp_tile_k*/16, /*wave_size*/64, /*name*/NULL, /*pipeline*/NULL,
    ...
    case 4:
        *spec = ckc_make_deep_fused_conv_pool_spec(
            ...
            2, 1, 32, 32, 16, 64, NULL, NULL,
            false, false, /*cache_input_footprint*/true, false);
        *arch = "gfx950";
        return 0;
    case 5:
        *spec = ckc_make_deep_fused_conv_pool_spec(
            ...
            2, 1, 32, 32, 16, 64, NULL, NULL,
            false, false, false, /*direct_conv0_from_input_cache*/true);
        *arch = "gfx950";
        return 0;
    case 6:
...
int main(int argc, char **argv) {
    ...
    ckc_kernel_def_t *kernel =
        ckc_build_deep_fused_conv_pool_new(&b, &spec, arch);
    if (kernel == NULL) {
