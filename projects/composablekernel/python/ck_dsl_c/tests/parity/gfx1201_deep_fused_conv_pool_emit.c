...
static int make_cfg(int idx, ckc_gfx1201_deep_fused_conv_pool_spec_t *spec,
                    const char **arch) {
    *arch = "gfx1201";
    switch (idx) {
    case 0:
        *spec = ckc_gfx1201_deep_fused_conv_pool_make_spec(
            /*n*/1, /*h*/64, /*w*/128, /*c*/8, /*k0*/16, /*k1*/16,
    ...
    case 1:
        *spec = ckc_gfx1201_deep_fused_conv_pool_make_spec(
            1, 80, 80, 16, 16, 16, 3, 3, 4, 8, 32, 16, 0,
            2, 1, NULL, false, false, false, false);
        return 0;
    case 2:
        *spec = ckc_gfx1201_deep_fused_conv_pool_make_spec(
            1, 80, 80, 8, 16, 16, 3, 3, 2, 4, 32, 16, 0,
            2, 1, NULL, false, false, false, false);
        return 0;
    case 3:
        *spec = ckc_gfx1201_deep_fused_conv_pool_make_spec(
            1, 96, 96, 8, 16, 16, 3, 3, 4, 8, 32, 16, 0,
            2, 1, NULL, false, false, false, false);
        return 0;
    case 4:
        *spec = ckc_gfx1201_deep_fused_conv_pool_make_spec(
            1, 32, 64, 8, 16, 16, 3, 3, 4, 8, 32, 16, 0,
            2, 1, NULL, false, false, false, false);
        return 0;
    default:
        return -1;
...
int main(int argc, char **argv) {
    ...
    ckc_kernel_def_t *kernel =
        ckc_build_gfx1201_deep_fused_conv_pool_new(&b, &spec, arch);
    if (kernel == NULL) {
