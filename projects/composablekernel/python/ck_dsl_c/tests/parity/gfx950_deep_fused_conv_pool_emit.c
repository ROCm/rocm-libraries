...
static ckc_gfx950_deep_fused_conv_pool_spec_t
mk(int n, int h, int w, int c, int k0, int k1, int r, int s,
   int pool_tile_h, int pool_tile_w, bool cache_input_footprint,
   bool direct_conv0_from_input_cache) {
    ckc_gfx950_deep_fused_conv_pool_spec_t out;
    ckc_deep_fused_conv_pool_spec_t base = ckc_make_deep_fused_conv_pool_spec(
        n, h, w, c, k0, k1, r, s, pool_tile_h, pool_tile_w,
        /*tile_n*/16, /*tile_k*/16, /*conv1_tile_k*/0,
        /*warp_m*/2, /*warp_n*/1,
        /*warp_tile_m*/16, /*warp_tile_n*/16, /*warp_tile_k*/16,
        /*wave_size*/64,
        /*name*/CKC_GFX950_DEEP_FUSED_CONV_POOL_NAME, /*pipeline*/NULL,
