...
static int make_spec(int idx, ckc_sage_attention_spec_t *spec) {
    ...
    *spec = ckc_sage_attention_spec_default();
    ...
    case 0:
        ...
        qs.layout = CKC_QK_SCALE_PER_BLOCK; qs.scale_block = 16;
        qs.stride_batch = 128; qs.stride_head = 8; qs.stride_block = 1;
        ks.layout = CKC_QK_SCALE_PER_BLOCK; ks.scale_block = 64;
        ks.stride_batch = 128; ks.stride_head = 8; ks.stride_block = 1;
        spec->common = common;
        spec->quant_mode = CKC_SAGE_QUANT_FP16_BF16;
        spec->q_scale = qs; spec->k_scale = ks;
        spec->seqlen_q = 16; spec->seqlen_k = 64;
        break;
    case 1:
        shape = ckc_fmha_shape_make(64, 8, 8, 16, 64);
        common = ckc_fmha_common_spec_default(shape);
    ...
    case 2:
        ...
        common.dtype = "f16";
        common.mask_mode = CKC_FMHA_MASK_NONE;
        qs.layout = CKC_QK_SCALE_PER_HEAD; qs.scale_block = 0;
        qs.stride_batch = 8; qs.stride_head = 1; qs.stride_block = 1;
        ks.layout = CKC_QK_SCALE_PER_HEAD; ks.scale_block = 0;
        ks.stride_batch = 8; ks.stride_head = 1; ks.stride_block = 1;
        spec->common = common;
    ...
    case 3:
        ...
        spec->q_scale = qs; spec->k_scale = ks;
        spec->seqlen_q = 32; spec->seqlen_k = 128;
        break;
    case 4:
        ...
        qs.layout = CKC_QK_SCALE_PER_BLOCK; qs.scale_block = 32;
        qs.stride_batch = 256; qs.stride_head = 16; qs.stride_block = 1;
        ks.layout = CKC_QK_SCALE_PER_BLOCK; ks.scale_block = 64;
        ks.stride_batch = 256; ks.stride_head = 16; ks.stride_block = 1;
        spec->common = common;
        spec->quant_mode = CKC_SAGE_QUANT_FP16_BF16;
        spec->q_scale = qs; spec->k_scale = ks;
        spec->seqlen_q = 64; spec->seqlen_k = 64;
        break;
    case 5:
        shape = ckc_fmha_shape_make(128, 8, 8, 16, 64);
        common = ckc_fmha_common_spec_default(shape);
