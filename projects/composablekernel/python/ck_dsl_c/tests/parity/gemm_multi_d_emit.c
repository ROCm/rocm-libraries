...
static int make_base(int idx, ckc_gemm_universal_spec_t *base) {
    *base = ckc_gemm_universal_spec_default();
    ...
    case 0: /* gemmmd1: TileSpec(128,128,64, 2,2), DataSpec(dtype_a='fp16') */
        base->name = "gemmmd1";
        base->tile.tile_m = 128; base->tile.tile_n = 128; base->tile.tile_k = 64;
        base->tile.warp_m = 2;   base->tile.warp_n = 2;
        base->data.dtype_a = "fp16";
        break;
    case 1: /* gemmmd2: TileSpec(64,64,64, 1,2) */
        base->name = "gemmmd2";
        base->tile.tile_m = 64; base->tile.tile_n = 64; base->tile.tile_k = 64;
        base->tile.warp_m = 1;  base->tile.warp_n = 2;
        break;
    case 2: /* gemmmd3: TileSpec(256,128,128, 4,2) */
        base->name = "gemmmd3";
        base->tile.tile_m = 256; base->tile.tile_n = 128; base->tile.tile_k = 128;
        base->tile.warp_m = 4;   base->tile.warp_n = 2;
        break;
    case 3: /* gemmmd4: TileSpec(192,192,64, 2,2) */
        base->name = "gemmmd4";
        base->tile.tile_m = 192; base->tile.tile_n = 192; base->tile.tile_k = 64;
        base->tile.warp_m = 2;   base->tile.warp_n = 2;
        break;
    case 4: /* gemmmd5: TileSpec(128,128,128, 2,2) */
        base->name = "gemmmd5";
        base->tile.tile_m = 128; base->tile.tile_n = 128; base->tile.tile_k = 128;
        base->tile.warp_m = 2;   base->tile.warp_n = 2;
        break;
    case 5: /* gemmmd6: TileSpec(256,256,32, 4,4) */
        base->name = "gemmmd6";
        base->tile.tile_m = 256; base->tile.tile_n = 256; base->tile.tile_k = 32;
        base->tile.warp_m = 4;   base->tile.warp_n = 4;
        break;
    default:
        return -1;
    }
...
static int make_d_ops(int idx, ckc_gemm_multi_d_operand_t *ops,
...
int main(int argc, char **argv) {
    ...
    ckc_gemm_multi_d_spec_t *spec = ckc_gemm_multi_d_spec_new(
        &arena, &base, ops, num_d, "fp16", NULL, load_kind);
    if (spec == NULL) {
