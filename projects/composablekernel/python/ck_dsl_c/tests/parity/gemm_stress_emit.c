...
static int make_spec(int idx, ckc_gemm_universal_spec_t *spec) {
    *spec = ckc_gemm_universal_spec_default();
    ...
    case 0:
        ...
        spec->trait.pipeline = "compv4"; spec->trait.epilogue = "default";
        spec->block_size = 64;
        break;
    case 1:
        spec->name = "s01";
    ...
    case 4:
        ...
        spec->tile = TILE(64, 64, 16, 1, 1, 1, 16, 16, 16);
        spec->trait.pipeline = "compv4"; spec->trait.epilogue = "default";
        spec->data.dtype_a = "bf16"; spec->data.dtype_b = "bf16";
    ...
    case 5:
        ...
        spec->trait.pipeline = "compv4"; spec->trait.epilogue = "cshuffle";
        spec->data.dtype_a = "bf16"; spec->data.dtype_b = "bf16";
        spec->data.dtype_c = "bf16";
        spec->block_size = 256;
        break;
    ...
    case 12:
        ...
        spec->trait.pipeline = "mem"; spec->trait.epilogue = "default";
        spec->block_size = 256;
        break;
    case 13:
        spec->name = "s13";
        spec->tile = TILE(128, 128, 32, 2, 2, 1, 16, 16, 16);
        spec->trait.pipeline = "compv3"; spec->trait.epilogue = "default";
        spec->block_size = 256;
        break;
    case 14:
        spec->name = "s14";
        spec->tile = TILE(128, 128, 32, 2, 2, 1, 16, 16, 16);
        spec->trait.pipeline = "compv3"; spec->trait.epilogue = "cshuffle";
        spec->block_size = 256;
        break;
    case 15:
        spec->name = "s15";
    ...
    case 28:
        ...
        spec->tile = TILE(128, 128, 32, 2, 2, 1, 16, 16, 16);
        spec->trait.pipeline = "compv4"; spec->trait.epilogue = "default";
        spec->trait.pad_m = true; spec->trait.pad_n = true; spec->trait.pad_k = true;
        spec->block_size = 256;
        break;
    case 29:
        spec->name = "s29";
    ...
    case 30:
        spec->name = "s30";
        spec->tile = TILE(128, 128, 32, 2, 2, 1, 16, 16, 16);
        spec->trait.pipeline = "compv4"; spec->trait.scheduler = "interwave";
    ...
    case 34:
        spec->name = "s34";
        spec->tile = TILE(128, 128, 32, 2, 2, 1, 16, 16, 16);
        spec->trait.pipeline = "wsp3"; spec->trait.epilogue = "default";
        spec->block_size = 256;
        break;
    case 35:
        spec->name = "s35";
