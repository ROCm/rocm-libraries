...
inline std::vector<WarpConfig> get_supported_warp_configs(GpuArch arch) {
    switch (arch) {
        ...
        case GpuArch::GFX_942: return {{1, 1, 1}, {1, 2, 1}, {1, 4, 1}, {2, 1, 1}, {2, 1, 2}, {2, 2, 1}, {4, 1, 1}};
        case GpuArch::GFX_950: return {{1, 1, 1}, {1, 2, 1}, {1, 4, 1}, {2, 1, 1}, {2, 1, 2}, {2, 2, 1}, {4, 1, 1}, {8, 2, 1}, {4, 4, 1}};
...
inline std::size_t get_lds_capacity(Pipeline pipeline) {
    ...
    if (pipeline == Pipeline::CompV6) return 32768;
