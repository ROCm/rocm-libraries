...
| C API | `dispatcher/bindings/ctypes/multi_d_gemm_ctypes_lib.cpp` | Multi-D ABI; A/B/C + D device alloc/copy; layout-derived strides; warmup/repeat timing; `dispatcher_get_num_d_tensors`. |
