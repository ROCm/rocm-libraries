...
class TestPhase3Configs:
    ...
    def test_fp8_preshuffleb_name(self):
        ...
        assert cfg.name == (
            "grouped_gemm_bquant_fp8_rcr_preshuffleb_cshuffle_intrawave_"
    ...
    def test_bf8_preshuffleb_name(self):
        ...
        assert cfg.name == (
            "grouped_gemm_bquant_bf8_rcr_preshuffleb_cshuffle_intrawave_"
            "128x128x128_1x4x1_16x16x128_qg1x1x128_preshuffleb"
        )
    ...
    def test_fp8i4_preshuffleb_name(self):
        ...
        assert cfg.name == (
            "grouped_gemm_bquant_fp8i4_rcr_preshuffleb_cshuffle_intrawave_"
    ...
    def test_bf8i4_preshuffleb_name(self):
        ...
        assert cfg.name == (
            "grouped_gemm_bquant_bf8i4_rcr_preshuffleb_cshuffle_intrawave_"
            "128x128x128_1x4x1_16x16x32_qg1x1x128_preshuffleb"
        )
