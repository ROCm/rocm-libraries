.. meta::
   :description: Installation instructions for rocBLAS
   :keywords: lib, rocblas, blas, algorithm, install, sdk, rocm
...
rocBLAS is included with the ROCm Core SDK on Linux and Windows. For the most
...
Alternatively, if you want to install rocBLAS as part of the ROCm
...
This includes rocBLAS, other BLAS libraries, and runtime components.
...
nightly builds for the ROCm Core SDK and its components, including rocBLAS. See
