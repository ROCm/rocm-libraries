...
* Improved the General Batched GEMM performance for the hipBLASLt backend by leveraging the hipBLASLt General Batched GEMM feature introduced in version 1.3.0.
