...
OLD_ROCBLAS_VERSION="5.3.0"
NEW_ROCBLAS_VERSION="5.4.0"

OLD_SO_VERSION="rocblas_SOVERSION 5.3"
NEW_SO_VERSION="rocblas_SOVERSION 5.4"

OLD_HIPBLASLT_VERSION="HIPBLASLT_VERSION 1.2.0"
NEW_HIPBLASLT_VERSION="HIPBLASLT_VERSION 1.2.2"
