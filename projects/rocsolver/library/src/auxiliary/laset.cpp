...
ROCSOLVER_EXPORT rocblas_status rocsolver_slaset(
...
{
    return rocsolver::laset( handle, uplo, m, n, alpha, beta,
                      A, shiftA, lda, strideA, batch_count );
}

ROCSOLVER_EXPORT rocblas_status rocsolver_dlaset(
    rocblas_handle handle,
    char const uplo,
    rocblas_int const m,
    rocblas_int const n,
...
ROCSOLVER_EXPORT rocblas_status rocsolver_claset(
    rocblas_handle handle,
    char const uplo,
    rocblas_int const m,
    rocblas_int const n,
...
ROCSOLVER_EXPORT rocblas_status rocsolver_zlaset(
    rocblas_handle handle,
    char const uplo,
    rocblas_int const m,
    rocblas_int const n,
