 ...
 */
LegacyPerformanceConfig ConvHipDirectFwdLegacyExhaustiveSearch::GetDefaultPerformanceConfig(
...
ConvHipDirectFwdLegacyExhaustiveSearch::Search(const ExecutionContext& ctx,
                                               const ProblemDescription& problem,
...
LegacyPerformanceConfig
ConvHipDirectFwdLegacyExhaustiveSearch::SearchImpl(const ExecutionContext& ctx,
                                                   const ProblemDescription& problem,
                                                   const AnyInvokeParams& invoke_ctx) const
{
    LegacyPerformanceConfig result;
    ...
    if(!is_passed)
        MIOPEN_THROW("Search failed for ConvHipDirectFwdLegacyExhaustiveSearch");
    return result;
}
