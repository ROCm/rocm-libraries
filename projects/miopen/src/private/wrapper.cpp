...
//
// Phase 1 pass-through wrapper for RFC 0001 (MIOpen -> hipDNN forwarding
// wrapper). Each public C entry point in include/miopen/miopen.h has a
// matching extern "C" stub here that forwards to the corresponding _impl
// symbol in MIOpen Private. The Phase 2 routing policy from RFC §4.4
// (hipDNN vs Private) will be applied to a subset of these stubs by hand,
// branching to a per-op translation shim under src/hipdnn_shims/.
//
// HAND-MAINTAINED. This file was bootstrapped one-shot from
// tools/wrapper/gen_wrapper_source.py against include/miopen/miopen.h at
// commit a827879e67 (263 entry points) and the generator was retired —
// see RFC §6 Q4. Add a stub here whenever a new MIOPEN_EXPORT function is
// added to miopen.h; the investigation_q4_stub_count CTest enforces that
// the count here matches the count of MIOPEN_EXPORT declarations in the
// public header.
//
...
extern "C" miopenStatus_t miopenSet4dTensorDescriptor_impl(miopenTensorDescriptor_t tensorDesc, miopenDataType_t dataType, int n, int c, int h, int w);
extern "C" miopenStatus_t miopenSetNdTensorDescriptorWithLayout_impl(miopenTensorDescriptor_t tensorDesc,
...
extern "C" miopenStatus_t miopenCreateSeqTensorDescriptor_impl(miopenSeqTensorDescriptor_t* tensorDesc);
extern "C" miopenStatus_t miopenDestroySeqTensorDescriptor_impl(miopenSeqTensorDescriptor_t tensorDesc);
...
extern "C" miopenStatus_t miopenTransformTensor_impl(miopenHandle_t handle,
                                                   ...
                                                   const miopenTensorDescriptor_t yDesc,
                                                   void* y);
extern "C" miopenStatus_t miopenCreateConvolutionDescriptor_impl(miopenConvolutionDescriptor_t* convDesc);
extern "C" miopenStatus_t miopenInitConvolutionDescriptor_impl(miopenConvolutionDescriptor_t convDesc,
                                                             ...
                                                             int dilation_h,
                                                             int dilation_w);
extern "C" miopenStatus_t miopenInitConvolutionNdDescriptor_impl(miopenConvolutionDescriptor_t convDesc,
                                  int spatialDim,
                                  const int* padA,
                                  const int* strideA,
                                  const int* dilationA,
                                  miopenConvolutionMode_t c_mode);
extern "C" miopenStatus_t miopenGetConvolutionSpatialDim_impl(miopenConvolutionDescriptor_t convDesc,
                                                            int* spatialDim);
extern "C" miopenStatus_t miopenGetConvolutionDescriptor_impl(miopenConvolutionDescriptor_t convDesc,
                                                            miopenConvolutionMode_t* c_mode,
                                                            int* pad_h,
                                                            int* pad_w,
                                                            int* stride_h,
                                                            ...
                                                            int* dilation_h,
                                                            int* dilation_w);
extern "C" miopenStatus_t miopenGetConvolutionNdDescriptor_impl(miopenConvolutionDescriptor_t convDesc,
                                 ...
                                 int* dilationA,
                                 miopenConvolutionMode_t* c_mode);
extern "C" miopenStatus_t miopenGetConvolutionGroupCount_impl(miopenConvolutionDescriptor_t convDesc,
                                                            int* groupCount);
extern "C" miopenStatus_t miopenSetConvolutionGroupCount_impl(miopenConvolutionDescriptor_t convDesc,
                                                            int groupCount);
extern "C" miopenStatus_t miopenSetTransposeConvOutputPadding_impl(miopenConvolutionDescriptor_t convDesc, int adj_h, int adj_w);
extern "C" miopenStatus_t miopenSetTransposeConvNdOutputPadding_impl(miopenConvolutionDescriptor_t convDesc, int spatialDim, const int* adjA);
extern "C" miopenStatus_t miopenGetConvolutionForwardOutputDim_impl(miopenConvolutionDescriptor_t convDesc,
                                     ...
                                     int* h,
                                     int* w);
extern "C" miopenStatus_t miopenGetConvolutionNdForwardOutputDim_impl(miopenConvolutionDescriptor_t convDesc,
                                       const miopenTensorDescriptor_t inputTensorDesc,
                                       const miopenTensorDescriptor_t filterDesc,
                                       int* nDim,
                                       int* outputTensorDimA);
extern "C" miopenStatus_t miopenDestroyConvolutionDescriptor_impl(miopenConvolutionDescriptor_t convDesc);
...
extern "C" miopenStatus_t miopenGetConvolutionFindMode_impl(const miopenConvolutionDescriptor_t convDesc, miopenConvolutionFindMode_t* findMode);
extern "C" miopenStatus_t miopenConvolutionForwardGetSolutionCount_impl(miopenHandle_t handle,
                                         const miopenTensorDescriptor_t wDesc,
                                         const miopenTensorDescriptor_t xDesc,
                                         const miopenConvolutionDescriptor_t convDesc,
                                         const miopenTensorDescriptor_t yDesc,
                                         size_t* solutionCount);
extern "C" miopenStatus_t miopenConvolutionForwardGetSolution_impl(miopenHandle_t handle,
                                    const miopenTensorDescriptor_t wDesc,
                                    const miopenTensorDescriptor_t xDesc,
                                    const miopenConvolutionDescriptor_t convDesc,
                                    const miopenTensorDescriptor_t yDesc,
...
extern "C" miopenStatus_t miopenConvolutionForwardGetSolutionWorkspaceSize_impl(miopenHandle_t handle,
                                                 const miopenTensorDescriptor_t wDesc,
                                                 const miopenTensorDescriptor_t xDesc,
                                                 const miopenConvolutionDescriptor_t convDesc,
                                                 const miopenTensorDescriptor_t yDesc,
...
extern "C" miopenStatus_t miopenConvolutionForwardCompileSolution_impl(miopenHandle_t handle,
                                        const miopenTensorDescriptor_t wDesc,
                                        const miopenTensorDescriptor_t xDesc,
                                        const miopenConvolutionDescriptor_t convDesc,
                                        const miopenTensorDescriptor_t yDesc,
                                        const uint64_t solution_id);
extern "C" miopenStatus_t miopenConvolutionForwardImmediate_impl(miopenHandle_t handle,
                                  const miopenTensorDescriptor_t wDesc,
                                  const void* w,
                                  const miopenTensorDescriptor_t xDesc,
                                  const void* x,
                                  ...
                                  size_t workSpaceSize,
                                  const uint64_t solution_id);
extern "C" miopenStatus_t miopenConvolutionBackwardDataGetSolutionCount_impl(miopenHandle_t handle,
                                              const miopenTensorDescriptor_t dyDesc,
                                              const miopenTensorDescriptor_t wDesc,
                                              const miopenConvolutionDescriptor_t convDesc,
                                              const miopenTensorDescriptor_t dxDesc,
                                              size_t* solutionCount);
extern "C" miopenStatus_t miopenConvolutionBackwardDataGetSolution_impl(miopenHandle_t handle,
                                         const miopenTensorDescriptor_t dyDesc,
                                         const miopenTensorDescriptor_t wDesc,
                                         const miopenConvolutionDescriptor_t convDesc,
                                         const miopenTensorDescriptor_t dxDesc,
                                         ...
                                         size_t* solutionCount,
                                         miopenConvSolution_t* solutions);
extern "C" miopenStatus_t miopenConvolutionBackwardDataGetSolutionWorkspaceSize_impl(miopenHandle_t handle,
                                                      const miopenTensorDescriptor_t dyDesc,
                                                      const miopenTensorDescriptor_t wDesc,
                                                      const miopenConvolutionDescriptor_t convDesc,
                                                      const miopenTensorDescriptor_t dxDesc,
                                                      const uint64_t solution_id,
                                                      size_t* workSpaceSize);
extern "C" miopenStatus_t miopenConvolutionBackwardDataCompileSolution_impl(miopenHandle_t handle,
                                             const miopenTensorDescriptor_t dyDesc,
                                             const miopenTensorDescriptor_t wDesc,
                                             const miopenConvolutionDescriptor_t convDesc,
                                             const miopenTensorDescriptor_t dxDesc,
                                             const uint64_t solution_id);
extern "C" miopenStatus_t miopenConvolutionBackwardDataImmediate_impl(miopenHandle_t handle,
                                       const miopenTensorDescriptor_t dyDesc,
                                       const void* dy,
                                       const miopenTensorDescriptor_t wDesc,
                                       const void* w,
                                       ...
                                       size_t workSpaceSize,
                                       const uint64_t solution_id);
extern "C" miopenStatus_t miopenConvolutionBackwardWeightsGetSolutionCount_impl(miopenHandle_t handle,
                                                 const miopenTensorDescriptor_t dyDesc,
                                                 const miopenTensorDescriptor_t xDesc,
                                                 const miopenConvolutionDescriptor_t convDesc,
                                                 const miopenTensorDescriptor_t dwDesc,
                                                 size_t* solutionCount);
extern "C" miopenStatus_t miopenConvolutionBackwardWeightsGetSolution_impl(miopenHandle_t handle,
                                            const miopenTensorDescriptor_t dyDesc,
                                            const miopenTensorDescriptor_t xDesc,
                                            const miopenConvolutionDescriptor_t convDesc,
                                            const miopenTensorDescriptor_t dwDesc,
                                            ...
                                            size_t* solutionCount,
                                            miopenConvSolution_t* solutions);
extern "C" miopenStatus_t miopenConvolutionBackwardWeightsGetSolutionWorkspaceSize_impl(miopenHandle_t handle,
    const miopenTensorDescriptor_t dyDesc,
    const miopenTensorDescriptor_t xDesc,
    const miopenConvolutionDescriptor_t convDesc,
    const miopenTensorDescriptor_t dwDesc,
    const uint64_t solution_id,
    size_t* workSpaceSize);
extern "C" miopenStatus_t miopenConvolutionBackwardWeightsCompileSolution_impl(miopenHandle_t handle,
                                                const miopenTensorDescriptor_t dyDesc,
                                                const miopenTensorDescriptor_t xDesc,
                                                const miopenConvolutionDescriptor_t convDesc,
                                                const miopenTensorDescriptor_t dwDesc,
                                                const uint64_t solution_id);
extern "C" miopenStatus_t miopenConvolutionBackwardWeightsImmediate_impl(miopenHandle_t handle,
                                          const miopenTensorDescriptor_t dyDesc,
                                          const void* dy,
                                          const miopenTensorDescriptor_t xDesc,
                                          const void* x,
                                          ...
                                          size_t workSpaceSize,
                                          const uint64_t solution_id);
extern "C" miopenStatus_t miopenConvolutionForwardGetWorkSpaceSize_impl(miopenHandle_t handle,
                                         const miopenTensorDescriptor_t wDesc,
                                         const miopenTensorDescriptor_t xDesc,
                                         const miopenConvolutionDescriptor_t convDesc,
                                         const miopenTensorDescriptor_t yDesc,
                                         size_t* workSpaceSize);
extern "C" miopenStatus_t miopenFindConvolutionForwardAlgorithm_impl(miopenHandle_t handle,
                                      const miopenTensorDescriptor_t xDesc,
                                      const void* x,
                                      const miopenTensorDescriptor_t wDesc,
                                      const void* w,
...
extern "C" miopenStatus_t miopenConvolutionForwardBias_impl(miopenHandle_t handle,
                                                          ...
                                                          const miopenTensorDescriptor_t yDesc,
                                                          void* y);
extern "C" miopenStatus_t miopenConvolutionBackwardDataGetWorkSpaceSize_impl(miopenHandle_t handle,
                                              const miopenTensorDescriptor_t dyDesc,
                                              const miopenTensorDescriptor_t wDesc,
                                              const miopenConvolutionDescriptor_t convDesc,
                                              const miopenTensorDescriptor_t dxDesc,
                                              size_t* workSpaceSize);
extern "C" miopenStatus_t miopenFindConvolutionBackwardDataAlgorithm_impl(miopenHandle_t handle,
                                           const miopenTensorDescriptor_t dyDesc,
                                           const void* dy,
                                           const miopenTensorDescriptor_t wDesc,
                                           const void* w,
...
extern "C" miopenStatus_t miopenConvolutionBackwardData_impl(miopenHandle_t handle,
                              ...
                              void* workSpace,
                              size_t workSpaceSize);
extern "C" miopenStatus_t miopenConvolutionBackwardWeightsGetWorkSpaceSize_impl(miopenHandle_t handle,
                                                 const miopenTensorDescriptor_t dyDesc,
                                                 const miopenTensorDescriptor_t xDesc,
                                                 const miopenConvolutionDescriptor_t convDesc,
                                                 const miopenTensorDescriptor_t dwDesc,
                                                 size_t* workSpaceSize);
extern "C" miopenStatus_t miopenFindConvolutionBackwardWeightsAlgorithm_impl(miopenHandle_t handle,
                                              const miopenTensorDescriptor_t dyDesc,
                                              const void* dy,
                                              const miopenTensorDescriptor_t xDesc,
                                              const void* x,
                                              ...
                                              size_t workSpaceSize,
                                              bool exhaustiveSearch);
extern "C" miopenStatus_t miopenConvolutionBackwardWeights_impl(miopenHandle_t handle,
                                 const void* alpha,
                                 const miopenTensorDescriptor_t dyDesc,
                                 const void* dy,
                                 const miopenTensorDescriptor_t xDesc,
...
extern "C" miopenStatus_t miopenGetPoolingIndexType_impl(miopenPoolingDescriptor_t poolDesc,
                                                       miopenIndexType_t* index_type);
extern "C" miopenStatus_t miopenSetPoolingWorkSpaceIndexMode_impl(miopenPoolingDescriptor_t poolDesc, miopenPoolingWorkspaceIndexMode_t workspace_index);
extern "C" miopenStatus_t miopenGetPoolingWorkSpaceIndexMode_impl(miopenPoolingDescriptor_t poolDesc, miopenPoolingWorkspaceIndexMode_t* workspace_index);
extern "C" miopenStatus_t miopenSet2dPoolingDescriptor_impl(miopenPoolingDescriptor_t poolDesc,
                                                          ...
                                                          int stride_h,
                                                          int stride_w);
extern "C" miopenStatus_t miopenGet2dPoolingDescriptor_impl(const miopenPoolingDescriptor_t poolDesc,
                                                          miopenPoolingMode_t* mode,
                                                          int* windowHeight,
                                                          int* windowWidth,
                                                          int* pad_h,
                                                          ...
                                                          int* stride_h,
                                                          int* stride_w);
extern "C" miopenStatus_t miopenGetPoolingForwardOutputDim_impl(const miopenPoolingDescriptor_t poolDesc,
...
extern "C" miopenStatus_t miopenSetNdPoolingDescriptor_impl(miopenPoolingDescriptor_t poolDesc,
                                                          ...
                                                          const int* padA,
                                                          const int* stridesA);
extern "C" miopenStatus_t miopenGetNdPoolingDescriptor_impl(const miopenPoolingDescriptor_t poolDesc,
                                                          int nbDimsRequested,
                                                          miopenPoolingMode_t* mode,
                                                          int* nbDims,
                                                          int* windowDimA,
                                                          int* padA,
                                                          int* stridesA);
extern "C" miopenStatus_t miopenGetPoolingNdForwardOutputDim_impl(const miopenPoolingDescriptor_t poolDesc,
                                   const miopenTensorDescriptor_t tensorDesc,
                                   int dims,
                                   int* tensorDimArr);
extern "C" miopenStatus_t miopenPoolingGetWorkSpaceSize_impl(const miopenTensorDescriptor_t yDesc,
                                                           size_t* workSpaceSize);
extern "C" miopenStatus_t miopenPoolingGetWorkSpaceSizeV2_impl(const miopenPoolingDescriptor_t poolDesc,
                                const miopenTensorDescriptor_t yDesc,
                                size_t* workSpaceSize);
...
extern "C" miopenStatus_t miopenSetLRNDescriptor_impl(const miopenLRNDescriptor_t lrnDesc,
...
extern "C" miopenStatus_t miopenLayerNormForward_impl(miopenHandle_t handle,
                                                    ...
                                                    void* rstd);
extern "C" miopenStatus_t miopenGetLayerNormBackwardWorkspaceSize_impl(miopenHandle_t handle,
                                        miopenNormMode_t mode,
                                        const miopenTensorDescriptor_t dyDesc,
                                        const miopenTensorDescriptor_t xDesc,
                                        const miopenTensorDescriptor_t weightDesc,
...
extern "C" miopenStatus_t miopenCatForward_impl(miopenHandle_t handle,
                                              ...
                                              void* y,
                                              const int32_t dim);
extern "C" miopenStatus_t miopenDeriveBNTensorDescriptor_impl(miopenTensorDescriptor_t derivedBnDesc,
                                                            const miopenTensorDescriptor_t xDesc,
                                                            miopenBatchNormMode_t bn_mode);
extern "C" miopenStatus_t miopenBatchNormalizationForwardTraining_impl(miopenHandle_t handle,
                                        miopenBatchNormMode_t bn_mode,
                                        void* alpha,
                                        void* beta,
                                        const miopenTensorDescriptor_t xDesc,
...
extern "C" miopenStatus_t miopenBatchNormalizationForwardTraining_V2_impl(miopenHandle_t handle,
                                           miopenBatchNormMode_t bn_mode,
                                           void* alpha,
                                           void* beta,
                                           const miopenTensorDescriptor_t xDesc,
                                           ...
                                           void* resultSaveMean,
                                           void* resultSaveInvVariance);
extern "C" miopenStatus_t miopenBatchNormalizationForwardTraining_V3_impl(miopenHandle_t handle,
                                           miopenBatchNormMode_t bn_mode,
                                           void* alpha,
                                           void* beta,
                                           const miopenTensorDescriptor_t xDesc,
                                           ...
                                           void* resultSaveMean,
                                           void* resultSaveInvVariance);
extern "C" miopenStatus_t miopenBatchNormForwardTrainingActivation_impl(miopenHandle_t handle,
                                         miopenBatchNormMode_t bn_mode,
                                         void* alpha,
                                         void* beta,
                                         const miopenTensorDescriptor_t xDesc,
...
extern "C" miopenStatus_t miopenBatchNormForwardTrainingActivation_V2_impl(miopenHandle_t handle,
                                            miopenBatchNormMode_t bn_mode,
                                            void* alpha,
                                            void* beta,
                                            const miopenTensorDescriptor_t xDesc,
                                            ...
                                            void* resultSaveInvVariance,
                                            const miopenActivationDescriptor_t activDesc);
extern "C" miopenStatus_t miopenBatchNormalizationForwardInference_impl(miopenHandle_t handle,
                                         miopenBatchNormMode_t bn_mode,
                                         void* alpha,
                                         void* beta,
                                         const miopenTensorDescriptor_t xDesc,
                                         ...
                                         double epsilon);
extern "C" miopenStatus_t miopenBatchNormalizationForwardInference_V2_impl(miopenHandle_t handle,
                                            miopenBatchNormMode_t bn_mode,
                                            void* alpha,
                                            void* beta,
                                            const miopenTensorDescriptor_t xDesc,
                                            ...
                                            void* estimatedVariance,
                                            double epsilon);
extern "C" miopenStatus_t miopenBatchNormalizationForwardInferenceInvVariance_impl(miopenHandle_t handle,
    miopenBatchNormMode_t bn_mode,
    void* alpha,
    void* beta,
    const miopenTensorDescriptor_t xDesc,
...
extern "C" miopenStatus_t miopenBatchNormForwardInferenceActivationInvVariance_impl(miopenHandle_t handle,
    miopenBatchNormMode_t bn_mode,
    void* alpha,
    void* beta,
    const miopenTensorDescriptor_t xDesc,
    ...
    void* estimatedInvVariance,
    const miopenActivationDescriptor_t activDesc);
extern "C" miopenStatus_t miopenBatchNormForwardInferenceActivation_impl(miopenHandle_t handle,
                                          miopenBatchNormMode_t bn_mode,
                                          void* alpha,
                                          void* beta,
                                          const miopenTensorDescriptor_t xDesc,
                                          ...
                                          double epsilon,
                                          const miopenActivationDescriptor_t activDesc);
extern "C" miopenStatus_t miopenBatchNormalizationBackward_impl(miopenHandle_t handle,
                                 miopenBatchNormMode_t bn_mode,
...
extern "C" miopenStatus_t miopenBatchNormalizationBackward_V2_impl(miopenHandle_t handle,
                                    miopenBatchNormMode_t bn_mode,
                                    const void* alphaDataDiff,
                                    const void* betaDataDiff,
                                    const void* alphaParamDiff,
                                    ...
                                    const void* savedMean,
                                    const void* savedInvVariance);
extern "C" miopenStatus_t miopenBatchNormBackwardActivation_impl(miopenHandle_t handle,
                                  miopenBatchNormMode_t bn_mode,
                                  const void* alphaDataDiff,
                                  const void* betaDataDiff,
                                  const void* alphaParamDiff,
                                  ...
                                  const void* savedInvVariance,
                                  const miopenActivationDescriptor_t activDesc);
extern "C" miopenStatus_t miopenCreateActivationDescriptor_impl(miopenActivationDescriptor_t* activDesc);
extern "C" miopenStatus_t miopenSetActivationDescriptor_impl(const miopenActivationDescriptor_t activDesc,
                              miopenActivationMode_t mode,
                              double activAlpha,
                              double activBeta,
                              double activGamma);
extern "C" miopenStatus_t miopenGetActivationDescriptor_impl(const miopenActivationDescriptor_t activDesc,
                              miopenActivationMode_t* mode,
                              double* activAlpha,
                              double* activBeta,
                              double* activGamma);
...
extern "C" miopenStatus_t miopenActivationBackward_impl(miopenHandle_t handle,
                                                      ...
                                                      const miopenTensorDescriptor_t dxDesc,
                                                      void* dx);
extern "C" miopenStatus_t miopenDestroyActivationDescriptor_impl(miopenActivationDescriptor_t activDesc);
...
extern "C" miopenStatus_t miopenFusionPlanGetWorkSpaceSize_impl(miopenHandle_t handle,
                                 miopenFusionPlanDescriptor_t fusePlanDesc,
                                 size_t* workSpaceSize,
                                 miopenConvFwdAlgorithm_t algo);
extern "C" miopenStatus_t miopenFusionPlanConvolutionGetAlgo_impl(miopenFusionPlanDescriptor_t fusePlanDesc,
                                   const int requestAlgoCount,
                                   int* returnedAlgoCount,
                                   miopenConvFwdAlgorithm_t* returnedAlgos);
extern "C" miopenStatus_t miopenFusionPlanConvolutionSetAlgo_impl(miopenFusionPlanDescriptor_t fusePlanDesc, miopenConvFwdAlgorithm_t algo);
extern "C" miopenStatus_t miopenCreateOpConvForward_impl(miopenFusionPlanDescriptor_t fusePlanDesc,
                                                       miopenFusionOpDescriptor_t* convOp,
                                                       miopenConvolutionDescriptor_t convDesc,
                                                       const miopenTensorDescriptor_t wDesc);
extern "C" miopenStatus_t miopenCreateOpActivationForward_impl(miopenFusionPlanDescriptor_t fusePlanDesc,
                                miopenFusionOpDescriptor_t* activFwdOp,
                                miopenActivationMode_t mode);
extern "C" miopenStatus_t miopenCreateOpActivationBackward_impl(miopenFusionPlanDescriptor_t fusePlanDesc,
...
extern "C" miopenStatus_t miopenCreateOpBiasForward_impl(miopenFusionPlanDescriptor_t fusePlanDesc,
                                                       ...
                                                       const miopenTensorDescriptor_t bDesc);
extern "C" miopenStatus_t miopenCreateOpBatchNormInference_impl(miopenFusionPlanDescriptor_t fusePlanDesc,
                                 miopenFusionOpDescriptor_t* bnOp,
                                 const miopenBatchNormMode_t bn_mode,
                                 const miopenTensorDescriptor_t bnScaleBiasMeanVarDesc);
extern "C" miopenStatus_t miopenCreateOpBatchNormForward_impl(miopenFusionPlanDescriptor_t fusePlanDesc,
                               miopenFusionOpDescriptor_t* bnFwdOp,
                               const miopenBatchNormMode_t bn_mode,
                               bool runningMeanVariance);
extern "C" miopenStatus_t miopenCreateOpBatchNormBackward_impl(miopenFusionPlanDescriptor_t fusePlanDesc,
...
extern "C" miopenStatus_t miopenSetOpArgsBiasForward_impl(miopenOperatorArgs_t args,
                                                        ...
                                                        const void* beta,
                                                        const void* bias);
extern "C" miopenStatus_t miopenExecuteFusionPlan_impl(const miopenHandle_t handle,
...
extern "C" miopenStatus_t miopenExecuteFusionPlan_v2_impl(const miopenHandle_t handle,
                           const miopenFusionPlanDescriptor_t fusePlanDesc,
                           const miopenTensorDescriptor_t inputDesc,
                           const void* input,
                           const miopenTensorDescriptor_t outputDesc,
                           ...
                           void* workspace,
                           size_t workspaceSize);
extern "C" miopenStatus_t miopenConvolutionBiasActivationForward_impl(miopenHandle_t handle,
                                       const void* alpha1,
                                       const miopenTensorDescriptor_t xDesc,
                                       const void* x,
                                       const miopenTensorDescriptor_t wDesc,
...
extern "C" miopenStatus_t miopenSetRNNDescriptor_V2_impl(miopenRNNDescriptor_t rnnDesc,
                                                       ...
                                                       miopenRNNAlgo_t algo,
                                                       miopenDataType_t dataType);
extern "C" miopenStatus_t miopenSetRNNDataSeqTensorDescriptor_impl(miopenSeqTensorDescriptor_t seqTensorDesc,
                                    miopenDataType_t dataType,
                                    ...
                                    void* paddingMarker);
extern "C" miopenStatus_t miopenGetRNNDataSeqTensorDescriptor_impl(miopenSeqTensorDescriptor_t seqTensorDesc,
                                    miopenDataType_t* dataType,
                                    miopenRNNBaseLayout_t* layout,
                                    int* maxSequenceLen,
                                    int* batchSize,
...
extern "C" miopenStatus_t miopenGetRNNWorkspaceSize_impl(miopenHandle_t handle,
                                                       ...
                                                       const miopenTensorDescriptor_t* xDesc,
                                                       size_t* numBytes);
extern "C" miopenStatus_t miopenGetRNNTrainingReserveSize_impl(miopenHandle_t handle,
...
extern "C" miopenStatus_t miopenDropoutGetReserveSpaceSize_impl(const miopenTensorDescriptor_t xDesc,
...
extern "C" miopenStatus_t miopenDropoutBackward_impl(miopenHandle_t handle,
                                                   ...
                                                   void* reserveSpace,
                                                   size_t reserveSpaceSizeInBytes);
extern "C" miopenStatus_t miopenCreateReduceTensorDescriptor_impl(miopenReduceTensorDescriptor_t* reduceTensorDesc);
extern "C" miopenStatus_t miopenDestroyReduceTensorDescriptor_impl(miopenReduceTensorDescriptor_t reduceTensorDesc);
extern "C" miopenStatus_t miopenSetReduceTensorDescriptor_impl(miopenReduceTensorDescriptor_t reduceTensorDesc,
...
extern "C" miopenStatus_t miopenGetReduceTensorDescriptor_impl(const miopenReduceTensorDescriptor_t reduceTensorDesc,
                                miopenReduceTensorOp_t* reduceTensorOp,
                                miopenDataType_t* reduceTensorCompType,
                                miopenNanPropagation_t* reduceTensorNanOpt,
                                miopenReduceTensorIndices_t* reduceTensorIndices,
                                miopenIndicesType_t* reduceTensorIndicesType);
extern "C" miopenStatus_t miopenGetReductionIndicesSize_impl(miopenHandle_t handle,
                              const miopenReduceTensorDescriptor_t reduceTensorDesc,
                              const miopenTensorDescriptor_t aDesc,
                              const miopenTensorDescriptor_t cDesc,
                              size_t* sizeInBytes);
extern "C" miopenStatus_t miopenGetReductionWorkspaceSize_impl(miopenHandle_t handle,
                                const miopenReduceTensorDescriptor_t reduceTensorDesc,
                                const miopenTensorDescriptor_t aDesc,
                                const miopenTensorDescriptor_t cDesc,
                                size_t* sizeInBytes);
...
extern "C" miopenStatus_t miopenSetSoftmaxDescriptor_impl(miopenSoftmaxDescriptor_t softmaxDesc,
                                                        ...
                                                        miopenSoftmaxAlgorithm_t algorithm,
                                                        miopenSoftmaxMode_t mode);
extern "C" miopenStatus_t miopenGetSoftmaxDescriptor_impl(const miopenSoftmaxDescriptor_t softmaxDesc,
                                                        float* alpha,
                                                        float* beta,
                                                        miopenSoftmaxAlgorithm_t* algorithm,
                                                        miopenSoftmaxMode_t* mode);
extern "C" miopenStatus_t miopenDestroyProblem_impl(miopenProblem_t problem);
extern "C" miopenStatus_t miopenSetProblemTensorDescriptor_impl(miopenProblem_t problem,
...
extern "C" miopenStatus_t miopenLoadSolution_impl(miopenSolution_t* solution,
                                                const char* data,
                                                size_t size);
...
extern "C" miopenStatus_t miopenCreateActivationProblem_impl(miopenProblem_t* problem,
...
extern "C" miopenStatus_t miopenCreateBatchnormProblem_impl(miopenProblem_t* problem,
                                                          ...
                                                          bool runningMeanVariance,
                                                          miopenProblemDirection_t direction);
extern "C" miopenStatus_t miopenFuseProblems_impl(miopenProblem_t problem1, miopenProblem_t problem2);
...
extern "C" miopenStatus_t miopenCreateSoftmaxProblem_impl(miopenProblem_t* problem,
                                                        ...
                                                        miopenProblemDirection_t direction);
extern "C" miopenStatus_t miopenGetReduceCalculationWorkspaceSize_impl(miopenHandle_t handle,
                                        const miopenTensorDescriptor_t xDesc,
                                        const int32_t dim,
                                        const miopenReduceCalculationOp_t reduceCalculationOp,
                                        const miopenTensorDescriptor_t reduceDesc,
                                        size_t* sizeInBytes);
extern "C" miopenStatus_t miopenReduceCalculationForward_impl(miopenHandle_t handle,
...
extern "C" miopenStatus_t miopenT5LayerNormForward_impl(miopenHandle_t handle,
                                                      ...
                                                      const miopenTensorDescriptor_t rstdDesc,
                                                      void* rstd);
extern "C" miopenStatus_t miopenGetT5LayerNormBackwardWorkspaceSize_impl(miopenHandle_t handle,
                                          miopenNormMode_t mode,
                                          const miopenTensorDescriptor_t dyDesc,
                                          const miopenTensorDescriptor_t xDesc,
                                          const miopenTensorDescriptor_t weightDesc,
...
extern "C" miopenStatus_t miopenFusedAdam_impl(miopenHandle_t handle,
                                             ...
                                             const void* foundInf);
extern "C" miopenStatus_t miopenFusedAdamWithOutput_impl(miopenHandle_t handle,
...
extern "C" miopenStatus_t miopenTransformersAdamW_impl(miopenHandle_t handle,
                                                     ...
                                                     const miopenTensorDescriptor_t foundInfDesc,
                                                     const void* foundInf);
extern "C" miopenStatus_t miopenTransformersAdamWWithOutput_impl(miopenHandle_t handle,
                                  const miopenTensorDescriptor_t paramInDesc,
                                  void* paramIn,
                                  const miopenTensorDescriptor_t paramOutDesc,
                                  void* paramOut,
                                  ...
                                  const miopenTensorDescriptor_t foundInfDesc,
                                  const void* foundInf);
extern "C" miopenStatus_t miopenGetGetitemWorkspaceSize_impl(miopenHandle_t handle,
                              uint32_t indexCount,
...
extern "C" miopenStatus_t miopenKthvalueForward_impl(miopenHandle_t handle,
                                                   ...
                                                   int32_t dim  = -1,
                                                   bool keepDim = false);
extern "C" miopenStatus_t miopenGetPReLUBackwardWorkspaceSize_impl(miopenHandle_t handle,
                                    miopenTensorDescriptor_t inputDesc,
...
extern "C" miopenStatus_t miopenPReLUBackward_impl(miopenHandle_t handle,
                                                 ...
                                                 void* dweight);
extern "C" miopenStatus_t miopenGetSoftMarginLossForwardWorkspaceSize_impl(miopenHandle_t handle,
                                            miopenTensorDescriptor_t inputDesc,
...
extern "C" miopenStatus_t miopenSoftMarginLossBackward_impl(miopenHandle_t handle,
                                                          ...
                                                          void* dinput,
                                                          miopenLossReductionMode_t reduction);
extern "C" miopenStatus_t miopenGetMultiMarginLossForwardWorkspaceSize_impl(miopenHandle_t handle,
                                             miopenTensorDescriptor_t inputDesc,
                                             miopenTensorDescriptor_t targetDesc,
                                             miopenTensorDescriptor_t weightDesc,
                                             miopenTensorDescriptor_t outputDesc,
...
extern "C" miopenStatus_t miopenGetStream(miopenHandle_t handle,
                                             miopenAcceleratorQueue_t* streamID)
{
...
extern "C" miopenStatus_t miopenSet4dTensorDescriptor(miopenTensorDescriptor_t tensorDesc, miopenDataType_t dataType, int n, int c, int h, int w)
{
...
extern "C" miopenStatus_t miopenSetNdTensorDescriptorWithLayout(miopenTensorDescriptor_t tensorDesc,
                                      ...
                                      int num_lens)
{
    return miopenSetNdTensorDescriptorWithLayout_impl(tensorDesc, dataType, tensorLayout, lens, num_lens);
}
...
extern "C" miopenStatus_t miopenSet4dTensorDescriptorEx(miopenTensorDescriptor_t tensorDesc,
                                                           ...
                                                           int wStride)
{
    return miopenSet4dTensorDescriptorEx_impl(tensorDesc, dataType, n, c, h, w, nStride, cStride, hStride, wStride);
}
...
extern "C" miopenStatus_t miopenGet4dTensorDescriptor(miopenTensorDescriptor_t tensorDesc,
                                                         ...
                                                         int* wStride)
{
    return miopenGet4dTensorDescriptor_impl(tensorDesc, dataType, n, c, h, w, nStride, cStride, hStride, wStride);
}
...
extern "C" miopenStatus_t miopenOpTensor(miopenHandle_t handle,
                                            ...
                                            void* C)
{
    return miopenOpTensor_impl(handle, tensorOp, alpha1, aDesc, A, alpha2, bDesc, B, beta, cDesc, C);
}
...
extern "C" miopenStatus_t miopenInitConvolutionDescriptor(miopenConvolutionDescriptor_t convDesc,
                                                             ...
                                                             int dilation_w)
{
    return miopenInitConvolutionDescriptor_impl(convDesc, c_mode, pad_h, pad_w, stride_h, stride_w, dilation_h, dilation_w);
}
...
extern "C" miopenStatus_t miopenInitConvolutionNdDescriptor(miopenConvolutionDescriptor_t convDesc,
                                  ...
                                  miopenConvolutionMode_t c_mode)
{
    return miopenInitConvolutionNdDescriptor_impl(convDesc, spatialDim, padA, strideA, dilationA, c_mode);
}
...
extern "C" miopenStatus_t miopenGetConvolutionDescriptor(miopenConvolutionDescriptor_t convDesc,
                                                            ...
                                                            int* dilation_w)
{
    return miopenGetConvolutionDescriptor_impl(convDesc, c_mode, pad_h, pad_w, stride_h, stride_w, dilation_h, dilation_w);
}
...
extern "C" miopenStatus_t miopenGetConvolutionNdDescriptor(miopenConvolutionDescriptor_t convDesc,
                                 ...
                                 miopenConvolutionMode_t* c_mode)
{
    return miopenGetConvolutionNdDescriptor_impl(convDesc, requestedSpatialDim, spatialDim, padA, strideA, dilationA, c_mode);
}
...
extern "C" miopenStatus_t miopenSetTransposeConvOutputPadding(miopenConvolutionDescriptor_t convDesc, int adj_h, int adj_w)
{
    return miopenSetTransposeConvOutputPadding_impl(convDesc, adj_h, adj_w);
}

extern "C" miopenStatus_t miopenSetTransposeConvNdOutputPadding(miopenConvolutionDescriptor_t convDesc, int spatialDim, const int* adjA)
{
    return miopenSetTransposeConvNdOutputPadding_impl(convDesc, spatialDim, adjA);
}

extern "C" miopenStatus_t miopenGetConvolutionForwardOutputDim(miopenConvolutionDescriptor_t convDesc,
                                     const miopenTensorDescriptor_t inputTensorDesc,
                                     const miopenTensorDescriptor_t filterDesc,
                                     int* n,
                                     int* c,
                                     ...
                                     int* w)
{
    return miopenGetConvolutionForwardOutputDim_impl(convDesc, inputTensorDesc, filterDesc, n, c, h, w);
}

extern "C" miopenStatus_t miopenGetConvolutionNdForwardOutputDim(miopenConvolutionDescriptor_t convDesc,
                                       const miopenTensorDescriptor_t inputTensorDesc,
                                       const miopenTensorDescriptor_t filterDesc,
                                       int* nDim,
                                       int* outputTensorDimA)
{
    return miopenGetConvolutionNdForwardOutputDim_impl(convDesc, inputTensorDesc, filterDesc, nDim, outputTensorDimA);
}
...
extern "C" miopenStatus_t miopenGetConvolutionFindMode(const miopenConvolutionDescriptor_t convDesc, miopenConvolutionFindMode_t* findMode)
{
    return miopenGetConvolutionFindMode_impl(convDesc, findMode);
}

extern "C" miopenStatus_t miopenConvolutionForwardGetSolutionCount(miopenHandle_t handle,
                                         const miopenTensorDescriptor_t wDesc,
                                         const miopenTensorDescriptor_t xDesc,
                                         const miopenConvolutionDescriptor_t convDesc,
                                         const miopenTensorDescriptor_t yDesc,
                                         size_t* solutionCount)
{
    return miopenConvolutionForwardGetSolutionCount_impl(handle, wDesc, xDesc, convDesc, yDesc, solutionCount);
}

extern "C" miopenStatus_t miopenConvolutionForwardGetSolution(miopenHandle_t handle,
                                    const miopenTensorDescriptor_t wDesc,
                                    const miopenTensorDescriptor_t xDesc,
                                    const miopenConvolutionDescriptor_t convDesc,
                                    const miopenTensorDescriptor_t yDesc,
                                    ...
                                    miopenConvSolution_t* solutions)
{
    return miopenConvolutionForwardGetSolution_impl(handle, wDesc, xDesc, convDesc, yDesc, maxSolutionCount, solutionCount, solutions);
}

extern "C" miopenStatus_t miopenConvolutionForwardGetSolutionWorkspaceSize(miopenHandle_t handle,
                                                 const miopenTensorDescriptor_t wDesc,
                                                 const miopenTensorDescriptor_t xDesc,
                                                 const miopenConvolutionDescriptor_t convDesc,
                                                 const miopenTensorDescriptor_t yDesc,
                                                 ...
                                                 size_t* workSpaceSize)
{
    return miopenConvolutionForwardGetSolutionWorkspaceSize_impl(handle, wDesc, xDesc, convDesc, yDesc, solution_id, workSpaceSize);
}

extern "C" miopenStatus_t miopenConvolutionForwardCompileSolution(miopenHandle_t handle,
                                        const miopenTensorDescriptor_t wDesc,
                                        const miopenTensorDescriptor_t xDesc,
                                        const miopenConvolutionDescriptor_t convDesc,
                                        const miopenTensorDescriptor_t yDesc,
                                        const uint64_t solution_id)
{
    return miopenConvolutionForwardCompileSolution_impl(handle, wDesc, xDesc, convDesc, yDesc, solution_id);
}

extern "C" miopenStatus_t miopenConvolutionForwardImmediate(miopenHandle_t handle,
                                  const miopenTensorDescriptor_t wDesc,
                                  const void* w,
                                  const miopenTensorDescriptor_t xDesc,
                                  const void* x,
                                  ...
                                  const uint64_t solution_id)
{
    return miopenConvolutionForwardImmediate_impl(handle, wDesc, w, xDesc, x, convDesc, yDesc, y, workSpace, workSpaceSize, solution_id);
}

extern "C" miopenStatus_t miopenConvolutionBackwardDataGetSolutionCount(miopenHandle_t handle,
                                              const miopenTensorDescriptor_t dyDesc,
                                              const miopenTensorDescriptor_t wDesc,
                                              const miopenConvolutionDescriptor_t convDesc,
                                              const miopenTensorDescriptor_t dxDesc,
                                              size_t* solutionCount)
{
    return miopenConvolutionBackwardDataGetSolutionCount_impl(handle, dyDesc, wDesc, convDesc, dxDesc, solutionCount);
}

extern "C" miopenStatus_t miopenConvolutionBackwardDataGetSolution(miopenHandle_t handle,
                                         const miopenTensorDescriptor_t dyDesc,
                                         const miopenTensorDescriptor_t wDesc,
                                         const miopenConvolutionDescriptor_t convDesc,
                                         const miopenTensorDescriptor_t dxDesc,
                                         ...
                                         miopenConvSolution_t* solutions)
{
    return miopenConvolutionBackwardDataGetSolution_impl(handle, dyDesc, wDesc, convDesc, dxDesc, maxSolutionCount, solutionCount, solutions);
}

extern "C" miopenStatus_t miopenConvolutionBackwardDataGetSolutionWorkspaceSize(miopenHandle_t handle,
                                                      const miopenTensorDescriptor_t dyDesc,
                                                      const miopenTensorDescriptor_t wDesc,
                                                      const miopenConvolutionDescriptor_t convDesc,
                                                      const miopenTensorDescriptor_t dxDesc,
                                                      ...
                                                      size_t* workSpaceSize)
{
    return miopenConvolutionBackwardDataGetSolutionWorkspaceSize_impl(handle, dyDesc, wDesc, convDesc, dxDesc, solution_id, workSpaceSize);
}

extern "C" miopenStatus_t miopenConvolutionBackwardDataCompileSolution(miopenHandle_t handle,
                                             const miopenTensorDescriptor_t dyDesc,
                                             const miopenTensorDescriptor_t wDesc,
                                             const miopenConvolutionDescriptor_t convDesc,
                                             const miopenTensorDescriptor_t dxDesc,
                                             const uint64_t solution_id)
{
    return miopenConvolutionBackwardDataCompileSolution_impl(handle, dyDesc, wDesc, convDesc, dxDesc, solution_id);
}

extern "C" miopenStatus_t miopenConvolutionBackwardDataImmediate(miopenHandle_t handle,
                                       const miopenTensorDescriptor_t dyDesc,
                                       const void* dy,
                                       const miopenTensorDescriptor_t wDesc,
                                       const void* w,
                                       ...
                                       const uint64_t solution_id)
{
    return miopenConvolutionBackwardDataImmediate_impl(handle, dyDesc, dy, wDesc, w, convDesc, dxDesc, dx, workSpace, workSpaceSize, solution_id);
}

extern "C" miopenStatus_t miopenConvolutionBackwardWeightsGetSolutionCount(miopenHandle_t handle,
                                                 const miopenTensorDescriptor_t dyDesc,
                                                 const miopenTensorDescriptor_t xDesc,
                                                 const miopenConvolutionDescriptor_t convDesc,
                                                 const miopenTensorDescriptor_t dwDesc,
                                                 size_t* solutionCount)
{
    return miopenConvolutionBackwardWeightsGetSolutionCount_impl(handle, dyDesc, xDesc, convDesc, dwDesc, solutionCount);
}

extern "C" miopenStatus_t miopenConvolutionBackwardWeightsGetSolution(miopenHandle_t handle,
                                            const miopenTensorDescriptor_t dyDesc,
                                            const miopenTensorDescriptor_t xDesc,
                                            const miopenConvolutionDescriptor_t convDesc,
                                            const miopenTensorDescriptor_t dwDesc,
                                            ...
                                            miopenConvSolution_t* solutions)
{
    return miopenConvolutionBackwardWeightsGetSolution_impl(handle, dyDesc, xDesc, convDesc, dwDesc, maxSolutionCount, solutionCount, solutions);
}

extern "C" miopenStatus_t miopenConvolutionBackwardWeightsGetSolutionWorkspaceSize(miopenHandle_t handle,
    const miopenTensorDescriptor_t dyDesc,
    const miopenTensorDescriptor_t xDesc,
    const miopenConvolutionDescriptor_t convDesc,
    const miopenTensorDescriptor_t dwDesc,
    ...
    size_t* workSpaceSize)
{
    return miopenConvolutionBackwardWeightsGetSolutionWorkspaceSize_impl(handle, dyDesc, xDesc, convDesc, dwDesc, solution_id, workSpaceSize);
}

extern "C" miopenStatus_t miopenConvolutionBackwardWeightsCompileSolution(miopenHandle_t handle,
                                                const miopenTensorDescriptor_t dyDesc,
                                                const miopenTensorDescriptor_t xDesc,
                                                const miopenConvolutionDescriptor_t convDesc,
                                                const miopenTensorDescriptor_t dwDesc,
                                                const uint64_t solution_id)
{
    return miopenConvolutionBackwardWeightsCompileSolution_impl(handle, dyDesc, xDesc, convDesc, dwDesc, solution_id);
}

extern "C" miopenStatus_t miopenConvolutionBackwardWeightsImmediate(miopenHandle_t handle,
                                          const miopenTensorDescriptor_t dyDesc,
                                          const void* dy,
                                          const miopenTensorDescriptor_t xDesc,
                                          const void* x,
                                          ...
                                          const uint64_t solution_id)
{
    return miopenConvolutionBackwardWeightsImmediate_impl(handle, dyDesc, dy, xDesc, x, convDesc, dwDesc, dw, workSpace, workSpaceSize, solution_id);
}

extern "C" miopenStatus_t miopenConvolutionForwardGetWorkSpaceSize(miopenHandle_t handle,
                                         const miopenTensorDescriptor_t wDesc,
                                         const miopenTensorDescriptor_t xDesc,
                                         const miopenConvolutionDescriptor_t convDesc,
                                         const miopenTensorDescriptor_t yDesc,
                                         size_t* workSpaceSize)
{
    return miopenConvolutionForwardGetWorkSpaceSize_impl(handle, wDesc, xDesc, convDesc, yDesc, workSpaceSize);
}

extern "C" miopenStatus_t miopenFindConvolutionForwardAlgorithm(miopenHandle_t handle,
                                      const miopenTensorDescriptor_t xDesc,
                                      const void* x,
                                      const miopenTensorDescriptor_t wDesc,
                                      const void* w,
                                      ...
                                      bool exhaustiveSearch)
{
    return miopenFindConvolutionForwardAlgorithm_impl(handle, xDesc, x, wDesc, w, convDesc, yDesc, y, requestAlgoCount, returnedAlgoCount, perfResults, workSpace, workSpaceSize, exhaustiveSearch);
}
...
extern "C" miopenStatus_t miopenConvolutionForward(miopenHandle_t handle,
                                                      ...
                                                      size_t workSpaceSize)
{
    return miopenConvolutionForward_impl(handle, alpha, xDesc, x, wDesc, w, convDesc, algo, beta, yDesc, y, workSpace, workSpaceSize);
}
...
extern "C" miopenStatus_t miopenConvolutionBackwardDataGetWorkSpaceSize(miopenHandle_t handle,
                                              const miopenTensorDescriptor_t dyDesc,
                                              const miopenTensorDescriptor_t wDesc,
                                              const miopenConvolutionDescriptor_t convDesc,
                                              const miopenTensorDescriptor_t dxDesc,
                                              size_t* workSpaceSize)
{
    return miopenConvolutionBackwardDataGetWorkSpaceSize_impl(handle, dyDesc, wDesc, convDesc, dxDesc, workSpaceSize);
}

extern "C" miopenStatus_t miopenFindConvolutionBackwardDataAlgorithm(miopenHandle_t handle,
                                           const miopenTensorDescriptor_t dyDesc,
                                           const void* dy,
                                           const miopenTensorDescriptor_t wDesc,
                                           const void* w,
                                           ...
                                           bool exhaustiveSearch)
{
    return miopenFindConvolutionBackwardDataAlgorithm_impl(handle, dyDesc, dy, wDesc, w, convDesc, dxDesc, dx, requestAlgoCount, returnedAlgoCount, perfResults, workSpace, workSpaceSize, exhaustiveSearch);
}

extern "C" miopenStatus_t miopenConvolutionBackwardData(miopenHandle_t handle,
                              const void* alpha,
                              const miopenTensorDescriptor_t dyDesc,
                              const void* dy,
                              const miopenTensorDescriptor_t wDesc,
                              ...
                              size_t workSpaceSize)
{
    return miopenConvolutionBackwardData_impl(handle, alpha, dyDesc, dy, wDesc, w, convDesc, algo, beta, dxDesc, dx, workSpace, workSpaceSize);
}

extern "C" miopenStatus_t miopenConvolutionBackwardWeightsGetWorkSpaceSize(miopenHandle_t handle,
                                                 const miopenTensorDescriptor_t dyDesc,
                                                 const miopenTensorDescriptor_t xDesc,
                                                 const miopenConvolutionDescriptor_t convDesc,
                                                 const miopenTensorDescriptor_t dwDesc,
                                                 size_t* workSpaceSize)
{
    return miopenConvolutionBackwardWeightsGetWorkSpaceSize_impl(handle, dyDesc, xDesc, convDesc, dwDesc, workSpaceSize);
}

extern "C" miopenStatus_t miopenFindConvolutionBackwardWeightsAlgorithm(miopenHandle_t handle,
                                              const miopenTensorDescriptor_t dyDesc,
                                              const void* dy,
                                              const miopenTensorDescriptor_t xDesc,
                                              const void* x,
                                              ...
                                              bool exhaustiveSearch)
{
    return miopenFindConvolutionBackwardWeightsAlgorithm_impl(handle, dyDesc, dy, xDesc, x, convDesc, dwDesc, dw, requestAlgoCount, returnedAlgoCount, perfResults, workSpace, workSpaceSize, exhaustiveSearch);
}

extern "C" miopenStatus_t miopenConvolutionBackwardWeights(miopenHandle_t handle,
                                 const void* alpha,
                                 const miopenTensorDescriptor_t dyDesc,
                                 const void* dy,
                                 const miopenTensorDescriptor_t xDesc,
                                 ...
                                 size_t workSpaceSize)
{
    return miopenConvolutionBackwardWeights_impl(handle, alpha, dyDesc, dy, xDesc, x, convDesc, algo, beta, dwDesc, dw, workSpace, workSpaceSize);
}
...
extern "C" miopenStatus_t miopenSetPoolingWorkSpaceIndexMode(miopenPoolingDescriptor_t poolDesc, miopenPoolingWorkspaceIndexMode_t workspace_index)
{
    return miopenSetPoolingWorkSpaceIndexMode_impl(poolDesc, workspace_index);
}

extern "C" miopenStatus_t miopenGetPoolingWorkSpaceIndexMode(miopenPoolingDescriptor_t poolDesc, miopenPoolingWorkspaceIndexMode_t* workspace_index)
{
...
extern "C" miopenStatus_t miopenSet2dPoolingDescriptor(miopenPoolingDescriptor_t poolDesc,
                                                          ...
                                                          int stride_w)
{
    return miopenSet2dPoolingDescriptor_impl(poolDesc, mode, windowHeight, windowWidth, pad_h, pad_w, stride_h, stride_w);
}
...
extern "C" miopenStatus_t miopenGet2dPoolingDescriptor(const miopenPoolingDescriptor_t poolDesc,
                                                          ...
                                                          int* stride_w)
{
    return miopenGet2dPoolingDescriptor_impl(poolDesc, mode, windowHeight, windowWidth, pad_h, pad_w, stride_h, stride_w);
}

extern "C" miopenStatus_t miopenGetPoolingForwardOutputDim(const miopenPoolingDescriptor_t poolDesc,
                                 const miopenTensorDescriptor_t tensorDesc,
                                 int* n,
                                 int* c,
                                 int* h,
...
extern "C" miopenStatus_t miopenGetNdPoolingDescriptor(const miopenPoolingDescriptor_t poolDesc,
                                                          ...
                                                          int* stridesA)
{
    return miopenGetNdPoolingDescriptor_impl(poolDesc, nbDimsRequested, mode, nbDims, windowDimA, padA, stridesA);
}

extern "C" miopenStatus_t miopenGetPoolingNdForwardOutputDim(const miopenPoolingDescriptor_t poolDesc,
                                   const miopenTensorDescriptor_t tensorDesc,
                                   int dims,
                                   int* tensorDimArr)
{
...
extern "C" miopenStatus_t miopenPoolingForward(miopenHandle_t handle,
                                                  ...
                                                  size_t workSpaceSize)
{
    return miopenPoolingForward_impl(handle, poolDesc, alpha, xDesc, x, beta, yDesc, y, do_backward, workSpace, workSpaceSize);
}
...
extern "C" miopenStatus_t miopenPoolingBackward(miopenHandle_t handle,
                                                   ...
                                                   void* workSpace)
{
    return miopenPoolingBackward_impl(handle, poolDesc, alpha, yDesc, y, dyDesc, dy, xDesc, x, beta, dxDesc, dx, workSpace);
}
...
extern "C" miopenStatus_t miopenLRNForward(miopenHandle_t handle,
                                              ...
                                              void* workSpace)
{
    return miopenLRNForward_impl(handle, lrnDesc, alpha, xDesc, x, beta, yDesc, y, do_backward, workSpace);
}
...
extern "C" miopenStatus_t miopenLRNBackward(miopenHandle_t handle,
                                               ...
                                               const void* workSpace)
{
    return miopenLRNBackward_impl(handle, lrnDesc, alpha, yDesc, y, dyDesc, dy, xDesc, x, beta, dxDesc, dx, workSpace);
}
...
extern "C" miopenStatus_t miopenLayerNormForward(miopenHandle_t handle,
                                                    ...
                                                    void* rstd)
{
    return miopenLayerNormForward_impl(handle, mode, xDesc, x, weightDesc, weight, biasDesc, bias, epsilon, normalized_dim, yDesc, y, meanDesc, mean, rstdDesc, rstd);
}

extern "C" miopenStatus_t miopenGetLayerNormBackwardWorkspaceSize(miopenHandle_t handle,
                                        miopenNormMode_t mode,
                                        const miopenTensorDescriptor_t dyDesc,
                                        const miopenTensorDescriptor_t xDesc,
                                        const miopenTensorDescriptor_t weightDesc,
                                        ...
                                        size_t* sizeInBytes)
{
    return miopenGetLayerNormBackwardWorkspaceSize_impl(handle, mode, dyDesc, xDesc, weightDesc, meanDesc, rstdDesc, normalized_dim, dxDesc, dwDesc, dbDesc, sizeInBytes);
}
...
extern "C" miopenStatus_t miopenLayerNormBackward(miopenHandle_t handle,
                                                     ...
                                                     void* db)
{
    return miopenLayerNormBackward_impl(handle, mode, workspace, workspaceSizeInBytes, dyDesc, dy, xDesc, x, weightDesc, weight, meanDesc, mean, rstdDesc, rstd, normalized_dim, dxDesc, dx, dwDesc, dw, dbDesc, db);
}
...
extern "C" miopenStatus_t miopenBatchNormalizationForwardTraining(miopenHandle_t handle,
                                        miopenBatchNormMode_t bn_mode,
                                        void* alpha,
                                        void* beta,
                                        const miopenTensorDescriptor_t xDesc,
                                        ...
                                        void* resultSaveInvVariance)
{
    return miopenBatchNormalizationForwardTraining_impl(handle, bn_mode, alpha, beta, xDesc, x, yDesc, y, bnScaleBiasMeanVarDesc, bnScale, bnBias, expAvgFactor, resultRunningMean, resultRunningVariance, epsilon, resultSaveMean, resultSaveInvVariance);
}

extern "C" miopenStatus_t miopenBatchNormalizationForwardTraining_V2(miopenHandle_t handle,
                                           miopenBatchNormMode_t bn_mode,
                                           void* alpha,
                                           void* beta,
                                           const miopenTensorDescriptor_t xDesc,
                                           ...
                                           void* resultSaveInvVariance)
{
    return miopenBatchNormalizationForwardTraining_V2_impl(handle, bn_mode, alpha, beta, xDesc, x, yDesc, y, scaleDesc, biasVarDesc, savedMeanDesc, savedVarDesc, bnScale, bnBias, expAvgFactor, resultRunningMean, resultRunningVariance, epsilon, resultSaveMean, resultSaveInvVariance);
}

extern "C" miopenStatus_t miopenBatchNormalizationForwardTraining_V3(miopenHandle_t handle,
                                           miopenBatchNormMode_t bn_mode,
                                           void* alpha,
                                           void* beta,
                                           const miopenTensorDescriptor_t xDesc,
                                           ...
                                           void* resultSaveInvVariance)
{
    return miopenBatchNormalizationForwardTraining_V3_impl(handle, bn_mode, alpha, beta, xDesc, x, yDesc, y, scaleDesc, biasVarDesc, savedMeanDesc, savedVarDesc, bnScale, bnBias, expAvgFactor, prevResultRunningMean, prevResultRunningVariance, nextResultRunningMean, nextResultRunningVariance, epsilon, resultSaveMean, resultSaveInvVariance);
}

extern "C" miopenStatus_t miopenBatchNormForwardTrainingActivation(miopenHandle_t handle,
                                         miopenBatchNormMode_t bn_mode,
                                         void* alpha,
                                         void* beta,
                                         const miopenTensorDescriptor_t xDesc,
                                         ...
                                         const miopenActivationDescriptor_t activDesc)
{
    return miopenBatchNormForwardTrainingActivation_impl(handle, bn_mode, alpha, beta, xDesc, x, yDesc, y, scaleDesc, biasVarDesc, savedMeanDesc, savedVarDesc, bnScale, bnBias, expAvgFactor, resultRunningMean, resultRunningVariance, epsilon, resultSaveMean, resultSaveInvVariance, activDesc);
}

extern "C" miopenStatus_t miopenBatchNormForwardTrainingActivation_V2(miopenHandle_t handle,
                                            miopenBatchNormMode_t bn_mode,
                                            void* alpha,
                                            void* beta,
                                            const miopenTensorDescriptor_t xDesc,
                                            ...
                                            const miopenActivationDescriptor_t activDesc)
{
    return miopenBatchNormForwardTrainingActivation_V2_impl(handle, bn_mode, alpha, beta, xDesc, x, yDesc, y, scaleDesc, biasVarDesc, savedMeanDesc, savedVarDesc, bnScale, bnBias, expAvgFactor, prevResultRunningMean, prevResultRunningVariance, nextResultRunningMean, nextResultRunningVariance, epsilon, resultSaveMean, resultSaveInvVariance, activDesc);
}

extern "C" miopenStatus_t miopenBatchNormalizationForwardInference(miopenHandle_t handle,
                                         miopenBatchNormMode_t bn_mode,
                                         void* alpha,
                                         void* beta,
                                         const miopenTensorDescriptor_t xDesc,
                                         ...
                                         double epsilon)
{
    return miopenBatchNormalizationForwardInference_impl(handle, bn_mode, alpha, beta, xDesc, x, yDesc, y, bnScaleBiasMeanVarDesc, bnScale, bnBias, estimatedMean, estimatedVariance, epsilon);
}

extern "C" miopenStatus_t miopenBatchNormalizationForwardInference_V2(miopenHandle_t handle,
                                            miopenBatchNormMode_t bn_mode,
                                            void* alpha,
                                            void* beta,
                                            const miopenTensorDescriptor_t xDesc,
                                            ...
                                            double epsilon)
{
    return miopenBatchNormalizationForwardInference_V2_impl(handle, bn_mode, alpha, beta, xDesc, x, yDesc, y, scaleDesc, biasDesc, estMeanDesc, estVarianceDesc, bnScale, bnBias, estimatedMean, estimatedVariance, epsilon);
}

extern "C" miopenStatus_t miopenBatchNormalizationForwardInferenceInvVariance(miopenHandle_t handle,
    miopenBatchNormMode_t bn_mode,
    void* alpha,
    void* beta,
    const miopenTensorDescriptor_t xDesc,
    ...
    void* estimatedInvVariance)
{
    return miopenBatchNormalizationForwardInferenceInvVariance_impl(handle, bn_mode, alpha, beta, xDesc, x, yDesc, y, scaleDesc, biasDesc, estMeanDesc, estInvVarianceDesc, bnScale, bnBias, estimatedMean, estimatedInvVariance);
}

extern "C" miopenStatus_t miopenBatchNormForwardInferenceActivationInvVariance(miopenHandle_t handle,
    miopenBatchNormMode_t bn_mode,
    void* alpha,
    void* beta,
    const miopenTensorDescriptor_t xDesc,
    ...
    const miopenActivationDescriptor_t activDesc)
{
    return miopenBatchNormForwardInferenceActivationInvVariance_impl(handle, bn_mode, alpha, beta, xDesc, x, yDesc, y, scaleDesc, biasDesc, estMeanDesc, estInvVarianceDesc, bnScale, bnBias, estimatedMean, estimatedInvVariance, activDesc);
}

extern "C" miopenStatus_t miopenBatchNormForwardInferenceActivation(miopenHandle_t handle,
                                          miopenBatchNormMode_t bn_mode,
                                          void* alpha,
                                          void* beta,
                                          const miopenTensorDescriptor_t xDesc,
                                          ...
                                          const miopenActivationDescriptor_t activDesc)
{
    return miopenBatchNormForwardInferenceActivation_impl(handle, bn_mode, alpha, beta, xDesc, x, yDesc, y, scaleDesc, biasDesc, estMeanDesc, estVarianceDesc, bnScale, bnBias, estimatedMean, estimatedVariance, epsilon, activDesc);
}

extern "C" miopenStatus_t miopenBatchNormalizationBackward(miopenHandle_t handle,
                                 miopenBatchNormMode_t bn_mode,
                                 const void* alphaDataDiff,
                                 const void* betaDataDiff,
                                 const void* alphaParamDiff,
                                 ...
                                 const void* savedInvVariance)
{
    return miopenBatchNormalizationBackward_impl(handle, bn_mode, alphaDataDiff, betaDataDiff, alphaParamDiff, betaParamDiff, xDesc, x, dyDesc, dy, dxDesc, dx, bnScaleBiasDiffDesc, bnScale, resultBnScaleDiff, resultBnBiasDiff, epsilon, savedMean, savedInvVariance);
}

extern "C" miopenStatus_t miopenBatchNormalizationBackward_V2(miopenHandle_t handle,
                                    miopenBatchNormMode_t bn_mode,
                                    const void* alphaDataDiff,
                                    const void* betaDataDiff,
                                    const void* alphaParamDiff,
                                    ...
                                    const void* savedInvVariance)
{
    return miopenBatchNormalizationBackward_V2_impl(handle, bn_mode, alphaDataDiff, betaDataDiff, alphaParamDiff, betaParamDiff, xDesc, x, dyDesc, dy, dxDesc, dx, scaleDesc, biasDesc, savedMeanDesc, savedVarDesc, bnScale, resultBnScaleDiff, resultBnBiasDiff, epsilon, savedMean, savedInvVariance);
}

extern "C" miopenStatus_t miopenBatchNormBackwardActivation(miopenHandle_t handle,
                                  miopenBatchNormMode_t bn_mode,
                                  const void* alphaDataDiff,
                                  const void* betaDataDiff,
                                  const void* alphaParamDiff,
                                  ...
                                  const miopenActivationDescriptor_t activDesc)
{
    return miopenBatchNormBackwardActivation_impl(handle, bn_mode, alphaDataDiff, betaDataDiff, alphaParamDiff, betaParamDiff, xDesc, x, dyDesc, dy, dxDesc, dx, scaleDesc, biasDesc, savedMeanDesc, savedVarianceDesc, bnScale, bnBias, resultBnScaleDiff, resultBnBiasDiff, epsilon, savedMean, savedInvVariance, activDesc);
}
...
extern "C" miopenStatus_t miopenSetActivationDescriptor(const miopenActivationDescriptor_t activDesc,
                              miopenActivationMode_t mode,
                              double activAlpha,
                              double activBeta,
                              double activGamma)
...
extern "C" miopenStatus_t miopenGetActivationDescriptor(const miopenActivationDescriptor_t activDesc,
                              miopenActivationMode_t* mode,
                              double* activAlpha,
                              double* activBeta,
                              double* activGamma)
...
extern "C" miopenStatus_t miopenActivationBackward(miopenHandle_t handle,
                                                      ...
                                                      void* dx)
{
    return miopenActivationBackward_impl(handle, activDesc, alpha, yDesc, y, dyDesc, dy, xDesc, x, beta, dxDesc, dx);
}
...
extern "C" miopenStatus_t miopenGLUBackward(miopenHandle_t handle,
                                               ...
                                               const uint32_t dim)
{
    return miopenGLUBackward_impl(handle, inputDesc, input, outputGradDesc, outputGrad, inputGradDesc, inputGrad, dim);
}
...
extern "C" miopenStatus_t miopenSoftmaxBackward_V2(miopenHandle_t handle,
                                                      ...
                                                      miopenSoftmaxMode_t mode)
{
    return miopenSoftmaxBackward_V2_impl(handle, alpha, yDesc, y, dyDesc, dy, beta, dxDesc, dx, algorithm, mode);
}
...
extern "C" miopenStatus_t miopenFusionPlanGetWorkSpaceSize(miopenHandle_t handle,
                                 miopenFusionPlanDescriptor_t fusePlanDesc,
                                 size_t* workSpaceSize,
                                 miopenConvFwdAlgorithm_t algo)
{
...
extern "C" miopenStatus_t miopenFusionPlanConvolutionGetAlgo(miopenFusionPlanDescriptor_t fusePlanDesc,
                                   const int requestAlgoCount,
                                   int* returnedAlgoCount,
                                   miopenConvFwdAlgorithm_t* returnedAlgos)
{
    return miopenFusionPlanConvolutionGetAlgo_impl(fusePlanDesc, requestAlgoCount, returnedAlgoCount, returnedAlgos);
}

extern "C" miopenStatus_t miopenFusionPlanConvolutionSetAlgo(miopenFusionPlanDescriptor_t fusePlanDesc, miopenConvFwdAlgorithm_t algo)
{
...
extern "C" miopenStatus_t miopenCreateOpActivationBackward(miopenFusionPlanDescriptor_t fusePlanDesc,
                                 miopenFusionOpDescriptor_t* activBwdOp,
                                 miopenActivationMode_t mode)
{
...
extern "C" miopenStatus_t miopenCreateOpBatchNormInference(miopenFusionPlanDescriptor_t fusePlanDesc,
                                 miopenFusionOpDescriptor_t* bnOp,
                                 const miopenBatchNormMode_t bn_mode,
                                 const miopenTensorDescriptor_t bnScaleBiasMeanVarDesc)
{
    return miopenCreateOpBatchNormInference_impl(fusePlanDesc, bnOp, bn_mode, bnScaleBiasMeanVarDesc);
}
...
extern "C" miopenStatus_t miopenSetOpArgsActivForward(miopenOperatorArgs_t args,
                            ...
                            double activGamma)
{
    return miopenSetOpArgsActivForward_impl(args, activFwdOp, alpha, beta, activAlpha, activBeta, activGamma);
}
...
extern "C" miopenStatus_t miopenSetOpArgsActivBackward(miopenOperatorArgs_t args,
                             ...
                             double activGamma)
{
    return miopenSetOpArgsActivBackward_impl(args, activBwdOp, alpha, beta, y, reserved, activAlpha, activBeta, activGamma);
}
...
extern "C" miopenStatus_t miopenSetOpArgsBatchNormInference(miopenOperatorArgs_t args,
                                  ...
                                  double epsilon)
{
    return miopenSetOpArgsBatchNormInference_impl(args, bnOp, alpha, beta, bnScale, bnBias, estimatedMean, estimatedVariance, epsilon);
}
...
extern "C" miopenStatus_t miopenSetOpArgsBatchNormForward(miopenOperatorArgs_t args,
                                                             ...
                                                             double epsilon)
{
    return miopenSetOpArgsBatchNormForward_impl(args, bnOp, alpha, beta, bnScale, bnBias, savedMean, savedInvVariance, runningMean, runningVariance, expAvgFactor, epsilon);
}
...
extern "C" miopenStatus_t miopenSetOpArgsBatchNormBackward(miopenOperatorArgs_t args,
                                                              ...
                                                              const void* savedInvVariance)
{
    return miopenSetOpArgsBatchNormBackward_impl(args, bnOp, alpha, beta, x, bnScale, bnBias, resultBnScaleDiff, resultBnBiasDiff, savedMean, savedInvVariance);
}
...
extern "C" miopenStatus_t miopenExecuteFusionPlan(const miopenHandle_t handle,
                        ...
                        miopenOperatorArgs_t args)
{
    return miopenExecuteFusionPlan_impl(handle, fusePlanDesc, inputDesc, input, outputDesc, output, args);
}

extern "C" miopenStatus_t miopenExecuteFusionPlan_v2(const miopenHandle_t handle,
                           const miopenFusionPlanDescriptor_t fusePlanDesc,
                           const miopenTensorDescriptor_t inputDesc,
                           const void* input,
                           const miopenTensorDescriptor_t outputDesc,
                           ...
                           size_t workspaceSize)
{
    return miopenExecuteFusionPlan_v2_impl(handle, fusePlanDesc, inputDesc, input, outputDesc, output, args, workspace, workspaceSize);
}

extern "C" miopenStatus_t miopenConvolutionBiasActivationForward(miopenHandle_t handle,
                                       const void* alpha1,
                                       const miopenTensorDescriptor_t xDesc,
                                       const void* x,
                                       const miopenTensorDescriptor_t wDesc,
                                       ...
                                       void* y)
{
    return miopenConvolutionBiasActivationForward_impl(handle, alpha1, xDesc, x, wDesc, w, convDesc, algo, workspace, workspaceSizeInBytes, alpha2, zDesc, z, biasDesc, bias, activationDesc, yDesc, y);
}
...
extern "C" miopenStatus_t miopenGetRNNDescriptor(miopenRNNDescriptor_t rnnDesc,
                                                    ...
                                                    int* layer)
{
    return miopenGetRNNDescriptor_impl(rnnDesc, rnnMode, algoMode, inputMode, dirMode, biasMode, hiddenSize, layer);
}
...
extern "C" miopenStatus_t miopenGetRNNDescriptor_V2(miopenRNNDescriptor_t rnnDesc,
                                                       ...
                                                       miopenDataType_t* dataType)
{
    return miopenGetRNNDescriptor_V2_impl(rnnDesc, hiddenSize, layer, dropoutDesc, inputMode, dirMode, rnnMode, biasMode, algoMode, dataType);
}
...
extern "C" miopenStatus_t miopenSetRNNDescriptor(miopenRNNDescriptor_t rnnDesc,
                                                    ...
                                                    miopenDataType_t dataType)
{
    return miopenSetRNNDescriptor_impl(rnnDesc, hsize, nlayers, inMode, direction, rnnMode, biasMode, algo, dataType);
}
...
extern "C" miopenStatus_t miopenSetRNNDescriptor_V2(miopenRNNDescriptor_t rnnDesc,
                                                       ...
                                                       miopenDataType_t dataType)
{
    return miopenSetRNNDescriptor_V2_impl(rnnDesc, hsize, nlayers, dropoutDesc, inMode, direction, rnnMode, biasMode, algo, dataType);
}

extern "C" miopenStatus_t miopenSetRNNDataSeqTensorDescriptor(miopenSeqTensorDescriptor_t seqTensorDesc,
                                    miopenDataType_t dataType,
                                    miopenRNNBaseLayout_t layout,
                                    int maxSequenceLen,
                                    int batchSize,
                                    ...
                                    void* paddingMarker)
{
    return miopenSetRNNDataSeqTensorDescriptor_impl(seqTensorDesc, dataType, layout, maxSequenceLen, batchSize, vectorSize, sequenceLenArray, paddingMarker);
}

extern "C" miopenStatus_t miopenGetRNNDataSeqTensorDescriptor(miopenSeqTensorDescriptor_t seqTensorDesc,
                                    miopenDataType_t* dataType,
                                    miopenRNNBaseLayout_t* layout,
                                    int* maxSequenceLen,
                                    int* batchSize,
                                    ...
                                    void* paddingMarker)
{
    return miopenGetRNNDataSeqTensorDescriptor_impl(seqTensorDesc, dataType, layout, maxSequenceLen, batchSize, vectorSize, sequenceLenArrayLimit, sequenceLenArray, paddingMarker);
}
...
extern "C" miopenStatus_t miopenGetRNNTempSpaceSizes(miopenHandle_t handle,
                                                        ...
                                                        size_t* reserveSpaceSize)
{
    return miopenGetRNNTempSpaceSizes_impl(handle, rnnDesc, xDesc, fwdMode, workSpaceSize, reserveSpaceSize);
}
...
extern "C" miopenStatus_t miopenGetRNNLayerParam(miopenHandle_t handle,
                                                    ...
                                                    void* layerParam)
{
    return miopenGetRNNLayerParam_impl(handle, rnnDesc, layer, xDesc, wDesc, w, paramID, paramDesc, layerParam);
}
...
extern "C" miopenStatus_t miopenGetRNNLayerBias(miopenHandle_t handle,
                                                   ...
                                                   void* layerBias)
{
    return miopenGetRNNLayerBias_impl(handle, rnnDesc, layer, xDesc, wDesc, w, biasID, biasDesc, layerBias);
}
...
extern "C" miopenStatus_t miopenGetRNNLayerParamOffset(miopenRNNDescriptor_t rnnDesc,
                                                          ...
                                                          size_t* layerParamOffset)
{
    return miopenGetRNNLayerParamOffset_impl(rnnDesc, layer, xDesc, paramID, paramDesc, layerParamOffset);
}
...
extern "C" miopenStatus_t miopenGetRNNLayerBiasOffset(miopenRNNDescriptor_t rnnDesc,
                                                         ...
                                                         size_t* layerBiasOffset)
{
    return miopenGetRNNLayerBiasOffset_impl(rnnDesc, layer, xDesc, biasID, biasDesc, layerBiasOffset);
}
...
extern "C" miopenStatus_t miopenSetRNNLayerParam(miopenHandle_t handle,
                                                    ...
                                                    const void* layerParam)
{
    return miopenSetRNNLayerParam_impl(handle, rnnDesc, layer, xDesc, wDesc, w, paramID, paramDesc, layerParam);
}
...
extern "C" miopenStatus_t miopenSetRNNLayerBias(miopenHandle_t handle,
                                                   ...
                                                   const void* layerBias)
{
    return miopenSetRNNLayerBias_impl(handle, rnnDesc, layer, xDesc, wDesc, w, biasID, biasDesc, layerBias);
}
...
extern "C" miopenStatus_t miopenRNNForward(miopenHandle_t handle,
                                              ...
                                              size_t reserveSpaceNumBytes)
{
    return miopenRNNForward_impl(handle, rnnDesc, fwdMode, xDesc, x, hDesc, hx, hy, cDesc, cx, cy, yDesc, y, w, weightSpaceSize, workSpace, workSpaceNumBytes, reserveSpace, reserveSpaceNumBytes);
}
...
extern "C" miopenStatus_t miopenRNNBackwardSeqData(miopenHandle_t handle,
                                                      ...
                                                      size_t reserveSpaceNumBytes)
{
    return miopenRNNBackwardSeqData_impl(handle, rnnDesc, yDesc, y, dy, hDesc, hx, dhy, dhx, cDesc, cx, dcy, dcx, xDesc, dx, w, weightSpaceSize, workSpace, workSpaceNumBytes, reserveSpace, reserveSpaceNumBytes);
}
...
extern "C" miopenStatus_t miopenRNNBackwardWeightsSeqTensor(miopenHandle_t handle,
                                  ...
                                  size_t reserveSpaceNumBytes)
{
    return miopenRNNBackwardWeightsSeqTensor_impl(handle, rnnDesc, xDesc, x, hDesc, hx, yDesc, y, dw, weightSpaceSize, workSpace, workSpaceNumBytes, reserveSpace, reserveSpaceNumBytes);
}
...
extern "C" miopenStatus_t miopenRNNForwardTraining(miopenHandle_t handle,
                                                      ...
                                                      size_t reserveSpaceNumBytes)
{
    return miopenRNNForwardTraining_impl(handle, rnnDesc, sequenceLen, xDesc, x, hxDesc, hx, cxDesc, cx, wDesc, w, yDesc, y, hyDesc, hy, cyDesc, cy, workSpace, workSpaceNumBytes, reserveSpace, reserveSpaceNumBytes);
}
...
extern "C" miopenStatus_t miopenRNNBackwardData(miopenHandle_t handle,
                                                   ...
                                                   size_t reserveSpaceNumBytes)
{
    return miopenRNNBackwardData_impl(handle, rnnDesc, sequenceLen, yDesc, y, dyDesc, dy, dhyDesc, dhy, dcyDesc, dcy, wDesc, w, hxDesc, hx, cxDesc, cx, dxDesc, dx, dhxDesc, dhx, dcxDesc, dcx, workSpace, workSpaceNumBytes, reserveSpace, reserveSpaceNumBytes);
}
...
extern "C" miopenStatus_t miopenRNNBackwardWeights(miopenHandle_t handle,
                                                      ...
                                                      size_t reserveSpaceNumBytes)
{
    return miopenRNNBackwardWeights_impl(handle, rnnDesc, sequenceLen, xDesc, x, hxDesc, hx, yDesc, y, dwDesc, dw, workSpace, workSpaceNumBytes, reserveSpace, reserveSpaceNumBytes);
}
...
extern "C" miopenStatus_t miopenRNNForwardInference(miopenHandle_t handle,
                                                       ...
                                                       size_t workSpaceNumBytes)
{
    return miopenRNNForwardInference_impl(handle, rnnDesc, sequenceLen, xDesc, x, hxDesc, hx, cxDesc, cx, wDesc, w, yDesc, y, hyDesc, hy, cyDesc, cy, workSpace, workSpaceNumBytes);
}
...
extern "C" miopenStatus_t miopenGetCTCLossDescriptor(miopenCTCLossDescriptor_t ctcLossDesc,
                                                        ...
                                                        bool* apply_softmax_layer)
{
    return miopenGetCTCLossDescriptor_impl(ctcLossDesc, dataType, blank_label_id, apply_softmax_layer);
}
...
extern "C" miopenStatus_t miopenSetCTCLossDescriptor(miopenCTCLossDescriptor_t ctcLossDesc,
                                                        ...
                                                        bool apply_softmax_layer)
{
    return miopenSetCTCLossDescriptor_impl(ctcLossDesc, dataType, blank_label_id, apply_softmax_layer);
}

extern "C" miopenStatus_t miopenGetCTCLossWorkspaceSize(miopenHandle_t handle,
                              const miopenTensorDescriptor_t probsDesc,
                              const miopenTensorDescriptor_t gradientsDesc,
                              const int* labels,
                              const int* labelLengths,
                              ...
                              size_t* workSpaceSize)
{
    return miopenGetCTCLossWorkspaceSize_impl(handle, probsDesc, gradientsDesc, labels, labelLengths, inputLengths, algo, ctcLossDesc, workSpaceSize);
}
...
extern "C" miopenStatus_t miopenCTCLoss(miopenHandle_t handle,
                                           ...
                                           size_t workSpaceSize)
{
    return miopenCTCLoss_impl(handle, probsDesc, probs, labels, labelLengths, inputLengths, losses, gradientsDesc, gradients, algo, ctcLossDesc, workSpace, workSpaceSize);
}
...
extern "C" miopenStatus_t miopenGetDropoutDescriptor(miopenDropoutDescriptor_t dropoutDesc,
                                                        ...
                                                        miopenRNGType_t* rng_mode)
{
    return miopenGetDropoutDescriptor_impl(dropoutDesc, handle, dropout, states, seed, use_mask, state_evo, rng_mode);
}
...
extern "C" miopenStatus_t miopenRestoreDropoutDescriptor(miopenDropoutDescriptor_t dropoutDesc,
                                                            ...
                                                            miopenRNGType_t rng_mode)
{
    return miopenRestoreDropoutDescriptor_impl(dropoutDesc, handle, dropout, states, stateSizeInBytes, seed, use_mask, state_evo, rng_mode);
}
...
extern "C" miopenStatus_t miopenSetDropoutDescriptor(miopenDropoutDescriptor_t dropoutDesc,
                                                        ...
                                                        miopenRNGType_t rng_mode)
{
    return miopenSetDropoutDescriptor_impl(dropoutDesc, handle, dropout, states, stateSizeInBytes, seed, use_mask, state_evo, rng_mode);
}
...
extern "C" miopenStatus_t miopenDropoutForward(miopenHandle_t handle,
                                                  ...
                                                  size_t reserveSpaceSizeInBytes)
{
    return miopenDropoutForward_impl(handle, dropoutDesc, noise_shape, xDesc, x, yDesc, y, reserveSpace, reserveSpaceSizeInBytes);
}
...
extern "C" miopenStatus_t miopenDropoutBackward(miopenHandle_t handle,
                                                   ...
                                                   size_t reserveSpaceSizeInBytes)
{
    return miopenDropoutBackward_impl(handle, dropoutDesc, noise_shape, dyDesc, dy, dxDesc, dx, reserveSpace, reserveSpaceSizeInBytes);
}

extern "C" miopenStatus_t miopenCreateReduceTensorDescriptor(miopenReduceTensorDescriptor_t* reduceTensorDesc)
{
    return miopenCreateReduceTensorDescriptor_impl(reduceTensorDesc);
}

extern "C" miopenStatus_t miopenDestroyReduceTensorDescriptor(miopenReduceTensorDescriptor_t reduceTensorDesc)
{
    return miopenDestroyReduceTensorDescriptor_impl(reduceTensorDesc);
}

extern "C" miopenStatus_t miopenSetReduceTensorDescriptor(miopenReduceTensorDescriptor_t reduceTensorDesc,
                                miopenReduceTensorOp_t reduceTensorOp,
                                miopenDataType_t reduceTensorCompType,
                                miopenNanPropagation_t reduceTensorNanOpt,
                                miopenReduceTensorIndices_t reduceTensorIndices,
                                miopenIndicesType_t reduceTensorIndicesType)
{
    return miopenSetReduceTensorDescriptor_impl(reduceTensorDesc, reduceTensorOp, reduceTensorCompType, reduceTensorNanOpt, reduceTensorIndices, reduceTensorIndicesType);
}

extern "C" miopenStatus_t miopenGetReduceTensorDescriptor(const miopenReduceTensorDescriptor_t reduceTensorDesc,
                                miopenReduceTensorOp_t* reduceTensorOp,
                                miopenDataType_t* reduceTensorCompType,
                                miopenNanPropagation_t* reduceTensorNanOpt,
                                miopenReduceTensorIndices_t* reduceTensorIndices,
                                miopenIndicesType_t* reduceTensorIndicesType)
{
    return miopenGetReduceTensorDescriptor_impl(reduceTensorDesc, reduceTensorOp, reduceTensorCompType, reduceTensorNanOpt, reduceTensorIndices, reduceTensorIndicesType);
}

extern "C" miopenStatus_t miopenGetReductionIndicesSize(miopenHandle_t handle,
                              const miopenReduceTensorDescriptor_t reduceTensorDesc,
                              const miopenTensorDescriptor_t aDesc,
                              const miopenTensorDescriptor_t cDesc,
                              size_t* sizeInBytes)
...
extern "C" miopenStatus_t miopenGetReductionWorkspaceSize(miopenHandle_t handle,
                                const miopenReduceTensorDescriptor_t reduceTensorDesc,
                                const miopenTensorDescriptor_t aDesc,
                                const miopenTensorDescriptor_t cDesc,
                                size_t* sizeInBytes)
{
    return miopenGetReductionWorkspaceSize_impl(handle, reduceTensorDesc, aDesc, cDesc, sizeInBytes);
}
...
extern "C" miopenStatus_t miopenReduceTensor(miopenHandle_t handle,
                   ...
                   void* C)
{
    return miopenReduceTensor_impl(handle, reduceTensorDesc, indices, indicesSizeInBytes, workspace, workspaceSizeInBytes, alpha, aDesc, A, beta, cDesc, C);
}
...
extern "C" miopenStatus_t miopenSetProblemTensorDescriptor(miopenProblem_t problem,
                                 miopenTensorArgumentId_t id,
                                 const miopenTensorDescriptor_t descriptor)
{
...
extern "C" miopenStatus_t miopenSetFindOptionPreallocatedWorkspace(miopenFindOptions_t options,
                                                                      void* buffer,
                                                                      size_t size)
{
...
extern "C" miopenStatus_t miopenFindSolutions(miopenHandle_t handle,
                                                 ...
                                                 size_t maxSolutions)
{
    return miopenFindSolutions_impl(handle, problem, options, solutions, numSolutions, maxSolutions);
}
...
extern "C" miopenStatus_t miopenLoadSolution(miopenSolution_t* solution,
                                                const char* data,
                                                size_t size)
{
...
extern "C" miopenStatus_t miopenGetSolutionSolverId(miopenSolution_t solution,
                                                       uint64_t* solverId)
{
...
extern "C" miopenStatus_t miopenGetReduceCalculationWorkspaceSize(miopenHandle_t handle,
                                        const miopenTensorDescriptor_t xDesc,
                                        const int32_t dim,
                                        const miopenReduceCalculationOp_t reduceCalculationOp,
                                        const miopenTensorDescriptor_t reduceDesc,
                                        size_t* sizeInBytes)
{
    return miopenGetReduceCalculationWorkspaceSize_impl(handle, xDesc, dim, reduceCalculationOp, reduceDesc, sizeInBytes);
}

extern "C" miopenStatus_t miopenReduceCalculationForward(miopenHandle_t handle,
                               miopenReduceCalculationNanPropagation_t nanPropagation,
                               void* workspace,
                               size_t workspaceSizeInBytes,
                               const miopenTensorDescriptor_t xDesc,
                               ...
                               void* y)
{
    return miopenReduceCalculationForward_impl(handle, nanPropagation, workspace, workspaceSizeInBytes, xDesc, x, dim, reduceCalculationOp, reduceDesc, y);
}
...
extern "C" miopenStatus_t miopenReduceExtremeForward(miopenHandle_t handle,
                           ...
                           void* indice)
{
    return miopenReduceExtremeForward_impl(handle, xDesc, x, dim, reduceExtremeOp, yDesc, y, indiceDesc, indice);
}
...
extern "C" miopenStatus_t miopenGroupNormForward(miopenHandle_t handle,
                                                    ...
                                                    void* rstd)
{
    return miopenGroupNormForward_impl(handle, mode, xDesc, x, weightDesc, weight, biasDesc, bias, num_groups, epsilon, yDesc, y, meanDesc, mean, rstdDesc, rstd);
}
...
extern "C" miopenStatus_t miopenAddLayerNormForward(miopenHandle_t handle,
                                                       ...
                                                       void* rstd)
{
    return miopenAddLayerNormForward_impl(handle, mode, xDesc, x, x2Desc, x2, weightDesc, weight, biasDesc, bias, epsilon, normalized_dim, yDesc, y, meanDesc, mean, rstdDesc, rstd);
}
...
extern "C" miopenStatus_t miopenT5LayerNormForward(miopenHandle_t handle,
                                                      ...
                                                      void* rstd)
{
    return miopenT5LayerNormForward_impl(handle, mode, xDesc, x, weightDesc, weight, epsilon, yDesc, y, rstdDesc, rstd);
}

extern "C" miopenStatus_t miopenGetT5LayerNormBackwardWorkspaceSize(miopenHandle_t handle,
                                          miopenNormMode_t mode,
                                          const miopenTensorDescriptor_t dyDesc,
                                          const miopenTensorDescriptor_t xDesc,
                                          const miopenTensorDescriptor_t weightDesc,
                                          ...
                                          size_t* sizeInBytes)
{
    return miopenGetT5LayerNormBackwardWorkspaceSize_impl(handle, mode, dyDesc, xDesc, weightDesc, rstdDesc, dxDesc, dwDesc, sizeInBytes);
}
...
extern "C" miopenStatus_t miopenT5LayerNormBackward(miopenHandle_t handle,
                                                       ...
                                                       void* dw)
{
    return miopenT5LayerNormBackward_impl(handle, mode, workspace, workspaceSizeInBytes, dyDesc, dy, xDesc, x, weightDesc, weight, rstdDesc, rstd, dxDesc, dx, dwDesc, dw);
}
...
extern "C" miopenStatus_t miopenFusedAdam(miopenHandle_t handle,
                                             ...
                                             const void* foundInf)
{
    return miopenFusedAdam_impl(handle, paramDesc, param, gradDesc, grad, expAvgDesc, expAvg, expAvgSqDesc, expAvgSq, maxExpAvgSqDesc, maxExpAvgSq, stateStepDesc, stateStep, state_step, lr, beta1, beta2, weight_decay, eps, amsgrad, maximize, adamw, gradScaleDesc, gradScale, foundInfDesc, foundInf);
}

extern "C" miopenStatus_t miopenFusedAdamWithOutput(miopenHandle_t handle,
                          const miopenTensorDescriptor_t paramInDesc,
                          void* paramIn,
                          const miopenTensorDescriptor_t paramOutDesc,
                          void* paramOut,
...
extern "C" miopenStatus_t miopenTransformersAdamW(miopenHandle_t handle,
                                                     ...
                                                     const void* foundInf)
{
    return miopenTransformersAdamW_impl(handle, paramDesc, param, gradDesc, grad, expAvgDesc, expAvg, expAvgSqDesc, expAvgSq, stateStepDesc, stateStep, state_step, lr, beta1, beta2, weight_decay, eps, correct_bias, gradScaleDesc, gradScale, foundInfDesc, foundInf);
}

extern "C" miopenStatus_t miopenTransformersAdamWWithOutput(miopenHandle_t handle,
                                  const miopenTensorDescriptor_t paramInDesc,
                                  void* paramIn,
                                  const miopenTensorDescriptor_t paramOutDesc,
                                  void* paramOut,
                                  ...
                                  const void* foundInf)
{
    return miopenTransformersAdamWWithOutput_impl(handle, paramInDesc, paramIn, paramOutDesc, paramOut, paramOutFloat16Desc, paramOutFloat16, gradInDesc, gradIn, expAvgInDesc, expAvgIn, expAvgOutDesc, expAvgOut, expAvgSqInDesc, expAvgSqIn, expAvgSqOutDesc, expAvgSqOut, stateStepInDesc, stateStepIn, stateStepOutDesc, stateStepOut, state_step, lr, beta1, beta2, weight_decay, eps, step_size, correct_bias, gradScaleDesc, gradScale, foundInfDesc, foundInf);
}
...
extern "C" miopenStatus_t miopenGetitemBackward(miopenHandle_t handle,
                                                   ...
                                                   uint32_t offset)
{
    return miopenGetitemBackward_impl(handle, workspace, workspaceSizeInBytes, dyDesc, dy, indexCount, indexDescs, indexs, dxDesc, dx, errorDesc, error, dimCount, dims, sliceCount, slices, offset);
}
...
extern "C" miopenStatus_t miopenPReLUBackward(miopenHandle_t handle,
                                                 ...
                                                 void* dweight)
{
    return miopenPReLUBackward_impl(handle, workspace, workspaceSizeInBytes, inputDesc, input, weightDesc, weight, doutputDesc, doutput, dinputDesc, dinput, dweightDesc, dweight);
}

extern "C" miopenStatus_t miopenGetSoftMarginLossForwardWorkspaceSize(miopenHandle_t handle,
                                            miopenTensorDescriptor_t inputDesc,
                                            miopenTensorDescriptor_t targetDesc,
                                            miopenTensorDescriptor_t outputDesc,
                                            miopenLossReductionMode_t reduction,
                                            size_t* sizeInBytes)
{
    return miopenGetSoftMarginLossForwardWorkspaceSize_impl(handle, inputDesc, targetDesc, outputDesc, reduction, sizeInBytes);
}
...
extern "C" miopenStatus_t miopenSoftMarginLossBackward(miopenHandle_t handle,
                                                          ...
                                                          miopenLossReductionMode_t reduction)
{
    return miopenSoftMarginLossBackward_impl(handle, inputDesc, input, targetDesc, target, doutputDesc, doutput, dinputDesc, dinput, reduction);
}

extern "C" miopenStatus_t miopenGetMultiMarginLossForwardWorkspaceSize(miopenHandle_t handle,
                                             miopenTensorDescriptor_t inputDesc,
                                             miopenTensorDescriptor_t targetDesc,
                                             miopenTensorDescriptor_t weightDesc,
                                             miopenTensorDescriptor_t outputDesc,
                                             ...
                                             size_t* sizeInBytes)
{
    return miopenGetMultiMarginLossForwardWorkspaceSize_impl(handle, inputDesc, targetDesc, weightDesc, outputDesc, p, margin, reduction, sizeInBytes);
}
...
extern "C" miopenStatus_t miopenMultiMarginLossForward(miopenHandle_t handle,
                                                          ...
                                                          size_t workspaceSizeInBytes)
{
    return miopenMultiMarginLossForward_impl(handle, inputDesc, input, targetDesc, target, weightDesc, weight, outputDesc, output, p, margin, reduction, workspace, workspaceSizeInBytes);
}
...
extern "C" miopenStatus_t miopenGetTuningPolicy(miopenHandle_t handle,
                                                   miopenTuningPolicy_t* value)
{
