...
template <class T>
struct immed_conv2d_test : miopen::test::conv::conv_test_base<T, miopen::test::conv::ConvApi::Immediate>
{
};

using GPU_immed_conv_2d_FP32 = immed_conv2d_test<float>;

TEST_P(GPU_immed_conv_2d_FP32, TestFP32) { this->Run(); }

INSTANTIATE_TEST_SUITE_P(Full, GPU_immed_conv_2d_FP32, ::testing::ValuesIn(GetDataset()));
