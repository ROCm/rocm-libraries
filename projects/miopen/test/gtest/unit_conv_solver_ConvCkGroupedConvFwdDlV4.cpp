...
auto GetConvFullTestCases(miopenDataType_t datatype)
{
    ...
    return std::vector{
        ...
        TestCase{{datatype, miopenTensorNCHW, {32, 1, 28, 28}},
                 {datatype, miopenTensorNCHW, {1, 1, 5, 5}},
                 datatype, {{2, 2}, {1, 1}, {1, 1}, 1}},
        ...
        TestCase{{datatype, miopenTensorNCHW, {8, 1, 56, 56}},
                 {datatype, miopenTensorNCHW, {1, 1, 5, 5}},
                 datatype, {{2, 2}, {2, 2}, {1, 1}, 1}},
        TestCase{{datatype, miopenTensorNCHW, {8, 2, 56, 56}},
                 {datatype, miopenTensorNCHW, {2, 1, 5, 5}},
                 datatype, {{2, 2}, {2, 2}, {1, 1}, 2}},
        TestCase{{datatype, miopenTensorNCHW, {32, 1, 7, 7}},
        ...
        TestCase{{datatype, miopenTensorNCHW, {2, 1, 112, 112}},
                 {datatype, miopenTensorNCHW, {1, 1, 3, 3}},
                 datatype, {{1, 1}, {1, 1}, {1, 1}, 1}},
        TestCase{{datatype, miopenTensorNCHW, {2, 2, 112, 112}},
                 {datatype, miopenTensorNCHW, {2, 1, 3, 3}},
                 datatype, {{1, 1}, {1, 1}, {1, 1}, 2}}, 
        TestCase{{datatype, miopenTensorNCHW, {32, 1, 28, 28}},
                 {datatype, miopenTensorNCHW, {1, 1, 3, 3}},
                 datatype, {{1, 1}, {2, 2}, {1, 1}, 1}},
        TestCase{{datatype, miopenTensorNCHW, {32, 6, 28, 28}},
                 {datatype, miopenTensorNCHW, {6, 1, 3, 3}},
                 datatype, {{1, 1}, {2, 2}, {1, 1}, 6}},
        TestCase{{datatype, miopenTensorNCHW, {32, 1, 112, 112}},
                 {datatype, miopenTensorNCHW, {1, 1, 3, 3}},
                 datatype, {{1, 1}, {2, 2}, {1, 1}, 1}},
        TestCase{{datatype, miopenTensorNCHW, {8, 3, 112, 112}},
                 {datatype, miopenTensorNCHW, {3, 1, 3, 3}},
...
using GPU_UnitTestConvSolverConvDepthwiseFwd_FP16 = GPU_UnitTestConvSolverFwd_FP16;
using CPU_UnitTestConvSolverConvDepthwiseFwdDevApplicability_FP16 =
    CPU_UnitTestConvSolverDevApplicabilityFwd_NONE;
using CPU_UnitTestConvSolverConvDepthwiseFwdeterministicApplicability_NONE =
    CPU_UnitTestConvSolverDevApplicabilityFwd_NONE;

TEST_P(GPU_UnitTestConvSolverConvDepthwiseFwd_FP16, ConvDepthwiseFwd)
{
    this->RunTest(miopen::solver::conv::ConvDepthwiseFwd{});
};

TEST_P(CPU_UnitTestConvSolverConvDepthwiseFwdDevApplicability_FP16, ConvDepthwiseFwd)
{
    this->RunTest(miopen::solver::conv::ConvDepthwiseFwd{});
};

TEST_P(CPU_UnitTestConvSolverConvDepthwiseFwdeterministicApplicability_NONE, ConvDepthwiseFwd)
{
    this->RunTest(miopen::solver::conv::ConvDepthwiseFwd{});
};
...
INSTANTIATE_TEST_SUITE_P(Smoke,
                         GPU_UnitTestConvSolverConvDepthwiseFwd_FP16,
...
INSTANTIATE_TEST_SUITE_P(Smoke,
                         CPU_UnitTestConvSolverConvDepthwiseFwdDevApplicability_FP16,
                         testing::Combine(testing::Values(GetTestParams(miopenHalf)),
                                          testing::Values(GetConvSmokeTestCases(miopenHalf)[0])));

INSTANTIATE_TEST_SUITE_P(
    Smoke,
    CPU_UnitTestConvSolverConvDepthwiseFwdeterministicApplicability_NONE,
