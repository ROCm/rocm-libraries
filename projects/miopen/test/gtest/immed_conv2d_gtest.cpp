...
struct TestNameGenerator
{
    ...
    {
        return GetParamNamesString(info, std::make_index_sequence<20>{});
    }
};
...
INSTANTIATE_TEST_SUITE_P(Smoke, GPU_Immed_Conv2d_FP32, GetCasesSmoke<float>(), TestNameGenerator{});
INSTANTIATE_TEST_SUITE_P(Full, GPU_Immed_Conv2d_FP32, GetCasesFull<float>(), TestNameGenerator{});
