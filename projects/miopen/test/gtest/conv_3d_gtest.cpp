...
INSTANTIATE_MIOPEN_TEST_SUITES(0,
                               GPU_Conv_3d_FP32,
                               float,
                               {16, 32, 4, 9, 9},
                               {64, 32, 3, 3, 3},
                               ...
                               "conv",
                               "default");
INSTANTIATE_MIOPEN_TEST_SUITES(1,
                               GPU_Conv_3d_FP32,
                               float,
                               {4, 3, 4, 227, 227},
                               {4, 3, 3, 11, 11},
                               ...
                               "conv",
                               "default");
INSTANTIATE_MIOPEN_TEST_SUITES(2,
                               GPU_Conv_3d_FP32,
                               float,
                               {16, 128, 4, 56, 56},
                               {256, 4, 3, 3, 3},
                               ...
                               "conv",
                               "default");
INSTANTIATE_MIOPEN_TEST_SUITES(3,
                               GPU_Conv_3d_FP32,
                               float,
                               {16, 128, 56, 56, 56},
                               {256, 4, 3, 3, 3},
                               ...
                               "conv",
                               "default");
INSTANTIATE_MIOPEN_TEST_SUITES(4,
                               GPU_Conv_3d_FP32,
                               float,
                               {4, 4, 4, 161, 700},
                               {32, 1, 3, 5, 20},
                               ...
                               "conv",
                               "default");
INSTANTIATE_MIOPEN_TEST_SUITES(5,
                               GPU_Conv_3d_FP32,
                               float,
                               {8, 512, 4, 28, 28},
                               {512, 128, 1, 1, 1},
                               ...
                               "conv",
                               "same");
INSTANTIATE_MIOPEN_TEST_SUITES(6,
                               GPU_Conv_3d_FP32,
                               float,
                               {8, 512, 4, 56, 56},
                               {512, 128, 1, 1, 1},
                               ...
                               "conv",
                               "same");
INSTANTIATE_MIOPEN_TEST_SUITES(7,
                               GPU_Conv_3d_FP32,
                               float,
                               {8, 512, 3, 14, 14},
                               {512, 128, 1, 1, 1},
                               ...
                               "trans",
                               "same");
INSTANTIATE_MIOPEN_TEST_SUITES(8,
                               GPU_Conv_3d_FP32,
                               float,
                               {16, 64, 3, 4, 4},
                               {64, 32, 1, 3, 3},
                               ...
                               "trans",
                               "default");
INSTANTIATE_MIOPEN_TEST_SUITES(9,
                               GPU_Conv_3d_FP32,
                               float,
                               {16, 32, 4, 9, 9},
                               {64, 32, 3, 3, 3},
                               ...
                               "conv",
                               "default");
INSTANTIATE_MIOPEN_TEST_SUITES(10,
                               GPU_Conv_3d_FP32,
                               float,
                               {4, 3, 4, 227, 227},
                               {4, 3, 3, 11, 11},
                               ...
                               "conv",
                               "default");
INSTANTIATE_MIOPEN_TEST_SUITES(11,
                               GPU_Conv_3d_FP32,
                               float,
                               {16, 128, 4, 56, 56},
                               {256, 4, 3, 3, 3},
                               ...
                               "conv",
                               "default");
INSTANTIATE_MIOPEN_TEST_SUITES(12,
                               GPU_Conv_3d_FP32,
                               float,
                               {4, 4, 4, 161, 700},
                               {32, 1, 3, 5, 20},
                               ...
                               "conv",
                               "default");
INSTANTIATE_MIOPEN_TEST_SUITES(13,
                               GPU_Conv_3d_FP32,
                               float,
                               {8, 512, 4, 28, 28},
                               {512, 128, 1, 1, 1},
                               ...
                               "conv",
                               "same");
INSTANTIATE_MIOPEN_TEST_SUITES(14,
                               GPU_Conv_3d_FP32,
                               float,
                               {8, 512, 4, 56, 56},
                               {512, 128, 1, 1, 1},
                               ...
                               "conv",
                               "same");
INSTANTIATE_MIOPEN_TEST_SUITES(15,
                               GPU_Conv_3d_FP32,
                               float,
                               {8, 512, 3, 14, 14},
                               {512, 128, 1, 1, 1},
                               ...
                               "trans",
                               "same");
INSTANTIATE_MIOPEN_TEST_SUITES(16,
                               GPU_Conv_3d_FP32,
                               float,
                               {16, 64, 3, 4, 4},
                               {64, 32, 1, 3, 3},
