...
//         std::transform(tokens.begin(), tokens.end(), std::back_inserter(ptrs), [](const auto&
//         str) {
//             return str.data();
//         });
...
//     {flags + "--input 128 256 14 14 --weights 256 256 3 3 --pads_strides_dilations 1 1 1 1 1 1"},
//     {flags + "--input 128 512 7 7   --weights 512 512 3 3 --pads_strides_dilations 1 1 1 1 1 1"},
//     {flags + "--input 128 1024 14 14 --weights 512 1024 1 1 --pads_strides_dilations 0 0 2 2 1
//     1"}, {flags + "--input 128 1024 14 14 --weights 2048 1024 1 1 --pads_strides_dilations 0 0 2
//     2 1 1"}, {flags + "--input 128 256 14 14 --weights 1024 256 1 1 --pads_strides_dilations 0 0
//     1 1 1 1"}, {flags + "--input 128 512 28 28 --weights 256 512 1 1 --pads_strides_dilations 0 0
//     2 2 1 1"}, {flags + "--input 128 1024 14 14 --weights 256 1024 1 1 --pads_strides_dilations 0
//     0 1 1 1 1"}, {flags + "--input 128 64 56 56 --weights 256 64 1 1 --pads_strides_dilations 0 0
//     1 1 1 1"}, {flags + "--input 128 64 56 56 --weights 64 64 1 1 --pads_strides_dilations 0 0 1
//     1 1 1"}, {flags + "--input 128 128 28 28 --weights 512 128 1 1 --pads_strides_dilations 0 0 1
//     1 1 1"}, {flags + "--input 128 256 56 56 --weights 128 256 1 1 --pads_strides_dilations 0 0 2
//     2 1 1"}, {flags + "--input 128 256 56 56 --weights 64 256 1 1 --pads_strides_dilations 0 0 1
//     1 1 1"}, {flags + "--input 128 512 28 28 --weights 1024 512 1 1 --pads_strides_dilations 0 0
//     2 2 1 1"}, {flags + "--input 128 512 28 28 --weights 128 512 1 1 --pads_strides_dilations 0 0
//     1 1 1 1"}, {flags + "--input 128 512 7 7   --weights 2048 512 1 1 --pads_strides_dilations 0
//     0 1 1 1 1"}, {flags + "--input 128 2048 7 7 --weights 512 2048 1 1 --pads_strides_dilations 0
//     0 1 1 1 1"}
//         // clang-format on
//     };
// }
...
// INSTANTIATE_TEST_SUITE_P(Full, CPU_ConvEmbedConfig_FP32,
// testing::Values(GetTestCases("--float"))); INSTANTIATE_TEST_SUITE_P(Full,
// CPU_ConvEmbedConfig_FP16, testing::Values(GetTestCases("--half")));
