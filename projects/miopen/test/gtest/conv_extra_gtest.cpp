...
INSTANTIATE_ALL_TEST_SUITES(0, {16, 3, 64, 128}, {96, 3, 11, 11}, {0, 0, 1, 1, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(1, {16, 3, 32, 32}, {96, 3, 11, 11}, {0, 0, 2, 2, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(2, {16, 3, 64, 128}, {96, 3, 11, 11}, {5, 5, 2, 2, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(3, {16, 3, 32, 32}, {96, 3, 11, 11}, {5, 5, 2, 2, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(4, {2, 16, 1024, 2048}, {32, 16, 3, 3}, {0, 0, 1, 1, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(5, {2, 16, 1024, 2048}, {32, 16, 3, 3}, {1, 1, 1, 1, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(6, {2, 16, 3072, 3072}, {32, 16, 3, 3}, {0, 0, 2, 2, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(7, {2, 16, 3072, 3072}, {32, 16, 3, 3}, {2, 2, 2, 2, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(8, {128, 320, 1, 7}, {256, 320, 1, 1}, {0, 0, 1, 1, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(9, {128, 1024, 1, 7}, {2048, 1024, 1, 1}, {1, 1, 1, 1, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(10, {352, 192, 7, 1}, {320, 192, 1, 1}, {0, 0, 1, 1, 1, 1});
INSTANTIATE_ALL_TEST_SUITES(11, {352, 16, 7, 1}, {32, 16, 1, 1}, {2, 2, 1, 1, 1, 1});

INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(12, {4, 1, 161, 700}, {4, 1, 5, 20}, {0, 0, 2, 2, 1, 1});
INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(13, {4, 1, 161, 700}, {4, 1, 5, 20}, {0, 0, 2, 2, 1, 1});
INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(14, {4, 32, 79, 341}, {4, 32, 5, 10}, {0, 0, 2, 2, 1, 1});
INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(15, {4, 32, 79, 341}, {4, 32, 5, 10}, {0, 0, 2, 2, 1, 1});
INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(16, {4, 3, 227, 227}, {4, 3, 11, 11}, {0, 0, 4, 4, 1, 1});
INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(17, {4, 3, 224, 224}, {4, 3, 11, 11}, {2, 2, 4, 4, 1, 1});
INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(18, {16, 1, 48, 480}, {16, 1, 3, 3}, {1, 1, 1, 1, 1, 1});
// Forward disabled since FFT fails verification for the forward direction
INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(
    19, {32, 64, 27, 27}, {192, 64, 5, 5}, {2, 2, 1, 1, 1, 1}, false);
INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(20, {4, 96, 14, 14}, {32, 96, 5, 5}, {2, 2, 1, 1, 1, 1});
INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(21, {4, 16, 14, 14}, {4, 16, 5, 5}, {2, 2, 1, 1, 1, 1});
INSTANTIATE_FLOAT_SPECIFIC_TEST_SUITES(22, {4, 32, 14, 14}, {4, 32, 5, 5}, {2, 2, 1, 1, 1, 1});
