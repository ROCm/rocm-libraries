...
template <class T>
struct conv3d_test : miopen::test::conv::conv_test_base<T>
{
};

using GPU_conv_3d_FP32 = conv3d_test<float>;

TEST_P(GPU_conv_3d_FP32, TestFP32) { this->Run(); }

INSTANTIATE_TEST_SUITE_P(Full, GPU_conv_3d_FP32, ::testing::ValuesIn(GetDataset()));
