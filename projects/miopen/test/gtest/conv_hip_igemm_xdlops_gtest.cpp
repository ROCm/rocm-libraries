...
#define INSTANTIATE_MIOPEN_INT8_TEST_SUITES(id, ...) \
    INSTANTIATE_MIOPEN_TEST_SUITES(id, GPU_ConvHipIgemmXdlops_I8, int8_t, __VA_ARGS__)

INSTANTIATE_MIOPEN_INT8_TEST_SUITES(0,
                                    true,
                                    false,
                                    false,
                                    {256, 128, 28, 28},
                                    ...
                                    "NHWC",
                                    {1, 1, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(1,
                                    true,
                                    false,
                                    false,
                                    {128, 512, 7, 7},
                                    ...
                                    "NHWC",
                                    {1, 1, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(2,
                                    true,
                                    false,
                                    false,
                                    {128, 64, 56, 56},
                                    ...
                                    "NHWC",
                                    {0, 0, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(3,
                                    true,
                                    false,
                                    false,
                                    {256, 256, 56, 56},
...
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(4,
                                    true,
                                    false,
                                    false,
                                    {256, 128, 28, 28},
                                    ...
                                    "NHWC",
                                    {1, 1, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(5,
                                    true,
                                    false,
                                    false,
                                    {128, 512, 7, 7},
                                    ...
                                    "NHWC",
                                    {1, 1, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(6,
                                    true,
                                    false,
                                    false,
                                    {128, 64, 56, 56},
                                    ...
                                    "NHWC",
                                    {0, 0, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(7,
                                    true,
                                    false,
                                    false,
                                    {256, 256, 56, 56},
                                    ...
                                    "NHWC",
                                    {0, 0, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(8,
                                    true,
                                    false,
                                    false,
                                    {256, 128, 28, 28},
                                    ...
                                    "NHWC",
                                    {1, 1, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(9,
                                    true,
                                    false,
                                    false,
                                    {128, 512, 7, 7},
                                    ...
                                    "NHWC",
                                    {1, 1, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(10,
                                    true,
                                    false,
                                    false,
                                    {128, 64, 56, 56},
                                    ...
                                    "NHWC",
                                    {0, 0, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(11,
                                    true,
                                    false,
                                    false,
                                    {256, 256, 56, 56},
...
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(12,
                                    false,
                                    true,
                                    false,
                                    {256, 128, 28, 28},
                                    ...
                                    "NHWC",
                                    {1, 1, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(13,
                                    false,
                                    true,
                                    false,
                                    {128, 512, 7, 7},
                                    ...
                                    "NHWC",
                                    {1, 1, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(14,
                                    false,
                                    true,
                                    false,
                                    {128, 64, 56, 56},
                                    ...
                                    "NHWC",
                                    {0, 0, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(15,
                                    false,
                                    true,
                                    false,
                                    {256, 256, 56, 56},
                                    ...
                                    "NHWC",
                                    {0, 0, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(16,
                                    false,
                                    true,
                                    false,
                                    {256, 128, 28, 28},
                                    ...
                                    "NHWC",
                                    {1, 1, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(17,
                                    false,
                                    true,
                                    false,
                                    {128, 512, 7, 7},
                                    ...
                                    "NHWC",
                                    {1, 1, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(18,
                                    false,
                                    true,
                                    false,
                                    {128, 64, 56, 56},
                                    ...
                                    "NHWC",
                                    {0, 0, 1, 1, 1, 1});
INSTANTIATE_MIOPEN_INT8_TEST_SUITES(19,
                                    false,
                                    true,
                                    false,
                                    {256, 256, 56, 56},
