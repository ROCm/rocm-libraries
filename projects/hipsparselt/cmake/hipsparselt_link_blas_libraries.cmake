...
#
# The explicit BLAS selection is checked before HIPSPARSELT_ENABLE_THEROCK. The
# two settings are independent: THEROCK selects how hipBLASLt is consumed, not
# which CPU reference BLAS the clients link. Checking THEROCK first meant that
# consuming a staged hipBLASLt package forced TheRock's cblas target, which
# outside TheRock resolves to a CBLAS-only library with no LAPACK and no Fortran
# runtime -- the clients then fail to link on dlange_ and _gfortran_*.
# TheRock is unaffected: it leaves HIPSPARSELT_ENABLE_BLIS at its OFF default.
#
...
function(hipsparselt_link_blas_libraries target_name)
    ...
    elseif(HIPSPARSELT_ENABLE_THEROCK)
