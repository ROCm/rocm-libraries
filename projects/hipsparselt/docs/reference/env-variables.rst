...
.. list-table::
    ...
    * - | ``HIPSPARSELT_LOG_FILE``
        | Specifies file path for logging output.
      - | String path to log file
        | File name may contain %i, replaced with process ID
...
.. list-table::
    ...
    * - | ``HIPSPARSELT_ENABLE_MARKER``
        | Enables roctrace logging for performance analysis.
      - ``0``
      - | ``0``: Disable roctrace logging
        | ``1``: Enable roctrace logging
