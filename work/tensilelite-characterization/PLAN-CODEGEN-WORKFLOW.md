...
- [ ] **P4** round 6 (closing push). Gap to 80% now **~1.82 pts** ≈ ~1000 lines — REACHABLE. Spread across KWA 2775 / KW 1217 / Solution 1165 + mid files (StreamK 547 / LocalRead 489 / GlobalWriteBatch 338 / GSU 238 / Activation 207 / …). **NEXT = round 6 then P5 gate.**
