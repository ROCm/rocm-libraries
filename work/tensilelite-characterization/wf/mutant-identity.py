...
def cmd_identity(args):
    ...
    ident = identity(args.file or "", diff_text,
                     line_anchor=args.line_text, line_number=args.line_number)
...
def main(argv=None):
    p = argparse.ArgumentParser(description="Stable mutant identity (file + line anchor + diff-hash)")
    ...
    pc = sub.add_parser("canon", help="print the canonicalized diff body that gets hashed")
