...
#
# Re-runs wf/rank-modules.py (Issue 17), snapshots its output under
...
#
# Usage:
#   wf/rank-refresh.sh [--out-dir <dir>] [--pin <sha>] [--metrics <json>]
...
RANKER="work/tensilelite-characterization/wf/rank-modules.py"
SRC="projects/hipblaslt/tensilelite"
OUT_DIR="work/tensilelite-characterization/coverage/mutprod/ranking-history"
PIN=""
METRICS=""
