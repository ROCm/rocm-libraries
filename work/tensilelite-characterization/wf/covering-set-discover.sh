...
#
# Usage:
#   wf/covering-set-discover.sh --module Tensile/<...>.py [--out <dir>]
...
#   work/tensilelite-characterization/coverage/mutprod/covering/<basename>).
#
...
# wf/tests/covering-set-discover-selftest.sh.
...
data = {
    ...
    "generator": "work/tensilelite-characterization/wf/covering-set-discover.sh",
}
...
if [[ -z "$OUT" ]]; then
  OUT="work/tensilelite-characterization/coverage/mutprod/covering/${BASENAME}"
fi
