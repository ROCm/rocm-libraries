...
#if TEST_STD_VER >= 11
TEST_CONSTINIT gpu::unique_ptr_h<int> global_static_unique_ptr_single;
TEST_CONSTINIT gpu::unique_ptr_h<int[]> global_static_unique_ptr_runtime;
...
#if TEST_STD_VER >= 11
  {
    using U1 = gpu::unique_ptr_h<ElemType>;
