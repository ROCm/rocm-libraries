...
- `dnn-providers/integration-tests/src/integration_tests/sdpa/IntegrationGpuSdpaFwdInference.cpp` (new)
  ...
  - Cases (9): MHA, bottom-right causal, GQA, MQA, non-square bottom-right
    causal, off-tile remainder seqlen, sub-tile seqlen, causal+remainder, and
    causal seqQ>seqKv — head dim 128, bf16, scale `1/sqrt(d)`.
...
- All 9 cases **PASS**: DUT = AITER ASM, reference = CPU graph executor,
