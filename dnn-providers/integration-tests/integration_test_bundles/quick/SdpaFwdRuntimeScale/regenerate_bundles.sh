...
#
# Usage:
#   cd <repo-root>/dnn-providers/integration-tests/integration_test_bundles/quick/SdpaFwdRuntimeScale
...
GENERATOR="$(cd "$GOLDEN_ROOT/../reference_data_scripts" && pwd)/generate_sdpa_runtime_scale_test_bundle.py"
