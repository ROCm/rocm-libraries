...
# Builds the test environment list
# ~~~
# Parameters:
...
#
# Arguments:
#   prefix_name - Prefix to add to all target names (e.g., "hipdnn-integration-tests" creates "hipdnn-integration-tests-check")
#
# Creates prefixed targets (e.g., "hipdnn-integration-tests-check", "hipdnn-integration-tests-unit-check", etc.)
...
function(_add_test_target_internal APPEND_FUNCTION_SUFFIX TARGET WORKING_DIR)
    ...
    set_property(GLOBAL APPEND PROPERTY INTEGRATION_TESTS_TEST_TARGETS ${TARGET})
...
function(install_integration_tests_ctest_files)
    ...
    file(WRITE "${INSTALLED_CTEST_FILE}"
         "# Autogenerated CTestTestfile for installed hipdnn-integration-tests\n"
    )
    file(APPEND "${INSTALLED_CTEST_FILE}" "# Generated by hipdnn-integration-tests build system\n\n")

    # Get all test targets that were registered
    get_property(all_tests GLOBAL PROPERTY INTEGRATION_TESTS_TEST_TARGETS)
    ...
    install(FILES "${INSTALLED_CTEST_FILE}"
            DESTINATION ${INTEGRATION_TESTS_CTEST_FILE_INSTALL_PATH} RENAME CTestTestfile.cmake
    )

endfunction() # install_integration_tests_ctest_files
