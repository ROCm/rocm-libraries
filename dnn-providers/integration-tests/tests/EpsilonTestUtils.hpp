                                  ...
                                  DataType epsilonDataType)
{
    ...
    case DataType::HALF:
        return CreateTensorAttributesDirect(builder,
                                            ...
                                            builder.CreateStruct(Float16Value(epsilon)).Union());
    case DataType::BFLOAT16:
        return CreateTensorAttributesDirect(builder,
                                            ...
                                            builder.CreateStruct(BFloat16Value(epsilon)).Union());
    case DataType::DOUBLE:
        return CreateTensorAttributesDirect(
            ...
            builder.CreateStruct(Float64Value(static_cast<double>(epsilon))).Union());
    default:
