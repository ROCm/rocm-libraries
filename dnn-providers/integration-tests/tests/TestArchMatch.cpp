...
{
    EXPECT_TRUE(archMatches(
        "gfx942:sramecc+:xnack-", "gfx942:sramecc+:xnack-", ArchMatchMode::Strict));
}
...
TEST(TestArchMatchLoose, RejectsNonSubstring)
{
    ...
    EXPECT_FALSE(archMatches(
        "gfx942:sramecc+:xnack-", "gfx942:xnack-", ArchMatchMode::Loose));
}
