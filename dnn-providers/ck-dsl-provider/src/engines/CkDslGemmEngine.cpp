...
CkDslGemmEngine::CkDslGemmEngine(int64_t id) : id_(id) {}

int64_t CkDslGemmEngine::id() const {
    return id_;
}

bool CkDslGemmEngine::isApplicable(
    CkDslHandle& handle,
...
void CkDslGemmEngine::getDetails(
...
size_t CkDslGemmEngine::getMaxWorkspaceSize(
...
void CkDslGemmEngine::initializeExecutionContext(
    const CkDslHandle& handle, const hipdnn_flatbuffers_sdk::flatbuffer_utilities::IGraph& opGraph,
...
void CkDslGemmEngine::addPlanBuilder(
