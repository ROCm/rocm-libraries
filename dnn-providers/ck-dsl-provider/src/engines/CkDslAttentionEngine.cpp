...
#include "CkDslAttentionEngine.hpp"
...
CkDslAttentionEngine::CkDslAttentionEngine(int64_t id) : id_(id) {}

int64_t CkDslAttentionEngine::id() const {
    return id_;
}

bool CkDslAttentionEngine::isApplicable(
    CkDslHandle& handle,
...
void CkDslAttentionEngine::getDetails(
...
size_t CkDslAttentionEngine::getMaxWorkspaceSize(
...
void CkDslAttentionEngine::initializeExecutionContext(
    const CkDslHandle& handle, const hipdnn_flatbuffers_sdk::flatbuffer_utilities::IGraph& opGraph,
...
void CkDslAttentionEngine::addPlanBuilder(
