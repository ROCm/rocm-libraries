...
MiopenSigmoidPlan::MiopenSigmoidPlan(
...
size_t MiopenSigmoidPlan::getWorkspaceSize([[maybe_unused]] const HipdnnMiopenHandle& handle) const
{
    return 0;
}

void MiopenSigmoidPlan::execute(const HipdnnMiopenHandle& handle,
