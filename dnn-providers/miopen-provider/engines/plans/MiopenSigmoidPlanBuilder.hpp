...
class MiopenSigmoidPlanBuilder : public hipdnn_plugin_sdk::IPlanBuilder<HipdnnMiopenHandle,
                                                                        HipdnnMiopenSettings,
                                                                        HipdnnMiopenContext>
{
public:
    MiopenSigmoidPlanBuilder() = default;
    ~MiopenSigmoidPlanBuilder() override = default;

    // Disallow copy and assignment
    MiopenSigmoidPlanBuilder(const MiopenSigmoidPlanBuilder&) = delete;
    MiopenSigmoidPlanBuilder& operator=(const MiopenSigmoidPlanBuilder&) = delete;
