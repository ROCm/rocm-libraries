...
class MiopenBinaryPointwisePlanBuilder
    : public hipdnn_plugin_sdk::
          IPlanBuilder<HipdnnMiopenHandle, HipdnnMiopenSettings, HipdnnMiopenContext>
{
public:
    MiopenBinaryPointwisePlanBuilder() = default;
    ~MiopenBinaryPointwisePlanBuilder() override = default;

    // Disallow copy and assignment
    MiopenBinaryPointwisePlanBuilder(const MiopenBinaryPointwisePlanBuilder&) = delete;
    MiopenBinaryPointwisePlanBuilder& operator=(const MiopenBinaryPointwisePlanBuilder&) = delete;
