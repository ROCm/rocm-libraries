...
size_t MiopenTanhPlan::getWorkspaceSize([[maybe_unused]] const HipdnnMiopenHandle& handle) const
{
    return 0;
}

void MiopenTanhPlan::execute(const HipdnnMiopenHandle& handle,
