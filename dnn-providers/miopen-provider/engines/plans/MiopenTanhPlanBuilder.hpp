...
class MiopenTanhPlanBuilder : public hipdnn_plugin_sdk::IPlanBuilder<HipdnnMiopenHandle,
                                                                     HipdnnMiopenSettings,
                                                                     HipdnnMiopenContext>
{
public:
    MiopenTanhPlanBuilder() = default;
    ~MiopenTanhPlanBuilder() override = default;

    // Disallow copy and assignment
    MiopenTanhPlanBuilder(const MiopenTanhPlanBuilder&) = delete;
    MiopenTanhPlanBuilder& operator=(const MiopenTanhPlanBuilder&) = delete;
