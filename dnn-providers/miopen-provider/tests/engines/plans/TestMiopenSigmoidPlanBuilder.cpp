...
class TestMiopenSigmoidPlanBuilder : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsTrueForValidSigmoidGraph)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::SIGMOID_FWD);
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsFalseForUnsupportedMode)
{
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsFalseForNonFloatComputeType)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::SIGMOID_FWD,
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsFalseForVirtualInputTensor)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::SIGMOID_FWD,
                               hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT,
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsFalseForVirtualOutputTensor)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::SIGMOID_FWD,
                               hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT,
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsTrueForHalfIoDtype)
{
    auto builder
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsFalseForBfloat16IoDtype)
{
    auto builder
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsTrueForRank1Tensor)
{
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsFalseForRank5Tensor)
{
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsFalseForMismatchedElementCount)
{
...
TEST_F(TestMiopenSigmoidPlanBuilder, GetMaxWorkspaceSizeReturnsZero)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::SIGMOID_FWD);
...
TEST_F(TestMiopenSigmoidPlanBuilder, GetCustomKnobsReturnsEmpty)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::SIGMOID_FWD);
...
TEST_F(TestMiopenSigmoidPlanBuilder, BuildPlanDoesNotThrowForValidGraph)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::SIGMOID_FWD);
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsFalseForMultiNodeGraph)
{
...
TEST_F(TestMiopenSigmoidPlanBuilder, IsApplicableReturnsFalseForUnsupportedAttributes)
{
    const MockGraph mockGraph;
