...
class TestMiopenTanhPlanBuilder : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsTrueForValidTanhGraph)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::TANH_FWD);
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsFalseForUnsupportedMode)
{
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsFalseForNonFloatComputeType)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::TANH_FWD,
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsFalseForVirtualInputTensor)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::TANH_FWD,
                               hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT,
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsFalseForVirtualOutputTensor)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::TANH_FWD,
                               hipdnn_flatbuffers_sdk::data_objects::DataType::FLOAT,
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsTrueForHalfIoDtype)
{
    auto builder
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsFalseForBfloat16IoDtype)
{
    auto builder
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsTrueForRank1Tensor)
{
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsFalseForRank5Tensor)
{
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsFalseForMismatchedElementCount)
{
...
TEST_F(TestMiopenTanhPlanBuilder, GetMaxWorkspaceSizeReturnsZero)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::TANH_FWD);
...
TEST_F(TestMiopenTanhPlanBuilder, GetCustomKnobsReturnsEmpty)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::TANH_FWD);
...
TEST_F(TestMiopenTanhPlanBuilder, BuildPlanDoesNotThrowForValidGraph)
{
    auto builder
        = createPointwiseGraph(hipdnn_flatbuffers_sdk::data_objects::PointwiseMode::TANH_FWD);
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsFalseForMultiNodeGraph)
{
...
TEST_F(TestMiopenTanhPlanBuilder, IsApplicableReturnsFalseForUnsupportedAttributes)
{
    const MockGraph mockGraph;
