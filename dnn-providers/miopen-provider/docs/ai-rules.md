...
In the superbuild, targets are prefixed and YAML category-driven (e.g., `miopen-provider-check`, `miopen-provider-quick-check`, `miopen-provider-unit-check`). See `projects/hipdnn/docs/Superbuild.md` for full details.
