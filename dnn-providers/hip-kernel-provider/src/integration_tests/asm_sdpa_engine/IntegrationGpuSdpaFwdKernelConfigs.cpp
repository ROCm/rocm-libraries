...
/**
 * @file IntegrationGpuSdpaFwdKernelConfigs.cpp
 * @brief Integration tests for all available ASM SDPA forward kernel configurations.
 *
 * This test suite iterates over all kernel configurations defined in cfg_fmha_fwd
 * and verifies that each configuration produces correct results using a compatible graph.
 */
...
class SdpaFwdKernelConfigs : public IntegrationGraphVerificationHarness<DataType, GraphTestCase>
{
protected:
...
using IntegrationGpuSdpaFwdKernelConfigsBf16 = SdpaFwdKernelConfigs<bfloat16>;

} // namespace

TEST_P(IntegrationGpuSdpaFwdKernelConfigsBf16, Correctness)
{
...
INSTANTIATE_TEST_SUITE_P(Smoke,
                         IntegrationGpuSdpaFwdKernelConfigsBf16,
