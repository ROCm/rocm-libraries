...
class BatchnormBackwardActivation
    : public IntegrationGraphVerificationHarness<
          DataType,
          std::tuple<hip_kernel_provider::test_bn_common::BatchnormTestCase,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(
        testing::ValuesIn(hip_kernel_provider::test_bn_common::getBnBwdTestCases()),
        testing::ValuesIn(test_activation_common::createBatchnormBwdActivationTestCases())));
INSTANTIATE_TEST_SUITE_P(
    Full,
    IntegrationGpuBatchnormBackwardActivationNchwFp32,
    testing::Combine(
        testing::ValuesIn(hip_kernel_provider::test_bn_common::getBnBwdFullTestCases()),
        testing::ValuesIn(test_activation_common::createBatchnormBwdActivationTestCases())));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(
        testing::ValuesIn(hip_kernel_provider::test_bn_common::getBnBwd3dTestCases()),
        testing::ValuesIn(test_activation_common::createBatchnormBwdActivationTestCases())));
