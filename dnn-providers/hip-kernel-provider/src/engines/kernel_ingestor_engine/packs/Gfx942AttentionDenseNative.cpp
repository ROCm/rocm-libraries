 ...
 *
 * Deprecated booleans win when set; otherwise the (left_bound, right_bound,
 * diagonal_alignment) trio is authoritative, with an unset bound meaning unbounded.
