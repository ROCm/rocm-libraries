...
class TestCpuHipFlash2FwdFP16Hd128CausalMha
    : public TestCpuHipFlash2FwdGoldenReference<half>
{
};
...
class TestCpuHipFlash2FwdFP16Hd128CausalGqa4
    : public TestCpuHipFlash2FwdGoldenReference<half>
{
};
...
class TestCpuHipFlash2FwdFP16Hd64Causal
    : public TestCpuHipFlash2FwdGoldenReference<half>
{
};
