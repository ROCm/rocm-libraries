...
class ProblemDescription
{
    ...
    static int64_t getStride(
        const hipdnn_flatbuffers_sdk::data_objects::TensorAttributes* x,
    ...
    static int64_t getInnerSize(const flatbuffers::Vector<int64_t>* xDims,
                                unsigned normalizeDim)
    {
        int64_t innerSize = 1;
