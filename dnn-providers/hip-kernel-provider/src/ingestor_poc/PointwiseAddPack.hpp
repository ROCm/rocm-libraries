 ...
 * @brief The descriptor set the kernel-ingestor POC ships, built in memory.
 *
...
/// @brief Builds this POC's descriptor set.
...
/// @brief Builds the state manager backing this POC's engine.
