...
for SQ in (4096,8192):
    ...
    ms=time_launches(ours,warmup=10,iters=50,stream=st)
    flop=2.0*(2.0*SQ*SQ*HD)*0.5*H
    print(f"DISPATCH SQ={SQ} block_size={BS} 4wgqa time={ms*1e3:.1f}us TF/s={flop/ms/1e12:.1f}",flush=True)
