...
def build():
    b = IRBuilder("e2eRaggedABI"); b.kernel.attrs["max_workgroup_size"] = 256
...
if __name__ == "__main__":
    ...
    art = compile_kernel(build(), arch="gfx942"); open("/home/AMD/avirgoel/wk/eRagABI.hsaco", "wb").write(art.hsaco); print("BUILT", art.kernel_name, "NSEQ", NSEQ, "TOTALQ", TOTALQ, "TOTALQB", TOTALQB, flush=True)
