...
def build():
    ...
    V_lds=b.smem_alloc(BF16,[64,264],name_hint="Vlds")  # +8 pad: break 128-dword bank collision
    ...
    with loop as (kv, carry):
        ...
        for nt in range(NDdim):
            ...
            for kk in range(NKpv):
                va=b.smem_load_vN(V_lds,b.add(b.mul(b.const_i32(kk),b.const_i32(K)),b.mul(ld.k_blk,b.const_i32(APL))),b.add(b.mul(b.const_i32(nt),b.const_i32(32)),ld.m_in_atom),dtype=BF16,n=APL)  # PROXY wide read (wrong numerics, right inst-count)
