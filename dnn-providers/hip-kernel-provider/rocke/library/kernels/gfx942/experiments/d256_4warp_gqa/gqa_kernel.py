...
def build():
    ...
    qhead=b.block_id_x(); kvh=b.div(qhead,b.const_i32(GQAG))  # GQA: CTA=query head
    V_lds=b.smem_alloc(BF16,[64,256],name_hint="Vlds")
    qr=b.buffer_rsrc(Q,b.const_i32(128*H*HD*2)); kr=b.buffer_rsrc(Kp,b.const_i32(NPHYS*BS*HKV*HD*2)); vr=b.buffer_rsrc(Vp,b.const_i32(NPHYS*BS*HKV*HD*2))
    ...
    for nt in range(NDdim):
        for i in range(CPL):
            ...
            oi=b.add(b.mul(b.add(wq,c),b.const_i32(H)),qhead)
