...
words for every format; FP4 uses eight meaningful words.
"""
...
# Catalog scope in the FP4 base; the sibling FP6 follow-up expands these pairs.
SCALED_WMMA_OPS = {
