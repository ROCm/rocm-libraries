                                     ...
                                     rocke_value_t* d_rsrc)
{
     ...
     * if p.groups > 1 else None  (Python PR #10064 _emit_direct_epilogue). */
    dctx.D_desc = D_desc;
                                          ...
                                          rocke_value_t* c0)
{
    ...
    rocke_value_t* k_out_group_base = rocke_conv_make_k_out_group_base(b, p);
    /* c_map = op.c_layout() */
                                       ...
                                       rocke_value_t* d_rsrc)
{
    ...
    /* D_desc = make_d_descriptor(p) */
    rocke_tensor_descriptor_t* D_desc = rocke_conv_make_d_descriptor(b, p);
    /* Grouped conv: k_out_group_base (Python PR #10064 _emit_cshuffle_epilogue). */
    rocke_conv_d_addr_ctx_t dctx;
    dctx.D_desc = D_desc;
    dctx.k_out_group_base = rocke_conv_make_k_out_group_base(b, p);
