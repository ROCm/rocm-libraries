...
static const rocke_ati_mma_frag_row_t rocke_ati_mma_frag[] = {
    ...
    {"wmma.scaled.16x16x128.src0_fp8e4m3_e8m0_b32.src1_fp8e4m3_e8m0_b32.src2_fp32.dst_fp32", 8},
    {"wmma.scaled.16x16x128.src0_bf8e5m2_e8m0_b32.src1_bf8e5m2_e8m0_b32.src2_fp32.dst_fp32", 8},
    {"wmma.scaled.16x16x128.src0_fp8e4m3_e8m0_b16.src1_fp8e4m3_e8m0_b16.src2_fp32.dst_fp32", 8},
    {"wmma.scaled.16x16x128.src0_bf8e5m2_e8m0_b16.src1_bf8e5m2_e8m0_b16.src2_fp32.dst_fp32", 8},
};
 ...
 * (canonical) catalog keys (interned strings from rocke_normalize_dtype), exactly as
...
static const rocke_mma_op_t k_mma_gfx950[] = {
    ...
    {"mma",
     {{"fp4e2m1", 16, NULL}, {"fp4e2m1", 16, NULL}, {"fp32", 4, NULL}},
     {"fp32", 4, NULL},
     16,
     16,
     128,
     ...
     64},
    {"mma",
     {{"fp6e2m3", 12, NULL}, {"fp6e2m3", 12, NULL}, {"fp32", 4, NULL}},
     {"fp32", 4, NULL},
     16,
     16,
     96,
...
static const rocke_mma_op_t k_mma_gfx1250[] = {
    ...
    {"wmma",
     ...
     32},
    {"wmma",
     {{"fp8e4m3", 8, NULL}, {"fp8e4m3", 8, NULL}, {"fp32", 8, &lm_wmma_gfx12_src2}},
     {"fp32", 8, &lm_wmma_gfx12_dst},
     16,
     16,
     64,
     ...
     32},
    {"wmma",
     {{"fp8e4m3", 8, NULL}, {"bf8e5m2", 8, NULL}, {"fp32", 8, &lm_wmma_gfx12_src2}},
     {"fp32", 8, &lm_wmma_gfx12_dst},
     16,
     16,
     64,
     ...
     32},
    {"wmma",
     {{"bf8e5m2", 8, NULL}, {"fp8e4m3", 8, NULL}, {"fp32", 8, &lm_wmma_gfx12_src2}},
     {"fp32", 8, &lm_wmma_gfx12_dst},
     16,
     16,
     64,
     ...
     32},
    {"wmma",
     {{"bf8e5m2", 8, NULL}, {"bf8e5m2", 8, NULL}, {"fp32", 8, &lm_wmma_gfx12_src2}},
     {"fp32", 8, &lm_wmma_gfx12_dst},
     16,
     16,
     64,
