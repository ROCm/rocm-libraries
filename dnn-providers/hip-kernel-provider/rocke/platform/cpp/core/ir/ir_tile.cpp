...
static const rocke_mma_hint_row_t ROCKE_MMA_RESULT_HINT[] = {
    ...
    {"wmma_scale_f32_16x16x128_fp8_bf8", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp8_fp6", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp8_bf6", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp8_fp4", "mxacc"},
    {"wmma_scale_f32_16x16x128_bf8_fp8", "mxacc"},
    {"wmma_scale_f32_16x16x128_bf8_bf8", "mxacc"},
    {"wmma_scale_f32_16x16x128_bf8_fp6", "mxacc"},
    {"wmma_scale_f32_16x16x128_bf8_bf6", "mxacc"},
    {"wmma_scale_f32_16x16x128_bf8_fp4", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp6_fp8", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp6_bf8", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp6_fp6", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp6_bf6", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp6_fp4", "mxacc"},
    {"wmma_scale_f32_16x16x128_bf6_fp8", "mxacc"},
    {"wmma_scale_f32_16x16x128_bf6_bf8", "mxacc"},
    {"wmma_scale_f32_16x16x128_bf6_fp6", "mxacc"},
    {"wmma_scale_f32_16x16x128_bf6_bf6", "mxacc"},
    {"wmma_scale_f32_16x16x128_bf6_fp4", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp4_fp8", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp4_bf8", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp4_fp6", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp4_bf6", "mxacc"},
    {"wmma_scale_f32_16x16x128_fp4_fp4", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp8_fp8", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp8_bf8", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp8_fp6", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp8_bf6", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp8_fp4", "mxacc"},
    {"wmma_scale16_f32_16x16x128_bf8_fp8", "mxacc"},
    {"wmma_scale16_f32_16x16x128_bf8_bf8", "mxacc"},
    {"wmma_scale16_f32_16x16x128_bf8_fp6", "mxacc"},
    {"wmma_scale16_f32_16x16x128_bf8_bf6", "mxacc"},
    {"wmma_scale16_f32_16x16x128_bf8_fp4", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp6_fp8", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp6_bf8", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp6_fp6", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp6_bf6", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp6_fp4", "mxacc"},
    {"wmma_scale16_f32_16x16x128_bf6_fp8", "mxacc"},
    {"wmma_scale16_f32_16x16x128_bf6_bf8", "mxacc"},
    {"wmma_scale16_f32_16x16x128_bf6_fp6", "mxacc"},
    {"wmma_scale16_f32_16x16x128_bf6_bf6", "mxacc"},
    {"wmma_scale16_f32_16x16x128_bf6_fp4", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp4_fp8", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp4_bf8", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp4_fp6", "mxacc"},
    {"wmma_scale16_f32_16x16x128_fp4_bf6", "mxacc"},
...
static rocke_value_t** rocke_build_mem_operands(rocke_ir_builder_t* b, rocke_value_t* smem,
                                                rocke_value_t* const* indices, int num_indices,
                                                rocke_value_t* value, bool with_value,
                                                int* out_count) {
...
rocke_value_t* rocke_b_smem_alloc_ex(rocke_ir_builder_t* b, const rocke_type_t* elem,
    ...
    return rocke_i_op1(b, ROCKE_OP_TILE_SMEM_ALLOC, NULL, 0, t, attrs_p,
    ...
    elem_name = value->type->elem->name;
    {
        ...
        if (!rocke_n_in(n, allowed, acount)) {
            rocke_i_set_err(b, ROCKE_ERR_VALUE,
                            "unsupported vector width for smem_store_vN of %s: %d", elem_name, n);
            return;
        }
    }
...
rocke_value_t* rocke_b_smem_load_vN(rocke_ir_builder_t* b, rocke_value_t* smem,
    ...
    if (num_indices <= 0) {
        return (rocke_value_t*)rocke_i_set_err(b, ROCKE_ERR_VALUE,
                                               "smem_load_vN needs at least one index");
    }
...
rocke_value_t* rocke_b_smem_load_vN_f32(rocke_ir_builder_t* b, rocke_value_t* smem,
    ...
    if (num_indices <= 0) {
        return (rocke_value_t*)rocke_i_set_err(b, ROCKE_ERR_VALUE,
                                               "smem_load_vN_f32 needs at least one index");
    }
...
#define ROCKE_MMA_WRAP(fn, opid)                                                  \
    rocke_value_t* fn(rocke_ir_builder_t* b, rocke_value_t* a, rocke_value_t* bb, \
                      rocke_value_t* c) {                                         \
...
rocke_value_t* rocke_b_register_p_from_qk_c(rocke_ir_builder_t* b, rocke_value_t* qk_c,
    ...
    if (!target_dtype ||
        ...
        return (rocke_value_t*)rocke_i_set_err(
            b, ROCKE_ERR_VALUE, "register_p_from_qk_c target must be f16/bf16, got %s",
...
rocke_op_t* rocke_b_inline_asm(rocke_ir_builder_t* b, const char* asm_template,
    ...
    return rocke_i_op(b, ROCKE_OP_TILE_INLINE_ASM, operands, num_operands, result_types,
                      num_results, &attrs, NULL, 0, "asm", NULL);
}
...
rocke_op_t* rocke_b_inline_asm_multi(rocke_ir_builder_t* b, const char* asm_template,
    ...
    return rocke_b_inline_asm(b, asm_template, constraints, operands, num_operands, result_types,
                              num_results, opts);
}
...
static void rocke_b_gfx1250_scalar_control(rocke_ir_builder_t* b, const char* mnemonic, int imm) {
    ...
    rocke_op_t* op;
    const char* text;
    if (!rocke_i_live(b)) return;
    if (imm < 0 || imm > 0xFFFF) {
        rocke_i_set_err(b, ROCKE_ERR_VALUE, "%s imm must fit an unsigned i16 (0..65535), got %d",
                        mnemonic, imm);
        return;
    }
...
rocke_value_t* rocke_b_exec_and_saveexec(rocke_ir_builder_t* b, rocke_value_t* mask) {
    if (!rocke_i_live(b) || !mask) return NULL;
    const rocke_type_t* i64_t = rocke_i64();
    rocke_op_t* op = rocke_i_op(b, ROCKE_OP_TILE_EXEC_AND_SAVEEXEC, &mask, 1, &i64_t, 1, NULL, NULL,
                                0, "exec_save", NULL);
    return op ? op->results[0] : NULL;
}

rocke_value_t* rocke_b_exec_xor(rocke_ir_builder_t* b, rocke_value_t* saved) {
    if (!rocke_i_live(b) || !saved) return NULL;
    const rocke_type_t* i64_t = rocke_i64();
    rocke_op_t* op = rocke_i_op(b, ROCKE_OP_TILE_EXEC_XOR, &saved, 1, &i64_t, 1, NULL, NULL, 0,
                                "exec_compl", NULL);
    return op ? op->results[0] : NULL;
}

rocke_value_t* rocke_b_exec_or_saveexec(rocke_ir_builder_t* b, rocke_value_t* compl_v) {
    if (!rocke_i_live(b) || !compl_v) return NULL;
    const rocke_type_t* i64_t = rocke_i64();
    rocke_op_t* op = rocke_i_op(b, ROCKE_OP_TILE_EXEC_OR_SAVEEXEC, &compl_v, 1, &i64_t, 1, NULL,
                                NULL, 0, "exec_tmp", NULL);
    return op ? op->results[0] : NULL;
}

void rocke_b_exec_or(rocke_ir_builder_t* b, rocke_value_t* saved) {
    if (!rocke_i_live(b) || !saved) return;
