 ...
 *
 *   - ROCKE_LL_DATALAYOUT / ROCKE_LL_TRIPLE          (Python _DATALAYOUT /
 * _TRIPLE)
 ...
 * LLVM 22 by one field -- it emits the ELF symbol-mangling spec m:e that LLVM
 * 22 omits. The p8-indexed layout is otherwise identical (Python
 * _DATALAYOUT_LLVM23). */
...
const rocke_ll_decl_t ROCKE_LL_INTRINSIC_DECLS[] = {
    ...
    {"global.load.async.to.lds.b64",
     "declare void @llvm.amdgcn.global.load.async.to.lds.b64(ptr addrspace(1) "
     "nocapture, ptr "
     "addrspace(3) nocapture, i32 immarg, i32 immarg)"},
    {"global.load.async.to.lds.b128",
     "declare void @llvm.amdgcn.global.load.async.to.lds.b128(ptr addrspace(1) "
     "nocapture, ptr "
     "addrspace(3) nocapture, i32 immarg, i32 immarg)"},
    ...
    {"fmuladd.v2f32",
     "declare <2 x float> @llvm.fmuladd.v2f32(<2 x float>, <2 "
     "x float>, <2 x float>)"},
    {"fmuladd.v4f32",
     "declare <4 x float> @llvm.fmuladd.v4f32(<4 x float>, <4 "
     "x float>, <4 x float>)"},
    {"fmuladd.v8f32",
     "declare <8 x float> @llvm.fmuladd.v8f32(<8 x float>, <8 "
     "x float>, <8 x float>)"},
    {"fmuladd.v16f32",
     "declare <16 x float> @llvm.fmuladd.v16f32(<16 x "
     "float>, <16 x float>, <16 x float>)"},
    {"fmuladd.v2f16",
     "declare <2 x half> @llvm.fmuladd.v2f16(<2 x half>, <2 x "
     "half>, <2 x half>)"},
    {"fmuladd.v4f16",
     "declare <4 x half> @llvm.fmuladd.v4f16(<4 x half>, <4 x "
     "half>, <4 x half>)"},
    {"fmuladd.v8f16",
     "declare <8 x half> @llvm.fmuladd.v8f16(<8 x half>, <8 x "
     "half>, <8 x half>)"},
    {"fmuladd.v2bf16",
     "declare <2 x bfloat> @llvm.fmuladd.v2bf16(<2 x "
     "bfloat>, <2 x bfloat>, <2 x bfloat>)"},
    {"fmuladd.v4bf16",
     "declare <4 x bfloat> @llvm.fmuladd.v4bf16(<4 x "
     "bfloat>, <4 x bfloat>, <4 x bfloat>)"},
    {"fmuladd.v8bf16",
     "declare <8 x bfloat> @llvm.fmuladd.v8bf16(<8 x "
     "bfloat>, <8 x bfloat>, <8 x bfloat>)"},
    {"wmma.f32.16x16x16.f16",
     "declare <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.f16.v8f32.v16f16(<16 "
     "x half>, <16 x "
     "half>, <8 x float>)"},
    {"wmma.f32.16x16x16.bf16",
     "declare <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v16i16(<16 "
     "x i16>, <16 x i16>, "
     "<8 x float>)"},
    {"wmma.i32.16x16x16.iu8",
     "declare <8 x i32> @llvm.amdgcn.wmma.i32.16x16x16.iu8.v8i32.v4i32(i1, <4 "
     "x i32>, i1, <4 x "
     "i32>, <8 x i32>, i1)"},
    {"wmma.i32.16x16x16.iu4",
     "declare <8 x i32> @llvm.amdgcn.wmma.i32.16x16x16.iu4.v8i32.v2i32(i1, <2 "
     "x i32>, i1, <2 x "
     "i32>, <8 x i32>, i1)"},
    {"wmma.gfx12.f32.16x16x16.f16",
     "declare <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.f16.v8f32.v8f16(<8 x "
     "half>, <8 x half>, "
     "<8 x float>)"},
    {"wmma.gfx12.f32.16x16x16.bf16",
     "declare <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v8i16(<8 x "
     "i16>, <8 x i16>, <8 "
     "x float>)"},
    {"wmma.gfx1250.f32.16x16x32.f16",
     "declare <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.f16.v8f32.v16f16(i1 "
     "immarg, <16 x half>, "
     "i1 immarg, <16 x half>, i16 immarg, <8 x float>, i1 immarg, i1 immarg)"},
    {"wmma.gfx1250.f32.16x16x32.bf16",
     "declare <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.bf16.v8f32.v16bf16(i1 "
     "immarg, <16 x "
     "bfloat>, i1 immarg, <16 x bfloat>, i16 immarg, <8 x float>, i1 immarg, "
     "i1 immarg)"},
    {"wmma.gfx1250.f32.16x16x64.fp8.fp8",
     "declare <8 x float> "
     "@llvm.amdgcn.wmma.f32.16x16x64.fp8.fp8.v8f32.v8i32(<8 x i32>, <8 x i32>, "
     "i16 immarg, <8 x float>, i1 immarg, i1 immarg)"},
    {"wmma.gfx1250.f32.16x16x64.fp8.bf8",
     "declare <8 x float> "
     "@llvm.amdgcn.wmma.f32.16x16x64.fp8.bf8.v8f32.v8i32(<8 x i32>, <8 x i32>, "
     "i16 immarg, <8 x float>, i1 immarg, i1 immarg)"},
    {"wmma.gfx1250.f32.16x16x64.bf8.fp8",
     "declare <8 x float> "
     "@llvm.amdgcn.wmma.f32.16x16x64.bf8.fp8.v8f32.v8i32(<8 x i32>, <8 x i32>, "
     "i16 immarg, <8 x float>, i1 immarg, i1 immarg)"},
    {"wmma.gfx1250.f32.16x16x64.bf8.bf8",
     "declare <8 x float> "
     "@llvm.amdgcn.wmma.f32.16x16x64.bf8.bf8.v8f32.v8i32(<8 x i32>, <8 x i32>, "
     "i16 immarg, <8 x float>, i1 immarg, i1 immarg)"},
    {"mfma.f32.16x16x16f16",
     "declare <4 x float> @llvm.amdgcn.mfma.f32.16x16x16f16(<4 x half>, <4 x "
     "half>, <4 x float>, "
     "i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.16x16x32.f16",
     "declare <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.f16(<8 x half>, <8 x "
     "half>, <4 x float>, "
     "i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.16x16x16bf16.1k",
     "declare <4 x float> @llvm.amdgcn.mfma.f32.16x16x16bf16.1k(<4 x i16>, <4 "
     "x i16>, <4 x float>, "
     "i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.16x16x32.bf16",
     "declare <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.bf16(<8 x bfloat>, <8 "
     "x bfloat>, <4 x "
     "float>, i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.32x32x8f16",
     "declare <16 x float> @llvm.amdgcn.mfma.f32.32x32x8f16(<4 x half>, <4 x "
     "half>, <16 x float>, "
     "i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.32x32x8bf16.1k",
     "declare <16 x float> @llvm.amdgcn.mfma.f32.32x32x8bf16.1k(<4 x i16>, <4 "
     "x i16>, <16 x "
     "float>, i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.32x32x16.f16",
     "declare <16 x float> @llvm.amdgcn.mfma.f32.32x32x16.f16(<8 x half>, <8 x "
     "half>, <16 x "
     "float>, i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.16x16x4f32",
     "declare <4 x float> @llvm.amdgcn.mfma.f32.16x16x4f32(float, float, <4 x "
     "float>, i32 immarg, "
     "i32 immarg, i32 immarg)"},
    {"mfma.f32.32x32x2f32",
     "declare <16 x float> @llvm.amdgcn.mfma.f32.32x32x2f32(float, float, <16 "
     "x float>, i32 "
     "immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.4x4x4f16",
     "declare <4 x float> @llvm.amdgcn.mfma.f32.4x4x4f16(<4 x half>, <4 x "
     "half>, <4 x float>, i32 "
     "immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.16x16x32.fp8.fp8",
     "declare <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(<2 x i32>, <2 "
     "x i32>, <4 x "
     "float>, i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.16x16x32.bf8.bf8",
     "declare <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.bf8.bf8(<2 x i32>, <2 "
     "x i32>, <4 x "
     "float>, i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.32x32x16.fp8.fp8",
     "declare <16 x float> @llvm.amdgcn.mfma.f32.32x32x16.fp8.fp8(<2 x i32>, "
     "<2 x i32>, <16 x "
     "float>, i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.f32.32x32x16.bf8.bf8",
     "declare <16 x float> @llvm.amdgcn.mfma.f32.32x32x16.bf8.bf8(<2 x i32>, "
     "<2 x i32>, <16 x "
     "float>, i32 immarg, i32 immarg, i32 immarg)"},
    ...
    {"update.dpp.i32",
     "declare i32 @llvm.amdgcn.update.dpp.i32(i32, i32, i32 "
     "immarg, i32 immarg, i32 immarg, i1 "
     "immarg)"},
    ...
    {"ds.load.tr16.b128.v8bf16",
     "declare <8 x bfloat> @llvm.amdgcn.ds.load.tr16.b128.v8bf16(ptr "
     "addrspace(3))"},
    {"ds.load.tr16.b128.v8f16",
     "declare <8 x half> @llvm.amdgcn.ds.load.tr16.b128.v8f16(ptr "
     "addrspace(3))"},
    {"iglp.opt", "declare void @llvm.amdgcn.iglp.opt(i32 immarg)"},
    {"sched.barrier", "declare void @llvm.amdgcn.sched.barrier(i32 immarg)"},
    {"sched.group.barrier",
     "declare void @llvm.amdgcn.sched.group.barrier(i32 "
     "immarg, i32 immarg, i32 immarg)"},
    {"s.setprio", "declare void @llvm.amdgcn.s.setprio(i16 immarg)"},
    {"s.waitcnt", "declare void @llvm.amdgcn.s.waitcnt(i32 immarg)"},
    {"make.buffer.rsrc.p1",
     "declare ptr addrspace(8) @llvm.amdgcn.make.buffer.rsrc.p1(ptr "
     "addrspace(1) nocapture "
     "readnone, i16, i32, i32)"},
    {"raw.ptr.buffer.load.lds",
     "declare void @llvm.amdgcn.raw.ptr.buffer.load.lds(ptr addrspace(8) "
     "nocapture readonly, ptr "
     "addrspace(3) nocapture, i32, i32, i32, i32 immarg, i32 immarg)"},
    {"global.load.lds",
     "declare void @llvm.amdgcn.global.load.lds(ptr addrspace(1) nocapture "
     "readonly, ptr "
     "addrspace(3) nocapture, i32 immarg, i32 immarg, i32 immarg)"},
    {"raw.ptr.buffer.load.v2i32",
     "declare <2 x i32> @llvm.amdgcn.raw.ptr.buffer.load.v2i32(ptr "
     "addrspace(8) nocapture "
     "readonly, i32, i32, i32 immarg)"},
    {"raw.ptr.buffer.load.v4i32",
     "declare <4 x i32> @llvm.amdgcn.raw.ptr.buffer.load.v4i32(ptr "
     "addrspace(8) nocapture "
     "readonly, i32, i32, i32 immarg)"},
    {"raw.ptr.buffer.load.i32",
     "declare i32 @llvm.amdgcn.raw.ptr.buffer.load.i32(ptr addrspace(8) "
     "nocapture readonly, i32, "
     "i32, i32 immarg)"},
    {"raw.ptr.buffer.load.i16",
     "declare i16 @llvm.amdgcn.raw.ptr.buffer.load.i16(ptr addrspace(8) "
     "nocapture readonly, i32, "
     "i32, i32 immarg)"},
    ...
    {"raw.ptr.buffer.store.v2i32",
     "declare void @llvm.amdgcn.raw.ptr.buffer.store.v2i32(<2 x i32>, ptr "
     "addrspace(8) nocapture "
     "writeonly, i32, i32, i32 immarg)"},
    {"raw.ptr.buffer.store.v4i32",
     "declare void @llvm.amdgcn.raw.ptr.buffer.store.v4i32(<4 x i32>, ptr "
     "addrspace(8) nocapture "
     "writeonly, i32, i32, i32 immarg)"},
    {"raw.ptr.buffer.store.i16",
     "declare void @llvm.amdgcn.raw.ptr.buffer.store.i16(i16, ptr addrspace(8) "
     "nocapture "
     "writeonly, i32, i32, i32 immarg)"},
    ...
    {"amdgcn.permlane32.swap",
     "declare { i32, i32 } @llvm.amdgcn.permlane32.swap(i32, i32, i1 immarg, "
     "i1 immarg)"},
    /* Overloaded on the data type; see the amdgcn.permlane16 note below. */
    {"amdgcn.permlanex16",
     "declare i32 @llvm.amdgcn.permlanex16.i32(i32, i32, "
     "i32, i32, i1 immarg, i1 immarg)"},
    {"mfma.f32.32x32x16.bf16",
     "declare <16 x float> @llvm.amdgcn.mfma.f32.32x32x16.bf16(<8 x bfloat>, "
     "<8 x bfloat>, <16 x "
     "float>, i32 immarg, i32 immarg, i32 immarg)"},
    {"mfma.scale.f32.16x16x128.f8f6f4",
     "declare <4 x float> @llvm.amdgcn.mfma.scale.f32.16x16x128.f8f6f4(<8 x "
     "i32>, <8 x i32>, <4 x "
     "float>, i32 immarg, i32 immarg, i32 immarg, i32 immarg, i32, i32 immarg, "
     "i32, i32 immarg)"},
    {"mfma.f32.16x16x128.fp4",
     "declare <4 x float> @llvm.amdgcn.mfma.f32.16x16x128.fp4(i64, i64, <4 x "
     "float>, i32 immarg, "
     "i32 immarg, i32 immarg)"},
    {"mfma.f32.16x16x96.fp6",
     "declare <4 x float> @llvm.amdgcn.mfma.f32.16x16x96.fp6(<3 x i32>, <3 x "
     "i32>, <4 x float>, "
     "i32 immarg, i32 immarg, i32 immarg)"},
    ...
    {"raw.ptr.buffer.load.async.lds",
     "declare void @llvm.amdgcn.raw.ptr.buffer.load.async.lds(ptr addrspace(8) "
     "nocapture readonly, "
     "ptr addrspace(3) nocapture, i32, i32, i32, i32 immarg, i32 immarg)"},
    {"global.load.async.to.lds.b8",
     "declare void @llvm.amdgcn.global.load.async.to.lds.b8(ptr addrspace(1) "
     "nocapture, ptr "
     "addrspace(3) nocapture, i32 immarg, i32 immarg)"},
    ...
    {"amdgcn.permlane16",
     "declare i32 @llvm.amdgcn.permlane16.i32(i32, i32, "
     "i32, i32, i1 immarg, i1 immarg)"},
    ...
    {"av.load.b128.p1",
     "declare <4 x i32> @llvm.amdgcn.av.load.b128.p1(ptr "
     "addrspace(1), metadata)"},
    {"av.store.b128.p0", "declare void @llvm.amdgcn.av.store.b128.p0(ptr, <4 x i32>, metadata)"},
    {"av.store.b128.p1",
     "declare void @llvm.amdgcn.av.store.b128.p1(ptr "
     "addrspace(1), <4 x i32>, metadata)"},
