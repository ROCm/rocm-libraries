...
> **Worked end-to-end example.** [`add_ir_op_walkthrough.md`](add_ir_op_walkthrough.md) adds a real op (`math.floor` → `llvm.floor.f32`) across every touchpoint below, with concrete line references. Read it alongside this recipe.
