...
per-lane operand length `n` is 8 for `32x32x16` and `16x16x32`, and 4 for
`16x16x16` and `32x32x8`; the builders carry it into `_tr_frag` rather
...
length that is not a multiple of 4 outright.
