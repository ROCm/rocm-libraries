...
Quantized-weight GEMM: `matmul_nbits.py` ships `MatMulNBitsSpec` for fp16
activations and packed-int4 weights with group size 32. Its validator accepts
gfx1151 and gfx1201.

Deep fusion: `deep_fused_conv_pool.py` ships the conv -> epilogue -> conv ->
maxpool prototype. gfx950 and gfx1201 use the shared target-selected `MmaOp`
body; gfx1151 has a target-specific implementation.
