...
static int make_spec(int idx, ckc_rmsnorm2d_spec_t *s) {
    *s = ckc_rmsnorm2d_spec_default();
    ...
    case 0: /* N1024 b256 v4 f16 */
        s->n_per_block = 1024; s->block_size = 256; s->vec = 4;
        s->dtype = "f16";  s->save_inv_rms = false;
        break;
    case 1: /* N2048 b256 v4 bf16 */
        s->n_per_block = 2048; s->block_size = 256; s->vec = 4;
        s->dtype = "bf16"; s->save_inv_rms = false;
        break;
    case 2: /* N4096 b256 v4 f16 */
        s->n_per_block = 4096; s->block_size = 256; s->vec = 4;
        s->dtype = "f16";  s->save_inv_rms = false;
        break;
    case 3: /* N8192 b256 v8 bf16 */
        s->n_per_block = 8192; s->block_size = 256; s->vec = 8;
        s->dtype = "bf16"; s->save_inv_rms = false;
        break;
    case 4: /* N16384 b256 v8 f16 save_inv_rms */
        s->n_per_block = 16384; s->block_size = 256; s->vec = 8;
        s->dtype = "f16";  s->save_inv_rms = true;
        break;
    case 5: /* N131072 b256 v4 f16 (two-pass) */
        s->n_per_block = 131072; s->block_size = 256; s->vec = 4;
        s->dtype = "f16";  s->save_inv_rms = false;
        break;
    default:
        return -1;
