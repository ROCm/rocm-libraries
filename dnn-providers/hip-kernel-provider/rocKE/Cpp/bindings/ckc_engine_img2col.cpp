...
/*
 * bindings/ckc_engine_img2col.cpp -- img2col family bindings for the ckc_engine
 * module. Kept in its own translation unit because the img2col helper header
 * defines its own struct ckc_conv_problem (a peer copy of the conv
...
ckc_img2col_spec_t build_spec(const py::dict& d, std::deque<std::string>& store)
{
    ...
    ckc_img2col_spec_t s = ckc_img2col_spec_default();
