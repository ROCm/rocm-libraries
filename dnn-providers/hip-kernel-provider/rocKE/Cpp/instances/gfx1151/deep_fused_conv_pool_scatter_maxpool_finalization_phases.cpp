...
static void ckc_gfx1151_dfcp_finalquant_body(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                                             ckc_value_t* c1_smem,
                                             ckc_value_t* y_ptr,
                                             int out_k,
                                             int words,
...
static void ckc_gfx1151_dfcp_finalpack_i8_body(ckc_gfx1151_dfcp_build_ctx_t* ctx,
                                               ckc_value_t* c1_smem,
                                               ckc_value_t* y_ptr,
                                               int out_k,
                                               int words,
