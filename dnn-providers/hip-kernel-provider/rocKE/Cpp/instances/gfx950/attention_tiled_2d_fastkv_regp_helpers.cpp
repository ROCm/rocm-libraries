    ...
    return ckc::guard_builder(b, [&]() -> ckc_kernel_def_t* {
        ...
        if(!spec->use_fast_paged_kv_desc)
        {
            ckc__fastkv_regp_set_err(
                b, CKC_ERR_VALUE, "fastKV register-P experiment requires use_fast_paged_kv_desc");
            return NULL;
        }
        ...
        {
            ckc__fastkv_regp_set_err(
                b, CKC_ERR_VALUE, "fastKV register-P experiment requires transposed R4");
            return NULL;
        }
        ...
        {
            ckc__fastkv_regp_set_err(
                b, CKC_ERR_VALUE, "fastKV register-P experiment does not support FP8 KV cache");
            return NULL;
        }
