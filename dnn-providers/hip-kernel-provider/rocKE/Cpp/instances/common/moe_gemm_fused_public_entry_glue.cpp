...
ckc_kernel_def_t* ckc_build_moe_interleaved_gate_up_silu_gemm(
    ckc_ir_builder_t* b, const ckc_moe_interleaved_gate_up_silu_gemm_spec_t* spec, const char* arch)
{
...
static ckc_status_t ckc_moe_sig_emit(
    const ckc_sig_entry_t* items, size_t n, ckc_sig_entry_t* out, size_t out_cap, size_t* out_count)
{
    size_t i;
