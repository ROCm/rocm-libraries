                                          ...
                                          ckc_value_t* const* up_res)
{
    ...
    ckc_value_t* warp_m_off = ckc_b_mul(
        b, ctx->warp_m_idx, ckc_b_const_i32(b, (int64_t)ctx->mfmas_m * ctx->t.warp_tile_m));
    ckc_value_t* warp_n_off = ckc_b_mul(
        b, ctx->warp_n_idx, ckc_b_const_i32(b, (int64_t)ctx->mfmas_n * ctx->t.warp_tile_n));

    ckc_moe_cwarp_decode_t cdec;
    if(!ckc_moe_cwarp_decode_init(&cdec, b, ctx->u_gu, warp_m_off, warp_n_off, ctx->lane))
    {
