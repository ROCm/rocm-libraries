 ...
 *
 * ckc/instance_gfx1151_wmma_gemm_int8.h -- C99 port of the gfx1151
 ...
 * ckc_b_block_id_y, ckc_b_zero_vec_f32, ckc_b_scf_for_iter, ckc_b_global_load_vN
 * (with ckc_i8()), ckc_b_vec_pack, ckc_b_sext, ckc_b_sitofp_f32,
 * ckc_b_cast_f32_to, ckc_b_wmma_f32_16x16x16_f16, ckc_b_scf_yield,
 * ckc_b_vec_extract, ckc_b_fmul, ckc_b_trunc_f32_to_f16, ckc_b_global_store,
 * ckc_b_ret), ckc/helper_ck_dsl.core.arch.h for the is_valid_spec MMA-catalog
 * gate + wave_size, and ckc/helper_ck_dsl.helpers.spec.h for kernel_name_join.
 *
 ...
 */
#ifndef CKC_INSTANCE_GFX1151_WMMA_GEMM_INT8_H
#define CKC_INSTANCE_GFX1151_WMMA_GEMM_INT8_H
...
#endif /* CKC_INSTANCE_GFX1151_WMMA_GEMM_INT8_H */
