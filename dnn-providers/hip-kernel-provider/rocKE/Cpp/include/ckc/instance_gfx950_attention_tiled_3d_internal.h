 ...
 *
 * ckc/instance_gfx950_attention_tiled_3d_internal.h -- PRIVATE shared state +
 * phase-function contract for the C99 port of the gfx950 WIDE-K tiled split-KV
 * 3D attention kernels (ck_dsl/instances/gfx950/attention_tiled_3d.py):
 *
 ...
 * ckc_gfx950_attention_tiled_3d_build_ctx_t, which holds EXACTLY the set of
 ...
 *   `ckc_gfx950_attention_tiled_3d_` prefix.
 *
 * WIDE-K MFMA DISPATCH. mfma_16x16x32_for_dtype / mfma_16x16x16_for_dtype /
 * warp_xor_reduce_max are ck_dsl.helpers.attention symbols. The 16x16x16 +
 * wave64 reductions + softcap + binary-search ports live in
 * helper_helper_ck_dsl.helpers.attention.h; warp_xor_reduce_sum +
 * dequant_fp8x8_to_dtype in helper_ck_dsl.helpers.attention.h. The wide-K
 ...
 * ckc/instance_gfx950_attention_tiled_3d.h.
 */
#ifndef CKC_INSTANCE_GFX950_ATTENTION_TILED_3D_INTERNAL_H
#define CKC_INSTANCE_GFX950_ATTENTION_TILED_3D_INTERNAL_H
...
typedef struct ckc_gfx950_attention_tiled_3d_build_ctx
{
    ...
    ckc_bound_transpose_lds_reader_t* pv_tr_reader;
 ...
 * by ckc_..._emit_early_zero_fill, called from here in Python order at line 416.) */
...
void ckc_gfx950_attention_tiled_3d_emit_softmax_loop(
    ckc_gfx950_attention_tiled_3d_build_ctx_t* ctx);
...
#endif /* CKC_INSTANCE_GFX950_ATTENTION_TILED_3D_INTERNAL_H */
