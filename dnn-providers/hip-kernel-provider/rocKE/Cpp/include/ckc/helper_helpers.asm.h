 ...
 *
 * ckc/helper_helpers.asm.h -- C99 port of ck_dsl.helpers.asm.
 *
 * Typed AMDGPU inline-asm helpers (NEW, additive -- golden-safe). This module
 * wraps `ckc_b_inline_asm` / `ckc_b_inline_asm_multi` with named, typed helpers
 ...
 * unaffected.
 */
#ifndef CKC_HELPER_HELPERS_ASM_H
#define CKC_HELPER_HELPERS_ASM_H
...
#define CKC_MFMA_F8F6F4_HAZARD_NOP 8
 ...
 *     CKC_MFMA_F8F6F4_HAZARD_NOP for the default, or 0 to suppress it).
 *
...
#endif /* CKC_HELPER_HELPERS_ASM_H */
