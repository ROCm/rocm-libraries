 ...
 *
 * ckc/helper_ck_dsl.helpers.io.h -- C99 port of ck_dsl.helpers.io.
 *
 ...
 *
 *   ckc_io_ir_type(dtype)
 *       Pure map. Returns the interned scalar singleton (ckc_f16()/ckc_bf16())
 ...
 */
#ifndef CKC_HELPER_CK_DSL_HELPERS_IO_H
#define CKC_HELPER_CK_DSL_HELPERS_IO_H
 ...
 *
 * Accepts "f16", "fp16" (alias) -> ckc_f16(); "bf16" -> ckc_bf16().
...
/* Builder-aware variant. Same mapping as ckc_io_ir_type, but on an unsupported
 * dtype it sets the builder's sticky error (CKC_ERR_VALUE) with the
...
/* C99 port of ck_dsl.helpers.io.store_scalar_from_f32:
 *
 ...
 * No-op when the builder is already in an error state, like every ckc_b_* call. */
...
/* C99 port of ck_dsl.helpers.io.load_scalar:
 *
...
/* C99 port of ck_dsl.helpers.io.load_vec:
 *
...
/* C99 port of ck_dsl.helpers.io.load_lane_slice_f32:
 *
...
/* C99 port of ck_dsl.helpers.io.store_vec:
 *
...
/* C99 port of ck_dsl.helpers.io.pack_f32_to:
 *
...
#endif /* CKC_HELPER_CK_DSL_HELPERS_IO_H */
