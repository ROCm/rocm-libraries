...
:mod:`ck_dsl.instances.common.matmul_nbits`.
...
class MatMulNBitsSpec(WarpTileBlockSizeMixin):
    ...
    :class:`~ck_dsl.instances.common.gemm_universal.TileSpec` so naming, grid,
...
def validate_common_spec(
    ...
    checks live in :func:`ck_dsl.instances.common.matmul_nbits.is_valid_spec`.
    """
...
# :func:`ck_dsl.helpers.i4_dequant.unpack_i4_byte_to_pair_f32` (low nibble
