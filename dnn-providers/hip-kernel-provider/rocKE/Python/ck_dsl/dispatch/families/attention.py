...
Worked implementation mirroring :mod:`ck_dsl.dispatch.gemm.bf16_rcr`, backed by
:mod:`ck_dsl.instances.common.attention_unified` (the unified tiled FMHA
emitter).
...
(:func:`ck_dsl.helpers.attention.use_2d_kernel`, surfaced as
...
class AttentionSpec:
    ...
    num_query_heads: int
    num_kv_heads: int
    name: str = "ck_dsl_attention_unified"
