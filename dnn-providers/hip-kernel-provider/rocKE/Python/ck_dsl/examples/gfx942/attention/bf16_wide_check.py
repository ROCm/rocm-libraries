...
Run:  python ck_dsl/examples/gfx942/attention/bf16_wide_check.py
"""
...
from ck_dsl import compile_kernel  # noqa: E402
from ck_dsl.instances import build_unified_attention_2d_tiled  # noqa: E402
from ck_dsl.instances.gfx942.attention_tiled_2d import (  # noqa: E402
    UnifiedAttention2DTiledSpec,
)
from ck_dsl.instances.common.attention_unified import _attn_signature  # noqa: E402
from ck_dsl.runtime import KernelLauncher  # noqa: E402
...
def run_ck(s, data, launcher, spec, warmup, attempts):
    return H._run_ck_dsl(s, data, launcher, spec, warmup=warmup, attempts=attempts)
...
def flash_ms(s, data, warmup, attempts):
    ...
    from ck_dsl.runtime import time_launches
