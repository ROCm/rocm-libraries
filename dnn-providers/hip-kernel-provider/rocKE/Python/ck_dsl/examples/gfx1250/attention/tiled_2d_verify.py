...
Requires ``ml_dtypes`` for bf16 / fp8e4m3 host encoding:
    ...
    /tmp/ckdsl_gfx1250/venv/bin/python -m pip -q install ml_dtypes

Run on a gfx1250 device:

    export PATH=/opt/rocm/bin:$PATH
    export LD_LIBRARY_PATH=/opt/rocm/lib:/opt/rocm/lib64:$LD_LIBRARY_PATH
    export PYTHONPATH=/tmp/ckdsl_gfx1250/python
    HIP_VISIBLE_DEVICES=3 python -m \\
        ck_dsl.examples.gfx1250.attention.tiled_2d_verify --scenario sw
"""
