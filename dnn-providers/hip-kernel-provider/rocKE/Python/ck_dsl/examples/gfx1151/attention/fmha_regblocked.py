...
:class:`~ck_dsl.helpers.WmmaTensor` (one SSA vector, no f32 cast), each
``m_repeat * n_repeat`` matmul is one :func:`~ck_dsl.helpers.wmma_mma`, the
...
:func:`~ck_dsl.helpers.store_wmma_tile`. The cooperative K/V LDS staging and the
