...
>   `python -c "import torch; from ck_dsl.runtime.comgr import resolved_lib_rocm_version as v; assert v()==(7,2)"`.
...
> bug was fixed (`_run_ck_dsl` had force-built the 2D MFMA kernel for
