...
# Adds a subdirectory to the build with a status message, and optionally checks for an expected
# target.
#
# Usage: add_subdirectory_with_message(COMPONENT <component> PREFIX_PATH <prefix> [EXPECT_TARGET
# <target>])
#
# Arguments: COMPONENT <component>  - Component name (e.g., "mxdatagenerator"). PREFIX_PATH <prefix>
# - Path prefix (e.g., "shared", "projects"). EXPECT_TARGET <target> - Optional target name produced
# by the subdirectory.
