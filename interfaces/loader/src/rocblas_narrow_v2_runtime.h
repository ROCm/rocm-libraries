...
rocblas_datatype narrow_v2_pointer_type(Pointer) noexcept {
    ...
    using Element1 = std::conditional_t<std::is_pointer_v<std::remove_cv_t<Element0>>,
...
rocm_blas_v2_scalar narrow_v2_scalar(rocblas_handle handle, Pointer pointer,
    ...
    return {narrow_v2_header(sizeof(rocm_blas_v2_scalar)), type,
            narrow_v2_pointer_mode(handle), pointer};
}
...
rocblas_status narrow_v2_dispatch(rocblas_handle, const rocm_blas_v2_vector_transform_request*) noexcept;
rocblas_status narrow_v2_dispatch(rocblas_handle, const rocm_blas_v2_vector_reduce_request*) noexcept;
rocblas_status narrow_v2_dispatch(rocblas_handle, const rocm_blas_v2_rotation_request*) noexcept;
rocblas_status narrow_v2_dispatch(rocblas_handle, const rocm_blas_v2_matrix_vector_request*) noexcept;
...
rocblas_status narrow_v2_dispatch(rocblas_handle, const rocm_blas_v2_structured_matrix_request*) noexcept;
rocblas_status narrow_v2_dispatch(rocblas_handle, const rocm_blas_v2_triangular_matrix_request*) noexcept;
rocblas_status narrow_v2_dispatch(rocblas_handle, const rocm_blas_v2_matrix_transform_request*) noexcept;
