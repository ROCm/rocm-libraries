...
foreach(provider IN ITEMS BLAS_PROVIDER COMBINED_BLAS_PROVIDER BLASLT_PROVIDER SOLVER_PROVIDER RAND_PROVIDER ROCBLAS_BRIDGE_PROVIDER BLAS_NARROW_V2_PROVIDER)
  read_exports("${${provider}}" actual_provider provider_pairs)
  ...
  assert_versions("${provider}" "${provider_pairs}" "rocm_interfaces_provider_query_v1" "${EXPECTED_PROVIDER_VERSION}")
endforeach()
