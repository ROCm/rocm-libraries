...
#   hwreg(26, offset=2, size=1)  — DISABLE_XDL_ARB_STALL (back-to-back WMMA hint)
...
# CHECK: v_add_f32
# CHECK-NEXT: s_setreg_IMM32_b32 hwreg(26,2,1)
...
test_start:
    ...
    v_add_f32 v0, v1, v2
    s_setreg_IMM32_b32 hwreg(26,2,1), 1          // DISABLE_XDL_ARB_STALL - KEEP (WMMA perf hint)
