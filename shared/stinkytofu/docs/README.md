...
- [Register Allocation](developer/register-allocation.md) -- Allocator interface, live intervals, region scope, verification on attached SSA, and keeping symbolic names and the `.set` block honest after a colouring is applied
- [The Greedy Allocator](developer/register-allocation-GreedyAllocator.md) -- The greedy and greedy-compact colouring policies in detail
