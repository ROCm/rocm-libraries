...
host-validation backend uses 32-bit CBLAS dimensions.
...
if(DEFINED BLA_SIZEOF_INTEGER
   ...
   AND NOT "${BLA_SIZEOF_INTEGER}" STREQUAL "4")
    ...
    string(
        ...
        "ROCHostValidation requires the LP64 CBLAS ABI "
...
# host-validation target can depend on one stable semantic target.
...
if(CBLAS_FOUND AND NOT CBLAS_FIND_QUIETLY)
    message(STATUS "ROCHostValidation CBLAS:")
