...
void registerOperationBindings(nb::module_& module) {
    nb::class_<AxpbyProblem>(module, "AxpbyProblem")
        ...
        .def_rw("alpha", &AxpbyProblem::alpha)
        .def_rw("beta", &AxpbyProblem::beta);
    ...
    nb::class_<EpilogueProblem>(module, "EpilogueProblem")
        ...
        .def_rw("output_scale", &EpilogueProblem::outputScale)
        .def_rw("auxiliary_scale", &EpilogueProblem::auxiliaryScale)
        ...
        .def_rw("activation_parameter0", &EpilogueProblem::activationParameter0)
        .def_rw("activation_parameter1", &EpilogueProblem::activationParameter1)
