...
set(layout_header
    "${HOST_NUMERICS_SOURCE_DIR}/include/roc/host_numerics/amd_gpu_layout/mx.hpp"
)
set(layout_source
    "${HOST_NUMERICS_SOURCE_DIR}/src/amd_gpu_layout/mx.cpp"
)
set(layout_threading
    "${HOST_NUMERICS_SOURCE_DIR}/src/amd_gpu_layout/mx_threading.hpp"
)
set(component_cmake "${HOST_NUMERICS_SOURCE_DIR}/CMakeLists.txt")
...
file(
    GLOB_RECURSE
    generic_sources
    "${HOST_NUMERICS_SOURCE_DIR}/include/roc/host_numerics/*.hpp"
...
foreach(generic_source IN LISTS generic_sources)
    ...
    if(contents MATCHES "amd_gpu_layout")
        message(
            FATAL_ERROR
            "Generic host-numerics source depends on AMD GPU layout code: ${generic_source}"
        )
    endif()
endforeach()
