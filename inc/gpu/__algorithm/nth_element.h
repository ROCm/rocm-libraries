...
#ifndef __GPU___ALGORITHM_NTH_ELEMENT_H
#define __GPU___ALGORITHM_NTH_ELEMENT_H
    ...
    while (true)
    {
        ...
        if (!__comp(*__i, *__m))  // if *__first == *__m
        {
            ...
            if (std::__nth_element_find_guard<_Compare>(__i, __j, __m, __comp)) {
                ...
                // gpu::__nth_element<_Compare>(__i, __nth, __last, __comp);
                __first = __i;
                continue;
            }
        }
        ...
        if (__nth < __i)
        {
            // gpu::__nth_element<_Compare>(__first, __nth, __i, __comp);
            __last = __i;
        }
        else
        {
            // gpu::__nth_element<_Compare>(__i+1, __nth, __last, __comp);
            __first = ++__i;
        }
    }
}
...
void __nth_element_impl(_RandomAccessIterator __first, _RandomAccessIterator __nth, _RandomAccessIterator __last,
  ...
  gpu::__nth_element<_AlgPolicy, __comp_ref_type<_Compare> >(__first, __nth, __last, __comp);
...
#endif // __GPU___ALGORITHM_NTH_ELEMENT_H
