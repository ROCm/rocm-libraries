...
#ifndef __GPU___ALGORITHM_SET_UNION_H
#define __GPU___ALGORITHM_SET_UNION_H
...
__device__ _LIBGPU_HIDE_FROM_ABI _LIBGPU_CONSTEXPR_SINCE_CXX20 __set_union_result<_InIter1, _InIter2, _OutIter> __set_union(
...
__device__ _LIBGPU_HIDE_FROM_ABI _LIBGPU_CONSTEXPR_SINCE_CXX20 _OutputIterator set_union(
    ...
    _Compare __comp) {
  return gpu::__set_union<_ClassicAlgPolicy, __comp_ref_type<_Compare> >(
             std::move(__first1),
             std::move(__last1),
             std::move(__first2),
             std::move(__last2),
...
#endif // __GPU___ALGORITHM_SET_UNION_H
