...
#ifndef __GPU___ALGORITHM_IS_PERMUTATION_H
#define __GPU___ALGORITHM_IS_PERMUTATION_H
...
struct _ConstTimeDistance : std::false_type {};

#if _LIBGPU_STD_VER >= 20

template <class _Iter1, class _Sent1, class _Iter2, class _Sent2>
struct _ConstTimeDistance<_Iter1, _Sent1, _Iter2, _Sent2, std::enable_if_t<
...
struct _ConstTimeDistance<_Iter1, _Iter1, _Iter2, _Iter2, std::enable_if_t<
    std::is_same<typename std::iterator_traits<_Iter1>::iterator_category, std::random_access_iterator_tag>::value &&
    std::is_same<typename std::iterator_traits<_Iter2>::iterator_category, std::random_access_iterator_tag>::value
> > : std::true_type {};
...
__is_permutation(_Iter1 __first1, _Sent1 __last1, _Iter2 __first2, _Sent2 __last2,
                 _Pred&& __pred, _Proj1&& __proj1, _Proj2&& __proj2,
                 /*_ConstTimeDistance=*/std::false_type) {
  // Shorten sequences as much as possible by lopping of any equal prefix.
...
// 2+2 iterators
template <class _ForwardIterator1, class _ForwardIterator2>
_LIBGPU_NODISCARD_EXT __device__ inline _LIBGPU_HIDE_FROM_ABI _LIBGPU_CONSTEXPR_SINCE_CXX20 bool is_permutation(
...
#endif // __GPU___ALGORITHM_IS_PERMUTATION_H
