...
#ifndef __GPU___ALGORITHM_STABLE_SORT_H
#define __GPU___ALGORITHM_STABLE_SORT_H
...
__stable_sort(_RandomAccessIterator __first, _RandomAccessIterator __last, _Compare __comp,
              ...
              typename std::iterator_traits<_RandomAccessIterator>::value_type* __buff, std::ptrdiff_t __buff_size);

template <class _AlgPolicy, class _Compare, class _RandomAccessIterator>
void
__stable_sort_move(_RandomAccessIterator __first1, _RandomAccessIterator __last1, _Compare __comp,
                   typename std::iterator_traits<_RandomAccessIterator>::difference_type __len,
                   typename std::iterator_traits<_RandomAccessIterator>::value_type* __first2)
{
    using _Ops = _IterOps<_AlgPolicy>;
    ...
    typename std::iterator_traits<_RandomAccessIterator>::difference_type __l2 = __len / 2;
    _RandomAccessIterator __m = __first1 + __l2;
    gpu::__stable_sort<_AlgPolicy, _Compare>(__first1, __m, __comp, __l2, __first2, __l2);
    gpu::__stable_sort<_AlgPolicy, _Compare>(__m, __last1, __comp, __len - __l2, __first2 + __l2, __len - __l2);
...
{
    static const unsigned value = 128*std::is_trivially_copy_assignable<_Tp>::value;
};
...
//         gpu::__merge<_Compare>(move_iterator<value_type*>(__buff),
...
//                                  __first, __comp);
    ...
    gpu::__stable_sort<_AlgPolicy, _Compare>(__first, __m, __comp, __l2, __buff, __buff_size);
    gpu::__stable_sort<_AlgPolicy, _Compare>(__m, __last, __comp, __len - __l2, __buff, __buff_size);
    gpu::__inplace_merge<_AlgPolicy>(__first, __m, __last, __comp, __l2, __len - __l2, __buff, __buff_size);
}
...
void __stable_sort_impl(_RandomAccessIterator __first, _RandomAccessIterator __last, _Compare& __comp) {
  ...
  gpu::pair<value_type*, std::ptrdiff_t> __buf(0, 0);
...
_LIBGPU_SUPPRESS_DEPRECATED_POP
  ...
  gpu::__stable_sort<_AlgPolicy, __comp_ref_type<_Compare> >(__first, __last, __comp, __len, __buf.first, __buf.second);
}
...
#endif // __GPU___ALGORITHM_STABLE_SORT_H
