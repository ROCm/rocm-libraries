...
struct __non_trivially_copyable_base {
  __device__ _LIBGPU_CONSTEXPR _LIBGPU_HIDE_FROM_ABI
  __non_trivially_copyable_base() _NOEXCEPT {}
  __device__ _LIBGPU_CONSTEXPR_SINCE_CXX14 _LIBGPU_HIDE_FROM_ABI
...
// TODO: uncomment once we implement tuple
    ...
    >::type* = nullptr>
    __device__ explicit _LIBGPU_HIDE_FROM_ABI _LIBGPU_CONSTEXPR
    ...
    >::type* = nullptr>
    __device__ _LIBGPU_HIDE_FROM_ABI _LIBGPU_CONSTEXPR
    pair() _NOEXCEPT_(std::is_nothrow_default_constructible<first_type>::value &&
                      std::is_nothrow_default_constructible<second_type>::value)
        : first(), second() {}
